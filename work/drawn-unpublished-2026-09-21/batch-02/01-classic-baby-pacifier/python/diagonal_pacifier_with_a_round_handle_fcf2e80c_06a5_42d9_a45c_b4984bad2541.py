...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_05/baby care pacifier_fcf2e80c-06a5-42d9-a45c-b4984bad2541.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        path('shield',(6,14),[((14,6),8,8,True),(42,34),((34,42),8,8,True),(6,14)],True)
        path('teat',(22,14),[(28,8),((40,20),9,9,True),(34,26)])
        self.relate('connect','teat','shield')
        path('handle',(14,22),[((26,34),10,10,False)])
