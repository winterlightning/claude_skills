"""Large Sparkle-Eyed Smiling Face
...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_34/smiley shine big eyes_58fdbda2-95d4-42f4-b93e-df89f627bc82.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    category = 'objects'
    aliases = ()
    keywords = ('face', 'smile', 'sparkle', 'eyes', 'expression', 'joy')
