...
description: Author or revise a standalone Pictographic SOLO48 icon using the condensed icon-design-distilled guidance. Use for objects, figures, or reference reconstructions read independently at 48 pixels. Generated from .claude/skills/icon-solo-distilled/SKILL.md by icon_set/scripts/generate_skills.py; edit the source, not this copy.
---
