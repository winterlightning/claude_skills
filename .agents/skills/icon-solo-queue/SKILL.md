...
description: Process a page of the Pictographic solo generation queue with icon-solo-distilled, generating standalone icons and saving verified component briefs for combinations. Use when asked to run a solo queue batch at a given offset. Generated from .claude/skills/icon-solo-queue/SKILL.md by icon_set/scripts/generate_skills.py; edit the source, not this copy.
---
