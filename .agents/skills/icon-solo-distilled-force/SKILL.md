...
description: Author or revise any requested input as a Pictographic SOLO48 icon using condensed icon-design-distilled guidance. Use when solo output is required regardless of input family, including combinations, wrappers, modifiers, symbols, and avatars, without intake classification or rerouting. Generated from .claude/skills/icon-solo-distilled-force/SKILL.md by icon_set/scripts/generate_skills.py; edit the source, not this copy.
---
