"""The sims (video-games), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '694737df-4e64-4a06-955d-79d65aef3ad6'
SOURCE_PATH = 'icons-json/video-games/the sims_694737df-4e64-4a06-955d-79d65aef3ad6.json'
AUTHOR = 'json_to_solo'

class TheSimsVideoGames(Solo48):
    icon_id = 'the-sims-video-games'
