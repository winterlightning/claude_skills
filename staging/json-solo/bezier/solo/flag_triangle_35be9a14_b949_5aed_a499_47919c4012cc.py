"""Flag triangle (social), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class FlagTriangleSocial(Solo48):
    icon_id = 'flag-triangle-social'
