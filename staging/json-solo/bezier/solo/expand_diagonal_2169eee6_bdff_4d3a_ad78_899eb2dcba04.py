"""Expand diagonal (design), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ExpandDiagonalDesign(Solo48):
    icon_id = 'expand-diagonal-design'
    ...
    def build(self):
        ...
        self.add_bezier('e11', (6, 9), ((6, 7.495), (7.495, 6), (9, 6)))
        self.add_bezier('e12', (39, 42), ((40.35, 42), (42, 40.35), (42, 39)))
