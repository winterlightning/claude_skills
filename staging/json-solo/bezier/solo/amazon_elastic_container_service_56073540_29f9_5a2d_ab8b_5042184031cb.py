"""Amazon elastic container service (programing), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '56073540-29f9-5a2d-ab8b-5042184031cb'
SOURCE_PATH = 'icons-json/programing/amazon elastic container service_56073540-29f9-5a2d-ab8b-5042184031cb.json'
AUTHOR = 'json_to_solo'

class AmazonElasticContainerServicePrograming(Solo48):
    icon_id = 'amazon-elastic-container-service-programing'
