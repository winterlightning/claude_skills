"""Rating star (rating), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class RatingStarRating(Solo48):
    icon_id = 'rating-star-rating'
