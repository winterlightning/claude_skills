"""Paragraph two column (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'ae53c84e-ee3a-4727-8ba4-a655774e41c6'
SOURCE_PATH = 'icons-json/interface-essential/paragraph two column_ae53c84e-ee3a-4727-8ba4-a655774e41c6.json'
AUTHOR = 'json_to_solo'

class ParagraphTwoColumnInterfaceEssential(Solo48):
    icon_id = 'paragraph-two-column-interface-essential'
