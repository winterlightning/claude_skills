"""Cursor left horizontal (state), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class CursorLeftHorizontalState(Solo48):
    icon_id = 'cursor-left-horizontal-state'
    ...
    def build(self):
        ...
        self.add_bezier('e4', (39, 22), ((38.645, 22.91), (38.664, 24.08), (39, 25)))
