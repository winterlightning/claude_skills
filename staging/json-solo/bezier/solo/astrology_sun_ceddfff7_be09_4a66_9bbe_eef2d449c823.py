"""Astrology sun (_uncategorized_04), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class AstrologySunUncategorized04(Solo48):
    icon_id = 'astrology-sun-uncategorized-04'
