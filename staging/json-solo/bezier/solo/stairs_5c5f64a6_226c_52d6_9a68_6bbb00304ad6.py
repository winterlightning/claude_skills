"""Stairs (furnitures), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '5c5f64a6-226c-52d6-9a68-6bbb00304ad6'
SOURCE_PATH = 'icons-json/furnitures/stairs_5c5f64a6-226c-52d6-9a68-6bbb00304ad6.json'
AUTHOR = 'json_to_solo'

class StairsFurnitures(Solo48):
    icon_id = 'stairs-furnitures'
