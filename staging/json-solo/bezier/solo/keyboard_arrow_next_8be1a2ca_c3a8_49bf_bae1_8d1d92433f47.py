"""Keyboard arrow next (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class KeyboardArrowNextInterfaceEssential(Solo48):
    icon_id = 'keyboard-arrow-next-interface-essential'
