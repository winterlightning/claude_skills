"""Tennis net (sports), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class TennisNetSports(Solo48):
    icon_id = 'tennis-net-sports'
