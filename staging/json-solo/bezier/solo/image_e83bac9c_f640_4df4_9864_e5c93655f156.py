"""Image (images), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'e83bac9c-f640-4df4-9864-e5c93655f156'
SOURCE_PATH = 'icons-json/images/image_e83bac9c-f640-4df4-9864-e5c93655f156.json'
AUTHOR = 'json_to_solo'

class ImageImages(Solo48):
    icon_id = 'image-images'
