"""Three bars (other), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ThreeBarsOther(Solo48):
    icon_id = 'three-bars-other'
