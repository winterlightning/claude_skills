"""Amazon elastic kubernetes service (_uncategorized_02), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class AmazonElasticKubernetesServiceUncategorized02(Solo48):
    icon_id = 'amazon-elastic-kubernetes-service-uncategorized-02'
