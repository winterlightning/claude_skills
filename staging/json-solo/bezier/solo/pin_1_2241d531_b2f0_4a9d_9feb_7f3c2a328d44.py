"""Pin 1 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '2241d531-b2f0-4a9d-9feb-7f3c2a328d44'
SOURCE_PATH = 'icons-json/interface-essential/pin 1_2241d531-b2f0-4a9d-9feb-7f3c2a328d44.json'
AUTHOR = 'json_to_solo'

class Pin12241d531(Solo48):
    icon_id = 'pin-1-2241d531'
