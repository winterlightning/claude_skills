"""Arrow corner bottom (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class ArrowCornerBottomArrows(Solo48):
    icon_id = 'arrow-corner-bottom-arrows'
