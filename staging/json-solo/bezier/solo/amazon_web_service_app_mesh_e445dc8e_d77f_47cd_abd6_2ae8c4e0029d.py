"""Amazon web service app mesh (_uncategorized_02), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class AmazonWebServiceAppMeshUncategorized02(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e7', (24, 13), ((24, 13.548), (24, 13.452), (24, 14)))
