...
class Helmet(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e6', (19, 14), ((13.482, 16.855), (9.482, 23.185), (8, 31)))
        self.add_bezier('sym-e7', (8, 31), ((7.445, 33.917), (8.127, 37.009), (8, 40)))
        self.add_line('sym-e8', (19, 29), (19, 14))
        self.add_bezier('sym-e9', (29, 14), ((34.518, 16.855), (38.518, 23.185), (40, 31)))
        self.add_bezier('sym-e10', (40, 31), ((40.555, 33.917), (39.873, 37.009), (40, 40)))
