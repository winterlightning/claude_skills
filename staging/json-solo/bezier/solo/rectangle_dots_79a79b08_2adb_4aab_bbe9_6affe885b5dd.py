"""Rectangle dots (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class RectangleDots79a79b08(Solo48):
    icon_id = 'rectangle-dots-79a79b08'
