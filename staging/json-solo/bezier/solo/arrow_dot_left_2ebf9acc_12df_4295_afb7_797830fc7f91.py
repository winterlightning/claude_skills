"""Arrow dot left (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class ArrowDotLeftArrows(Solo48):
    icon_id = 'arrow-dot-left-arrows'
