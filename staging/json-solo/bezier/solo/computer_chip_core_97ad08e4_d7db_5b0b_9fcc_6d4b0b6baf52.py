"""Computer chip core (electronics), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ComputerChipCoreElectronics(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e16', (14, 36), ((12.2, 36), (12, 35.726), (12, 34)))
        ...
        self.add_bezier('sym-e21', (34, 36), ((35.8, 36), (36, 35.726), (36, 34)))
        ...
        self.add_bezier('sym-e28', (12, 14), ((12, 12.274), (12.2, 12), (14, 12)))
        ...
        self.add_bezier('sym-e33', (36, 14), ((36, 12.274), (35.8, 12), (34, 12)))
