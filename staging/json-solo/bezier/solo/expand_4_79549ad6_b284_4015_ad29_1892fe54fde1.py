"""Expand 4 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Expand4InterfaceEssential(Solo48):
    icon_id = 'expand-4-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('e12', (8, 6), ((7.452, 6), (6.548, 6), (6, 6)))
        self.add_bezier('e13', (6, 40), ((6, 40.548), (6, 41.452), (6, 42)))
        self.add_bezier('e14', (8, 42), ((7.452, 42), (6.548, 42), (6, 42)))
        self.add_bezier('e15', (40, 42), ((40.548, 42), (41.452, 42), (42, 42)))
        ...
        self.add_contour('c7', 'e8', 'e14')
        self.add_contour('c8', 'e9')
        self.add_contour('c9', 'e10', 'e15')
