"""Photo time lapse (photography), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class PhotoTimeLapsePhotography(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e3', (24, 24), ((24, 24.3), (24, 24.691), (24, 25)))
