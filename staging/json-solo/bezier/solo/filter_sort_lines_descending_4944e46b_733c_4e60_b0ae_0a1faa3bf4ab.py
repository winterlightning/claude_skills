"""Filter sort lines descending (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class FilterSortLinesDescendingInterfaceEssential(Solo48):
    icon_id = 'filter-sort-lines-descending-interface-essential'
