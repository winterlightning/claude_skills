"""Arrow thick top (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class ArrowThickTopE3d7b5b6(Solo48):
    icon_id = 'arrow-thick-top-e3d7b5b6'
    ...
    def build(self):
        ...
        self.add_bezier('e8', (32, 42), ((31.773, 42.645), (32.008, 44), (31.158, 44)), ((31.023, 44), (31.143, 44), (31, 44)))
