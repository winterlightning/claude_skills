"""Expand horizontal 3 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ExpandHorizontal3InterfaceEssential(Solo48):
    icon_id = 'expand-horizontal-3-interface-essential'
    ...
    def build(self):
        ...
        self.add_line('sym-e2', (24, 24), (40, 24))
        self.add_line('sym-e3', (40, 24), (42, 24))
