"""Gpon splitter (networks), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '5e84ad9b-6c2b-40b1-a87a-845328653eac'
SOURCE_PATH = 'icons-json/networks/gpon splitter_5e84ad9b-6c2b-40b1-a87a-845328653eac.json'
AUTHOR = 'json_to_solo'

class GponSplitterNetworks(Solo48):
    icon_id = 'gpon-splitter-networks'
