"""Watch time (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class WatchTimeInterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e3', (24, 23), ((24.673, 24.336), (25.936, 25.936), (27, 27)))
