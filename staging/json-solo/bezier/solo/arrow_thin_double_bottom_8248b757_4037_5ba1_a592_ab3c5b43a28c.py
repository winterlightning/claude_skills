"""Arrow thin double bottom (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class ArrowThinDoubleBottomArrows(Solo48):
    icon_id = 'arrow-thin-double-bottom-arrows'
