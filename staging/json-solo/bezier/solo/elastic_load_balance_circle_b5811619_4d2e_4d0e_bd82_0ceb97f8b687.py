"""Elastic load balance circle (programing), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ElasticLoadBalanceCirclePrograming(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e10', (35, 24), ((34.73, 24), (34.27, 24), (34, 24)))
        ...
        self.add_bezier('sym-e15', (34, 13), ((34.27, 12.73), (34.73, 13.27), (35, 13)))
        self.add_line('sym-e16', (21, 24), (22, 26))
        self.add_line('sym-e17', (22, 26), (34, 35))
        self.add_bezier('sym-e18', (34, 35), ((34.27, 35.27), (34.73, 34.73), (35, 35)))
