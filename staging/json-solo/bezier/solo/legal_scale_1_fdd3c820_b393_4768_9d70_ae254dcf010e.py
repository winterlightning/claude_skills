"""Legal scale 1 (office), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class LegalScale1Office(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e8', (17, 24), ((17.018, 24.497), (17.091, 24.503), (17, 25)))
        self.add_bezier('sym-e9', (17, 25), ((16.582, 27.349), (14.518, 29.469), (12, 30)))
        self.add_bezier('sym-e10', (12, 30), ((8.982, 30.64), (5.218, 29.543), (4, 27)))
        self.add_bezier('sym-e11', (4, 27), ((4, 26.537), (4, 25.514), (4, 25)))
        self.add_bezier('sym-e12', (4, 25), ((4, 24.596), (4, 24.413), (4, 24)))
        ...
        self.add_bezier('sym-e17', (31, 24), ((30.982, 24.497), (30.909, 24.503), (31, 25)))
        self.add_bezier('sym-e18', (31, 25), ((31.418, 27.349), (33.482, 29.469), (36, 30)))
        self.add_bezier('sym-e19', (36, 30), ((39.018, 30.64), (41.782, 29.543), (43, 27)))
        self.add_bezier('sym-e20', (43, 27), ((43.218, 26.537), (44, 25.514), (44, 25)))
        self.add_bezier('sym-e21', (44, 25), ((44, 24.596), (44, 24.413), (44, 24)))
