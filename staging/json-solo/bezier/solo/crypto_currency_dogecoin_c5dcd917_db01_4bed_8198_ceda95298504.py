"""Crypto currency dogecoin (money), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class CryptoCurrencyDogecoinMoney(Solo48):
    icon_id = 'crypto-currency-dogecoin-money'
    ...
    def build(self):
        ...
        self.add_bezier('e6', (28, 34), ((28.927, 34), (30.382, 33.173), (31.209, 32.682)), ((36.764, 29.391), (37.164, 21.536), (33.518, 16.691)), ((32.291, 15.073), (30.155, 13), (28, 13)))
