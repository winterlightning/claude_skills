"""Honeycomb (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class HoneycombF0c353b7(Solo48):
    icon_id = 'honeycomb-f0c353b7'
    ...
    def build(self):
        ...
        self.add_bezier('e15', (15, 42), ((14.975, 42), (14.951, 41.992), (14.926, 41.992)), ((13.871, 41.992), (11.965, 40.483), (11, 40)))
