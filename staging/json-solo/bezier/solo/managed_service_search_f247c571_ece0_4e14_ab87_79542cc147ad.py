"""Managed service search (business), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ManagedServiceSearchBusiness(Solo48):
    icon_id = 'managed-service-search-business'
