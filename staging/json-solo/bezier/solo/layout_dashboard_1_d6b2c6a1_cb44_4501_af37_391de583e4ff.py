"""Layout dashboard 1 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'd6b2c6a1-cb44-4501-af37-391de583e4ff'
SOURCE_PATH = 'icons-json/interface-essential/layout dashboard 1_d6b2c6a1-cb44-4501-af37-391de583e4ff.json'
AUTHOR = 'json_to_solo'

class LayoutDashboard1InterfaceEssential(Solo48):
    icon_id = 'layout-dashboard-1-interface-essential'
