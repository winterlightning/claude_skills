"""Chemical hexagon (health), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '621db80c-1add-451c-9953-27071a412659'
SOURCE_PATH = 'icons-json/health/chemical hexagon_621db80c-1add-451c-9953-27071a412659.json'
AUTHOR = 'json_to_solo'

class ChemicalHexagon621db80c(Solo48):
    icon_id = 'chemical-hexagon-621db80c'
    ...
    def build(self):
        ...
        self.add_bezier('e19', (26, 42), ((25.73, 42), (26.27, 42), (26, 42)))
        ...
        self.add_contour('c10', 'e12', 'e19', 'e13')
