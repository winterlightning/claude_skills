"""Cursor right horizontal (state), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class CursorRightHorizontalState(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e5', (9, 22), ((9.355, 22.91), (9.336, 24.08), (9, 25)))
