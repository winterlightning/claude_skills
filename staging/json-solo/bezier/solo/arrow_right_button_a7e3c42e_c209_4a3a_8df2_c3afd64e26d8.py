"""Arrow right button (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class ArrowRightButtonSymbol(Solo48):
    icon_id = 'arrow-right-button-symbol'
