"""Shrink (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Shrink9099219f(Solo48):
    icon_id = 'shrink-9099219f'
