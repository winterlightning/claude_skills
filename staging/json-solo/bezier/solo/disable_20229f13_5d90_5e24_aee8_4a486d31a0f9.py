"""Disable (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class DisableInterfaceEssential(Solo48):
    icon_id = 'disable-interface-essential'
