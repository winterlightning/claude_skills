"""Fall down large head (diagrams), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class FallDownLargeHeadDiagrams(Solo48):
    icon_id = 'fall-down-large-head-diagrams'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e3', (44, 17), ((44, 18.145), (42.236, 20), (41, 20)))
        self.add_line('sym-e4', (41, 20), (24, 20))
        self.add_line('sym-e5', (24, 20), (7, 20))
        self.add_bezier('sym-e6', (7, 20), ((5.764, 20), (4, 18.145), (4, 17)))
