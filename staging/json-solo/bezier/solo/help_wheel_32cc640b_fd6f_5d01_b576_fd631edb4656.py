"""Help wheel (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '32cc640b-fd6f-5d01-b576-fd631edb4656'
SOURCE_PATH = 'icons-json/interface-essential/help wheel_32cc640b-fd6f-5d01-b576-fd631edb4656.json'
AUTHOR = 'json_to_solo'

class HelpWheelInterfaceEssential(Solo48):
    icon_id = 'help-wheel-interface-essential'
