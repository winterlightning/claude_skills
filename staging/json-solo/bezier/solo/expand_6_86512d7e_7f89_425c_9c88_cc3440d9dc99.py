"""Expand 6 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Expand6InterfaceEssential(Solo48):
    icon_id = 'expand-6-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e3', (6, 42), ((6, 41.452), (6, 40.548), (6, 40)))
        self.add_line('sym-e4', (6, 40), (6, 31))
        self.add_line('sym-e5', (42, 17), (42, 6))
        self.add_line('sym-e6', (17, 42), (8, 42))
        self.add_bezier('sym-e7', (8, 42), ((7.452, 42), (6.548, 42), (6, 42)))
