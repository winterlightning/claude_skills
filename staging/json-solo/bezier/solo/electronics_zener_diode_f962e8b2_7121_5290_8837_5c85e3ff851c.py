"""Electronics zener diode (electronics), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'f962e8b2-7121-5290-8837-5c85e3ff851c'
SOURCE_PATH = 'icons-json/electronics/electronics zener diode_f962e8b2-7121-5290-8837-5c85e3ff851c.json'
AUTHOR = 'json_to_solo'

class ElectronicsZenerDiodeElectronics(Solo48):
    icon_id = 'electronics-zener-diode-electronics'
