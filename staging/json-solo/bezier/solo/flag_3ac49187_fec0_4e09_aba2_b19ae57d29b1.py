...
class Flag3ac49187(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e7', (12, 8), ((15.3, 6.527), (19.28, 4.873), (23, 6)))
        self.add_bezier('e8', (29, 8), ((32.65, 9.109), (36.61, 8.473), (40, 7)))
        self.add_bezier('e9', (40, 23), ((39.83, 23.118), (39.78, 23.391), (39.58, 23.5)), ((36.66, 25.036), (32.14, 24.955), (29, 24)))
        self.add_bezier('e10', (23, 22), ((19.24, 20.864), (15.35, 22.536), (12, 24)))
