"""Npm logo (logos), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '8aa0aabc-1453-4132-a38c-7cc77a33e7cf'
SOURCE_PATH = 'icons-json/logos/npm logo_8aa0aabc-1453-4132-a38c-7cc77a33e7cf.json'
AUTHOR = 'json_to_solo'

class NpmLogoLogos(Solo48):
    icon_id = 'npm-logo-logos'
