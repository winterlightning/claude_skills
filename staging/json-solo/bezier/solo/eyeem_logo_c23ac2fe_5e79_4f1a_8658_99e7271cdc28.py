"""Eyeem logo (logos), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'c23ac2fe-5e79-4f1a-8658-99e7271cdc28'
SOURCE_PATH = 'icons-json/logos/eyeem logo_c23ac2fe-5e79-4f1a-8658-99e7271cdc28.json'
AUTHOR = 'json_to_solo'

class EyeemLogoLogos(Solo48):
    icon_id = 'eyeem-logo-logos'
