"""Decrease (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Decrease1b23a6a3(Solo48):
    icon_id = 'decrease-1b23a6a3'
