"""Zig zag fall (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class ZigZagFallArrows(Solo48):
    icon_id = 'zig-zag-fall-arrows'
