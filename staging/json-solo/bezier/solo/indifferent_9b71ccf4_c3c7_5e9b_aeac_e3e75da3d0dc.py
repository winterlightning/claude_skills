"""Indifferent (smileys), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class IndifferentSmileys(Solo48):
    icon_id = 'indifferent-smileys'
