"""Layout 2 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Layout2InterfaceEssential(Solo48):
    icon_id = 'layout-2-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('e13', (42, 39), ((42, 40.055), (41.235, 42), (40, 42)))
        self.add_bezier('e14', (42, 9), ((42, 7.707), (40.309, 6), (39, 6)))
        self.add_bezier('e15', (9, 42), ((7.658, 42), (6, 40.358), (6, 39)))
        self.add_bezier('e16', (6, 8), ((6.368, 6.945), (6.658, 6), (8, 6)))
