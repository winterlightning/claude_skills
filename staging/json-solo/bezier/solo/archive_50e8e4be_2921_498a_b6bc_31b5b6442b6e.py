"""Archive (content), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class Archive50e8e4be(Solo48):
    icon_id = 'archive-50e8e4be'
    ...
    def build(self):
        ...
        self.add_bezier('e8', (8, 6), ((8, 5.391), (8, 4.609), (8, 4)))
