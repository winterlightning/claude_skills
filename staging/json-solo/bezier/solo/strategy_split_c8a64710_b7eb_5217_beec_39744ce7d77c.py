"""Strategy split (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class StrategySplitArrows(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e11', (24, 36), ((26.324, 29.684), (27.792, 24.037), (35, 22)))
        self.add_bezier('e12', (24, 37), ((24, 35.765), (23.198, 34.178), (22.748, 32.926)), ((20.907, 27.821), (18.384, 23.53), (13, 22)))
