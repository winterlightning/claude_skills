"""Three arrows down (state), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '4fe44175-fb41-4dbd-a349-bde8c4354a91'
SOURCE_PATH = 'icons-json/state/three arrows down_4fe44175-fb41-4dbd-a349-bde8c4354a91.json'
AUTHOR = 'json_to_solo'

class ThreeArrowsDownState(Solo48):
    icon_id = 'three-arrows-down-state'
