"""Star burst (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'dcbfa235-b6ab-4926-bc2a-34d5ce7146d8'
SOURCE_PATH = 'icons-json/symbol/star burst_dcbfa235-b6ab-4926-bc2a-34d5ce7146d8.json'
AUTHOR = 'json_to_solo'

class StarBurstSymbol(Solo48):
    icon_id = 'star-burst-symbol'
