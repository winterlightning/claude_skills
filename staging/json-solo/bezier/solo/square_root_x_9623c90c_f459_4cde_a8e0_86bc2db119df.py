"""Square root x (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class SquareRootXInterfaceEssential(Solo48):
    icon_id = 'square-root-x-interface-essential'
