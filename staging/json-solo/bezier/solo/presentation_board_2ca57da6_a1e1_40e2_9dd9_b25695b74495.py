"""Presentation board (office), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class PresentationBoard(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e12', (6, 28), ((6, 28.884), (7.354, 29.697), (8, 30)))
        self.add_bezier('e13', (6, 8), ((6.278, 7.272), (7.018, 6), (8, 6)))
        self.add_bezier('e14', (40, 6), ((41.023, 6.442), (41.517, 6.985), (42, 8)))
        self.add_bezier('e15', (42, 28), ((41.542, 29.105), (41.055, 29.476), (40, 30)))
