"""Acrobatic hanging (sports), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class AcrobaticHanging0f4c8289(Solo48):
    icon_id = 'acrobatic-hanging-0f4c8289'
