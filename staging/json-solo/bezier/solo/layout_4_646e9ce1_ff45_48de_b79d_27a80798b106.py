"""Layout 4 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Layout4InterfaceEssential(Solo48):
    icon_id = 'layout-4-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e6', (42, 40), ((41.902, 40.139), (42, 40.853), (42, 41)))
        self.add_bezier('sym-e7', (42, 41), ((41.632, 41.614), (40.728, 42), (40, 42)))
        self.add_bezier('sym-e8', (40, 42), ((39.935, 42), (40.065, 42), (40, 42)))
        self.add_line('sym-e9', (40, 42), (24, 42))
        self.add_line('sym-e10', (24, 42), (8, 42))
        self.add_bezier('sym-e11', (8, 42), ((7.935, 42), (8.065, 42), (8, 42)))
        self.add_bezier('sym-e12', (8, 42), ((7.272, 42), (6.368, 41.614), (6, 41)))
        self.add_bezier('sym-e13', (6, 41), ((6, 40.853), (6.098, 40.139), (6, 40)))
        ...
        self.add_bezier('sym-e19', (42, 8), ((41.869, 7.149), (41.892, 6.425), (41, 6)))
        self.add_bezier('sym-e20', (41, 6), ((40.877, 6), (40.123, 6.033), (40, 6)))
        self.add_line('sym-e21', (40, 6), (24, 6))
        self.add_line('sym-e22', (24, 6), (8, 6))
        self.add_bezier('sym-e23', (8, 6), ((7.877, 6.033), (7.123, 6), (7, 6)))
        self.add_bezier('sym-e24', (7, 6), ((6.108, 6.425), (6.131, 7.149), (6, 8)))
