"""Download (emails), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '5fe422c3-4803-4575-8eb7-78ff267e78a3'
SOURCE_PATH = 'icons-json/emails/download_5fe422c3-4803-4575-8eb7-78ff267e78a3.json'
AUTHOR = 'json_to_solo'

class Download5fe422c3(Solo48):
    icon_id = 'download-5fe422c3'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e3', (40, 40), ((41.127, 40), (44, 38.221), (44, 37)))
        self.add_line('sym-e4', (44, 37), (44, 32))
        self.add_line('sym-e5', (14, 23), (24, 31))
        self.add_line('sym-e6', (24, 40), (8, 40))
        self.add_bezier('sym-e7', (8, 40), ((6.873, 40), (4, 38.221), (4, 37)))
