"""Deploy rules (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class DeployRulesArrows(Solo48):
    icon_id = 'deploy-rules-arrows'
