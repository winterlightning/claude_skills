"""Circle medical cross (state), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class CircleMedicalCrossState(Solo48):
    icon_id = 'circle-medical-cross-state'
