"""Peace (travel), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '2e44a4da-4f72-452e-869b-7b4b265330f4'
SOURCE_PATH = 'icons-json/travel/peace_2e44a4da-4f72-452e-869b-7b4b265330f4.json'
AUTHOR = 'json_to_solo'

class Peace2e44a4da(Solo48):
    icon_id = 'peace-2e44a4da'
