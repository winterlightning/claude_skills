"""Math symbol (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class MathSymbolInterfaceEssential(Solo48):
    icon_id = 'math-symbol-interface-essential'
