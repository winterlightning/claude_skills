"""Magic wand (design), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class MagicWandDesign(Solo48):
    icon_id = 'magic-wand-design'
    ...
    def build(self):
        ...
        self.add_line('e2', (34, 20), (40, 20))
        self.add_line('e3', (40, 20), (42, 20))
        ...
        self.add_bezier('e12', (32, 10), ((31.885, 10), (31.936, 10.181), (31.805, 10.181)), ((31.658, 10.181), (31.147, 10), (31, 10)))
        self.add_contour('c0', 'e0', 'e1', 'e2', 'e3', 'e4', 'e5', 'e6', 'e12', 'e7', 'e8', 'e9', 'e10')
