"""Double arrow 1 right (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class DoubleArrow1RightArrows(Solo48):
    icon_id = 'double-arrow-1-right-arrows'
