"""Expand 3 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Expand3InterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e11', (13, 6), ((11.167, 6), (9.69, 6.016), (7.857, 6.016)), ((7.235, 6.016), (6.63, 6.016), (6, 6)))
        self.add_bezier('e12', (40, 42), ((40.548, 42), (41.452, 42), (42, 42)))
        self.add_contour('c0', 'e0')
        self.add_contour('c1', 'e11')
        self.add_contour('c2', 'e1')
        self.add_contour('c3', 'e2')
        self.add_contour('c4', 'e3')
        self.add_contour('c5', 'e4', 'e12')
