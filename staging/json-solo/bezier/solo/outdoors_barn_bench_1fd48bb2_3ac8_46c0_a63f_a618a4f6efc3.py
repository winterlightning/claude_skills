"""Outdoors barn bench (outdoors), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class OutdoorsBarnBenchOutdoors(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e7', (9, 41), ((9.27, 41.27), (9.73, 41.73), (10, 42)))
