"""Cat cat ball (pets), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class CatCatBallPets(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e10', (33, 24), ((33.218, 18.009), (33.7, 14.373), (38, 10)))
        self.add_bezier('sym-e11', (15, 24), ((14.782, 18.009), (14.3, 14.373), (10, 10)))
        self.add_bezier('sym-e12', (33, 24), ((33.218, 29.991), (33.7, 33.627), (38, 38)))
        self.add_bezier('sym-e13', (15, 24), ((14.782, 29.991), (14.3, 33.627), (10, 38)))
