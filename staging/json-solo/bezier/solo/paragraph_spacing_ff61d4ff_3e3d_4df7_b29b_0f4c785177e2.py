"""Paragraph spacing (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'ff61d4ff-3e3d-4df7-b29b-0f4c785177e2'
SOURCE_PATH = 'icons-json/interface-essential/paragraph spacing_ff61d4ff-3e3d-4df7-b29b-0f4c785177e2.json'
AUTHOR = 'json_to_solo'

class ParagraphSpacingInterfaceEssential(Solo48):
    icon_id = 'paragraph-spacing-interface-essential'
