"""Chip (state), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ChipState(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e22', (12, 33), ((12, 34.006), (12.871, 36), (14, 36)))
