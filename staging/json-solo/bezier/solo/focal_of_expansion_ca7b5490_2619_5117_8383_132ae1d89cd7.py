"""Focal of expansion (technology), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class FocalOfExpansionTechnology(Solo48):
    icon_id = 'focal-of-expansion-technology'
