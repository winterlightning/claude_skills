"""App window small (_uncategorized_03), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class AppWindowSmallUncategorized03(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e2', (44, 36), ((44, 37.61), (41.464, 40), (40, 40)))
        self.add_line('sym-e3', (40, 40), (24, 40))
        self.add_line('sym-e4', (24, 40), (8, 40))
        self.add_bezier('sym-e5', (8, 40), ((6.536, 40), (4, 37.61), (4, 36)))
        self.add_line('sym-e6', (4, 36), (4, 18))
        self.add_line('sym-e7', (4, 18), (4, 12))
        self.add_bezier('sym-e8', (4, 12), ((4, 10.4), (6.536, 8), (8, 8)))
        self.add_line('sym-e9', (8, 8), (24, 8))
        self.add_line('sym-e10', (24, 8), (40, 8))
        self.add_bezier('sym-e11', (40, 8), ((41.464, 8), (44, 10.4), (44, 12)))
