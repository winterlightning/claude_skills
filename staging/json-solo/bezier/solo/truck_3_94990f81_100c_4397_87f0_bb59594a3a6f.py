"""Truck 3 (transportation), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '94990f81-100c-4397-87f0-bb59594a3a6f'
SOURCE_PATH = 'icons-json/transportation/truck 3_94990f81-100c-4397-87f0-bb59594a3a6f.json'
AUTHOR = 'json_to_solo'

class Truck394990f81(Solo48):
    icon_id = 'truck-3-94990f81'
    ...
    def build(self):
        ...
        self.add_bezier('e10', (4, 23), ((4.009, 22.803), (4.009, 22.363), (4.018, 22.166)), ((4.018, 21.686), (4.118, 21.108), (4.255, 20.677)), ((4.6, 19.594), (7.291, 15.434), (7.991, 14.905)), ((8.464, 14.535), (8.491, 14.222), (9, 14)))
