"""Chrome logo (logos), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class ChromeLogoLogos(Solo48):
    icon_id = 'chrome-logo-logos'
