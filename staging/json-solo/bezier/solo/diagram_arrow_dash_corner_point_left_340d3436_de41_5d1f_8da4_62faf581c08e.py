"""Diagram arrow dash corner point left (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class DiagramArrowDashCornerPointLeftArrows(Solo48):
    icon_id = 'diagram-arrow-dash-corner-point-left-arrows'
