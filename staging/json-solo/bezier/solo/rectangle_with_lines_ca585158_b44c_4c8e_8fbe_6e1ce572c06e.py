"""Rectangle with lines (state), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class RectangleWithLinesState(Solo48):
    icon_id = 'rectangle-with-lines-state'
