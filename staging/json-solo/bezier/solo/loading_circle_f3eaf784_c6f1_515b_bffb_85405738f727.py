"""Loading circle (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'f3eaf784-c6f1-515b-bffb-85405738f727'
SOURCE_PATH = 'icons-json/interface-essential/loading circle_f3eaf784-c6f1-515b-bffb-85405738f727.json'
AUTHOR = 'json_to_solo'

class LoadingCircleInterfaceEssential(Solo48):
    icon_id = 'loading-circle-interface-essential'
