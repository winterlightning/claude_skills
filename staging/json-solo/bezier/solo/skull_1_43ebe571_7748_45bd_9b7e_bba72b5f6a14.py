"""Skull 1 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '43ebe571-7748-45bd-9b7e-bba72b5f6a14'
SOURCE_PATH = 'icons-json/interface-essential/skull 1_43ebe571-7748-45bd-9b7e-bba72b5f6a14.json'
AUTHOR = 'json_to_solo'

class Skull1InterfaceEssential(Solo48):
    icon_id = 'skull-1-interface-essential'
