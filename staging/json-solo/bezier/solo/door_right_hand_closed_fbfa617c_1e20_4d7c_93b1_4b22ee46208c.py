"""Door right hand closed (building), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class DoorRightHandClosedBuilding(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e3', (35, 6), ((36.064, 6.499), (36.493, 6.904), (37, 8)))
        self.add_line('sym-e4', (37, 8), (37, 42))
        self.add_line('sym-e5', (6, 42), (11, 42))
        self.add_line('sym-e6', (11, 42), (11, 8))
        self.add_bezier('sym-e7', (11, 8), ((11.507, 6.904), (11.936, 6.499), (13, 6)))
