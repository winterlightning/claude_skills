"""Receipt (shopping), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class ReceiptShopping(Solo48):
    icon_id = 'receipt-shopping'
    ...
    def build(self):
        ...
        self.add_bezier('e20', (10, 43), ((8.947, 42.055), (8.379, 41.4), (8, 40)))
        self.add_bezier('e21', (38, 4), ((39.053, 4.873), (39.646, 5.627), (40, 7)))
        self.add_bezier('e22', (40, 40), ((40, 40.336), (39.983, 41.036), (39.983, 41.382)), ((39.983, 42.164), (39.2, 44), (38.316, 44)), ((38.038, 44), (37.278, 44), (37, 44)))
        self.add_bezier('e23', (37, 44), ((37.278, 44), (37.722, 44), (38, 44)))
        self.add_contour('c0', 'e0', 'e1', 'e2', 'e3', 'e4', 'e5', 'e6', 'e7', 'e8', 'e20', 'e9', 'e10', 'e11', 'e12', 'e13', 'e14', 'e15', 'e16', 'e17', 'e18', 'e21', 'e19', 'e22')
