"""Diagram arrow dash top (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class DiagramArrowDashTopArrows(Solo48):
    icon_id = 'diagram-arrow-dash-top-arrows'
    ...
    def build(self):
        ...
        self.add_bezier('e4', (24, 43), ((24, 43.3), (24, 43.7), (24, 44)))
