"""Nested pie (business), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class NestedPieBusiness(Solo48):
    icon_id = 'nested-pie-business'
    ...
    def build(self):
        ...
        self.add_bezier('e6', (17, 33), ((20.055, 31.573), (22.327, 30.227), (23.509, 26.855)), ((23.709, 26.282), (24, 25.618), (24, 25)))
