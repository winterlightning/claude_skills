"""Computer chip (electronics), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ComputerChipElectronics(Solo48):
    icon_id = 'computer-chip-electronics'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e2', (31, 36), ((34.003, 36), (36, 35.412), (36, 32)))
        ...
        self.add_bezier('sym-e14', (12, 32), ((12, 35.412), (13.997, 36), (17, 36)))
        self.add_line('sym-e15', (17, 36), (19, 36))
        self.add_line('sym-e16', (29, 6), (29, 12))
        self.add_line('sym-e17', (29, 12), (31, 12))
        self.add_bezier('sym-e18', (31, 12), ((34.003, 12), (36, 12.588), (36, 16)))
        ...
        self.add_bezier('sym-e26', (12, 16), ((12, 12.588), (13.997, 12), (17, 12)))
