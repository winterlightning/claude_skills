"""Layout 14 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Layout14InterfaceEssential(Solo48):
    icon_id = 'layout-14-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e2', (40, 42), ((41.105, 42), (42, 41.096), (42, 40)))
        ...
        self.add_bezier('sym-e9', (42, 8), ((41.615, 7.018), (41.285, 6), (40, 6)))
        self.add_line('sym-e10', (40, 6), (24, 6))
        self.add_line('sym-e11', (24, 6), (8, 6))
        self.add_bezier('sym-e12', (8, 6), ((6.715, 6), (6.385, 7.018), (6, 8)))
        ...
        self.add_bezier('sym-e17', (6, 40), ((6, 41.096), (6.895, 42), (8, 42)))
