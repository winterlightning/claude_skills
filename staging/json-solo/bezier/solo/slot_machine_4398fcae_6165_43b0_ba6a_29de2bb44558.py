"""Slot machine (state), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class SlotMachineState(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e7', (6, 40), ((6.008, 40.033), (6, 39.967), (6, 40)))
        self.add_bezier('sym-e8', (6, 40), ((6, 41.219), (7.059, 41.656), (8, 42)))
        self.add_line('sym-e9', (8, 42), (24, 42))
        self.add_line('sym-e10', (24, 42), (40, 42))
        self.add_bezier('sym-e11', (40, 42), ((40.941, 41.656), (42, 41.219), (42, 40)))
        self.add_bezier('sym-e12', (42, 40), ((42, 39.967), (41.992, 40.033), (42, 40)))
        self.add_line('sym-e13', (42, 40), (42, 26))
        self.add_line('sym-e14', (40, 6), (24, 6))
        self.add_line('sym-e15', (24, 6), (8, 6))
        self.add_bezier('sym-e16', (8, 6), ((6.92, 6.352), (6, 6.642), (6, 8)))
        self.add_line('sym-e17', (6, 8), (6, 16))
        self.add_line('sym-e18', (6, 16), (6, 26))
        self.add_line('sym-e19', (42, 16), (42, 8))
        self.add_bezier('sym-e20', (42, 8), ((42, 6.642), (41.08, 6.352), (40, 6)))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4')
        self.add_contour('sym-c1', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e13')
