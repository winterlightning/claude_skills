"""Workflow exit door (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class WorkflowExitDoorInterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e6', (34, 19), ((34, 17.155), (32.31, 15), (30, 15)))
