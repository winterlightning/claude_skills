"""Line (diagrams), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Line22755210(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e5', (34, 15), ((33.73, 14.73), (33.27, 14.27), (33, 14)))
        self.add_line('sym-e6', (24, 24), (15, 34))
        self.add_bezier('sym-e7', (15, 34), ((14.73, 33.73), (14.27, 33.27), (14, 33)))
