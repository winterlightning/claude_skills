"""Expand diagonal 3 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ExpandDiagonal3InterfaceEssential(Solo48):
    icon_id = 'expand-diagonal-3-interface-essential'
