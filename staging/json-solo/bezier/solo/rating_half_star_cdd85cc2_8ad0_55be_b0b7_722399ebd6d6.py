"""Rating half star (rating), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class RatingHalfStarRating(Solo48):
    icon_id = 'rating-half-star-rating'
    ...
    def build(self):
        ...
        self.add_bezier('e6', (40, 32), ((40, 32.073), (40, 32.327), (40, 32.4)), ((40, 33.082), (39.702, 33.618), (39, 34)))
