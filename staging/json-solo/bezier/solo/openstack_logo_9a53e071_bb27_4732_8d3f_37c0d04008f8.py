"""Openstack logo (logos), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class OpenstackLogoLogos(Solo48):
    icon_id = 'openstack-logo-logos'
