"""Expand vertical left right (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '48373455-7c35-4928-8419-3623bf606696'
SOURCE_PATH = 'icons-json/interface-essential/expand vertical left right_48373455-7c35-4928-8419-3623bf606696.json'
AUTHOR = 'json_to_solo'

class ExpandVerticalLeftRightInterfaceEssential(Solo48):
    icon_id = 'expand-vertical-left-right-interface-essential'
