"""Grid dot (design), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class GridDotDesign(Solo48):
    icon_id = 'grid-dot-design'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e1', (6, 9), ((6, 7.323), (7.675, 6.458), (9, 6)))
        self.add_line('sym-e2', (9, 6), (24, 6))
        self.add_line('sym-e3', (24, 6), (39, 6))
        self.add_bezier('sym-e4', (39, 6), ((40.325, 6.458), (42, 7.323), (42, 9)))
        self.add_line('sym-e5', (42, 9), (42, 24))
        self.add_line('sym-e6', (42, 24), (42, 39))
        self.add_bezier('sym-e7', (42, 39), ((42, 40.677), (40.325, 41.542), (39, 42)))
        self.add_line('sym-e8', (39, 42), (24, 42))
        self.add_line('sym-e9', (24, 42), (9, 42))
        self.add_bezier('sym-e10', (9, 42), ((7.675, 41.542), (6, 40.677), (6, 39)))
