"""Navigation right circle 1 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class NavigationRightCircle1InterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e4', (4, 24), ((4, 23.31), (4.218, 22.53), (4.4, 21.87)), ((5.364, 18.26), (8.118, 16.05), (11.345, 15.23)), ((11.591, 15.17), (11.764, 15), (12, 15)))
