"""Nintendo switch (video-games), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class NintendoSwitchVideoGames(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e7', (9, 8), ((6.582, 8), (4, 11.997), (4, 15)))
        self.add_line('sym-e8', (4, 15), (4, 24))
        self.add_line('sym-e9', (4, 24), (4, 33))
        self.add_bezier('sym-e10', (4, 33), ((4, 36.003), (6.582, 40), (9, 40)))
        self.add_line('sym-e11', (9, 40), (13, 40))
        self.add_line('sym-e12', (35, 40), (39, 40))
        self.add_bezier('sym-e13', (39, 40), ((41.418, 40), (44, 36.003), (44, 33)))
        self.add_line('sym-e14', (44, 33), (44, 24))
        self.add_line('sym-e15', (44, 24), (44, 15))
        self.add_bezier('sym-e16', (44, 15), ((44, 11.997), (41.418, 8), (39, 8)))
