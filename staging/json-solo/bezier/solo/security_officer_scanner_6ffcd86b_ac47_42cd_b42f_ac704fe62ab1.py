"""Security officer scanner (travel), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class SecurityOfficerScannerTravel(Solo48):
    icon_id = 'security-officer-scanner-travel'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e4', (8, 6), ((8.652, 4.882), (8.486, 4.518), (10, 4)))
        self.add_line('sym-e5', (10, 4), (24, 4))
        self.add_line('sym-e6', (24, 4), (38, 4))
        self.add_bezier('sym-e7', (38, 4), ((39.514, 4.518), (39.348, 4.882), (40, 6)))
