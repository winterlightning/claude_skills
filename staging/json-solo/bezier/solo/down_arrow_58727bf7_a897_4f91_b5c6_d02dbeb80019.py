"""Down arrow (state), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '58727bf7-a897-4f91-b5c6-d02dbeb80019'
SOURCE_PATH = 'icons-json/state/down arrow_58727bf7-a897-4f91-b5c6-d02dbeb80019.json'
AUTHOR = 'json_to_solo'

class DownArrowState(Solo48):
    icon_id = 'down-arrow-state'
