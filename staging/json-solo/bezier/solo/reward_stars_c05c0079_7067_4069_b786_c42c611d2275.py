"""Reward stars (rating), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class RewardStarsRating(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e10', (24, 35), ((23.845, 35), (23.164, 34.902), (23, 35)))
        self.add_bezier('e11', (14, 41), ((13.673, 41.106), (13.527, 41.403), (13.2, 41.509)), ((13.257, 41.125), (12.951, 40.385), (13, 40)))
        self.add_bezier('e12', (15, 29), ((15, 28.795), (15.205, 28.18), (15, 28)))
        self.add_contour('c0', 'e0', 'e1', 'e2', 'e3', 'e4', 'e10', 'e5', 'e11', 'e6', 'e12', 'e7', 'e8', 'e9', closed=True)
