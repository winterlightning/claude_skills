"""Arrow zigzag bottom (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'f2bfa046-1d2d-5b66-af55-572915e98be2'
SOURCE_PATH = 'icons-json/arrows/arrow zigzag bottom_f2bfa046-1d2d-5b66-af55-572915e98be2.json'
AUTHOR = 'json_to_solo'

class ArrowZigzagBottomArrows(Solo48):
    icon_id = 'arrow-zigzag-bottom-arrows'
