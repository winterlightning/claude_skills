"""Navigation arrows right (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class NavigationArrowsRightInterfaceEssential(Solo48):
    icon_id = 'navigation-arrows-right-interface-essential'
