"""Anchor logo (_uncategorized_03), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class AnchorLogoUncategorized03(Solo48):
    icon_id = 'anchor-logo-uncategorized-03'
    ...
    def build(self):
        ...
        self.add_bezier('e9', (24, 14), ((24, 14.27), (24, 14.73), (24, 15)))
        self.add_bezier('e10', (24, 42), ((23.73, 42), (23.46, 41.992), (23.19, 41.992)), ((16.882, 41.992), (11.449, 37.148), (9.395, 31.445)), ((8.806, 29.817), (8.205, 27.718), (8, 26)))
        self.add_bezier('e11', (24, 42), ((24.262, 42), (24.515, 41.992), (24.777, 41.992)), ((31.184, 41.992), (36.968, 37.042), (38.825, 31.069)), ((39.292, 29.555), (39.845, 27.579), (40, 26)))
