"""Power (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'f71eb996-3671-43a1-ae4a-03a0b33fa716'
SOURCE_PATH = 'icons-json/symbol/power_f71eb996-3671-43a1-ae4a-03a0b33fa716.json'
AUTHOR = 'json_to_solo'
