"""Underwear bikini bottom (clothes), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class UnderwearBikiniBottomClothes(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e1', (28, 40), ((28.236, 37.231), (28.3, 34.634), (29, 32)))
        self.add_bezier('sym-e2', (29, 32), ((30.445, 26.585), (33.155, 21.449), (37, 19)))
        self.add_bezier('sym-e3', (37, 19), ((39.2, 17.585), (41.664, 17.788), (44, 17)))
        self.add_line('sym-e4', (44, 17), (43, 8))
        self.add_line('sym-e5', (43, 8), (24, 8))
        self.add_line('sym-e6', (24, 8), (5, 8))
        self.add_line('sym-e7', (5, 8), (4, 17))
        self.add_bezier('sym-e8', (4, 17), ((6.336, 17.788), (8.8, 17.585), (11, 19)))
        self.add_bezier('sym-e9', (11, 19), ((14.845, 21.449), (17.555, 26.585), (19, 32)))
        self.add_bezier('sym-e10', (19, 32), ((19.7, 34.634), (19.764, 37.231), (20, 40)))
