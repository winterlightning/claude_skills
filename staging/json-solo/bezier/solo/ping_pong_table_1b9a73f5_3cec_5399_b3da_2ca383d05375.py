"""Ping pong table (sports), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class PingPongTableSports(Solo48):
    icon_id = 'ping-pong-table-sports'
