"""3 three squares (state), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'a9b057d5-e3a1-46b4-aa87-bcc44d4860f2'
SOURCE_PATH = 'icons-json/state/3 three squares_a9b057d5-e3a1-46b4-aa87-bcc44d4860f2.json'
AUTHOR = 'json_to_solo'

class Icon3ThreeSquaresState(Solo48):
    icon_id = 'icon-3-three-squares-state'
