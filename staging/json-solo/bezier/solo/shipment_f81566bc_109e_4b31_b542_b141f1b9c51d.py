"""Shipment (shipping), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class ShipmentF81566bc(Solo48):
    icon_id = 'shipment-f81566bc'
    ...
    def build(self):
        ...
        self.add_bezier('e19', (39, 14), ((38.373, 13.48), (37.736, 13.24), (37, 13)))
