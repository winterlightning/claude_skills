"""Billboard (business), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class BillboardBusiness(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e7', (10, 34), ((8.56, 34), (6, 34.471), (6, 32)))
        self.add_line('sym-e8', (6, 32), (6, 8))
        self.add_bezier('sym-e9', (6, 8), ((6.008, 7.869), (6, 8.131), (6, 8)))
        self.add_bezier('sym-e10', (6, 8), ((6, 7.043), (7.067, 6), (8, 6)))
        self.add_bezier('sym-e11', (8, 6), ((8.376, 6), (8.624, 6), (9, 6)))
        self.add_line('sym-e12', (9, 6), (24, 6))
        self.add_line('sym-e13', (24, 6), (39, 6))
        self.add_bezier('sym-e14', (39, 6), ((39.376, 6), (39.624, 6), (40, 6)))
        self.add_bezier('sym-e15', (40, 6), ((40.933, 6), (42, 7.043), (42, 8)))
        self.add_bezier('sym-e16', (42, 8), ((42, 8.131), (41.992, 7.869), (42, 8)))
        self.add_line('sym-e17', (42, 8), (42, 32))
        self.add_bezier('sym-e18', (42, 32), ((42, 34.471), (39.44, 34), (38, 34)))
        ...
        self.add_contour('sym-c2', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e15', 'sym-e16', 'sym-e17', 'sym-e18', 'sym-e19')
