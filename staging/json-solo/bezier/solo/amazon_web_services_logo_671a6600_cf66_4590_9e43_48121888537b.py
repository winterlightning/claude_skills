"""Amazon web services logo (_uncategorized_03), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '671a6600-cf66-4590-9e43-48121888537b'
SOURCE_PATH = 'icons-json/_uncategorized_03/amazon web services logo_671a6600-cf66-4590-9e43-48121888537b.json'
AUTHOR = 'json_to_solo'

class AmazonWebServicesLogoUncategorized03(Solo48):
    icon_id = 'amazon-web-services-logo-uncategorized-03'
