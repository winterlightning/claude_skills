"""Slab serif text character (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class SlabSerifTextCharacterInterfaceEssential(Solo48):
    icon_id = 'slab-serif-text-character-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('e12', (34, 5), ((34.177, 4.782), (34.341, 4.382), (34.552, 4.191)), ((34.661, 4.082), (34.891, 4.1), (35, 4)))
