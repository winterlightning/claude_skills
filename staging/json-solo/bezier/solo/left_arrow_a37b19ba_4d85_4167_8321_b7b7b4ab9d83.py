"""Left arrow (transportation), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class LeftArrowTransportation(Solo48):
    icon_id = 'left-arrow-transportation'
