"""Batch-03/glasses sun circle (accessories), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class Batch03GlassesSunCircle(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e5', (24, 22), ((22.735, 22), (21.27, 22.944), (20, 24)))
        self.add_line('sym-e6', (44, 24), (42, 24))
        self.add_bezier('sym-e7', (24, 22), ((25.265, 22), (26.73, 22.944), (28, 24)))
