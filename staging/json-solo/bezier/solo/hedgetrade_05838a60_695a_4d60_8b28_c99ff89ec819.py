"""Hedgetrade (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class HedgetradeSymbol(Solo48):
    icon_id = 'hedgetrade-symbol'
