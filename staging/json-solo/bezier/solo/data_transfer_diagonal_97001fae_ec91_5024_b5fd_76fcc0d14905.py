"""Data transfer diagonal (networks), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class DataTransferDiagonalNetworks(Solo48):
    icon_id = 'data-transfer-diagonal-networks'
