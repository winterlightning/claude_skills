"""Door left hand closed (building), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class DoorLeftHandClosedBuilding(Solo48):
    icon_id = 'door-left-hand-closed-building'
    ...
    def build(self):
        ...
        self.add_bezier('e6', (10, 8), ((10.458, 6.994), (10.977, 6.45), (12, 6)))
        self.add_bezier('e7', (35, 6), ((35.933, 6), (36.714, 7.288), (37, 8)))
