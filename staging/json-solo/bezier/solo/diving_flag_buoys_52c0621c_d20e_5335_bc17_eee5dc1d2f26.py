"""Diving flag buoys (outdoors), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class DivingFlagBuoysOutdoors(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e9', (13, 32), ((13.33, 32), (13.67, 32), (14, 32)))
