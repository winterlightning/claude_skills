"""Synchronize arrows (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class SynchronizeArrowsInterfaceEssential(Solo48):
    icon_id = 'synchronize-arrows-interface-essential'
