"""Curve down large head (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class CurveDownLargeHeadArrows(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e5', (6, 13), ((6, 13.319), (6.18, 14.035), (6.27, 14.345)), ((6.925, 16.489), (8.815, 18.232), (10.942, 18.862)), ((11.138, 18.919), (11.82, 19), (12, 19)))
        self.add_bezier('e6', (26, 19), ((26.27, 19), (27.166, 19.255), (27.445, 19.32)), ((30.619, 20.032), (33.229, 22.486), (34.227, 25.579)), ((34.391, 26.078), (35, 26.476), (35, 27)))
