...
class PhoneWithDownArrowSymbol(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e7', (39, 34), ((40.915, 35.915), (38.924, 37.991), (37.639, 39.57)), ((36.919, 40.462), (36.142, 41.444), (35.005, 41.828)), ((34.587, 41.967), (34.055, 41.992), (33.622, 41.992)), ((33.541, 41.992), (33.461, 42), (33.38, 42)), ((33.379, 42), (33.378, 42), (33.376, 42)), ((29.997, 42), (26.43, 39.194), (24, 37.091)), ((18.895, 32.673), (13.994, 27.911), (10.091, 22.364)), ((8.414, 19.975), (6.008, 16.145), (6.008, 13.184)), ((6, 13.103), (6, 13.015), (6, 12.934)), ((6, 12.933), (6, 12.931), (6, 12.93)), ((6, 12.693), (6.016, 12.455), (6.016, 12.218)), ((6.016, 11.277), (6.327, 10.353), (6.851, 9.575)), ((7.53, 8.577), (10.075, 6), (11.359, 6)), ((11.408, 6), (11.457, 6.008), (11.506, 6.008)), ((12.177, 6.008), (12.534, 6.534), (13, 7)))
        self.add_bezier('e8', (17, 11), ((18.481, 12.481), (18.031, 14.462), (17, 16)))
        self.add_contour('c0', 'e0', 'e1')
        self.add_contour('c1', 'e2')
        self.add_contour('c2', 'e6', 'e3', 'e7', 'e4', 'e8', 'e5')
