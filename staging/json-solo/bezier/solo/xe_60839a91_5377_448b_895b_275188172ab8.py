"""Xe (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class XeSymbol(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e2', (31, 39), ((31.164, 39.406), (31.627, 39.729), (32, 40)))
        self.add_bezier('sym-e3', (32, 40), ((32.136, 40), (31.864, 39.889), (32, 40)))
        ...
        self.add_bezier('sym-e10', (31, 9), ((31.164, 8.594), (31.627, 8.271), (32, 8)))
        self.add_bezier('sym-e11', (32, 8), ((32.136, 8), (31.864, 8.111), (32, 8)))
        ...
        self.add_contour('sym-c4', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12')
