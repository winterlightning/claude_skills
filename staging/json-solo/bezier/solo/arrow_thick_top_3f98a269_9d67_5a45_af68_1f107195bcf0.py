"""Arrow thick top (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ArrowThickTopArrows(Solo48):
    icon_id = 'arrow-thick-top-arrows'
