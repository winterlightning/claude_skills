"""Electronics tunnel diode (electronics), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class ElectronicsTunnelDiodeElectronics(Solo48):
    icon_id = 'electronics-tunnel-diode-electronics'
