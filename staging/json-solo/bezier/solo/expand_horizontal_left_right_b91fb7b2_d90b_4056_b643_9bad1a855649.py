"""Expand horizontal left right (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'b91fb7b2-d90b-4056-b643-9bad1a855649'
SOURCE_PATH = 'icons-json/interface-essential/expand horizontal left right_b91fb7b2-d90b-4056-b643-9bad1a855649.json'
AUTHOR = 'json_to_solo'

class ExpandHorizontalLeftRightInterfaceEssential(Solo48):
    icon_id = 'expand-horizontal-left-right-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('e10', (20, 23), ((20, 23.278), (20, 23.722), (20, 24)))
        self.add_bezier('e11', (20, 23), ((20, 23.278), (20, 23.722), (20, 24)))
