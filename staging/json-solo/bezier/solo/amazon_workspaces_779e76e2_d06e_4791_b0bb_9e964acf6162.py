"""Amazon workspaces (_uncategorized_03), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class AmazonWorkspacesUncategorized03(Solo48):
    icon_id = 'amazon-workspaces-uncategorized-03'
    ...
    def build(self):
        ...
        self.add_bezier('e9', (24, 42), ((24.27, 41.885), (24.755, 42), (25, 42)))
        self.add_bezier('e10', (6, 16), ((6, 15.73), (6, 15.27), (6, 15)))
