"""Arrow corner top (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class ArrowCornerTopArrows(Solo48):
    icon_id = 'arrow-corner-top-arrows'
