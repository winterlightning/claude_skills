"""Envelope (emails), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class EnvelopeEmails(Solo48):
    icon_id = 'envelope-emails'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e6', (24, 28), ((23.32, 28), (22.459, 27.455), (22, 27)))
        self.add_line('sym-e7', (22, 27), (4, 9))
        self.add_line('sym-e8', (4, 9), (4, 14))
        self.add_line('sym-e9', (4, 14), (4, 37))
        self.add_bezier('sym-e10', (4, 37), ((4, 37.31), (4, 37.68), (4, 38)))
        self.add_bezier('sym-e11', (4, 38), ((4, 38.35), (4, 38.65), (4, 39)))
        self.add_line('sym-e12', (4, 39), (19, 24))
        self.add_bezier('sym-e13', (24, 28), ((24.68, 28), (25.541, 27.455), (26, 27)))
        self.add_line('sym-e14', (26, 27), (44, 9))
        self.add_line('sym-e15', (44, 9), (44, 14))
        self.add_line('sym-e16', (44, 14), (44, 37))
        self.add_bezier('sym-e17', (44, 37), ((44, 37.31), (44, 37.68), (44, 38)))
        self.add_bezier('sym-e18', (44, 38), ((44, 38.35), (44, 38.65), (44, 39)))
