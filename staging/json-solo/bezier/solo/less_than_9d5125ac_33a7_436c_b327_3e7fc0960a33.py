"""Less than (_uncategorized), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class LessThanUncategorized(Solo48):
    icon_id = 'less-than-uncategorized'
