"""Shape cube (design), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ShapeCubeDesign(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e9', (15, 6), ((14.885, 6.049), (14.763, 6.098), (14.648, 6.139)), ((14.419, 6.286), (14.188, 6.812), (14, 7)))
