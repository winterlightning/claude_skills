"""Steady and fall (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class SteadyAndFallArrows(Solo48):
    icon_id = 'steady-and-fall-arrows'
    ...
    def build(self):
        ...
        self.add_bezier('e8', (4, 21), ((4, 23.072), (6.764, 26), (9, 26)))
