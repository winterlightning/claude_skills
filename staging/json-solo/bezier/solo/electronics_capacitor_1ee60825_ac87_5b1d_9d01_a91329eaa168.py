"""Electronics capacitor (electronics), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class ElectronicsCapacitorElectronics(Solo48):
    icon_id = 'electronics-capacitor-electronics'
    ...
    def build(self):
        self.add_line('sym-e0', (40, 27), (35, 27))
        self.add_line('sym-e1', (35, 27), (24, 27))
        self.add_line('sym-e2', (24, 27), (13, 27))
        self.add_line('sym-e3', (13, 27), (8, 27))
