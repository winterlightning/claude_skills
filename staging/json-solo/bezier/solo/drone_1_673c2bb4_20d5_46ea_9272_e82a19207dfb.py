"""Drone 1 (technology), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class Drone1Technology(Solo48):
    icon_id = 'drone-1-technology'
