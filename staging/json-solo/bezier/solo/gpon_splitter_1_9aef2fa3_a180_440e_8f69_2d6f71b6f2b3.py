"""Gpon splitter 1 (networks), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class GponSplitter1Networks(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e11', (39, 10), ((39, 9.368), (39.3, 8.564), (39, 8)))
