"""Devastated (smileys), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class DevastatedSmileys(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e6', (15, 34), ((19.755, 26.755), (28.273, 26.718), (33, 34)))
