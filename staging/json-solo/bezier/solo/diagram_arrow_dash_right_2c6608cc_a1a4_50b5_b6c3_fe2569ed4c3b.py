"""Diagram arrow dash right (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class DiagramArrowDashRightArrows(Solo48):
    icon_id = 'diagram-arrow-dash-right-arrows'
    ...
    def build(self):
        ...
        self.add_bezier('e4', (5, 24), ((4.7, 24), (4.3, 24), (4, 24)))
