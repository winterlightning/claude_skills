"""Fahrenheit (state), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class FahrenheitState(Solo48):
    icon_id = 'fahrenheit-state'
    ...
    def build(self):
        ...
        self.add_bezier('e3', (8, 4), ((8, 4.3), (8, 4.7), (8, 5)))
