"""Keyboard asterisk (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class KeyboardAsterisk2a575848(Solo48):
    icon_id = 'keyboard-asterisk-2a575848'
