"""Two pronged fork knife (food), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class TwoProngedForkKnifeFood(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e6', (15, 15), ((14.19, 10.945), (11.32, 6.727), (8, 4)))
        self.add_bezier('e7', (29, 15), ((29, 18.2), (31.74, 19.682), (35, 20)))
        self.add_bezier('e8', (35, 20), ((35.78, 19.845), (36.62, 20.1), (37.33, 19.727)), ((38.68, 19), (40, 17.482), (40, 16)))
