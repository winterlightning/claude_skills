"""Arrow thick corner 2 top left (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ArrowThickCorner2TopLeftArrows(Solo48):
    icon_id = 'arrow-thick-corner-2-top-left-arrows'
