"""Honey (food), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class HoneyFood(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e17', (32, 42), ((32.115, 42), (32.419, 42), (32.534, 42)), ((33.229, 42), (33.501, 41.303), (34, 41)))
        self.add_bezier('e18', (15, 12), ((15.27, 11.689), (15.697, 11.27), (16, 11)))
        self.add_contour('c0', 'e0', 'e17', 'e1', 'e2', 'e3', 'e4')
        self.add_contour('c1', 'e5')
        self.add_contour('c2', 'e6', 'e7', 'e8', 'e9')
        self.add_contour('c3', 'e10', 'e18', 'e11', 'e12', 'e13', 'e14')
        self.add_contour('c4', 'e15', 'e16')
