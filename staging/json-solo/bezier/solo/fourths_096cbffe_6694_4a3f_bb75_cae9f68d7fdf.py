"""Fourths (_uncategorized), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '096cbffe-6694-4a3f-bb75-cae9f68d7fdf'
SOURCE_PATH = 'icons-json/_uncategorized_19/fourths_096cbffe-6694-4a3f-bb75-cae9f68d7fdf.json'
AUTHOR = 'json_to_solo'

class FourthsUncategorized(Solo48):
    icon_id = 'fourths-uncategorized'
