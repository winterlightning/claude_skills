"""Window closed (building), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class WindowClosedBuilding(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e3', (39, 8), ((39.582, 8), (39.736, 8.672), (40, 9)))
        ...
        self.add_bezier('sym-e14', (8, 9), ((8.264, 8.672), (8.418, 8), (9, 8)))
