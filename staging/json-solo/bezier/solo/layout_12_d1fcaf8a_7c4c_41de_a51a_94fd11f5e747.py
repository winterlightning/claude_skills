"""Layout 12 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Layout12InterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e13', (42, 40), ((42, 41.293), (40.982, 41.607), (40, 42)))
        self.add_bezier('e14', (8, 42), ((6.912, 42), (6, 41.08), (6, 40)))
        self.add_bezier('e15', (6, 8), ((6.008, 7.959), (6.008, 8.381), (6.016, 8.34)), ((6.016, 7.088), (7.059, 6.36), (8, 6)))
        self.add_bezier('e16', (42, 8), ((42, 6.74), (40.965, 6.401), (40, 6)))
