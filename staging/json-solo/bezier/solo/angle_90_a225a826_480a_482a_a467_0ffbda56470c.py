"""Angle 90 (_uncategorized_03), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'a225a826-480a-482a-a467-0ffbda56470c'
SOURCE_PATH = 'icons-json/_uncategorized_03/angle 90_a225a826-480a-482a-a467-0ffbda56470c.json'
AUTHOR = 'json_to_solo'

class Angle90Uncategorized03(Solo48):
    icon_id = 'angle-90-uncategorized-03'
