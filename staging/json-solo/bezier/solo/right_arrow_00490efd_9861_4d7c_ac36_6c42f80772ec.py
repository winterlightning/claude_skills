"""Right arrow (transportation), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '00490efd-9861-4d7c-ac36-6c42f80772ec'
SOURCE_PATH = 'icons-json/transportation/right arrow_00490efd-9861-4d7c-ac36-6c42f80772ec.json'
AUTHOR = 'json_to_solo'

class RightArrowTransportation(Solo48):
    icon_id = 'right-arrow-transportation'
