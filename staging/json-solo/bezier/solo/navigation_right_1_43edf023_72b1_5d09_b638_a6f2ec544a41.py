"""Navigation right 1 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class NavigationRight1InterfaceEssential(Solo48):
    icon_id = 'navigation-right-1-interface-essential'
