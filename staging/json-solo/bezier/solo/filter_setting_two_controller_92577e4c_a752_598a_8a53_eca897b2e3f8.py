"""Filter setting two controller (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class FilterSettingTwoControllerInterfaceEssential(Solo48):
    icon_id = 'filter-setting-two-controller-interface-essential'
