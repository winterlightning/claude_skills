"""Graph lines (business), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class GraphLinesBusiness(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e8', (4, 37), ((4, 37.278), (4, 36.722), (4, 37)))
