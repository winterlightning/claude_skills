"""Shopping cart empty (shopping), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class ShoppingCartEmptyShopping(Solo48):
    icon_id = 'shopping-cart-empty-shopping'
    ...
    def build(self):
        ...
        self.add_bezier('e5', (35, 31), ((35.827, 30.832), (36.364, 30.497), (37, 30)))
        self.add_bezier('e6', (40, 10), ((40.2, 8.863), (40.182, 8.775), (41, 8)))
