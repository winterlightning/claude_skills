"""Arrows maximize (_uncategorized_04), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '7e87f104-8fcb-4d6d-a74a-85d7b8aa530f'
SOURCE_PATH = 'icons-json/_uncategorized_04/arrows maximize_7e87f104-8fcb-4d6d-a74a-85d7b8aa530f.json'
AUTHOR = 'json_to_solo'

class ArrowsMaximizeUncategorized04(Solo48):
    icon_id = 'arrows-maximize-uncategorized-04'
