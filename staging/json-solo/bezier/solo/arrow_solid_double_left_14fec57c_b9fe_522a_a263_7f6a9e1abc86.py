"""Arrow solid double left (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class ArrowSolidDoubleLeftArrows(Solo48):
    icon_id = 'arrow-solid-double-left-arrows'
