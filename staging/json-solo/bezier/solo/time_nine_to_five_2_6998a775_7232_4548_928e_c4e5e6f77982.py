"""Time nine to five 2 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class TimeNineToFive2InterfaceEssential(Solo48):
    icon_id = 'time-nine-to-five-2-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('e3', (24, 23), ((24.309, 23.309), (24.691, 23.691), (25, 24)))
