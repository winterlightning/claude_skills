"""Arrows retweet (_uncategorized_04), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ArrowsRetweetUncategorized04(Solo48):
    icon_id = 'arrows-retweet-uncategorized-04'
    ...
    def build(self):
        ...
        self.add_bezier('e8', (6, 16), ((6, 14.585), (7.593, 13), (9, 13)))
        self.add_bezier('e9', (42, 33), ((42, 34.432), (39.35, 36), (38, 36)))
