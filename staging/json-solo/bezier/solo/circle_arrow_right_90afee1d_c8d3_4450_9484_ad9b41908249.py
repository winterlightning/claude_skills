"""Circle arrow right (state), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class CircleArrowRightState(Solo48):
    icon_id = 'circle-arrow-right-state'
