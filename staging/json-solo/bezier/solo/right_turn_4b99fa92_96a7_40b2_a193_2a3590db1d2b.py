"""Right turn (transportation), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class RightTurn4b99fa92(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e5', (18, 24), ((18.182, 23.509), (17.945, 23.055), (18.264, 22.618)), ((19.045, 21.536), (20.618, 20), (22, 20)))
