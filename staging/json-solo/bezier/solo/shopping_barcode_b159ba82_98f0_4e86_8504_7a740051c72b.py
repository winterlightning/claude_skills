"""Shopping barcode (products), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class ShoppingBarcodeProducts(Solo48):
    icon_id = 'shopping-barcode-products'
