"""Time clock three to six (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class TimeClockThreeToSix572d7dbc(Solo48):
    icon_id = 'time-clock-three-to-six-572d7dbc'
