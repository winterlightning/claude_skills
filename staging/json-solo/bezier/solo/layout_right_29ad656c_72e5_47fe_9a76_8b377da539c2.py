"""Layout right (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class LayoutRightInterfaceEssential(Solo48):
    icon_id = 'layout-right-interface-essential'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e2', (39, 42), ((40.415, 42), (42, 40.465), (42, 39)))
        self.add_bezier('sym-e3', (42, 39), ((42, 38.935), (41.992, 39.065), (42, 39)))
        self.add_line('sym-e4', (42, 39), (42, 24))
        self.add_line('sym-e5', (42, 24), (42, 9))
        self.add_bezier('sym-e6', (42, 9), ((41.992, 8.935), (42, 9.065), (42, 9)))
        self.add_bezier('sym-e7', (42, 9), ((42, 7.535), (40.415, 6), (39, 6)))
        self.add_line('sym-e8', (39, 6), (30, 6))
        self.add_line('sym-e9', (30, 6), (9, 6))
        self.add_bezier('sym-e10', (9, 6), ((7.846, 6), (6, 7.83), (6, 9)))
        self.add_line('sym-e11', (6, 9), (6, 24))
        self.add_line('sym-e12', (6, 24), (6, 39))
        self.add_bezier('sym-e13', (6, 39), ((6, 40.17), (7.846, 42), (9, 42)))
