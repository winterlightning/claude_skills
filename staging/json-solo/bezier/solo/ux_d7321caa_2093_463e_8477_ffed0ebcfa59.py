"""Ux (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'd7321caa-2093-463e-8477-ffed0ebcfa59'
SOURCE_PATH = 'icons-json/symbol/ux_d7321caa-2093-463e-8477-ffed0ebcfa59.json'
AUTHOR = 'json_to_solo'

class UxSymbol(Solo48):
    icon_id = 'ux-symbol'
