"""Bad (smileys), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class BadSmileys(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e3', (17, 33), ((20.664, 27.218), (27.355, 27.173), (31, 33)))
