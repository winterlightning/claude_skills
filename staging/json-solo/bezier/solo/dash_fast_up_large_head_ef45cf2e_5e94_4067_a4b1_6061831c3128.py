"""Dash fast up large head (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class DashFastUpLargeHeadArrows(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e5', (24, 39), ((34.518, 35.566), (37.209, 22.96), (39, 10)))
