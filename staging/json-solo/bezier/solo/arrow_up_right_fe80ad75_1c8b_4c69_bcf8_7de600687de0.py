"""Arrow up right (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ArrowUpRightFe80ad75(Solo48):
    icon_id = 'arrow-up-right-fe80ad75'
