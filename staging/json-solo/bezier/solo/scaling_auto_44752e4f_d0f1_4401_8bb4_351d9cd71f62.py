"""Scaling auto (programing), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ScalingAutoPrograming(Solo48):
    icon_id = 'scaling-auto-programing'
    ...
    def build(self):
        ...
        self.add_bezier('e16', (17, 28), ((17.712, 29.145), (18.683, 29.771), (20, 30)))
        self.add_bezier('e17', (28, 30), ((29.317, 29.771), (30.288, 29.137), (31, 28)))
        self.add_bezier('e18', (31, 20), ((30.403, 18.945), (29.309, 18), (28, 18)))
        self.add_bezier('e19', (19, 18), ((18.313, 18.303), (17, 19.084), (17, 20)))
