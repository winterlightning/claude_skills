"""Design file text (tools), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class DesignFileTextTools(Solo48):
    icon_id = 'design-file-text-tools'
