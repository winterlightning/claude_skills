"""Border all (_uncategorized), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'b3130eb4-ba01-4cc2-8254-369e3a650d77'
SOURCE_PATH = 'icons-json/_uncategorized_07/border all_b3130eb4-ba01-4cc2-8254-369e3a650d77.json'
AUTHOR = 'json_to_solo'

class BorderAllUncategorized(Solo48):
    icon_id = 'border-all-uncategorized'
