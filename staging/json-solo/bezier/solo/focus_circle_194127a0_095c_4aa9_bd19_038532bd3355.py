"""Focus circle (symbol), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '194127a0-095c-4aa9-bd19-038532bd3355'
SOURCE_PATH = 'icons-json/symbol/focus circle_194127a0-095c-4aa9-bd19-038532bd3355.json'
AUTHOR = 'json_to_solo'

class FocusCircleSymbol(Solo48):
    icon_id = 'focus-circle-symbol'
