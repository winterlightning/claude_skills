"""Snowflake (holidays), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class Snowflake34931aa4(Solo48):
    icon_id = 'snowflake-34931aa4'
    ...
    def build(self):
        ...
        self.add_bezier('e19', (19, 31), ((20.571, 29.953), (22.151, 28.336), (23.746, 27.33)), ((26.716, 25.456), (29.825, 23.497), (33, 22)))
