"""Pie (food), converted from the icons-json construction graph by json_to_solo --mode bezier. CIRCLE keyshape; curves kept as cubic beziers."""
...
class PieC499c017(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e3', (26, 25), ((25.364, 24.364), (24.545, 23.7), (24, 23)))
