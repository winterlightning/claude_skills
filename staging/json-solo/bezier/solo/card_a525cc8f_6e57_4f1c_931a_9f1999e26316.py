...
class Card(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e8', (39, 40), ((39.3, 40), (40.064, 39.988), (40.364, 39.988)), ((42.009, 39.988), (43.982, 37.649), (43.982, 35.36)), ((43.991, 35.262), (43.991, 35.098), (44, 35)))
        ...
        self.add_bezier('e10', (8, 8), ((7.855, 8), (7.345, 8.012), (7.2, 8.012)), ((5.627, 8.012), (4.009, 9.969), (4.009, 12.123)), ((4, 12.209), (4, 12.295), (4, 12.394)), ((4, 12.566), (4, 12.828), (4, 13)))
