"""Graph (finance), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class Graph5552619f(Solo48):
    icon_id = 'graph-5552619f'
    ...
    def build(self):
        ...
        self.add_bezier('e4', (11, 40), ((10.391, 40), (9.609, 40), (9, 40)))
