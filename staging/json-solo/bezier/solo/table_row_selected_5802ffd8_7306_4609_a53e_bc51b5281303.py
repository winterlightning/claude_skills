"""Table row selected (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class TableRowSelectedInterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e3', (44, 37), ((43.927, 37.177), (44, 37.823), (44, 38)))
        self.add_bezier('sym-e4', (44, 38), ((43.609, 38.859), (42.091, 40), (41, 40)))
        ...
        self.add_bezier('sym-e9', (7, 8), ((5.909, 8), (4.391, 9.141), (4, 10)))
        self.add_bezier('sym-e10', (4, 10), ((4, 10.177), (4.073, 10.823), (4, 11)))
        self.add_line('sym-e11', (4, 11), (4, 24))
        self.add_line('sym-e12', (4, 24), (4, 37))
        self.add_bezier('sym-e13', (4, 37), ((4.073, 37.177), (4, 37.823), (4, 38)))
        self.add_bezier('sym-e14', (4, 38), ((4.391, 38.859), (5.909, 40), (7, 40)))
        self.add_line('sym-e15', (7, 40), (24, 40))
        self.add_line('sym-e16', (44, 24), (44, 11))
        self.add_bezier('sym-e17', (44, 11), ((43.927, 10.823), (44, 10.177), (44, 10)))
        self.add_bezier('sym-e18', (44, 10), ((43.609, 9.141), (42.091, 8), (41, 8)))
