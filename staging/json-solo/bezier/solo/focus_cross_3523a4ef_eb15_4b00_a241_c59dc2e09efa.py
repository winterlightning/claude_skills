"""Focus cross (photography), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class FocusCrossPhotography(Solo48):
    icon_id = 'focus-cross-photography'
    ...
    def build(self):
        ...
        self.add_bezier('sym-e5', (40, 42), ((41.145, 41.485), (41.485, 41.186), (42, 40)))
        self.add_line('sym-e6', (42, 40), (42, 35))
        self.add_line('sym-e7', (13, 42), (8, 42))
        self.add_bezier('sym-e8', (8, 42), ((6.855, 41.485), (6.515, 41.186), (6, 40)))
        self.add_line('sym-e9', (6, 40), (6, 35))
        self.add_line('sym-e10', (35, 6), (40, 6))
        self.add_bezier('sym-e11', (40, 6), ((41.145, 6.515), (41.485, 6.814), (42, 8)))
        self.add_line('sym-e12', (42, 8), (42, 13))
        self.add_line('sym-e13', (13, 6), (8, 6))
        self.add_bezier('sym-e14', (8, 6), ((6.855, 6.515), (6.515, 6.814), (6, 8)))
