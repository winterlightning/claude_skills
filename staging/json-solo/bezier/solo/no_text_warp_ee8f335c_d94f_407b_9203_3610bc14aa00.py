"""No text warp (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'ee8f335c-d94f-407b-9203-3610bc14aa00'
SOURCE_PATH = 'icons-json/interface-essential/no text warp_ee8f335c-d94f-407b-9203-3610bc14aa00.json'
AUTHOR = 'json_to_solo'

class NoTextWarpInterfaceEssential(Solo48):
    icon_id = 'no-text-warp-interface-essential'
