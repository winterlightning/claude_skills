"""Module (design), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class ModuleDesign(Solo48):
    icon_id = 'module-design'
    ...
    def build(self):
        ...
        self.add_bezier('e9', (24, 6), ((23.73, 6), (23.27, 6), (23, 6)))
