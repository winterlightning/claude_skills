"""Increase indent (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class IncreaseIndentInterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('sym-e2', (16, 24), ((16, 24.395), (15.182, 24.653), (15, 25)))
        self.add_bezier('sym-e3', (15, 25), ((14.6, 25.74), (13.655, 27.41), (13, 28)))
        self.add_bezier('sym-e4', (13, 28), ((10.2, 30.49), (6.909, 32.68), (4, 35)))
        self.add_line('sym-e5', (4, 35), (4, 24))
        self.add_line('sym-e6', (4, 24), (4, 13))
        self.add_bezier('sym-e7', (4, 13), ((6.909, 15.32), (10.2, 17.51), (13, 20)))
        self.add_bezier('sym-e8', (13, 20), ((13.655, 20.59), (14.6, 22.26), (15, 23)))
        self.add_bezier('sym-e9', (15, 23), ((15.182, 23.347), (16, 23.605), (16, 24)))
