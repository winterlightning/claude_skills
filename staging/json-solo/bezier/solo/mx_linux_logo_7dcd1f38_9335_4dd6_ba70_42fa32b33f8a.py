"""Mx linux logo (logos), converted from the icons-json construction graph by json_to_solo --mode bezier. HRECT_L keyshape; curves kept as cubic beziers."""
...
class MxLinuxLogoLogos(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e10', (19, 25), ((18.7, 25.33), (19.3, 25.67), (19, 26)))
