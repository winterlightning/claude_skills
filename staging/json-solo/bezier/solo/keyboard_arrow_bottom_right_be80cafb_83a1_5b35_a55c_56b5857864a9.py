"""Keyboard arrow bottom right (interface-essential), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class KeyboardArrowBottomRightInterfaceEssential(Solo48):
    icon_id = 'keyboard-arrow-bottom-right-interface-essential'
