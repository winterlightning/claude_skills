"""Rate (diagrams), converted from the icons-json construction graph by json_to_solo --mode bezier. SQUARE keyshape; curves kept as cubic beziers."""
...
class RateDiagrams(Solo48):
    icon_id = 'rate-diagrams'
    ...
    def build(self):
        ...
        self.add_bezier('e7', (23, 6), ((23.27, 6), (23.73, 6), (24, 6)))
