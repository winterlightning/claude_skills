"""Arrow solid double top (arrows), converted from the icons-json construction graph by json_to_solo --mode bezier. VRECT_L keyshape; curves kept as cubic beziers."""
...
class ArrowSolidDoubleTopArrows(Solo48):
    icon_id = 'arrow-solid-double-top-arrows'
