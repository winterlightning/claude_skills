"""Batch-03/hat (accessories), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class Batch03Hat(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e6', (13, 9), (14, 8), radius_x=1)
        self.add_line('sym-e8', (14, 8), (24, 12))
        self.add_line('sym-e9', (24, 12), (34, 8))
        self.add_arc('sym-e11', (34, 8), (35, 9), radius_x=1)
        ...
        self.add_contour('sym-c2', 'sym-e5', 'sym-e6', 'sym-e8', 'sym-e9', 'sym-e11', 'sym-e12')
