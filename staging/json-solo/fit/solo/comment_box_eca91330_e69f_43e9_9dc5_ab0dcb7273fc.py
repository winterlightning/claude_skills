...
class CommentBoxEca91330(Solo48):
    icon_id = 'comment-box-eca91330'
    ...
    def build(self):
        ...
        self.add_arc('e7', (39, 33), (44, 30), radius_x=4, sweep=False)
        self.add_arc('e8-1', (44, 12), (40, 8), radius_x=4, sweep=False)
        self.add_line('e8-2', (40, 8), (38, 8))
        self.add_line('e9-1', (8, 8), (5, 9))
        self.add_line('e9-2', (5, 9), (4, 13))
        self.add_arc('e10', (4, 29), (8, 33), radius_x=4, sweep=False)
        self.add_contour('c0', 'e0', 'e1', 'e7', 'e2', 'e8-1', 'e8-2', 'e3', 'e9-1', 'e9-2', 'e4', 'e10', 'e5', 'e6', closed=True)
