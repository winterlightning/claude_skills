...
class IndiferentSmileys(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e3-2', (28, 5), (43, 19), radius_x=20)
        self.add_arc('sym-e4-1', (43, 19), (43, 20), radius_x=26, sweep=False)
        self.add_arc('sym-e4-2', (43, 20), (43, 21), radius_x=19, sweep=False)
        self.add_line('sym-e4-3', (43, 21), (43, 22))
        self.add_line('sym-e4-4', (43, 22), (43, 23))
        self.add_arc('sym-e5', (43, 23), (44, 24), radius_x=23, sweep=False)
        self.add_line('sym-e6', (44, 24), (43, 25))
        self.add_line('sym-e7-1', (43, 25), (43, 27))
        self.add_arc('sym-e7-2', (43, 27), (43, 29), radius_x=16)
        self.add_arc('sym-e7-3', (43, 29), (24, 44), radius_x=20)
        self.add_arc('sym-e10-1', (24, 44), (5, 29), radius_x=20)
        self.add_arc('sym-e10-2', (5, 29), (5, 27), radius_x=17)
        self.add_line('sym-e10-3', (5, 27), (5, 25))
        self.add_arc('sym-e11', (5, 25), (4, 24), radius_x=13, sweep=False)
        self.add_arc('sym-e12', (4, 24), (5, 23), radius_x=22, sweep=False)
        self.add_line('sym-e13-1', (5, 23), (5, 22))
        self.add_arc('sym-e13-2', (5, 22), (5, 21), radius_x=12)
        self.add_arc('sym-e13-3', (5, 21), (5, 20), radius_x=18)
        self.add_arc('sym-e13-4', (5, 20), (5, 19), radius_x=27)
        self.add_arc('sym-e14-1', (5, 19), (20, 5), radius_x=20)
