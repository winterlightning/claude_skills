...
class RtfFormatState(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e14-1', (36, 44), (40, 40), radius_x=4, sweep=False)
        self.add_line('e14-2', (40, 40), (40, 39))
        self.add_arc('e15', (20, 34), (18, 32), radius_x=2)
        self.add_arc('e16', (18, 16), (20, 14), radius_x=2)
        self.add_arc('e17', (28, 14), (30, 16), radius_x=2)
        self.add_arc('e18', (30, 32), (28, 34), radius_x=2)
        self.add_contour('c0', 'e0', 'e1', 'e2', 'e3', 'e12-1', 'e12-2', 'e4', 'e13-1', 'e13-2', 'e5', 'e14-1', 'e14-2', 'e6')
