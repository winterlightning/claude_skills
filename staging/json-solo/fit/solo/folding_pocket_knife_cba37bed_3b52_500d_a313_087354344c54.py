...
class FoldingPocketKnife(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e4-4', (40, 39), (31, 42), radius_x=15)
        self.add_arc('e5-1', (11, 42), (6, 37), radius_x=5)
        self.add_arc('e5-2', (6, 37), (7, 34), radius_x=5)
        self.add_arc('e5-3', (7, 34), (10, 31), radius_x=5)
        self.add_line('e6', (27, 31), (31, 30))
        self.add_arc('e7', (33, 29), (38, 27), radius_x=7)
        self.add_line('e8-1', (38, 27), (21, 12))
        self.add_arc('e8-2', (21, 12), (11, 6), radius_x=71, sweep=False)
        self.add_arc('e8-3', (11, 6), (17, 20), radius_x=19, sweep=False)
        self.add_contour('c0', 'e4-1', 'e4-2', 'e4-3', 'e4-4', 'e0', 'e5-1', 'e5-2', 'e5-3', 'e1', 'e6', 'e2', 'e7')
