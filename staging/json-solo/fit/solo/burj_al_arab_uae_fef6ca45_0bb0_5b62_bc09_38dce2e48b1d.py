"""Batch-02/burj al arab uae (landmarks), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class Batch02BurjAlArabUae(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e3', (34, 44), (13, 9), radius_x=37, sweep=False)
