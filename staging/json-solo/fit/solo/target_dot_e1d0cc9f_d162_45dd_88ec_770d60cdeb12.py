"""Target dot (state), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'e1d0cc9f-d162-45dd-88ec-770d60cdeb12'
SOURCE_PATH = 'icons-json/state/target dot_e1d0cc9f-d162-45dd-88ec-770d60cdeb12.json'
AUTHOR = 'json_to_solo'

class TargetDotState(Solo48):
    icon_id = 'target-dot-state'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'state'
    aliases = ()
    keywords = ('target', 'dot', 'state')
