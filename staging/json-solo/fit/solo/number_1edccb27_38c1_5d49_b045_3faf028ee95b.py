...
class NumberInterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e5-1', (8, 30), (15, 27), radius_x=5)
        self.add_arc('e5-2', (15, 27), (17, 33), radius_x=4)
        self.add_arc('e5-3', (17, 33), (10, 40), radius_x=35)
        self.add_arc('e5-4', (10, 40), (8, 44), radius_x=8, sweep=False)
        self.add_arc('e6-1', (30, 29), (37, 27), radius_x=5)
        self.add_arc('e6-2', (37, 27), (40, 31), radius_x=5)
        self.add_arc('e6-3', (40, 31), (37, 35), radius_x=5)
        self.add_arc('e7-1', (37, 35), (40, 38), radius_x=6)
        self.add_line('e7-2', (40, 38), (40, 40))
        self.add_arc('e7-3', (40, 40), (36, 44), radius_x=4)
        self.add_arc('e7-4', (36, 44), (30, 40), radius_x=7)
        self.add_contour('c0', 'e5-1', 'e5-2', 'e5-3', 'e5-4', 'e0')
        self.add_contour('c1', 'e6-1', 'e6-2', 'e6-3')
        self.add_contour('c2', 'e7-1', 'e7-2', 'e7-3', 'e7-4')
