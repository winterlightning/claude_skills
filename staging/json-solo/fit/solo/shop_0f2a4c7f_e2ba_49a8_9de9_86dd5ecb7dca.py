...
SOURCE_PATH = 'icons-json/shopping/shop_0f2a4c7f-e2ba-49a8-9de9-86dd5ecb7dca.json'
AUTHOR = 'json_to_solo'

class Shop0f2a4c7f(Solo48):
    icon_id = 'shop-0f2a4c7f'
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (41, 22), (36, 22), radius_x=5)
        self.add_line('sym-e3', (36, 22), (34, 20))
        self.add_arc('sym-e4', (34, 20), (32, 22), radius_x=23, sweep=False)
        self.add_arc('sym-e5', (32, 22), (26, 22), radius_x=5)
        self.add_line('sym-e6', (26, 22), (24, 20))
        self.add_line('sym-e7', (24, 20), (22, 22))
        self.add_arc('sym-e8', (22, 22), (16, 22), radius_x=5)
        self.add_arc('sym-e9', (16, 22), (14, 20), radius_x=24)
        self.add_arc('sym-e10', (14, 20), (12, 22), radius_x=17)
        self.add_arc('sym-e11', (12, 22), (7, 22), radius_x=5)
        self.add_line('sym-e12', (7, 22), (7, 40))
        self.add_line('sym-e13', (7, 40), (24, 40))
        self.add_arc('sym-e14', (41, 22), (44, 18), radius_x=5, sweep=False)
        ...
        self.add_arc('sym-e22', (5, 15), (4, 18), radius_x=10, sweep=False)
        self.add_arc('sym-e25', (4, 18), (7, 22), radius_x=5, sweep=False)
        ...
        self.add_contour('sym-c1', 'sym-e14', 'sym-e17', 'sym-e18', 'sym-e19', 'sym-e20', 'sym-e21', 'sym-e22', 'sym-e25')
