"""Batch-04/cd (computers), converted from the icons-json construction graph by json_to_solo --mode fit. CIRCLE keyshape; curves fitted to integer lines and arcs."""
...
class Batch04Cd(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e2', (29, 12), (38, 23), radius_x=12)
        self.add_arc('e3', (10, 24), (19, 36), radius_x=12, sweep=False)
