"""Ga (text u) (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class GaTextUSymbol(Solo48):
    icon_id = 'ga-text-u-symbol'
    ...
    def build(self):
        ...
        self.add_arc('e5-2', (33, 26), (29, 20), radius_x=6)
        self.add_arc('e5-3', (29, 20), (35, 12), radius_x=8)
        self.add_arc('e5-4', (35, 12), (40, 17), radius_x=5)
