...
class GasUncategorized(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (40, 30), (40, 29), radius_x=30)
        self.add_arc('sym-e3', (40, 29), (40, 28), radius_x=30)
        self.add_arc('sym-e4', (40, 28), (29, 9), radius_x=33, sweep=False)
        self.add_line('sym-e5', (29, 9), (25, 5))
        self.add_arc('sym-e6', (25, 5), (24, 4), radius_x=11, sweep=False)
        self.add_line('sym-e7', (24, 4), (23, 5))
        self.add_line('sym-e8', (23, 5), (19, 9))
        self.add_arc('sym-e9', (19, 9), (8, 28), radius_x=33, sweep=False)
        self.add_line('sym-e10', (8, 28), (8, 29))
        self.add_line('sym-e11', (8, 29), (8, 30))
        self.add_arc('sym-e12', (8, 30), (23, 44), radius_x=16, sweep=False)
