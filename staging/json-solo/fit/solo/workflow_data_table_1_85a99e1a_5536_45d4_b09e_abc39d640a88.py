...
SOURCE_PATH = 'icons-json/business/workflow data table 1_85a99e1a-5536-45d4-b09e-abc39d640a88.json'
AUTHOR = 'json_to_solo'

class WorkflowDataTable185a99e1a(Solo48):
    icon_id = 'workflow-data-table-1-85a99e1a'
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (6, 39), (8, 42), radius_x=4, sweep=False)
        ...
        self.add_arc('sym-e10', (42, 39), (40, 42), radius_x=4)
        ...
        self.add_arc('sym-e18', (9, 6), (6, 9), radius_x=4, sweep=False)
        self.add_line('sym-e19', (6, 9), (6, 14))
        self.add_line('sym-e20', (24, 42), (30, 42))
        self.add_line('sym-e21', (24, 6), (39, 6))
        self.add_arc('sym-e22', (39, 6), (42, 9), radius_x=4)
        self.add_line('sym-e23', (42, 9), (42, 14))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e12', 'sym-e13')
