"""6 (typeface), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '18a47161-8a3e-4ed7-a669-036a89f553a3'
SOURCE_PATH = 'icons-json/typeface/6_18a47161-8a3e-4ed7-a669-036a89f553a3.json'
AUTHOR = 'json_to_solo'

class Icon618a47161(Solo48):
    icon_id = 'icon-6-18a47161'
