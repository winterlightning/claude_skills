...
class LayersBackDesign(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e11', (42, 41), (41, 42), radius_x=1)
        self.add_arc('e12', (16, 42), (15, 41), radius_x=1)
        self.add_arc('e13', (33, 32), (32, 33), radius_x=1)
        self.add_arc('e14', (33, 7), (32, 6), radius_x=1, sweep=False)
        self.add_line('e15', (6, 6), (6, 7))
        self.add_arc('e16', (6, 32), (7, 33), radius_x=1, sweep=False)
