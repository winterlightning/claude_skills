...
class Unlock1Symbol(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e5-1', (35, 15), (24, 4), radius_x=11, sweep=False)
        self.add_line('e5-2', (24, 4), (19, 5))
        self.add_arc('e5-3', (19, 5), (16, 7), radius_x=11, sweep=False)
        self.add_arc('e5-4', (16, 7), (13, 14), radius_x=9, sweep=False)
        self.add_line('e6-1', (40, 39), (39, 42))
        self.add_line('e6-2', (39, 42), (33, 44))
        self.add_line('e7-1', (14, 44), (9, 42))
        self.add_line('e7-2', (9, 42), (8, 39))
        self.add_line('e7-3', (8, 39), (8, 38))
        self.add_contour('c0', 'e5-1', 'e5-2', 'e5-3', 'e5-4', 'e0')
        self.add_contour('c1', 'e6-1', 'e6-2', 'e1', 'e7-1', 'e7-2', 'e7-3', 'e2', 'e3', 'e4', closed=True)
