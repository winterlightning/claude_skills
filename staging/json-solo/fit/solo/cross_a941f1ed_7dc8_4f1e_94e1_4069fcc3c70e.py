...
class Cross(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e11', (31, 17), (30, 6), radius_x=15, sweep=False)
        self.add_arc('e12', (19, 6), (17, 8), radius_x=2, sweep=False)
        self.add_line('e13', (7, 17), (6, 19))
        self.add_line('e14', (6, 28), (8, 31))
        self.add_arc('e15', (17, 40), (19, 42), radius_x=2, sweep=False)
        self.add_line('e16', (28, 42), (31, 41))
        self.add_line('e17', (40, 31), (42, 29))
        self.add_line('e18-1', (42, 21), (42, 19))
        self.add_arc('e18-2', (42, 19), (40, 17), radius_x=3)
        self.add_contour('c0', 'e11', 'e0', 'e12', 'e1', 'e2', 'e13', 'e3', 'e14', 'e4', 'e5', 'e15', 'e6', 'e16', 'e7', 'e8', 'e17', 'e9', 'e18-1', 'e18-2', 'e10', closed=True)
