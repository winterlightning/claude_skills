"""Batch-06/shanty house (landmarks), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class Batch06ShantyHouse(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e4', (10, 40), (8, 37), radius_x=4)
        ...
        self.add_arc('sym-e9', (40, 37), (38, 40), radius_x=3)
