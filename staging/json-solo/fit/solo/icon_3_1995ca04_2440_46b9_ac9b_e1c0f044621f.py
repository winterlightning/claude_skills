"""3 (typeface), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '1995ca04-2440-46b9-ac9b-e1c0f044621f'
SOURCE_PATH = 'icons-json/typeface/3_1995ca04-2440-46b9-ac9b-e1c0f044621f.json'
AUTHOR = 'json_to_solo'

class Icon31995ca04(Solo48):
    icon_id = 'icon-3-1995ca04'
