"""0 (typeface), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'f61c90a0-6368-4e53-b27b-c3ce98ffe7d0'
SOURCE_PATH = 'icons-json/typeface/0_f61c90a0-6368-4e53-b27b-c3ce98ffe7d0.json'
AUTHOR = 'json_to_solo'

class Icon0Typeface(Solo48):
    icon_id = 'icon-0-typeface'
