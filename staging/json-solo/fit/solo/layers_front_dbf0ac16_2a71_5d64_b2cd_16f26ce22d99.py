...
class LayersFrontDesign(Solo48):
    ...
    def build(self):
        ...
        self.add_line('e8-2', (30, 6), (26, 6))
        self.add_arc('e9', (8, 6), (6, 8), radius_x=2, sweep=False)
        self.add_arc('e10', (6, 31), (7, 32), radius_x=2)
        self.add_arc('e11', (36, 16), (42, 17), radius_x=4)
        self.add_arc('e12', (42, 40), (40, 42), radius_x=2)
        self.add_line('e13', (17, 42), (16, 41))
        self.add_arc('e14', (16, 17), (20, 16), radius_x=3)
        self.add_contour('c0', 'e0', 'e8-1', 'e8-2', 'e1', 'e9', 'e2', 'e10', 'e3')
