"""Batch-07/cap (accessories), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'ac0c8839-9020-4a65-9a30-af5a45d63503'
SOURCE_PATH = 'icons-json/accessories/batch-07/cap_ac0c8839-9020-4a65-9a30-af5a45d63503.json'
AUTHOR = 'json_to_solo'

class Batch07Cap(Solo48):
    icon_id = 'batch-07-cap'
