"""Messages bubble with dots (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'a1a51949-b13a-41fa-81ae-78731ae3349e'
SOURCE_PATH = 'icons-json/symbol/messages bubble with dots_a1a51949-b13a-41fa-81ae-78731ae3349e.json'
AUTHOR = 'json_to_solo'

class MessagesBubbleWithDotsSymbol(Solo48):
    icon_id = 'messages-bubble-with-dots-symbol'
