...
class PhoneCallSplitPhones(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e1', (24, 37), (22, 29), radius_x=29, sweep=False)
        self.add_arc('sym-e2', (22, 29), (13, 13), radius_x=42, sweep=False)
        self.add_arc('sym-e3', (13, 13), (11, 10), radius_x=24, sweep=False)
        self.add_line('sym-e4', (11, 10), (6, 6))
        self.add_line('sym-e5', (6, 6), (6, 17))
        self.add_line('sym-e6', (24, 35), (24, 31))
        self.add_line('sym-e7', (6, 6), (16, 6))
        self.add_arc('sym-e8', (24, 37), (26, 29), radius_x=28)
        self.add_arc('sym-e9', (26, 29), (35, 13), radius_x=42)
        self.add_arc('sym-e10', (35, 13), (37, 10), radius_x=25)
