...
class TagsInterfaceEssential(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e3', (8, 40), (12, 44), radius_x=4, sweep=False)
        self.add_line('sym-e4', (12, 44), (13, 44))
        self.add_arc('sym-e5', (13, 44), (14, 44), radius_x=24)
        self.add_arc('sym-e6-1', (14, 44), (15, 44), radius_x=24)
        self.add_arc('sym-e6-2', (15, 44), (16, 44), radius_x=24)
        self.add_line('sym-e7', (16, 44), (24, 44))
        self.add_line('sym-e8', (24, 44), (32, 44))
        self.add_arc('sym-e9-1', (32, 44), (33, 44), radius_x=33)
        self.add_arc('sym-e9-2', (33, 44), (34, 44), radius_x=34)
        self.add_arc('sym-e10', (34, 44), (35, 44), radius_x=36)
        self.add_line('sym-e11', (35, 44), (36, 44))
        self.add_arc('sym-e12', (36, 44), (40, 40), radius_x=4, sweep=False)
        self.add_arc('sym-e13', (40, 40), (40, 39), radius_x=39)
        self.add_line('sym-e14', (40, 39), (40, 19))
        self.add_line('sym-e15', (40, 19), (40, 18))
        self.add_arc('sym-e17', (40, 18), (38, 15), radius_x=4, sweep=False)
        self.add_line('sym-e18', (38, 15), (28, 6))
        self.add_arc('sym-e19', (28, 6), (24, 4), radius_x=5, sweep=False)
        self.add_arc('sym-e22', (24, 4), (20, 6), radius_x=5, sweep=False)
        self.add_line('sym-e23', (20, 6), (10, 15))
        self.add_arc('sym-e24', (10, 15), (8, 18), radius_x=4, sweep=False)
