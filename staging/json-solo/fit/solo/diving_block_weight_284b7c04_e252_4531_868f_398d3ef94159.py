...
class DivingBlockWeightRecreation(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e6', (24, 44), (23, 44), radius_x=28, sweep=False)
        ...
        self.add_arc('sym-e14', (30, 5), (40, 17), radius_x=16)
        self.add_line('sym-e15', (40, 17), (40, 19))
        self.add_line('sym-e16', (40, 19), (40, 26))
        self.add_arc('sym-e17', (24, 4), (23, 4), radius_x=70)
        self.add_line('sym-e18', (23, 4), (18, 5))
        self.add_arc('sym-e19', (18, 5), (8, 17), radius_x=16, sweep=False)
        self.add_line('sym-e20', (8, 17), (8, 19))
