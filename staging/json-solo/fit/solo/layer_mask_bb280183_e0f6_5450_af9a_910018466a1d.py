...
class LayerMaskDesign(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (12, 6), (6, 11), radius_x=7, sweep=False)
        ...
        self.add_arc('sym-e11', (6, 37), (12, 42), radius_x=7, sweep=False)
        self.add_line('sym-e12', (12, 42), (24, 42))
        self.add_line('sym-e13', (24, 42), (36, 42))
        self.add_arc('sym-e14', (36, 42), (42, 37), radius_x=7, sweep=False)
        ...
        self.add_arc('sym-e23', (42, 11), (36, 6), radius_x=7, sweep=False)
