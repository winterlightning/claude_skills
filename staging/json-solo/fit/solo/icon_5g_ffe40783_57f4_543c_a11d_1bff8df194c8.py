"""5g (mobile), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'ffe40783-57f4-543c-a11d-1bff8df194c8'
SOURCE_PATH = 'icons-json/mobile/5g_ffe40783-57f4-543c-a11d-1bff8df194c8.json'
AUTHOR = 'json_to_solo'

class Icon5gMobile(Solo48):
    icon_id = 'icon-5g-mobile'
