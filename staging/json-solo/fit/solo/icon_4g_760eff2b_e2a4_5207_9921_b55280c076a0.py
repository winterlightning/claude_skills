"""4g (mobile), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '760eff2b-e2a4-5207-9921-b55280c076a0'
SOURCE_PATH = 'icons-json/mobile/4g_760eff2b-e2a4-5207-9921-b55280c076a0.json'
AUTHOR = 'json_to_solo'

class Icon4gMobile(Solo48):
    icon_id = 'icon-4g-mobile'
