"""Synchronize arrows search (interface-essential), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'df40480b-5166-4148-8ffb-4e38ec361c58'
SOURCE_PATH = 'icons-json/interface-essential/synchronize arrows search_df40480b-5166-4148-8ffb-4e38ec361c58.json'
AUTHOR = 'json_to_solo'

class SynchronizeArrowsSearchInterfaceEssential(Solo48):
    icon_id = 'synchronize-arrows-search-interface-essential'
