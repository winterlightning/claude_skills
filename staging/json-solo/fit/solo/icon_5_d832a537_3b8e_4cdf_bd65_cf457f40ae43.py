"""5 (typeface), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'd832a537-3b8e-4cdf-bd65-cf457f40ae43'
SOURCE_PATH = 'icons-json/typeface/5_d832a537-3b8e-4cdf-bd65-cf457f40ae43.json'
AUTHOR = 'json_to_solo'

class Icon5Typeface(Solo48):
    icon_id = 'icon-5-typeface'
