...
class Cog(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e10-1', (9, 35), (6, 31), radius_x=8)
        self.add_line('e10-2', (6, 31), (6, 30))
        self.add_arc('e11', (10, 26), (10, 21), radius_x=4, sweep=False)
        self.add_line('e12-1', (7, 17), (6, 16))
        self.add_line('e12-2', (6, 16), (10, 12))
        self.add_arc('e12-3', (10, 12), (20, 11), radius_x=7, sweep=False)
        self.add_arc('e13-1', (21, 8), (24, 6), radius_x=4)
        self.add_line('e13-2', (24, 6), (27, 7))
        self.add_arc('e13-3', (27, 7), (29, 12), radius_x=8, sweep=False)
        self.add_arc('e13-4', (29, 12), (33, 13), radius_x=6, sweep=False)
        self.add_arc('e14', (39, 13), (41, 17), radius_x=4)
        self.add_arc('e15', (38, 21), (39, 26), radius_x=5, sweep=False)
        self.add_arc('e16-1', (42, 30), (41, 33), radius_x=5)
        self.add_line('e16-2', (41, 33), (39, 35))
        self.add_arc('e17-1', (35, 34), (29, 36), radius_x=7, sweep=False)
        self.add_arc('e17-2', (29, 36), (26, 42), radius_x=6)
        self.add_line('e18-1', (22, 42), (19, 36))
        self.add_arc('e18-2', (19, 36), (14, 34), radius_x=9, sweep=False)
