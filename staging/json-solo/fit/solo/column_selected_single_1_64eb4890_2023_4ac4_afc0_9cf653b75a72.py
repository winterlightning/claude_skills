...
SOURCE_PATH = 'icons-json/state/column selected single 1_64eb4890-2023-4ac4-afc0-9cf653b75a72.json'
AUTHOR = 'json_to_solo'

class ColumnSelectedSingle164eb4890(Solo48):
    icon_id = 'column-selected-single-1-64eb4890'
