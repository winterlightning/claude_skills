...
class IwiwLogo1Logos(Solo48):
    ...
    def build(self):
        ...
        self.add_line('e21', (35, 31), (35, 29))
        self.add_line('e22', (13, 17), (12, 17))
        self.add_arc('e23', (7, 22), (6, 22), radius_x=1, sweep=False)
        self.add_arc('e24', (6, 29), (7, 31), radius_x=3, sweep=False)
        ...
        self.add_contour('c6', 'e11', 'e22', 'e12', 'e23', 'e13', 'e24', 'e14', 'e15')
