"""Hub (programing), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
...
class HubPrograming(Solo48):
    ...
    def build(self):
        ...
        self.add_line('e15-1', (22, 41), (24, 42))
        self.add_line('e15-2', (24, 42), (26, 41))
        self.add_line('e16', (39, 18), (37, 17))
        self.add_line('e17', (9, 18), (11, 17))
        self.add_arc('e18', (28, 28), (20, 28), radius_x=5)
        self.add_arc('e19', (28, 23), (24, 20), radius_x=13, sweep=False)
        self.add_contour('c0', 'e0')
        self.add_contour('c1', 'e1', 'e15-1', 'e15-2', 'e2')
