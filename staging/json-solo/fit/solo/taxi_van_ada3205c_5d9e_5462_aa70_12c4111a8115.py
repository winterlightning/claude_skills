...
class TaxiVanTransportation(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e11-1', (8, 34), (4, 32), radius_x=3)
        self.add_arc('e11-2', (4, 32), (4, 30), radius_x=13, sweep=False)
        self.add_line('e12-1', (4, 12), (5, 9))
        self.add_arc('e12-2', (5, 9), (7, 8), radius_x=3)
        self.add_arc('e12-3', (7, 8), (8, 8), radius_x=8, sweep=False)
        self.add_line('e13', (29, 8), (33, 10))
        self.add_arc('e14-1', (44, 24), (42, 20), radius_x=8, sweep=False)
        self.add_arc('e14-2', (42, 20), (38, 19), radius_x=4, sweep=False)
        self.add_contour('c0', 'e10-1', 'e10-2', 'e0', 'e1')
        self.add_contour('c1', 'e2')
        self.add_contour('c2', 'e11-1', 'e11-2', 'e3', 'e12-1', 'e12-2', 'e12-3', 'e4', 'e13', 'e5')
        self.add_contour('c3', 'e14-1', 'e14-2', 'e6')
