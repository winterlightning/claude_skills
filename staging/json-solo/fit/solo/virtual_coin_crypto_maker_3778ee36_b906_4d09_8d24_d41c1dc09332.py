"""Virtual coin crypto maker (finance), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class VirtualCoinCryptoMakerFinance(Solo48):
    icon_id = 'virtual-coin-crypto-maker-finance'
    ...
    def build(self):
        ...
        self.add_arc('sym-e1', (28, 23), (29, 20), radius_x=4)
        self.add_line('sym-e2', (29, 20), (44, 8))
        self.add_line('sym-e3', (44, 8), (44, 40))
        self.add_line('sym-e4', (20, 40), (20, 23))
        self.add_arc('sym-e5', (20, 23), (19, 20), radius_x=4, sweep=False)
