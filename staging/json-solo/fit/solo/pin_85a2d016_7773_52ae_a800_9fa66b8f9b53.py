...
class Pin85a2d016(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e3', (12, 28), (8, 18), radius_x=18)
        self.add_line('sym-e5', (8, 18), (8, 17))
        self.add_arc('sym-e6', (8, 17), (9, 14), radius_x=9)
        self.add_arc('sym-e7', (9, 14), (23, 4), radius_x=15)
        self.add_line('sym-e8', (23, 4), (24, 4))
        self.add_line('sym-e9', (24, 4), (25, 4))
        self.add_arc('sym-e10', (25, 4), (39, 14), radius_x=15)
        self.add_line('sym-e11', (39, 14), (40, 17))
        self.add_line('sym-e12', (40, 17), (40, 18))
        self.add_arc('sym-e14', (40, 18), (36, 28), radius_x=18)
        self.add_line('sym-e15', (36, 28), (24, 44))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', closed=True)
        self.add_contour('sym-c1', 'sym-e2', 'sym-e3', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e14', 'sym-e15', closed=True)
