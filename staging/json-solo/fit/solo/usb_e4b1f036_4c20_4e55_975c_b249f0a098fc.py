...
class UsbState(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e5', (10, 17), (8, 19), radius_x=2, sweep=False)
        self.add_line('sym-e6', (8, 19), (8, 38))
        self.add_arc('sym-e7', (8, 38), (16, 44), radius_x=9, sweep=False)
        self.add_arc('sym-e8', (16, 44), (17, 44), radius_x=26)
        self.add_line('sym-e9', (17, 44), (24, 44))
        self.add_line('sym-e10', (24, 44), (31, 44))
        self.add_arc('sym-e11', (31, 44), (32, 44), radius_x=33)
        self.add_arc('sym-e12', (32, 44), (40, 38), radius_x=9, sweep=False)
        self.add_line('sym-e13', (40, 38), (40, 19))
        self.add_arc('sym-e14', (40, 19), (38, 17), radius_x=2, sweep=False)
