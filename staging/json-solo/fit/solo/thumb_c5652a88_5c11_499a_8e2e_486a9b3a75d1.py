"""Thumb (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class ThumbC5652a88(Solo48):
    icon_id = 'thumb-c5652a88'
