...
class PlatesHotels(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e5', (18, 19), (15, 18), radius_x=6)
        self.add_arc('sym-e6', (15, 18), (9, 8), radius_x=13)
        self.add_line('sym-e7', (4, 29), (9, 29))
        self.add_arc('sym-e8', (9, 29), (10, 33), radius_x=22, sweep=False)
        self.add_arc('sym-e9', (10, 33), (17, 40), radius_x=10, sweep=False)
        self.add_line('sym-e10', (17, 40), (18, 40))
        self.add_line('sym-e11', (18, 40), (24, 40))
        self.add_line('sym-e12', (24, 40), (30, 40))
        self.add_line('sym-e13', (30, 40), (31, 40))
        self.add_arc('sym-e14', (31, 40), (38, 33), radius_x=10, sweep=False)
        self.add_arc('sym-e15', (38, 33), (39, 29), radius_x=21, sweep=False)
        self.add_line('sym-e16', (44, 8), (39, 8))
        self.add_arc('sym-e17', (39, 8), (33, 18), radius_x=13)
        self.add_arc('sym-e18', (33, 18), (30, 19), radius_x=6)
