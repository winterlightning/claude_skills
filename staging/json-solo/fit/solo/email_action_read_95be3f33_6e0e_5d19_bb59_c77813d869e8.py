...
class EmailActionReadEmails(Solo48):
    ...
    def build(self):
        self.add_arc('sym-e0', (44, 14), (44, 13), radius_x=1)
        self.add_arc('sym-e1', (44, 13), (39, 8), radius_x=5, sweep=False)
        self.add_line('sym-e2', (39, 8), (24, 8))
        self.add_line('sym-e3', (24, 8), (9, 8))
        self.add_arc('sym-e4', (9, 8), (4, 13), radius_x=5, sweep=False)
        self.add_line('sym-e5', (4, 13), (4, 14))
        self.add_line('sym-e6', (4, 14), (4, 33))
        self.add_line('sym-e7', (4, 33), (4, 34))
        self.add_line('sym-e8', (4, 34), (4, 35))
        self.add_line('sym-e9-1', (4, 35), (5, 38))
        self.add_arc('sym-e9-2', (5, 38), (8, 40), radius_x=4, sweep=False)
        self.add_arc('sym-e10', (8, 40), (9, 40), radius_x=1)
        self.add_line('sym-e11', (9, 40), (24, 40))
        self.add_line('sym-e12', (24, 40), (39, 40))
        self.add_line('sym-e13', (39, 40), (40, 40))
        self.add_arc('sym-e14-1', (40, 40), (43, 38), radius_x=4, sweep=False)
        self.add_line('sym-e14-2', (43, 38), (44, 35))
        self.add_line('sym-e15', (44, 35), (44, 34))
        self.add_arc('sym-e16', (44, 34), (44, 33), radius_x=34)
        ...
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9-1', 'sym-e9-2', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e13', 'sym-e14-1', 'sym-e14-2', 'sym-e15', 'sym-e16', 'sym-e17', 'sym-e18', 'sym-e19', 'sym-e20', 'sym-e21')
