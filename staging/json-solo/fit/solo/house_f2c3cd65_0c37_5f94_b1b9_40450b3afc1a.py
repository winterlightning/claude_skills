...
class House(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e10', (29, 34), (25, 28), radius_x=6, sweep=False)
        self.add_arc('sym-e11', (25, 28), (24, 28), radius_x=4)
        self.add_arc('sym-e12', (24, 28), (23, 28), radius_x=4)
        self.add_arc('sym-e13', (23, 28), (19, 34), radius_x=6, sweep=False)
