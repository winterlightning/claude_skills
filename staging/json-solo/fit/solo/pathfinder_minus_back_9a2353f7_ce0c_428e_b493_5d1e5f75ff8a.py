...
class PathfinderMinusBackDesign(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e15', (29, 30), (29, 29), radius_x=2)
        self.add_arc('e16', (16, 38), (17, 40), radius_x=2, sweep=False)
        self.add_arc('e17', (42, 40), (44, 38), radius_x=2, sweep=False)
        self.add_line('e18', (44, 17), (42, 16))
        self.add_arc('e19', (6, 30), (4, 29), radius_x=2)
        self.add_arc('e20', (4, 10), (6, 8), radius_x=2)
        self.add_line('e21', (29, 8), (29, 10))
