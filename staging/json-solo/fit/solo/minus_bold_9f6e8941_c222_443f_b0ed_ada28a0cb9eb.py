...
class MinusBold9f6e8941(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e5', (4, 29), (4, 25))
        self.add_line('sym-e6', (4, 25), (4, 24))
        self.add_line('sym-e7', (4, 24), (4, 23))
        self.add_line('sym-e8', (4, 23), (4, 19))
        self.add_arc('sym-e9', (4, 19), (4, 17), radius_x=9, sweep=False)
        self.add_line('sym-e10', (4, 17), (4, 16))
        self.add_arc('sym-e11', (4, 16), (8, 8), radius_x=10)
        self.add_line('sym-e12', (8, 8), (24, 8))
        self.add_line('sym-e13', (24, 8), (40, 8))
        self.add_arc('sym-e14', (40, 8), (44, 16), radius_x=10)
        self.add_line('sym-e15', (44, 16), (44, 17))
        self.add_arc('sym-e16', (44, 17), (44, 19), radius_x=9, sweep=False)
        self.add_line('sym-e17', (44, 19), (44, 23))
        self.add_line('sym-e18', (44, 23), (44, 24))
        self.add_line('sym-e19', (44, 24), (44, 25))
        self.add_line('sym-e20', (44, 25), (44, 29))
        self.add_arc('sym-e21', (44, 29), (44, 31), radius_x=9, sweep=False)
        self.add_line('sym-e22', (44, 31), (44, 32))
        self.add_arc('sym-e23', (44, 32), (40, 40), radius_x=10)
