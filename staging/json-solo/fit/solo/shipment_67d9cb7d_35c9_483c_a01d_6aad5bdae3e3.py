"""Shipment (delivery), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '67d9cb7d-35c9-483c-a01d-6aad5bdae3e3'
SOURCE_PATH = 'icons-json/delivery/shipment_67d9cb7d-35c9-483c-a01d-6aad5bdae3e3.json'
AUTHOR = 'json_to_solo'

class Shipment67d9cb7d(Solo48):
    icon_id = 'shipment-67d9cb7d'
