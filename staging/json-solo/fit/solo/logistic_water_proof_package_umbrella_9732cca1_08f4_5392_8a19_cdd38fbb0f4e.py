...
class LogisticWaterProofPackageUmbrellaShipping(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e11-1', (40, 19), (26, 6), radius_x=15, sweep=False)
        self.add_arc('e11-2', (26, 6), (8, 18), radius_x=16, sweep=False)
        self.add_line('e11-3', (8, 18), (11, 17))
        self.add_arc('e11-4', (11, 17), (18, 18), radius_x=6)
        self.add_line('e11-5', (18, 18), (19, 19))
        self.add_arc('e11-6', (19, 19), (26, 17), radius_x=7)
        self.add_arc('e11-7', (26, 17), (28, 18), radius_x=6)
        self.add_arc('e11-8', (28, 18), (32, 17), radius_x=3, sweep=False)
        self.add_arc('e11-9', (32, 17), (40, 19), radius_x=6)
        self.add_contour('c0', 'e11-1', 'e11-2', 'e11-3', 'e11-4', 'e11-5', 'e11-6', 'e11-7', 'e11-8', 'e11-9')
