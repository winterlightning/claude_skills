...
class VideoCrossSymbol(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (42, 34), (44, 33), radius_x=2, sweep=False)
        self.add_line('sym-e3', (44, 33), (44, 24))
        self.add_line('sym-e4', (44, 24), (44, 15))
        self.add_arc('sym-e5', (44, 15), (42, 14), radius_x=2, sweep=False)
        self.add_line('sym-e6', (42, 14), (33, 19))
        self.add_line('sym-e7', (33, 19), (33, 12))
        self.add_arc('sym-e8', (33, 12), (30, 8), radius_x=4, sweep=False)
        self.add_line('sym-e9', (30, 8), (7, 8))
        self.add_arc('sym-e10', (7, 8), (4, 12), radius_x=5, sweep=False)
        self.add_line('sym-e11', (4, 12), (4, 24))
        self.add_line('sym-e12', (4, 24), (4, 36))
        self.add_arc('sym-e13', (4, 36), (7, 40), radius_x=5, sweep=False)
        self.add_line('sym-e14', (7, 40), (30, 40))
        self.add_arc('sym-e15', (30, 40), (33, 36), radius_x=4, sweep=False)
