(() => {
  ...
  const operations = [
    ...
    ['Disapprove with feedback','POST','/api/reviews',true,() => ({...current(),status:'disapprove',reason:'other',feedback:'Describe what needs fixing.'}),'Moves Ready or Approved icons to Disapproved. Reasons: bad-stroke, meaning, other. Other requires nonempty feedback.','201 · {saved: true, status: "pending", updated_by, id, feedback}'],
