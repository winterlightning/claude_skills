...
class FaqText(Solo48):
    ...
    def build(self) -> None:
        self.add_polyline('f-stem', (8, 8), (4, 8), (4, 24), (4, 40))
        self.add_line('f-bar', (4, 24), (8, 24))
        ...
        self.add_arc('q-top', (36, 12), (44, 12), radius_x=4, radius_y=4, sweep=True)
        self.add_line('q-right', (44, 12), (44, 33))
        self.add_arc('q-bottom', (44, 33), (36, 33), radius_x=4, radius_y=4, sweep=True)
        self.add_line('q-left', (36, 33), (36, 12))
        self.add_contour('q', 'q-top', 'q-right', 'q-bottom', 'q-left', closed=True)
        self.add_line('q-tail', (40, 37), (44, 40))
