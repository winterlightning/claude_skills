"""A with lines (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
...
class AWithLines(Solo48):
    icon_id = 'a-with-lines'
