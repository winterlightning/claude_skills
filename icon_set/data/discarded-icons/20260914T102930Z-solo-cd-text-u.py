"""Cd (text u) (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class CdTextU(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e5-2', (32, 26), (28, 18), radius_x=7)
        self.add_arc('e5-3', (28, 18), (40, 14), radius_x=7)
        self.add_contour('c0', 'e3-1', 'e3-2', 'e3-3', 'e0', 'e4-1', 'e4-2')
        self.add_contour('c1', 'e1', 'e5-1', 'e5-2', 'e5-3')
