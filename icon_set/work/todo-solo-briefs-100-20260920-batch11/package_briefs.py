...
held={6,15,58,60,63,65,80,89,93,94,102,105,111}
...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [11,18,19,39,41,48,56,57,68,73,75,77,84,87,95,109,110]:
  ...
  if i in []:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty bordered coaster; retained as solo as requested.'})
