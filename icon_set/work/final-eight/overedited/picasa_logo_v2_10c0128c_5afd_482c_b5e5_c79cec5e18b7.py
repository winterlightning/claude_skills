"""picasa-logo: Circular shutter — clear spacing; earlier revisions preserved."""
...
class PicasaLogoVariant2(Solo48):
    ...
    variant_label = 'Circular shutter — clear spacing'
    ...
    def build(self):
        # Plan: Moved the right and lower facets inward to leave clear space inside the circular rim.
        ...
        poly('upper-left',(8,12),(24,24),(32,32));join('upper-left','rim')
        poly('right',(36,8),(32,20),(32,32),(40,36));join('right','rim');join('right','upper-left')
        poly('left',(4,24),(16,24),(24,24));join('left','rim');join('left','upper-left')
        poly('bottom',(12,40),(16,32),(16,24));join('bottom','rim');join('bottom','left')
        line('bar',(16,32),(32,32));join('bar','bottom');join('bar','upper-left');join('bar','right')
