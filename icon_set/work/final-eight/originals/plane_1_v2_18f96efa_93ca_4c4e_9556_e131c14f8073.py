"""plane-1: Ascending plane — spacing review; earlier revisions preserved."""
...
class Plane1Variant2(Solo48):
    icon_id = 'plane-1-v2'
    variant_of = 'plane-1'
    variant_label = 'Ascending plane — spacing review'
    ...
    def build(self):
        # Plan: Attempted broader wings and tail at several integer-grid positions. Preserve the ascending single-wing perspective; the wing and tail returns still need manual spacing review.
