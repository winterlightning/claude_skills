"""plane-1-travel: Side-view plane — spacing review; earlier revisions preserved."""
...
class Plane1TravelVariant2(Solo48):
    ...
    variant_label = 'Side-view plane — spacing review'
    ...
    def build(self):
        # Plan: Attempted wider wing tips, wider fuselage and shortened tail. Keep this distinct horizontal plane; swept-wing returns still need a spacing exception review.
