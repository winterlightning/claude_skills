"""Rebuild the lower tower with equal stepped side walls and a rectangular central gate; simplify the pennant to a clean rectangle. Independent feedback revision; parent preserved."""
...
class LandmarkVariant2(Solo48):
    ...
    variant_label = 'Rebuild the lower tower with equal stepped side walls and a rectangular central gate; simplify the pennant to a clean rectangle.'
