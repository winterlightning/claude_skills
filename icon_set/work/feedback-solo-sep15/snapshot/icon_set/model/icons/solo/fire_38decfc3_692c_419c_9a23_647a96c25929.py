"""fire-weather: smooth geometric reconstruction on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '38decfc3-692c-419c-9a23-647a96c25929'
SOURCE_PATH = 'pictographic-primitives/weather/fire_38decfc3-692c-419c-9a23-647a96c25929.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class FireWeather(Solo48):
    icon_id = 'fire-weather'
