"""Round the document perimeter and folded corner with coherent equal-radius turns. Independent feedback revision; parent preserved."""
...
class DocumentA4b94225Variant2(Solo48):
    icon_id = 'document-a4b94225-v2'
    variant_of = 'document-a4b94225'
    variant_label = 'Round the document perimeter and folded corner with coherent equal-radius turns.'
