"""Arrow double top (arrows), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'fd71931e-46f1-5390-a409-62af27b325ee'
SOURCE_PATH = 'pictographic-primitives/arrows/arrow double top_fd71931e-46f1-5390-a409-62af27b325ee.svg'
AUTHOR = 'gpt-6'

class ArrowDoubleTop(Solo48):
    icon_id = 'arrow-double-top'
    ...
    def build(self):
        runs = [{'start': (40, 20), 'steps': [('L', 24, 4), ('L', 8, 20)], 'closed': False}, {'start': (40, 44), 'steps': [('L', 24, 28), ('L', 8, 44)], 'closed': False}]
        rotation = 0
