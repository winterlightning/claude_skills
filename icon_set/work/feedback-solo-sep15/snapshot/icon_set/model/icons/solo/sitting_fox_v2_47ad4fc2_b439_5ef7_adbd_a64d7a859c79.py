"""Round the seated fox back and hindquarters, and make the raised tail flow into the base with a continuous tangent. Independent feedback revision; parent preserved."""
...
class SittingFoxVariant2(Solo48):
    icon_id = 'sitting-fox-v2'
    variant_of = 'sitting-fox'
    variant_label = 'Round the seated fox back and hindquarters, and make the raised tail flow into the base with a continuous tangent.'
