"""Recompose the antenna phone horizontally with a landscape body and clear screen division. Independent feedback revision; parent preserved."""
...
class AntennaMobilePhoneVariant2(Solo48):
    icon_id = 'antenna-mobile-phone-v2'
    variant_of = 'antenna-mobile-phone'
    variant_label = 'Recompose the antenna phone horizontally with a landscape body and clear screen division.'
