"""Widen each pin neck to eight centerline units, stagger the larger center pin below the rear pair, and use level collars with clear enclosed gaps. Independent feedback revision; parent preserved."""
...
class BowlingPinsThreeVariant2(Solo48):
    ...
    variant_label = 'Widen each pin neck to eight centerline units, stagger the larger center pin below the rear pair, and use level collars with clear enclosed gaps.'
