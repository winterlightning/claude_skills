"""A film-strip frame with clipped outer corners and three sprocket openings in each horizontal band. Square envelope fits the frame. Lucide film informs connected perforation rails; detached dashes become open rectangular sprockets. Balanced horizontal bands preserve the reference layout."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '2c0caaff-251d-42ec-9746-332bd5f92647'
SOURCE_PATH = 'pictographic-primitives/photography/film_2c0caaff-251d-42ec-9746-332bd5f92647.svg'
AUTHOR = 'gpt-6'
