"""Enlarge the bottle neck opening vertically and horizontally, shorten the shoulders, and center the simple star within the lower body. Independent feedback revision; parent preserved."""
...
class StarLabelledBottleVariant2(Solo48):
    ...
    variant_label = 'Enlarge the bottle neck opening vertically and horizontally, shorten the shoulders, and center the simple star within the lower body.'
