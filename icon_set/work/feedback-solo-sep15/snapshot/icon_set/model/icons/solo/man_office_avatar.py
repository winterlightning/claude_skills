"""man-office: broad jacket lapels.
Distinct-avatar plan: preserve reference identity; use broad jacket lapels.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-06/references/man-office.svg'
SOURCE_HEAD_ICON_ID = 'man-office'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 24
class ManOfficeAvatar(Solo48):
    icon_id = 'man-office-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('man', 'office', 'portrait', 'bust')
    def build(self):
        cx = 24
        radius, cy = (10, 14)
