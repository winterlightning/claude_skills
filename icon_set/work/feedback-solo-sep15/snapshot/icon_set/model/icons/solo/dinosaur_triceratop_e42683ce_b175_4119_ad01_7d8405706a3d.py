...
class StandingTriceratops(Solo48):
    ...
    def build(self) -> None:
        self.add_polyline('front',(4,29),(4,20),(8,20),(8,8),(16,20))
        self.add_arc('back',(16,20),(28,14),radius_x=15)
        self.add_arc('rump',(28,14),(40,24),radius_x=17)
        self.add_polyline('tail-legs',(40,24),(44,30),(37,32),(37,40),(29,40),(29,31),(20,31),(20,40),(12,40),(12,35))
        self.add_arc('chest',(12,35),(4,29),radius_x=6,sweep=False)
        self.add_line('muzzle',(4,29),(4,29))
