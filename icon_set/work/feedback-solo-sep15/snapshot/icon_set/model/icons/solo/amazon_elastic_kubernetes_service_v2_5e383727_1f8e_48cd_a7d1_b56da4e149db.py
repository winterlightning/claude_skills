...
class AmazonElasticKubernetesServiceVariant2(Solo48):
    icon_id = 'amazon-elastic-kubernetes-service-v2'
    variant_of = 'amazon-elastic-kubernetes-service'
    variant_label = 'Widen the hexagon to the square envelope while retaining the original mark.'
