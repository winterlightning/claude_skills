"""Widen the ear group and deepen its central notch; bring the back of the neck into the enlarged head. Independent feedback revision; parent preserved."""
...
class HowlingWolfVariant2(Solo48):
    ...
    variant_label = 'Widen the ear group and deepen its central notch; bring the back of the neck into the enlarged head.'
