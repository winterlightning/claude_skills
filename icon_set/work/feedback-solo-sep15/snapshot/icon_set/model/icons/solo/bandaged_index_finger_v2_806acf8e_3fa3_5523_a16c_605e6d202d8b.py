"""Round the raised index and show three folded knuckles above a rectangular wrist cuff. Independent feedback revision; parent preserved."""
...
class BandagedIndexFingerVariant2(Solo48):
    ...
    variant_label = 'Round the raised index and show three folded knuckles above a rectangular wrist cuff.'
