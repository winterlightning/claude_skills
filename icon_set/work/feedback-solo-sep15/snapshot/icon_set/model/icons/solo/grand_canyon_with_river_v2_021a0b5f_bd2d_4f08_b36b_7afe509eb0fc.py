"""Simplify the canyon to two stepped cliffs, distant mountain slopes, and one curved river. Independent feedback revision; parent preserved."""
...
class GrandCanyonWithRiverVariant2(Solo48):
    ...
    variant_label = 'Simplify the canyon to two stepped cliffs, distant mountain slopes, and one curved river.'
