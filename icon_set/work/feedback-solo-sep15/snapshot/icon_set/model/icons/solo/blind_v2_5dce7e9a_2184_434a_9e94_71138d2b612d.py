"""Replace segmented eye curves with coherent mirrored elliptical arcs and exact slash attachment points. Independent feedback revision; parent preserved."""
...
class BlindVariant2(Solo48):
    icon_id = 'blind-v2'
    variant_of = 'blind'
    variant_label = 'Replace segmented eye curves with coherent mirrored elliptical arcs and exact slash attachment points.'
