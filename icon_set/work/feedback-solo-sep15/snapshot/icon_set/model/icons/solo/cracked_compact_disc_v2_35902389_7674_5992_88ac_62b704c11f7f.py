"""Open the crack entry further around the rim and spread the zigzag so it has a clear gap to the disc edge. Independent feedback revision; parent preserved."""
...
class CrackedCompactDiscVariant2(Solo48):
    ...
    variant_label = 'Open the crack entry further around the rim and spread the zigzag so it has a clear gap to the disc edge.'
