"""man-1-5: simple open shirt silhouette.
Distinct-avatar plan: preserve reference identity; use simple open shirt silhouette.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-04/references/man-1-5.svg'
