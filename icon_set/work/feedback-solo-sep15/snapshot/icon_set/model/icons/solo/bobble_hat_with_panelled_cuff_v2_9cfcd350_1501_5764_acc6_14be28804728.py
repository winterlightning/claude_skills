"""Remove both cuff divider lines; retain the single crown-to-cuff division. Independent feedback revision; parent preserved."""
...
class BobbleHatWithPanelledCuffVariant2(Solo48):
    ...
    variant_label = 'Remove both cuff divider lines; retain the single crown-to-cuff division.'
