"""rhombus-vertical-shape: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '36f9de4e-504c-5766-aa5a-8f53dfc7eb8b'
SOURCE_PATH = 'pictographic-primitives/design/rhombus vertical shape_36f9de4e-504c-5766-aa5a-8f53dfc7eb8b.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class RhombusVerticalShape(Solo48):
    icon_id = 'rhombus-vertical-shape'
    ...
    def build(self):
        # Plan: Four mirrored straight edges replace short mismatched corner fragments.
        ...
        self.add_polyline('diamond',*[(24, 4), (40, 24), (24, 44), (8, 24)],closed=True)
