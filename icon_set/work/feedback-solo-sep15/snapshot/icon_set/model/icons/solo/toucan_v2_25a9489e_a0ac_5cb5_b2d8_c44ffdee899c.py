"""Raise the open wing curve into the body and keep it clear of the tail; widen the body to preserve room for the eye. Independent feedback revision; parent preserved."""
...
class ToucanVariant2(Solo48):
    icon_id = 'toucan-v2'
    variant_of = 'toucan'
    variant_label = 'Raise the open wing curve into the body and keep it clear of the tail; widen the body to preserve room for the eye.'
