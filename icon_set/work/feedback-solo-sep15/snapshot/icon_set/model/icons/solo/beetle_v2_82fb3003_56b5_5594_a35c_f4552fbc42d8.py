"""Replace the segmented shell with one true oval, give it a centered seam, and attach matching leg fans to its sides. Independent feedback revision; parent preserved."""
...
class BeetleVariant2(Solo48):
    icon_id = 'beetle-v2'
    variant_of = 'beetle'
    variant_label = 'Replace the segmented shell with one true oval, give it a centered seam, and attach matching leg fans to its sides.'
