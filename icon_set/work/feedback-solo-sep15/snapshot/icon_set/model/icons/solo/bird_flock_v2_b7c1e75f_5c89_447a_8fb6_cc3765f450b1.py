"""Reduce the flock from five birds to three larger paired curves; use one repeated wing definition and generous air between the birds. Independent feedback revision; parent preserved."""
...
class BirdFlockVariant2(Solo48):
    ...
    variant_label = 'Reduce the flock from five birds to three larger paired curves; use one repeated wing definition and generous air between the birds.'
