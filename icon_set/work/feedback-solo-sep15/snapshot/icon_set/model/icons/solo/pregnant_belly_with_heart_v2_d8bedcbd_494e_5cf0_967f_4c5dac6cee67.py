"""Smooth the belly using matched vertical tangents and balance the arm curve across the torso. Independent feedback revision; parent preserved."""
...
class PregnantBellyWithHeartVariant2(Solo48):
    ...
    variant_label = 'Smooth the belly using matched vertical tangents and balance the arm curve across the torso.'
