"""Give the Merlion a rounded mane and projecting muzzle, a smoother fish body, and a curved spout that visibly leaves its mouth. Independent feedback revision; parent preserved."""
...
class MerlionStatueVariant2(Solo48):
    ...
    variant_label = 'Give the Merlion a rounded mane and projecting muzzle, a smoother fish body, and a curved spout that visibly leaves its mouth.'
