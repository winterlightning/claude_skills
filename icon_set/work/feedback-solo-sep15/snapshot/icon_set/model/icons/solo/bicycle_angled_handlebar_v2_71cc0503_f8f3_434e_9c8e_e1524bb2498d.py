...
class BicycleAngledHandlebarVariant2(Solo48):
    icon_id = 'bicycle-angled-handlebar-v2'
    variant_of = 'bicycle-angled-handlebar'
    variant_label = 'Enlarge the matching wheels to radius eight and keep their baseline level.'
