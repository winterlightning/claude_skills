"""A side-view bicycle has two equal round wheels connected by a triangular frame. A short saddle rises above the rear wheel and a bent handlebar sits above the front fork.

Equal wheels and shared frame dimensions; triangle top tube retained. Hubs and pedal detail omitted for clearance.
...
class Bicycle(Solo48):
    ...
    def build(self):
        ...
        branches.append(('top-bar',[(16,20),(35,20)]))
