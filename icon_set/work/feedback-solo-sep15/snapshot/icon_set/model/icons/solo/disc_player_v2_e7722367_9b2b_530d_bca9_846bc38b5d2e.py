"""Replace the hub ring with a dot at the exact disc center (24,21). Independent feedback revision; parent preserved."""
...
class DiscPlayerVariant2(Solo48):
    icon_id = 'disc-player-v2'
    variant_of = 'disc-player'
    variant_label = 'Replace the hub ring with a dot at the exact disc center (24,21).'
