...
class ActionCameraOnMountVariant3(Solo48):
    icon_id = 'action-camera-on-mount-v3'
    ...
    def build(self):
        ...
        arc('tr', (38, 6), (42, 10), 4)
        line('right', (42, 10), (42, 28))
        arc('br', (42, 28), (38, 32), 4)
        segments('bottom', (38, 32), (24, 32), (10, 32))
        arc('bl', (10, 32), (6, 28), 4)
        line('left', (6, 28), (6, 10))
        arc('tl', (6, 10), (10, 6), 4)
        contour('body', 'top-1', 'tr', 'right', 'br', 'bottom-1', 'bottom-2', 'bl', 'left', 'tl', closed=True)
        circle('lens',24,19,4)
        line('post', (24, 32), (24, 42))
        connect('post', 'body')
