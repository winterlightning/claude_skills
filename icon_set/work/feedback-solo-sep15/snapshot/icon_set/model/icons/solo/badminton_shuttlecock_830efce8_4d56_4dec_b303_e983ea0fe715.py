"""Diagonal shuttlecock with rounded cork and scalloped feather skirt. No exact local Lucide match; coherent arcs and one feather rib retain the silhouette. Second short feather line omitted for clearance.
...
class BadmintonShuttlecock(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('feather-rib',(22,34),(28,22))
        self.relate('connect','feather-rib','outline')
        self.relate('connect','feather-rib','cork-divider')
