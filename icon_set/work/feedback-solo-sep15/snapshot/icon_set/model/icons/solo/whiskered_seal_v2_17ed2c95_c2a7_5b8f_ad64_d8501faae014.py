"""Add a centered oval nose inside the seal silhouette. Independent feedback revision; parent preserved."""
...
class WhiskeredSealVariant2(Solo48):
    icon_id = 'whiskered-seal-v2'
    variant_of = 'whiskered-seal'
    variant_label = 'Add a centered oval nose inside the seal silhouette.'
