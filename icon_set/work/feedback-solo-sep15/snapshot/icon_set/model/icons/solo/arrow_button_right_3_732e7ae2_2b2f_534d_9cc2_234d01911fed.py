"""Arrow button right 3 (arrows), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '732e7ae2-2b2f-534d-9cc2-234d01911fed'
SOURCE_PATH = 'pictographic-primitives/arrows/arrow button right 3_732e7ae2-2b2f-534d-9cc2-234d01911fed.svg'
AUTHOR = 'gpt-6'

class ArrowButtonRight3(Solo48):
    icon_id = 'arrow-button-right-3'
