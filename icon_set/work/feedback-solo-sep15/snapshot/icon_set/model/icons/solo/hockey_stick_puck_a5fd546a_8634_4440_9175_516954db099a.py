"""A long hockey stick leans upward to the right, ending in a curved blade that extends left along the bottom. A small circular puck sits separately beside the lower shaft.

Long leaning shaft, hooked blade and separate round puck retained; blade outline reduced to one coherent stroke.
"""
...
class HockeyStickPuck(Solo48):
    ...
    def build(self):
        ...
        self.add_line('shaft',(42,6),(30,38))
        self.add_arc('heel',(30,38),(26,42),radius_x=4)
        self.add_line('blade',(26,42),(6,42))
