"""Spread the amphitheater into a broad horseshoe, with flatter concentric elliptical rows and longer vertical ends. Independent feedback revision; parent preserved."""
...
class AmfitheaterInDelphiTopVariant2(Solo48):
    icon_id = 'amfitheater-in-delphi-top-v2'
    variant_of = 'amfitheater-in-delphi-top'
    variant_label = 'Spread the amphitheater into a broad horseshoe, with flatter concentric elliptical rows and longer vertical ends.'
