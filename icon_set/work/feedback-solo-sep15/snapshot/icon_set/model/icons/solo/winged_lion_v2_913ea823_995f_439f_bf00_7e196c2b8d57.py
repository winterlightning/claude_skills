"""Enlarge the lion head into a rounded mane with a projecting side muzzle; simplify the wing and remove its crowded inner seam. Independent feedback revision; parent preserved."""
...
class WingedLionVariant2(Solo48):
    icon_id = 'winged-lion-v2'
    variant_of = 'winged-lion'
    variant_label = 'Enlarge the lion head into a rounded mane with a projecting side muzzle; simplify the wing and remove its crowded inner seam.'
