"""Remove the internal feather rib, leaving three outer feather curves and an empty feather fan. Independent feedback revision; parent preserved."""
...
class BadmintonShuttlecockVariant2(Solo48):
    icon_id = 'badminton-shuttlecock-v2'
    variant_of = 'badminton-shuttlecock'
    variant_label = 'Remove the internal feather rib, leaving three outer feather curves and an empty feather fan.'
