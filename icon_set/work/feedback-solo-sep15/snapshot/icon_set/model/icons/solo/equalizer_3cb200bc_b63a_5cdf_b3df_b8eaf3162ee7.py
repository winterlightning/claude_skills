...
SOURCE_PATH = 'pictographic-primitives/audio/equalizer_3cb200bc-b63a-5cdf-b3df-b8eaf3162ee7.svg'
AUTHOR = 'gpt-6'
...
class Equalizer(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('e2', (8, 23), (8, 9))
        self.add_line('e3', (8, 31), (8, 40))
        self.add_line('e4', (24, 8), (24, 15))
        self.add_line('e5', (24, 23), (24, 40))
        self.add_arc('e6-top', (20, 18), (28, 18), radius_x=4, radius_y=3, large_arc=False, sweep=True)
        self.add_arc('e6-bottom', (28, 18), (20, 18), radius_x=4, radius_y=3, large_arc=False, sweep=True)
        self.add_arc('e7-top', (4, 27), (12, 27), radius_x=4, radius_y=3, large_arc=False, sweep=True)
        self.add_arc('e7-bottom', (12, 27), (4, 27), radius_x=4, radius_y=3, large_arc=False, sweep=True)
        self.add_arc('e8-top', (34, 32), (44, 32), radius_x=5, radius_y=4, large_arc=False, sweep=True)
        self.add_arc('e8-bottom', (44, 32), (34, 32), radius_x=5, radius_y=4, large_arc=False, sweep=True)
