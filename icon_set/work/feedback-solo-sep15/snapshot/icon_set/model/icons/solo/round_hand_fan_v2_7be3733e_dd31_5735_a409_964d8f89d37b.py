"""Rebuild the fan blade as an exact circle with a diagonal handle at a shared circle point. Independent feedback revision; parent preserved."""
...
class RoundHandFanVariant2(Solo48):
    ...
    variant_label = 'Rebuild the fan blade as an exact circle with a diagonal handle at a shared circle point.'
