"""Double the single-stroke doorway height and center the tower crossbar, making the entrance legible at 48 pixels. Independent feedback revision; parent preserved."""
...
class LandmarkVariant2(Solo48):
    ...
    variant_label = 'Double the single-stroke doorway height and center the tower crossbar, making the entrance legible at 48 pixels.'
