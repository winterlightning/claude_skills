"""Replace tall pointed ears with smaller rounded Bengal-style ear tips. Independent feedback revision; parent preserved."""
...
class BengalCatFaceVariant2(Solo48):
    icon_id = 'bengal-cat-face-v2'
    variant_of = 'bengal-cat-face'
    variant_label = 'Replace tall pointed ears with smaller rounded Bengal-style ear tips.'
