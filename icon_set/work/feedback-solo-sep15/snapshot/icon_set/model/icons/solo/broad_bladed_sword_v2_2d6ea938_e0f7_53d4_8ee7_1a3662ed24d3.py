"""Rebuild the sword around one exact 45-degree centerline; straighten and lengthen the grip, use a perpendicular guard, and broaden the symmetrical blade. Independent feedback revision; parent preserved."""
...
class BroadBladedSwordVariant2(Solo48):
    icon_id = 'broad-bladed-sword-v2'
    variant_of = 'broad-bladed-sword'
    variant_label = 'Rebuild the sword around one exact 45-degree centerline; straighten and lengthen the grip, use a perpendicular guard, and broaden the symmetrical blade.'
