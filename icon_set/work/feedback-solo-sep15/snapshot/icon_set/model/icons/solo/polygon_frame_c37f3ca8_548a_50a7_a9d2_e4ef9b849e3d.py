"""Polygon frame (design), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'c37f3ca8-548a-50a7-a9d2-e4ef9b849e3d'
SOURCE_PATH = 'pictographic-primitives/design/polygon frame_c37f3ca8-548a-50a7-a9d2-e4ef9b849e3d.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class PolygonFrame(Solo48):
    icon_id = 'polygon-frame'
