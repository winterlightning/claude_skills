"""Spread the windmill supports across a broad tapered building, center its entrance, and align the four sails around one hub. Independent feedback revision; parent preserved."""
...
class WindmillVariant2(Solo48):
    icon_id = 'windmill-v2'
    variant_of = 'windmill'
    variant_label = 'Spread the windmill supports across a broad tapered building, center its entrance, and align the four sails around one hub.'
