"""Give the penguin a rounder forward belly and a sharper downward-pointing bill, opening up its left profile. Independent feedback revision; parent preserved."""
...
class PenguinLookingDownVariant2(Solo48):
    ...
    variant_label = 'Give the penguin a rounder forward belly and a sharper downward-pointing bill, opening up its left profile.'
