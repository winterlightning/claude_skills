"""Square the drive housing on a shared horizontal baseline and retain one solid dot at the circular disc center. Independent feedback revision; parent preserved."""
...
class CdRomDriveVariant2(Solo48):
    ...
    variant_label = 'Square the drive housing on a shared horizontal baseline and retain one solid dot at the circular disc center.'
