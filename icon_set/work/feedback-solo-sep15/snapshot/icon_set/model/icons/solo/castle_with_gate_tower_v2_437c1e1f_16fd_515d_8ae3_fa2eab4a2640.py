"""Widen the gate from 8 to 12 centerline units and raise its lintel by one unit; remove the inner tower divider so the larger opening stays clear. Independent feedback revision; parent preserved."""
...
class LandmarkVariant2(Solo48):
    ...
    variant_label = 'Widen the gate from 8 to 12 centerline units and raise its lintel by one unit; remove the inner tower divider so the larger opening stays clear.'
