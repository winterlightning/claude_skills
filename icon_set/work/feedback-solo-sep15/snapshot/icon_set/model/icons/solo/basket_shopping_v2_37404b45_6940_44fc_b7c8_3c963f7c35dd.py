"""Replace the tapered handle with one smooth half-ellipse. Independent feedback revision; parent preserved."""
...
class BasketShoppingVariant2(Solo48):
    icon_id = 'basket-shopping-v2'
    variant_of = 'basket-shopping'
    variant_label = 'Replace the tapered handle with one smooth half-ellipse.'
