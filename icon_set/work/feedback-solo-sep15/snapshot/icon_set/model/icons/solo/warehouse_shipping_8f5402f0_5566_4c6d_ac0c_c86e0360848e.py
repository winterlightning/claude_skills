...
class WarehouseShipping(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (7, 17), (6, 19), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_line('sym-e4', (6, 19), (6, 42))
        self.add_line('sym-e5', (6, 42), (42, 42))
        self.add_line('sym-e7', (42, 42), (42, 19))
        self.add_line('sym-e9', (42, 19), (41, 17))
        self.add_line('sym-e10', (41, 17), (24, 6))
        self.add_contour('sym-c0', 'sym-e1', 'sym-e2', 'sym-e4', 'sym-e5', 'sym-e7', 'sym-e9', 'sym-e10', closed=True)
