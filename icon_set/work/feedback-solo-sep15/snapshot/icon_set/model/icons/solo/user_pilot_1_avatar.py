"""user-pilot-1: uniform front bands.
Distinct-avatar plan: preserve reference identity; use uniform front bands.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-11/references/user-pilot-1.svg'
SOURCE_HEAD_ICON_ID = 'user-pilot-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 30
class UserPilot1Avatar(Solo48):
    icon_id = 'user-pilot-1-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'pilot', '1', 'portrait', 'bust')
    def build(self):
        cx = 24
