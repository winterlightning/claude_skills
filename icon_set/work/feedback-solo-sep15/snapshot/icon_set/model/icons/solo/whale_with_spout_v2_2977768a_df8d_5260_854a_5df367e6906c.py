"""Enlarge and round the whale forehead, then flow its back into the raised tail with matching tangents and a broad smooth belly. Independent feedback revision; parent preserved."""
...
class WhaleWithSpoutVariant2(Solo48):
    icon_id = 'whale-with-spout-v2'
    variant_of = 'whale-with-spout'
    variant_label = 'Enlarge and round the whale forehead, then flow its back into the raised tail with matching tangents and a broad smooth belly.'
