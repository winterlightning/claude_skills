...
class Badge3Variant2(Solo48):
    icon_id = 'badge-3-v2'
    variant_of = 'badge-3'
    variant_label = 'Widen the central shield symmetrically while retaining its side wings.'
    ...
    def build(self):
        ...
        path('wing-left', (12, 20), [('L', (4, 20)), ('L', (4, 32)), ('L', (12, 32))])
        path('wing-right', (36, 20), [('L', (44, 20)), ('L', (44, 32)), ('L', (36, 32))])
