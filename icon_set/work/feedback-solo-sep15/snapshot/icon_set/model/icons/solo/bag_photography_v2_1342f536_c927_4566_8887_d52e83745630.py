...
class BagPhotographyVariant2(Solo48):
    icon_id = 'bag-photography-v2'
    variant_of = 'bag-photography'
    variant_label = 'Use a rounded carry handle above the existing rounded rectangular camera bag.'
