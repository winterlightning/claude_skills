"""reward-stars: smooth geometric reconstruction on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'c05c0079-7067-4069-b786-c42c611d2275'
SOURCE_PATH = 'pictographic-primitives/rating/reward stars_c05c0079-7067-4069-b786-c42c611d2275.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class RewardStars(Solo48):
    icon_id = 'reward-stars'
