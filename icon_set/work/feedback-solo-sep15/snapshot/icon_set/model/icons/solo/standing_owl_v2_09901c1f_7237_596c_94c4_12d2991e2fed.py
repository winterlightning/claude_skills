"""Make both owl ear tufts truly triangular and mirrored; round the lower face symmetrically and center the eyes and beak. Independent feedback revision; parent preserved."""
...
class StandingOwlVariant2(Solo48):
    icon_id = 'standing-owl-v2'
    variant_of = 'standing-owl'
    variant_label = 'Make both owl ear tufts truly triangular and mirrored; round the lower face symmetrically and center the eyes and beak.'
