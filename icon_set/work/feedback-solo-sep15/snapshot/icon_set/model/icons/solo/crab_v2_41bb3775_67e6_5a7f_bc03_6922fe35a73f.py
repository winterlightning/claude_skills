"""Use exact paired quarter-ellipses for the opposing claws, broaden the upper body curve, and give each leg a shared side attachment. Independent feedback revision; parent preserved."""
...
class CrabVariant2(Solo48):
    icon_id = 'crab-v2'
    variant_of = 'crab'
    variant_label = 'Use exact paired quarter-ellipses for the opposing claws, broaden the upper body curve, and give each leg a shared side attachment.'
