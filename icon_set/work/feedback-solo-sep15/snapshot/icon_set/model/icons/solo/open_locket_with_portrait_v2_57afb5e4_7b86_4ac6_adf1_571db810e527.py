"""Simplify the portrait to a dot head and shoulder curve; separate both oval locket halves at one clean hinge. Independent feedback revision; parent preserved."""
...
class OpenLocketWithPortraitVariant2(Solo48):
    ...
    variant_label = 'Simplify the locket portrait to a dot head and one shoulder curve; retain both hinged halves.'
