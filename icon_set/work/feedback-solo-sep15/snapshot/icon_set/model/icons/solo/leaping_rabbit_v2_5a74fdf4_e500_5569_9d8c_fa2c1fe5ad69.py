"""Round the rabbit head and muzzle while retaining the leaping body and long ear. Independent feedback revision; parent preserved."""
...
class LeapingRabbitVariant2(Solo48):
    ...
    variant_label = 'Round the rabbit head and muzzle while retaining the leaping body and long ear.'
