"""Round the raised wing and simplify the flying bird into a swept wing, small head, projecting bill and curved belly. Independent feedback revision; parent preserved."""
...
class FlyingBirdVariant2(Solo48):
    ...
    variant_label = 'Round the raised wing and simplify the flying bird into a swept wing, small head, projecting bill and curved belly.'
