"""Rebuild the snake with a larger round head, a short forked tongue and two generous S-bends with tangent straight runs. Independent feedback revision; parent preserved."""
...
class SlitheringSnakeVariant2(Solo48):
    icon_id = 'slithering-snake-v2'
    variant_of = 'slithering-snake'
    variant_label = 'Rebuild the snake with a larger round head, a short forked tongue and two generous S-bends with tangent straight runs.'
