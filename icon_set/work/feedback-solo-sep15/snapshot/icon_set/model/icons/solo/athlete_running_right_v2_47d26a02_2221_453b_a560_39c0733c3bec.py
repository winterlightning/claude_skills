"""Enlarge the head and body; center the head over the upper torso with exactly four visible units of separation. Independent feedback revision; parent preserved."""
...
class AthleteRunningRightVariant2(Solo48):
    icon_id = 'athlete-running-right-v2'
    variant_of = 'athlete-running-right'
    variant_label = 'Enlarge the head and body; center the head over the upper torso with exactly four visible units of separation.'
