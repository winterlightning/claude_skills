...
class BabyOnesie(Solo48):
    ...
    def build(self) -> None:
        self.add_line('suit-1', (16, 6), (8, 6))
        self.add_line('suit-2', (8, 6), (6, 16))
        self.add_line('suit-3', (6, 16), (10, 20))
        ...
        self.add_line('suit-7', (20, 40), (20, 42))
        self.add_line('suit-8', (20, 42), (28, 42))
        self.add_line('suit-9', (28, 42), (28, 40))
        ...
        self.add_line('suit-13', (38, 20), (42, 16))
        self.add_line('suit-14', (42, 16), (40, 6))
        self.add_line('suit-15', (40, 6), (32, 6))
        self.add_arc('suit-16', (32, 6), (16, 6), radius_x=8, radius_y=8, sweep=True)
