"""Replace the pointed lower jaw with a true horizontal oval while retaining the eye style. Independent feedback revision; parent preserved."""
...
class AlienHeadAngularEyesVariant2(Solo48):
    icon_id = 'alien-head-angular-eyes-v2'
    variant_of = 'alien-head-angular-eyes'
    variant_label = 'Replace the pointed lower jaw with a true horizontal oval while retaining the eye style.'
