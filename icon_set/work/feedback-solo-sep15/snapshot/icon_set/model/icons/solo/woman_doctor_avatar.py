"""woman-doctor: long bob and coat lapels.
Distinct-avatar plan: preserve reference identity; use long bob and coat lapels.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-14/references/woman-doctor.svg'
...
class WomanDoctorAvatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('woman', 'doctor', 'portrait', 'bust')
    def build(self):
        cx = 24
