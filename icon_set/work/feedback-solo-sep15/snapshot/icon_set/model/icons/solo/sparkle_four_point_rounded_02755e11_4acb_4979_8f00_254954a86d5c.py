...
class SparkleFourPointRounded(Solo48):
    icon_id='sparkle-four-point-rounded'
    ...
    def build(self):
        ...
        for j in range(4):self.add_arc('side-'+str(j),tips[j],tips[(j+1)%4],radius_x=18,sweep=False)
