"""Dot-lens alternative: replace the small lens circle with a dot. Independent feedback revision; parent preserved."""
...
class ActionCameraOnMountVariant2(Solo48):
    icon_id = 'action-camera-on-mount-v2'
    variant_of = 'action-camera-on-mount'
    variant_label = 'Large-lens alternative: enlarge and center the circular lens; remove the adjacent screen mark to keep clearance.'
    ...
    def build(self):
        """Symbol plan: Dot-lens alternative: replace the small lens circle with a dot. Reference: Lucide disc: centered dot."""
