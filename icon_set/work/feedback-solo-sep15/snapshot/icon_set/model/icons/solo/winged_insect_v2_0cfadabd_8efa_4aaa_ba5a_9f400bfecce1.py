"""Rebuild the mirrored wings and join the abdomen to exact shared nodes on their inner edges, eliminating the offset body endpoints. Independent feedback revision; parent preserved."""
...
class WingedInsectVariant2(Solo48):
    icon_id = 'winged-insect-v2'
    variant_of = 'winged-insect'
    variant_label = 'Rebuild the mirrored wings and join the abdomen to exact shared nodes on their inner edges, eliminating the offset body endpoints.'
