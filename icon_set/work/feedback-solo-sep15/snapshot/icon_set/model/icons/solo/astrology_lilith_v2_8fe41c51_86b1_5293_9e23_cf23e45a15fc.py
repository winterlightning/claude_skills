...
class AstrologyLilithVariant2(Solo48):
    icon_id = 'astrology-lilith-v2'
    variant_of = 'astrology-lilith'
    variant_label = 'Replace the upper oval with a circular semicircle and center the cross beneath it.'
