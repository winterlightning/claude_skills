"""Make the cockatoo crest distinct and extend its hooked beak; round the crown and neck while keeping a single dot eye. Independent feedback revision; parent preserved."""
...
class CockatooVariant2(Solo48):
    icon_id = 'cockatoo-v2'
    variant_of = 'cockatoo'
    variant_label = 'Make the cockatoo crest distinct and extend its hooked beak; round the crown and neck while keeping a single dot eye.'
