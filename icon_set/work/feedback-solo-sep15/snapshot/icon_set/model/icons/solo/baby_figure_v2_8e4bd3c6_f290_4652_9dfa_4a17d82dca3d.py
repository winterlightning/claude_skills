"""Replace the diaper curve and tapered body with one rounded rectangular torso. Independent feedback revision; parent preserved."""
...
class BabyFigureVariant2(Solo48):
    ...
    variant_label = 'Replace the diaper curve and tapered body with one rounded rectangular torso.'
