"""Widen both rectangular straps equally from 16 to 24 units, keeping the dial centered. Independent feedback revision; parent preserved."""
...
class AnalogueWristwatchVariant2(Solo48):
    ...
    variant_label = 'Widen both rectangular straps equally from 16 to 24 units, keeping the dial centered.'
