...
class Weights(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e4', (32, 8), (31, 11), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_line('sym-e5', (31, 11), (31, 24))
        self.add_line('sym-e6', (31, 24), (17, 24))
        ...
        self.add_arc('sym-e22', (9, 40), (8, 37), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        self.add_line('sym-e23', (8, 37), (8, 24))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e13', closed=False)
        self.add_contour('sym-c1', 'sym-e14', 'sym-e15', 'sym-e16', 'sym-e17', 'sym-e18', closed=False)
        self.add_contour('sym-c2', 'sym-e19', 'sym-e20', 'sym-e21', 'sym-e22', 'sym-e23', closed=False)
