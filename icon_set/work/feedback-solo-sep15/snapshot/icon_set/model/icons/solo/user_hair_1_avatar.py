"""user-hair-1: broad swept hair and round shirt.
Distinct-avatar plan: preserve reference identity; use broad swept hair and round shirt.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-10/references/user-hair-1.svg'
SOURCE_HEAD_ICON_ID = 'user-hair-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserHair1Avatar(Solo48):
    icon_id = 'user-hair-1-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'hair', '1', 'portrait', 'bust')
    def build(self):
