"""Redraw the roof as two clean slopes and widen the hut body with matching lower corners; make the doorway one longer centered vertical stroke. Independent feedback revision; parent preserved."""
...
class SimpleGabledShackVariant2(Solo48):
    ...
    variant_label = 'Redraw the roof as two clean slopes and widen the hut body with matching lower corners; make the doorway one longer centered vertical stroke.'
