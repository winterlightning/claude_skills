"""Remove the pinched inner leaf triangles and leave a generous open suspension above the bowl. Independent feedback revision; parent preserved."""
...
class TrailingHangingPlanterVariant2(Solo48):
    ...
    variant_label = 'Remove the pinched inner leaf triangles and leave a generous open suspension above the bowl.'
