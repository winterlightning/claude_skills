"""Separate the mother’s hand from the baby by eight centerline units (four visible units). Independent feedback revision; parent preserved."""
...
class DiaperChangeVariant3(Solo48):
    ...
    variant_label = 'Separate the mother’s hand from the baby by eight centerline units (four visible units).'
