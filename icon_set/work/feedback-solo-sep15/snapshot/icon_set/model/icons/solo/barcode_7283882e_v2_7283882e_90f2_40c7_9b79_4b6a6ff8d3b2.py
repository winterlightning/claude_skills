"""Align all four barcode bars to the same top baseline. Independent feedback revision; parent preserved."""
...
class Barcode7283882eVariant2(Solo48):
    ...
    variant_label = 'Align all four barcode bars to the same top baseline.'
