"""Windsurfing alternative: circular head, one horizontal arm, raised arm, triangular sail and upward-curved board. Independent feedback revision; parent preserved."""
...
class BoardRiderOverWavesVariant4(Solo48):
    icon_id = 'board-rider-over-waves-v4'
    variant_of = 'board-rider-over-waves'
    variant_label = 'Windsurfing alternative: circular head, one horizontal arm, raised arm, triangular sail and upward-curved board.'
