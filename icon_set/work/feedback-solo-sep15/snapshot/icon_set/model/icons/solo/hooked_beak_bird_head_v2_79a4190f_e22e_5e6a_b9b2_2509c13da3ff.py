"""Replace the zero-length eye line with a centered dot and rebuild the crown and hooked beak using fewer smooth curves. Independent feedback revision; parent preserved."""
...
class HookedBeakBirdHeadVariant2(Solo48):
    ...
    variant_label = 'Replace the zero-length eye line with a centered dot and rebuild the crown and hooked beak using fewer smooth curves.'
