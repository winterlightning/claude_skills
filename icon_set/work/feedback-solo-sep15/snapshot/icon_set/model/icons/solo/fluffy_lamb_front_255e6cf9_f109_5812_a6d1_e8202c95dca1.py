...
SOURCE_ICON_ID = '255e6cf9-f109-5812-a6d1-e8202c95dca1'
SOURCE_PATH = 'pictographic-primitives/animals/lamb_255e6cf9-f109-5812-a6d1-e8202c95dca1.svg'
AUTHOR = 'gpt-6'

class FluffyLambFront(Solo48):
    icon_id = 'fluffy-lamb-front'
    ...
    def build(self) -> None:
        ...
        self.add_line('ear-right-0', p_30_22, p_33_26)
        self.add_line('ear-right-1', p_33_26, p_30_26)
        ...
        self.add_line('ear-left-0', p_18_26, p_15_26)
        self.add_line('ear-left-1', p_15_26, p_18_22)
