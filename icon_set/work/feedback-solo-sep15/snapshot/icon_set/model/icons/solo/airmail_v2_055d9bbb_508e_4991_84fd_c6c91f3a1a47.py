"""Round all four envelope corners with equal-radius arcs; retain the folded flap. Independent feedback revision; parent preserved."""
...
class AirmailVariant2(Solo48):
    icon_id = 'airmail-v2'
    variant_of = 'airmail'
    variant_label = 'Round all four envelope corners with equal-radius arcs; retain the folded flap.'
