"""paragraph-1: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'ae140cef-c1a1-4209-9858-289364e04e70'
SOURCE_PATH = 'pictographic-primitives/interface-essential/paragraph 1_ae140cef-c1a1-4209-9858-289364e04e70.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class Paragraph1(Solo48):
    icon_id = 'paragraph-1'
    ...
    def build(self):
        # Plan: SQUARE; true semicircular paragraph bowl and exact stem attachments.
