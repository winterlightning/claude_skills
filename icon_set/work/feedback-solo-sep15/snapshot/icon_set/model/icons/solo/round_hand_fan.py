...
class RoundHandFan(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('blade-top-left', (12, 19), *(((13.88594784, 11.19601141), (20.97450503, 6), (29, 6)),))
        self.add_arc('blade-top-right', (29, 6), (42, 19), radius_x=17, sweep=True)
        self.add_bezier('blade-bottom-right', (42, 19), *(((42, 27.02549497), (36.80398859, 34.11405216), (29, 36)),))
