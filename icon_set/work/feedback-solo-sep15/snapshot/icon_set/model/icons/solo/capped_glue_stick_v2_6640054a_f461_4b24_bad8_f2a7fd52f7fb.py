"""Rebuild the glue stick as a narrow upright tube with a wider cap and a simple base seam. Independent feedback revision; parent preserved."""
...
class CappedGlueStickVariant2(Solo48):
    ...
    variant_label = 'Rebuild the glue stick as a narrow upright tube with a wider cap and a simple base seam.'
