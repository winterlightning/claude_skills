"""Replace the uncertain left body curvature with an exact quarter-circle and a tangent vertical join; keep the bill and dorsal fin distinct. Independent feedback revision; parent preserved."""
...
class LeapingMarlinVariant2(Solo48):
    ...
    variant_label = 'Replace the uncertain left body curvature with an exact quarter-circle and a tangent vertical join; keep the bill and dorsal fin distinct.'
