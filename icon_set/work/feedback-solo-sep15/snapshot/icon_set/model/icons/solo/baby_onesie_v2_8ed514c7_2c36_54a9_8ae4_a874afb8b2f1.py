"""Replace both tapered sleeves with mirrored horizontal rectangles. Independent feedback revision; parent preserved."""
...
class BabyOnesieVariant2(Solo48):
    icon_id = 'baby-onesie-v2'
    variant_of = 'baby-onesie'
    variant_label = 'Replace both tapered sleeves with mirrored horizontal rectangles.'
