"""Broaden the lower jaw toward the face and replace its short arc with a smooth, deep curve so the open mouth is unmistakable. Applied to the original icon identity."""
