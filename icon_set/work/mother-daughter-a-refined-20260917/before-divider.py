...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        path('mother-hood',(2,46),[('L',(2,16)),('A',(16,2),14,14,True),('A',(30,16),14,14,True),('L',(30,20))])
        circle('mother-face',16,16,5)
        path('daughter-hood',(30,20),[('L',(34,20)),('C',(46,33),(41,20),(46,26)),('L',(46,40)),('L',(46,46))])
        circle('daughter-face',33,33,4)
        path('mother-wrap',(2,30),[('C',(20,36),(8,35),(15,36))])
        poly('daughter-left',(20,36),(20,40),(20,46))
        path('daughter-wrap',(20,40),[('C',(33,46),(23,44),(29,46)),('C',(46,40),(38,46),(43,44))])
        path('mother-arm',(2,44),[('C',(20,40),(11,47),(17,46))])
        join('mother-hood','daughter-hood');join('mother-wrap','mother-hood');join('mother-wrap','daughter-left');join('daughter-wrap','daughter-left');join('daughter-wrap','daughter-hood');join('mother-arm','mother-hood');join('mother-arm','daughter-left');join('mother-arm','daughter-wrap')
