...
for n,r in enumerate(batch.ROWS,1):
 ...
 labels=[('Original reference','reference.png'),('Previous drawing','before.png'),('New · light','light-192.png'),('New · dark','dark-192.png')]
