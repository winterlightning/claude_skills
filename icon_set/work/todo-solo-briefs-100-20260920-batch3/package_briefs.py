...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [2,3,20,31,32,38,55,65,91]:
  ...
  if i in [24,75,84]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty pouch or cage enclosure; retained as solo as requested.'})
