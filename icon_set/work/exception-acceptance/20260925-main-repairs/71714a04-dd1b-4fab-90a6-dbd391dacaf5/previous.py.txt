...
SOURCE_PATH = 'icon_set/work/todo-references/laptop small squares_71714a04-dd1b-4fab-90a6-dbd391dacaf5.svg'
AUTHOR = "gpt-6"
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for i,y in enumerate((12,24)):
            self.add_polyline('tile-'+str(i),(16,y),(16+tile,y),(16+tile,y+tile),(16,y+tile),closed=True)
