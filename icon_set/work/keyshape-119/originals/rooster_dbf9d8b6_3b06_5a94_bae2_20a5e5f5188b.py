...
class RoosterWithScallopedBase(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('body-1', (6, 25), (17, 13), radius_x=12, radius_y=12, sweep=True)
        self.add_arc('body-2', (17, 13), (29, 25), radius_x=12, radius_y=12, sweep=True)
        self.add_line('body-3', (29, 25), (29, 40))
        self.add_arc('body-4', (29, 40), (23, 42), radius_x=6, radius_y=6, sweep=True)
        self.add_arc('body-5', (23, 42), (17, 40), radius_x=6, radius_y=6, sweep=False)
        self.add_arc('body-6', (17, 40), (11, 42), radius_x=6, radius_y=6, sweep=True)
        self.add_arc('body-7', (11, 42), (6, 40), radius_x=6, radius_y=6, sweep=True)
        self.add_line('body-8', (6, 40), (6, 25))
        ...
        self.add_line('beak-1', (29, 23), (42, 34))
        self.add_line('beak-2', (42, 34), (29, 34))
        ...
        self.add_arc('wattle-2', (36, 39), (29, 42), radius_x=7, radius_y=5, sweep=True)
