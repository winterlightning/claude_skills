...
class RamHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('left-crown', (14, 6), (20, 14), radius_x=6, radius_y=12, sweep=True)
        ...
        self.add_arc('right-crown', (34, 6), (28, 14), radius_x=6, radius_y=12, sweep=False)
        ...
        self.add_arc('face-left', (14, 22), (24, 42), radius_x=10, radius_y=24, sweep=False)
        self.add_arc('face-right', (24, 42), (34, 22), radius_x=10, radius_y=24, sweep=False)
