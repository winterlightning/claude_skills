...
class MantaRay(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('right-wing', (36, 24), (42, 6), radius_x=28, radius_y=28, sweep=True)
        self.add_arc('leading-right', (42, 6), (21, 8), radius_x=60, radius_y=60, sweep=False)
        ...
        self.add_arc('tail-curl', (28, 42), (36, 42), radius_x=8, radius_y=4, sweep=False)
