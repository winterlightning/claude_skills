...
class WildBoar(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('face', (36, 17), (42, 24), radius_x=12, radius_y=12, sweep=False)
        self.add_arc('snout', (42, 24), (40, 31), radius_x=6, radius_y=7, sweep=True)
        ...
        self.add_arc('tail-round', (6, 25), (6, 21), radius_x=4, radius_y=4, sweep=True)
        self.add_line('tail-end', (6, 21), (6, 14))
