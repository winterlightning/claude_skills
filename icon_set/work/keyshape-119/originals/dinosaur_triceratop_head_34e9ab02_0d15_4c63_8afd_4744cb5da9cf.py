...
class TriceratopsHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('crown-left', (16,15), (24,6), radius_x=8, radius_y=10)
        self.add_arc('crown-right', (24,6), (32,15), radius_x=8, radius_y=10)
        self.add_arc('right-horn-tip', (32,15), (40,19), radius_x=5, sweep=False)
        self.add_arc('right-frill', (40,19), (42,33), radius_x=6, radius_y=14)
        self.add_arc('right-cheek', (42,33), (42,37), radius_x=4)
        self.add_line('right-jowl', (42,37), (36,37))
        self.add_arc('snout-right', (36,37), (24,42), radius_x=12, radius_y=9)
        self.add_arc('snout-left', (24,42), (12,37), radius_x=12, radius_y=9)
        self.add_line('left-jowl', (12,37), (6,37))
        self.add_arc('left-cheek', (6,37), (6,33), radius_x=4)
        self.add_arc('left-frill', (6,33), (8,19), radius_x=6, radius_y=14)
        ...
        self.add_arc('left-horn-outer', (6,6), (8,19), radius_x=24, sweep=False)
        self.add_contour('left-horn', 'left-horn-inner', 'left-horn-outer')
        self.add_arc('right-horn-outer', (40,19), (42,6), radius_x=24, sweep=False)
