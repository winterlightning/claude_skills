...
class WhaleTailWithSpout(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("head",(6,42),(14,31),radius_x=12)
        ...
        self.add_line('notch-2', (40, 17), (42, 13))
        self.add_arc("fluke-right",(42,13),(42,25),radius_x=20)
        ...
        self.add_arc("spray-left",(6,13),(10,13),radius_x=4,radius_y=8)
