...
class StylizedRamHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('crown', (12, 12), (22, 6), radius_x=10, radius_y=10, sweep=True)
        self.add_arc('forehead', (22, 6), (42, 20), radius_x=28, radius_y=28, sweep=True)
        self.add_arc('nose', (42, 20), (42, 26), radius_x=10, radius_y=10, sweep=True)
        self.add_arc('muzzle-round', (42, 26), (40, 32), radius_x=6, radius_y=6, sweep=True)
        ...
        self.add_arc('neck-top', (6, 20), (12, 12), radius_x=10, radius_y=8, sweep=True)
        self.relate("connect", 'head', 'neck-top')
        self.add_arc('jaw-upper', (34, 32), (26, 40), radius_x=8, radius_y=8, sweep=True)
        self.add_arc('jaw-lower', (26, 40), (16, 42), radius_x=10, radius_y=6, sweep=True)
        self.add_arc('neck-base', (16, 42), (10, 42), radius_x=6, radius_y=3, sweep=True)
