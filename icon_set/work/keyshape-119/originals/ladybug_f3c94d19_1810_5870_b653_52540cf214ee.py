...
class Ladybug(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('wing-2', (39, 31), (33, 42), radius_x=15, radius_y=15, sweep=True, large_arc=False)
        self.add_arc('wing-3', (33, 42), (24, 42), radius_x=15, radius_y=15, sweep=True, large_arc=False)
        self.add_arc('wing-4', (24, 42), (15, 42), radius_x=15, radius_y=15, sweep=True, large_arc=False)
        self.add_arc('wing-5', (15, 42), (9, 31), radius_x=15, radius_y=15, sweep=True, large_arc=False)
        ...
        self.add_line('antenna-left', (18, 8), (15, 6))
        self.relate("connect", 'antenna-left', 'head')
        self.add_line('leg-left-top', (15, 19), (6, 14))
        self.relate("connect", 'leg-left-top', 'wings')
        self.add_line('leg-left-middle', (9, 31), (6, 31))
        self.relate("connect", 'leg-left-middle', 'wings')
        self.add_line('leg-left-bottom', (15, 42), (6, 42))
        self.relate("connect", 'leg-left-bottom', 'wings')
        self.add_line('antenna-right', (30, 8), (33, 6))
        self.relate("connect", 'antenna-right', 'head')
        self.add_line('leg-right-top', (33, 19), (42, 14))
        self.relate("connect", 'leg-right-top', 'wings')
        self.add_line('leg-right-middle', (39, 31), (42, 31))
        self.relate("connect", 'leg-right-middle', 'wings')
        self.add_line('leg-right-bottom', (33, 42), (42, 42))
