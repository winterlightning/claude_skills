...
class LeapingOrca(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('head', (35, 17), (42, 34), radius_x=22, radius_y=22, sweep=True, large_arc=False)
        self.add_arc('nose', (42, 34), (41, 37), radius_x=5, radius_y=5, sweep=True, large_arc=False)
        ...
        self.add_line('fluke', (7, 32), (6, 30))
        self.add_arc('tail-back', (6, 30), (10, 26), radius_x=10, radius_y=10, sweep=True, large_arc=False)
