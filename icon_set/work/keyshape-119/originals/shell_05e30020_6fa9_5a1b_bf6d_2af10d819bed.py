...
class ScallopShell(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('right-edge', (42, 19), (42, 27), radius_x=4, radius_y=8, sweep=True, large_arc=False)
        self.add_line('right-slope', (42, 27), (28, 42))
        self.add_arc('hinge', (28, 42), (20, 42), radius_x=4, radius_y=4, sweep=True, large_arc=False)
        self.add_line('left-slope', (20, 42), (6, 27))
        self.add_arc('left-edge', (6, 27), (6, 19), radius_x=4, radius_y=8, sweep=True, large_arc=False)
