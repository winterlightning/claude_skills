"""Blank pet identification tag with suspension loop. Centerlines (11,6)-(37,42). Lucide tag supplies rounded corners; one legible ring replaces nested rings."""
...
class PetIdTag(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('plate-br',(37,39),(30,42),radius_x=7)
        self.add_line('plate-bottom',(30,42),(18,42))
        self.add_arc('plate-bl',(18,42),(11,39),radius_x=7)
