...
class WoollySheep(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('fleece-top', (6, 25), (18, 9), radius_x=16, radius_y=16, sweep=True, large_arc=False)
        ...
        self.add_arc('fleece-left', (18, 37), (6, 25), radius_x=16, radius_y=12, sweep=True, large_arc=False)
        ...
        self.add_arc('head-right', (36, 24), (42, 10), radius_x=8, radius_y=14, sweep=False, large_arc=False)
        self.add_arc('crown', (42, 10), (28, 10), radius_x=8, radius_y=5, sweep=False, large_arc=False)
        self.add_contour('head', 'head-left', 'head-right', 'crown', closed=True)
        self.relate("connect", 'fleece', 'head')
        self.add_line('ear', (42, 10), (42, 6))
        self.relate("connect", 'ear', 'head')
        self.add_line('hind-leg', (10, 36), (10, 42))
        self.add_line('front-leg', (28, 35), (28, 42))
