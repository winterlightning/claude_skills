...
class HoneyBee(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('abdomen-right', (33, 35), (24, 42), radius_x=9, radius_y=9, sweep=True)
        self.add_arc('abdomen-left', (24, 42), (15, 35), radius_x=9, radius_y=9, sweep=True)
        ...
        self.add_arc('left-wing-round-top', (6, 27), (6, 32), radius_x=2, radius_y=5, sweep=False)
        self.add_arc('left-wing-round-bottom', (6, 32), (9, 39), radius_x=7, radius_y=7, sweep=False)
        ...
        self.add_arc('right-wing-round-top', (42, 27), (42, 32), radius_x=2, radius_y=5, sweep=True)
        self.add_arc('right-wing-round-bottom', (42, 32), (39, 39), radius_x=7, radius_y=7, sweep=True)
