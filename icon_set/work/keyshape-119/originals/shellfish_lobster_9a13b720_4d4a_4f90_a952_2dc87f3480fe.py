...
class Lobster(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('left-antenna', (24, 14), (14, 6), radius_x=10, radius_y=12, sweep=False, large_arc=False)
        ...
        self.add_arc('right-antenna', (24, 14), (34, 6), radius_x=10, radius_y=12, sweep=True, large_arc=False)
