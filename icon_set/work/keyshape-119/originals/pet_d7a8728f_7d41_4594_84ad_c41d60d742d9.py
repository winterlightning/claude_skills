...
class RoundBug(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('body-5', (36, 34), (30, 42), radius_x=6, radius_y=10, sweep=True)
        self.add_arc('body-6', (30, 42), (24, 42), radius_x=10, radius_y=10, sweep=True)
        self.add_arc('body-7', (24, 42), (18, 42), radius_x=10, radius_y=10, sweep=True)
        self.add_arc('body-8', (18, 42), (12, 34), radius_x=6, radius_y=10, sweep=True)
