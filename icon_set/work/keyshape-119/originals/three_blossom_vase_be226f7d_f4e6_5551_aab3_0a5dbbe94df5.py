...
class ThreeBlossomVase(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('left0', (8, 6), (14, 6), radius_x=3, radius_y=3, sweep=True)
        self.add_arc('left1', (14, 6), (14, 11), radius_x=3, radius_y=3, sweep=True)
        self.add_arc('left2', (14, 11), (8, 11), radius_x=3, radius_y=3, sweep=True)
        self.add_arc('left3', (8, 11), (8, 6), radius_x=3, radius_y=3, sweep=True)
        self.add_contour('left', 'left0', 'left1', 'left2', 'left3', closed=True)
        self.add_arc('right0', (34, 6), (40, 6), radius_x=3, radius_y=3, sweep=True)
        self.add_arc('right1', (40, 6), (40, 11), radius_x=3, radius_y=3, sweep=True)
        self.add_arc('right2', (40, 11), (34, 11), radius_x=3, radius_y=3, sweep=True)
        self.add_arc('right3', (34, 11), (34, 6), radius_x=3, radius_y=3, sweep=True)
        ...
        self.add_arc('pot-r', (34, 40), (28, 42), radius_x=6, radius_y=6, sweep=True)
        self.add_line('pot-base', (28, 42), (20, 42))
        self.add_arc('pot-l', (20, 42), (14, 40), radius_x=6, radius_y=6, sweep=True)
