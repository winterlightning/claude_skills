...
class TrexHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('snout-round', (6,16), (10,8), radius_x=8)
        self.add_line('brow', (10,8), (22,8))
        self.add_arc('skull', (22,8), (31,6), radius_x=15, sweep=True)
        ...
        self.add_arc('jaw-hinge', (30,42), (38,35), radius_x=8,sweep=False)
