...
class Drawing(Solo48):
    ...
    def build(self) -> None:
        ...
        self.rounded('case',4,16,44,40,4)
        self.add_polyline('handle',(17,16),(17,8),(31,8),(31,16))
        self.relate('connect','case','handle')
        self.add_bezier('dollar-upper',(27,25),((22,23),(20,25),(24,28)))
        self.add_bezier('dollar-lower',(24,28),((28,30),(27,33),(21,31)))
        self.add_line('dollar-stem',(24,25),(24,31))
