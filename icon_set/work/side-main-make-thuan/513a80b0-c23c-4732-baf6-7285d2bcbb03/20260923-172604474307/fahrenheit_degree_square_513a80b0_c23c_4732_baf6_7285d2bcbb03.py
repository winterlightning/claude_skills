"""A Fahrenheit F and degree mark inside a rounded square.

Symbol plan: Square frame, hand-authored F with a shared stem junction; small source degree mark retained as a dot. Ink extremes (4,4)-(44,44).
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48

SOURCE_ICON_ID = '513a80b0-c23c-4732-baf6-7285d2bcbb03'
SOURCE_PATH = 'pictographic-primitives/other/square temperature fahrenheit_513a80b0-c23c-4732-baf6-7285d2bcbb03.svg'
AUTHOR = "gpt-6"
...
class AuthoredIcon(Solo48):
    icon_id = 'fahrenheit-degree-square'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'other'
    aliases = ()
    keywords = ('fahrenheit', 'degree', 'square')

    def build(self):
        rounded_rect(self,'frame',6,6,42,42,3)
        self.add_line('stem-upper',(24,15),(24,24))
        self.add_line('stem-lower',(24,24),(24,33))
        self.add_contour('stem','stem-upper','stem-lower')
        self.add_line('top',(24,15),(33,15));self.relate('connect','top','stem-upper')
        self.add_line('middle',(24,24),(31,24))
        self.relate('connect','middle','stem-upper');self.relate('connect','middle','stem-lower')
