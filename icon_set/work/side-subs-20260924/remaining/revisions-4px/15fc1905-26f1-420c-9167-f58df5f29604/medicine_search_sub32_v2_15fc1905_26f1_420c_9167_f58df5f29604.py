...
class Drawing(Sub32):
    ...
    REPAIR_PLAN = {'concept': 'Medicine Search Magnifying Glass', 'core_parts': ['circular magnifier lens', 'lower-right handle', 'diagonal capsule outline', 'one transverse divider'], 'flexible_parts': 'Coordinates and proportions only; no parts removed.', 'repair': 'Retain the complete all-4px capsule and magnifier unchanged.'}
    icon_id = 'medicine-search-sub32-v2'
