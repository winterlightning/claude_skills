...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_line('text-M-0-0-0-0',(17, 16),(17, 2))
        self.add_line('text-M-0-0-0-1',(17, 2),(23, 11))
        self.add_line('text-M-0-0-0-2',(23, 11),(29, 2))
        self.add_contour('glyph-M-0-0-0',*['text-M-0-0-0-0', 'text-M-0-0-0-1', 'text-M-0-0-0-2'],closed=False)
        self.add_line('text-M-0-0-1-0',(29, 2),(29, 16))
