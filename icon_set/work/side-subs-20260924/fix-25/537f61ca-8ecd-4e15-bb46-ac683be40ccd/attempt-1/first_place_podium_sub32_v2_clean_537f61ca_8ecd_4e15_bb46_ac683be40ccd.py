...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_polyline('outline',(2,28),(2,14),(9,14),(9,4),(23,4),(23,16),(30,16),(30,28),closed=True)
        self.add_line('left-partition',(9,14),(9,28))
        self.add_line('right-partition',(23,16),(23,28))
