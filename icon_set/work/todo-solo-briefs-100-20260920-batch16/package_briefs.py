...
held={0, 5, 7, 12, 20, 24, 25, 27, 30, 33, 35, 38, 43, 46, 47, 48, 50, 57, 64, 69, 82, 91, 100, 112, 114, 121, 124}
...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [9,34,40,52,86,99,111,126]:
  ...
  if i in [10,81]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty panel or enclosure arrangement; retained as solo as requested, though container may be a better authoring family.'})
