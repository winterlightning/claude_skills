...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_19/framework_a80c4976-31bf-47f2-b198-dfc75df4dc14.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'square-focus-grid-with-circle'
...
class Drawing(Solo48):
    ...
    variant_of = 'square-focus-grid-with-circle'
    variant_label = 'Square Grid Layout Structure'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('square', 'grid', 'layout', 'structure', 'outer', 'frame', 'enclosing', 'inner')
    def build(self):
        # Plan: A rounded square outer frame enclosing an inner square split into four regions around a small central square.
