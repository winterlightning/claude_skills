...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/folders/duplicate folder_7f241b41-a40e-5d93-877e-90934b0259e9.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'folder'
...
class Drawing(Solo48):
    ...
    variant_of = 'folder'
    variant_label = 'Two Overlapping Folders'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'folders'
    aliases = ()
    keywords = ('overlapping', 'folders', 'offset', 'file', 'raised', 'tabs', 'folder')
    def build(self):
        # Plan: Two offset overlapping file folders with raised upper-left tabs, the front folder lower-right.
