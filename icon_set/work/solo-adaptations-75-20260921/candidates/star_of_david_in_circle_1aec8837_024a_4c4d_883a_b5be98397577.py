...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/video-games/batch-06/magic circle_1aec8837-024a-4c4d-883a-b5be98397577.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'star-of-david'
...
class Drawing(Solo48):
    icon_id = 'star-of-david-in-circle'
    variant_of = 'star-of-david'
    variant_label = 'Star of David in Circle'
    keyshape = Keyshape.CIRCLE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'video-games'
    aliases = ()
    keywords = ('star', 'david', 'circle', 'overlapping', 'equilateral', 'triangles', 'form', 'pointed')
    def build(self):
        # Plan: Two overlapping equilateral triangles form a six-pointed star inscribed in a circle, with the star tips meeting the circular boundary.
        ...
        p('down',(24,44),(8,12),(40,12),closed=True)
