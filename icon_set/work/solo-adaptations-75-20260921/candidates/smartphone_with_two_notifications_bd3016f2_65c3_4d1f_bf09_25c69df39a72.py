...
SOURCE_ICON_ID = 'bd3016f2-65c3-4d1f-bf09-25c69df39a72'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_01/alert notification bars 1_bd3016f2-65c3-4d1f-bf09-25c69df39a72.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'smartphone-with-two-notifications'
    variant_of = 'mobile-phone'
    variant_label = 'Smartphone with Two Notifications'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('smartphone', 'notifications', 'speaker', 'stacked', 'notification', 'cards', 'text', 'mark')
    def build(self):
        # Plan: An upright smartphone has a short upper speaker and two stacked notification cards, each with a short text mark.
