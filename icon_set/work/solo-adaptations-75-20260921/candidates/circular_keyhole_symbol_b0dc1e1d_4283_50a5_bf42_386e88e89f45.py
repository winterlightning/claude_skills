"""A circular outline surrounds a round-headed keyhole with a narrow lower slot."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'b0dc1e1d-4283-50a5-bf42-386e88e89f45'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/interface-essential/keyhole circle_b0dc1e1d-4283-50a5-bf42-386e88e89f45.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'keyhole'
DESIGN_NOTES = 'Keyhole lower slot becomes one open stroke to retain a readable round head.'
CONSTRUCTION_REFERENCE = 'Lucide scan original and atomic-debug; coherent contours and shared attachment nodes.'

class Drawing(Solo48):
    icon_id = 'circular-keyhole-symbol'
    variant_of = 'keyhole'
    variant_label = 'Circular Keyhole Symbol'
    keyshape = Keyshape.CIRCLE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'interface-essential'
    aliases = ()
    keywords = ('keyhole', 'outline', 'round', 'headed', 'slot', 'interface-essential')
    def build(self):
        # Plan: A circular outline surrounds a round-headed keyhole with a narrow lower slot.
        # CIRCLE: exact SOLO48 envelope; repeated parts share coordinates.
        # Reduction: Keyhole lower slot becomes one open stroke to retain a readable round head.
