...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_08/browser page text 2_b317a6a6-fb5f-4063-b4ca-9345a6cec436.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    variant_label = 'Web Browser Page Layout'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('web', 'browser', 'page', 'layout', 'window', 'header', 'dots', 'sidebar')
    def build(self):
        # Plan: A browser window has three header dots, a narrow sidebar of short lines and two stacked content panels.
        ...
        rr('window',6,6,42,42,2,left=(18,),right=(18,),top=(),bottom=(18,))
