"""A graphics tablet has an inset drawing area with a circle, two right-side control cells and a diagonal stylus entering at upper right."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '3db34463-b35b-4824-850c-ed10b22276f4'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_21/graphic tablet draw_3db34463-b35b-4824-850c-ed10b22276f4.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'drawing-tablet-with-diagonal-stylus'
...
class Drawing(Solo48):
    icon_id = 'graphics-tablet-with-stylus-pen'
    variant_of = 'drawing-tablet-with-diagonal-stylus'
    variant_label = 'Graphics Tablet with Stylus Pen'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('graphics', 'tablet', 'stylus', 'pen', 'inset', 'drawing', 'area', 'circle')
    def build(self):
        # Plan: A graphics tablet has an inset drawing area with a circle, two right-side control cells and a diagonal stylus entering at upper right.
