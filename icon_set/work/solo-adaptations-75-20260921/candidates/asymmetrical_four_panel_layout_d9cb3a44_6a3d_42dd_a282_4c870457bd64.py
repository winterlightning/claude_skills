...
SOURCE_ICON_ID = 'd9cb3a44-6a3d-42dd-a282-4c870457bd64'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_12/composition layout 3_d9cb3a44-6a3d-42dd-a282-4c870457bd64.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'layout'
...
class Drawing(Solo48):
    icon_id = 'asymmetrical-four-panel-layout'
    variant_of = 'layout'
    variant_label = 'Asymmetrical Four Panel Layout'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('asymmetrical', 'panel', 'layout', 'square', 'frame', 'split', 'columns', 'staggered')
    def build(self):
        # Plan: A rounded square frame split into two columns with staggered horizontal divisions.
        ...
        rr('frame',6,6,42,42,2,top=(24,),bottom=(24,),left=(30,),right=(18,))
