...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [7,8,10,20,24,26,58,62,69,72,81,82,95]:
  ...
  if i in [89]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty bordered coaster; retained as solo as requested.'})
