...
held={6, 17, 82, 26, 28, 94, 95, 110, 111, 114, 51, 55, 57, 59, 62, 63}
...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [0,4,7,10,11,25,36,70,83,106,108]:
  ...
  if i in [27,29]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'A page or article enclosure; retained as solo as requested.'})
