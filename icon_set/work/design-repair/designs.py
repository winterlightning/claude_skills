...
def body(steps):
 ...
 for s in steps:
  ...
  if kind=='L':lines.append(f'self.add_line({name!r}, {args[0]!r}, {args[1]!r})');members.append(name)
   ...
   lines.append(f'self.add_polyline({name!r}, '+', '.join(map(repr,pts))+f', closed={closed})')
  elif kind=='C':
...
for name in ['camera','camera-with-shutter-button']:
 s=[('P','housing',[(8,14),(12,14),(18,8),(30,8),(36,14),(40,14)]),('A','tr',(40,14),(44,18),4),('L','right',(44,18),(44,36)),('A','br',(44,36),(40,40),4),('L','bottom',(40,40),(8,40)),('A','bl',(8,40),(4,36),4),('L','left',(4,36),(4,18)),('A','tl',(4,18),(8,14),4),('C','body',[*[f'housing-{i}' for i in range(1,6)],'tr','right','br','bottom','bl','left','tl'])]+circle('lens',24,26,6)
...
D['dinosaur-footprint']=('SQUARE',[
 ('P','toes',[(6,28),(6,6),(17,20),(24,6),(31,20),(42,6),(42,28)]),('A','heel-right',(42,28),(24,42),18,14),('A','heel-left',(24,42),(6,28),18,14),('C','track',[*[f'toes-{i}' for i in range(1,7)],'heel-right','heel-left'])], 'Three pointed toes and one elliptical heel, mirrored about x=24. Lucide footprints informs the simple single-contour footprint, not human toe anatomy.')
...
D['wolf-face']=('SQUARE',[
 ('P','upper',[(6,28),(7,18),(6,6),(16,10),(32,10),(42,6),(41,18),(42,28),(30,40)]),('A','chin',(30,40),(18,40),10),('L','left-jaw',(18,40),(6,28)),('C','head',[*[f'upper-{i}' for i in range(1,9)],'chin','left-jaw'])]+circle('nose',24,31,3), 'Lucide dog: simple face and centered muzzle; pointed ears preserve wolf identity. Mirror x=24; chin radius 10 reaches y=42 exactly.')
...
D['pointed-paintbrush']=('SQUARE',[
 ('L','handle-upper',(20,24),(36,8)),('A','cap-top',(36,8),(40,8),4,4),('A','cap-right',(40,8),(40,12),4,4),('L','handle-lower',(40,12),(26,30)),('L','ferrule',(26,30),(20,24)),('C','handle'),('A','bristle-crown',(20,24),(8,32),10,10,False),('L','bristle-tip',(8,32),(6,42)),('L','bristle-bottom',(6,42),(22,42)),('A','bristle-side',(22,42),(26,30),11,11,False),('C','bristles',['bristle-crown','bristle-tip','bristle-bottom','bristle-side'],False),('R','handle','bristles')], 'Lucide paintbrush: diagonal handle and broad bristle head. Intentional bristle point; coherent cap will be checked against exact square extrema.')
...
D['anteater']=('HRECT_L',[
 ('A','back',(18,22),(44,22),13,14),('L','rear',(44,22),(44,40)),('L','hind-foot',(44,40),(36,40)),('L','hind-leg',(36,40),(34,29)),('L','belly',(34,29),(26,29)),('L','fore-leg',(26,29),(24,40)),('L','fore-foot',(24,40),(16,40)),('L','fore-front',(16,40),(16,28)),('L','snout-lower',(16,28),(4,32)),('L','snout-front',(4,32),(4,26)),('L','face',(4,26),(18,22)),('C','animal')], 'Long tapered snout and domed back on a left-facing animal with two broad legs. No useful Lucide anteater match; natural profile asymmetry is intentional.')
