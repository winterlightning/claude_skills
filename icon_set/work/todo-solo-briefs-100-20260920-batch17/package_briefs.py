...
held=set(json.loads((P/'held-indices.json').read_text()))
...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [0,1,20,24,40,47,48,55,56,65,66,76,95,97,98,118,129,135,153,158,162]:
  ...
  if i in [21,22,79,80,81,91,92,101,102,103,117,121,122,123,125,126]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty panel or enclosure arrangement; retained as solo as requested, though container may be a better authoring family.'})
