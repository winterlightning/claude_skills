...
def make(n,ids):
 ...
 for g in gs:
  ...
  if g['icon_id']=='letter-a-uppercase':
...
for n,ids in [(33,('letter-c-uppercase','digit-5')),(42,('letter-a-uppercase',)),(43,('letter-c-uppercase','letter-s-uppercase','letter-s-uppercase')),(44,('letter-c-uppercase','letter-s-uppercase','letter-v-uppercase')),(45,('letter-p-uppercase','letter-h-uppercase','letter-p-uppercase')),(46,('letter-x-uppercase','letter-m-uppercase','letter-l-uppercase'))]:make(n,ids)
