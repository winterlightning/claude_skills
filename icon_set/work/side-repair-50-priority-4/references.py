...
names=['headphones','link-2-off','search-activity','smartphone','minus','bot','circle-check','send','cross','gamepad-2','cpu','mountain','bike','shopping-cart','wifi','cylinder','tornado','equal','shirt','syringe','arrow-down','zap','flower-2']
