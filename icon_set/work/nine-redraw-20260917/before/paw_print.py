...
class PawPrint(Solo48):
    ...
    def build(self):
        # Symbol plan: Restore a broad three-lobed central paw pad and arrange four toes in an arch.
        ...
        for n,x,y,r in [('upper-left',17,7,3),('upper-right',31,7,3),('outer-left',6,20,3),('outer-right',42,20,3)]:circle(n,x,y,r)
