...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [0,2,3,5,8,9,10,21,24,26,27,46,53,61,70,71,75,97,98]:
  ...
  if i==1:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'A domed architectural/oven enclosure; retained as solo as requested.'})
