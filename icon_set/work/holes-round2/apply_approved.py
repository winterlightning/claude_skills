...
AUTHOR='gpt-6'
W=Path(__file__).parent;excluded=['user-with-gear'];mapping=json.loads((W/'mapping.json').read_text());backup=W/'approved-source-backups';backup.mkdir(exist_ok=True)
changes=[]
for m in mapping:
