...
SOURCE_ICON_ID='d4554878-96fc-4ac9-833b-7cf76a28dfc4'
SOURCE_PATH='icon_set/work/todo-references/ui webpage template add_d4554878-96fc-4ac9-833b-7cf76a28dfc4.svg'
AUTHOR='gpt-6'
PLAN='Page template with horizontal rows and a lower-right add sign.'
CONSTRUCTION_REFERENCE='panels-top-left: repeated horizontal divisions and rounded upper corners'

class Drawing(Solo48):
    icon_id='ui-webpage-template-add'
    keyshape=Keyshape.SQUARE
    semantic_role="MAIN"
    semantic_kind="noun"
    category="objects/general"
    aliases=()
    keywords=('ui', 'webpage', 'template', 'add')
    ...
    def build(self):
        ...
        for y in (16,26):
            ...
            self.relate('connect',f'row-{y}','left','right-1','right-2')
        self.add_line('row-last',(6,36),(24,36))
        self.relate('connect','row-last','left')
        self.cross('add',36,38,4)
        self.contours = [c for c in self.contours if c.contour_id not in ['right']]
