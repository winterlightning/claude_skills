"""Woman User Profile Avatar. Expand the circular face and preserve long center-parted hair; coherent circular jaw and broad shoulders.
...
AUTHOR = 'gpt-6'
PLAN = 'Expand the circular face and preserve long center-parted hair; coherent circular jaw and broad shoulders.'
OMISSIONS = 'Neck seams and shirt collar omitted to protect the exact detached face-to-body gap; hairstyle retained.'
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('hair',(8,30),[('L',(8,20)),('A',(24,4),16,16,True),('A',(40,20),16,16,True),('L',(40,30))])

        # Shared human vocabulary: radius8 circular jaw; bottom28, shoulders36 => 4u ink gap.
        self.path('fringe',(16,20),[('C',(24,12),(20,19),(23,15)),('C',(32,20),(25,16),(29,19))])
