"""A text document with its upper right corner folded.

Symbol plan: One page perimeter, a shared fold corner, and horizontal text series. VRECT_L ink extremes (6,2)-(42,46).
Construction: file-text: folded corner shares perimeter nodes and text uses repeated baselines.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('page',(30,4),(40,14),(40,44),(8,44),(8,4),closed=True)
        self.add_polyline('fold',(30,4),(30,14),(40,14))
        self.relate('connect','page','fold')
        for i,(y,end) in enumerate(((24,31),(34,28))):
            self.add_line(f'text-{i}',(16,y),(end,y))
