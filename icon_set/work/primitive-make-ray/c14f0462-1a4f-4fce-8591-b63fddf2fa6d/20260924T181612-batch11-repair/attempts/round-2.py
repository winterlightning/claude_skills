...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('cargo',(4,26),(4,8),(28,8),(28,16),(28,26))
        self.add_polyline('cab',(28,16),(36,16),(44,26))
        self.circle('wheel-left',12,36,4)
        self.circle('wheel-right',36,36,4)
        self.add_line('chassis',(16,36),(32,36))
        self.add_line('rear-support',(12,28),(12,32));self.relate('connect','rear-support','wheel-left')
        self.add_line('front-support',(36,28),(36,32));self.relate('connect','front-support','wheel-right')
