"""An eight-sided outline.

Symbol plan: Mirrored horizontal, vertical and 45-degree sides about (24,24). SQUARE ink extremes (4,4)-(44,44).
Construction: octagon: balanced equal corner cuts and deliberate polygon corners.
...
class Drawing(Solo48):
    ...
    def build(self):
        lo,hi,cut=6,42,10
        self.add_polyline('octagon',(lo+cut,lo),(hi-cut,lo),(hi,lo+cut),(hi,hi-cut),(hi-cut,hi),(lo+cut,hi),(lo,hi-cut),(lo,lo+cut),closed=True)
