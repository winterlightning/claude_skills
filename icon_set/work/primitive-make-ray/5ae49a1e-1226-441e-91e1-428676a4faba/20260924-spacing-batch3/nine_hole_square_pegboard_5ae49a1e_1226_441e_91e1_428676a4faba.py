...
AUTHOR='gpt-6'
PLAN='A square pegboard with nine perforation marks. Three-by-three pattern keeps equal pitch9 and centered alignment; rounded board.'
...
FINAL_OMISSIONS = 'Replace tiny outlined holes with solid circular marks.'
VISUAL_REVIEW = 'Three-by-three pattern keeps equal pitch9 and centered alignment; rounded board.'
