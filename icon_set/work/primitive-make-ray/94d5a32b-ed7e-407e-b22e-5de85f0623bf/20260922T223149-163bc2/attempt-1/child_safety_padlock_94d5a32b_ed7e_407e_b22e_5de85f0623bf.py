...
class Drawing(Solo48):
    ...
    def build(self):
        # Padlock with arched shackle and child figure embedded in lower body. Shared symmetry axis24; head radius3 at(24,27), torso begins(24,38) giving exactly8 centerline/4 ink gap. VRECT_L ink(6,2)-(42,46).
        def circle(n,x,y,r):
        ...
        rounded('lock-body',8,16,40,44,4)
        self.add_line('shackle-left',(16,16),(16,12))
        self.add_arc('shackle-top',(16,12),(32,12),radius_x=8)
        self.add_line('shackle-right',(32,12),(32,16))
        self.add_contour('shackle','shackle-left','shackle-top','shackle-right')
        self.relate('connect','lock-body','shackle')
        circle('head',24,27,3)
        self.add_line('torso',(24,38),(24,44))
        self.add_polyline('arms',(16,35),(20,38),(24,38),(28,38),(32,35))
