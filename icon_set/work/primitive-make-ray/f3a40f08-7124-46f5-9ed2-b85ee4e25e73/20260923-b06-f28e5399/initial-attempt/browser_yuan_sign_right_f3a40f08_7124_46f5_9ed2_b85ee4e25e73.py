"""A browser containing a right-aligned yuan sign with one crossbar.
Plan: Browser frame and one-bar yuan. Repeated arm endpoints mirror about x=28; symbol placement intentionally right-aligned."""
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.browser()
        x=28
        self.add_polyline("yuan-fork",(x-6,22),(x,28),(x+6,22))
