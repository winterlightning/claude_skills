...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('left-body',(18,24),[('L',(18,26)),('C',(12,32),(18,28),(12,28))])
        self.path('right-body',(30,24),[('L',(30,26)),('C',(36,32),(30,28),(36,28))])
        self.path('left-hair',(14,16),[('C',(10,24),(14,20),(12,23)),('L',(18,24))])
        self.path('right-hair',(34,16),[('C',(38,24),(34,20),(36,23)),('L',(30,24))])
        self.add_polyline('ledge',(8,32),(12,32),(36,32),(40,32))
        self.add_polyline('lectern',(12,32),(16,44),(32,44),(36,32))
        for a,b in [('hair-cap','fringe'),('hair-cap','jaw'),('fringe','jaw'),('jaw','left-body'),('jaw','right-body'),('left-body','ledge'),('right-body','ledge'),('lectern','ledge'),('left-hair','jaw'),('right-hair','jaw'),('left-hair','hair-cap'),('right-hair','hair-cap'),('left-hair','fringe'),('right-hair','fringe'),('left-hair','left-body'),('right-hair','right-body')]:self.relate('connect',a,b)
