"""A minimalist smiling face within a round outline.

SOLO48 CIRCLE; Lucide reference: no useful Lucide face match; circular geometry.
...
class MinimalSmilingFace(Solo48):
    ...
    aliases = ('Minimalist Smiling Face Emoji',)
    keywords = tuple('minimalist smiling face emoji'.split())
    ...
    def build(self) -> None:
        ...
        self.add_arc('smile',(14,29),(34,29),radius_x=12,radius_y=8,sweep=False)
