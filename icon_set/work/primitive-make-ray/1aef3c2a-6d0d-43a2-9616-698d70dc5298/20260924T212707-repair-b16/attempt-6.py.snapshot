...
AUTHOR='gpt-6'
PLAN='Lucide monitor enclosure; two equal upright squares on shared x15 axis; enlarge both openings to8.'
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for i,y in enumerate((12,28)):
            self.add_polyline(f'square-{i}',(17,y),(25,y),(25,y+8),(17,y+8),closed=True)
