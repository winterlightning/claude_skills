"""mobile phone woman. Circular face with flared hair sides and symmetric shoulders; phone uses tall rounded enclosure.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('hair-left',(20,17),(17,23))
        self.add_line('hair-right',(28,17),(31,23))
        self.relate('connect','woman-head','hair-left')
        self.relate('connect','woman-head','hair-right')
