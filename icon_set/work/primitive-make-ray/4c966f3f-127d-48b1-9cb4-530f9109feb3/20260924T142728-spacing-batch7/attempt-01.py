...
Omissions: Secondary inner rim and terminal fold curl omitted to enlarge the cavity.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('fold',(27,16),(27,26),radius_x=5,radius_y=5)
        self.add_polyline('sound',(6,24),(8,24),(11,27),(14,21),(16,24))
