...
class Drawing(Solo48):
    ...
    def build(self):
        # SQUARE frame, large flat-crowned skull; paired eyes and narrowed open jaw.
        self.box('browser',6,6,42,42,4)
        self.add_line('crown',(19,15),(29,15))
        self.add_arc('cranium-right',(29,15),(33,19),radius_x=4)
        self.add_line('temple-right',(33,19),(33,26))
        self.add_arc('cheek-right',(33,26),(29,30),radius_x=4)
        self.add_line('jaw-right',(29,30),(29,33))
        self.add_line('jaw-left',(19,33),(19,30))
        self.add_arc('cheek-left',(19,30),(15,26),radius_x=4)
        self.add_line('temple-left',(15,26),(15,19))
        self.add_arc('cranium-left',(15,19),(19,15),radius_x=4)
        self.add_contour('skull','jaw-left','cheek-left','temple-left','cranium-left','crown','cranium-right','temple-right','cheek-right','jaw-right')
        for x in (20,28):self.add_dot(f'eye-{x}',(x,23))
