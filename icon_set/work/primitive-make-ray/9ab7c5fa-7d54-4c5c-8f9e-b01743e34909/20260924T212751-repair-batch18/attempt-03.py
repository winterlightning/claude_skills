...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('browser',(4,16),(4,8),(44,8),(44,16),(44,40),(4,40),closed=True)
        self.add_line('chrome',(4,16),(44,16));self.relate('connect','browser','chrome')
        self.add_arc('skull-top',(12,28),(36,28),radius_x=12)
        self.add_bezier('skull-right',(36,28),((36,34),(29,34),(29,36)))
        self.add_bezier('skull-left',(19,36),((19,34),(12,34),(12,28)))
