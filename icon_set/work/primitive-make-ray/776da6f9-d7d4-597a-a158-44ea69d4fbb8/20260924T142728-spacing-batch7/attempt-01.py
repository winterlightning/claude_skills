...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('dollar-top',(24,12),(24,14));self.relate('connect','dollar','dollar-top')
        self.add_line('dollar-bottom',(24,22),(24,24));self.relate('connect','dollar','dollar-bottom')
