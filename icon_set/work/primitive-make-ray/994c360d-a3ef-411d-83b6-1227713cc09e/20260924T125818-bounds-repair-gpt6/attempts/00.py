...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('brain',(10,34),((6,34),(6,31),(6,28)),((6,25),(7,24),(7,22)),((5,17),(8,12),(14,12)),((14,8),(18,6),(20,6)),((22,6),(24,8),(24,8)),((24,8),(26,6),(28,6)),((30,6),(34,8),(34,12)),((40,12),(43,17),(41,22)),((41,24),(42,25),(42,28)),((42,31),(42,34),(38,34)))
        self.add_arc('terminal-left-a',(16,20),(20,20),radius_x=2)
        self.add_arc('terminal-left-b',(20,20),(16,20),radius_x=2)
        self.add_contour('terminal-left','terminal-left-a','terminal-left-b',closed=True)
        self.add_line('trace-left',(18,22),(18,42))
        self.relate('connect','trace-left','terminal-left')
        self.add_arc('terminal-right-a',(28,20),(32,20),radius_x=2)
        self.add_arc('terminal-right-b',(32,20),(28,20),radius_x=2)
        self.add_contour('terminal-right','terminal-right-a','terminal-right-b',closed=True)
        self.add_line('trace-right',(30,22),(30,42))
