"""toilet use right: fresh spacing repair.
Plan: Forward-leaning seated figure, rounded bowl and check mark; head-to-neck distance 13 gives exact 8 centerline clearance.
Keyshape SQUARE: extrema derived from the profile's standard envelope.
Omissions: Narrow tank outline reduced to its back edge; seat and thigh share a single stroke.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('arm',(15,23),(26,26),(22,34))
        for a,b in [('torso','leg'),('tank','seat'),('seat','torso'),('seat','leg'),('leg','bowl'),('torso','arm')]:self.relate('connect',a,b)
