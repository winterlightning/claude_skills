...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('bolt',(28,8),(18,14),(28,14),(26,20))
        self.add_polyline('noise-left',(6,8),(8,12),(6,16))
        self.add_polyline('noise-right',(42,8),(40,12),(42,16))
        self.add_polyline('body',(12,36),(4,36),(4,32),(8,28),(40,28),(44,32),(44,36),(36,36))
        ...
        self.add_contour('car',*(f'body-{j}' for j in range(1,8)),'wheel-right','chassis','wheel-left',closed=True)
