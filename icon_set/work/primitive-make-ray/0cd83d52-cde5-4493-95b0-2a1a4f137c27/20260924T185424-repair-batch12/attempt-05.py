...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('bolt',(24,8),(16,14),(26,14),(26,16))
        self.add_polyline('noise-left',(6,12),(10,16),(6,20))
        self.add_polyline('noise-right',(42,12),(38,16),(42,20))
        self.circle('wheel-left',16,36,4);self.circle('wheel-right',32,36,4)
        self.add_polyline('front',(12,36),(4,36),(4,24),(12,24))
        self.add_polyline('roof',(12,24),(18,22),(30,22),(36,24))
        self.add_polyline('rear',(36,24),(44,24),(44,36),(36,36))
