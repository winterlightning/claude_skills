"""circle-skull-1: Visual review rejected eye-free reduction as headphone-like. Restore identifying eyes; enlarge dome and rebalance cheeks. Preserve readable skull and report spacing blocker rather than approve reduced silhouette.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('eye-left',(19,23),(20,24))
        self.add_line('eye-right',(29,23),(28,24))
