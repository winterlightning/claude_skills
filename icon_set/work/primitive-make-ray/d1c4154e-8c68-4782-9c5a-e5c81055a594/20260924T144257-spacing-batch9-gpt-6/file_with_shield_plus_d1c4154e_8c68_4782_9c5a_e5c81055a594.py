"""file-with-shield-plus: Preserve clipped page, shield and recognizable plus arms in final blocked candidate. Earlier tiny plus lost meaning and nested spacing still failed.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('page',(6,42),(6,6),(34,6),(42,14),(42,42),closed=True)
        ...
        self.add_polyline('plus-h',(22,23),(24,23),(26,23))
        self.add_polyline('plus-v',(24,21),(24,23),(24,25))
