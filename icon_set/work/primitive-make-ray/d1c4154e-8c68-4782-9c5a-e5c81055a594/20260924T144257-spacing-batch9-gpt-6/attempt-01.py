"""file-with-shield-plus: Wider page keyshape funds a larger shield; compact plus retains both arms with real central junction.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('page',(6,42),(6,6),(30,6),(42,18),(42,42),closed=True)
        self.add_line('shield-top',(15,15),(33,15))
        self.add_bezier('shield-right',(33,15),((33,27),(33,30),(24,34)))
        self.add_bezier('shield-left',(24,34),((15,30),(15,27),(15,15)))
        self.add_contour('shield','shield-top','shield-right','shield-left',closed=True)
        self.add_polyline('plus-h',(23,23),(24,23),(25,23))
        self.add_polyline('plus-v',(24,22),(24,23),(24,24))
