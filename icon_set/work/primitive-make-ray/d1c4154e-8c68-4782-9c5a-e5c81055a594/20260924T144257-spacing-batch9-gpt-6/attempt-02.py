...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('page',(6,42),(6,6),(38,6),(42,10),(42,42),closed=True)
        self.add_line('shield-top',(15,14),(33,14))
        self.add_bezier('shield-right',(33,14),((33,27),(33,30),(24,33)))
        self.add_bezier('shield-left',(24,33),((15,30),(15,27),(15,14)))
