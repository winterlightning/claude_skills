"""trash list. Plan: Lucide trash-2 bin and lid; two bullet rows replace three, shared 12-unit row step.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for i,y in enumerate((22,34)): self.add_dot(f'bullet-{i}',(17,y)); self.add_line(f'list-{i}',(25,y),(31,y))
