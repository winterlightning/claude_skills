...
AUTHOR="gpt-6"
PLAN='Two bullet rows replace three; solid dots replace tiny square bullets; broad symmetric bin.'
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for j,y in enumerate((23,33)):
            self.add_dot(f'bullet-{j}',(17,y))
            self.add_line(f'list-{j}',(25,y),(31,y))
