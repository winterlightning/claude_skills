'laptop dollar sign. Restored dollar top/bottom ticks and the laptop base divider. Complete strict candidate remains blocked: dollar bottom and screen divider have only 4 centerline units; lower tick is only 1 unit from divider. Separate 2-unit-spacing proposal saved without approval or validator exception. Construction reference: local Lucide laptop + dollar-sign.'
