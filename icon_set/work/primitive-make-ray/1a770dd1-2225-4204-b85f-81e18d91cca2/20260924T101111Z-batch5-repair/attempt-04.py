...
class PresentationPieChartBadge(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("p-nw", (12,23), (16,19), radius_x=4)
        self.add_arc("p-ne", (16,19), (20,23), radius_x=4)
        self.add_arc("p-se", (20,23), (16,27), radius_x=4)
        self.add_arc("p-sw", (16,27), (12,23), radius_x=4)
        self.add_contour("p-loop", "p-nw", "p-ne", "p-se", "p-sw", closed=True)
        self.add_line("p-stem", (12,23), (12,31))
        self.relate("connect", "p-stem", "p-nw")
        self.relate("connect", "p-stem", "p-sw")
