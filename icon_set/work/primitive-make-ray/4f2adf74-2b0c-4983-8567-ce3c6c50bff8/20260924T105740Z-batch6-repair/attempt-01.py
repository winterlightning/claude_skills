...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('cornice',(6,26),(8,26),(40,26),(42,26))
        self.add_polyline('building',(8,26),(8,42),(20,42),(28,42),(40,42),(40,26));self.relate('connect','building','cornice')
        self.add_arc('door-top',(18,42),(30,42),radius_x=6)
        self.relate('connect','door-top','building')
        for j,x in enumerate((8,28)):
            self.circle('note-'+str(j)+'-left',x,17,2);self.circle('note-'+str(j)+'-right',x+10,17,2)
            n='beam-'+str(j);self.add_polyline(n,(x+2,17),(x+2,6),(x+12,6),(x+12,17))
