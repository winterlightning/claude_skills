...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('play',(20,22),(30,26),(20,30),closed=True)
        self.add_polyline('scan-left',(6,22),(6,16),(10,12))
        self.add_polyline('scan-right',(42,22),(42,16),(38,12))
        self.add_polyline('scan-bottom',(22,39),(24,42),(26,39))
