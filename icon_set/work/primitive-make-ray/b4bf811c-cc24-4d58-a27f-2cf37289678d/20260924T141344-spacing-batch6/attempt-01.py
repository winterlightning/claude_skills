"""trash clock.
Plan: Bin upper-left, enlarged clock lower-right. Clock hands require a 26-unit clock diameter.
Construction: Lucide trash-2 connected bin silhouette; source clock at front.
Omissions: Bin right and lower walls are occluded by the enlarged clock; handle merged with lid.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('lid',(6,14),(12,14),(12,6),(24,6),(24,10))
        self.add_polyline('bin',(6,14),(6,38),(10,42))
        self.relate('connect','lid','bin')
        self.circle('clock',29,29,13)
