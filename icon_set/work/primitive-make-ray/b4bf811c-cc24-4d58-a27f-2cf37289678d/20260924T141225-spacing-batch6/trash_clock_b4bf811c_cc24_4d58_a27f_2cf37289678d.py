"""trash clock.
Symbol plan: Trash bin boundary doubles as the clock enclosure; centered clock hands remain clear.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('bin',(8,12),[('L',(8,38)),('A',(14,44),6,6,False),('L',(34,44)),('A',(40,38),6,6,False),('L',(40,12))])
        self.add_polyline('lid',(8,12),(16,12),(32,12),(40,12))
        self.add_polyline('handle',(16,12),(16,4),(32,4),(32,12))
        self.join('bin','lid');self.join('lid','handle')
        self.add_polyline('hands',(24,22),(24,32),(30,32))
