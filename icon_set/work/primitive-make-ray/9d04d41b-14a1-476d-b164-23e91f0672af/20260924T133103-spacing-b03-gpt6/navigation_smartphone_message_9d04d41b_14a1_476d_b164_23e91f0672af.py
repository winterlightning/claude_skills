...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        # Restore a recognizable pointed pin after rejecting the flattened numeric-pass shape.
        self.add_arc('pin-cap',(20,24),(28,24),radius_x=4)
        self.add_line('pin-right',(28,24),(24,28))
        self.add_line('pin-left',(24,28),(20,24))
