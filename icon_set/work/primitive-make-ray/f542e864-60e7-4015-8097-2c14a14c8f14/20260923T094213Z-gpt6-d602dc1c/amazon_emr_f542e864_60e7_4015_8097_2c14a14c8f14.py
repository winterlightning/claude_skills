...
class AmazonEmr(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("hub-upper", (6, 24), (24, 24), radius_x=9)
        self.add_arc("hub-lower", (24, 24), (6, 24), radius_x=9)
        self.add_contour("hub", "hub-upper", "hub-lower", closed=True)
        self.add_line("plus-horizontal", (13, 24), (17, 24))
        self.add_line("plus-vertical", (15, 22), (15, 26))
