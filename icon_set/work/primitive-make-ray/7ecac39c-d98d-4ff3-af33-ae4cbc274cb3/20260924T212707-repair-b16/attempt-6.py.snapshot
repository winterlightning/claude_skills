...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('b-stem',(12,32),(12,16))
        self.add_arc('b-upper',(12,16),(12,24),radius_x=8,radius_y=4)
        self.add_arc('b-lower',(12,24),(12,32),radius_x=8,radius_y=4)
        self.add_contour('b','b-stem','b-upper','b-lower',closed=True)
        self.add_line('u-left',(21,16),(21,28));self.add_arc('u-bottom',(21,28),(29,28),radius_x=4,sweep=False);self.add_line('u-right',(29,28),(29,16));self.add_contour('u','u-left','u-bottom','u-right')
        self.add_polyline('y-top',(31,16),(35,24),(39,16));self.add_line('y-stem',(35,24),(35,32));self.relate('connect','y-top','y-stem')
