...
class Drawing(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('face-left',(16,10),((5,15),(5,33),(16,38)))
        self.add_bezier('face-right',(32,38),((43,33),(43,15),(32,10)))
        ...
        self.add_bezier('pound-bow',(29,18),((29,12),(20,12),(20,18)))
        self.add_polyline('pound-stem',(20,18),(20,25),(20,34))
        self.add_polyline('pound-bar',(17,25),(20,25),(28,25))
        self.add_polyline('pound-base',(19,34),(20,34),(29,34))
