"""clipboard: complete reference reconstructed on SOLO48.
...
SOURCE_PATH = 'icon_set/work/todo-references/clipboard_8a44db68-8509-4e9a-b460-4143125c86a9.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.rounded_rect('clip',16,4,16,8,4)
