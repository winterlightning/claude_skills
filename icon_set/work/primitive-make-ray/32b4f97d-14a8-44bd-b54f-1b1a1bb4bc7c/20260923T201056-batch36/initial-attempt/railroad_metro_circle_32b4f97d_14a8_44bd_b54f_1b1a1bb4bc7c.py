...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.box('train',15,16,33,34,4)
        self.add_line('window-divider',(15,25),(33,25))
        self.relate('connect','window-divider','train')
        self.add_line('contact-stem',(24,8),(24,16))
        self.add_polyline('contact-bar',(19,8),(24,8),(29,8))
        self.relate('connect','contact-stem','contact-bar')
        self.relate('connect','contact-stem','train')
        self.add_line('rail-left',(19,34),(12,40))
        self.add_line('rail-right',(29,34),(36,40))
