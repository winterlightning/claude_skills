"""A blank notepad bound along its top.

Symbol plan: Three equal binding strokes placed at 8-unit intervals over a rounded page. VRECT_L ink extremes (6,2)-(42,46).
Construction: notebook: equal binding series and rounded page corners.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for i,x in enumerate((16,24,32)):
            self.add_line(f'binding-{i}',(x,4),(x,20))
