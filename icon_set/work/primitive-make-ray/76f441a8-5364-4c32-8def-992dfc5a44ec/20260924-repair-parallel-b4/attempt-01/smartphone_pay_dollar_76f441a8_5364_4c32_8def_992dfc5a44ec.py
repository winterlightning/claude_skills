"""Phone behind a prominent dollar banknote.
Symbol plan: shared contour owners and attachment nodes; repeated marks share a spacing parameter.
Omissions: Banknote corner ornaments and phone footer removed to open the spacing.
Construction: Lucide smartphone and dollar-sign: rounded frame and two-lobe currency stroke.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('phone',(24,42),[('L',(10,42)),('A',(6,38),4,4,True),('L',(6,10)),('A',(10,6),4,4,True)])
        self.box('banknote',16,6,42,34,2)
        self.path('dollar',(33,15),[('L',(28,15)),('A',(28,23),4,4,False),('L',(30,23)),('A',(30,29),3,3,True),('L',(25,29))])
        self.add_line('dollar-top',(29,12),(29,15));self.relate('connect','dollar-top','dollar')
        self.add_line('dollar-bottom',(29,29),(29,31));self.relate('connect','dollar-bottom','dollar')
