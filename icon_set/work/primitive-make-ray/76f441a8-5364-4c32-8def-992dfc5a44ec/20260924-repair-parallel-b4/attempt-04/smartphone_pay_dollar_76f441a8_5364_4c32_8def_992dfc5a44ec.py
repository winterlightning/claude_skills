...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('phone',(20,42),[('L',(10,42)),('A',(6,38),4,4,True),('L',(6,10)),('A',(10,6),4,4,True)])
        self.box('banknote',18,6,42,42,2)
        self.relate('connect','phone','banknote')
        self.path('dollar',(33,16),[('L',(30,16)),('A',(30,24),3,4,False),('A',(30,32),3,4,True),('L',(27,32))])
        self.add_line('dollar-top',(30,15),(30,16));self.relate('connect','dollar-top','dollar')
        self.add_line('dollar-bottom',(30,32),(30,33));self.relate('connect','dollar-bottom','dollar')
