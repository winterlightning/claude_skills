...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('arms',(16,27),(20,24),(24,24),(28,28));self.relate('connect','arms','torso');self.relate('connect','arms','slash')
        self.add_polyline('legs',(16,32),(21,28),(26,34));self.relate('connect','legs','torso')
