...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.circle('head',29,17,2)
        self.add_line('torso',(23,25),(20,29))
        self.add_polyline('arms',(17,25),(23,25),(27,29));self.relate('connect','arms','torso')
        self.add_polyline('legs',(15,34),(20,29),(23,36));self.relate('connect','legs','torso')
