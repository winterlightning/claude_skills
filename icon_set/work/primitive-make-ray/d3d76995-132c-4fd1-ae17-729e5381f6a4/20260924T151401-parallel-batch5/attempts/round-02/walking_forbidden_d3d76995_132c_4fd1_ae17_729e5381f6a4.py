...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('arms',(18,24),(24,24),(28,28));self.relate('connect','arms','torso');self.relate('connect','arms','slash')
        self.add_polyline('legs',(16,33),(21,28),(24,35));self.relate('connect','legs','torso')
