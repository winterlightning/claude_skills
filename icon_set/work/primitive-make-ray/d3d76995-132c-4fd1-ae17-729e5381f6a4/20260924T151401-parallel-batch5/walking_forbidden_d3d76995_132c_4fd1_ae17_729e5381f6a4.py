"""Walking forbidden.
Symbol plan: Final restores CIRCLE radius20 after rounded-square trials. Head30,16 radius2; upper torso24,24->21,28 lies on its axis, giving exact8 centerline/4 ink gap. Circular sign/head gap remains uncertified. One arm and two legs remain.
Omissions: Outline person reduced to stick construction; far arm omitted. Rounded-square sign trial retained in attempts but final restores source circular border.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('slash',(8,12),(24,24),(40,36));self.relate('connect','slash','sign')
