"""walking forbidden. Plan: Shared full_body_ref stick figure inside prohibition ring; head radius2; exact detached8-unit gap to torso start. Preserve slash and walking limbs. Align upper torso vertically beneath head; retain walking hip bend.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('sign',(8,12),[('A',(40,36),20,20,True),('A',(8,12),20,20,True)],True)
        self.add_polyline('slash',(8,12),(24,24),(40,36));self.join('sign','slash')
        self.circle('head',30,16,2)
        self.add_line('torso',(30,26),(30,30))
        self.add_line('hip',(30,30),(24,34));self.join('torso','hip')
        self.add_polyline('arms',(22,26),(30,26),(34,28));self.join('torso','arms')
        self.add_polyline('legs',(18,38),(24,34),(30,38));self.join('hip','legs')
