"""walking forbidden. Plan: Rebalance slash as lower chord to enlarge head space. Head radius3 bottom18 to aligned torso start26 =8. Slash crosses actual hip node24,34.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('sign',(4,24),[('A',(36,40),20,20,True),('A',(4,24),20,20,True)],True)
        self.add_polyline('slash',(4,24),(24,34),(36,40));self.join('sign','slash')
        self.circle('head',24,15,3)
        self.add_line('torso',(24,26),(24,34))
        self.add_polyline('arms',(16,28),(24,26),(32,28));self.join('torso','arms')
        self.add_polyline('legs',(16,38),(24,34),(30,38));self.join('torso','legs');self.join('torso','slash');self.join('legs','slash')
