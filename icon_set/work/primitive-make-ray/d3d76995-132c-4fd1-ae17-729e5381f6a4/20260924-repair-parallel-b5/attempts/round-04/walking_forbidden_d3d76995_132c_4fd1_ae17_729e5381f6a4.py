"""walking forbidden. Plan: Rebalance slash as lower chord to enlarge head space. Head radius3 bottom18 to aligned torso start26 =8. Slash crosses actual hip node24,34. Rebuild full circular contour with split chord endpoints.
