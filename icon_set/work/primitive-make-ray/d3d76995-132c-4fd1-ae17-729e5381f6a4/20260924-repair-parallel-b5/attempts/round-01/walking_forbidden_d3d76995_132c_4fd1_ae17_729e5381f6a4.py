"""walking forbidden. Plan: Shared full_body_ref stick figure inside prohibition ring; head radius2; exact detached8-unit gap to torso start. Preserve slash and walking limbs.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('torso',(30,26),(24,34))
        self.add_polyline('arms',(22,26),(30,26),(34,28));self.join('torso','arms')
        self.add_polyline('legs',(18,38),(24,34),(30,38));self.join('torso','legs')
