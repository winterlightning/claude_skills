"""walking forbidden. Plan: Rebalance slash as lower chord to enlarge head space. Head radius3 bottom18 to aligned torso start26 =8. Slash crosses actual hip node24,34. Rebuild full circular contour with split chord endpoints. Lower head/neck together by1; omit rear arm; spread stride away from slash.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('arms',(24,27),(32,27));self.join('torso','arms')
