...
AUTHOR="gpt-6"
PLAN='Compact stick figure and diagonal prohibition retained; slash/head clearance and slash/leg spacing remain blocked. Readable diagonal version selected after six attempted repairs.'
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.circle('head',24,14,2)
        self.add_line('torso',(24,24),(24,30))
        self.add_polyline('arms',(16,26),(24,24),(32,26))
