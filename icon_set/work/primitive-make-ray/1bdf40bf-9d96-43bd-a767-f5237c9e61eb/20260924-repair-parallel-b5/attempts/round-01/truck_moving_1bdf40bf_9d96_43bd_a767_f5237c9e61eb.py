"""truck moving. Plan: House on cargo truck; minimal roof/walls, no small door; matching wheels.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('house',(8,24),(8,16),(18,6),(28,16),(28,24))
        self.add_polyline('cargo',(6,24),(8,24),(28,24),(30,24),(30,34),(6,34),(6,24))
        self.join('house','cargo')
        self.add_polyline('cab',(30,24),(36,24),(42,30),(42,36),(36,36))
        self.join('cargo','cab')
        for name,x in [('left',14),('right',36)]:self.circle('wheel-'+name,x,39,3)
        self.add_line('chassis',(14,36),(30,36))
        self.join('chassis','wheel-left');self.join('cab','wheel-right')
