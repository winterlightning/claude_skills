...
class Drawing(Solo48):
    ...
    def build(self):
        for i,x in enumerate((12,24,36)):
         self.add_polyline(f'star-{i}',(x,12),(x+3,20),(x+6,22),(x+4,26),(x+5,32),(x,29),(x-5,32),(x-4,26),(x-6,22),(x-3,20),closed=True)
        self.relate('connect','star-0','star-1');self.relate('connect','star-1','star-2')
