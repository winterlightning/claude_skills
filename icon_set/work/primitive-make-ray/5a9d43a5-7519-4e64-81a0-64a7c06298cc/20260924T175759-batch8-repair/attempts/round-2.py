...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.rounded('paper',6,6,42,42,4)
        self.add_polyline('r-stem',(14,30),(14,22),(14,14),(20,14))
        self.add_arc('r-bowl',(20,14),(20,22),radius_x=4)
        self.add_line('r-return',(20,22),(14,22))
        for a,b in [('r-stem','r-bowl'),('r-stem','r-return'),('r-bowl','r-return')]:self.relate('connect',a,b)
        self.add_polyline('rx-down',(20,22),(28,30),(32,34))
        self.add_polyline('rx-up',(24,34),(28,30),(32,26))
