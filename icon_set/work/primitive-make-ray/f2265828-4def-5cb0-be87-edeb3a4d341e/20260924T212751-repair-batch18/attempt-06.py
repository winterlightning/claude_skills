...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_bezier('vertical',(24,4),((36,4),(30,15),(30,21)),((30,23),(30,25),(30,27)),((30,33),(36,44),(24,44)),((12,44),(18,33),(18,27)),((18,25),(18,23),(18,21)),((18,15),(12,4),(24,4)))
        self.add_bezier('diagonal-a',(7,14),((10,4),(19,15),(24,18)),((26,19),(28,20),(30,21)),((35,24),(46,29),(41,34)),((38,44),(29,33),(24,30)),((22,29),(20,28),(18,27)),((13,24),(2,19),(7,14)))
        self.add_bezier('diagonal-b',(41,14),((46,19),(35,24),(30,27)),((28,28),(26,29),(24,30)),((19,33),(10,44),(7,34)),((2,29),(13,24),(18,21)),((20,20),(22,19),(24,18)),((29,15),(38,4),(41,14)))
        self.relate('connect','vertical','diagonal-a','diagonal-b')
        self.add_dot('nucleus',(24,24))

# Final broad-lobe candidate retains the nucleus as a separate dot.
