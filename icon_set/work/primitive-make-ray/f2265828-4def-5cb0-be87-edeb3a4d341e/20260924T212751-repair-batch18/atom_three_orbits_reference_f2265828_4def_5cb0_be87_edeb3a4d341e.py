"""An atom with three crossing orbits and a central nucleus.
Symbol plan and construction: atom: coherent crossing elliptical contours; source requires three orbits.
Keyshape: CIRCLE allows the three orbit directions their radial reach.
Omissions: Nucleus outline simplified to a solid dot. All three orbits retained.
Review: Blocked: six enclosed orbit pockets remain undersized. Shared crossing nodes are explicit and genuine; no false connections used. Enlarged lobes and alternate centre spacing were tried; final selects the balanced in-bounds candidate."""
