"""trash can list. Plan: Lucide trash-2 continuous bin and open lid; two well-spaced list lines replace three; handle shares lid nodes.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('handle',(16,12),[('L',(16,8)),('A',(20,4),4,4,True),('L',(28,4)),('A',(32,8),4,4,True),('L',(32,12))]);self.join('lid','handle')
        self.path('bin',(8,12),[('L',(8,40)),('A',(12,44),4,4,False),('L',(36,44)),('A',(40,40),4,4,False),('L',(40,12))]);self.join('lid','bin')
        for i,y in enumerate((22,34)): self.add_line(f'list-{i}',(18,y),(30,y))
