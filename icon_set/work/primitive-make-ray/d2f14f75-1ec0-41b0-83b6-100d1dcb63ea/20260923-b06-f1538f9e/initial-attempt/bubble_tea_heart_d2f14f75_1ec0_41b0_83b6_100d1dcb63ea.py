...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path("cup",(8,12),[("L",(12,40)),
            ("A",(16,44),4,4,False),("L",(32,44)),
            ("A",(36,40),4,4,False),("L",(40,12))])
        self.relate("connect","cup","lid")
        self.path("heart",(24,25),[("A",(16,25),4,4,False),
            ("A",(17,29),6,6,False),("L",(24,36)),
            ("L",(31,29)),("A",(32,25),6,6,False),
            ("A",(24,25),4,4,False)],True)
