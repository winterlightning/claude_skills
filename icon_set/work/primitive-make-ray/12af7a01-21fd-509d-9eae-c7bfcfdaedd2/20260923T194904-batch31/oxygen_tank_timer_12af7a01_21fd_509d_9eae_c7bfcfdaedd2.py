...
class Drawing(Solo48):
    ...
    def build(self):
        self.box('tank',6,22,22,42,4)
        self.add_polyline('neck',(10,22),(10,14),(14,14),(18,14),(18,18),(18,22))
        self.relate('connect','tank','neck')
        self.add_line('valve',(14,6),(14,14))
        self.relate('connect','valve','neck')
        self.add_polyline('valve-handle',(10,6),(14,6),(18,6))
        self.relate('connect','valve','valve-handle')
        self.add_line('hose',(18,18),(26,18))
        self.relate('connect','hose','neck')
        self.circle('gauge',34,18,8)
        self.relate('connect','hose','gauge')
        self.add_polyline('gauge-hands',(34,14),(34,18),(38,18))
