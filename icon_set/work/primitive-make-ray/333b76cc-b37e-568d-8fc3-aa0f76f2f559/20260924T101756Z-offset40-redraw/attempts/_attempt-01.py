...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        path('profile',(16,44),[('L',(16,37)),('C',(8,22),(10,30),(8,26)),('A',(26,4),18,18,True),('C',(36,10),(31,4),(34,7))])
        path('visor',(30,12),[('L',(37,12)),('A',(40,15),3,3,True),('L',(40,23)),('A',(37,26),3,3,True),('L',(30,26)),('A',(23,19),7,7,True),('A',(30,12),7,7,True)],True)
        line('strap',(8,22),(23,19));join('strap','profile');join('strap','visor')
        path('face',(36,26),[('L',(38,33)),('L',(32,33)),('L',(32,36)),('A',(28,40),4,4,True),('L',(25,40)),('L',(25,44))]);join('face','visor')
