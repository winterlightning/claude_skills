...
class Drawing(Solo48):
    ...
    def build(self):
        # Rounded square card encloses circular head, bowed arms and short vertical torso. Axis24; bounds6/42. Head cy17 r3; torso starts28: exact head-to-torso ink gap4.
        ...
        circle('head',24,17,3)
        self.add_arc('arm-left',(14,24),(24,28),radius_x=10,radius_y=4,sweep=False)
        self.add_arc('arm-right',(24,28),(34,24),radius_x=10,radius_y=4,sweep=False)
