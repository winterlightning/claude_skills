"""user drop zone 1. Plan: Two connected nodes beside a circled P; enlarge central circle and rebalance the letter.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for name,y in [('upper',11),('lower',37)]:
            self.circle('node-'+name,41,y,3)
            self.add_line('link-'+name,(20,8 if y==11 else 40),(41,8 if y==11 else 40))
            self.join('link-'+name,'main');self.join('link-'+name,'node-'+name)
        self.add_polyline('p-stem',(16,30),(16,26),(16,18),(20,18))
        self.path('p-bowl',(20,18),[('A',(20,26),4,4,True),('L',(16,26))]);self.join('p-stem','p-bowl')
