"""user drop zone 1. Plan: Enlarge main and P opening, smaller complete circular nodes, outward branch junctions. Recenter P stem.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('p-stem',(17,31),(17,27),(17,17),(20,17))
        self.path('p-bowl',(20,17),[('A',(20,27),5,5,True),('L',(17,27))]);self.join('p-stem','p-bowl')
