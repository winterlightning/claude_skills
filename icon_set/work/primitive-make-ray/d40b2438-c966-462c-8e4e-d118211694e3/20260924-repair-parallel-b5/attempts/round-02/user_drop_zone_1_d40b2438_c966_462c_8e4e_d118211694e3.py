"""user drop zone 1. Plan: Rebalance main left; diagonal links to node left endpoints open node spacing.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.circle('main',18,24,14)
        for name,y in [('upper',11),('lower',37)]:
            self.circle('node-'+name,41,y,3)
            self.add_line('link-'+name,(18,10 if y==11 else 38),(38,y))
