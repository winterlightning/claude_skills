"""A curved leaf and its diagonal vein are contained in a house.
...
SOURCE_ICON_ID='095fe804-eb94-45af-aa66-9fa427a386a8'
SOURCE_PATH='icon_set/work/todo-references/house leaf_095fe804-eb94-45af-aa66-9fa427a386a8.svg'
AUTHOR='gpt-6'
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.house()
        self.add_bezier('leaf-top',(16,33),((11,22),(24,24),(30,21)))
        self.add_bezier('leaf-bottom',(30,21),((32,31),(25,34),(16,33)))
        self.add_contour('leaf','leaf-top','leaf-bottom',closed=True)
        self.add_polyline('vein',(15,33),(16,33),(25,27))
        self.relate('connect','leaf','vein')

# Final visible envelope: (4,4)-(44,44)
# Visual review: Leaf and rising vein read clearly; natural directional asymmetry is retained.
