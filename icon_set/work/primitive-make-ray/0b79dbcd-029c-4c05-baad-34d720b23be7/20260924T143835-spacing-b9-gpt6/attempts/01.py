...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        pts=[(21,17),(27,17),(29,21),(24,26),(19,21)]
        for i in range(5): self.add_arc(f'bug-{i}',pts[i],pts[(i+1)%5],radius_x=5)
        self.add_contour('bug',*(f'bug-{i}' for i in range(5)),closed=True)
        for i,(a,b) in enumerate([((21,17),(19,15)),((27,17),(29,15)),((19,21),(15,21)),((29,21),(33,21))]):
