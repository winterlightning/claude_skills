"""mail-card-bug: Widen card; remove bug divider, lower legs and envelope seam strokes. Four legs and round bug body remain; flap and card share actual nodes.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('envelope',(6,26),(6,42),(42,42),(42,26))
        self.add_polyline('flap',(6,26),(9,29),(18,34),(30,34),(39,29),(42,26))
        self.add_polyline('card',(9,29),(9,6),(39,6),(39,29))
        self.relate('connect','envelope','flap')
        self.relate('connect','flap','card')
