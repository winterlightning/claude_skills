"""video game control directions. Plan: Simplify enclosures and use open directional cross; enlarged rounded A and B counters retain both labels and relative positions.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('a',(6,42),[('L',(6,34)),('L',(6,26)),('A',(18,26),6,6,True),('L',(18,34)),('L',(18,42))])
        self.add_line('a-bar',(6,34),(18,34));self.join('a','a-bar')
        self.add_polyline('b-stem',(28,6),(28,16),(28,26))
        self.path('b-outline',(28,6),[('L',(37,6)),('A',(37,16),5,5,True),('A',(37,26),5,5,True),('L',(28,26))]);self.join('b-stem','b-outline')
        self.add_line('b-middle',(28,16),(37,16));self.join('b-stem','b-middle');self.join('b-outline','b-middle')
        self.cross('pad',38,38,4)
