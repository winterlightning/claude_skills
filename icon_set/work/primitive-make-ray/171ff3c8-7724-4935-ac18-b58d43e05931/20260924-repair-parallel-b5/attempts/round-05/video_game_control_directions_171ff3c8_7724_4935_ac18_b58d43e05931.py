"""video game control directions. Plan: Separate circular buttons on a wider diagonal; recenter labels within their owners.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.circle('button-a',14,30,8);self.circle('button-b',34,14,8)
        self.letter_a('a',(14,24),(10,36),(18,36),(12,30),(16,30))
        self.path('b',(34,6),[('L',(34,14)),('L',(34,22)),('L',(34,22)),('A',(34,14),4,4,False),('L',(34,14))])
        self.path('b-top',(34,6),[('L',(34,6)),('A',(34,14),4,4,True)]);self.join('b','b-top')
