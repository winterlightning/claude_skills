"""video game control directions. Plan: Enlarge button openings to20 diameter inside square extremes.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.circle('button-a',16,30,10);self.circle('button-b',32,16,10)
