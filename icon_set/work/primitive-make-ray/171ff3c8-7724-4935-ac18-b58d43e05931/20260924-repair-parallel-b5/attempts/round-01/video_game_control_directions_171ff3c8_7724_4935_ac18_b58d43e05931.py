"""video game control directions. Plan: Larger A/B controls with B horizontals8 apart; omit pad center circle as minor detail. Preserve two buttons and outlined direction pad.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.circle('button-a',14,28,8);self.circle('button-b',30,14,8)
        self.letter_a('a',(14,22),(10,34),(18,34),(12,28),(16,28))
        self.path('b',(26,6),[('L',(26,14)),('L',(26,22)),('L',(30,22)),('A',(30,14),4,4,False),('L',(26,14))])
        self.path('b-top',(26,6),[('L',(30,6)),('A',(30,14),4,4,True)]);self.join('b','b-top')
