...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('hull',(6,30),[('L',(18,30)),('L',(30,30)),('A',(18,34),12,4,True),('A',(6,30),12,4,True)],True)
        ...
        self.path('transfer-bottom',(6,40),[('A',(18,42),12,2,False)])
        self.add_polyline('arrow-bottom',(14,38),(18,42),(14,42));self.relate('connect','transfer-bottom','arrow-bottom')
