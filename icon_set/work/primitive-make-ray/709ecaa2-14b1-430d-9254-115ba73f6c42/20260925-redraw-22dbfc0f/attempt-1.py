...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.box("cap",14,4,20,16,4)
        self.add_line("cross-h",(20,12),(28,12));self.add_line("cross-v",(24,8),(24,16));self.relate("connect","cross-h","cross-v")
        self.add_arc("jaw",(14,20),(34,20),radius_x=10,sweep=False);self.relate("connect","jaw","cap")
