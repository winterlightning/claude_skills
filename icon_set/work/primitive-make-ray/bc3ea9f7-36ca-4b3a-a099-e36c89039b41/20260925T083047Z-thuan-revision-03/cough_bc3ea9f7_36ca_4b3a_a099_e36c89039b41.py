"""A left-facing human head profile with forehead, nose, chin and short neck. Restore the source profile without the extra cough rays.
Construction: Shared human_ref/user.svg informs a round cranium; no detached head or torso, so head/body clearance is inapplicable. Source owns profile anatomy.
