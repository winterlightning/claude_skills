...
AUTHOR='gpt-6'
PLAN='Sass script with expanded upper loop and exactly circular lower loop; true shared attachment24,31 and open terminal.'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('script',(24,22),((32,24),(35,13),(28,13)),((23,13),(15,18),(15,22)),((15,25),(24,26),(24,31)))
        self.circle('lower-loop',21,31,3)
        self.add_bezier('terminal',(24,31),((29,27),(33,29),(31,33)))
        self.relate('connect','script','lower-loop');self.relate('connect','terminal','lower-loop');self.relate('connect','terminal','script')
