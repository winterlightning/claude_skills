"""Mobile Phone with Pound Sign. Rounded phone, restored bottom band, and recognizable sterling hook and baseline.
...
AUTHOR = 'gpt-6'
PLAN = 'Rounded phone, restored bottom band, and recognizable sterling hook and baseline.'
OMISSIONS = 'None.'
CONSTRUCTION_REFERENCES = ['smartphone']
PARENT_MODULE = 'icon_set/model/icons/solo/mobile_phone_pound_sign_a70db137_a446_4f4c_b656_4fea14660981.py'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.phone()
        self.path('pound',(29,17),[('A',(21,17),4,4,False),('L',(21,22)),('L',(21,25)),('C',(18,28),(21,27),(20,28))])
        self.add_polyline('pound-cross',(17,22),(21,22),(28,22))
