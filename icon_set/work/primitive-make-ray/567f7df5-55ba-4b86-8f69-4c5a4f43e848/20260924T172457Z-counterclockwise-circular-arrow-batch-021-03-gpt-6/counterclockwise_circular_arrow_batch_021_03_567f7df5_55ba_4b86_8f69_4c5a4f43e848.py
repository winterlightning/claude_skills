"""counterclockwise-circular-arrow-batch-021-03: A single smooth near-circular counterclockwise orbit ends in a balanced downward V head; lower-left opening retained.
...
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__counterclockwise-circular-arrow-batch-021-03/20260924T172457Z-thuan-mac/reference/go backward_567f7df5-55ba-4b86-8f69-4c5a4f43e848.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    ...
    category = 'objects'
    aliases = ()
    keywords = ('counterclockwise', 'circular', 'arrow', 'batch', '021', '03')
    def build(self):
