...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('female-bowl',(30,16),[('A',(42,22),12,6,True),('A',(30,28),12,6,True)])
        self.add_polyline('female-stem',(30,16),(36,10),(40,6))
        self.add_polyline('female-cross',(32,6),(36,10),(40,14))
        self.relate('connect','female-stem','female-cross')
        self.relate('connect','female-stem','female-bowl')
