...
class Drawing(Solo48):
    icon_id = 'person-with-side-parted-bob'
    ...
    def build(self):
        self.path('hair',(12,27),[('C',(8,25),(10,27),(8,27)),('L',(8,20)),('A',(24,4),16,16,True),('A',(40,20),16,16,True),('L',(40,25)),('C',(36,27),(40,27),(38,27))])

        # Shared human vocabulary: radius8 circular jaw; bottom28, shoulders36 => 4u ink gap.
        self.path('fringe',(16,20),[('C',(27,12),(21,19),(25,16)),('C',(32,20),(27,16),(29,19))])
