...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('body',(12,16),[('L',(16,16)),('L',(32,16)),('L',(36,16)),('A',(40,20),4,4,True),('L',(40,44)),('C',(24,40),(36,40),(30,40)),('C',(8,44),(18,40),(12,40)),('L',(8,20)),('A',(12,16),4,4,True)],True)
        self.path('shackle',(16,16),[('L',(16,12)),('A',(32,12),8,8,True),('L',(32,16))]);self.relate('connect','shackle','body')
        self.circle('head',24,28,4)
        # Head bottom 32; shoulder crest 40: exact 8 centerline / 4 ink gap.
