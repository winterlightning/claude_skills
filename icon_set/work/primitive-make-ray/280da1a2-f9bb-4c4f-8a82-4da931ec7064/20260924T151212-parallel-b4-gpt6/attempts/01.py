"""tag yuan: fresh spacing repair.
Plan: Widen the clipped-corner price tag and use a single-stroke yuan mark with crossbars 8 apart.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('tag',(6,22),[('L',(22,6)),('L',(42,6)),('L',(42,38)),('A',(38,42),4),('L',(10,42)),('A',(6,38),4),('L',(6,22))],True)
