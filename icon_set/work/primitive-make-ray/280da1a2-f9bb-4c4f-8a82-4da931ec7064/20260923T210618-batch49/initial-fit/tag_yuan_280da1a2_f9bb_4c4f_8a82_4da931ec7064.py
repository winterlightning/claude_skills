...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('yuan-fork',(18,23),(23,30),(28,23))
        self.add_polyline('yuan-stem',(23,30),(23,35),(23,38))
        for n,y in [('upper',30),('lower',35)]:
            self.add_polyline(n,(18,y),(23,y),(28,y))
