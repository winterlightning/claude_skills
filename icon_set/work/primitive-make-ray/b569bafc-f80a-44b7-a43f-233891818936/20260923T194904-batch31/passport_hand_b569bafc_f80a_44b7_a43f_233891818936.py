...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        nodes=[(24,18),(32,22),(34,28),(32,34),(24,38),(16,34),(14,28),(16,22)]
        for i,a in enumerate(nodes):self.add_arc(f'globe-{i}',a,nodes[(i+1)%8],radius_x=10)
        self.add_contour('globe',*[f'globe-{i}' for i in range(8)],closed=True)
        self.circle('meridian',24,28,4,10)
        self.relate('connect','meridian','globe')
        for i,y in enumerate((22,34)):
            self.add_line(f'latitude-{i}',(16,y),(32,y))
            self.relate('connect',f'latitude-{i}','globe')
            self.relate('connect',f'latitude-{i}','meridian')
