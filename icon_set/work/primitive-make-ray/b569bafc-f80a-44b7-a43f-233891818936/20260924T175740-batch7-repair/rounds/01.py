...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        nodes=[(16,28),(24,20),(32,28),(24,36)]
        for i,a in enumerate(nodes):self.add_arc(f'globe-{i}',a,nodes[(i+1)%4],radius_x=8)
        self.add_contour('globe',*[f'globe-{i}' for i in range(4)],closed=True)
        self.add_polyline('equator',(16,28),(24,28),(32,28))
        self.add_polyline('meridian',(24,20),(24,28),(24,36))
