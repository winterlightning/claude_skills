...
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__outward-arrows-from-divider-solo-b014/20260924T111035Z-thuan-mac/reference/expand horizontal 2_3cd9562a-4ab1-4edc-bc5f-dd0abab98a01.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    ...
    def build(self):
        ...
        def point(x,y):return (y,x) if False else (x,y)
