"""text options.
Symbol plan: Large A above open dropdown; remove top dropdown wall for a broad open field.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.letter_a('a',(24,6),(14,25),(34,25),(19,16),(29,16))
        self.add_polyline('dropdown',(6,34),(6,42),(42,42),(42,34))
        self.add_polyline('chevron',(20,34),(24,38),(28,34))
