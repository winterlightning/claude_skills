"""turn 1. Plan: Diamond sign preserves opposed turn arrows; open stroke arrows replace narrow outlined route. Enlarge diamond to radial keyshape. Rebalance arrow branches inward.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('right',(24,20),(28,20));self.add_line('left',(24,28),(20,28))
        self.add_polyline('right-tip',(26,18),(28,20),(26,22));self.add_polyline('left-tip',(22,26),(20,28),(22,30))
