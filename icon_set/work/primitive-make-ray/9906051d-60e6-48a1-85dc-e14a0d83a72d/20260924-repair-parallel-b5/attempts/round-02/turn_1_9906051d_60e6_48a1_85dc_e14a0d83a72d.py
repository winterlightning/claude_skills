"""turn 1. Plan: Diamond sign preserves opposed turn arrows; open stroke arrows replace narrow outlined route. Enlarge diamond to radial keyshape.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('right',(24,20),(30,20));self.add_line('left',(24,28),(18,28))
        self.add_polyline('right-tip',(27,17),(30,20),(27,23));self.add_polyline('left-tip',(21,25),(18,28),(21,31))
