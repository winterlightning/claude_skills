...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('right-turn',(24,20),(29,20),(27,18));self.relate('connect','route','right-turn')
        self.add_polyline('left-turn',(24,28),(19,28),(21,30));self.relate('connect','route','left-turn')
