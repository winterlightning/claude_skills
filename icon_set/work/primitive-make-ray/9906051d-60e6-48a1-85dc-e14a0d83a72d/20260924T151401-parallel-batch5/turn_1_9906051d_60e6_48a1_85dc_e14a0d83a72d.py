"""Turn 1.
Symbol plan: CIRCLE radial envelope20 about24,24 holds a diamond with extremes4,4..44,44. Single vertical route and opposing short branches retain the staggered junction.
Omissions: Double route outline and short arrowhead returns removed; opposing turn branches retained.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('right-turn',(24,20),(28,20));self.relate('connect','route','right-turn')
        self.add_line('left-turn',(24,28),(20,28));self.relate('connect','route','left-turn')
