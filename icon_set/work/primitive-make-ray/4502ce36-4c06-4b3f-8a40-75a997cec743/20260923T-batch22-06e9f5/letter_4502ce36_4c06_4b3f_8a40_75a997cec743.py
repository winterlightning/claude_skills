"""letter, complete SOLO48 composition.
Symbol plan is recorded in build(). Visible keyshape extremes: (2, 6, 46, 42).
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48
SOURCE_ICON_ID = '4502ce36-4c06-4b3f-8a40-75a997cec743'
SOURCE_PATH = 'icon_set/work/todo-references/letter_4502ce36-4c06-4b3f-8a40-75a997cec743.svg'
AUTHOR = "gpt-6"
...
class Drawing(Solo48):
    ...
    def build(self):
        # Rectangular envelope with four short diagonal corner-fold strokes.
        self.add_polyline('envelope',(4,8),(44,8),(44,40),(4,40),closed=True)
        for i,(a,b) in enumerate((((4,8),(12,14)),((44,8),(36,14)),((4,40),(12,34)),((44,40),(36,34)))):
            self.add_line('fold-'+str(i),a,b)
            self.relate('connect','envelope','fold-'+str(i))
