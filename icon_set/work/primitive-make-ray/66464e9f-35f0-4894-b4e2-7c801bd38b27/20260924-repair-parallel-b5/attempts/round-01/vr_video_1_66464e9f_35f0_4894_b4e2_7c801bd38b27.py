"""vr video 1. Plan: Stylus above cube, goggles in foreground; cube wall ends at actual goggle top node. Omit crowded rim and lens circles; preserve nose bridge.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('cube-right',(30,22),(30,28));self.join('cube-top','cube-right')
