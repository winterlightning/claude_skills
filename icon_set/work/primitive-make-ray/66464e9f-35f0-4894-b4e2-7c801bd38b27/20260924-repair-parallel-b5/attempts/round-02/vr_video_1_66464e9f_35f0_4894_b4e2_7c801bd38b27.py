"""vr video 1. Plan: Stylus above cube, goggles in foreground; cube wall ends at actual goggle top node. Omit crowded rim and lens circles; preserve nose bridge. Raise cube top away from goggle junction.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('cube-top',(24,16),(30,18),(18,26));self.join('cube-left','cube-top')
        self.add_line('cube-right',(30,18),(30,28));self.join('cube-top','cube-right')
