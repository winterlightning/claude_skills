...
Plan: Lucide smartphone rounded rectangle with true lower-band endpoint joins; plus has four spokes joined at a shared central node.
Keyshape VRECT_L: extrema derived from the profile's standard envelope.
Omissions: Secondary circle bezel omitted to preserve a clear plus inside the phone.
"""
