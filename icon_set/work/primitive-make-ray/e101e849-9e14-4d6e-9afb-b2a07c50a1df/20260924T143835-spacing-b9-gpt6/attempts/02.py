...
Plan: Rounded phone frame surrounds a complete circled plus. Exact straight-wall clearance8 and circle-to-plus margin9 preserve all nested symbols.
Keyshape SQUARE: extrema derived from the profile's standard envelope.
Omissions: Phone widened to the square keyshape; bottom separator omitted; plus shortened.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        # Wider phone body gives the circle and plus independent clear space.
