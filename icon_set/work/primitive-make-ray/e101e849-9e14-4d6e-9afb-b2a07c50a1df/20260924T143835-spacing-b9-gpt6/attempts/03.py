...
Plan: Preserve source nesting and upright phone. Expanded circle tests the remaining width and lower-band limits.
Keyshape VRECT_L: extrema derived from the profile's standard envelope.
Omissions: Plus shortened and circle enlarged; complete phone, circle and plus retained.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.phone()
        self.circle('add-circle',24,20,9)
        self.cross('plus',24,20,2)
