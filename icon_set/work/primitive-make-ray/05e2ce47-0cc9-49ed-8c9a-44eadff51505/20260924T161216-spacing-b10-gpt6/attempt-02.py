"""mobile phone wrench. Open circular jaws and diagonal shaft; shared nodes at both jaw apices.
...
Omissions: Phone separator omitted.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('jaw-bottom-a',(17,31),(21,27),radius_x=4)
        self.add_arc('jaw-bottom-b',(21,27),(25,31),radius_x=4)
        self.add_contour('jaw-bottom','jaw-bottom-a','jaw-bottom-b')
        self.add_line('shaft',(21,27),(27,17))
        self.add_arc('jaw-top-a',(23,13),(27,17),radius_x=4,sweep=False)
        self.add_arc('jaw-top-b',(27,17),(31,13),radius_x=4,sweep=False)
