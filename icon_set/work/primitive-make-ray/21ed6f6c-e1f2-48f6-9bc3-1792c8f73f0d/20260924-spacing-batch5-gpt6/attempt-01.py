"""Rating basket with three raised sparkle marks. Lucide shopping-basket informs trapezoid and handles. Reduce tiny closed star holes to open four-ray sparkle marks; omit basket ribs.
...
class Drawing(Solo48):
    ...
    def build(self):
        for n,x,y in [('left',9,13),('middle',24,9),('right',39,13)]:self.cross(n,x,y,3)
        self.add_polyline('basket',(6,27),(12,42),(36,42),(42,27),(34,27),(14,27),closed=True)
