...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('outer-ridge',(15,23),(33,23),radius_x=9)
        self.add_arc('inner-arch',(21,26),(27,26),radius_x=3)
        self.add_bezier('inner-left',(21,26),((21,27),(20,27),(18,28)))
        self.add_bezier('inner-right',(27,26),((27,27),(28,27),(30,28)))
        self.relate('connect','inner-arch','inner-left')
        self.relate('connect','inner-arch','inner-right')
        self.add_line('center-ridge',(24,28),(24,29))
