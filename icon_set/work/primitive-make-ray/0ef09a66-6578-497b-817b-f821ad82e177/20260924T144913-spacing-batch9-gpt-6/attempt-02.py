...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('outer-ridge',(17,21),(31,21),radius_x=7)
        self.add_arc('inner-arch',(19,24),(29,24),radius_x=5)
        self.add_bezier('inner-left',(19,24),((19,29),(18,29),(18,30)))
        self.add_bezier('inner-right',(29,24),((29,29),(30,29),(30,30)))
        self.relate('connect','inner-arch','inner-left')
        self.relate('connect','inner-arch','inner-right')
        self.add_line('center-ridge',(24,26),(24,31))
