...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('inner-arch',(19,25),(29,25),radius_x=5)
        self.add_bezier('inner-left',(19,25),((19,29),(18,29),(18,30)))
        self.add_bezier('inner-right',(29,25),((29,29),(30,29),(30,30)))
        self.relate('connect','inner-arch','inner-left')
        self.relate('connect','inner-arch','inner-right')
        self.add_line('center-ridge',(24,27),(24,31))
