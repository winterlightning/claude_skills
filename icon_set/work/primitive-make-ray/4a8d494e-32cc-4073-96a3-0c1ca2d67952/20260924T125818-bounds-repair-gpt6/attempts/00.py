...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('barrel',(22,10),(38,6),(42,18),(26,22),(22,10),closed=True)
        self.add_polyline('eyepiece',(22,10),(12,14),(16,26),(26,22))
        self.relate('connect','barrel','eyepiece')
        self.add_polyline('tripod',(14,42),(26,22),(28,42))
        self.relate('connect','barrel','tripod')
        for name,x,y in [('star-left',10,10),('star-right',38,34)]:
