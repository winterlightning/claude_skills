...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.relate('connect','screen','stand');self.relate('connect','stand','foot')
        self.add_bezier('dollar-upper',(25,14),((15,10),(14,19),(21,20)))
        self.add_bezier('dollar-lower',(21,20),((28,21),(27,30),(17,26)))
        self.add_contour('dollar','dollar-upper','dollar-lower')
        self.add_line('stem-top',(21,10),(21,13))
        self.add_line('stem-bottom',(21,27),(21,30))
