...
AUTHOR='gpt-6'
PLAN='Fragile parcel retains dominant glass handling symbol in square carton. Packing ribbon and redundant upward arrow omitted to open spacing. SQUARE6,6–42,42; shared glass axis24 and radius8 bowl.'
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('bowl-upper',(16,18),(16,14),(32,14),(32,18))
        self.add_arc('bowl-lower-right',(32,18),(24,26),radius_x=8)
        self.add_arc('bowl-lower-left',(24,26),(16,18),radius_x=8)
        self.add_contour('glass','bowl-upper','bowl-lower-right','bowl-lower-left',closed=True)
