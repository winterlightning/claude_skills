...
class Drawing(Solo48):
    ...
    def build(self):
        self.box('frame',4,10,40,28,3)
        self.add_polyline('l',(12,16),(12,32),(15,32))
        self.add_line('i',(21,16),(21,32))
        self.add_polyline('k-stem',(27,16),(27,24),(27,32))
        self.add_polyline('k-arms',(32,16),(27,24),(32,32))
        self.relate('connect','k-stem','k-arms')
        self.add_polyline('e',(39,16),(36,16),(36,24),(36,32),(39,32))
        self.add_line('e-middle',(36,24),(39,24))
