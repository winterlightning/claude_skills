...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('k-stem',(28,16),(28,24),(28,32))
        self.add_polyline('k-arms',(32,16),(28,24),(32,32))
        self.relate('connect','k-stem','k-arms')
        self.add_polyline('e',(40,16),(36,16),(36,24),(36,32),(40,32))
        self.add_line('e-middle',(36,24),(40,24))
