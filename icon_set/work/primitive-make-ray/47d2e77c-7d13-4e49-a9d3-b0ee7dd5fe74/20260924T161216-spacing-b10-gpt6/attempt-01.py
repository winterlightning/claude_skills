"""monitor globe. Larger vertical content band and one equator instead of two parallels.
...
Omissions: Second latitude omitted.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('meridian',(24,13),(24,20),(24,27))
        self.add_polyline('equator',(17,20),(24,20),(31,20))
