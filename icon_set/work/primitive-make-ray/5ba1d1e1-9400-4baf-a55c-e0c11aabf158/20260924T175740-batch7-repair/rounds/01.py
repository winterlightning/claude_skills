...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('arm-right',(24,22),(29,28),(32,28));self.relate('connect','torso','arm-right')
        self.add_polyline('arm-left',(24,22),(12,25),(12,28));self.relate('connect','torso','arm-left')
        self.box('bag',8,28,8,10,2);self.relate('connect','bag','arm-left')
        self.add_polyline('legs',(16,44),(24,32),(34,44));self.relate('connect','torso','legs')
