...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.circle('head',22,11,5)
        self.add_line('torso',(22,24),(22,32))
        self.add_line('arm-right',(22,24),(32,24));self.relate('connect','torso','arm-right')
        self.add_line('arm-left',(22,24),(14,28));self.relate('connect','torso','arm-left');self.relate('connect','arm-left','arm-right')
        ...
        self.add_polyline('plane-spine',(36,6),(36,10),(36,14))
        self.add_polyline('wings',(35,12),(36,10),(42,12));self.relate('connect','plane-spine','wings')
        self.add_polyline('tail',(34,16),(36,14),(38,16));self.relate('connect','plane-spine','tail')
