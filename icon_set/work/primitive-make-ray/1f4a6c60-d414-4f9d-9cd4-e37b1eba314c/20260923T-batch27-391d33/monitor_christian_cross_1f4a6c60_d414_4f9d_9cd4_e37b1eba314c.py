"""monitor christian cross, complete SOLO48 composition.
Symbol plan in build(); visible keyshape extremes (4, 4, 44, 44).
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48
SOURCE_ICON_ID = '1f4a6c60-d414-4f9d-9cd4-e37b1eba314c'
SOURCE_PATH = 'icon_set/work/todo-references/monitor christian cross_1f4a6c60-d414-4f9d-9cd4-e37b1eba314c.svg'
AUTHOR = "gpt-6"

class Drawing(Solo48):
    icon_id = 'monitor-christian-cross'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects"
    aliases = ()
    keywords = ('monitor christian cross',)
    ...
    def build(self):
        # Latin cross: short upper stem and longer lower stem.
        self.monitor()
        self.add_polyline('cross-stem',(24,15),(24,18),(24,25))
        self.add_polyline('cross-bar',(19,18),(24,18),(29,18))
