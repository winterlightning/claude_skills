...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('screen',(14,16),(34,16),(34,32),(14,32),closed=True)
        self.add_polyline('upper-control',(8,19),(10,19),(10,17))
        self.add_line('plus-v',(9,25),(9,29))
        self.add_line('plus-h-left',(7,27),(9,27))
        self.add_line('plus-h-right',(9,27),(11,27))
        self.relate('connect','plus-v','plus-h-left','plus-h-right')
        for i,y in enumerate((20,28)): self.circle(f'button-{i}',39,y,2)
