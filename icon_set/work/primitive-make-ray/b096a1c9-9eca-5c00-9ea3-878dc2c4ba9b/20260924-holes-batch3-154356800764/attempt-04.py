...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('one',(6,8),(9,6),(9,10))
        self.add_bezier('two-top',(6,19),((12,16),(17,20),(12,23)))
        self.add_polyline('two-base',(12,23),(6,28),(14,28));self.relate('connect','two-top','two-base')
        self.add_bezier('three',(6,36),((13,36),(13,38),(9,38)),((13,38),(13,42),(6,42)))
        for i,y in enumerate((9,24,39)):self.add_line('row-'+str(i),(24,y),(42,y))
