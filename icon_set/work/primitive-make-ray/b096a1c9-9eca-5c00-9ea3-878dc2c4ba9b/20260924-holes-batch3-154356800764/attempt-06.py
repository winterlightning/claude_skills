...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('one',(8,6),(12,4),(12,12))
        self.add_bezier('two-top',(8,21),((16,19),(19,22),(14,24)))
        self.add_polyline('two-base',(14,24),(8,28),(16,28));self.relate('connect','two-top','two-base')
        self.add_bezier('three',(8,36),((17,36),(17,40),(12,40)),((17,40),(17,44),(8,44)))
