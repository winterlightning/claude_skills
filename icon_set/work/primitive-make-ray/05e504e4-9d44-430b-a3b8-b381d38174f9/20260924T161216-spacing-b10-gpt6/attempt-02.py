"""monitor astronomy. Enlarged screen vertical opening; crescent rebalanced left.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('moon-outer',(27,16),(27,24),radius_x=6,large_arc=True,sweep=False)
        self.add_arc('moon-inner',(27,24),(27,16),radius_x=6)
        self.add_contour('moon','moon-outer','moon-inner',closed=True)
        self.add_polyline('star-h',(29,14),(31,14),(33,14))
        self.add_polyline('star-v',(31,12),(31,14),(31,16))
