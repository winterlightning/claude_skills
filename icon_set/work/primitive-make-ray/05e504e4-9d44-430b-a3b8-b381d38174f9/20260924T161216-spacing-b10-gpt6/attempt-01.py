"""monitor astronomy. Crescent and compact four-point star retained; screen and stand centered.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.monitor()
        self.add_arc('moon-outer',(24,15),(24,25),radius_x=7,large_arc=True,sweep=False)
        self.add_arc('moon-inner',(24,25),(24,15),radius_x=7)
        self.add_contour('moon','moon-outer','moon-inner',closed=True)
        self.add_polyline('star-h',(29,15),(31,15),(33,15))
        self.add_polyline('star-v',(31,13),(31,15),(31,17))
