"""waiting room couple.
Symbol plan: Open clock with shortened hand; paired seated people follow full_body_ref.png and exact4 detached ink gap.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('clock-hands',(14,17),(14,18),(16,18))
