"""waiting room couple.
Plan: Clock at left with two seated figures at right, shared head radii and exact four-unit head/torso ink gaps.
Construction: human_ref/full_body_ref.png supplies round heads and simple connected seated limbs; source supplies scene.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('clock',(12,10),[('A',(12,26),8,8,True),('A',(12,10),8,8,True)],True)
        self.add_line('clock-hand',(12,10),(12,18))
        self.relate('connect','clock','clock-hand')
        for i,x in enumerate((29,42)):
            self.circle(f'head-{i}',x,10,2)
            self.add_line(f'torso-{i}',(x,20),(x,30))
            self.mark_human_figure(f'person-{i}',head=f'head-{i}',torso=f'torso-{i}',torso_junction='start')
        self.add_polyline('legs-left',(29,30),(24,30),(24,40))
        self.add_polyline('legs-right',(42,30),(44,30),(44,40))
