"""waiting room couple.
Plan: Repair round4 simplify dial to left semicircle while preserving clock hands, two heads and two seated poses. Shared human exact gap remains eight centerline units.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('clock-hands',(15,17),(15,19),(17,19))
        for i,x in enumerate((30,42)):
            self.circle(f'head-{i}',x,23,2)
            self.add_line(f'torso-{i}',(x,33),(x,35))
            self.mark_human_figure(f'person-{i}',head=f'head-{i}',torso=f'torso-{i}',torso_junction='start')
        self.add_polyline('legs-left',(30,35),(22,35),(18,40));self.join('torso-0','legs-left')
        self.add_polyline('legs-right',(42,35),(44,35),(44,40));self.join('torso-1','legs-right')
