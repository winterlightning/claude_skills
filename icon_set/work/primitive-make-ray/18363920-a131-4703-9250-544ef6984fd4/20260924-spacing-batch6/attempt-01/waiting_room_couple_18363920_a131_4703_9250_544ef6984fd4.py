"""waiting room couple.
Plan: Shared full-body human reference; head radius3, bottom19 to torso27 gives exact four-unit ink gap. Remove duplicated left leg and spread seated pair.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.circle('clock',12,12,6)
        self.add_polyline('clock-hands',(12,9),(12,12),(15,12))
        ...
        self.add_polyline('legs-left',(25,34),(16,34),(12,42));self.join('torso-0','legs-left')
        self.add_polyline('legs-right',(39,34),(42,34),(42,42));self.join('torso-1','legs-right')
