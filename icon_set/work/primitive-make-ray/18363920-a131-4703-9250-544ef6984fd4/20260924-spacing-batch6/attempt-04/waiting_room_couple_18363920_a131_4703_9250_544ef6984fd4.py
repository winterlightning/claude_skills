"""waiting room couple.
Plan: Repair round3 use wider horizontal keyshape to separate clock and pair; retain same exact detached head gap and seated poses.
