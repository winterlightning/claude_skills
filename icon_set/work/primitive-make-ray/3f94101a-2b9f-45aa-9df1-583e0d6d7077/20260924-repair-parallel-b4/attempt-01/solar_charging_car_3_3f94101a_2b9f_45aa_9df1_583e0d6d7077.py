...
class Drawing(Solo48):
    ...
    def build(self):
        self.box('charger',24,8,44,40,3)
        self.add_polyline('bolt',(35,17),(33,24),(35,24),(33,31))
        self.circle('sun',10,11,3)
        self.add_polyline('panel',(6,28),(14,28),(16,40),(4,40),closed=True)
