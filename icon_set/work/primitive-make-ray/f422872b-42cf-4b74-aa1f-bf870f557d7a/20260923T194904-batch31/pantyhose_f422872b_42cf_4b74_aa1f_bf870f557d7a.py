...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_line('waist-top',(14,4),(24,4))
        self.add_line('waist-right',(24,4),(24,12))
        self.add_bezier('bent-outer',(24,12),((30,16),(38,16),(38,22)),((38,25),(30,28),(24,32)),((22,33),(20,35),(18,36)))
        self.add_bezier('raised-foot',(18,36),((15,38),(13,40),(12,38)),((10,38),(10,36),(10,34)),((10,31),(13,30),(13,27)))
        self.add_bezier('bent-inner',(13,27),((16,29),(23,24),(29,21)),((23,19),(17,19),(14,18)),((12,17),(12,15),(12,13)),((12,9),(14,7),(14,4)))
        self.add_contour('bent-leg','waist-top','waist-right','bent-outer','raised-foot','bent-inner',closed=True)
        # Both rear-leg ends are shared nodes on the foreground leg; no inferred near-contact.
        self.add_bezier('standing-leg',(24,32),((22,38),(24,40),(31,42)),((29,44),(22,44),(20,44)),((16,44),(16,40),(18,36)))
        self.relate('connect','standing-leg','bent-leg')
        self.add_line('back-upper-leg',(14,18),(13,27))
        self.relate('connect','back-upper-leg','bent-leg')
