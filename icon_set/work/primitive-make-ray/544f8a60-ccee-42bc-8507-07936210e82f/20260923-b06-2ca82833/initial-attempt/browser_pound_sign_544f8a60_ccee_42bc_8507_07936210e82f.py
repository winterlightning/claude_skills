"""A browser with a centered pound sterling sign.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.browser()
        x=22
        self.path("pound-stem",(x+8,26),[("A",(x,26),4,4,False),
            ("L",(x,34))])
        self.add_polyline("pound-foot",(x-4,34),(x,34),(x+8,34))
        self.add_polyline("pound-bar",(x-4,26),(x,26),(x+4,26))
