"""Suitcase medical, drawn from its complete supplied reference.
...
SOURCE_ICON_ID='bd89654b-e123-4919-90d7-5f527d36f38f'
SOURCE_PATH='icon_set/work/todo-references/suitcase medical_bd89654b-e123-4919-90d7-5f527d36f38f.svg'
AUTHOR='gpt-6'

class Drawing(Solo48):
    icon_id='suitcase-medical'
    keyshape=Keyshape.SQUARE
    semantic_role='MAIN'
    semantic_kind='noun'
    category='objects/general'
    aliases=()
    keywords=('suitcase', 'medical')

    def build(self):
        # The medical cross is reduced to its four centerline arms for legibility.
        self.suitcase()
        c=(24,28)
        for n,p in [('north',(24,22)),('south',(24,34)),('west',(18,28)),('east',(30,28))]:
            self.add_line(n,c,p)
