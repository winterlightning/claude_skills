...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('leg',(24,25),(33,33));self.relate('connect','bowl','leg');self.relate('connect','bar','leg')

KEYSHAPE_REASON='The complete composition uses centerline extremes (6,6)–(42,42).'
FINAL_REDUCTIONS='Source R retained despite parking slash filename.'
