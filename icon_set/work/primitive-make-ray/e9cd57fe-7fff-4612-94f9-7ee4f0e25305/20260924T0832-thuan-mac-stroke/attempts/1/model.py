"""Turntable with a rounded square deck, circular platter, and diagonal tonearm. Consistent corner radii replace flattened elliptical deck corners.
...
class Drawing(Solo48):
    ...
    def build(self):
        # Symbol plan: Turntable with a rounded square deck, circular platter, and diagonal tonearm. Consistent corner radii replace flattened elliptical deck corners.
