"""Turntable with a square deck, circular platter and diagonal tonearm. Equal edges and round stroke joins replace flattened elliptical corners.
...
class Drawing(Solo48):
    ...
    def build(self):
        # Symbol plan: Turntable with a square deck, circular platter and diagonal tonearm. Equal edges and round stroke joins replace flattened elliptical corners.
        p=self.path; oval=self.oval; line=self.add_line; poly=self.add_polyline; dot=self.add_dot
        join=lambda a,b:self.relate("connect",a,b)
        poly('deck',(6,6),(42,6),(42,42),(6,42),closed=True)
