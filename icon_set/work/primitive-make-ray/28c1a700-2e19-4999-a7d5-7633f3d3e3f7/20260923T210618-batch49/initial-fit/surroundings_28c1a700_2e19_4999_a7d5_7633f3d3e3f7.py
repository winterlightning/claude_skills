"""Surroundings, drawn from its complete supplied reference.
...
SOURCE_ICON_ID='28c1a700-2e19-4999-a7d5-7633f3d3e3f7'
SOURCE_PATH='icon_set/work/todo-references/surroundings_28c1a700-2e19-4999-a7d5-7633f3d3e3f7.svg'
AUTHOR='gpt-6'

class Drawing(Solo48):
    icon_id='surroundings'
    ...
    def build(self):
        ...
        self.rect('frame',6,6,42,42,4)
        self.add_polyline('mountain',(6,38),(20,26),(29,35),(32,38))
        self.add_polyline('rear-mountain',(29,35),(35,31),(42,38))
