...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('front-body',(24,18),[('L',(20,24)),('A',(14,30),6,6,False),('L',(14,36)),('A',(20,42),6,6,False),('L',(32,42)),('A',(42,32),10,10,False),('A',(34,18),16,16,False)])
        self.relate('connect','front-crown','front-body')
        self.add_polyline('back-crown',(6,16),(10,24),(20,24),(16,16));self.relate('connect','back-crown','front-body')
        ...
        self.add_bezier('dollar',(30,26),((22,24),(22,30),(28,30)),((34,30),(32,35),(26,33)))
