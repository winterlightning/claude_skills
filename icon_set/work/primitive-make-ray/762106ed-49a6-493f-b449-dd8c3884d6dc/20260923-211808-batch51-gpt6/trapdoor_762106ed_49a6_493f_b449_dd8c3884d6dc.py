"""A square trapdoor panel sits inside a rounded frame with a lower seam.
Plan: Centered inner panel and outer frame share the bottom seam attachment axis.
Keyshape SQUARE: exact ink and centerline envelopes ((4, 4, 44, 44), (6, 6, 42, 42)).
References: Supplied SVG, rendered and visually inspected. Lucide original/tv.svg and atomic-debug/tv.svg: coherent contours, shared nodes, consistent rounding; re-authored on SOLO48.
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48
SOURCE_ICON_ID = '762106ed-49a6-493f-b449-dd8c3884d6dc'
SOURCE_PATH = 'icon_set/work/todo-references/trapdoor_762106ed-49a6-493f-b449-dd8c3884d6dc.svg'
AUTHOR = 'gpt-6'
