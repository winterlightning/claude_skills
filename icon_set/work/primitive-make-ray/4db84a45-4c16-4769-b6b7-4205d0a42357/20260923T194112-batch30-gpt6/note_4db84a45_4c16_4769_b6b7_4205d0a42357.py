...
class Drawing(Solo48):
    """An empty clipboard with a broad clip.

    Plan: Centered clip and board with shared attachment nodes.
    Construction reference: notebook: enclosure and clean joined boundary.
    """
    icon_id = 'note'
