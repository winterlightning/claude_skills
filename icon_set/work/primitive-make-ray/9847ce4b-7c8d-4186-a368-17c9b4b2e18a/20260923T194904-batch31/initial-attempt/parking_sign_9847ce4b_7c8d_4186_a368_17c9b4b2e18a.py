"""An upright parking sign on an extended left post.
Symbol plan: Open tall sign perimeter contains a hand-built P; left edge continues down as the post. Ink extremes (8,2)-(40,46).
Construction: square-parking: P stem and bowl; reference owns the open sign/post silhouette.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('sign-post',(10,44),(10,4),(38,4),(38,28))
        self.parking_letter('p',18,12,28,11,8)
