"""Bottle opener with a smooth oval head, heart-notched opening and a narrow capsule-ended handle. Symmetry axis x=24; bounds (10,4)-(38,44).
Keyshape VRECT_M; fresh revision for feedback: Bad stroke drawn.
Construction reference: No useful local Lucide bottle opener; smooth arc joins follow the supplied oval head.
Omissions: Handle shortened relative to the source to preserve aperture clearance.
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48
SOURCE_ICON_ID = '0b913234-7695-5b92-8cb9-b37fc3a45260'
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__bottle-opener-with-heart-notched-aperture/20260924T090148Z-thuan-mac/reference/beer opener_0b913234-7695-5b92-8cb9-b37fc3a45260.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('opening',(24,16),('A',(20,16),2,2,False),('L',(20,22)),('L',(28,22)),('L',(28,16)),('A',(24,16),2,2,False),closed=True)
        self.contacts()
