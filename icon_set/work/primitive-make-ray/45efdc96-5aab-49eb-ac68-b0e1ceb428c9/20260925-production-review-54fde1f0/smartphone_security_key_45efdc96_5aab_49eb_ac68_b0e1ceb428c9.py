"""Smartphone Security Key. Phone security key has an open circular bow, diagonal shaft and one clear tooth; omit the crowded second tooth.
...
AUTHOR = 'gpt-6'
PLAN = 'Phone security key has an open circular bow, diagonal shaft and one clear tooth; omit the crowded second tooth.'
OMISSIONS = 'None.'
