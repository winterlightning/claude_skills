"""Smartphone Security Key. Phone security key has an open circular bow, diagonal shaft and two distinct teeth.
...
AUTHOR = 'gpt-6'
PLAN = 'Phone security key has an open circular bow, diagonal shaft and two distinct teeth.'
OMISSIONS = 'None.'
CONSTRUCTION_REFERENCES = ['smartphone', 'key-round']
PARENT_MODULE = 'icon_set/model/icons/solo/smartphone_security_key_45efdc96_5aab_49eb_ac68_b0e1ceb428c9.py'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.phone()
        self.circle('key-bow',20,24,4)
        self.add_polyline('key-shaft',(20,20),(26,14),(28,12),(31,15))
        self.add_line('key-tooth',(26,14),(29,17))
