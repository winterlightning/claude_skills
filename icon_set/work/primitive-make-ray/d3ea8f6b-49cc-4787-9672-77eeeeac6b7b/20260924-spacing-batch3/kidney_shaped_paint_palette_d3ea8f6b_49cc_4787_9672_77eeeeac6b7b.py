...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        circle('well-upper',24,17,2);circle('well-left',18,29,2)

FINAL_OMISSIONS = 'Reduce four paint wells to two.'
VISUAL_REVIEW = 'Move lower-left well inward one grid unit; preserve organic asymmetric notch and smooth outer silhouette.'
