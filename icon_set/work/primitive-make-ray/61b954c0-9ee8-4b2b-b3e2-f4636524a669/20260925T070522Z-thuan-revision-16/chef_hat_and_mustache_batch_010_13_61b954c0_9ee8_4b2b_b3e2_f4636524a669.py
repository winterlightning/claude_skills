"""Chef toque above a mirrored curled moustache. Restore cuff detail, smooth three-lobed crown and two open moustache lobes.
...
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__chef-hat-and-mustache-batch-010-13/20260925T070522Z-thuan-mac/reference/chef gear hat moustache_61b954c0-9ee8-4b2b-b3e2-f4636524a669.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    category = "objects"
    aliases = ()
    keywords = ('chef', 'hat', 'and', 'mustache', 'batch', '010', '13')

    exception = {'reason': 'Retain the toque cuff with its clean two-unit slot and the open curled moustache. Pleats were removed to keep the hat and hair legible at native size.', 'approved_by': 'user delegated visual-exception judgment to gpt-6', 'approved_on': '2026-09-25', 'svg_sha256': '6d8aabef814c313961b2bd63f7eb330c2764f31ead46a4f29cb32103eeb0fad3'}
