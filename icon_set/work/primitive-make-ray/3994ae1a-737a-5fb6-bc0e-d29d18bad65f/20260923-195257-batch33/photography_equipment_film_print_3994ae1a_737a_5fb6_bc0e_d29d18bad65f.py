...
class Drawing(Solo48):
    icon_id='photography-equipment-film-print'
    keyshape=Keyshape.HRECT_L
    semantic_role='MAIN'
    semantic_kind='noun'
    category='objects/media'
    aliases=()
    keywords=('photography', 'equipment', 'film', 'print')
    ...
    def build(self):
        # A photographic landscape print with large left peak, smaller right peak and upper-right sun.
