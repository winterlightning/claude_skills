"""transporter 2.
Symbol plan: Narrow elevator door with central seam; paired up/down arrows on separate right rail.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('door',(6,42),(6,6),(26,6),(26,42),(16,42),(6,42))
        self.add_line('seam',(16,16),(16,42));self.join('door','seam')
