...
class Drawing(Solo48):
    ...
    def build(self):
        self.suitcase()
        self.add_bezier('cap-low', (19, 28), ((15, 32), (21, 38), (25, 34)))
        self.add_line('side-low', (25, 34), (27, 32))
        self.add_line('side-low-upper', (27, 32), (29, 30))
        self.add_bezier('cap-high', (29, 30), ((33, 26), (27, 20), (23, 24)))
        self.add_line('side-high', (23, 24), (21, 26))
        self.add_line('side-high-lower', (21, 26), (19, 28))
        self.add_contour('pill', 'cap-low', 'side-low', 'side-low-upper', 'cap-high', 'side-high', 'side-high-lower', closed=True)
        self.add_line('pill-seam', (21, 26), (27, 32))
