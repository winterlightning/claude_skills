...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.suitcase()
        self.add_bezier('cap-low',(20,26),((17,29),(23,35),(26,32)))
        self.add_line('side-low',(26,32),(27,31))
        self.add_line('side-low-upper',(27,31),(28,30))
        self.add_bezier('cap-high',(28,30),((31,27),(25,21),(22,24)))
        self.add_line('side-high',(22,24),(21,25))
        self.add_line('side-high-lower',(21,25),(20,26))
        self.add_contour('pill','cap-low','side-low','side-low-upper','cap-high','side-high','side-high-lower',closed=True)
        self.add_line('pill-seam',(21,25),(27,31))
