...
Plan: Globe with central meridian and full equator above a capsule microphone and broad U stand.
Construction: Lucide mic capsule and U cradle; globe meridian and equator with actual shared endpoints.
Omissions: Two meridians reduced to one; base crossbar omitted to reserve vertical space for the globe grid.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('globe',(8,22),[('L',(8,14)),('A',(24,4),16,10,True),('A',(40,14),16,10,True),('L',(40,22))])
        self.add_polyline('equator',(8,14),(24,14),(40,14))
        self.add_line('meridian',(24,4),(24,14))
        self.relate('connect','globe','equator');self.relate('connect','globe','meridian');self.relate('connect','meridian','equator')
        self.rect('microphone',20,23,8,11,4)
        self.path('support',(8,31),[('A',(24,43),16,12,False),('A',(40,31),16,12,False)])
        self.add_line('stand',(24,43),(24,44));self.relate('connect','support','stand')
