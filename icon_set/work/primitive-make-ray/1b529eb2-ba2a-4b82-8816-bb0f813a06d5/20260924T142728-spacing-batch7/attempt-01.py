"""microphone podcast international 1.
Plan: Upper globe dome with a shared central meridian and interrupted equator above a capsule microphone and broad U stand.
Construction: Lucide mic capsule and U cradle; globe central meridian re-authored for available clearance.
Omissions: Two tightly packed curved meridians reduced to one; equator interrupted behind microphone.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('globe',(8,20),[('A',(24,4),16,16,True),('A',(40,20),16,16,True)])
        self.add_line('meridian',(24,4),(24,11))
        self.relate('connect','globe','meridian')
        self.add_line('equator-left',(8,20),(11,20))
        self.add_line('equator-right',(40,20),(37,20))
        self.relate('connect','globe','equator-left');self.relate('connect','globe','equator-right')
        self.rect('microphone',20,20,8,11,4)
        self.path('support',(8,29),[('A',(24,40),16,11,False),('A',(40,29),16,11,False)])
        self.add_polyline('stand',(24,40),(24,44))
        self.add_polyline('base',(16,44),(24,44),(32,44))
        self.relate('connect','support','stand');self.relate('connect','stand','base')
