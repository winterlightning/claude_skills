...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('upper-a',(36,14),(36,20))
        self.add_line('upper-b',(36,20),(40,20))
        self.add_arc('terminal',(40,20),(40,28),radius_x=4)
        self.add_line('lower-a',(40,28),(36,28))
        self.add_line('lower-b',(36,28),(36,34))
        ...
        self.add_contour('outline','top','tr','upper-a','upper-b','terminal','lower-a','lower-b','br','bottom','bl','left','tl',closed=True)
