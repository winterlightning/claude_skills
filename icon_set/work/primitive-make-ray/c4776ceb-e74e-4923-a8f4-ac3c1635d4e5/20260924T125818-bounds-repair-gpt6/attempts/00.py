...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('hands',(24,10),((21,7),(19,6),(16,6)),((12,6),(6,14),(6,20)),((6,24),(7,30),(8,34)),((8,39),(14,39),(14,34)))
        self.add_line('fingers-1',(14,34),(14,30))
        self.add_line('fingers-2',(14,30),(26,42))
        self.add_line('fingers-3',(26,42),(32,36))
        self.add_bezier('right-hand',(32,36),((36,42),(41,38),(42,32)),((42,28),(42,24),(42,20)),((42,14),(36,6),(32,6)),((29,6),(27,7),(24,10)))
        self.add_contour('hand-outline','hands','fingers-1','fingers-2','fingers-3','right-hand',closed=True)
