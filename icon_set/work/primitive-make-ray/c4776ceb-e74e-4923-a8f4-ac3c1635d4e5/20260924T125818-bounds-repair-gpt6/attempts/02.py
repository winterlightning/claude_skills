...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('fingers-1',(16,34),(16,32))
        self.add_line('fingers-2',(16,32),(26,42))
        ...
        self.add_contour('hand-outline','hands','thumb-turn','fingers-1','fingers-2','fingers-3','right-hand',closed=True)
