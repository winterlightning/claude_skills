"""counterclockwise-circular-refresh-arrows-batch-020-03: Two counterclockwise turns and balanced V heads are exact half-turn partners; coherent arcs replace awkward squared hooks.
...
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__counterclockwise-circular-refresh-arrows-batch-020-03/20260924T172457Z-thuan-mac/reference/repeat_0a11ecc5-12d2-479f-ad50-bf72f2730e09.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    ...
    category = 'objects'
    aliases = ()
    keywords = ('counterclockwise', 'circular', 'refresh', 'arrows', 'batch', '020', '03')
    def build(self):
