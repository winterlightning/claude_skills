"""house-paw-print: Visual repair: restore triangular paw pad; raise eaves and toe row to enlarge pad opening. Solid toes omit only tiny interiors.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for name,x,y in [('toe-left',16,21),('toe-top',24,15),('toe-right',32,21)]:self.add_dot(name,(x,y))
        self.add_polyline('pad',(24,26),(17,34),(31,34),closed=True)
