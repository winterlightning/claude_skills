"""house-paw-print: Reduce toe rings to solid pads and open lower pad contour; three-toe arrangement remains readable without undersized holes.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.house()
        for name,x,y in [('toe-left',16,23),('toe-top',24,17),('toe-right',32,23)]:self.add_dot(name,(x,y))
