...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_arc('outer-left',(12,40),(24,4),radius_x=20)
        self.add_arc('outer-right',(24,4),(36,40),radius_x=20)
        self.add_contour('outer-ring','outer-left','outer-right')
        self.add_bezier('keyhole-head',(20,27),((12,23),(16,12),(24,12)),((32,12),(36,23),(28,27)))
        self.add_line('keyhole-right',(28,27),(32,42))
        self.add_bezier('keyhole-base',(32,42),((32,44),(16,44),(16,42)))
        self.add_line('keyhole-left',(16,42),(20,27))
