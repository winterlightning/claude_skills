"""video game 360 vr.
Symbol plan: Tall band with full curved lower rim, compact spaced 360 digits, enlarged game interior.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('three',(10,4),[('A',(10,8),2,2,True),('A',(10,12),2,2,True)])
        self.path('six-tail',(24,4),[('L',(20,7)),('L',(20,10))])
        self.circle('six-loop',22,10,2);self.join('six-tail','six-loop')
        self.circle('zero',35,8,3)
        self.path('band',(8,22),[('L',(8,38)),('A',(14,44),6,6,False),('L',(34,44)),('A',(40,38),6,6,False),('L',(40,22))])
        self.add_arc('game-round',(29,23),(29,33),radius_x=7,large_arc=True,sweep=False)
        self.add_line('game-mouth-1',(29,33),(27,28));self.add_line('game-mouth-2',(27,28),(29,23))
