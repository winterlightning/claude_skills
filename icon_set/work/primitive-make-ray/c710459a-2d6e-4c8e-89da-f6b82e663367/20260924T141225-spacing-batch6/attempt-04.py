"""video game 360 vr.
Symbol plan: Taller square envelope, compact digits and larger game opening.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('three',(8,6),[('A',(8,10),2,2,True),('A',(8,14),2,2,True)])
        self.path('six-tail',(25,6),[('L',(21,9)),('L',(21,14))])
        self.circle('six-loop',23,14,2);self.join('six-tail','six-loop')
        self.circle('zero',38,11,3)
        self.path('band-left',(6,27),[('L',(6,36)),('A',(12,42),6,6,False)])
        self.path('band-right',(42,27),[('L',(42,36)),('A',(36,42),6,6,True)])
        self.add_arc('game-round',(29,28),(29,40),radius_x=8,large_arc=True,sweep=False)
        self.add_line('game-mouth-1',(29,40),(24,34));self.add_line('game-mouth-2',(24,34),(29,28))
