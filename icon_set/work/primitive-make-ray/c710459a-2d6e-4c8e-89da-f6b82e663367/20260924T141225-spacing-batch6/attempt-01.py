"""video game 360 vr.
Symbol plan: Three independently spaced digits above interrupted curved VR band and open-mouth game emblem.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('six-top',(27,8),[('A',(21,14),6,6,False),('L',(21,17))])
        self.circle('six-loop',24,17,3);self.join('six-top','six-loop')
        self.circle('zero',39,14,5)
        self.path('band-left',(4,28),[('L',(4,34)),('A',(10,40),6,6,False),('L',(12,40))])
        self.path('band-right',(44,28),[('L',(44,34)),('A',(38,40),6,6,True),('L',(36,40))])
        self.path('game',(28,28),[('A',(28,38),7,7,False),('L',(23,33)),('L',(28,28))],True)
