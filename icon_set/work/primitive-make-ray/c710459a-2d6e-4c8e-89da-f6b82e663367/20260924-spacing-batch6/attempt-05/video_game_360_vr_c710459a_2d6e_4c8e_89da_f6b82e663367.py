"""video game 360 vr.
Plan: Restore full-height zero and narrow three; enlarge game emblem while opening band around it. Paired rounded sidewalls suggest cylindrical VR band. Deliberate numeral asymmetry and upward game mouth.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.circle('six-loop',22,17,4);self.add_polyline('six-stem',(18,17),(18,6),(26,6));self.join('six-loop','six-stem')
