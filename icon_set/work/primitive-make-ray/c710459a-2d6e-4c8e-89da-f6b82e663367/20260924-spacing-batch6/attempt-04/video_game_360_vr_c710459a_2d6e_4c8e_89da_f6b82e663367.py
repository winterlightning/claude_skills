"""video game 360 vr.
Plan: Repair round3: enlarge game symbol with six-unit radius and rotate mouth upward; remove band feet and lift six counter for clearance.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.circle('six-loop',24,18,3);self.add_polyline('six-stem',(21,18),(21,6),(27,6));self.join('six-loop','six-stem')
        self.circle('zero',39,14,3)
        
        self.add_line('band-left',(6,32),(6,42))
        self.add_line('band-right',(42,32),(42,42))
