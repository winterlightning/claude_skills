"""video game 360 vr.
Plan: Repair round1: open band around emblem and remove doubled lower wall; preserve three numerals and game outline.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('band-left',(4,32),(4,40),(11,40))
        self.add_polyline('band-right',(44,32),(44,40),(39,40))
