"""video game 360 vr.
Plan: Repair round2: choose taller square envelope, circular six/zero counters, preserve eight-unit three runs. Retain game mouth while freeing band.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('three',(6,6),(12,6),(12,14),(6,14))
        self.add_polyline('three-bottom',(12,14),(12,22),(6,22));self.join('three','three-bottom')
        self.circle('six-loop',24,19,3);self.add_polyline('six-stem',(21,19),(21,6),(27,6));self.join('six-loop','six-stem')
        self.circle('zero',39,14,3)
        self.add_polyline('band-left',(6,32),(6,42),(11,42))
        self.add_polyline('band-right',(42,32),(42,42),(39,42))
        self.add_arc('game-arc',(28,32),(28,40),radius_x=5,large_arc=True,sweep=False)
        self.add_polyline('game-mouth',(28,40),(24,36),(28,32));self.join('game-arc','game-mouth')
