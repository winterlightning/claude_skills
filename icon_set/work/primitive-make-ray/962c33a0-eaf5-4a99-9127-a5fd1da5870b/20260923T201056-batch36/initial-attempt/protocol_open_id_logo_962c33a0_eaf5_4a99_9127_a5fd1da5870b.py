...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('stem',(22,16),(22,10),(28,6),(28,38),(22,42),(22,16))
        ...
        self.add_line('inner-wall',(22,36),(22,22))
        self.add_contour('inner-counter','inner-loop','inner-wall',closed=True)
        self.add_polyline('arrow-upper',(28,16),(42,22),(42,18))
