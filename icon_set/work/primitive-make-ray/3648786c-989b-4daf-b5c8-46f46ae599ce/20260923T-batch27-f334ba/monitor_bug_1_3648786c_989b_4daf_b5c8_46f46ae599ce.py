"""monitor bug 1, complete SOLO48 composition.
...
SOURCE_PATH = 'icon_set/work/todo-references/monitor bug 1_3648786c-989b-4daf-b5c8-46f46ae599ce.svg'
AUTHOR = "gpt-6"
...
class Drawing(Solo48):
    ...
    def build(self):
        # Oval bug body, transverse line and mirrored diagonal legs.
        self.monitor()
        self.circle('bug-body',24,20,5)
        self.add_line('bug-crossbar',(15,20),(33,20))
        self.relate('connect','bug-body','bug-crossbar')
        for i,(a,b) in enumerate((((21,16),(18,15)),((27,16),(30,15)),((21,24),(18,25)),((27,24),(30,25)))):
            self.add_line('leg-'+str(i),a,b)
            self.relate('connect','bug-body','leg-'+str(i))
