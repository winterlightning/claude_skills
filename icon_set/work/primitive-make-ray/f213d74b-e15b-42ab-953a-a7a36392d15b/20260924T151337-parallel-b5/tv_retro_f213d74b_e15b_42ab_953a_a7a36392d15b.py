...
AUTHOR="gpt-6"
PLAN='One control dot replaces two buttons; feet omitted to enlarge cabinet and screen clearance.'
class Drawing(Solo48):
    ...
    def build(self):
        self.rect('cabinet',6,14,42,42,4)
        self.add_polyline('antenna',(16,6),(24,14),(32,6))
        self.relate('connect','antenna','cabinet')
        self.rect('display',15,23,24,33,3)
        self.add_dot('button',(33,28))
