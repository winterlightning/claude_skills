"""tv retro. Plan: Lucide tv rounded cabinet and V antenna; enlarged inset display. Omit two tiny buttons and short feet to open nested frame spacing.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.rect('cabinet',6,14,36,28,4,split_x=(24,))
        self.add_polyline('antenna',(16,6),(24,14),(32,6));self.join('antenna','cabinet')
        self.rect('display',15,23,18,10,3)
