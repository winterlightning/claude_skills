...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('top-bar',(17,13),(24,13),(31,13))
        self.add_line('tick',(24,12),(24,13));self.relate('connect','tick','top-bar')
        self.add_bezier('left-fall',(17,13),((17,24),(25,27),(31,27)))
        self.add_bezier('right-fall',(31,13),((31,24),(23,27),(17,27)))
