...
AUTHOR='gpt-6'
PLAN='A front-facing self-driving car with radio waves. Car roof/fascia and both signal arcs mirror about x24. All body attachments are explicit nodes; room preserved between arcs and roof.'
...
FINAL_OMISSIONS = 'Drop headlights and simplify wheels to short stems.'
VISUAL_REVIEW = 'Car roof/fascia and both signal arcs mirror about x24. All body attachments are explicit nodes; room preserved between arcs and roof.'
