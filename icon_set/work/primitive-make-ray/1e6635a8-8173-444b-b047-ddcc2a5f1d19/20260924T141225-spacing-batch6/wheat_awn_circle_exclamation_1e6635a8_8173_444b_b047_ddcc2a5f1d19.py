...
Symbol plan: Circular wheat emblem; shared stem and mirrored open grain branches replace small leaf loops. Reference has no exclamation.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for row,y in enumerate((18,28)):
            self.add_polyline(f'grain-row-{row}',(16,y),(24,y+6),(32,y))
            self.join('stem',f'grain-row-{row}')
