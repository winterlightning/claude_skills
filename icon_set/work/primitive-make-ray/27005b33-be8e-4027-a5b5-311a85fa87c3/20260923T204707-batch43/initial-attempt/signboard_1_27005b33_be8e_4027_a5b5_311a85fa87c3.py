"""A hanging rectangular sign suspended from a right-side post.
Symbol plan: signpost and rectangle-horizontal: shared rails, rounded panel corners, exact hanger nodes.
Keyshape: HRECT_L; inspect ink_extremes for the fixed profile envelope.
Reduction: None.
"""
