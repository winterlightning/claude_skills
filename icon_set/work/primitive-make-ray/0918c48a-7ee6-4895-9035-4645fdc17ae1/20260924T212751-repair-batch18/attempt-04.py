...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('panel',(13,10),(35,10),(42,10),(42,42),(6,42),(6,10),closed=True)
        for i,x in enumerate((13,35)):
         self.add_line(f'hanger-{i}',(x,6),(x,10));self.relate('connect','panel',f'hanger-{i}')
        self.score(20)

KEYSHAPE_REASON='The wide composition uses centerline extremes (4,8)–(42,42).'
