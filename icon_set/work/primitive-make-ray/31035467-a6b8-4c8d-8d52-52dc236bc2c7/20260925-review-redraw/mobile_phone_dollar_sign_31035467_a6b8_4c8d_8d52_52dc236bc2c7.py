'mobile phone dollar sign. Restored dollar top/bottom ticks and the phone footer divider. Complete strict candidate remains blocked: lower tick is only 4 centerline units from the footer. Separate 2-unit-spacing proposal saved without approval or validator exception. Construction reference: local Lucide smartphone + dollar-sign.'
