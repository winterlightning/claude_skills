...
Plan: Mirrored user.svg busts: head bottom34, shoulder apex42, exact 4 ink gap.
Keyshape VRECT_L: extrema derived from the profile's standard envelope.
Omissions: Bubble tails removed; short check and minimal busts retain agreement scene.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('bubble',(18,4),[('L',(30,4)),('A',(34,8),4),('L',(34,20)),('A',(30,24),4),('L',(18,24)),('A',(14,20),4),('L',(14,8)),('A',(18,4),4)],True)
        self.add_polyline('check',(22,13),(24,15),(26,13))
