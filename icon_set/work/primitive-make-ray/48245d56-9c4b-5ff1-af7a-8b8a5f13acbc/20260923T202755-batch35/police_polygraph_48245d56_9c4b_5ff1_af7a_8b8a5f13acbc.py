"""A polygraph monitor with a pulse trace and two lower controls.

Symbol plan: activity: intentional angular waveform; rounded enclosure from printer.
Envelope: VRECT_L. The upright composition benefits from the 32-by-40 centerline envelope, (8,4)–(40,44).
Reduction: Small outlined buttons reduced to round dots.
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.profiles import Profile
from icon_set.model.icons.solo._base import Solo48

SOURCE_ICON_ID = '48245d56-9c4b-5ff1-af7a-8b8a5f13acbc'
SOURCE_PATH = 'icon_set/work/todo-references/police polygraph_48245d56-9c4b-5ff1-af7a-8b8a5f13acbc.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'police-polygraph'
    ...
    def build(self):
        ...
        self.add_polyline('trace',(8,16),(15,16),(19,12),(25,19),(29,13),(32,16))
        self.relate('connect','trace','monitor')
        self.add_line('control-divider',(8,27),(40,27))
        self.relate('connect','control-divider','monitor')
        for i,x in enumerate((18,30)): self.add_dot(f'control-{i}',(x,35))
