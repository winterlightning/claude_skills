...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('hand',(6,24),[('L',(6,30)),('A',(18,42),12,12,False),('L',(22,42)),('A',(30,34),8,8,False),('L',(38,18)),('A',(30,18),4,4,False),('L',(30,14)),('A',(22,14),4,4,False),('L',(22,10)),('A',(14,10),4,4,False),('L',(14,26)),('L',(6,24))],True)
        ...
        self.path('motion',(32,30),[('A',(42,40),10,10,True),('L',(42,42))])
        self.add_polyline('arrow',(36,36),(42,42),(42,34));self.relate('connect','motion','arrow')
