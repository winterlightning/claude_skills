...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('hand',(26,30),[('A',(14,34),10,10,True),('A',(6,26),8,8,True),('L',(6,22)),('L',(10,26)),('L',(10,14)),('A',(18,14),4,4,True),('L',(18,10)),('A',(26,10),4,4,True),('L',(26,14)),('A',(34,14),4,4,True),('L',(34,18)),('A',(42,18),4,4,True),('L',(42,26))])
        for n,x,y in [('index',18,14),('middle',26,14),('ring',34,18)]:
            self.add_line(n,(x,y),(x,24));self.relate('connect','hand',n)
        self.path('motion',(26,26),[('A',(36,36),10,10,True),('L',(36,42))])
