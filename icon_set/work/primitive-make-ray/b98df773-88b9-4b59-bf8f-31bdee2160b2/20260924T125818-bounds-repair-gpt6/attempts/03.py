...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('cells',(24,8),(30,9),(30,15),(36,18),(36,24),(30,27),(24,24),(18,27),(12,24),(12,18),(18,15),(18,9),closed=True)
        ...
        self.add_polyline('basket',(4,16),(4,30),(44,30),(44,8))
        self.add_arc('wheel-left-a',(12,38),(16,38),radius_x=2)
        self.add_arc('wheel-left-b',(16,38),(12,38),radius_x=2)
        self.add_contour('wheel-left','wheel-left-a','wheel-left-b',closed=True)
        self.add_arc('wheel-right-a',(32,38),(36,38),radius_x=2)
        self.add_arc('wheel-right-b',(36,38),(32,38),radius_x=2)
