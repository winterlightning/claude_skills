...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('cells',(24,6),(29,9),(29,15),(34,18),(34,24),(29,27),(24,24),(19,27),(14,24),(14,18),(19,15),(19,9),closed=True)
        self.add_polyline('junction',(19,15),(24,18),(29,15))
        ...
        self.add_arc('bowl',(4,24),(44,24),radius_x=20,radius_y=12,sweep=False)
        self.add_line('left',(6,16),(4,24))
        self.add_line('handle',(44,24),(40,12))
