"""insurance expensive.
Plan: High left dollar and lower right health plus sit over the descending balance beam.
Construction: Lucide dollar-sign and source seesaw direction; simple shared-node open dollar avoids tiny holes.
Omissions: Coin rim removed to retain dollar; health cross reduced to stroke form; fulcrum base omitted.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('dollar',(18,8),[('L',(16,8)),('C',(11,8),(11,13),(16,13)),('C',(21,13),(21,18),(16,18)),('L',(14,18))])
        self.add_line('dollar-top',(16,6),(16,8));self.relate('connect','dollar','dollar-top')
        self.add_line('dollar-bottom',(16,18),(16,20));self.relate('connect','dollar','dollar-bottom')
        self.cross('medical-cross',36,20,6)
        self.add_polyline('beam',(6,26),(24,34),(42,42))
