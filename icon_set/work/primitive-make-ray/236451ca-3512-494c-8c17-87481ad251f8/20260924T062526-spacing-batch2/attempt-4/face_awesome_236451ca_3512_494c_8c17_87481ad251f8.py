...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('head',(4,24),[('A',(44,24),20,16,True),('A',(4,24),20,16,True)],True)
        for i,x in enumerate((15,33)):
            self.add_polyline(f'star-{i}',(x,12),(x+3,18),(x+7,19),(x+4,24),(x+5,29),(x,26),(x-5,29),(x-4,24),(x-7,19),(x-3,18),closed=True)
        self.add_arc('smile',(20,30),(28,30),radius_x=5,sweep=False)
