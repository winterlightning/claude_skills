...
PLAN = 'Closed charging bolt between four mirrored waves; preserve the complete arrangement and record the remaining width-budget failure.'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('flash',(26,8),(18,26),(24,26),(22,40),(30,22),(24,22),closed=True)
        for side in [-1,1]:
            for name,x,rx,ry in [('outer',8,4,14),('inner',14,1,6)]:
