...
PLAN = 'Four mirrored charging waves around a narrow centerline bolt; shared nested arc parameters preserve repetition.'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('flash',(26,8),(22,24),(26,24),(22,40))
        for side in [-1,1]:
