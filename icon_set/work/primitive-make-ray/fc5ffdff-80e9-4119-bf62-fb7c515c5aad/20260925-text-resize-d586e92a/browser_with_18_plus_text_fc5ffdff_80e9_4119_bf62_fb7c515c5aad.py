...
PARENT_RESULT='icon_set/work/primitive-make-ray/fc5ffdff-80e9-4119-bf62-fb7c515c5aad/20260925-clean-c15034e0/result.json'
...
class Drawing(Solo48):
    ...
    semantic_kind="noun"
    category="objects"
    PATH_STROKE_WIDTHS = {n: 2.4 for n in ("one-0","one-1","one-2","eight-0","eight-1","plus-h","plus-v")}
    ...
    def build(self):
        ...
        # Typeface-v2 digit outlines at 60% proportional size, including 2.4-unit text strokes; no replacement glyphs.
        ...
        self.glyph('one','1',7.6,24)
        self.glyph('eight','8',18.4,24)
        self.add_polyline('plus-h',(32.8,29.7),(34.8,29.7),(36.8,29.7))
        self.add_polyline('plus-v',(34.8,27.7),(34.8,29.7),(34.8,31.7));self.relate('connect','plus-h','plus-v')
