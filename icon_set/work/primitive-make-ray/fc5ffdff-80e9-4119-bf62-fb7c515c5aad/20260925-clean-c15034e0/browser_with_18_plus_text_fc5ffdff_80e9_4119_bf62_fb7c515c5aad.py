...
AUTHOR="gpt-6"
USER_HEADER_SPACING={"approved_by":"user","centerline_gap":4,"scope":"calendar top rim to divider"}
PARENT_RESULT='icon_set/work/primitive-make-ray/fc5ffdff-80e9-4119-bf62-fb7c515c5aad/20260925-feedback-fed4a5e4/result.json'
...
class Drawing(Solo48):
    ...
    def build(self):
        # User-approved compact header: rim y=10, divider y=14 (4 centerline units).
        # Typeface-v2 digit outlines at 80% layout size; no replacement glyphs.
        self.add_polyline('calendar',(4,14),(4,10),(14,10),(34,10),(44,10),(44,14),(44,40),(4,40),closed=True)
        self.add_line('header',(4,14),(44,14));self.relate('connect','calendar','header')
        for x in (14,34):
            self.add_line('binding-'+str(x),(x,8),(x,10));self.relate('connect','calendar','binding-'+str(x))
        self.glyph('one','1',4,19.5)
        self.glyph('eight','8',17,19.5)
        self.add_polyline('plus-h',(35,28),(37,28),(39,28))
        self.add_polyline('plus-v',(37,26),(37,28),(37,30));self.relate('connect','plus-h','plus-v')
