...
class Drawing(Solo48):
    ...
    def glyph(self,n,char,dx,dy):
        ...
        xy=lambda z:(z.real+dx,z.imag+dy)
    ...
    def build(self):
        # Native typeface-v2 digits: original paths, translation only, no redrawing or snapping.
        ...
        self.glyph('one','1',1,20)
        self.glyph('eight','8',16,20)
        self.add_polyline('plus-h',(36,30),(39,30),(42,30))
        self.add_polyline('plus-v',(39,27),(39,30),(39,33));self.relate('connect','plus-h','plus-v')
