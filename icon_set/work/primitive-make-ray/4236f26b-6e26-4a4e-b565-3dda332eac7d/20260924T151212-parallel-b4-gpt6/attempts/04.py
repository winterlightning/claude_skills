...
Plan: Rounded compass dial above readable SE, with a true NE/SW needle junction at both contour nodes. Letter bars and turns use 8-unit spacing.
Keyshape VRECT_L: extrema derived from the profile's standard envelope.
Omissions: Dial ticks omitted and triangular pointer reduced to a diagonal needle.
"""
