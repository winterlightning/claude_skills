...
Plan: Small compass dial above hand-authored SE. E bars and S turns use 8-unit vertical steps; pointer retains source upper-right direction.
Keyshape VRECT_L: extrema derived from the profile's standard envelope.
Omissions: Dial ticks omitted; pointer enlarged into a triangle that genuinely joins the dial.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('dial',(24,4),[('A',(32,12),8),('A',(24,20),8),('A',(16,12),8),('A',(24,4),8)],True)
        self.add_polyline('pointer',(24,4),(32,12),(24,12),closed=True);self.relate('connect','pointer','dial')
