...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('pointer',(20,12),(28,8),(25,16),closed=True)
        self.path('s',(18,28),[('L',(14,28)),('A',(14,36),4,4,False),('A',(14,44),4,4,True),('L',(10,44))])
        self.add_polyline('e',(38,28),(28,28),(28,36),(28,44),(38,44))
        self.add_line('e-bar',(28,36),(36,36));self.relate('connect','e','e-bar')
