...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        axis=24
        self.add_polyline('mortarboard',(17,20),(axis,13),(31,20),(30,21),(axis,27),(18,21),closed=True)
        self.add_polyline('band',(18,21),(18,35),(axis,35),(30,35),(30,21))
