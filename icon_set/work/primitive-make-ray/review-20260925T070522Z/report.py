...
lines=['# Primitive fix batch — thuan-mac','',
       ...
       'Local validation: **9 strict passes**, **11 accepted exact-SVG visual exceptions**. Automatic errors and warnings remain in each run.',
