...
Plan: Symmetric house envelope and six-lobed cog; paired coordinates preserve balance. No useful direct Lucide cog construction inspected.
Keyshape SQUARE: extrema derived from the profile's standard envelope.
Omissions: Tiny center dot omitted; cog shifted upward to clear the floor.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.house()
        points=[(22,18),(26,18),(28,22),(32,22),(32,26),(28,28),(28,32),(24,34),(20,32),(20,28),(16,26),(16,22),(20,22)]
