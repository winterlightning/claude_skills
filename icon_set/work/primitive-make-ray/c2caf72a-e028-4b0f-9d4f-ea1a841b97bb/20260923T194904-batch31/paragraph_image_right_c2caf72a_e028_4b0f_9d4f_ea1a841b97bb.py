"""A paragraph layout with an image aligned at the upper right.
Symbol plan: Square document frame, upper-right image box, two short left rules and one full rule. Ink extremes (4,4)-(44,44).
Construction: image: rounded image inset; input owns the paragraph arrangement.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.box('image',25,15,33,25,2)
        for i,y in enumerate((18,26)):self.add_line(f'left-text-{i}',(14,y),(16,y))
        self.add_line('full-text',(14,34),(34,34))
