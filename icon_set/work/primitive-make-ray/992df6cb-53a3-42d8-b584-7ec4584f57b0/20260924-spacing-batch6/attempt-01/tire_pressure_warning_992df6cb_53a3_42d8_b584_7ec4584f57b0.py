...
Plan: Single open tire silhouette and centered pressure mark; simplify thick doubled tire wall into one U.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('tire',(14,4),[('C',(14,15),(8,18),(8,28)),('C',(8,38),(14,40),(24,40)),('C',(34,40),(40,38),(40,28)),('C',(40,18),(34,15),(34,4))])
        self.add_line('warning',(24,13),(24,27))
        for n,x in [('left',18),('right',30)]:
            self.add_line('tread-'+n,(x,40),(x,44))
