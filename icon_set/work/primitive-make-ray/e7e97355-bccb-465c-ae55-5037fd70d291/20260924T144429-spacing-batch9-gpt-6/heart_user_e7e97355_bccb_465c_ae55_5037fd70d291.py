"""heart-user: Correct left lobe sweep; paired smooth heart lobes. Retain circular head and exact 4 ink head/body gap. Shoulder-to-heart spacing remains blocked.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('lobe-lo', (16, 4), (8, 12), radius_x=8, sweep=False)
        ...
        self.add_arc('shoulders', (20, 35), (28, 35), radius_x=4)
