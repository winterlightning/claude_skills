...
Plan: Shared user.svg bust construction inside a broad mirrored heart. Head/body exact gap retained; heart flanks widened around shoulders.
Keyshape SQUARE: extrema derived from the profile's standard envelope.
Omissions: Human bust reduced to small circular head and open shoulders; heart notch made shallower.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        # Mirrored broad heart, with a shallow notch and room in the lower bowl.
        self.add_bezier('heart',(24,10),((21,6),(18,6),(15,6)),((10,6),(6,10),(6,16)),((6,31),(12,36),(24,42)),((36,36),(42,31),(42,16)),((42,10),(38,6),(33,6)),((30,6),(27,6),(24,10)))
        self.circle('head',24,21,2)
        # head bottom23, shoulders crest31: exact 8 centerline / 4 ink gap.
        self.add_arc('shoulders',(20,33),(28,33),radius_x=4,radius_y=2)
