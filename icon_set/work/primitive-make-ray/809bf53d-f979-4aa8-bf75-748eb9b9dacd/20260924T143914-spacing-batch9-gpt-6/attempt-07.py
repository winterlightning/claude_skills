"""circle-bluetooth: Restored straight stem; preserve defining Bluetooth loops and circle. Blocked if triangular apertures cannot meet hole gate.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('upper',(24,24),(24,13),(33,18),(24,24))
        self.add_polyline('lower',(24,24),(33,30),(24,35),(24,24))
        self.add_polyline('rune',(16,18),(24,24),(16,30))
