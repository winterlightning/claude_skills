"""Two interlocked diagonal chain links with smoothly rounded ends and a central connecting stroke. Replace chamfered top and mismatched ends.
Construction: Lucide unlink original and atomic-debug: open round-ended contours; connector changes unlink to link.
Fresh standalone revision; original preserved.
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48
SOURCE_ICON_ID = '735c106d-fe4f-417b-ab3f-58d5a82b5c39'
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__chain-link/20260925T070522Z-thuan-mac/reference/link slash_735c106d-fe4f-417b-ab3f-58d5a82b5c39.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for name,swap in [('lower',False),('upper',True)]:
            ...
            path(name,tr((13,23)),[('L',tr((8,28))),('C',tr((6,35)),tr((7,30)),tr((6,32))),('A',tr((13,42)),7,7,False),('C',tr((20,39)),tr((16,42)),tr((18,41))),('L',tr((25,35)))])
