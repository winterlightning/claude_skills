...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('front-head',(8,18),[('L',(8,16)),('A',(16,8),8,8,True),('A',(24,16),8,8,True),('L',(24,18)),('A',(16,26),8,8,True),('A',(8,18),8,8,True)],True)
        self.add_bezier('front-fringe',(8,18),((12,18),(14,16),(16,16)),((18,16),(20,18),(24,18)))
        self.relate('connect','front-head','front-fringe')
        self.path('front-body',(4,40),[('L',(4,38)),('A',(12,30),8,8,True),('L',(20,30)),('A',(28,38),8,8,True),('L',(28,40))])
        self.circle('back-head',38,22,6)
        self.path('back-body',(28,38),[('A',(38,32),10,6,True),('A',(44,40),6,8,True)])
