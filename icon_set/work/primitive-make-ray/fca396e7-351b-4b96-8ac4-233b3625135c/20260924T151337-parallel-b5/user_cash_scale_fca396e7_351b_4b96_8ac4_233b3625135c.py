...
AUTHOR="gpt-6"
PLAN='Coin rim and closed fulcrum base omitted; person reduced to bust; dollar uses short end stems to avoid small enclosed holes.'
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('shoulders',(6,23),[('A',(12,20),6,3,True),('A',(18,23),6,3,True)])
        self.add_polyline('beam',(6,32),(24,32),(42,32))
        self.add_polyline('fulcrum',(14,42),(24,32),(34,42))
        self.relate('connect','beam','fulcrum')
        self.add_bezier('dollar',(34,8),((26,8),(26,16),(34,16)),((42,16),(42,22),(34,22)))
        self.add_line('dollar-top',(34,6),(34,8))
        self.add_line('dollar-bottom',(34,22),(34,24))
        self.relate('connect','dollar','dollar-top')
        self.relate('connect','dollar','dollar-bottom')
