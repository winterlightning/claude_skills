"""veterinarian.
Plan: Shared human user.svg circular head and shoulder vocabulary, head bottom18 to shoulder top26 gives exact four-unit ink gap. Person and cat retain veterinarian association; omit collar, stethoscope and outer badge ring to free composition.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('body-bottom',(6,42),(18,42));self.join('shoulders','body-bottom')
