...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('shoulders',(6,42),[('L',(6,36)),('A',(16,26),10,10,True),('L',(20,26))])
        self.add_line('stethoscope-tube',(16,26),(16,32))
        self.relate('connect','shoulders','stethoscope-tube')
        self.path('stethoscope-bell',(16,32),[('A',(16,36),2,2,True),('A',(16,32),2,2,True)],True)
