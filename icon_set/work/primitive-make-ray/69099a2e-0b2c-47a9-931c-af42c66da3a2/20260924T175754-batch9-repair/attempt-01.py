...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        pts=[(24,34),(14,24),(24,14),(34,24)]
        for j,(a,b) in enumerate(zip(pts,pts[1:])):self.add_arc(f'history-{j}',a,b,radius_x=10)
        self.add_contour('history',*(f'history-{j}' for j in range(3)))
        self.add_polyline('arrow',(32,22),(34,24),(34,21))
        self.relate('connect','history','arrow')
        self.add_line('hand',(24,22),(24,24))
