...
class PersonOnRisingEscalator(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline("left-arm", (15, 22), (12, 25), (12, 35))
        ...
        self.add_line("rail-landing", (6, 35), (12, 35))
        self.add_line("rail-upper-left", (12, 35), (20, 29))
        ...
        self.add_line("rail-left", (6, 42), (6, 35))
        ...
        self.add_line("direction-shaft", (33, 40), (42, 40))
