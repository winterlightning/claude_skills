...
class Drawing(Solo48):
    ...
    def build(self):
        self.terminal()
        self.add_arc('hook',(24,17),(16,17),radius_x=4,sweep=False)
        self.add_polyline('stem',(16,17),(16,20),(16,28))
        self.add_polyline('bar',(16,20),(22,20))
        self.add_polyline('base',(16,28),(24,28))
