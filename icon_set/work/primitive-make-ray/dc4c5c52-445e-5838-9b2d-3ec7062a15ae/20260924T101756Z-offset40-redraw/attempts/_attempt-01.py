...
SOURCE_PATH='icon_set/work/primitive-fix-thuan/solo__walking-dog/20260924T101756Z-thuan-mac/reference/dog walk_dc4c5c52-445e-5838-9b2d-3ec7062a15ae.svg'
AUTHOR="gpt-6"
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        path('tail',(12,18),[('C',(4,8),(5,17),(4,14))]);join('tail','dog')
