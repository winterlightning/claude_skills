...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('jaw-left-upper',(16,18),(20,22),radius_x=4)
        self.add_arc('jaw-left-lower',(20,22),(16,26),radius_x=4)
        self.add_arc('jaw-right-upper',(32,18),(28,22),radius_x=4,sweep=False)
        self.add_arc('jaw-right-lower',(28,22),(32,26),radius_x=4,sweep=False)
