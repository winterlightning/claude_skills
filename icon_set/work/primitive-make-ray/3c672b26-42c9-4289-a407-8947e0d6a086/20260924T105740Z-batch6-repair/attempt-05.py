...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        # Repair: Square-envelope fit to spread the lower row.
        for j,(x,y) in enumerate([(12, 12), (24, 12), (36, 12), (18, 36), (30, 36)]):
            path(f'ring-{j}',(x-6,y),[('A',(x+6,y),6,6,True),('A',(x-6,y),6,6,True)],True)
