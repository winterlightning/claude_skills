...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline("roof",(14,26),(24,21),(34,26),closed=True)
        self.add_line("base",(14,34),(34,34))
        for x in (16,24,32):
            self.add_line(f"column-{x}",(x,26),(x,34));self.relate("connect",f"column-{x}","base");self.relate("connect",f"column-{x}","roof")
