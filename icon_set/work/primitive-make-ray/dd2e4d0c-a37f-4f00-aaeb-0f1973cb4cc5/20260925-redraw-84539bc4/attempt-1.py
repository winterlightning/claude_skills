...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline("roof",(14,26),(24,19),(34,26),closed=True)
        self.add_line("base",(14,35),(34,35))
        for x in (17,24,31):
            self.add_line(f"column-{x}",(x,29),(x,35));self.relate("connect",f"column-{x}","base")
