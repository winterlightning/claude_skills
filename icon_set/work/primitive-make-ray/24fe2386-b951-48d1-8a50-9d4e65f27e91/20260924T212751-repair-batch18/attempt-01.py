...
class Drawing(Solo48):
    ...
    def build(self):
        # Broad rounded A and D counters; both letters retained in source order.
        self.browser()
        self.add_polyline('a-left',(14,34),(14,30),(14,26))
        self.add_arc('a-cap',(14,26),(22,26),radius_x=4)
        self.add_polyline('a-right',(22,26),(22,30),(22,34))
        self.add_line('a-bar',(14,30),(22,30))
        for n in ['a-left','a-right']:
            self.relate('connect',n,'a-cap');self.relate('connect',n,'a-bar')
        self.add_line('d-stem',(30,22),(30,34))
        self.add_arc('d-bowl',(30,22),(30,34),radius_x=4,radius_y=6)
