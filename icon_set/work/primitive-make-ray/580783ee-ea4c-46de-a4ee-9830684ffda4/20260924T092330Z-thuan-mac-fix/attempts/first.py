...
class Drawing(Solo48):
    ...
    def build(self):
        s = self
        path(s,'planet',(17,20),('A',(7,30),10,10,False),('A',(11,38),10,10,False),('A',(17,40),10,10,False),('A',(27,30),10,10,False))
        s.add_polyline('rocket',(26,14),(30,14),(34,10),(42,6),(38,14),(34,18),(34,22),closed=True)
        s.add_polyline('trail',(6,42),(11,38),(23,26));s.relate('connect','planet','trail')
