...
class Drawing(Solo48):
    ...
    def build(self):
        self.page()
        # user.svg construction: head bottom21, shoulder crest29, exact ink gap4.
        self.circle('head',22,17,4)
        self.add_bezier('shoulders',(16,35),((16,31),(18,29),(22,29)),((26,29),(28,31),(28,35)))
