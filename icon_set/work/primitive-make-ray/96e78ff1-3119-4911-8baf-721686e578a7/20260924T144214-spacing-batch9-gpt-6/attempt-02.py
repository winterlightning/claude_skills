"""file-person: Human reference user.svg: head bottom22, shoulders apex30, exact 4 ink gap; shift shared person axis to23 to clear page.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('shoulders',(17,36),(29,36),radius_x=6)
