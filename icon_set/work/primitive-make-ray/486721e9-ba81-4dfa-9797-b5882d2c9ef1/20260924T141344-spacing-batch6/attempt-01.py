...
Omissions: Map top and right segments occluded by pin.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('map',(11,18),(10,18),(6,42),(42,42),(41,35))
        self.path('pin',(20,17),[('A',(42,17),11,11,True),('C',(42,23),(35,29),(31,33)),('C',(27,29),(20,23),(20,17))],True)
        self.circle('pin-hole',31,17,2)
        self.path('route',(13,28),[('A',(23,42),14,14,False)])
        self.relate('connect','map','route')
