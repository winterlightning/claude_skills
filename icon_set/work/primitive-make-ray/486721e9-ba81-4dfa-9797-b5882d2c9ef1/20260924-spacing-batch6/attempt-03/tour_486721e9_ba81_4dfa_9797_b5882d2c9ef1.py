"""tour.
Plan: Short curved route in lower map with perpendicular bottom attachment. Large upper pin retains eye; open map boundary avoids overlap.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('route',(17,33),[('C',(17,36),(22,34),(22,38)),('L',(22,42))])
        self.join('map','route')
