"""tour.
Plan: Large pin above map, curved route below. Enlarge pin eye band and open map behind pin; purposeful perspective asymmetry.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('route',(14,26),((8,30),(13,32),(18,33)),((28,34),(22,38),(22,42)))
        self.join('map','route')
