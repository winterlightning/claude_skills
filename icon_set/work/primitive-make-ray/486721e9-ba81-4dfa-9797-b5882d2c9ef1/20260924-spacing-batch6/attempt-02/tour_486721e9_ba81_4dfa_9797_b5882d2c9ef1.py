"""tour.
Plan: Enlarged pin and eye above open map. Route simplified to gentle curve arriving perpendicular to lower map edge.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('route',(14,26),[('C',(14,31),(22,32),(22,36)),('L',(22,42))])
        self.join('map','route')
