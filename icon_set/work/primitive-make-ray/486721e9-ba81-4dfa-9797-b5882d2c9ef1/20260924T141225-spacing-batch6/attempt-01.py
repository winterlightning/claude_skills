"""tour.
Symbol plan: Pin upper right and route on map lower left. Dot replaces small pin ring.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('map',(12,15),(10,15),(6,42),(22,42),(42,42),(40,33))
        self.path('pin',(19,17),[('A',(41,17),11,11,True),('L',(30,31)),('L',(19,17))],True)
        self.add_dot('pin-hole',(30,17))
        self.path('route',(16,25),[('A',(16,33),4,4,False),('L',(22,33)),('A',(22,42),5,5,True)])
        self.join('map','route')
