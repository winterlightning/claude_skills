"""tour.
Symbol plan: Pin upper right and simplified bent route on map lower left. Dot replaces small pin ring.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('map',(10,15),(6,42),(20,42),(42,42),(40,33))
        self.path('pin',(19,17),[('A',(41,17),11,11,True),('L',(30,31)),('L',(19,17))],True)
        self.add_dot('pin-hole',(30,17))
        self.add_polyline('route',(16,26),(16,33),(20,42))
        self.join('map','route')
