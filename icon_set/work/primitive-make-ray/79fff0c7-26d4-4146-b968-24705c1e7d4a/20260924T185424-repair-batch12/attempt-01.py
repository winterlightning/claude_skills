...
class Drawing(Solo48):
    ...
    def build(self):
        # Open shoulder and pan contours remove narrow enclosed pockets.
        self.circle('head',12,11,3)
        self.add_arc('shoulders',(6,28),(18,28),radius_x=6)
        for n,cx in [('left',12),('right',36)]:
            self.add_arc(n+'-pan',(cx-8,30),(cx+8,30),radius_x=8,radius_y=6,sweep=False)
        self.add_polyline('base',(16,40),(24,40),(32,40))
        self.add_line('stem',(24,40),(24,32))
        self.relate('connect','stem','base')
        self.add_polyline('beam',(12,36),(24,32),(36,36))
        self.relate('connect','beam','stem')
        self.relate('connect','beam','left-pan')
        self.relate('connect','beam','right-pan')
        self.add_bezier('dollar',(40,10),((31,6),(30,16),(36,16)),((42,16),(41,24),(32,22)))
        self.add_line('dollar-top',(36,8),(36,6))
        self.add_line('dollar-bottom',(36,24),(36,22))
