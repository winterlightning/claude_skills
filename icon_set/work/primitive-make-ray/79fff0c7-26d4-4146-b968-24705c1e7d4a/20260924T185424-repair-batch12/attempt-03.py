...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('dollar-upper',(36,10),(36,16),radius_x=3,sweep=False)
        self.add_arc('dollar-lower',(36,16),(36,22),radius_x=3)
        self.add_polyline('dollar-bottom',(32,22),(36,22))
