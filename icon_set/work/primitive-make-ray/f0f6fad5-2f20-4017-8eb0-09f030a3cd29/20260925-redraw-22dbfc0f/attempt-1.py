...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line("latitude-n",(12,14),(34,14));self.relate("connect","latitude-n","hemisphere")
        self.add_line("latitude-s",(12,34),(34,34));self.relate("connect","latitude-s","hemisphere")
