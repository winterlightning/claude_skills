...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('leaf-upper',(15,29),((13,22),(21,18),(26,18)))
        self.add_bezier('leaf-lower',(26,18),((26,25),(22,29),(15,29)))
        self.add_contour('leaf','leaf-upper','leaf-lower',closed=True)
        self.add_line('leaf-vein',(15,29),(22,22))
        self.relate('connect','leaf','leaf-vein')
