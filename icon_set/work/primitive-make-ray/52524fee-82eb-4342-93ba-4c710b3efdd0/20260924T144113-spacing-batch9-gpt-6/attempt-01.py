"""circle-skull-xmark: Skull silhouette with four true attached crossbone rays; omit microscopic eyes and tooth divider. Enlarge jaw aperture.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('dome-left',(16,21),(24,13),radius_x=8)
        self.add_arc('dome-right',(24,13),(32,21),radius_x=8)
        self.add_line('cheek-r',(32,21),(32,25))
        self.add_polyline('jaw',(32,25),(29,28),(29,32),(19,32),(19,28),(16,25))
        self.add_line('cheek-l',(16,25),(16,21))
        self.relate('connect','jaw','cheek-r')
        self.relate('connect','jaw','cheek-l')
        self.relate('connect','dome-left','dome-right')
        self.relate('connect','dome-left','cheek-l')
        self.relate('connect','dome-right','cheek-r')
        self.add_line('bone-l',(16,21),(12,13))
        self.add_line('bone-r',(32,21),(36,13))
        self.add_line('bone-bl',(19,28),(12,35))
        self.add_line('bone-br',(29,28),(36,35))
        self.relate('connect','bone-l','dome-left')
        self.relate('connect','bone-l','cheek-l')
        self.relate('connect','bone-r','dome-right')
