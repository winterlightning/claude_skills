"""circle-skull-xmark: Preserve all four crossbone rays and identifying skull eyes. Top rays attach at exact 6-8-10 circle nodes; retain final spacing blockers rather than unrecognizable reduction.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('jaw-l',(16,32),(16,30))
        self.add_line('cheek-l',(16,30),(14,24))
        self.add_arc('dome-l',(14,24),(18,16),radius_x=10)
        self.add_arc('dome-top',(18,16),(30,16),radius_x=10)
        self.add_arc('dome-r',(30,16),(34,24),radius_x=10)
        self.add_line('cheek-r',(34,24),(32,30))
        self.add_line('jaw-r',(32,30),(32,32))
        self.add_contour('skull','jaw-l','cheek-l','dome-l','dome-top','dome-r','cheek-r','jaw-r')
        self.add_line('tooth',(24,31),(24,34))
        self.add_dot('eye-left',(20,23))
        self.add_dot('eye-right',(28,23))
        for name,a,b in [('bone-tl',(18,16),(13,11)),('bone-tr',(30,16),(35,11)),('bone-bl',(16,32),(13,35)),('bone-br',(32,32),(35,35))]:
