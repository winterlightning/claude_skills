...
Symbol plan: Sun disc bounded by cloud crown; explicit shared endpoints at both cloud/sun intersections, pin lower right.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('sun',(14,22),[('A',(6,14),8,8,True),('A',(22,14),8,8,True)])
        self.path('cloud',(22,14),[('A',(14,22),8,8,False),('A',(6,30),8,8,False),('A',(14,38),8,8,False),('L',(16,38))])
        self.join('sun','cloud')
        self.path('pin',(26,30),[('A',(42,30),8,8,True),('L',(34,42)),('L',(26,30))],True)
