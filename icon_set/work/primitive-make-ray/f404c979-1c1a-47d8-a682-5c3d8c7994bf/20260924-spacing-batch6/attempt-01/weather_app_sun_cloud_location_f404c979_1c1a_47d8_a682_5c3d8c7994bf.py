...
Plan: Rebalance three weather/location symbols into distinct regions: sun upper left, cloud lower left, pin right. Drop rays and pin eye as minor details; avoid overlapping enclosures.
