...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.circle('eye-left',20,20,4)
        self.circle('eye-right',28,20,4)
        self.add_polyline('jaw-left',(16,20),(16,25),(20,29),(20,32))
        self.add_polyline('jaw-right',(32,20),(32,25),(28,29),(28,32))
        self.relate('connect','eye-left','eye-right')
        self.relate('connect','eye-left','jaw-left')
        self.relate('connect','eye-right','jaw-right')
