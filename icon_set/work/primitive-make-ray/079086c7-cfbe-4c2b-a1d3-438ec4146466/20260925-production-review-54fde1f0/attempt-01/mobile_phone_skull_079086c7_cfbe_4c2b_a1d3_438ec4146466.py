...
Omissions: Teeth reduced to one central jaw mark; eye dots restored from the reference.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.phone()
        self.path('skull',(19,29),[('L',(19,26)),('C',(16,20),(17,25),(16,23)),('A',(24,12),8,8,True),('A',(32,20),8,8,True),('C',(29,26),(32,23),(31,25)),('L',(29,29))])
        self.add_dot('eye-left',(21,21));self.add_dot('eye-right',(27,21))
        self.add_line('jaw',(24,27),(24,29))
