...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('card',(8,8),[(20,8),(28,16),(28,36),((24,40),4,4,True),(8,40),((4,36),4,4,True),(4,12),((8,8),4,4,True)],True)
        self.rect('chip',12,22,8,10,2)
        self.add_line('signal-long',(36,26),(44,26))
        self.add_line('signal-short',(36,36),(40,36))
