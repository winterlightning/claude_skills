...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('s-top',(30,21),((27,19),(24,19),(24,19)),((16,19),(16,26),(24,26)))
        self.add_bezier('s-bottom',(24,26),((32,26),(32,33),(24,33)),((24,33),(21,33),(18,31)))
        self.add_contour('currency-s','s-top','s-bottom')
        self.add_line('currency-top',(24,17),(24,19))
        self.add_line('currency-bottom',(24,33),(24,34))
