"""User live.
Symbol plan: LIVE row with E pitch8 below a broadcast user; head(24,20)r3 shoulders apex31 gives exact8 centerline gap. Bounds6,6..42,42.
Omissions: Letter widths reduced initially to reserve gaps.
