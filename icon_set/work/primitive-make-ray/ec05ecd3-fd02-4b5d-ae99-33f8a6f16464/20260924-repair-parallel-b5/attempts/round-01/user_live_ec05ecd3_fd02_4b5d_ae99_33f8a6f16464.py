"""user live. Plan: Full LIVE caption with 8-unit E bar separation. One broadcast arc instead of two. Shared user.svg detached head and shoulder apex:21 to29.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_arc('signal',(6,24),(42,24),radius_x=18)
        self.circle('head',24,18,3)
        self.add_arc('shoulders',(18,32),(30,32),radius_x=6,radius_y=3)
