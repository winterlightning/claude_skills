"""user live. Plan: Full LIVE caption with 8-unit E bar separation. One broadcast arc instead of two. Shared user.svg detached head and shoulder apex:21 to29. Rebalance upper scene upward.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_arc('signal',(6,18),(42,18),radius_x=18,radius_y=12)
        ...
        self.add_line('letter-i',(18,26),(18,42))
        self.add_polyline('letter-v',(26,26),(29,42),(32,26))
        self.add_polyline('letter-e',(42,26),(40,26),(40,34),(40,42),(42,42))
        self.add_line('e-middle',(40,34),(42,34));self.join('letter-e','e-middle')
