"""user live. Plan: Drop broadcast arc as minor repeated context; head radius3 bottom10, shoulder apex18 keeps exact detached gap8.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('shoulders',(18,21),(30,21),radius_x=6,radius_y=3)
