"""user live. Plan: Rebalance letter widths and shallow shoulders while keeping the exact head gap. Narrow shoulders to give caption clearance margin.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('letter-l',(8,28),(8,44),(10,44))
        self.add_line('letter-i',(18,28),(18,44))
        self.add_polyline('letter-v',(26,28),(28,44),(30,28))
