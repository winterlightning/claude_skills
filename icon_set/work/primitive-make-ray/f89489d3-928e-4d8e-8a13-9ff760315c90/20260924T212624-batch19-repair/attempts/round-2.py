...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('a',(4,38),(4,24),(4,10),(14,10),(14,24),(14,33))
        self.add_line('a-bar',(4,24),(14,24));self.relate('connect','a','a-bar')
        self.add_arc('u-bottom',(14,33),(24,33),radius_x=5,sweep=False)
        self.add_polyline('u-right',(24,33),(24,10),(28,10),(36,10))
