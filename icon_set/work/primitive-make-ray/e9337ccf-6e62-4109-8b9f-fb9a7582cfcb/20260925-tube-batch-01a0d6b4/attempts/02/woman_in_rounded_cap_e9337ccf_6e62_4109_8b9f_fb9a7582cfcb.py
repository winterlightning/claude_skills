...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('visor',(14,14),[('C',(34,14),(20,12),(28,12)),('C',(14,14),(29,23),(19,23))],True)
        self.path('jaw',(14,14),[('L',(14,18)),('A',(24,28),10,10,False),('A',(34,18),10,10,False),('L',(34,14))])
        for side in (-1,1):
            p=lambda x,y:(x,y) if side==-1 else (48-x,y)
            n='hair'+str(side)
            self.path(n,p(14,18),[('C',p(9,26),p(14,21),p(11,25)),('C',p(18,27),p(12,28),p(15,28))])
            self.relate('connect',n,'jaw')
        self.path('shoulders',(8,44),[('C',(18,36),(8,38),(12,36)),('L',(24,41)),('L',(30,36)),('C',(40,44),(36,36),(40,38))])
