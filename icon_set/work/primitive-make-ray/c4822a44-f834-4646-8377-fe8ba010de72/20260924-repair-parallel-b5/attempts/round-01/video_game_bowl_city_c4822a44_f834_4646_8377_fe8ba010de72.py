"""video game bowl city. Plan: Flask/bowl with stepped city skyline and falling ball; open skyline removes tight bottom closure; shared9-unit tower widths.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('bowl',(16,18),[('C',(10,20),(6,24),(6,30)),('C',(6,38),(14,42),(24,42)),('C',(34,42),(42,38),(42,30)),('C',(42,24),(36,20),(28,18))])
        self.add_polyline('neck',(16,18),(16,12),(28,12),(28,18));self.join('bowl','neck')
        self.add_polyline('lip',(12,12),(16,12),(28,12),(30,12));self.join('lip','neck')
        self.circle('ball',39,9,3)
        self.add_polyline('city',(15,33),(15,25),(24,25),(24,21),(33,21),(33,33))
