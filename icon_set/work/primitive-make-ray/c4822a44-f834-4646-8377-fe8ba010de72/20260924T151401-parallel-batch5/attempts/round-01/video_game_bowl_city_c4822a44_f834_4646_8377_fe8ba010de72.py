...
Symbol plan: Wide round bowl, short neck, floating ball and two-step open skyline. Centerline6,6..42,42.
Omissions: City baseline and third stair removed to enlarge skyline openings; short neck lip integrated into neck.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('bowl',(18,16),[('C',(6,28),(10,18),(6,21)),('C',(24,42),(6,36),(14,42)),('C',(42,28),(34,42),(42,36)),('C',(30,16),(42,21),(38,18))])
        self.add_polyline('neck',(18,16),(18,14),(30,14),(30,16));self.relate('connect','bowl','neck')
        self.circle('ball',36,8,2)
        self.add_polyline('city',(16,32),(16,30),(24,30),(24,22),(32,22),(32,32))
