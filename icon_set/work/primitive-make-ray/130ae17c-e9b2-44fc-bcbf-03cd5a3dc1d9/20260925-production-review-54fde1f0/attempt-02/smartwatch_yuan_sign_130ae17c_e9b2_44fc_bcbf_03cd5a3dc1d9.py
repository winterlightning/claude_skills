"""Smartwatch with Yuan Sign. Separate rounded square dial and trapezoid straps; longer yuan stem and clear fork.
...
AUTHOR = 'gpt-6'
PLAN = 'Separate rounded square dial and trapezoid straps; longer yuan stem and clear fork.'
OMISSIONS = 'None.'
CONSTRUCTION_REFERENCES = ['watch']
PARENT_MODULE = 'icon_set/model/icons/solo/smartwatch_yuan_sign_130ae17c_e9b2_44fc_bcbf_03cd5a3dc1d9.py'
...
class Drawing(Solo48):
    ...
    aliases = ()
    keywords = ('smart', 'watch', 'square', 'yuan', 'sign')
    ...
    def build(self):
        ...
        self.box('dial',8,12,40,36,4)
        self.add_polyline('strap-top',(16,12),(18,4),(30,4),(32,12))
        self.add_polyline('strap-bottom',(16,36),(18,44),(30,44),(32,36))
        self.add_polyline('yuan',(17,20),(24,25),(31,20))
        self.add_line('yuan-stem',(24,25),(24,28))
