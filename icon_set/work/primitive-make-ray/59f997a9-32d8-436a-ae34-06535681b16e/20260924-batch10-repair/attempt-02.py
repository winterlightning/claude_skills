...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('parcel',(4,8),(16,8),(16,20),(16,32),(4,32),(4,20),closed=True)
        self.add_line('parcel-fold',(4,20),(16,20));self.relate('connect','parcel','parcel-fold')
        self.add_polyline('phone',(24,16),(44,16),(44,40),(24,40),closed=True)
