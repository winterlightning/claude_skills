...
class AerialYogaBowPose(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('left-suspension',(18,8),(14,20),(12,30))
        ...
        self.add_arc('limb-shoulder',(14,20),(4,30),radius_x=10,radius_y=10,sweep=False)
        ...
        self.add_arc('body-bend',(26,20),(26,28),radius_x=4)
        self.add_line('body-lower',(26,28),(26,37))
