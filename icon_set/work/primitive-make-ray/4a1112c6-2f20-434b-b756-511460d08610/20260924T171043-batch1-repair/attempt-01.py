...
class AerialYogaBowPose(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line("limb-side", (6, 30), (6, 36))
        self.add_arc("limb-fold", (6, 36), (18, 36), radius_x=6, sweep=False)
        self.add_line("limb-return", (18, 36), sling_left)
        self.add_contour(
            "folded-limb",
            "limb-shoulder",
            "limb-side",
        ...
        self.add_arc("body-bend", right_attach, (28, 34), radius_x=6, sweep=False)
        self.add_line("body-lower", (28, 34), (24, 38))
        self.add_line("torso", (24, 38), (28, 38))
        self.add_contour("body", "body-bend", "body-lower")
        self.relate("connect", "body-lower", "torso")
        self.relate("connect", "body", "sling")

        head_cx, head_cy, head_radius = 39, 38, 3
        self.add_arc(
            "head-top",
