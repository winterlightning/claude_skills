"""Open folder with the tab on its forward leaf.
...
Omissions: Rounded transitions reduced to round joins.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('front',(4,18),(14,18),(20,26),(44,26),(40,40),(8,40),closed=True)
