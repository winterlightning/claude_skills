"""french fries. Revision of reviewer feedback: Bad stroke drawn.
Plan: French fries standing in a tapered carton with a curved scoop. Three fries share wall nodes with carton. x8..40,y4..44.
Construction reference: No useful exact Lucide match; geometric contours reconstructed from supplied reference.
Omissions: Five narrow source fries reduced to three broad fries to retain 4px strokes.
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48
SOURCE_ICON_ID = '3694919c-1930-40ea-a0d1-04c413ff7f2f'
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__box-of-french-fries-batch-010-09/20260924T090615Z-thuan-mac/reference/french fries_3694919c-1930-40ea-a0d1-04c413ff7f2f.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    icon_id = 'box-of-french-fries-batch-010-09'
    ...
    def build(self):
        ...
        poly('carton',(8,26),(12,44),(36,44),(40,26))
        bez('scoop-left',(8,26),((12,26),(12,32),(24,32)))
        bez('scoop-right',(24,32),((36,32),(36,26),(40,26)))
        contour('scoop','scoop-left','scoop-right')
        poly('left-fry',(8,26),(8,8),(16,8),(16,30))
        poly('middle-fry',(16,30),(16,4),(24,4),(24,32))
        poly('right-fry',(24,32),(32,8),(40,8),(40,26))
