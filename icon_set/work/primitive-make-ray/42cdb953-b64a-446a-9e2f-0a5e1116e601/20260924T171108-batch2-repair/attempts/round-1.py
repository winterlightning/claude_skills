...
Plan: Three identical rounded rectangles in a centered series, shared width and radius. HRECT_L extremes (4,8)-(44,40). Lucide book informs tangent rounded corners. Three spines retained; labels and finger holes omitted because an eight-unit-wide spine cannot enclose details with eight-unit clearance.
"""
