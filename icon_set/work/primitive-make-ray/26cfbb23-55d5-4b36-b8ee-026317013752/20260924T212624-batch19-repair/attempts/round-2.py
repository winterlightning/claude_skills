...
class Drawing(Solo48):
    ...
    def build(self):
        self.box('panel',4,8,40,26,3)
        for i,x in enumerate((13,35)):
            self.add_line(f'post-{i}',(x,34),(x,40));self.relate('connect','panel',f'post-{i}')
        self.add_polyline('two',(13,17),(21,17),(21,21),(13,25),(21,25))
        self.circle('zero',33,21,3)
