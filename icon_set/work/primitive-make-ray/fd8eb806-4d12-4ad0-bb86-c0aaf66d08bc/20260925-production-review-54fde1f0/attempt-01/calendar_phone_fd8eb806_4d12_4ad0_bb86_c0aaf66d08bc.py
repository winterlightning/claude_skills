"""Calendar with Telephone Handset. Calendar with restored outlined diagonal handset and rounded frame.
...
AUTHOR = 'gpt-6'
PLAN = 'Calendar with restored outlined diagonal handset and rounded frame.'
OMISSIONS = 'None.'
