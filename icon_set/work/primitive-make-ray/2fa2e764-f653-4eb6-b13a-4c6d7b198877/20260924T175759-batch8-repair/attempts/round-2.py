...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('plug-right',(cx+radius,25),(cx+radius,28))
        self.add_arc('bowl-right',(cx+radius,28),(cx,34),radius_x=radius)
        self.add_arc('bowl-left',(cx,34),(cx-radius,28),radius_x=radius)
        self.add_line('plug-left',(cx-radius,28),(cx-radius,25))
        ...
        self.add_bezier('cable',(21,34),((21,37),(24,38),(24,42)))
