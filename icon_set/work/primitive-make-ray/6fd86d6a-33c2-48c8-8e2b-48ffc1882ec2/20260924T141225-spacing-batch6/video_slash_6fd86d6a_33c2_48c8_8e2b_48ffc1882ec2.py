"""video slash.
Symbol plan: Interrupted camera body and lens stay outside a broad diagonal slash corridor.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('body-upper',(24,10),[('L',(28,10)),('A',(32,14),4,4,True),('L',(32,18))])
        self.path('body-lower',(6,20),[('L',(6,34)),('A',(10,38),4,4,False),('L',(24,38))])
        self.add_polyline('lens',(32,18),(42,12),(42,28))
        self.join('body-upper','lens')
