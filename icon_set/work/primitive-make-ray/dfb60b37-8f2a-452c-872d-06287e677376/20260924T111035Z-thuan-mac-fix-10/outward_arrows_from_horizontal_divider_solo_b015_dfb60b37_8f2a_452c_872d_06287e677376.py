...
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__outward-arrows-from-horizontal-divider-solo-b015/20260924T111035Z-thuan-mac/reference/expand vertical 2_dfb60b37-8f2a-452c-872d-06287e677376.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    ...
    aliases = ()
    keywords = ('outward', 'arrows', 'from', 'horizontal', 'divider', 'solo', 'b015')
    def build(self):
