"""insurance cheap.
Plan: Dollar lower on the left of a rising price/health balance beam; medical plus higher at right. Dollar dimensions match the expensive counterpart.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('dollar',(18,16),[('L',(16,16)),('C',(11,16),(11,21),(16,21)),('C',(21,21),(21,26),(16,26)),('L',(14,26))])
        self.add_line('dollar-top',(16,14),(16,16));self.relate('connect','dollar','dollar-top')
