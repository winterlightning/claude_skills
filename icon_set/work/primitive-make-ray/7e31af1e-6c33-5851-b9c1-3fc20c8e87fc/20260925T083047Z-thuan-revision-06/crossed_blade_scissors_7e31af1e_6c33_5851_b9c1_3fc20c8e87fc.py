"""Open scissors with two round finger loops and crossed blade faces. Restore the blade outlines, smooth tips and visible front-over-back overlap.
Construction: Lucide scissors original and atomic-debug: circular finger loops and deliberately interrupted back blade.
