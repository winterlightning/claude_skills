...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('pages',(10,6),(18,6),(24,8),(30,6),(38,6),(38,16),(30,16),(24,18),(18,16),(10,16),closed=True)
        self.add_line('binding',(24,8),(24,18));self.relate('connect','pages','binding')
