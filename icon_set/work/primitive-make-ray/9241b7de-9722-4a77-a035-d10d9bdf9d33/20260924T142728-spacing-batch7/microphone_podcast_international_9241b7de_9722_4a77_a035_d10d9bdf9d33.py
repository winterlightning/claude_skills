...
Plan: Broad globe cap with elevated equator and one central meridian, over a capsule mic and U support.
Construction: Lucide mic capsule and U cradle, globe grid with actual shared endpoints.
Omissions: Paired meridians reduced to one; base crossbar omitted to avoid crowding the bowl.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('globe',(8,20),[('L',(8,12)),('A',(24,4),16,8,True),('A',(40,12),16,8,True),('L',(40,20))])
        self.add_polyline('equator',(8,12),(24,12),(40,12))
        self.add_line('meridian',(24,4),(24,12))
        self.relate('connect','globe','equator');self.relate('connect','globe','meridian');self.relate('connect','meridian','equator')
        self.rect('microphone',20,21,8,11,4)
        self.path('support',(8,29),[('A',(24,41),16,12,False),('A',(40,29),16,12,False)])
        self.add_line('stand',(24,41),(24,44))
