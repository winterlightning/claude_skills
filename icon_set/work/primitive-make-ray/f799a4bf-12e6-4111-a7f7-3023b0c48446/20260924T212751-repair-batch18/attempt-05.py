...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('a-left',(17,24),(17,22),(17,14))
        self.add_arc('a-cap',(17,14),(25,14),radius_x=4)
        self.add_polyline('a-right',(25,14),(25,22),(25,24))
        self.add_line('a-bar',(17,22),(25,22))
        for n in ['a-left','a-right']:
            self.relate('connect',n,'a-cap');self.relate('connect',n,'a-bar')
        self.add_polyline('b-stem',(17,20),(17,28),(17,36))
        self.add_arc('b-upper',(17,20),(17,28),radius_x=8,radius_y=4)
        self.add_arc('b-lower',(17,28),(17,36),radius_x=8,radius_y=4)
