...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('a-left',(15,26),(15,22),(15,18))
        self.add_arc('a-cap',(15,18),(23,18),radius_x=4)
        self.add_polyline('a-right',(23,18),(23,22),(23,26))
        self.add_line('a-bar',(15,22),(23,22))
        for n in ['a-left','a-right']:
            self.relate('connect',n,'a-cap');self.relate('connect',n,'a-bar')
        self.add_polyline('b-stem',(15,24),(15,32),(15,40))
        self.add_arc('b-upper',(15,24),(15,32),radius_x=8,radius_y=4)
        self.add_arc('b-lower',(15,32),(15,40),radius_x=8,radius_y=4)
