...
class Drawing(Solo48):
    ...
    def build(self):
        # A and B stay in two source-ordered rows, with explicit A crossbar nodes.
        self.rect('page',6,6,36,36,4)
        self.add_polyline('a-sides',(15,24),(17,18),(19,12),(21,18),(23,24))
        self.add_line('a-bar',(17,18),(21,18));self.relate('connect','a-sides','a-bar')
        self.add_polyline('b-stem',(15,28),(15,32),(15,36))
        self.add_arc('b-upper',(15,28),(15,32),radius_x=6,radius_y=2)
        self.add_arc('b-lower',(15,32),(15,36),radius_x=6,radius_y=2)
        self.relate('connect','b-stem','b-upper','b-lower')
        for i,y in enumerate((20,32)):self.add_line(f'answer-{i}',(32,y),(33,y))
