...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('a-sides',(16,24),(18,18),(20,12),(22,18),(24,24))
        self.add_line('a-bar',(18,18),(22,18));self.relate('connect','a-sides','a-bar')
        self.add_polyline('b-stem',(16,28),(16,32),(16,36))
        self.add_arc('b-upper',(16,28),(16,32),radius_x=6,radius_y=2)
        self.add_arc('b-lower',(16,32),(16,36),radius_x=6,radius_y=2)
