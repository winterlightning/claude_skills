...
Reduction: Retained both rules; reduced dollar flourish to paired circular turns.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('dollar',(28,14),[(22,14),((22,22),4,4,False),(24,22),((24,30),4,4,True),(18,30)])
        self.add_line('dollar-top',(23,10),(23,14))
        self.add_line('dollar-bottom',(23,30),(23,32))
        self.relate('connect','dollar-top','dollar')
        self.relate('connect','dollar-bottom','dollar')
        self.add_line('rule-long',(17,36),(31,36))
        self.add_line('rule-short',(17,40),(24,40))
