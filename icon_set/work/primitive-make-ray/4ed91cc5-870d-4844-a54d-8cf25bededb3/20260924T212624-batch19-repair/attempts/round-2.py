...
class AuthoredIcon(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('target-upper',(6,24),(42,24),radius_x=18)
        self.add_arc('target-lower',(42,24),(24,42),radius_x=18)
        self.add_polyline('rifle',(6,24),(24,24),(26,24),(42,24))
        self.add_polyline('stock',(6,24),(6,34),(18,34),(26,24))
        self.relate('connect','rifle','stock')
        self.relate('connect','rifle','target-upper');self.relate('connect','rifle','target-lower')
        self.add_line('sight-top',(24,6),(24,14))
