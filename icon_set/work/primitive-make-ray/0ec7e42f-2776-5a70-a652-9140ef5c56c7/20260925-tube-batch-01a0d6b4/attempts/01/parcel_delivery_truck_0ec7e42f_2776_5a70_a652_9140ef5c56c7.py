...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('cargo',(8,36),[('L',(4,36)),('L',(4,12)),('A',(8,8),4,4,True),('L',(12,8)),('L',(22,8)),('L',(24,8)),('A',(28,12),4,4,True),('L',(28,18)),('L',(28,30))])
        self.path('cab',(28,18),[('L',(34,18)),('L',(44,28)),('L',(44,32)),('A',(40,36),4,4,True)])
        self.circle('rear-wheel',12,36,4);self.circle('front-wheel',36,36,4)
        self.add_line('chassis',(16,36),(32,36));self.add_line('windscreen',(36,28),(44,28))
        self.add_polyline('parcel-tape',(12,8),(12,18),(17,15),(22,18),(22,8))
