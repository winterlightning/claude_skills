...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        c=16/3
        self.add_bezier('ring-top',(18,8),((22,c),(26,c),(30,8)))
        self.add_bezier('ring-bottom',(30,40),((26,48-c),(22,48-c),(18,40)))
        self.add_bezier('ring-left',(8,30),((c,26),(c,22),(8,18)))
        self.add_bezier('ring-right',(40,18),((48-c,22),(48-c,26),(40,30)))
        ...
        self.add_polyline('flap',(15,17),(24,24),(33,17))
