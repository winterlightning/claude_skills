...
class Drawing(Solo48):
    ...
    def build(self):
        self.frame()
        # Concentric bends retain a nine-unit handset band inside the square.
        self.add_line('ear-top',(15,15),(24,15))
        self.add_arc('inner-bend',(24,15),(33,24),radius_x=9,sweep=False)
        self.add_line('ear-bottom',(33,24),(33,33))
        self.add_arc('outer-bend',(33,33),(15,15),radius_x=18,sweep=True)
        self.add_contour('handset','ear-top','inner-bend','ear-bottom','outer-bend',closed=True)
