...
Visual review at48px and240px in light and dark: **not approved**. Both equal eight-tooth gears remain on the reference diagonal. Tooth valleys and hubs crowd at native size; not approved.
...
[SVG](cog-double.svg) · [Python](cog_double_b484255b_2a40_40d1_9943_7e27cfb9f399.py) · [Light](light-240.png) · [Dark](dark-240.png)
