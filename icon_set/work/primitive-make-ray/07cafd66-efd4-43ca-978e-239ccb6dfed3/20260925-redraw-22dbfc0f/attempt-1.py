...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_dot("tab-a",(13,10));self.add_dot("tab-b",(23,10))
        self.path("dollar",(29,23),[((26,20),(18,20),(18,25)),((18,30),(30,27),(30,32)),((30,37),(22,37),(19,34))])
        self.add_line("spine",(24,19),(24,38));self.relate("connect","spine","dollar")
