...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('feather-fan-1',(17,24),(22,13))
        self.add_line('feather-fan-2',(22,13),(31,18))
        self.add_line('feather-fan-3',(31,18),(23,24))
        self.add_arc('cork',(23,24),(17,24),radius_x=3)
