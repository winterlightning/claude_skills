...
SOURCE_PATH = 'pictographic-primitives/_uncategorized_10/card game dice_7313c8ec-d635-4b38-acd5-fea39286b43e.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'playing-cards-and-dice'
    ...
    def build(self):
        # Diamond card at left, spade card behind, and a four-pip die in foreground. Each closed symbol has its own contents; overlaps use visible interrupted contours. Square extremes (4,4)-(44,44).
        def circle(n,x,y,r):
        ...
        self.add_polyline('left-card',(26,34),(12,42),(6,16),(20,10),(26,26))
        self.add_polyline('back-card',(20,10),(24,6),(42,10),(38,26))
        rounded('die',26,26,42,42,3)
        ...
        for row in range(2):
            for col in range(2): self.add_dot(f'pip-{row}-{col}',(30+8*col,30+8*row))
