...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('face',(20,6),[('A',(30,16),10,10,True),('A',(26,24),10,10,True),('A',(14,24),10,10,True),('A',(10,16),10,10,True),('A',(20,6),10,10,True)],True)
        self.path('hair',(20,6),[('C',(26,4),(22,4),(24,4)),('C',(40,26),(36,4),(40,16)),('C',(38,34),(40,29),(39,32))]);self.relate('connect','hair','face')
        self.path('left-body',(8,44),[('C',(10,34),(8,39),(9,36)),('L',(14,32)),('L',(14,24))]);self.relate('connect','left-body','face')
        self.path('right-body',(26,24),[('L',(26,34)),('C',(38,34),(30,30),(34,30)),('C',(40,44),(40,37),(40,41))]);self.relate('connect','right-body','face');self.relate('connect','right-body','hair')
        self.path('neckline',(10,34),[('C',(26,34),(14,40),(21,40))]);self.relate('connect','neckline','left-body');self.relate('connect','neckline','right-body')
        # Source has a real connected neck; detached head spacing does not apply.
