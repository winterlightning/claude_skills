...
AUTHOR = 'gpt-6'
PLAN = 'A checkmark inside a rounded square communicates pass.'
OMISSIONS = 'No features omitted.'
...
class Drawing(Solo48):
    ...
    def build(self):
        # Symbol plan: A checkmark inside a rounded square communicates pass.
