"""A pass checkmark inside a rounded square.
Symbol plan: A directional check sits within a centered rounded frame. Ink extremes (4,4)-(44,44).
Construction: check: short descending stroke joined to a longer rising stroke; square-parking: rounded frame construction.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.box('frame',6,6,42,42,6)
        self.add_polyline('check',(15,25),(22,32),(33,17))
