...
class Drawing(Solo48):
    ...
    def build(self):
        nodes=[(11,17),(12,12),(24,4),(36,12),(37,17)]
        for i,(a,b) in enumerate(zip(nodes,nodes[1:])):self.add_arc('dome-'+str(i),a,b,radius_x=13)
        self.add_contour('globe-dome',*['dome-'+str(i) for i in range(4)])
        self.add_polyline('meridian',(24,4),(24,12),(24,17))
        self.add_polyline('latitude',(12,12),(24,12),(36,12))
        self.relate('connect','meridian','globe-dome')
        self.relate('connect','latitude','globe-dome')
        self.relate('connect','latitude','meridian')
