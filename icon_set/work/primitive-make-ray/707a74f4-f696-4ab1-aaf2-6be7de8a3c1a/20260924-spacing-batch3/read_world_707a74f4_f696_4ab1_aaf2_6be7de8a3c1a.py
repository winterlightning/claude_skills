...
AUTHOR='gpt-6'
PLAN='An open book below a globe. Paired page curves and globe quadrants mirror about x=24. Globe reads as a globe, rather than the earlier umbrella-like dome.'
...
class Drawing(Solo48):
    ...
    def build(self):
        # Complete symmetric globe with equator/meridian, open book, shared spine.
...
FINAL_OMISSIONS = 'Drop page text; use one equator and one meridian; separate complete globe above book.'
VISUAL_REVIEW = 'Paired page curves and globe quadrants mirror about x=24. Globe reads as a globe, rather than the earlier umbrella-like dome.'
