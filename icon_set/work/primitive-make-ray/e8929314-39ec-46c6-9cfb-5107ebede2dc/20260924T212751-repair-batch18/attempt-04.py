...
class Drawing(Solo48):
    ...
    def build(self):
        for row,(text,starts) in enumerate([('10100',(4,10,24,28,36)),('01100',(4,18,24,28,36))]):
            y=8+row*12
        ...
        for row,y in enumerate((30,38)):
            for col in range(2):
                x=4+20*col
                self.add_bezier(f'wave-{row}-{col}',(x,y),((x+3,y+2),(x+6,y+2),(x+9,y+2)),((x+12,y+2),(x+15,y+2),(x+20,y)))
