"""magnifying-glass-pill: Rebalance capsule to horizontal with rounded ends; omit internal seam to enlarge medicine aperture. Circular lens and exact 3-4-5 handle junction retained.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('pill-top',(19,17),(23,17))
        self.add_arc('pill-right',(23,17),(23,25),radius_x=4)
        self.add_line('pill-bottom',(23,25),(19,25))
        self.add_arc('pill-left',(19,25),(19,17),radius_x=4)
