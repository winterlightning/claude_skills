...
class Drawing(Solo48):
    ...
    def build(self):
        self.circle('head',34,13,5)
        self.add_arc('shoulder',(24,36),(44,36),radius_x=10,radius_y=10)
        self.add_line('right-side',(44,36),(44,40))
        self.add_contour('body','shoulder','right-side')
        self.add_polyline('screen',(4,40),(4,23),(10,23))
        self.add_polyline('laptop',(4,40),(16,40),(12,32),(4,32))
        self.relate('connect','screen','laptop')
        self.cross('medical',34,37,2)
