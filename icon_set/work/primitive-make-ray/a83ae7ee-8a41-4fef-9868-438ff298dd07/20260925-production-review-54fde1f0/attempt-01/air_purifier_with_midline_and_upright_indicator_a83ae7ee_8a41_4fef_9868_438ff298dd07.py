...
OMISSIONS = 'None.'
CONSTRUCTION_REFERENCES = ['wind', 'smartphone']
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.box('body',8,16,40,44,5)
        self.add_line('divider',(8,33),(40,33))
        self.add_line('indicator',(24,24),(24,25))
        for x in (18,30):
            self.path(f'air-{x}',(x,4),[('C',(x,8),(x-2,5),(x,6)),('C',(x,10),(x+1,9),(x+1,9))])
