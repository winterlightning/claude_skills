...
SOURCE_PATH = 'pictographic-primitives/_uncategorized_11/check payment give_3f6c05d9-0083-4007-be5b-cfc78f47999f.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'hand-selecting-bank-check'
    ...
    def build(self):
        ...
        self.add_polyline('check',(16,26),(6,26),(6,6),(42,6),(42,26),(40,26))
        self.add_line('writing',(14,15),(22,15))
        self.add_line('amount',(30,15),(34,15))
        self.add_line('finger-left',(24,32),(24,24))
        self.add_arc('tip',(24,24),(32,24),radius_x=4)
        self.add_polyline('finger-right',(32,24),(32,32),(36,32),(36,36))
        ...
        self.add_polyline('palm-left',(16,36),(16,32),(24,24))
