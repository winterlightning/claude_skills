...
class Drawing(Solo48):
    ...
    def build(self):
        # Infinity lobes share crossing at (23,24); axial endpoints own exact bounds.
        self.add_bezier('loop',(23,24),((23,16),(17,10),(12,10)),((7,10),(4,16),(4,24)),((4,32),(7,38),(12,38)),((17,38),(23,32),(23,24)),((23,16),(31,10),(36,10)),((41,10),(44,14),(44,20)),((44,22),(44,26),(44,28)),((44,34),(41,38),(36,38)),((31,38),(23,32),(23,24)))
        self.add_contour('infinity','loop',closed=True)
        self.add_line('minus',(12,24),(14,24))
