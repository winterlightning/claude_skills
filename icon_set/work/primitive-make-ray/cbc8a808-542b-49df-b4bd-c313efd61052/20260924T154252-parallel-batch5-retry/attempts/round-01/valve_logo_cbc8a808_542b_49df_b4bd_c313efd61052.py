...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        top,bottom=10,38
        for name,left in [('v-first',4),('v-second',33)]:
            self.add_polyline(name,(left,top),(left+2,bottom),(left+4,top))
        self.path('a-sides',(13,bottom),[('L',(13,26)),('L',(13,14)),('A',(21,14),4,4,True),('L',(21,26)),('L',(21,bottom))])
        self.add_line('a-bar',(13,26),(21,26));self.relate('connect','a-sides','a-bar')
        self.add_polyline('l',(26,top),(26,bottom),(28,bottom))
