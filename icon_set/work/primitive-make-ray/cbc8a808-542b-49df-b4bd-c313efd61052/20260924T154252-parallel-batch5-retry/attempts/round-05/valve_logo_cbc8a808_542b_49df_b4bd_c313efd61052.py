...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for name,left in [('v-first',4),('v-second',34)]:
            self.add_polyline(name,(left,top+8),(left+2,bottom),(left+4,top+8))
        self.path('a-sides',(13,bottom),[('L',(13,26)),('L',(13,12)),('A',(21,12),4,4,True),('L',(21,26)),('L',(21,bottom))])
        self.add_line('a-bar',(13,26),(21,26));self.relate('connect','a-sides','a-bar')
        self.add_polyline('l',(29,top),(29,bottom-8),(30,bottom-8))
