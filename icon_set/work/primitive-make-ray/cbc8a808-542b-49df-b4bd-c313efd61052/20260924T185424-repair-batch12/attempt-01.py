...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        top,bottom=10,38
        self.add_polyline('v-first',(4,top),(8,bottom),(12,top))
        self.add_polyline('a-sides',(14,bottom),(15,24),(16,top),(17,24),(18,bottom))
        self.add_line('a-bar',(15,24),(17,24));self.relate('connect','a-sides','a-bar')
