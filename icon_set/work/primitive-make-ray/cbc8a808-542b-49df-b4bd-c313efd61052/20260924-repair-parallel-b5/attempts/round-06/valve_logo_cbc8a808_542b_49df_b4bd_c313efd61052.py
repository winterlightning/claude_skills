"""valve logo. Plan: Enlarge rounded A opening vertically; two-row arrangement remains a visual mismatch to logo.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('v-first',(6,6),(10,18),(14,6))
        self.add_polyline('l',(38,6),(38,18),(42,18))
        self.add_polyline('v-second',(12,26),(16,42),(20,26))
        self.add_polyline('e',(36,26),(28,26),(28,34),(28,42),(36,42))
        self.add_line('e-middle',(28,34),(36,34));self.join('e','e-middle')
        self.path('a-sides',(22,18),[('L',(22,16)),('L',(22,10)),('A',(30,10),4,4,True),('L',(30,16)),('L',(30,18))])
        self.add_line('a-bar',(22,16),(30,16));self.join('a-sides','a-bar')
