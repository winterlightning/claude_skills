"""valve logo. Plan: Rebalance the full word with alternating letter baselines; E bars now8 apart.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_polyline('v-first',(4,10),(8,26),(12,10))
        self.add_polyline('a-sides',(14,38),(18,18),(22,38))
        self.add_line('a-bar',(16,28),(20,28));self.join('a-sides','a-bar')
        self.add_polyline('l',(24,10),(24,30),(28,30))
        self.add_polyline('v-second',(30,18),(34,38),(38,18))
        self.add_polyline('e',(44,10),(40,10),(40,18),(40,26),(44,26))
        self.add_line('e-middle',(40,18),(44,18));self.join('e','e-middle')
