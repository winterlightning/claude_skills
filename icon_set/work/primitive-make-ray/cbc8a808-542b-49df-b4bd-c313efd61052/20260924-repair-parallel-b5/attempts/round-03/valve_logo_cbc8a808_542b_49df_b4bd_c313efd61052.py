"""valve logo. Plan: Try square two-row word layout to give each letter its own8-unit horizontal gap; retain all letters.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('a-sides',(22,18),(24,12),(26,6),(28,12),(30,18))
        self.add_line('a-bar',(24,12),(28,12));self.join('a-sides','a-bar')
