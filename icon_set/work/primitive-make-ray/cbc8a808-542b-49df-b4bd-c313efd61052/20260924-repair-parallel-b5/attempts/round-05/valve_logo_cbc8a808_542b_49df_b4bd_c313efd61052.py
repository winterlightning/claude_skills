"""valve logo. Plan: Replace pinched triangular A counter with a rounded arch and shared bar junctions.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('a-sides',(22,18),[('L',(22,14)),('L',(22,10)),('A',(30,10),4,4,True),('L',(30,14)),('L',(30,18))])
        self.add_line('a-bar',(22,14),(30,14));self.join('a-sides','a-bar')
