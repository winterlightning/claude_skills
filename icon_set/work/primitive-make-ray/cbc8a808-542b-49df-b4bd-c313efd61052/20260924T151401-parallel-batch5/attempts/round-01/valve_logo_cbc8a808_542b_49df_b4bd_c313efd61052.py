...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('a-sides',(13,bottom),(17,top),(21,bottom))
        self.add_line('a-bar',(15,24),(19,24));self.relate('connect','a-bar','a-sides')
        self.add_polyline('l',(24,top),(24,bottom),(28,bottom))
        self.add_polyline('v-second',(31,top),(34,bottom),(37,top))
