...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        x0=4; top=10; bottom=38
        self.add_polyline('v-first',(4,top),(6,bottom),(8,top))
        self.add_polyline('a-sides',(12,bottom),(16,24),(20,top),(24,24),(28,bottom))
        self.add_line('a-bar',(16,24),(24,24));self.relate('connect','a-bar','a-sides')
        self.add_polyline('l',(31,top),(31,bottom),(33,bottom))
        self.add_polyline('v-second',(36,top),(38,bottom),(40,top))
