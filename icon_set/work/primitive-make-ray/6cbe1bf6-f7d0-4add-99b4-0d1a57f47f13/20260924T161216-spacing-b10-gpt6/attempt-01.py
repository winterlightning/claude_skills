"""monitor math. Taller monitor to give division dots a sixteen-unit band.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('plus-h',(17,24),(20,24),(23,24))
        self.add_polyline('plus-v',(20,21),(20,24),(20,27))
        self.relate('connect','plus-h','plus-v')
        self.add_line('divide-bar',(28,20),(31,20))
        self.add_dot('divide-top',(30,12))
        self.add_dot('divide-bottom',(30,28))
