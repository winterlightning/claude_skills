...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('body',(20,38),[('L',(20,30)),('L',(19,28)),('L',(19,25)),
            ('A',(24,20),5),('A',(29,25),5),('L',(29,28)),('L',(28,30)),('L',(28,38))])
        self.add_bezier('route-top',(14,27),((10,27),(8,28),(8,29)))
        self.add_arc('route-left',(6,34),(8,39),radius_x=8,sweep=False)
        self.add_line('route-bottom',(13,42),(19,42))
        self.add_line('route-dash',(27,42),(29,42))
        self.add_polyline('arrow-head',(38,23),(42,27),(38,31))
        self.add_line('arrow-shaft',(34,27),(42,27))
