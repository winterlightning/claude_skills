"""video game logo companion cube. Plan: Four mirrored corner blocks connected by straight rails; drop narrow connector sleeves and medallion ring while retaining central heart.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('heart',(24,32),[('L',(19,27)),('C',(15,23),(20,18),(24,22)),('C',(28,18),(33,23),(29,27)),('L',(24,32))],True)
