"""video game logo companion cube. Plan: Four mirrored corner blocks connected by straight rails; drop narrow connector sleeves and medallion ring while retaining central heart. Raise tip to give bottom rail8-unit clearance. Rebalance paired lobes inward for rail clearance.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path('heart',(24,30),[('L',(19,27)),('C',(17,23),(20,18),(24,22)),('C',(28,18),(31,23),(29,27)),('L',(24,30))],True)
