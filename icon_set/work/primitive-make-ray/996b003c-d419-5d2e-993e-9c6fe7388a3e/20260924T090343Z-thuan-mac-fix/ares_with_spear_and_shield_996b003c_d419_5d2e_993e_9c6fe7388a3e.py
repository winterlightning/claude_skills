"""Ares with upright spear and round shield, with head aligned to the shoulder and a coherent standing torso. Bounds (6,6)-(42,42). Head (23,11), radius5; torso starts (23,24): exactly 8 centerline / 4 ink gap.
