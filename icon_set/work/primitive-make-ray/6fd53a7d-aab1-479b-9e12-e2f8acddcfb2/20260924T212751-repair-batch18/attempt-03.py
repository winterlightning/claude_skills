...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('shirt-sides',(28,20),(32,20),(32,28),(28,28),(28,36),(20,36),(20,28),(16,28),(16,20),(20,20))
        self.add_bezier('neck',(20,20),((20,24),(28,24),(28,20)))
        self.add_contour('shirt',*[f'shirt-sides-{i}' for i in range(1,10)],'neck',closed=True)
        self.contours=[c for c in self.contours if c.contour_id!='shirt-sides']
