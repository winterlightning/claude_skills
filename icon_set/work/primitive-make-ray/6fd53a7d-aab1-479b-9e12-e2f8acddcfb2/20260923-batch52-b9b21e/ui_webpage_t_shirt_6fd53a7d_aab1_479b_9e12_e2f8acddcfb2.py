...
class Drawing(Solo48):
    ...
    def build(self):
        self.browser()
        self.add_polyline('shirt-left',(22,23),(19,23),(15,27),(17,30),(20,28),(20,33),(28,33),(28,28),(31,30),(33,27),(29,23),(26,23))
        self.add_arc('neckline',(26,23),(22,23),radius_x=2)
        self.add_contour('shirt',*[f'shirt-left-{i}' for i in range(1,12)],'neckline',closed=True)
        self.contours = [c for c in self.contours if c.contour_id not in ['shirt-left']]
