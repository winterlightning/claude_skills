...
class Drawing(Solo48):
    ...
    def build(self):
        self.path('cup',(14,6),[('L',(34,6)),('L',(34,10)),('L',(34,14)),('A',(24,24),10,10,True),('A',(14,14),10,10,True),('L',(14,10))],True)
        self.path('handle-left',(14,6),[('L',(10,6)),('A',(6,10),4,4,False),('A',(10,14),4,4,False),('L',(14,14))])
        self.path('handle-right',(34,6),[('L',(38,6)),('A',(42,10),4,4,True),('A',(38,14),4,4,True),('L',(34,14))])
        self.join('cup','handle-left');self.join('cup','handle-right')
        self.add_line('stem',(24,24),(24,33));self.join('cup','stem')
        self.add_polyline('bracket',(12,38),(12,33),(24,33),(36,33),(36,38));self.join('stem','bracket')
