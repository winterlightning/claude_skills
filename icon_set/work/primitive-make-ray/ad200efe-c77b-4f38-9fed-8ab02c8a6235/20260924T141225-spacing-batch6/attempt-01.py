"""trip road 1.
Symbol plan: Perspective road framing a location pin; near lane dash survives, far dash omitted.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.add_line('road-left',(6,42),(16,6))
        self.add_line('road-right',(38,35),(42,42))
        self.path('pin',(20,17),[('A',(42,17),11,11,True),('L',(31,31)),('L',(20,17))],True)
        self.add_dot('pin-hole',(31,17))
        self.add_line('center-near',(24,35),(24,42))
