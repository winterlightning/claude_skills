...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        # Three open tines meet a broad spoon bowl; a rounded handle extends below.
        path('bowl',(10,4),[('L',(10,16)),('A',(24,30),14,14,False),('A',(38,16),14,14,False),('L',(38,4))])
        self.add_line('middle-tine',(24,4),(24,16))
        path('handle',(18,29),[('L',(18,38)),('A',(30,38),6,6,False),('L',(30,29))])
