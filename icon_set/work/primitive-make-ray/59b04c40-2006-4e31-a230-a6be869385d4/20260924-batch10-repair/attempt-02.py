...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('dollar-upper',(31,16),((28,14),(26,14),(24,14)),((14,14),(14,24),(24,24)))
        self.add_bezier('dollar-lower',(24,24),((34,24),(34,34),(24,34)),((22,34),(20,34),(17,32)))
        self.add_contour('dollar','dollar-upper','dollar-lower')
        self.add_line('stem-top',(24,6),(24,14));self.relate('connect','stem-top','dollar');self.relate('connect','stem-top','nw')
        self.add_line('stem-bottom',(24,34),(24,42));self.relate('connect','stem-bottom','dollar');self.relate('connect','stem-bottom','se')
