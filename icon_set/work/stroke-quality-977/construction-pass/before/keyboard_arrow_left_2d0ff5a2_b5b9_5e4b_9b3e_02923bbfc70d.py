...
SOURCE_PATH = 'pictographic-primitives/interface-essential/keyboard arrow left_2d0ff5a2-b5b9-5e4b-9b3e-02923bbfc70d.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class KeyboardArrowLeft(Solo48):
    icon_id = 'keyboard-arrow-left'
