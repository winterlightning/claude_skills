...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thin double right_fb433889-aede-54f7-a0b1-e3a15f2fb69f.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class ArrowThinDoubleRight(Solo48):
    icon_id = 'arrow-thin-double-right'
