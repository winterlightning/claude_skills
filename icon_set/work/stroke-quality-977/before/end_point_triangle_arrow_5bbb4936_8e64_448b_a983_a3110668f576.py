...
SOURCE_PATH = 'pictographic-primitives/arrows/end point triangle arrow_5bbb4936-8e64-448b-a983-a3110668f576.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class EndPointTriangleArrow(Solo48):
    icon_id = 'end-point-triangle-arrow'
