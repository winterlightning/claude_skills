...
SOURCE_ICON_ID = '7e131497-cb03-4911-8db1-e3bf9f6e07f5'
SOURCE_PATH = 'pictographic-primitives/interface-essential/loading_7e131497-cb03-4911-8db1-e3bf9f6e07f5.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class LoadingInterfaceEssential(Solo48):
    icon_id = 'loading-interface-essential'
