...
class SymbolArtillery(Solo48):
    ...
    def build(self):
        ...
        # Smooth elliptical bottom, mirrored around x=24; VRECT_L extrema unchanged.
        self.add_arc('e10-1', (9,36), (39,36), radius_x=15, radius_y=8, sweep=False)
        ...
        self.add_contour('c1', 'e9', 'e1', 'e10-1', 'e2', 'e11')
