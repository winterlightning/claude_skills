...
SOURCE_PATH = 'pictographic-primitives/social/flag plain_eebf37bf-e8e2-56e9-a2d9-06c1f2f7b55f.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class FlagPlainEebf37bf(Solo48):
    icon_id = 'flag-plain-eebf37bf'
