"""Arrows move (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '5ebb706f-5a30-4d8c-b8f1-4519aeaf46ea'
SOURCE_PATH = 'pictographic-primitives/symbol/arrows move_5ebb706f-5a30-4d8c-b8f1-4519aeaf46ea.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class ArrowsMove(Solo48):
    icon_id = 'arrows-move'
