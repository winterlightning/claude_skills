"""Direction button arrows (interface-essential), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '94d393c7-21fe-408e-8b1c-2e805481cd08'
SOURCE_PATH = 'pictographic-primitives/interface-essential/direction button arrows_94d393c7-21fe-408e-8b1c-2e805481cd08.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class DirectionButtonArrows(Solo48):
    icon_id = 'direction-button-arrows'
