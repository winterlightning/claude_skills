...
SOURCE_PATH = 'pictographic-primitives/interface-essential/move right 1_ed388f56-4309-5ffa-b1ce-4212112d03b6.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class MoveRight1InterfaceEssential(Solo48):
    icon_id = 'move-right-1-interface-essential'
