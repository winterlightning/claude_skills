...
SOURCE_PATH = 'pictographic-primitives/interface-essential/move left right_7ac8b923-cb80-4ed1-bae7-0b987ad44c16.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class MoveLeftRight(Solo48):
    icon_id = 'move-left-right'
