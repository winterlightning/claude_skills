"""Expand vertical 1 (interface-essential), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '6d212495-1586-47a1-8b42-60f7974ac965'
SOURCE_PATH = 'pictographic-primitives/interface-essential/expand vertical 1_6d212495-1586-47a1-8b42-60f7974ac965.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class ExpandVertical1(Solo48):
    icon_id = 'expand-vertical-1'
