"""Redistribute the necklace beads to a smoother circular rhythm and broaden the heart tip so the charm does not end in a long sharp wedge.
...
class BeadedLoopWithHeartCharm(Solo48):
    icon_id = 'beaded-loop-with-heart-charm-centerline-v2'
    ...
    def build(self) -> None:
        ...
        self.add_bezier('charm-ls', p_26_31, ((26, 36), (30, 40), p_34_42))
        self.add_bezier('charm-rs', p_34_42, ((38, 40), (42, 36), p_42_31))
