"""Remove the tiny folded thumb wedge and replace it with a clean outward thumb bend; shorten the finger creases to open the palm.
...
class GoalkeeperGlove(Solo48):
    icon_id = 'goalkeeper-glove-centerline-v2'
