"""Lower the exaggerated front sight and broaden the receiver top; the sight becomes a short purposeful notch rather than a tall unrelated spike.
...
class AutomaticRifle(Solo48):
    icon_id = 'automatic-rifle-centerline-v2'
    ...
    def build(self):
        ...
        P('body', (4, 19), (15, 19), (19, 8), (32, 8), (32, 21), (40, 21), (40, 29), (14, 29), (4, 35), closed=True)
