"""Replace the kink between the curled breech and barrel with a tangent curve that rises smoothly toward the muzzle.
...
class FieldCannonCurledBreech(Solo48):
    icon_id = 'field-cannon-curled-breech-centerline-v2'
    ...
    def build(self):
        ...
        self.add_bezier('upper-barrel', (13, 13), ((22, 13), (31, 8), (40, 8)))
        L('muzzle', (40, 8), (44, 18))
        ...
        J('trail', 'wheel')
        J('trail', 'barrel')
    variant_of = 'field-cannon-curled-breech'
