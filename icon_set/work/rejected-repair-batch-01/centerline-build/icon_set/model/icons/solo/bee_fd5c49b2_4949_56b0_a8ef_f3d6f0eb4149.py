...
class BeeWithSweptWings(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('left-wing-upper', (16, 18), (6, 34), radius_x=30, radius_y=30, sweep=True)
        self.add_arc('left-wing-lower', (6, 34), (16, 34), radius_x=7, radius_y=6, sweep=False)
        ...
        self.add_arc('left-antenna-curl', (16, 8), (10, 6), radius_x=6, radius_y=6, sweep=True)
        ...
        self.add_arc('right-wing-upper', (32, 18), (42, 34), radius_x=30, radius_y=30, sweep=False)
        self.add_arc('right-wing-lower', (42, 34), (32, 34), radius_x=7, radius_y=6, sweep=True)
        ...
        self.add_arc('right-antenna-curl', (32, 8), (38, 6), radius_x=6, radius_y=6, sweep=False)
