...
SOURCE_PATH = 'pictographic-primitives/programing/format catalog hive_a99356b9-4a4e-46d2-a937-aba6dd12d9e1.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class FormatCatalogHive(Solo48):
    icon_id = 'format-catalog-hive'
