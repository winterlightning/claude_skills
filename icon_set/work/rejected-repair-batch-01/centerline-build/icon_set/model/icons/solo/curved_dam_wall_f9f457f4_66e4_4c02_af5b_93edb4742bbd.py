"""Wave-bottom dam alternative: add three equal wave sections along the base. Independent feedback revision; parent preserved."""
...
class CurvedDamWall(Solo48):
    ...
    def build(self):
        ...
        join('wall', 'water')
        line('flow-left', (18, 25), (18, 34)); join('flow-left','water')
        line('flow-right', (30, 25), (30, 34)); join('flow-right','water')
