...
class AirplaneDepartingRunwayVariant4(Solo48):
    icon_id = 'airplane-departing-runway-v4'
    variant_of = 'airplane-departing-runway'
    variant_label = 'Side-view takeoff alternative: a larger tail, clear upper and lower wings, and one runway line.'
