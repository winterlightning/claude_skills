...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thick corner 1 top left_349b52ac-f996-5d80-a4a9-d35751fe8135.svg'
AUTHOR = 'gpt-6'

class ArrowThickCorner1TopLeft(Solo48):
    icon_id = 'arrow-thick-corner-1-top-left'
    ...
    def build(self):
        runs = [{'start': (40, 6), 'steps': [('L', 6, 6), ('L', 6, 40)], 'closed': False}, {'start': (18, 18), 'steps': [('L', 42, 42)], 'closed': False}]
        rotation = 0
