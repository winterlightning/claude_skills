"""user-pilot-tie-1: uniform collar and tie.
Distinct-avatar plan: preserve reference identity; use uniform collar and tie.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-pilot-tie-1.svg'
...
class UserPilotTie1Avatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'pilot', 'tie', '1', 'portrait', 'bust')
    def build(self):
        cx = 24
