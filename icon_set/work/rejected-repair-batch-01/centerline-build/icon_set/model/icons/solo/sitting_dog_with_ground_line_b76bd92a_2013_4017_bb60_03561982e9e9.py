"""Sitting Dog with Ground Line.

Plan: Seated dog with extended baseline; round haunch and upright ear preserve the side pose.
...
class SittingDogWithGroundLine(Solo48):
    ...
    def build(self):
        ...
        line('ground',(6,42),(24,42))
        self.relate('connect','body','ground')
