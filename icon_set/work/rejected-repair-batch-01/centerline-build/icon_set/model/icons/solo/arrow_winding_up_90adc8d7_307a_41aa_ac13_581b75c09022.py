...
class ArrowWindingUp(Solo48):
    icon_id = 'arrow-winding-up'
    ...
    def build(self) -> None:
        ...
        self.add_line('rise-left', (8, 44), (8, 34))
        ...
        self.add_line('rise-right', (30, 14), (30, 4))
        self.add_contour('route', 'rise-left', 'turn-left', 'middle', 'turn-right', 'rise-right')
        self.add_polyline('head', (20, 14), (30, 4), (40, 14))
