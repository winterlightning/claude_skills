"""instagram-logo-1: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '5f62be60-64f8-4b4b-b867-a302f8b567b1'
SOURCE_PATH = 'pictographic-primitives/logos/instagram logo 1_5f62be60-64f8-4b4b-b867-a302f8b567b1.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class InstagramLogo1(Solo48):
    icon_id = 'instagram-logo-1'
    ...
    def build(self):
        # Plan: SQUARE; four identical tangent corners and a concentric round lens.
