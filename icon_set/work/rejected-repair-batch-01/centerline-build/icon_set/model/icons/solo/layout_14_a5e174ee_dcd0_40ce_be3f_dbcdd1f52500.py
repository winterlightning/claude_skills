...
SOURCE_PATH = 'pictographic-primitives/interface-essential/layout 14_a5e174ee-dcd0-40ce-be3f-dbcdd1f52500.svg'
AUTHOR = 'gpt-6'
...
class Layout14(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e13', (6, 8), (6, 29))
        ...
        self.add_contour('sym-c1', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e12', 'sym-e13', 'sym-e15', closed=False)
        self.add_contour('sym-c2', 'sym-e16', 'sym-e17', 'sym-e18', closed=False)
        self.add_contour('sym-c3', 'sym-e19', closed=False)
