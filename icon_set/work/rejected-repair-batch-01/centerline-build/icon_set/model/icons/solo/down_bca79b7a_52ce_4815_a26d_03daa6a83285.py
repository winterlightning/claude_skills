...
SOURCE_PATH = 'pictographic-primitives/arrows/down_bca79b7a-52ce-4815-a26d-03daa6a83285.svg'
AUTHOR = 'gpt-6'

class DownBca79b7a(Solo48):
    icon_id = 'down-bca79b7a'
    ...
    def build(self):
        runs = [{'start': (4, 8), 'steps': [('L', 44, 8), ('L', 24, 40)], 'closed': True}]
        rotation = 0
