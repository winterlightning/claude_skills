"""user-doctor-hair-mullet: coat fastening with reference head silhouette.
...
Body cue: coat fastening. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-10/references/user-doctor-hair-mullet.svg'
SOURCE_HEAD_ICON_ID = 'user-doctor-hair-mullet'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 24
class UserDoctorHairMulletAvatar(Solo48):
    icon_id = 'user-doctor-hair-mullet-avatar'
