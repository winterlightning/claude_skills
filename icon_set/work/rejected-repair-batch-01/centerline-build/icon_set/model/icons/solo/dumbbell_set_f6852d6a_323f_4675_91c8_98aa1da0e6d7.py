"""Three horizontal dumbbells are stacked vertically, increasing in size toward the bottom. Each has paired rounded end weights connected by a straight bar with short projecting outer tips.

Three increasing widths; small weights reduced to solid strokes, with shared bilateral geometry.
...
SOURCE_ICON_ID = 'f6852d6a-323f-4675-91c8-98aa1da0e6d7'
SOURCE_PATH = 'pictographic-primitives/sports/dumbells sizes_f6852d6a-323f-4675-91c8-98aa1da0e6d7.svg'
AUTHOR = "gpt-6"

class DumbbellSet(Solo48):
    icon_id = 'dumbbell-set'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/sports"
    aliases = ()
    keywords = ('dumbbell', 'set', 'weight', 'fitness', 'strength', 'equipment')
    ...
    def build(self):
        branches=[]
        for i,(y,l,r) in enumerate([(9,16,32),(24,12,36),(39,8,40)]):
         branches.extend([(f'left-{i}',[(l,y-3),(l,y),(l,y+3)]),(f'right-{i}',[(r,y-3),(r,y),(r,y+3)]),(f'bar-{i}',[(l-2,y),(l,y),(r,y),(r+2,y)])])
