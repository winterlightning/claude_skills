"""Correct the bent wire to a true tangent quarter-ellipse; center the straight wire on the left bead instead of leaving it offset.
...
class BeadingWireWithBeads(Solo48):
    icon_id = 'beading-wire-with-beads-centerline-v2'
    ...
    def build(self) -> None:
        ...
        self.add_arc('wire-b', p_36_23, p_28_31, radius_x=8, radius_y=8, sweep=True, large_arc=False)
    ...
    variant_of = 'beading-wire-with-beads'
