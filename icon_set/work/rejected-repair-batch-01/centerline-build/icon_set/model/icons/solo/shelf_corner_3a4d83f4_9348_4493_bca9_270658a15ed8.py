"""Shelf corner (office), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '3a4d83f4-9348-4493-bca9-270658a15ed8'
SOURCE_PATH = 'pictographic-primitives/office/shelf corner_3a4d83f4-9348-4493-bca9-270658a15ed8.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class ShelfCorner(Solo48):
    icon_id = 'shelf-corner'
