...
SOURCE_PATH = 'pictographic-primitives/arrows/curve up large head_072e6fc6-3fac-441e-8cf4-0f3d62f34544.svg'
AUTHOR = 'gpt-6'

class CurveUpLargeHead(Solo48):
    icon_id = 'curve-up-large-head'
    ...
    def build(self):
        runs = [{'start': (6, 28), 'steps': [('L', 6, 34), ('A', 22, 34, 8, 8, False), ('L', 22, 20), ('A', 31, 11, 9, 9, True), ('L', 42, 11)], 'closed': False}, {'start': (37, 6), 'steps': [('L', 42, 11), ('L', 37, 16)], 'closed': False}]
        rotation = 0
