"""greek-woman-1: crossed flowing gown beneath the reference hair/headwear.
...
Clothing cue: crossed flowing gown. Hair asymmetry follows the reference, face remains centered.
"""
...
class GreekWoman1Avatar(Solo48):
    ...
    def build(self):
        ...
        for side, sign in [('left', -1), ('right', 1)]:
            ...
            self.add_line('tip-' + side, pt(16, 18), pt(16, 22))
