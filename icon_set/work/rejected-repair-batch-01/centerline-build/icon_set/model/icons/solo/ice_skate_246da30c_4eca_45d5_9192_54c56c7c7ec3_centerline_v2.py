"""Raise and round the skate’s toe so the boot no longer looks flattened, while keeping a clear gap to the blade.
...
class IceSkate(Solo48):
    icon_id = 'ice-skate-centerline-v2'
    ...
    def build(self) -> None:
        ...
        poly('upper', (6, 12), (20, 6), (20, 17), (32, 17))
        arc('toe', (32, 17), (32, 29), 10, 6)
        ...
        for x in (14, 30):
            self.relate('connect', f'support-{x}', 'blade')
    variant_of = 'ice-skate'
