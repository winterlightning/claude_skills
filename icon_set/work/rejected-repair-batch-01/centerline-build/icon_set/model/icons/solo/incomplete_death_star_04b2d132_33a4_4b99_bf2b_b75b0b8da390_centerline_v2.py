"""Regularize the exposed frame into an eight-unit cross and lengthen the equator, removing the short uneven end fragments.
...
class IncompleteDeathStar(Solo48):
    icon_id = 'incomplete-death-star-centerline-v2'
