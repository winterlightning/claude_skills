...
class Eggplant(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e4', (27, 14), ((24.845, 16.989), (22.1, 19.663), (18.318, 20.926)), ((15.882, 21.735), (14.382, 21.541), (12.009, 21.853)), ((8.6, 22.307), (5.791, 24), (4.582, 27.082)), ((4.255, 27.924), (4.0, 29.061), (4, 29.962)), ((4, 30.189), (4.009, 30.408), (4.009, 30.636)), ((4.009, 35.84), (9.155, 39.992), (14.627, 39.992)), ((14.726, 39.992), (14.828, 40), (14.927, 40)), ((15.255, 40), (15.591, 39.992), (15.918, 39.992)), ((20.682, 39.992), (26.427, 36.792), (30.055, 34.122)), ((31.427, 33.112), (32.964, 32.339), (34, 31)))
        ...
        self.add_contour('c2', 'e4', 'e1', closed=False)
        self.add_contour('c3', 'e5', closed=False)
        self.add_contour('c4', 'e2', 'e6', closed=False)
