"""Strengthen the demon’s slanted eyes with longer straight marks, keeping them mirrored and well separated from the cheek outline.
...
class HornedDemonFace(Solo48):
    icon_id = 'horned-demon-face-centerline-v2'
    ...
    def build(self) -> None:
        ...
        for side, sign in (('left', 1), ('right', -1)):
            self.add_line(f'eye-{side}', (24 + sign * (16 - 24), 23), (24 + sign * (20 - 24), 26))
    variant_of = 'horned-demon-face'
