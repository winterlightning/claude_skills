...
class ModernTvWide(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e2', (24, 8), (44, 8))
        self.add_line('sym-e5', (44, 8), (44, 33))
        self.add_arc('sym-e7', (44, 33), (43, 35), radius_x=3, radius_y=3, large_arc=False, sweep=True)
        self.add_line('sym-e8', (43, 35), (39, 35))
        self.add_line('sym-e9', (7, 40), (9, 35))
        self.add_line('sym-e10', (9, 35), (5, 35))
        self.add_arc('sym-e11', (5, 35), (4, 33), radius_x=3, radius_y=3, large_arc=False, sweep=True)
        self.add_line('sym-e13', (4, 33), (4, 8))
        self.add_line('sym-e16', (4, 8), (24, 8))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', closed=False)
        self.add_contour('sym-c1', 'sym-e2', 'sym-e5', 'sym-e7', 'sym-e8', closed=False)
        self.add_contour('sym-c2', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e13', 'sym-e16', closed=False)
