"""wide-hat-girl-1: round blouse neckline with reference head silhouette.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-13/references/wide-hat-girl-1.svg'
...
class WideHatGirl1Avatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('wide', 'hat', 'girl', '1', 'portrait', 'bust')
    def build(self):
