"""Hanging planter with leaves lowered to enlarge the triangular openings inside the hanger. VRECT_L preserves hanging proportions. Lucide sprout informed simple leaf construction; paired geometry stays mirrored."""
...
class TrailingHangingPlanter(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('rim-left', (10, 32), (17, 32))
        self.add_line('leaf-a', (17, 32), (17, 26))
        self.add_line('leaf-b', (17, 26), (24, 30))
        self.add_line('leaf-c', (24, 30), (31, 26))
        self.add_line('leaf-d', (31, 26), (31, 32))
        self.add_line('rim-right', (31, 32), (38, 32))
