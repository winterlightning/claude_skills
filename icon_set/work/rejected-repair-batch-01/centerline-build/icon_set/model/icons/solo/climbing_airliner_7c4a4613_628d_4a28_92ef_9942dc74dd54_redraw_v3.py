"""Give the climbing airliner a diagonal fuselage with equal swept wings and tailplanes. Use a rounded nose and consistent body width, preserving the upward flight direction."""
