"""Round the dragon’s intermediate cheek corners while keeping the pointed chin and antlers; the paired face contours now flow continuously toward the muzzle.
...
class ChineseDragonHead(Solo48):
    icon_id = 'chinese-dragon-head-centerline-v2'
    ...
    def build(self) -> None:
        ...
        self.add_bezier('cheek-right-2', p_39_21, ((39, 23), (38, 25), p_37_27))
        ...
        self.add_bezier('cheek-left-2', p_11_27, ((10, 25), (9, 23), p_9_21))
    ...
    variant_of = 'chinese-dragon-head'
