"""Smooth the horse’s rear mane into a continuous downward curve and align the inner mane’s lower tangent with the neck; preserve the side-facing head.
...
class HorseHead(Solo48):
    icon_id = 'horse-head-centerline-v2'
    ...
    def build(self):
        ...
        self.add_bezier('mane-back', (42, 20), ((42, 28), (38, 35), (34, 42)))
