"""user-secret: overcoat lapel with reference head silhouette.
...
Body cue: overcoat lapel. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-secret.svg'
SOURCE_HEAD_ICON_ID = 'user-secret'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class UserSecretAvatar(Solo48):
    icon_id = 'user-secret-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'secret', 'portrait', 'bust')
    def build(self):
