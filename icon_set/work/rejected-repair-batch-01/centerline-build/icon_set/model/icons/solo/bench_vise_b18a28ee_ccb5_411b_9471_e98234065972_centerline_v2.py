"""Widen the vise opening to twelve units and give both jaws identical geometry about their own stems; lengthen the screw shaft for a clearer working handle.
...
class BenchVise(Solo48):
    icon_id = 'bench-vise-centerline-v2'
    ...
    def build(self) -> None:
        ...
        for n, left in [('left', True), ('right', False)]:
            x = 16 if left else 28
            outer = 4 if left else 40
