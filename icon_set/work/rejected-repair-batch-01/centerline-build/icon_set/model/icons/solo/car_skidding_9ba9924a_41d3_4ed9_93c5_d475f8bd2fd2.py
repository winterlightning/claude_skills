...
class CarSkidding(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline('cabin', (14, 14), (18, 4), (30, 4), (34, 14))
        self.relate('connect', 'body', 'cabin')
        self.add_arc('left-track-a', (16, 32), (16, 38), radius_x=4, radius_y=3, sweep=False)
        self.add_arc('left-track-b', (16, 38), (16, 44), radius_x=4, radius_y=3, sweep=True)
        ...
        self.add_arc('right-track-b', (32, 38), (32, 44), radius_x=4, radius_y=3, sweep=True)
