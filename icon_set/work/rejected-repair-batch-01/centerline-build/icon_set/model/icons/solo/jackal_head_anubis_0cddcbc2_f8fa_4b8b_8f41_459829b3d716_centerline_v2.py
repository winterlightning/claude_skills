"""Round the lower muzzle into a true semicircle and raise the inner ear roots for a more elongated jackal face.
...
class JackalHeadAnubis(Solo48):
    icon_id = 'jackal-head-anubis-centerline-v2'
    ...
    def build(self) -> None:
        ...
        self.add_arc('chin', p_28_38, p_20_38, radius_x=4, radius_y=4, sweep=True, large_arc=False)
