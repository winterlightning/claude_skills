"""user-tie-hair-mullet: flared hair and tie.
Distinct-avatar plan: preserve reference identity; use flared hair and tie.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-tie-hair-mullet.svg'
...
class UserTieHairMulletAvatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'tie', 'hair', 'mullet', 'portrait', 'bust')
    def build(self):
        cx = 24
        radius, cy = (10, 14)
