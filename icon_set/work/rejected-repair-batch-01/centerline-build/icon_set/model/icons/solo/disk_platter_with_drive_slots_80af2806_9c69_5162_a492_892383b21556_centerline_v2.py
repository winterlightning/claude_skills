"""Enlarge the spindle opening and balance the three drive slots around the hub, keeping clear space to both circular edges.
...
class DiskPlatterWithDriveSlots(Solo48):
    icon_id = 'disk-platter-with-drive-slots-centerline-v2'
    ...
    def build(self) -> None:
        ...
        for side in (-1, 1):
            self.add_line('slot-left' if side < 0 else 'slot-right', (24 + side * 10, 30), (24 + side * 9, 31))
