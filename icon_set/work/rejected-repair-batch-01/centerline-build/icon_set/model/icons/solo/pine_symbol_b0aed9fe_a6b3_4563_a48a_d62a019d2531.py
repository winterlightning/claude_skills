"""pine-symbol: Smooth two-tier pine; earlier revisions preserved."""
...
class PineSymbol(Solo48):
    ...
    category = 'symbol'
    aliases = ()
    keywords = ('solo-ai-full-set', 'pine-symbol')

    def build(self):
        # Plan: Preserve two tiers; gently curved lower branches open the narrow shoulder transition.
