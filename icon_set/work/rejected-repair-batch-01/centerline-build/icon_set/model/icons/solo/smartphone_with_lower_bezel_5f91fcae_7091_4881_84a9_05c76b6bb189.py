"""Upright smartphone with lower bezel; small tangent corners retain its nearly square silhouette."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '5f91fcae-7091-4881-84a9-05c76b6bb189'
SOURCE_PATH = 'pictographic-primitives/phones/mobile phone_5f91fcae-7091-4881-84a9-05c76b6bb189.svg'
AUTHOR = 'gpt-6'

class SmartphoneWithLowerBezel5F91Fcae(Solo48):
    icon_id = 'smartphone-with-lower-bezel-5f91fcae'
