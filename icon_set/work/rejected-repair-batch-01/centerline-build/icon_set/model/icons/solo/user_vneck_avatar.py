"""user-vneck: parted hair and deep V neck.
Distinct-avatar plan: preserve reference identity; use parted hair and deep V neck.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-13/references/user-vneck.svg'
SOURCE_HEAD_ICON_ID = 'user-vneck'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserVneckAvatar(Solo48):
    icon_id = 'user-vneck-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'vneck', 'portrait', 'bust')
    def build(self):
