...
class JumpingDolphin(Solo48):
    ...
    def build(self):
        self.add_line('silhouette-1', (6, 24), (6, 17))
        self.add_arc('silhouette-2', (6, 17), (22, 7), radius_x=19, radius_y=19, sweep=True)
        self.add_line('silhouette-3', (22, 7), (30, 6))
        self.add_line('silhouette-4', (30, 6), (28, 12))
        self.add_arc('silhouette-5', (28, 12), (40, 32), radius_x=24, radius_y=24, sweep=True)
        self.add_bezier('silhouette-6', (40, 32), *(((41.56115701, 34.47992064), (42, 38.25772952), (42, 42)),))
        self.add_line('silhouette-7', (42, 42), (36, 39))
        self.add_line('silhouette-8', (36, 39), (27, 42))
        self.add_arc('silhouette-9', (27, 42), (31, 33), radius_x=12, radius_y=12, sweep=True)
        ...
        self.add_line('silhouette-13', (12, 27), (6, 30))
        self.add_line('silhouette-14', (6, 30), (6, 24))
