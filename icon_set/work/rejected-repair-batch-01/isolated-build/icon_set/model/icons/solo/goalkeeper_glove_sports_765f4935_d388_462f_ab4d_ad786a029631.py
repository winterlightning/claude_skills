...
class GoalkeeperGloveSports(Solo48):
    ...
    def build(self):
        for i,x in enumerate([10,18,26,34]):self.add_arc(f'finger-{i}',(x,10),(x+8,10),radius_x=4)
        self.skeleton([('left',[(10,10),(10,22),(6,22),(6,28),(14,34),(14,42),(34,42),(34,34),(42,26),(42,10)]),('cuff',[(14,34),(34,34)]),('index-seam',[(18,10),(18,20)]),('middle-seam',[(26,10),(26,20)]),('ring-seam',[(34,10),(34,20)])])
