"""Warp bulge (design), converted from the icons-json construction graph by json_to_solo --mode fit. CIRCLE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '5b98a2b1-ae7c-5444-a2ba-7bd6baaf76f5'
SOURCE_PATH = 'pictographic-primitives/design/warp bulge_5b98a2b1-ae7c-5444-a2ba-7bd6baaf76f5.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class WarpBulge(Solo48):
    icon_id = 'warp-bulge'
