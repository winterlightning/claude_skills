"""House with Chimney. Retains the identifying silhouette and visible features.
...
SOURCE_ICON_ID = '8595c55a-ed9b-429c-8d29-839ea8fef1b8'
SOURCE_PATH = 'pictographic-primitives/symbol/empty house_8595c55a-ed9b-429c-8d29-839ea8fef1b8.svg'
AUTHOR = 'gpt-6'


class HouseWithChimney(Solo48):
    icon_id = 'house-with-chimney'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "symbols/standalone"
    aliases = ()
    keywords = ('house', 'home', 'chimney', 'building', 'residence', 'property', 'real-estate', 'dwelling')
    ...
    def build(self) -> None:
        ...
        self.add_line('chimney', (34, 6), (34, 16))
