...
class CamperVanVariant2(Solo48):
    icon_id = 'camper-van-v2'
    variant_of = 'camper-van'
    variant_label = 'Round the roof, windscreen slope and lower body corners consistently.'
