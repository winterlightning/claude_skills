"""user-hair-long: round blouse neckline with reference head silhouette.
...
Body cue: round blouse neckline. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-11/references/user-hair-long.svg'
...
class UserHairLongAvatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'hair', 'long', 'portrait', 'bust')
    def build(self):
        cx = 24
