"""Cryto decentralized blockchain (arrows), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '7d2f76d6-a02b-4d6a-8493-e4b9695b0578'
SOURCE_PATH = 'pictographic-primitives/arrows/cryto decentralized blockchain_7d2f76d6-a02b-4d6a-8493-e4b9695b0578.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class CrytoDecentralizedBlockchain(Solo48):
    icon_id = 'cryto-decentralized-blockchain'
