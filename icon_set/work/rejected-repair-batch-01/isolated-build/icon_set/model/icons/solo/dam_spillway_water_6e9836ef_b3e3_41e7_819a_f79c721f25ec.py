"""Reduce the spillway to two falling streams above a single smooth water stroke. Independent feedback revision; parent preserved."""
...
class DamSpillwayWater(Solo48):
    ...
    def build(self):
        ...
        for i, x in enumerate((10, 32)):
            path(f'stream-{i}', (x, 8), [('L', (x, 21)), ('A', (x + 6, 27), 6, 6, False)])
        path('water', (4, 38), [('C', (24, 38), (10, 40.6666666667), (18, 40.6666666667)), ('C', (44, 38), (30, 36), (38, 36))])
