"""Vibrating phone with long paired zigzags and lower bezel; no home mark in this source."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'e84b2588-9e9b-4ddd-aaa5-81cac82e3e46'
SOURCE_PATH = 'pictographic-primitives/phones/phone vibrate_e84b2588-9e9b-4ddd-aaa5-81cac82e3e46.svg'
AUTHOR = 'gpt-6'

class VibratingSmartphoneWithLowerBezel(Solo48):
    icon_id = 'vibrating-smartphone-with-lower-bezel'
    ...
    def build(self):
        ...
        box(16,8,32,40,rad=3,ys=(30,))
        seam('bezel',(16,30),(32,30))
        self.add_polyline('vibration-left',(4,10),(7,16),(4,22),(7,28),(4,34))
        self.add_polyline('vibration-right',(44,10),(41,16),(44,22),(41,28),(44,34))
