"""plane-1-travel: Side-view plane — local spacing refinement; earlier revisions preserved."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'd64bbae0-775c-45ae-a797-8152cc224a80'
SOURCE_PATH = 'pictographic-primitives/travel/plane 1_d64bbae0-775c-45ae-a797-8152cc224a80.svg'
AUTHOR = 'gpt-6'

class Plane1Travel(Solo48):
    icon_id = 'plane-1-travel'
    ...
    def build(self):
        # Plan: Kept the complete original outline and symmetry. Widened the two wing returns locally.
