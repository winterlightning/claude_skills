"""oldman: plain pullover beneath full beard.
Distinct-avatar plan: preserve reference identity; use plain pullover beneath full beard.
...
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class OldmanAvatar(Solo48):
    icon_id = 'oldman-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('oldman', 'portrait', 'bust')
    def build(self):
