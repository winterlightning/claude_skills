"""Widen and straighten the ATV upper body while keeping both wheels and handlebar. Independent feedback revision; parent preserved."""
...
class AtvSideViewVariant2(Solo48):
    icon_id = 'atv-side-view-v2'
    variant_of = 'atv-side-view'
    variant_label = 'Widen and straighten the ATV upper body while keeping both wheels and handlebar.'
