"""man-clerk: parted hair and waistcoat fronts.
Distinct-avatar plan: preserve reference identity; use parted hair and waistcoat fronts.
...
SOURCE_ICON_ID = 'b58c66b2-b601-5bd6-ab46-21b45f1ea6ac'
SOURCE_PATH = 'pictographic-primitives/avatars/man clerk_b58c66b2-b601-5bd6-ab46-21b45f1ea6ac.svg'
SOURCE_HEAD_ICON_ID = 'man-clerk'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class ManClerkAvatar(Solo48):
    icon_id = 'man-clerk-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('man', 'clerk', 'portrait', 'bust')
    def build(self):
