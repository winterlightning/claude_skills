...
class AircraftReleasingBombVariant2(Solo48):
    icon_id = 'aircraft-releasing-bomb-v2'
    variant_of = 'aircraft-releasing-bomb'
    variant_label = 'Give the aircraft a closed top-side silhouette with a rounded nose, swept wing and separate falling bomb.'
