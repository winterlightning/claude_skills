...
SOURCE_PATH = 'pictographic-primitives/arrows/diagram arrow dash corner point bottom_616df8be-e4ab-5a77-b44c-bbf0e82e3e54.svg'
AUTHOR = 'gpt-6'

class DiagramArrowDashCornerPointBottom(Solo48):
    icon_id = 'diagram-arrow-dash-corner-point-bottom'
    ...
    def build(self):
        runs = [{'start': (6, 27), 'steps': [('L', 21, 42)], 'closed': False}, {'start': (36, 27), 'steps': [('L', 21, 42), ('L', 21, 6), ('L', 42, 6)], 'closed': False}]
        rotation = 0
