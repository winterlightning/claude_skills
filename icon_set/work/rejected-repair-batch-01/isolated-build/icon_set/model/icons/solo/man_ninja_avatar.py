"""man-ninja: tunic front panels.
Distinct-avatar plan: preserve reference identity; use tunic front panels.
...
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class ManNinjaAvatar(Solo48):
    icon_id = 'man-ninja-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('man', 'ninja', 'portrait', 'bust')
    def build(self):
