...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thick corner 1 bottom right_f66c9d61-89e3-59c1-8498-568adf181fd1.svg'
AUTHOR = 'gpt-6'

class ArrowThickCorner1BottomRight(Solo48):
    icon_id = 'arrow-thick-corner-1-bottom-right'
    ...
    def build(self):
        runs = [{'start': (8, 42), 'steps': [('L', 42, 42), ('L', 42, 8)], 'closed': False}, {'start': (30, 30), 'steps': [('L', 6, 6)], 'closed': False}]
        rotation = 0
