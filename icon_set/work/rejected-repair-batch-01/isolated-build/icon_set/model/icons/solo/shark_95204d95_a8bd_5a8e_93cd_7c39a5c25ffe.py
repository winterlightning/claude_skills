"""shark: HRECT_L ink (6,6)-(42,42). Left-swimming profile, dorsal, pectoral and fork tail; minor lower fin omitted."""
...
class Shark(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('body-1', (4, 25), (19, 17), radius_x=30, radius_y=24, sweep=True)
        ...
        self.add_arc('body-5', (38, 22), (44, 14), radius_x=20, radius_y=20, sweep=True)
        self.add_arc('body-6', (44, 14), (44, 36), radius_x=32, radius_y=32, sweep=False)
        self.add_arc('body-7', (44, 36), (38, 29), radius_x=20, radius_y=20, sweep=True)
        ...
        self.add_arc('body-11', (19, 32), (4, 25), radius_x=30, radius_y=24, sweep=True)
