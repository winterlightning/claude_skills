"""user-police-tie: rounded uniform neckline.
Distinct-avatar plan: preserve reference identity; use rounded uniform neckline.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-police-tie.svg'
SOURCE_HEAD_ICON_ID = 'user-police-tie'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 30
class UserPoliceTieAvatar(Solo48):
    icon_id = 'user-police-tie-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'police', 'tie', 'portrait', 'bust')
    def build(self):
        cx = 24
