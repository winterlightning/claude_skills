"""user-beard-2: shirt fastening with reference head silhouette.
...
Body cue: shirt fastening. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-09/references/user-beard-2.svg'
SOURCE_HEAD_ICON_ID = 'user-beard-2'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserBeard2Avatar(Solo48):
    icon_id = 'user-beard-2-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'beard', '2', 'portrait', 'bust')
    def build(self):
