...
class GirlPigtails(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('body-left', (8, 44), (14, 37))
        self.add_arc('body-top', (14, 37), (34, 37), radius_x=10, radius_y=7)
        self.add_line('body-right', (34, 37), (40, 44))
