...
SOURCE_PATH = 'pictographic-primitives/arrows/increase_221b5783-800f-49b5-82d0-cf19fce26cfc.svg'
AUTHOR = 'gpt-6'

class Increase(Solo48):
    icon_id = 'increase'
    ...
    def build(self):
        runs = [{'start': (4, 40), 'steps': [('L', 22, 40), ('A', 38, 24, 16, 16, False), ('L', 38, 8)], 'closed': False}, {'start': (32, 14), 'steps': [('L', 38, 8), ('L', 44, 14)], 'closed': False}]
        rotation = 0
