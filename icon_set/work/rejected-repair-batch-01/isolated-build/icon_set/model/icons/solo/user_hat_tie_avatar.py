"""user-hat-tie: western shirt fastening with reference head silhouette.
...
Body cue: western shirt fastening. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-11/references/user-hat-tie.svg'
SOURCE_HEAD_ICON_ID = 'user-hat-tie'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class UserHatTieAvatar(Solo48):
    icon_id = 'user-hat-tie-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'hat', 'tie', 'portrait', 'bust')
    def build(self):
