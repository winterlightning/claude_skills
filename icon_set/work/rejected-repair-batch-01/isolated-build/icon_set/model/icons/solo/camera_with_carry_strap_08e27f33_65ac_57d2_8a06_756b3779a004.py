"""Camera suspended from a triangular carrying strap. Tall envelope makes space for the physical strap; Lucide camera corners. Secondary lens ring, flash dot and hump removed to preserve open space."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '08e27f33-65ac-57d2-8a06-756b3779a004'
SOURCE_PATH = 'pictographic-primitives/photography/camera carry_08e27f33-65ac-57d2-8a06-756b3779a004.svg'
AUTHOR = 'gpt-6'
...
class CameraWithCarryStrap(Solo48):
    ...
    def build(self):
        ...
        body('camera',8,20,40,44,[(12,20),(36,20)])
        poly('strap',(12,20),(24,4),(36,20));connect('strap','camera')
        circle('lens',24,32,3)
