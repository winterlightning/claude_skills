...
SOURCE_PATH = 'pictographic-primitives/protection/shield_8e1100ca-39fe-4e71-b978-93997ec5e7d8.svg'
AUTHOR = 'gpt-6'

class Shield8e1100ca(Solo48):
    icon_id = 'shield-8e1100ca'
    ...
    def build(self):
        ...
        self.add_contour('c0', 'e0', 'e1', 'e3', 'e4', 'e5', closed=True)
