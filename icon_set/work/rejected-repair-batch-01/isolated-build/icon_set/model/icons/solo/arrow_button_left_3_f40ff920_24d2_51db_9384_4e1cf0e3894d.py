...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow button left 3_f40ff920-24d2-51db-9384-4e1cf0e3894d.svg'
AUTHOR = 'gpt-6'

class ArrowButtonLeft3(Solo48):
    icon_id = 'arrow-button-left-3'
