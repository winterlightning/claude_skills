...
A downward arrow. Exclude the monitor frame.
...
$icon-making
Process this pending component brief with the copied reference. Generate or reuse only Download arrow as a standalone sub icon. Do not recreate the combined reference.
