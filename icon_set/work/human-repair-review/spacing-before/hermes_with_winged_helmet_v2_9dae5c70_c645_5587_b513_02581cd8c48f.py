...
class HermesWithWingedHelmetVariant2(Solo48):
    icon_id = 'hermes-with-winged-helmet-v2'
    variant_of = 'hermes-with-winged-helmet'
    ...
    def build(self):
        ...
        self.add_line('wing-left-1', (14, 19), (7, 17))
        self.add_line('wing-left-2', (7, 17), (4, 9))
        self.add_line('wing-left-3', (4, 9), (14, 10))
        self.add_line('wing-right-1', (34, 19), (41, 17))
        self.add_line('wing-right-2', (41, 17), (44, 9))
