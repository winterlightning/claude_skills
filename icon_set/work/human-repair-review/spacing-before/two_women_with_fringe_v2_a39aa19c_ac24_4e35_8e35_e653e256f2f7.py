...
class TwoWomenWithFringeVariant2(Solo48):
    icon_id = 'two-women-with-fringe-v2'
    variant_of = 'two-women-with-fringe'
    ...
    def build(self):
        self.add_arc('front-head-a', (16, 6), (16, 26), radius_x=10, radius_y=10, large_arc=False, sweep=True)
        self.add_arc('front-head-b', (16, 26), (16, 6), radius_x=10, radius_y=10, large_arc=False, sweep=True)
        self.add_line('hair-left', (6, 16), (6, 28))
        self.add_line('hair-right', (26, 16), (26, 28))
        self.add_arc('fringe', (6, 16), (26, 16), radius_x=26, radius_y=26, large_arc=False, sweep=True)
