...
class SleddingPersonVariant2(Solo48):
    icon_id = 'sledding-person-v2'
    variant_of = 'sledding-person'
    ...
    def build(self):
        ...
        self.add_line('body-1', (12, 6), (15, 16))
        self.add_bezier('body-2', (15, 16), *(((17.5, 17.75), (22.0, 24.25), (25, 23)),))
        self.add_line('arm', (19, 10), (25, 23))
