...
class PersonRecliningWithFloatingPanelsVariant2(Solo48):
    icon_id = 'person-reclining-with-floating-panels-v2'
    variant_of = 'person-reclining-with-floating-panels'
    ...
    def build(self):
        ...
        self.add_line('chair-1', (42, 24), (38, 42))
        self.add_line('chair-2', (38, 42), (24, 42))
