...
class TwoWomanBustsVariant2(Solo48):
    icon_id = 'two-woman-busts-v2'
    variant_of = 'two-woman-busts'
    ...
    def build(self):
        ...
        self.add_line('fringe-1', (6, 16), (16, 13))
        self.add_line('fringe-2', (16, 13), (26, 16))
