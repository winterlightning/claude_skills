...
Six radiating spokes each carry a short pair of diagonal branches. Exclude the square border.
...
$icon-making
Process this pending component brief with the copied reference. Generate or reuse only Six-Spoke Snowflake as a standalone sub icon. Do not recreate the combined reference.
