# Variant of star-labelled-bottle-v2; parent file remains unchanged.
...
class StarLabelledBottleVariant5(Solo48):
    icon_id = 'star-labelled-bottle-v5'
    variant_of = 'star-labelled-bottle-v2'
