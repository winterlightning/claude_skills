# Variant of hanging-flower-pair; parent file remains unchanged.
...
class HangingFlowerPairVariant2(Solo48):
    icon_id = 'hanging-flower-pair-v2'
    variant_of = 'hanging-flower-pair'
    ...
    def build(self) -> None:
        ...
        self.add_line('tail-b', (19, 31), (19, 42))
        ...
        self.add_arc('flower-b', (35, 24), (42, 32), radius_x=8, radius_y=8, sweep=True)
