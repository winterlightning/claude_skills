# Variant of rainbow-between-clouds; parent file remains unchanged.
...
class RainbowBetweenCloudsVariant2(Solo48):
    icon_id = 'rainbow-between-clouds-v2'
    variant_of = 'rainbow-between-clouds'
    ...
    def build(self) -> None:
        self.add_arc('rainbow-outer', (6, 34), (42, 34), radius_x=20, radius_y=26, sweep=True, large_arc=False)
        self.add_arc('rainbow-inner', (16, 34), (32, 34), radius_x=8, radius_y=16, sweep=True, large_arc=False)
