# Variant of compact-disc-with-partition-segment-v2; parent file remains unchanged.
...
class CompactDiscWithPartitionSegmentVariant3(Solo48):
    icon_id = 'compact-disc-with-partition-segment-v3'
    variant_of = 'compact-disc-with-partition-segment-v2'
