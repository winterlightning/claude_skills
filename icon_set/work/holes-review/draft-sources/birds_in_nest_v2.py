# Variant of birds-in-nest; parent file remains unchanged.
...
class BirdsInNestVariant2(Solo48):
    icon_id = 'birds-in-nest-v2'
    variant_of = 'birds-in-nest'
    ...
    def build(self) -> None:
        self.add_arc('bowl', (42, 27), (6, 27), radius_x=22, radius_y=13, sweep=True)
