# Variant of shock-absorber; parent file remains unchanged.
...
class ShockAbsorberVariant2(Solo48):
    icon_id = 'shock-absorber-v2'
    variant_of = 'shock-absorber'
    ...
    def build(self) -> None:
        ...
        self.add_arc('eye-right', (24, 36), (24, 42), radius_x=4)
        self.add_arc('eye-left', (24, 42), (24, 36), radius_x=4)
