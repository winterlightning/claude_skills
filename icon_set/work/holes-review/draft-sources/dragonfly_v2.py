# Variant of dragonfly; parent file remains unchanged.
...
class DragonflyVariant2(Solo48):
    icon_id = 'dragonfly-v2'
    variant_of = 'dragonfly'
    ...
    def build(self):
        self.add_arc('head-1', (24, 6), (24, 12), radius_x=5, radius_y=5, sweep=True)
        self.add_arc('head-2', (24, 12), (24, 6), radius_x=5, radius_y=5, sweep=True)
