# Variant of stepped-office-block-with-flag; parent file remains unchanged.
...
class SteppedOfficeBlockWithFlagVariant2(Solo48):
    icon_id = 'stepped-office-block-with-flag-v2'
    variant_of = 'stepped-office-block-with-flag'
