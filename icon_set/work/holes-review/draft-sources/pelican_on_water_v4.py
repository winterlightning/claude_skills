# Variant of pelican-on-water-v2; parent file remains unchanged.
...
class PelicanOnWaterVariant4(Solo48):
    icon_id = 'pelican-on-water-v4'
    variant_of = 'pelican-on-water-v2'
