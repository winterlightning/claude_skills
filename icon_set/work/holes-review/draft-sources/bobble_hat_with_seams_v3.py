# Variant of bobble-hat-with-seams-v2; parent file remains unchanged.
...
class BobbleHatWithSeamsVariant3(Solo48):
    icon_id = 'bobble-hat-with-seams-v3'
    variant_of = 'bobble-hat-with-seams-v2'
