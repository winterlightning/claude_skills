# Variant of soldier-behind-sandbags; parent file remains unchanged.
...
class SoldierBehindSandbagsVariant2(Solo48):
    icon_id = 'soldier-behind-sandbags-v2'
    variant_of = 'soldier-behind-sandbags'
    ...
    def build(self):
        ...
        A('helmet', (30, 15), (42, 15), 7)
        L('brim', (30, 15), (42, 15))
        J('helmet', 'brim')
        A('face', (30, 15), (42, 15), 7, s=False)
        J('face', 'brim')
        J('face', 'helmet')
        L('rifle', (6, 15), (30, 15))
        J('rifle', 'helmet')
