# Variant of snow-capped-mountain-with-sun; parent file remains unchanged.
...
class SnowCappedMountainWithSunVariant2(Solo48):
    icon_id = 'snow-capped-mountain-with-sun-v2'
    variant_of = 'snow-capped-mountain-with-sun'
