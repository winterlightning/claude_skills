...
recipe('arched-tap-spraying-water','VRECT_L','An arched faucet with a lever, downward outlet and two spaced falling drops. The spout and stem are one smooth thick outline.', '''
...
recipe('arrow-angle-right','SQUARE','A 45-degree chevron with equal arms; kept as SOLO48 by user request.',"poly('chevron',(6,6),(42,24),(6,42))",'Lucide chevron-right: a single coherent two-arm stroke')
...
''')
recipe('arrow-left-right','HRECT_L','One centered shaft and matched 45-degree heads; square envelope avoids shallow stretched arrowheads.', '''
...
poly('band',(8,16),(14,16),(34,16),(40,16));join('cloth','band')
self.add_arc('face',(34,16),(14,16),radius_x=10);join('face','band');bottom=26
...
path('helmet',(14,14),[('A',(34,14),10,10,True),('L',(40,14)),('L',(34,18))])
