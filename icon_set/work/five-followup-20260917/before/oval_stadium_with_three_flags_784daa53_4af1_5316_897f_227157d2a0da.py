'oval-stadium-with-three-flags: Wide open arena with a low curved stadium wall and three complete repeated pennants, anchored on the rear rim. Original redrawn in place after the nine-icon meaning review.'
...
class OvalStadiumWithThreeFlags(Solo48):
    ...
    def build(self):
        # Symbol plan: Wide open arena with a low curved stadium wall and three complete repeated pennants, anchored on the rear rim.
        ...
        for i,(x,y) in enumerate([(4, 29), (20, 22), (36, 24)]):
