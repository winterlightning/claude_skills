'peacock-with-spread-tail: Circular spread fan with radial feather divisions behind a tapered bird body, curved head profile and two feet. Original redrawn in place after the nine-icon meaning review.'
...
class PeacockWithSpreadTail(Solo48):
    ...
    def build(self):
        # Symbol plan: Circular spread fan with radial feather divisions behind a tapered bird body, curved head profile and two feet.
        ...
        path('fan',(6,36),[('C',(2,26),(4,36),(2,32)),('C',(8,12),(2,20),(4,15)),('C',(24,4),(12,7),(18,4)),('C',(40,12),(30,4),(36,7)),('C',(46,26),(44,15),(46,20)),('C',(42,36),(46,32),(44,36))])
