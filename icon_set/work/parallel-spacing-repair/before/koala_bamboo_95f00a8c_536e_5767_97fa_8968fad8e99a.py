...
class KoalaWithBranch(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('head-right', (23, 6), (23, 25), radius_x=11, radius_y=11, sweep=True, large_arc=False)
        self.add_arc('head-left-bottom', (23, 25), (12, 14), radius_x=11, radius_y=11, sweep=True, large_arc=False)
        self.add_arc('head-left-top', (12, 14), (23, 6), radius_x=11, radius_y=11, sweep=True, large_arc=False)
        self.add_contour('head', 'head-right', 'head-left-bottom', 'head-left-top', closed=True)
        self.add_arc('ear-a', (23, 6), (15, 6), radius_x=8, radius_y=1, sweep=False, large_arc=False)
        self.add_arc('ear-b', (15, 6), (6, 10), radius_x=10, radius_y=8, sweep=False, large_arc=False)
        self.add_arc('ear-c', (6, 10), (12, 14), radius_x=7, radius_y=4, sweep=False, large_arc=False)
        ...
        self.add_arc('back', (12, 14), (6, 35), radius_x=30, radius_y=30, sweep=False, large_arc=False)
        self.add_arc('haunch', (6, 35), (16, 42), radius_x=14, radius_y=11, sweep=False, large_arc=False)
        self.add_line('base', (16, 42), (31, 42))
        self.add_arc('foot', (31, 42), (31, 38), radius_x=4, radius_y=4, sweep=False, large_arc=False)
        ...
        self.add_line('branch-top', (40, 16), (42, 9))
        self.add_line('branch-grip', (40, 16), (37, 23))
        self.add_line('fork', (40, 16), (42, 16))
