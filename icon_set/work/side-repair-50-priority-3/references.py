...
names=['shield','truck','skull','moon','thumbs-up','cctv','flower-2','sprout','users-round','thermometer','triangle-alert','hand','video','wind','laptop','wallet','luggage','drafting-compass','rotate-cw','shirt','trash','lock-open','cpu','split','scan-face','paperclip','file','graduation-cap','paw-print']
