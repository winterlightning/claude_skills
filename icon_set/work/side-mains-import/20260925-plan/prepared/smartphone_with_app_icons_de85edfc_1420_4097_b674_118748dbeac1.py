...
class Drawing(Solo48):
    ...
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    exception = {'approved_by': 'user', 'svg_sha256': '16139b3cff35ebf3c2118c2639148fc4f59acd80b6d703626af5efe52cd333d2', 'reason': 'put not pass as eception, im ok with it — All existing blocking validation findings for this exact standalone batch drawing, including review warnings.'}
