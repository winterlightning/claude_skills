...
class Drawing(Solo48):
    ...
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    exception = {'approved_by': 'user', 'svg_sha256': '8cec1fdaf0b98142922cf3203ebb0f012e3730aea19928dd5f37988ab83d89ec', 'reason': 'put not pass as eception, im ok with it — All existing blocking validation findings for this exact standalone batch drawing, including review warnings.'}
