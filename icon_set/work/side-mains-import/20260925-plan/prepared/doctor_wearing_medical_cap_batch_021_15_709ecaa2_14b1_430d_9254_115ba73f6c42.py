...
class Drawing(Solo48):
    ...
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    exception = {'approved_by': 'user', 'svg_sha256': 'e22ac547ae3df65e40ba9d0d6e2a48f03098024f6ca395239ac23f7ec2894080', 'reason': 'put exception on fail gate — All existing blocking validation findings for this exact standalone batch drawing, including review warnings.'}
