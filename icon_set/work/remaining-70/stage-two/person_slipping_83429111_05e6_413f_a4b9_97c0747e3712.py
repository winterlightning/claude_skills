...
class PersonSlipping(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('person-torso-1', (26, 22), *(((26.0, 25.36), (21.5, 26.5), (20, 29)),))
        self.add_line('person-arms-1', (12, 14), (18, 23))
        self.add_line('person-arms-2', (18, 23), (26, 22))
        self.add_line('person-arms-3', (26, 22), (42, 22))
        self.add_line('person-legs-1', (6, 24), (20, 29))
        self.add_line('person-legs-2', (20, 29), (14, 36))
        self.add_line('person-legs-3', (14, 36), (6, 34))
