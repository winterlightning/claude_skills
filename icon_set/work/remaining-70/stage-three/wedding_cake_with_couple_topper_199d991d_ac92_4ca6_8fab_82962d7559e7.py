# Refinement: Make the cake taller to fit shallow icing with eight units to both outer edges.
# Refinement: Use shallow icing scallops so the cake counter stays open.
...
class WeddingCakeWithCoupleTopper(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline('groom-body', (12, 22), (12, 16), (16, 16), (20, 16), (20, 22))
        self.add_polyline('bride-body', (28, 22), (30, 16), (34, 16), (38, 16), (40, 22))
        self.add_polyline('cake', (4, 31), (4, 22), (12, 22), (20, 22), (28, 22), (40, 22), (44, 22), (44, 31), (44, 40), (4, 40), closed=True)
        ...
        for i, x in enumerate((4, 14, 24, 34)):
            self.add_arc(f'icing-{i}', (x, 31), (x + 10, 31), radius_x=5, radius_y=1, sweep=False)
