...
class Handshake(Solo48):
    ...
    def build(self) -> None:
        self.add_polyline('hands', (10, 14), (15, 8), (28, 8), (38, 14), (38, 28), (30, 30), (28, 38), (22, 40), (10, 28), (10, 14), closed=True)
        ...
        self.add_line('thumb-inner', (24, 24), (30, 22))
        self.add_line('grip', (30, 22), (30, 30))
