# Repair: Lower the surfboard and lengthen the crouched body below the balancing arms.
...
class SurferBesideBreakingWave(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('body-1', (17, 24), *(((17.0, 26.0), (14.0, 26.25), (13, 30)),))
        self.add_line('body-2', (13, 30), (20, 33))
        self.add_line('board-1', (6, 33), (20, 33))
        self.add_line('board-2', (20, 33), (29, 33))
