...
class SquidVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('point-left', (8, 16), (24, 6), radius_x=32, sweep=True)
        self.add_arc('point-right', (24, 6), (40, 16), radius_x=32, sweep=True)
        ...
        for side in (-1, 1):
            ...
            self.add_line(tag + '-inner-root', p(6, 28), p(6, 38))
            self.add_arc(tag + '-inner-curl', p(6, 38), p(12, 42), radius_x=8, sweep=side < 0)
