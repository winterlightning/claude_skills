...
held={67, 72, 9, 74, 11, 75, 13, 81, 18, 23, 24, 90, 27, 94, 32, 102, 103, 104, 46, 47, 117, 56, 122, 61}
...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [17,28,29,33,36,49,53,59,60,69,70,71,80,84,91,98,99,100,101,106,123]:
  ...
  if i in [10,42,89]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty page or screen enclosure; retained as solo as requested.'})
