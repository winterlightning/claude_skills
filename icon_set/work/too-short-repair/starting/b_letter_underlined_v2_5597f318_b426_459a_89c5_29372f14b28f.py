# Variant of b-letter-underlined; parent file remains unchanged.
...
class BLetterUnderlinedVariant2(Solo48):
    ...
    def build(self) -> None:
        self.add_line('b-top', (8, 6), (26, 6))
        self.add_arc('b-upper', (26, 6), (26, 18), radius_x=12, radius_y=7, sweep=True)
        ...
        self.add_line('b-back-3', (8, 18), (8, 6))
        ...
        self.add_line('underline', (8, 42), (40, 42))
