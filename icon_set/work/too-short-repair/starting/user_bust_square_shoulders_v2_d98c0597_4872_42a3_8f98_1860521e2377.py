# Variant of user-bust-square-shoulders; parent file remains unchanged.
...
class UserBustSquareShouldersVariant2(Solo48):
    icon_id = 'user-bust-square-shoulders-v2'
    variant_of = 'user-bust-square-shoulders'
