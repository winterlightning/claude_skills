# Variant of bell-flat-clapper; parent file remains unchanged.
...
class BellFlatClapperVariant2(Solo48):
    icon_id = 'bell-flat-clapper-v2'
    variant_of = 'bell-flat-clapper'
