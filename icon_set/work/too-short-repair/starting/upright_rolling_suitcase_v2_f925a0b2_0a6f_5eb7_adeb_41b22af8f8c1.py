# Variant of upright-rolling-suitcase; parent file remains unchanged.
...
class UprightRollingSuitcaseVariant2(Solo48):
    icon_id = 'upright-rolling-suitcase-v2'
    variant_of = 'upright-rolling-suitcase'
