# Variant of person-with-bindle; parent file remains unchanged.
...
class PersonWithBindleVariant3(Solo48):
    icon_id = 'person-with-bindle-v3'
    variant_of = 'person-with-bindle'
