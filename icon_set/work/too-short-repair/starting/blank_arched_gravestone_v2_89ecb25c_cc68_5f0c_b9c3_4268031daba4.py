# Variant of blank-arched-gravestone; parent file remains unchanged.
...
class BlankArchedGravestoneVariant2(Solo48):
    icon_id = 'blank-arched-gravestone-v2'
    ...
    def build(self):
        ...
        J('walls', 'arch')
        P('base', (8, 36), (40, 36), (40, 42), (8, 42), closed=True)
        J('base', 'walls')
