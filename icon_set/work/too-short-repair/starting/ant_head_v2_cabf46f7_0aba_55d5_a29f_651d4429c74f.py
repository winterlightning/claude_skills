# Variant of ant-head; parent file remains unchanged.
"""Ant face; centerline extremes (8,6)-(40,42). Mirrored long antennae and circular eyes; broad mouth block retained. Oval eyes simplified to small circles for clear holes. Lucide bug informs symmetric arcs."""
...
class AntHeadVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('mouth-bottom-1', (29, 39), (29, 42))
        self.add_line('mouth-bottom-2', (29, 42), (19, 42))
        self.add_line('mouth-bottom-3', (19, 42), (19, 39))
        ...
        self.add_polyline('antenna-left', (20, 18), (20, 8), (14, 6), closed=False)
        ...
        self.add_polyline('antenna-right', (28, 18), (28, 8), (34, 6), closed=False)
