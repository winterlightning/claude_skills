# Variant of conical-pendant-lamp; parent file remains unchanged.
...
class ConicalPendantLampVariant2(Solo48):
    icon_id = 'conical-pendant-lamp-v2'
    variant_of = 'conical-pendant-lamp'
