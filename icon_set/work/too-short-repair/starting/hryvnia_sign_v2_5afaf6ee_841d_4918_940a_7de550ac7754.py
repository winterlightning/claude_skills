# Variant of hryvnia-sign; parent file remains unchanged.
...
class HryvniaSignVariant2(Solo48):
    icon_id = 'hryvnia-sign-v2'
    variant_of = 'hryvnia-sign'
    ...
    def build(self) -> None:
        self.add_line('top', (14, 6), (26, 6))
        self.add_arc('upper', (26, 6), (26, 20), radius_x=8)
        self.add_line('diagonal', (26, 20), (22, 28))
        self.add_arc('lower', (22, 28), (22, 42), radius_x=8, sweep=False)
        self.add_line('bottom', (22, 42), (34, 42))
