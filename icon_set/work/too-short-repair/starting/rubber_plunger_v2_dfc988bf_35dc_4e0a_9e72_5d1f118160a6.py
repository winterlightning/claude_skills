# Variant of rubber-plunger; parent file remains unchanged.
...
class RubberPlungerVariant2(Solo48):
    icon_id = 'rubber-plunger-v2'
    variant_of = 'rubber-plunger'
    ...
    def build(self) -> None:
        ...
        self.add_arc('cup-left', (8, 42), (24, 28), radius_x=16)
        self.add_arc('cup-right', (24, 28), (40, 42), radius_x=16)
        self.add_line('rim', (40, 42), (8, 42))
