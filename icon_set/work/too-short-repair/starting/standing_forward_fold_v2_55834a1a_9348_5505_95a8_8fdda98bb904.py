# Variant of standing-forward-fold; parent file remains unchanged.
...
class StandingForwardFoldVariant2(Solo48):
    icon_id = 'standing-forward-fold-v2'
    variant_of = 'standing-forward-fold'
