# Variant of upright-flashlight; parent file remains unchanged.
...
class UprightFlashlightVariant2(Solo48):
    ...
    def build(self) -> None:
        self.add_polyline('outline', (8, 6), (40, 6), (40, 14), (33, 22), (33, 40), (29, 42), (19, 42), (15, 40), (15, 22), (8, 14), closed=True)
