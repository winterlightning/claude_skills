# Variant of wet-floor-mop; parent file remains unchanged.
...
class WetFloorMopVariant2(Solo48):
    icon_id = 'wet-floor-mop-v2'
    variant_of = 'wet-floor-mop'
    ...
    def build(self) -> None:
        self.add_line('handle', (24, 6), (24, 22))
