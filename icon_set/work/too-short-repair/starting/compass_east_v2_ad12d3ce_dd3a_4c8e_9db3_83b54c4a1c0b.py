# Variant of compass-east; parent file remains unchanged.
...
class CompassEastVariant2(Solo48):
    icon_id = 'compass-east-v2'
    variant_of = 'compass-east'
    ...
    def build(self) -> None:
        ...
        self.add_polyline('legend', (38, 42), (32, 42), (32, 28), (38, 28), closed=False)
