# Variant of employee-behind-laptop; parent file remains unchanged.
...
class EmployeeBehindLaptopVariant2(Solo48):
    icon_id = 'employee-behind-laptop-v2'
    variant_of = 'employee-behind-laptop'
