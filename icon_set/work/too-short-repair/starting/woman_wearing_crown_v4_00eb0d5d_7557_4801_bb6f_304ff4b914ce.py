# Variant of woman-wearing-crown; parent file remains unchanged.
...
class WomanWearingCrownVariant4(Solo48):
    icon_id = 'woman-wearing-crown-v4'
    ...
    def build(self) -> None:
        self.add_polyline('crown', (14, 18), (10, 6), (18, 10), (24, 6), (30, 10), (38, 6), (34, 18), (24, 18), closed=True)
