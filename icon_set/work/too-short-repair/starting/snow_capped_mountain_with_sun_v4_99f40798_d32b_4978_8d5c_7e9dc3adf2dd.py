# Variant of snow-capped-mountain-with-sun-v3; parent file remains unchanged.
...
class SnowCappedMountainWithSunVariant4(Solo48):
    icon_id = 'snow-capped-mountain-with-sun-v4'
    variant_of = 'snow-capped-mountain-with-sun-v3'
