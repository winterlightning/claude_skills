...
class HandHoldingDocumentVariant3(Solo48):
    icon_id = 'hand-holding-document-v3'
    ...
    def build(self):
        self.add_polyline('paper', (18, 20), (8, 20), (8, 42), (32, 42), (32, 26))
        self.add_polyline('arm-top', (40, 6), (31, 10), (23, 10), (18, 20))
