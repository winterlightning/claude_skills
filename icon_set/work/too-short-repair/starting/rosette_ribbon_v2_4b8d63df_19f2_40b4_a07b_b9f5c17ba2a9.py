# Variant of rosette-ribbon; parent file remains unchanged.
...
class RosetteRibbonVariant2(Solo48):
    icon_id = 'rosette-ribbon-v2'
    variant_of = 'rosette-ribbon'
    ...
    def build(self) -> None:
        ...
        self.add_polyline('tails', (12, 20), (12, 42), (24, 36), (36, 42), (36, 20))
