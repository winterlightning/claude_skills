# Variant of bell-knob-curved-clapper; parent file remains unchanged.
...
class BellKnobCurvedClapperVariant2(Solo48):
    icon_id = 'bell-knob-curved-clapper-v2'
    variant_of = 'bell-knob-curved-clapper'
