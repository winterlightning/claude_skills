# Variant of mountain-pose; parent file remains unchanged.
...
class MountainPoseVariant2(Solo48):
    icon_id = 'mountain-pose-v2'
    variant_of = 'mountain-pose'
    ...
    def build(self):
        ...
        self.add_arc('shoulder-l', (8, 25), (24, 19), radius_x=16, radius_y=6, sweep=True)
        self.add_arc('shoulder-r', (24, 19), (40, 25), radius_x=16, radius_y=6, sweep=True)
        self.add_line('arm-r', (40, 25), (40, 34))
        self.add_contour('arms', 'arm-l', 'shoulder-l', 'shoulder-r', 'arm-r', closed=False)
        self.add_line('body', (24, 19), (24, 42))
