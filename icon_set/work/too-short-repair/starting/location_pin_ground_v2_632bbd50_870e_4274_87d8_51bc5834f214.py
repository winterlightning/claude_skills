# Variant of location-pin-ground; parent file remains unchanged.
...
class LocationPinGroundVariant2(Solo48):
    icon_id = 'location-pin-ground-v2'
    variant_of = 'location-pin-ground'
    ...
    def build(self) -> None:
        ...
        self.add_line('ground', (16, 42), (32, 42))
