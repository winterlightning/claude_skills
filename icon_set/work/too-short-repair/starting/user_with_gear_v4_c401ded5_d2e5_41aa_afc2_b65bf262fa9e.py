# Variant of user-with-gear; parent file remains unchanged.
...
class UserWithGearVariant4(Solo48):
    icon_id = 'user-with-gear-v4'
    ...
    def build(self) -> None:
        self.add_arc('head-left', (24, 24), (24, 6), radius_x=10)
