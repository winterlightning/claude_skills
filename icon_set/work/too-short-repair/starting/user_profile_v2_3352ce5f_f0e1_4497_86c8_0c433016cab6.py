# Variant of user-profile; parent file remains unchanged.
...
class UserProfileVariant2(Solo48):
    icon_id = 'user-profile-v2'
    variant_of = 'user-profile'
    ...
    def build(self) -> None:
        ...
        self.add_arc('shoulders', (8, 42), (40, 42), radius_x=16, radius_y=13, sweep=True)
