# Variant of occupant-side-airbag; parent file remains unchanged.
...
class OccupantSideAirbagVariant2(Solo48):
    icon_id = 'occupant-side-airbag-v2'
    variant_of = 'occupant-side-airbag'
