# Variant of helicopter-top-view; parent file remains unchanged.
...
class HelicopterTopViewVariant2(Solo48):
    icon_id = 'helicopter-top-view-v2'
    ...
    def build(self) -> None:
        ...
        self.add_line('tail', (24, 38), (24, 42))
        self.add_polyline('tail-rotor', (18, 42), (24, 42), (30, 42))
