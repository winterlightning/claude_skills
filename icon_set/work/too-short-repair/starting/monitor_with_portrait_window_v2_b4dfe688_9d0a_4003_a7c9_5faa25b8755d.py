# Variant of monitor-with-portrait-window; parent file remains unchanged.
...
class MonitorWithPortraitWindowVariant2(Solo48):
    icon_id = 'monitor-with-portrait-window-v2'
    variant_of = 'monitor-with-portrait-window'
