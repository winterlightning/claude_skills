# Variant of raised-clenched-fist; parent file remains unchanged.
...
class RaisedClenchedFistVariant2(Solo48):
    icon_id = 'raised-clenched-fist-v2'
    variant_of = 'raised-clenched-fist'
