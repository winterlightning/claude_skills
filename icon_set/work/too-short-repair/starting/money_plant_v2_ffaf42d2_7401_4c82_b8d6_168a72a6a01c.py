# Variant of money-plant; parent file remains unchanged.
...
class MoneyPlantVariant2(Solo48):
    icon_id = 'money-plant-v2'
    variant_of = 'money-plant'
    ...
    def build(self) -> None:
        ...
        self.add_line('dollar-tick', (24, 6), (24, 7))
        self.relate('connect', 'dollar', 'dollar-tick')
        self.add_polyline('stem', (24, 23), (24, 42))
        self.relate('connect', 'dollar', 'stem')
        for name, tip, root, sweep in [('left', (8, 29), (19, 42), False), ('right', (40, 29), (29, 42), True)]:
            self.add_arc('leaf-' + name + '-outer', tip, root, radius_x=11, radius_y=13, sweep=sweep)
            self.add_arc('leaf-' + name + '-inner', root, tip, radius_x=11, radius_y=13, sweep=sweep)
            self.add_contour('leaf-' + name, 'leaf-' + name + '-outer', 'leaf-' + name + '-inner', closed=True)
            self.add_line('branch-' + name, root, (24, 42))
