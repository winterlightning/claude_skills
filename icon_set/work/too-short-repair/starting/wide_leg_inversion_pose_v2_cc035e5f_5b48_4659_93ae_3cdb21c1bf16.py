# Variant of wide-leg-inversion-pose; parent file remains unchanged.
...
class WideLegInversionPoseVariant2(Solo48):
    icon_id = 'wide-leg-inversion-pose-v2'
    variant_of = 'wide-leg-inversion-pose'
