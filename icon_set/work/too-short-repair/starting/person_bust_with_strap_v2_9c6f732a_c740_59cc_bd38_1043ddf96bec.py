# Variant of person-bust-with-strap; parent file remains unchanged.
...
class PersonBustWithStrapVariant2(Solo48):
    icon_id = 'person-bust-with-strap-v2'
    variant_of = 'person-bust-with-strap'
