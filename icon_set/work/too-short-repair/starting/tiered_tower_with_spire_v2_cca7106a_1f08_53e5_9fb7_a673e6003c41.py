# Variant of tiered-tower-with-spire; parent file remains unchanged.
...
class TieredTowerWithSpireVariant2(Solo48):
    icon_id = 'tiered-tower-with-spire-v2'
    variant_of = 'tiered-tower-with-spire'
