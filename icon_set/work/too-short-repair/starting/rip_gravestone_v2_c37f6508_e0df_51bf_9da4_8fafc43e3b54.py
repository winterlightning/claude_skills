# Variant of rip-gravestone; parent file remains unchanged.
...
class RipGravestoneVariant2(Solo48):
    icon_id = 'rip-gravestone-v2'
    variant_of = 'rip-gravestone'
