# Variant of subtract-interface-essential; parent file remains unchanged.
...
class SubtractInterfaceEssentialVariant2(Solo48):
    icon_id = 'subtract-interface-essential-v2'
    variant_of = 'subtract-interface-essential'
