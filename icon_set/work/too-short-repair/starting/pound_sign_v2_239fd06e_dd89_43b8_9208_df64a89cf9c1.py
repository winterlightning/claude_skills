# Variant of pound-sign; parent file remains unchanged.
...
class PoundSignVariant2(Solo48):
    icon_id = 'pound-sign-v2'
    variant_of = 'pound-sign'
    ...
    def build(self) -> None:
        ...
        self.add_arc('foot', (16, 34), (8, 42), radius_x=13)
