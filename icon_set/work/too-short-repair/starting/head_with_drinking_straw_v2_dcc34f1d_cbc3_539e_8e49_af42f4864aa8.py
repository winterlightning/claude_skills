# Variant of head-with-drinking-straw; parent file remains unchanged.
...
class HeadWithDrinkingStrawVariant2(Solo48):
    icon_id = 'head-with-drinking-straw-v2'
    variant_of = 'head-with-drinking-straw'
    ...
    def build(self) -> None:
        ...
        self.add_line('neck-front', (20, 42), (20, 42))
        ...
        self.add_line('neck-back', (35, 34), (34, 42))
        self.add_contour('back-outline', 'skull', 'neck-back', closed=False)
        self.add_polyline('straw', (40, 6), (32, 6), (27, 26), closed=False)
