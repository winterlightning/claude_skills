# Variant of air-traffic-control-tower; parent file remains unchanged.
...
class AirTrafficControlTowerVariant2(Solo48):
    icon_id = 'air-traffic-control-tower-v2'
    variant_of = 'air-traffic-control-tower'
