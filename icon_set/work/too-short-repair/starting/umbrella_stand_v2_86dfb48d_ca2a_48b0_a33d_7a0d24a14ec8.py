# Variant of umbrella-stand; parent file remains unchanged.
...
class UmbrellaStandVariant2(Solo48):
    icon_id = 'umbrella-stand-v2'
    variant_of = 'umbrella-stand'
    ...
    def build(self) -> None:
        self.add_polyline('holder', (8, 27), (13, 42), (35, 42), (40, 27), closed=True)
