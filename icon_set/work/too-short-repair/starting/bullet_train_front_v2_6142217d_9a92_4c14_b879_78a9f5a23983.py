# Variant of bullet-train-front; parent file remains unchanged.
...
class BulletTrainFrontVariant2(Solo48):
    icon_id = 'bullet-train-front-v2'
    variant_of = 'bullet-train-front'
    ...
    def build(self) -> None:
        ...
        self.add_line('left-rail', (19, 38), (8, 42))
        self.add_line('right-rail', (29, 38), (40, 42))
