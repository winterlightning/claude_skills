# Variant of arrows-diagonal-resize; parent file remains unchanged.
...
class ArrowsDiagonalResizeVariant2(Solo48):
    icon_id = 'arrows-diagonal-resize-v2'
    variant_of = 'arrows-diagonal-resize'
