# Variant of person-wearing-headphones; parent file remains unchanged.
...
class PersonWearingHeadphonesVariant2(Solo48):
    icon_id = 'person-wearing-headphones-v2'
    variant_of = 'person-wearing-headphones'
