# Variant of open-scissors; parent file remains unchanged.
...
class OpenScissorsVariant2(Solo48):
    icon_id = 'open-scissors-v2'
    variant_of = 'open-scissors'
    ...
    def build(self) -> None:
        ...
        self.add_arc('bow-a', (24, 22), (36, 6), radius_x=18, sweep=False)
        self.add_contour('blade-a', 'neck-a', 'bow-a')
        self.add_line('neck-b', (35, 34), (24, 22))
        self.add_arc('bow-b', (24, 22), (12, 6), radius_x=18)
