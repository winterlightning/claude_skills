...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [15,19,22,31,32,35,48,52,85,87,88]:
  ...
  if i in [78]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty box enclosure; retained as solo as requested.'})
