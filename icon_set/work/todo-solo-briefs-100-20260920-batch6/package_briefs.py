...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [8,18,23,38,42,54,55,58,61,62,65,77,87,95]:
  ...
  if i in [25,68,70]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty cave, bell jar or vase enclosure; retained as solo as requested.'})
