...
class TimeReverse(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e5-1', (40, 24), (40, 28), radius_x=50, sweep=False)
        self.add_arc('e5-2', (40, 28), (36, 38), radius_x=18)
        self.add_arc('e5-3', (36, 38), (24, 44), radius_x=15)
        self.add_line('e5-4', (24, 44), (18, 43))
        self.add_arc('e5-5', (18, 43), (15, 41), radius_x=16, sweep=False)
        self.add_arc('e5-6', (15, 41), (8, 27), radius_x=18)
        self.add_line('e5-7', (8, 27), (9, 19))
        self.add_line('e5-8', (9, 19), (13, 13))
        self.add_arc('e5-9', (13, 13), (32, 10), radius_x=15)
        self.add_contour('c0', 'e0', 'e1')
        self.add_contour('c1', 'e5-1', 'e5-2', 'e5-3', 'e5-4', 'e5-5', 'e5-6', 'e5-7', 'e5-8', 'e5-9')
