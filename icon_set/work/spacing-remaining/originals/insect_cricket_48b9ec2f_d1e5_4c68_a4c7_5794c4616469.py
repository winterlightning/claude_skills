"""Insect head; centerline extremes (6,6)-(42,42). Mirrored antennae, cheek eyes and open palps. Lucide bug informs rounded face and bilateral appendages; oval eyes simplified to dots."""
...
class InsectHeadWithAntennae(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('antenna-arch-left', (14, 8), (6, 8), radius_x=6, radius_y=6, sweep=False)
        ...
        self.add_line('palp-left', (19, 41), (17, 42))
        self.relate("connect", 'face', 'palp-left')
        self.add_line('antenna-stem-right', (29, 17), (34, 8))
        self.add_arc('antenna-arch-right', (34, 8), (42, 8), radius_x=6, radius_y=6, sweep=True)
        ...
        self.add_line('palp-right', (29, 41), (31, 42))
