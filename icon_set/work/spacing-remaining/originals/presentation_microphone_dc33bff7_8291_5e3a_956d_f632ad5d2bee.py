...
class PresentationMicrophone(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e4-1', (40, 22), (24, 35), radius_x=15)
        self.add_arc('e4-2', (24, 35), (8, 22), radius_x=15)
        self.add_arc('e5-1', (14, 22), (24, 30), radius_x=10, sweep=False)
        self.add_arc('e5-2', (24, 30), (34, 21), radius_x=9, sweep=False)
        self.add_arc('e6-1', (34, 11), (29, 5), radius_x=7, sweep=False)
        self.add_line('e6-2', (29, 5), (24, 4))
        self.add_line('e6-3', (24, 4), (19, 5))
        self.add_arc('e6-4', (19, 5), (14, 11), radius_x=7, sweep=False)
