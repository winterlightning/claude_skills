...
class MobilePhone70454eff(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2-2', (39, 5), (36, 4), radius_x=5, sweep=False)
        self.add_line('sym-e3', (36, 4), (24, 4))
        self.add_line('sym-e4', (24, 4), (12, 4))
        self.add_arc('sym-e5-1', (12, 4), (9, 5), radius_x=5, sweep=False)
        ...
        self.add_arc('sym-e11', (11, 44), (12, 44), radius_x=24)
        ...
        self.add_arc('sym-e17-1', (40, 40), (40, 39), radius_x=39)
        self.add_arc('sym-e17-2', (40, 39), (40, 38), radius_x=39)
        self.add_line('sym-e18', (40, 38), (40, 36))
        self.add_line('sym-e19', (20, 12), (28, 12))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2-1', 'sym-e2-2', 'sym-e3', 'sym-e4', 'sym-e5-1', 'sym-e5-2', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9-1', 'sym-e9-2', 'sym-e11', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e16-1', 'sym-e16-2', 'sym-e17-1', 'sym-e17-2', 'sym-e18')
