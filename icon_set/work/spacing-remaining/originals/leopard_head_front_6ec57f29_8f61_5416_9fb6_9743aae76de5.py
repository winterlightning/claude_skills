...
class CheetahFace(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('ear-right-top', (34, 10), (40, 6), radius_x=6, radius_y=5, sweep=True, large_arc=False)
        self.add_arc('ear-right-round', (40, 6), (42, 11), radius_x=6, radius_y=6, sweep=True, large_arc=False)
        self.add_arc('ear-right-side', (42, 11), (42, 17), radius_x=4, radius_y=6, sweep=True, large_arc=False)
        self.add_arc('cheek-right', (42, 17), (24, 42), radius_x=18, radius_y=26, sweep=True, large_arc=False)
        self.add_arc('cheek-left', (24, 42), (6, 17), radius_x=18, radius_y=26, sweep=True, large_arc=False)
        self.add_arc('ear-left-side', (6, 17), (6, 11), radius_x=4, radius_y=6, sweep=True, large_arc=False)
        self.add_arc('ear-left-round', (6, 11), (8, 6), radius_x=6, radius_y=6, sweep=True, large_arc=False)
        self.add_arc('ear-left-top', (8, 6), (14, 10), radius_x=6, radius_y=5, sweep=True, large_arc=False)
