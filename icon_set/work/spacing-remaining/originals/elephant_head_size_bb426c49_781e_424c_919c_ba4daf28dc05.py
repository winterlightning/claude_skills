...
class ElephantHeadProfile(Solo48):
    ...
    def build(self):
        self.add_arc('head-trunk-1', (6, 12), (14, 6), radius_x=12, radius_y=7, sweep=True)
        self.add_arc('head-trunk-2', (14, 6), (29, 20), radius_x=15, radius_y=15, sweep=True)
        ...
        self.add_arc('head-trunk-7', (42, 8), (42, 18), radius_x=2, radius_y=10, sweep=True)
        self.add_arc('head-trunk-8', (42, 18), (34, 36), radius_x=12, radius_y=18, sweep=True)
        ...
        self.add_arc('ear-1', (13, 15), (6, 32), radius_x=11, radius_y=17, sweep=True)
        self.add_contour('ear', 'ear-1', closed=False)
        self.add_arc('jaw-1', (24, 33), (16, 36), radius_x=10, radius_y=10, sweep=True)
        self.add_arc('jaw-2', (16, 36), (10, 42), radius_x=6, radius_y=7, sweep=False)
        self.add_contour('jaw', 'jaw-1', 'jaw-2', closed=False)
        self.relate("connect", 'jaw', 'head-trunk')
        self.add_arc('tusk-1', (24, 33), (35, 42), radius_x=14, radius_y=14, sweep=False)
