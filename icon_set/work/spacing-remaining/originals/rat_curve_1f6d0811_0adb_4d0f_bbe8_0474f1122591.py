...
class CurledRat(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('ear-bottom', (6, 14), (10, 22), radius_x=8, radius_y=8, sweep=False)
        self.add_line('neck', (10, 22), (10, 26))
        self.add_arc('body-left', (10, 26), (30, 42), radius_x=20, radius_y=20, sweep=False)
        self.add_arc('body-right', (30, 42), (42, 25), radius_x=16, radius_y=21, sweep=False)
        self.add_arc('tail-rise', (42, 25), (40, 10), radius_x=6, radius_y=15, sweep=False)
        self.add_contour('body', 'ear-top', 'ear-bottom', 'neck', 'body-left', 'body-right', 'tail-rise')
        self.add_arc('brow', (12, 8), (32, 6), radius_x=20, radius_y=6, sweep=True)
