...
class Bulb(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e9-1', (27, 40), (29, 38), radius_x=3, sweep=False)
        self.add_arc('e9-2', (29, 38), (30, 32), radius_x=10)
        self.add_arc('e10', (32, 28), (16, 28), radius_x=9, large_arc=True, sweep=False)
