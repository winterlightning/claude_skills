...
class RoundWhale(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('belly-right', (42,30), (32,42), radius_x=10, radius_y=16)
        self.add_line('base-right', (32,42), (28,42))
        self.add_line('base-middle', (28,42), (20,42))
        self.add_line('base-left', (20,42), (16,42))
        self.add_arc('belly-left', (16,42), (6,30), radius_x=10, radius_y=16)
        ...
        self.add_arc('flipper-left', (6,30), (6,38), radius_x=4, radius_y=8, sweep=False)
        self.add_arc('flipper-right', (42,30), (42,38), radius_x=4, radius_y=8)
        ...
        self.add_arc('pleat-left', (16,34), (20,42), radius_x=4, radius_y=12, sweep=False)
        self.add_arc('pleat-right', (32,34), (28,42), radius_x=4, radius_y=12)
        ...
        self.add_arc('spout-left', (24,10), (16,6), radius_x=8, sweep=False)
        self.add_arc('spout-right', (24,10), (32,6), radius_x=8)
