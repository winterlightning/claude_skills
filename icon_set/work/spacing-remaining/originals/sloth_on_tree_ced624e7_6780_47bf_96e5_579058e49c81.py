...
class SlothOnBranch(Solo48):
    ...
    def build(self) -> None:
        # Rightward draped body and pendant limb; extremes (6,8)-(42,40).
        self.add_arc('head0', (6, 18), (12, 8), radius_x=10, radius_y=10, sweep=True)
        ...
        self.add_arc('head3', (12, 28), (6, 18), radius_x=10, radius_y=10, sweep=True)
        ...
        self.add_line('rump-1', (42, 23), (42, 31))
        self.add_line('rump-2', (42, 31), (39, 31))
        ...
        self.add_line('branch-left', (6, 28), (12, 28))
        self.add_line('branch-right', (39, 31), (42, 31))
