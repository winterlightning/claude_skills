...
class SimpleShark(Solo48):
    ...
    def build(self) -> None:
        self.add_line('upper-tail-1', (10, 22), (6, 14))
        self.add_line('upper-tail-2', (6, 14), (6, 24))
        self.add_line('upper-tail-3', (6, 24), (6, 34))
        self.add_line('upper-tail-4', (6, 34), (10, 28))
        self.add_line('upper-tail-5', (10, 28), (24, 32))
        self.add_line('upper-tail-6', (24, 32), (24, 40))
        self.add_line('upper-tail-7', (24, 40), (33, 33))
        self.add_arc('jaw', (33, 33), (42, 25), radius_x=13, radius_y=8, sweep=False, large_arc=False)
        self.add_arc('nose', (42, 25), (30, 17), radius_x=16, radius_y=8, sweep=False, large_arc=False)
