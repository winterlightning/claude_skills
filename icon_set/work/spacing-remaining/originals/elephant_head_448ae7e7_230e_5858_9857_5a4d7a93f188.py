...
class ElephantHead(Solo48):
    ...
    def build(self):
        self.add_arc('face-1', (14, 8), (24, 6), radius_x=10, radius_y=6, sweep=True)
        self.add_arc('face-2', (24, 6), (34, 8), radius_x=10, radius_y=6, sweep=True)
        ...
        self.add_arc('face-7', (34, 38), (26, 42), radius_x=8, radius_y=8, sweep=True)
        self.add_arc('face-8', (26, 42), (18, 38), radius_x=8, radius_y=8, sweep=True)
        ...
        self.add_arc('ear-left-1', (14, 8), (6, 17), radius_x=12, radius_y=9, sweep=False)
        self.add_arc('ear-left-2', (6, 17), (8, 30), radius_x=6, radius_y=13, sweep=False)
        ...
        self.add_arc('ear-right-1', (34, 8), (42, 17), radius_x=12, radius_y=9, sweep=True)
        self.add_arc('ear-right-2', (42, 17), (40, 30), radius_x=6, radius_y=13, sweep=True)
