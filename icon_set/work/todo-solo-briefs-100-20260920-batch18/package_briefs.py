...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in []:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty panel or enclosure arrangement; retained as solo as requested, though container may be a better authoring family.'})
