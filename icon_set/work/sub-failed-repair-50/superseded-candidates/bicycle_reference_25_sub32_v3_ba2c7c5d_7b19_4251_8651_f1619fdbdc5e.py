...
class RepairVariant(Sub32):
    ...
    icon_id = 'bicycle-reference-25-sub32-v3'
    ...
    def build(self):
        ...
        self.add_polyline('frame', (6, 24), (12, 12), (22, 12), (13, 24), (6, 24))
        self.add_line('crank', (12, 12), (13, 24))
        self.add_polyline('fork', (26, 24), (22, 12), (20, 4), (17, 4))
        self.add_line('seatpost', (12, 12), (12, 4))
        self.add_line('seat', (9, 4), (15, 4))
