...
class RoosterHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('crown',(6,31),((6,21),(12,14),(19,14)),((26,14),(30,18),(33,22)))
        ...
        self.add_bezier('comb',(19,14),((15,14),(12,12),(12,10)),((12,6),(20,6),(24,10)),((27,6),(28,6),(30,6)),((37,6),(37,14),(33,22)))
