...
class LeapingOrca(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('back',(9, 26),*(((12.60869517, 20.08981917), (18.49536673, 15.97698474), (25, 15)),))
        ...
        self.add_bezier('belly',(26, 30),*(((21.7664278, 28.17199802), (16.90418869, 28.54601641), (13, 31)),))
        self.add_line('tail-top',(13, 31),(9, 40))
