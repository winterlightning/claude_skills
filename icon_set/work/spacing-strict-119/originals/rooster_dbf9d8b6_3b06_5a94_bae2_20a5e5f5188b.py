...
class RoosterWithScallopedBase(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('body-2',(17, 13),(29, 25),radius_x=12,radius_y=12,large_arc=False,sweep=True)
        self.add_line('body-3',(29, 25),(29, 42))
        self.add_bezier('body-4',(29, 42),*(((27.5422399, 43.69026141), (25.21753356, 44), (23, 44)),))
        ...
        self.add_line('beak-1',(29, 23),(40, 34))
        self.add_line('beak-2',(40, 34),(29, 34))
        self.add_bezier('wattle-1',(29, 34),*(((32.86599325, 34.0), (35.5, 36.79822031), (36, 40)),))
        self.add_bezier('wattle-2',(36, 40),*(((34.60675893, 42.7111363), (31.99264674, 44), (29, 44)),))
