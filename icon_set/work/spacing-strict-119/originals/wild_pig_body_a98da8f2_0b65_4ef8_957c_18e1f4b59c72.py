...
class WildBoar(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('snout',(44, 24),*(((44, 26.58712249), (43.69026141, 29.29927988), (42, 31)),))
        self.add_line('chin',(42, 31),(35, 29))
        self.add_bezier('chest',(35, 29),*(((32.23857625, 29.0), (30.0, 31.23857625), (30, 34)),))
