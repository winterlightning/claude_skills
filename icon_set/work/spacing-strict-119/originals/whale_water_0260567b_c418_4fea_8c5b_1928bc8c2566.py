...
class WhaleTailWithSpout(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('back',(14,31),((20,31),(22,36),(28,36)),((34,36),(38,31),(38,25)))
        self.add_bezier('fluke-left',(38,25),((35,22),(34,18),(34,14)))
        self.add_polyline('notch',(34,14),(40,18),(42,14))
