...
class RoundLeafPottedPlant(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('left-lower', (24, 26), *(((13.89903423, 25.55169861), (6, 18.51787363), (6, 10)),))
        self.add_contour("left-leaf", "left-upper", "left-inner", "left-lower", closed=True)
        self.add_bezier('right-lower', (42, 10), *(((42, 18.51787363), (34.10096577, 25.55169861), (24, 26)),))
