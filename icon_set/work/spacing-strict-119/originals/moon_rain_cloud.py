...
class MoonRainCloud(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('cloud-right-upper',(28, 22),*(((32.418278, 22.0), (36.5, 23.790861), (36, 26)),))
        self.add_bezier('cloud-right-lower',(36, 26),*(((36.5, 28.209139), (32.418278, 30.0), (28, 30)),))
        ...
        self.add_bezier('moon-inner',(44, 8),*(((40.54822031, 8), (37.75, 12.92486775), (37.75, 19.0)), ((37.75, 25.07513225), (40.54822031, 30.0), (44, 30))))
        self.add_line('moon-tip',(44, 30),(36, 26))
