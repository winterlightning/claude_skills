...
class ManPortraitProfile(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('hair-front',(10,10),((10,6),(12,4),(16,4)))
        self.add_line('crown',(16,4),(24,4))
        self.add_bezier('head-back',(24,4),((32,4),(38,10),(38,18)))
        self.add_line('nape',(38,18),(34,32))
        self.add_line('neck-back',(34,32),(34,38))
        self.add_line('shoulder-back',(34,38),(40,44))
        ...
        self.add_line('shoulder-front',(20,38),(8,44))
