...
class Gorilla(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('silhouette-1', (6, 33), *(((6, 27.01470651), (8.06218191, 21.38197618), (12, 19)),))
        self.add_line('silhouette-2', (12, 19), (19, 19))
        self.add_arc('silhouette-3', (19, 19), (27, 12), radius_x=8, radius_y=8, sweep=False)
        self.add_bezier('silhouette-4', (27, 12), *(((27.57237784, 8.52884098), (30.99209203, 6), (35, 6)),))
        self.add_bezier('silhouette-5', (35, 6), *(((38.50691948, 6), (41.49916939, 8.52884098), (42, 12)),))
        ...
        self.add_bezier('silhouette-17', (6, 42), *(((6, 41.67204441), (6, 41.32795559), (6, 41)),))
