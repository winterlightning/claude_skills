...
class RoundBug(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier('body-5', (36, 34), *(((35.42115825, 38.73123217), (32.89656458, 42), (30, 42)),))
        self.add_bezier('body-6', (30, 42), *(((28.0471466, 42), (25.9528534, 42), (24, 42)),))
        self.add_bezier('body-7', (24, 42), *(((22.0471466, 42), (19.9528534, 42), (18, 42)),))
        self.add_bezier('body-8', (18, 42), *(((15.10343542, 42), (12.57884175, 38.73123217), (12, 34)),))
        ...
        self.add_arc('antenna-left-1', (18, 13), (11, 6), radius_x=15, radius_y=15, sweep=False)
        self.add_contour('antenna-left', 'antenna-left-1', closed=False)
        self.add_arc('antenna-right-1', (30, 13), (37, 6), radius_x=15, radius_y=15, sweep=True)
        self.add_contour('antenna-right', 'antenna-right-1', closed=False)
        self.add_arc('leg-l1-1', (12, 27), (6, 24), radius_x=12, radius_y=12, sweep=False)
        self.add_contour('leg-l1', 'leg-l1-1', closed=False)
        self.add_arc('leg-r1-1', (36, 27), (42, 24), radius_x=12, radius_y=12, sweep=True)
        self.add_contour('leg-r1', 'leg-r1-1', closed=False)
        self.add_line('leg-l2-1', (12, 34), (6, 34))
        self.add_contour('leg-l2', 'leg-l2-1', closed=False)
        self.add_line('leg-r2-1', (36, 34), (42, 34))
        self.add_contour('leg-r2', 'leg-r2-1', closed=False)
        self.add_arc('leg-l3-1', (18, 42), (6, 42), radius_x=15, radius_y=15, sweep=False)
        self.add_contour('leg-l3', 'leg-l3-1', closed=False)
        self.add_arc('leg-r3-1', (30, 42), (42, 42), radius_x=15, radius_y=15, sweep=True)
