...
SOURCE_ICON_ID = '5eb9130e-55bf-582b-bfe6-c9510aba9335'
SOURCE_PATH = 'pictographic-primitives/animals/wolf howl_5eb9130e-55bf-582b-bfe6-c9510aba9335.svg'
AUTHOR = 'gpt-6'


class HowlingWolfHead(Solo48):
    icon_id = 'howling-wolf-head'
    ...
    def build(self) -> None:
        ...
        self.add_line('ear-2', (39, 23), (42, 20))
        self.add_bezier('neck', (42, 20), *(((42, 24.68970455), (40.98224268, 29.35658757), (38, 33)),))
