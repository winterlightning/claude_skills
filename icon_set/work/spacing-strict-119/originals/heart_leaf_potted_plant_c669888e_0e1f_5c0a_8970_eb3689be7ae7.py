...
class HeartLeafPottedPlant(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('centre-a', (24, 10), (16, 10), radius_x=4, radius_y=4, sweep=False, large_arc=False)
        self.add_line('centre-b', (16, 10), (24, 16))
        self.add_line('centre-c', (24, 16), (32, 10))
        self.add_arc('centre-d', (32, 10), (24, 10), radius_x=4, radius_y=4, sweep=False, large_arc=False)
        ...
        self.add_line('pot-br',(39,42),(36,42))
        self.add_line('pot-b', (36, 42), (12, 42))
        self.add_line('pot-bl',(12,42),(9,42))
