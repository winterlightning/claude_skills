  ...
  for n in cls.body:
   if isinstance(n,ast.Assign):
    for t in n.targets:
     ...
     if isinstance(t,ast.Name) and t.id=='keywords':n.value=ast.Tuple([ast.Constant('solo-ai-clover-curve'),ast.Constant('solo-ai-next100'),ast.Constant(name)],ast.Load())
