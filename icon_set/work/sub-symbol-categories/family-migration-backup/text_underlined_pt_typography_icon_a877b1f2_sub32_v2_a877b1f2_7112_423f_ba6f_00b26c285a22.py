# Variant of text-underlined-pt-typography-icon-a877b1f2-sub32; parent file remains unchanged.
...
class DrawingVariant2(TextSub32):
    icon_id = 'text-underlined-pt-typography-icon-a877b1f2-sub32-v2'
    variant_of = 'text-underlined-pt-typography-icon-a877b1f2-sub32'
