"""Independent 32px profile of text-8k-ultra-high-definition-resolution-94cd3ca3.
...
SOURCE_ICON_ID = '94cd3ca3-2716-45b5-901f-ee15d4d77042'
SOURCE_PATH = 'icon_set/dist/text32/text-8k-ultra-high-definition-resolution-94cd3ca3.svg'
AUTHOR = 'gpt-6'
SOURCE_REFERENCES = (('94cd3ca3-2716-45b5-901f-ee15d4d77042', '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/text/8k (text)_94cd3ca3-2716-45b5-901f-ee15d4d77042.svg'),)
PROFILE_SOURCE_KEYS = ('text/text-8k-ultra-high-definition-resolution-94cd3ca3',)
SOLO_SOURCE_ICON_IDS = ()
TYPEFACE_GLYPH_IDS = ('digit-8', 'letter-k-uppercase')
REFERENCE_EXPORT_SHA256 = '8f88f8181a95798371bd9492444cf4227d7cd9ed52a5ca648d6015b9fb18d31f'

class Drawing(TextSub32):
    icon_id = 'text-8k-ultra-high-definition-resolution-94cd3ca3-sub32'
    ...
    def build(self):
        ...
        self.add_line('p2-r1-1', (49, 2), (29, 17))
        self.add_line('p2-r1-2', (29, 17), (49, 30))
