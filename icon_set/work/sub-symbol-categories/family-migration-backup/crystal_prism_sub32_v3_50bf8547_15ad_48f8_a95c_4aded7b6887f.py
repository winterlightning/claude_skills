# Variant of crystal-prism-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    ...
    variant_of = 'crystal-prism-sub32-v2'
    ...
    def build(self):
        # Tall crystal prism: vertically elongated facets, equal top and bottom diamond caps.
        ...
        for x in ['upper-facets-1','upper-facets-2']:
         for y in ['spine']: self.relate('connect',x,y)
        for x in ['lower-facets-1','lower-facets-2']: self.relate('connect',x,'spine')
        for a,b in [('outline-1','upper-facets-2'),('outline-2','upper-facets-2'),('outline-3','lower-facets-2'),('outline-2','lower-facets-2'),('outline-4','lower-facets-1'),('outline-5','lower-facets-1'),('outline-5','upper-facets-1'),('outline-6','upper-facets-1')]:self.relate('connect',a,b)
