# Variant of ice-skate-boot-sub32; parent file remains unchanged.
...
class DrawingVariant2(Sub32):
    icon_id = 'ice-skate-boot-sub32-v2'
    variant_of = 'ice-skate-boot-sub32'
    variant_label = 'Smooth instep and open toe clearance'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-2', (16, 2), (16, 9))
        self.add_arc('p1-r1-3', (16, 9), (21, 14), radius_x=5, radius_y=5, large_arc=False, sweep=False)
        self.add_bezier('p1-r1-4', (21,14), ((25,14),(26,17),(26,21)))
        self.add_line('p1-r1-5', (26, 21), (22, 21))
