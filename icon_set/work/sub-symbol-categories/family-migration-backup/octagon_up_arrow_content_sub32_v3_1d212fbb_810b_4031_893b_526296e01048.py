# Variant of octagon-up-arrow-content-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    ...
    variant_of = 'octagon-up-arrow-content-sub32-v2'
    ...
    def build(self):
        # Regular octagonal content below a separate upward arrow, with room between the two symbols.
        self.add_polyline('arrow',(11,7),(16,2),(21,7))
        self.add_line('shaft',(16,2),(16,8))
        self.relate('connect','shaft','arrow-1');self.relate('connect','shaft','arrow-2')
