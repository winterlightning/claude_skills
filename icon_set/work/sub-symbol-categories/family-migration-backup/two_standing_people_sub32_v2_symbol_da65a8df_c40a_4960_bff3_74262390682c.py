...
class DrawingVariant2ContainerSymbol(Sub32):
    ...
    variant_of = 'two-standing-people-sub32-v2'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/two-standing-people-sub32-v2'
    counterpart_icon_id = 'two-standing-people-sub32-v2'
    ...
    def build(self):
        ...
        for i, x in enumerate((7, 25)):
            ...
            join(f'torso-{i}', f'arms-{i}')
            join(f'torso-{i}', f'legs-{i}')
