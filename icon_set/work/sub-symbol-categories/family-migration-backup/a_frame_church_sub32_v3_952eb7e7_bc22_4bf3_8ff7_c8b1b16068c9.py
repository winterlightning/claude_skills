# Variant of a-frame-church-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    ...
    variant_of = 'a-frame-church-sub32-v2'
    ...
    def build(self):
        # Both roof runs have slope ±1: eave, wall attachment and apex are collinear.
        short_axis = 16
        short_half_span = 12
        apex_y = 10
