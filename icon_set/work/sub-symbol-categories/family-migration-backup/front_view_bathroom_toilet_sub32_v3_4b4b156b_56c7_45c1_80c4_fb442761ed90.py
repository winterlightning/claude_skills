# Variant of front-view-bathroom-toilet-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    ...
    variant_of = 'front-view-bathroom-toilet-sub32-v2'
    ...
    def build(self):
        # Rounded tank and a deeper bowl with coherent curved shoulders above the pedestal.
        ...
        self.add_line('foot-right',(20,24),(22,30));self.add_line('base',(22,30),(10,30));self.add_line('foot-left',(10,30),(12,24))
        self.add_bezier('bowl-left',(12,24),((8,22),(4,20),(4,14)))
        self.add_contour('bowl','seat','bowl-right','foot-right','base','foot-left','bowl-left',closed=True);self.relate('connect','tank','bowl')
