# Variant of crawling-beetle-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    ...
    variant_of = 'crawling-beetle-sub32-v2'
    ...
    def build(self):
        ...
        self.add_line('belly',(30,22),(8,22));self.add_contour('body','dome','belly',closed=True)
        self.add_line('seam',(19,10),(15,22));self.relate('connect','seam','body')
        self.add_bezier('antenna-root',(19,10),((17,6),(12,4),(8,4)))
        self.add_bezier('antenna-tip',(8,4),((4,4),(2,6),(2,8)))
        self.add_contour('antenna','antenna-root','antenna-tip');self.relate('connect','antenna','body');self.relate('connect','antenna','seam')
        self.add_line('front-leg',(15,22),(10,28));self.add_line('back-leg',(24,22),(27,28))
        self.relate('connect','front-leg','body');self.relate('connect','back-leg','body');self.relate('connect','front-leg','seam')
