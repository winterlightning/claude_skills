...
held={131, 27, 32, 36, 38, 43, 44, 49, 50, 51, 54, 55, 56, 63, 66, 72, 75, 81, 82, 85, 88, 94, 95, 96, 97, 102, 103, 104, 107, 108, 111, 117, 118, 120, 121}
...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [16,30,40,47,53,57,61,68,69,77,83,90,105,106,124,125,127,128,130]:
  ...
  if i in [39,59,110,112,129]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'An empty panel or enclosure arrangement; retained as solo as requested, though container may be a better authoring family.'})
