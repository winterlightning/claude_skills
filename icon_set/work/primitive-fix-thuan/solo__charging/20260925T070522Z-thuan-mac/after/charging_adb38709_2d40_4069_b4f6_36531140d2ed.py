"""Upright half-charged battery with a centered terminal and equal rounded corners. Repair the lopsided shoulder and inconsistent corner radii.
Construction: Lucide mail original and atomic-debug: uniform corner arcs; source battery layout.
Fresh standalone revision; original preserved.
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48
SOURCE_ICON_ID = 'adb38709-2d40-4069-b4f6-36531140d2ed'
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__charging/20260925T070522Z-thuan-mac/reference/charging_adb38709-2d40-4069-b4f6-36531140d2ed.svg'
AUTHOR = 'gpt-6'
