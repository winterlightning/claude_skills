...
class Drawing(Solo48):
    ...
    aliases = ('Digital Photo Camera',)
    keywords = ('digital', 'photo', 'camera')
    def build(self):
        ...
        path('shell',(8,14),[(12,14),(18,8),(30,8),(36,14),(40,14),((44,18),4,4,True),(44,36),((40,40),4,4,True),(8,40),((4,36),4,4,True),(4,18),((8,14),4,4,True)],True)
        circle('lens',24,24,7)
