"""Add a clearly positioned dot eye below the horns, giving the triceratops head a readable face while preserving its frill and horn silhouette. Applied to the original icon identity."""
