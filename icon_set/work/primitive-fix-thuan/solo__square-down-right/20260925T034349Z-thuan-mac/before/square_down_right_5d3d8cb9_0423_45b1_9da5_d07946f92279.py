...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('head',(16,25),(24,33),(32,25));self.relate('connect','shaft','head')

KEYSHAPE_REASON='The complete composition uses centerline extremes (6,6)–(42,42).'
FINAL_REDUCTIONS='Filename direction differs from the picture; preserve the picture.'
