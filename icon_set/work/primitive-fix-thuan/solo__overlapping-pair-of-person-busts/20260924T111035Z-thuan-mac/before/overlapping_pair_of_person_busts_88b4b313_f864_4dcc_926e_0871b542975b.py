...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_11/children_88b4b313-f864-4dcc-926e-0871b542975b.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    category = 'objects'
    aliases = ()
    keywords = ('overlapping', 'pair', 'of', 'person', 'busts')
