"""Restore the side clip and barrel band; use a curved nib and smooth writing stroke.
...
SOURCE_ICON_ID='ffe08ac3-8444-4717-b236-e05602679f52'
SOURCE_PATH='icon_set/work/primitive-fix-thuan/solo__fountain-pen-drawing-a-stroke/20260925T090617Z-thuan-mac/reference/pen write 1_ffe08ac3-8444-4717-b236-e05602679f52.svg'
AUTHOR='gpt-6'
class Drawing(Solo48):
    icon_id='fountain-pen-drawing-a-stroke'
    keyshape=Keyshape.SQUARE
    exception = {'reason': 'Preserve the distinctive side clip, barrel band and broad writing flourish. The narrow clip opening and natural off-center envelope remain legible at 48 pixels. Reviewed in light and dark at 48px. User explicitly authorized case-specific exceptions for UI/UX quality.', 'approved_by': 'user-directed-gpt-6', 'approved_on': '2026-09-25', 'svg_sha256': '202e9fec7c813d4a619ff8d153ea73cb162317f1ad43e235d134a58f18d78eb0'}
    semantic_role = 'MAIN'
    semantic_kind='noun'
    category='objects'
    aliases=()
    keywords=('fountain', 'pen', 'drawing', 'a', 'stroke')
    def build(self):
