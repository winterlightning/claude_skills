"""shofar. Revision of reviewer feedback: Bad stroke drawn.
Plan: Two rounded rims and tapered J horn. Shared rim nodes; square extremes 6,6,42,42.
...
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__traditional-ram-horn-shofar-solo/20260924T090615Z-thuan-mac/reference/shofar_b899b610-48c3-460c-9017-034a792ae9cb.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    ...
    def build(self):
        ...
        box('mouth',20,6,42,14,4)
        box('bell',6,28,14,42,4)
        bez('outer',(36,14),((36,32),(31,38),(14,38)))
        bez('inner',(24,14),((24,25),(23,30),(14,30)))
