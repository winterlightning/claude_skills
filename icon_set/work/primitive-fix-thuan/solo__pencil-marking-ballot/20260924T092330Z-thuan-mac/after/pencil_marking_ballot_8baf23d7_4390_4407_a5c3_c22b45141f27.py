...
Construction: Lucide square-pen: outlined ballot choices and pencil. Equal boxes preserve the source hierarchy; cross is essential and must remain readable.
"""
