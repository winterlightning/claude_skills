...
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__keyboard-arrow-bottom/20260924T100528Z-thuan-mac/reference/keyboard arrow bottom_921d7bfe-d6be-588f-ad4e-a75efb840443.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    category = 'objects'
    aliases = ()
    keywords = ('keyboard', 'arrow', 'bottom')
