"""Uppercase G for SOLO48; centerline envelope (10, 4)–(38, 44).
Plan: Open bowl with a right-angle inward terminal; asymmetric to distinguish G from C.
...
class LetterGUppercase(Solo48):
    icon_id = 'letter-g-uppercase'
    ...
    def build(self):
        rotation = 0
        mirror = False
        runs=[((38,12),[('A',24,4,14,8,False),('A',10,24,14,20,False),('A',24,44,14,20,False),('A',38,30,14,14,False),('L',38,24),('L',28,24)],False)]
