"""A rising vector path connects two hollow endpoint nodes and branches rightward. Restore one continuous sweep and a shallow tangent branch.
Construction: Source-specific vector editing diagram; Lucide cuboid informs explicit shared branch nodes.
Fresh SOLO48 revision; original preserved.
"""
from icon_set.model.keyshapes import Keyshape
from icon_set.model.icons.solo._base import Solo48
SOURCE_ICON_ID = '8d376546-c54d-4f5b-a590-61a7253d486e'
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__curved-vector-path-with-branching-handle/20260925T083047Z-thuan-mac/reference/vectors path corner_8d376546-c54d-4f5b-a590-61a7253d486e.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    category = "objects"
    aliases = ()
    keywords = ('curved', 'vector', 'path', 'with', 'branching', 'handle')
    ...
    def build(self):
        ...
        path('curve',(10,34),[('C',(18,25),(12,31),(15,28)),('C',(34,10),(24,17),(28,12))]);join('curve','lower');join('curve','upper')
        path('branch',(18,25),[('C',(42,23),(26,23),(34,23))]);join('curve','branch')
