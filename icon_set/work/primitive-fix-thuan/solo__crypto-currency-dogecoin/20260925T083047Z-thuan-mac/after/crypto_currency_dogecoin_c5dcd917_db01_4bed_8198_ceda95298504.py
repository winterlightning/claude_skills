"""A coin bearing a serif capital D. Restore the letter’s projecting serifs and a balanced rounded bowl inside the circular coin.
Construction: Source-specific letter and coin; rounded contour construction.
...
class Drawing(Solo48):
    ...
    category = "objects"
    aliases = ()
    keywords = ('crypto', 'currency', 'dogecoin')
    ...
    def build(self):
        ...
        poly('top-serif',(18,14),(21,14),(23,14))
        poly('bottom-serif',(18,34),(21,34),(23,34))
        line('stem',(21,14),(21,34));join('stem','top-serif');join('stem','bottom-serif')
