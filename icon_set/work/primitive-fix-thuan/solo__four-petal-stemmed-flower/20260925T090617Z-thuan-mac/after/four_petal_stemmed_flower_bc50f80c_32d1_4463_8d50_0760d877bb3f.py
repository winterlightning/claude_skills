...
class Drawing(Solo48):
    ...
    exception = {'reason': 'Preserve the flower center disk and four rounded petals. Local narrow petal-to-disk clearances remain open at native size; a missing center changes the reference. Reviewed in light and dark at 48px. User explicitly authorized case-specific exceptions for UI/UX quality.', 'approved_by': 'user-directed-gpt-6', 'approved_on': '2026-09-25', 'svg_sha256': '5e34a22d2f0981c85210ff032e96ed12d9153f5e6271446da8a837339eb68b53'}
    semantic_role = 'MAIN'
    semantic_kind='noun'
    category='objects'
    aliases=()
