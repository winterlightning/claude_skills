...
for i,r in enumerate(rows):
 ...
 if i not in held:
  ...
  if i in [22,36,41,42,51,57,83,88,95]:
  ...
  if i in [58,96]:flags.append({'source_uuid':r['uuid'],'concept':d['concept'],'note':'A vessel or open stall enclosure; retained as solo as requested.'})
