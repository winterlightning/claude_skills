...
def build(root=ROOT, target=None):
    gallery=root/'icon_set/dist/gallery';data=root/'icon_set/data'
    ...
    (root/'icon_set/work/sub-profile-migration/summary.json').write_text(json.dumps(summary,indent=2)+'\n')
