# Variant of graduation-cap-symbol-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    icon_id = 'graduation-cap-symbol-sub32-v3'
    variant_of = 'graduation-cap-symbol-sub32-v2'
    ...
    def build(self):
        ...
        self.add_contour('band','right','br','bl','left');self.relate('connect','board','band')
