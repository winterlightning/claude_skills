...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p1-r1-3', (18, 21), (18, 27))
        self.add_line('p1-r1-4', (18, 27), (30, 16))
        self.add_line('p1-r1-5', (30, 16), (18, 5))
        self.add_line('p1-r1-6', (18, 5), (18, 11))
