...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_bezier('p1-r1-1', (5, 26), ((5, 25), (6, 23), (8, 23)))
        self.add_bezier('p1-r1-2', (8, 23), ((10, 23), (12, 25), (12, 26)))
        self.add_bezier('p1-r1-3', (12, 26), ((12, 28), (10, 30), (8, 30)))
        self.add_bezier('p1-r1-4', (8, 30), ((6, 30), (5, 28), (5, 26)))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', 'p1-r1-4', closed=False)
        self.add_bezier('p2-r1-1', (20, 26), ((20, 25), (22, 23), (24, 23)))
        self.add_bezier('p2-r1-2', (24, 23), ((26, 23), (27, 25), (27, 26)))
        self.add_bezier('p2-r1-3', (27, 26), ((27, 28), (26, 30), (24, 30)))
        self.add_bezier('p2-r1-4', (24, 30), ((22, 30), (20, 28), (20, 26)))
        self.add_contour('path-2-1', 'p2-r1-1', 'p2-r1-2', 'p2-r1-3', 'p2-r1-4', closed=False)
        self.add_line('p3-r1-1', (8, 23), (16, 15))
        self.add_bezier('p3-r1-2', (16, 15), ((19, 14), (21, 12), (22, 10)))
        self.add_bezier('p3-r1-3', (22, 10), ((24, 8), (24, 5), (24, 3)))
        self.add_bezier('p3-r1-4', (24, 3), ((24, 2), (24, 2), (24, 2)))
        self.add_contour('path-3-1', 'p3-r1-1', 'p3-r1-2', 'p3-r1-3', 'p3-r1-4', closed=False)
        self.add_line('p4-r1-1', (24, 23), (16, 15))
        self.add_bezier('p4-r1-2', (16, 15), ((13, 14), (11, 12), (10, 10)))
        self.add_bezier('p4-r1-3', (10, 10), ((8, 8), (8, 5), (8, 3)))
