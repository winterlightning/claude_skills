...
class Drawing(Sub32):
    icon_id = 'column-selected-single-interface-essential-sub32'
    ...
    def build(self):
        self.add_line('p1-r1-1', (5, 20), (27, 20))
        self.add_contour('path-1-1', 'p1-r1-1', closed=False)
        self.add_line('p2-r1-1', (5, 20), (5, 30))
        self.add_line('p2-r1-2', (5, 30), (27, 30))
        self.add_line('p2-r1-3', (27, 30), (27, 20))
        self.add_contour('path-2-1', 'p2-r1-1', 'p2-r1-2', 'p2-r1-3', closed=False)
        self.add_line('p3-r1-1', (5, 20), (5, 12))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (27, 20), (27, 12))
        self.add_contour('path-4-1', 'p4-r1-1', closed=False)
        self.add_line('p5-r1-1', (5, 12), (27, 12))
        self.add_contour('path-5-1', 'p5-r1-1', closed=False)
        self.add_line('p6-r1-1', (5, 12), (5, 2))
        self.add_line('p6-r1-2', (5, 2), (27, 2))
        self.add_line('p6-r1-3', (27, 2), (27, 12))
