...
class Drawing(Sub32):
    exception = {'reason': 'User-approved complete reference composition; accept remaining visual/grid/spacing findings while preserving 32x32 and uniform 4px strokes.', 'approved_by': 'user', 'approved_on': '2026-09-24', 'svg_sha256': '8c5c33462edfb52fd858d9ab35b307c83814377b48ce6bdafd707a8063bd176e'}
    ...
    def build(self):
        ...
        self.add_line('fork-left',(6,10),(6,14))
        self.add_bezier('cup',(6,14),((6,19),(16,19),(16,14)))
