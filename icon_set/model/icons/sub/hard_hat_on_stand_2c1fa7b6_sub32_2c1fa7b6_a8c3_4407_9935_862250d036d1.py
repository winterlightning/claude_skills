...
class Drawing(Sub32):
    icon_id = 'hard-hat-on-stand-2c1fa7b6-sub32'
    ...
    def build(self):
        self.add_arc('p1-r1-1', (5, 16), (16, 5), radius_x=11, radius_y=11, large_arc=False, sweep=True)
        self.add_arc('p1-r1-2', (16, 5), (27, 16), radius_x=11, radius_y=11, large_arc=False, sweep=True)
        ...
        self.add_line('p3-r1-1', (16, 5), (16, 10))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (16, 16), (16, 27))
        self.add_contour('path-4-1', 'p4-r1-1', closed=False)
        self.add_line('p5-r1-1', (9, 27), (16, 27))
        self.add_line('p5-r1-2', (16, 27), (23, 27))
