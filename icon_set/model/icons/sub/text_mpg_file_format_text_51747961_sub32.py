...
class Drawing(TextSub32):
    icon_id = 'text-mpg-file-format-text-51747961-sub32'
    ...
    text_ink_bounds = (0.0, -1.9539862061712654e-06, 68.00000000000009, 20.0)

    def build(self):
        """Source-native uppercase composition for 'MPG'; 4-unit letter spacing."""
