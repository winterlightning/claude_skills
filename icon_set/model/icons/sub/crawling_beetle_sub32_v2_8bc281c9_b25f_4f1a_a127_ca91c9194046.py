...
class DrawingVariant2(Sub32):
    icon_id = 'crawling-beetle-sub32-v2'
    variant_of = 'crawling-beetle-sub32'
    ...
    def build(self):
        ...
        self.add_bezier('p1-r1-1', (2, 20), ((2, 17), (3, 15), (6, 12)))
        self.add_bezier('p1-r1-2', (6, 12), ((9, 9), (12, 8), (16, 8)))
        self.add_bezier('p1-r1-3', (16, 8), ((20, 8), (23, 9), (26, 12)))
        self.add_bezier('p1-r1-4', (26, 12), ((29, 15), (30, 17), (30, 20)))
        ...
        self.add_line('p3-r1-1', (16, 8), (5, short_low))
        self.add_line('p3-r1-2', (5, short_low), (2, short_low))
        self.add_contour('path-3-1', 'p3-r1-1', 'p3-r1-2', closed=False)
        self.add_line('p4-r1-1', (9, 20), (3, short_high))
        self.add_contour('path-4-1', 'p4-r1-1', closed=False)
        self.add_line('p5-r1-1', (26, 20), (20, short_high))
