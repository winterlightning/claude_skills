...
class Drawing(TextSub32):
    ...
    def build(self):
        """Source-native uppercase composition for 'API'; 4-unit letter spacing."""
        ...
        self.add_line('p3-r1-1', (64, 18), (52, 18))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (64, 2), (52, 2))
        self.add_contour('path-4-1', 'p4-r1-1', closed=False)
        self.add_line('p5-r1-1', (58, 2), (58, 18))
