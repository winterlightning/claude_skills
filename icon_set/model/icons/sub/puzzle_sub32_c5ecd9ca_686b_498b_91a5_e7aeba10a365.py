...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_line('p1-r1-1', (13, 10), (5, 10))
        self.add_line('p1-r1-2', (5, 10), (5, 16))
        self.add_bezier('p1-r1-3', (5, 16), ((8, 16), (9, 17), (9, 20)))
        self.add_bezier('p1-r1-4', (9, 20), ((9, 22), (8, 23), (5, 23)))
        self.add_line('p1-r1-5', (5, 23), (5, 30))
        self.add_line('p1-r1-6', (5, 30), (14, 30))
        ...
        self.add_line('p1-r1-11', (21, 30), (27, 30))
        self.add_line('p1-r1-12', (27, 30), (27, 10))
        self.add_line('p1-r1-13', (27, 10), (20, 10))
