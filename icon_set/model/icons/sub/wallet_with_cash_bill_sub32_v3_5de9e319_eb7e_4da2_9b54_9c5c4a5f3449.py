...
class DrawingVariant3(Sub32):
    icon_id = 'wallet-with-cash-bill-sub32-v3'
    ...
    def build(self):
        """Rounded wallet body, closed right fastening tab and angled protruding bill. Construction reference: wallet: rounded enclosure and genuinely attached fastening tab."""
        self.add_line('left', (2, 27), (2, 13))
        self.add_arc('tl', (2, 13), (5, 10), radius_x=3)
        self.add_line('top', (5, 10), (22, 10))
        self.add_arc('tr', (22, 10), (25, 13), radius_x=3)
        self.add_line('right-top', (25, 13), (25, 16))
        self.add_contour('upper', 'left', 'tl', 'top', 'tr', 'right-top')
        self.add_line('right-base', (25, 24), (25, 27))
        self.add_arc('br', (25, 27), (22, 30), radius_x=3)
        self.add_line('base', (22, 30), (5, 30))
        ...
        self.add_contour('bill', 'bill-left', 'bill-corner')
        self.relate('connect', 'bill', 'upper')
