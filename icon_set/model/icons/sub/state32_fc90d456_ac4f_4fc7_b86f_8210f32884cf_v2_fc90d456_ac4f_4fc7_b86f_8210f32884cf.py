# Variant of state32-fc90d456-ac4f-4fc7-b86f-8210f32884cf; parent file remains unchanged.
...
class DrawingVariant2(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p1-r1-4', (23,16), (23,2))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-4', closed=True)
        self.add_contour('knife-handle', 'p1-r1-3', closed=False)
        self.relate('connect','path-1-1','knife-handle')
