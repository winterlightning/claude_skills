"""Programming Code Chat Bubble: user-requested grid-fitted 32px version of code-message-40-solo.
...
SOURCE_ICON_ID='e1bcad48-dc6c-42e0-9104-5d6461fe3199'
SOURCE_PATH='pictographic-primitives/other/code message_e1bcad48-dc6c-42e0-9104-5d6461fe3199.svg'
SOLO_SOURCE_ICON_ID='code-message-40-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='code-message-40-sub32'
    keyshape=Keyshape.SQUARE
    semantic_role='SUB'
    semantic_kind='modifier'
    category='objects/interface-essential'
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'programming code chat bubble')
    def build(self):
        ...
        self.add_line('code-left-2', (9, 13), (13, 17))
        self.add_line('code-right-1', (19, 9), (23, 13))
        self.add_line('code-right-2', (23, 13), (19, 17))
        ...
        self.add_contour('code-right', 'code-right-1', 'code-right-2', closed=False)
