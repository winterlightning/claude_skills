...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_arc('p2-r1-1', (2, 16), (19, 9), radius_x=17, radius_y=17, large_arc=False, sweep=False)
        self.add_arc('p2-r1-2', (19, 9), (30, 16), radius_x=13, radius_y=13, large_arc=False, sweep=False)
        self.add_contour('path-2-1', 'p2-r1-1', 'p2-r1-2', closed=False)
        self.add_line('p3-r1-1', (11, 22), (13, 23))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (20, 23), (21, 22))
