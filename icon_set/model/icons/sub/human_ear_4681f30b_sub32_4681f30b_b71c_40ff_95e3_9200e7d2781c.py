...
class Drawing(Sub32):
    icon_id = 'human-ear-4681f30b-sub32'
    ...
    def build(self):
        ...
        self.add_arc('p1-r1-2', (26, 12), (19, 23), radius_x=7, radius_y=11, large_arc=False, sweep=True)
        self.add_arc('p1-r1-3', (19, 23), (13, 30), radius_x=6, radius_y=7, large_arc=False, sweep=True)
        self.add_arc('p1-r1-4', (13, 30), (6, 23), radius_x=7, radius_y=7, large_arc=False, sweep=True)
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', 'p1-r1-4', closed=False)
        self.add_arc('p2-r1-1', (13, 10), (17, 15), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        self.add_arc('p2-r1-2', (17, 15), (13, 19), radius_x=4, radius_y=4, large_arc=False, sweep=True)
