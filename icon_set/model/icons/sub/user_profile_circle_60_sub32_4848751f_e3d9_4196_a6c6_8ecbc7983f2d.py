"""User Profile Circle Icon: user-requested grid-fitted 32px version of user-profile-circle-60-solo.
...
SOLO_SOURCE_ICON_ID='user-profile-circle-60-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='user-profile-circle-60-sub32'
    ...
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'user profile circle icon')
    def build(self):
