"""Bitcoin Message Speech Bubble: user-requested grid-fitted 32px version of bitcoin-message-speech-bubble-solo.
...
SOLO_SOURCE_ICON_ID='bitcoin-message-speech-bubble-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='bitcoin-message-speech-bubble-sub32'
    keyshape=Keyshape.VRECT_XL
    semantic_role='SUB'
    semantic_kind='modifier'
    category='objects/finance'
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'bitcoin message speech bubble')
    def build(self):
