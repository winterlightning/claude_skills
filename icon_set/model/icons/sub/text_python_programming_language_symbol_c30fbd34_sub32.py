...
class Drawing(TextSub32):
    icon_id = 'text-python-programming-language-symbol-c30fbd34-sub32'
    ...
    text_ink_bounds = (2.28564, 0.0, 44.0, 20.0)

    def build(self):
        """Source-native uppercase composition for 'PY'; 4-unit letter spacing."""
        ...
        self.add_line('p2-r1-1', (42, 2), (33.98389, 10.5452))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_line('p3-r1-1', (26, 2.05579), (33.98297, 10.5452))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (33.98296, 10.5453), (33.98145, 18))
