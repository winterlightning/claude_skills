# Variant of container-content-text-f824dc04-sub32; parent file remains unchanged.
...
class DrawingVariant2(TextSub32):
    icon_id = 'container-content-text-f824dc04-sub32-v2'
    variant_of = 'container-content-text-f824dc04-sub32'
    variant_label = 'Tangent car corners and explicit dollar junction'
    ...
    def build(self):
        ...
        self.add_line('p3-r1-6', (30, 18), (30, 23))
        self.add_arc('p3-r1-7', (30, 23), (28, 25), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        ...
        self.add_arc('p3-r1-13', (4, 25), (2, 23), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('p3-r1-14', (2, 23), (2, 18))
