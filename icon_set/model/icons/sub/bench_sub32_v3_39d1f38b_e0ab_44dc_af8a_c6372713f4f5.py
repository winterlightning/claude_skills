...
# Variant of bench-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    icon_id = 'bench-sub32-v3'
    variant_of = 'bench-sub32-v2'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-1', (5, short_low), (10, short_low))
        self.add_line('p1-r1-2', (10, short_low), (22, short_low))
        self.add_line('p1-r1-3', (22, short_low), (27, short_low))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', closed=False)
        self.add_line('p2-r1-1', (2, 16), (8, 16))
        self.add_line('p2-r1-2', (8, 16), (24, 16))
        self.add_line('p2-r1-3', (24, 16), (30, 16))
        self.add_contour('path-2-1', 'p2-r1-1', 'p2-r1-2', 'p2-r1-3', closed=False)
        self.add_line('p3-r1-1', (10, short_low), (8, 16))
        self.add_line('p3-r1-2', (8, 16), (6, short_high))
        self.add_contour('path-3-1', 'p3-r1-1', 'p3-r1-2', closed=False)
        self.add_line('p4-r1-1', (22, short_low), (24, 16))
        self.add_line('p4-r1-2', (24, 16), (26, short_high))
