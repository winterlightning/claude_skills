...
class DrawingVariant2(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p1-r1-1', (20, 2), (short_low, 18))
        self.add_line('p1-r1-2', (short_low, 18), (13, 18))
        self.add_line('p1-r1-3', (13, 18), (12, 30))
        self.add_line('p1-r1-4', (12, 30), (short_high, 14))
        self.add_line('p1-r1-5', (short_high, 14), (19, 14))
