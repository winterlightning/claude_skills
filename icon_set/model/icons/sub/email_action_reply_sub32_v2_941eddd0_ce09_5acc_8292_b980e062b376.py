...
class DrawingVariant2(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p1-r1-3', (2, 15), (13, short_low))
        self.add_line('p1-r1-4', (13, short_low), (13, 11))
        self.add_bezier('p1-r1-5', (13, 11), ((24, 11), (30, 17), (30, short_high)))
        self.add_bezier('p1-r1-6', (30, short_high), ((24, 21), (20, 19), (13, 19)))
