# Variant of text-underlined-mt-text-d24c6147-sub32; parent file remains unchanged.
...
class DrawingVariant2(TextSub32):
    icon_id = 'text-underlined-mt-text-d24c6147-sub32-v2'
    variant_of = 'text-underlined-mt-text-d24c6147-sub32'
