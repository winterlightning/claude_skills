...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_bezier('p1-r1-1', (9, 13), ((9, 10), (8, 8), (6, 8)))
        ...
        self.add_bezier('p1-r1-6', (6, 24), ((8, 24), (9, 22), (9, 19)))
        self.add_line('p1-r1-7', (9, 19), (23, 19))
        self.add_bezier('p1-r1-8', (23, 19), ((23, 22), (24, 24), (26, 24)))
        ...
        self.add_bezier('p1-r1-13', (26, 8), ((24, 8), (23, 10), (23, 13)))
        self.add_line('p1-r1-14', (23, 13), (9, 13))
