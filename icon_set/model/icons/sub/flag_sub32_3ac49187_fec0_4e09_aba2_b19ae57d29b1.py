...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p2-r1-1', (5, 30), (10, 30))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_arc('p3-r1-1', (8, 5), (15, 3), radius_x=10, radius_y=10, large_arc=False, sweep=True)
        self.add_line('p3-r1-2', (15, 3), (20, 5))
        self.add_arc('p3-r1-3', (20, 5), (27, 4), radius_x=12, radius_y=12, large_arc=False, sweep=False)
        self.add_line('p3-r1-4', (27, 4), (27, 15))
        self.add_arc('p3-r1-5', (27, 15), (20, 16), radius_x=9, radius_y=9, large_arc=False, sweep=True)
        self.add_line('p3-r1-6', (20, 16), (15, 15))
        self.add_arc('p3-r1-7', (15, 15), (8, 16), radius_x=11, radius_y=11, large_arc=False, sweep=False)
