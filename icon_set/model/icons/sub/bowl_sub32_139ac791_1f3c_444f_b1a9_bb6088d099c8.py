...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_bezier('p1-r1-2', (30, 5), ((30, 13), (26, 19), (22, 22)))
        self.add_line('p1-r1-3', (22, 22), (22, 27))
        self.add_line('p1-r1-4', (22, 27), (10, 27))
        self.add_line('p1-r1-5', (10, 27), (10, 22))
        self.add_bezier('p1-r1-6', (10, 22), ((6, 19), (2, 13), (2, 5)))
