...
class DrawingVariant2(Sub32):
    icon_id = 'bell-sub32-v2'
    variant_of = 'bell-sub32'
    ...
    def build(self):
        ...
        self.add_arc('p1-r1-2', (24, 13), (short_high, 22), radius_x=14, radius_y=14, large_arc=False, sweep=False)
        self.add_arc('p1-r1-3', (short_high, 22), (26, 23), radius_x=2, radius_y=1, large_arc=False, sweep=True)
        self.add_line('p1-r1-4', (26, 23), (20, 23))
        self.add_line('p1-r1-5', (20, 23), (12, 23))
        self.add_line('p1-r1-6', (12, 23), (6, 23))
        self.add_arc('p1-r1-7', (6, 23), (short_low, 22), radius_x=2, radius_y=1, large_arc=False, sweep=True)
        self.add_arc('p1-r1-8', (short_low, 22), (8, 13), radius_x=14, radius_y=14, large_arc=False, sweep=False)
