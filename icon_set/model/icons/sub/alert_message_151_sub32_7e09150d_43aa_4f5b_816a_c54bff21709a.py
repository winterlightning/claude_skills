"""Message Alert Bubble: user-requested grid-fitted 32px version of alert-message-151-solo.
...
SOURCE_ICON_ID='7e09150d-43aa-4f5b-816a-c54bff21709a'
SOURCE_PATH='pictographic-primitives/messages/messages bubble information_7e09150d-43aa-4f5b-816a-c54bff21709a.svg'
SOLO_SOURCE_ICON_ID='alert-message-151-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='alert-message-151-sub32'
    keyshape=Keyshape.SQUARE
    semantic_role='SUB'
    semantic_kind='modifier'
    category = 'messages'
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'message alert bubble')
    def build(self):
