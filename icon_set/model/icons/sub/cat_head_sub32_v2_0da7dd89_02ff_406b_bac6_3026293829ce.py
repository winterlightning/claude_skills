...
class RepairVariant(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p2-r1-1', (11, 14), (11, 14))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_line('p3-r1-1', (21, 14), (21, 14))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_arc('p4-r1-1', (10, 21), (16, 21), radius_x=3, radius_y=2, large_arc=False, sweep=False)
        self.add_arc('p4-r1-2', (16, 21), (22, 21), radius_x=3, radius_y=2, large_arc=False, sweep=False)
        self.add_contour('path-4-1', 'p4-r1-1', 'p4-r1-2', closed=False)
REPAIR_PLAN = 'Integer-radius mirrored mouth; remove invented nose stem absent from original.'
CONSTRUCTION_REFERENCE = 'cat'
