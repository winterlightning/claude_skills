...
class DrawingVariant3(Sub32):
    icon_id = 'state32-bacc3012-d61e-47f0-8068-aba74c1f83c7-v3'
    ...
    def build(self):
        """Registered mark retaining the complete circle and a compact R with an open bowl. Construction reference: source composition; shared small-size character construction."""
