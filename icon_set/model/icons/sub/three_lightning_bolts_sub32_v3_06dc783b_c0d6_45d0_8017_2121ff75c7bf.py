...
class DrawingVariant3(Sub32):
    ...
    def build(self):
        """Single strong lightning bolt representing the repeated lightning state. Construction reference: shared typeface / geometric source construction."""
        self.add_polyline('bolt', (26, 2), (6, 18), (22, 18), (10, 30))
