...
class Drawing(Sub32):
    icon_id = 'book-open-content-sub32'
    ...
    def build(self):
        self.add_line('p1-r1-1', (2, 5), (16, 8))
        self.add_line('p1-r1-2', (16, 8), (30, 5))
        self.add_line('p1-r1-3', (30, 5), (30, 24))
        self.add_line('p1-r1-4', (30, 24), (16, 27))
        self.add_line('p1-r1-5', (16, 27), (2, 24))
        self.add_line('p1-r1-6', (2, 24), (2, 5))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', 'p1-r1-4', 'p1-r1-5', 'p1-r1-6', closed=False)
        self.add_line('p2-r1-1', (16, 8), (16, 27))
