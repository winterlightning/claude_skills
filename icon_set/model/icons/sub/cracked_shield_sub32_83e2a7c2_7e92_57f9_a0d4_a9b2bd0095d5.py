...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_arc('p1-r1-2', (10, 5), (5, 6), radius_x=11, radius_y=11, large_arc=False, sweep=True)
        self.add_line('p1-r1-3', (5, 6), (5, 15))
        self.add_arc('p1-r1-4', (5, 15), (16, 30), radius_x=17, radius_y=17, large_arc=False, sweep=False)
        self.add_arc('p1-r1-5', (16, 30), (27, 15), radius_x=17, radius_y=17, large_arc=False, sweep=False)
        self.add_line('p1-r1-6', (27, 15), (27, 6))
        self.add_arc('p1-r1-7', (27, 6), (22, 5), radius_x=11, radius_y=11, large_arc=False, sweep=True)
