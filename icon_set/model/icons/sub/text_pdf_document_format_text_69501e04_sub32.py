...
class Drawing(TextSub32):
    icon_id = 'text-pdf-document-format-text-69501e04-sub32'
    ...
    text_ink_bounds = (2.28564, -1.3322676295501878e-15, 66.21000000000001, 20.0024)

    def build(self):
        """Source-native uppercase composition for 'PDF'; 4-unit letter spacing."""
        ...
        self.add_line('p3-r1-1', (52.21094, 10.4907), (62.2337, 10.4907))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (52.20996, 18.0024), (52.20996, 2.3249))
        self.add_bezier('p4-r1-2', (52.20996, 2.3249), ((52.20996, 2.14546), (52.35542, 2), (52.53486, 2)))
        self.add_line('p4-r1-3', (52.53486, 2), (64.21000000000001, 2))
