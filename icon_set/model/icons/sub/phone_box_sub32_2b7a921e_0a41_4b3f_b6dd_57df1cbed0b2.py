...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_arc('p1-r1-1', (5, 13), (16, 2), radius_x=11, radius_y=11, large_arc=False, sweep=True)
        self.add_arc('p1-r1-2', (16, 2), (27, 13), radius_x=11, radius_y=11, large_arc=False, sweep=True)
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', closed=False)
        self.add_line('p2-r1-1', (5, 30), (5, 13))
        self.add_line('p2-r1-2', (5, 13), (27, 13))
        self.add_line('p2-r1-3', (27, 13), (27, 30))
