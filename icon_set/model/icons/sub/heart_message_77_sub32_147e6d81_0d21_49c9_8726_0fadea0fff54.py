"""Message Bubble with Heart: user-requested grid-fitted 32px version of heart-message-77-solo.
...
SOLO_SOURCE_ICON_ID='heart-message-77-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='heart-message-77-sub32'
    keyshape=Keyshape.SQUARE
    semantic_role='SUB'
    semantic_kind='modifier'
    category='objects/interface-essential'
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'message bubble with heart')
    def build(self):
