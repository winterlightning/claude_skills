...
class DrawingVariant2(Sub32):
    icon_id = 'crystal-prism-sub32-v2'
    variant_of = 'crystal-prism-sub32'
    ...
    def build(self):
        ...
        self.add_line('p2-r1-1', (short_low, 9), (16, 13))
        self.add_line('p2-r1-2', (16, 13), (short_high, 9))
        self.add_contour('path-2-1', 'p2-r1-1', 'p2-r1-2', closed=False)
        self.add_line('p3-r1-1', (short_low, 23), (16, 19))
        self.add_line('p3-r1-2', (16, 19), (short_high, 23))
