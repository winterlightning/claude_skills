# Variant of ice-cream-cone-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    ...
    variant_of = 'ice-cream-cone-sub32-v2'
    ...
    def build(self):
        # Domed scoop, rounded side lobes, flat supporting rim, and a long cone.
        ...
        self.add_polyline('cone',(10,16),(16,30),(22,16));self.relate('connect','cone','scoop')
