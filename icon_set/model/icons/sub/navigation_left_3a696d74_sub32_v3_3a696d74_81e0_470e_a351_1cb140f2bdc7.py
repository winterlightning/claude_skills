# Variant of navigation-left-3a696d74-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    ...
    variant_of = 'navigation-left-3a696d74-sub32-v2'
    ...
    def build(self):
        # Balanced curved-arrow head whose bisector follows the curve’s starting tangent.
