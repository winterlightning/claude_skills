...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p2-r1-1', (5, 17), (5, 19))
        self.add_arc('p2-r1-2', (5, 19), (16, 27), radius_x=11, radius_y=8, large_arc=False, sweep=False)
        self.add_arc('p2-r1-3', (16, 27), (27, 19), radius_x=11, radius_y=8, large_arc=False, sweep=False)
        self.add_line('p2-r1-4', (27, 19), (27, 17))
