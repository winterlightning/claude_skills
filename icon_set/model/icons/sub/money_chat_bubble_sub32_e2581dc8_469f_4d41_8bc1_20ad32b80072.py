"""Money Chat Bubble: user-requested grid-fitted 32px version of money-chat-bubble-solo.
...
SOLO_SOURCE_ICON_ID='money-chat-bubble-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='money-chat-bubble-sub32'
    keyshape=Keyshape.VRECT_XL
    semantic_role='SUB'
    semantic_kind='modifier'
    category='objects/finance'
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'money chat bubble')
    def build(self):
