# Variant of circular-arrow-sub-v2; parent file remains unchanged.
...
class CircularArrowSubVariant3(Sub32):
    icon_id = 'circular-arrow-sub-v3'
    variant_of = 'circular-arrow-sub-v2'
    variant_label = 'Smaller circle with clearer arrowhead'
