"""Medical Support Chat Bubble: user-requested grid-fitted 32px version of medical-message-55-solo.
...
SOURCE_ICON_ID='987a6dd1-3d83-40ea-b8e5-8536b255a9fb'
SOURCE_PATH='pictographic-primitives/other/chat medical cross 2_987a6dd1-3d83-40ea-b8e5-8536b255a9fb.svg'
SOLO_SOURCE_ICON_ID='medical-message-55-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='medical-message-55-sub32'
    ...
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'medical support chat bubble')
    def build(self):
