# Variant of baby-head-sub32; parent file remains unchanged.
...
class DrawingVariant2(Sub32):
    icon_id = 'baby-head-sub32-v2'
    variant_of = 'baby-head-sub32'
    variant_label = 'Circular head and precisely attached curl'
