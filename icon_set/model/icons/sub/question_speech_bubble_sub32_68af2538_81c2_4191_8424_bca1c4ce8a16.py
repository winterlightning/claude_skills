"""Question Speech Bubble: user-requested grid-fitted 32px version of question-speech-bubble-solo.
...
SOLO_SOURCE_ICON_ID='question-speech-bubble-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='question-speech-bubble-sub32'
    ...
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'question speech bubble')
    def build(self):
