...
class DrawingVariant2(Sub32):
    icon_id = 'cart-e3de8236-sub32-v2'
    variant_of = 'cart-e3de8236-sub32'
    ...
    def build(self):
        ...
        self.add_bezier('p1-r1-5', (26, 24), ((26, short_high), (24, short_high), (23, short_high)))
        self.add_line('p1-r1-6', (23, short_high), (9, short_high))
        self.add_bezier('p1-r1-7', (9, short_high), ((8, short_high), (6, short_high), (6, 24)))
