...
class DrawingVariant4(Sub32):
    icon_id = 'hryvnia-sign-sub32-v4'
    variant_of = 'hryvnia-sign-sub32-v3'
    ...
    def build(self):
        """Hryvnia: curved reverse S with rounded upper bowl, sweeping diagonal belly and two lower horizontal bars. Construction reference: Original source composition; clean contour construction."""
...
TYPEFACE_PROFILE_VARIANTS = ('symbol-hryvnia-curved-source32',)
