...
class Drawing(Sub32):
    icon_id = 'front-view-bathroom-toilet-sub32'
    ...
    def build(self):
        ...
        self.add_line('p2-r1-1', (5, 16), (9, 16))
        self.add_line('p2-r1-2', (9, 16), (23, 16))
        self.add_line('p2-r1-3', (23, 16), (27, 16))
        self.add_bezier('p2-r1-4', (27, 16), ((27, 22), (23, 23), (22, 24)))
        self.add_line('p2-r1-5', (22, 24), (24, 30))
        self.add_line('p2-r1-6', (24, 30), (8, 30))
        self.add_line('p2-r1-7', (8, 30), (10, 24))
        self.add_bezier('p2-r1-8', (10, 24), ((9, 23), (5, 22), (5, 16)))
