...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_line('p1-r1-1', (5, 8), (5, 2))
        self.add_line('p1-r1-2', (5, 2), (27, 2))
        self.add_line('p1-r1-3', (27, 2), (27, 8))
        self.add_arc('p1-r1-4', (27, 8), (16, 19), radius_x=11, radius_y=11, large_arc=False, sweep=True)
        self.add_arc('p1-r1-5', (16, 19), (5, 8), radius_x=11, radius_y=11, large_arc=False, sweep=True)
