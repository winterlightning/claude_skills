...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_bezier('p1-r1-1', (5, 2), ((5, 9), (10, 13), (16, 16)))
        self.add_bezier('p1-r1-2', (16, 16), ((22, 20), (27, 23), (27, 30)))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', closed=False)
        self.add_bezier('p2-r1-1', (27, 2), ((27, 9), (22, 13), (16, 16)))
        self.add_bezier('p2-r1-2', (16, 16), ((10, 20), (5, 23), (5, 30)))
        self.add_contour('path-2-1', 'p2-r1-1', 'p2-r1-2', closed=False)
        self.add_line('p3-r1-1', (5, 2), (27, 2))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (5, 30), (27, 30))
