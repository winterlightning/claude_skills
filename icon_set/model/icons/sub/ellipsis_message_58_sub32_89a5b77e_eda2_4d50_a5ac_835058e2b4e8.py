"""Speech Bubble With Ellipsis: user-requested grid-fitted 32px version of ellipsis-message-58-solo.
...
SOLO_SOURCE_ICON_ID='ellipsis-message-58-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='ellipsis-message-58-sub32'
