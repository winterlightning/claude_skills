...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_line('p1-r1-1', (5, 11), (14, 16))
        self.add_contour('path-1-1', 'p1-r1-1', closed=False)
        self.add_line('p2-r1-1', (6, 20), (14, 16))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_line('p3-r1-1', (14, 16), (27, 23))
        self.add_line('p3-r1-2', (27, 23), (14, 30))
        self.add_line('p3-r1-3', (14, 30), (14, 16))
        self.add_contour('path-3-1', 'p3-r1-1', 'p3-r1-2', 'p3-r1-3', closed=False)
        self.add_line('p4-r1-1', (14, 16), (14, 2))
        self.add_line('p4-r1-2', (14, 2), (27, 9))
        self.add_line('p4-r1-3', (27, 9), (14, 16))
