...
class DrawingVariant2(Sub32):
    icon_id = 'gas-symbol-sub32-v2'
    variant_of = 'gas-symbol-sub32'
    ...
    def build(self):
        ...
        self.add_bezier('p1-r1-3', (20, 8), ((20, 10), (short_high, 10), (short_high, 16)))
        self.add_line('p1-r1-4', (short_high, 16), (short_high, 20))
        self.add_line('p1-r1-5', (short_high, 20), (short_high, 23))
        self.add_arc('p1-r1-6', (short_high, 23), (16, 30), radius_x=12, radius_y=7, large_arc=False, sweep=True)
        self.add_arc('p1-r1-7', (16, 30), (short_low, 23), radius_x=12, radius_y=7, large_arc=False, sweep=True)
        self.add_line('p1-r1-8', (short_low, 23), (short_low, 20))
        self.add_line('p1-r1-9', (short_low, 20), (short_low, 16))
        self.add_bezier('p1-r1-10', (short_low, 16), ((short_low, 10), (12, 10), (12, 8)))
        ...
        self.add_line('p2-r1-1', (short_low, 20), (short_high, 20))
