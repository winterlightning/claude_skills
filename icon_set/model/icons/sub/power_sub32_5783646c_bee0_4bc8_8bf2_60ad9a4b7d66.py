...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_bezier('p2-r1-1', (9, 10), ((6, 12), (5, 15), (5, 19)))
        self.add_bezier('p2-r1-2', (5, 19), ((5, 25), (10, 30), (16, 30)))
        self.add_bezier('p2-r1-3', (16, 30), ((22, 30), (27, 25), (27, 19)))
        self.add_bezier('p2-r1-4', (27, 19), ((27, 15), (26, 12), (23, 10)))
