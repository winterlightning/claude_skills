...
class Drawing(Sub32):
    icon_id = 'rectangle-two-dots-sub32'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-4', (27, 5), (27, 16))
        self.add_line('p1-r1-5', (27, 16), (27, 27))
        ...
        self.add_line('p1-r1-10', (5, 27), (5, 16))
        self.add_line('p1-r1-11', (5, 16), (5, 5))
