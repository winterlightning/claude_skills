...
class Drawing(Sub32):
    icon_id = 'double-arrow-right-state-sub32'
    ...
    def build(self):
        self.add_line('p1-r1-1', (20, 5), (30, 16))
        self.add_line('p1-r1-2', (30, 16), (20, 27))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', closed=False)
        self.add_line('p2-r1-1', (20, 16), (2, 16))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_line('p3-r1-1', (20, 16), (9, 27))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (20, 16), (9, 5))
