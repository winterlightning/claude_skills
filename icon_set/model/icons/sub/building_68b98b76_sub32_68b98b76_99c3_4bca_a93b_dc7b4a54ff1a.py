...
class Drawing(Sub32):
    icon_id = 'building-68b98b76-sub32'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-2', (16, 9), (27, 2))
        self.add_line('p1-r1-3', (27, 2), (27, 30))
        self.add_line('p1-r1-4', (27, 30), (16, 30))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', 'p1-r1-4', closed=False)
        self.add_line('p2-r1-1', (16, 16), (5, 16))
        self.add_line('p2-r1-2', (5, 16), (5, 30))
        self.add_line('p2-r1-3', (5, 30), (16, 30))
