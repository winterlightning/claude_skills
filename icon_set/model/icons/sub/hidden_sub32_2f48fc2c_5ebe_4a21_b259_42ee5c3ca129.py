...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_bezier('p1-r1-1', (2, 16), ((4, 12), (6, 9), (9, 8)))
        self.add_bezier('p1-r1-2', (9, 8), ((12, 6), (13, 5), (16, 5)))
        self.add_bezier('p1-r1-3', (16, 5), ((19, 5), (20, 6), (23, 8)))
        self.add_bezier('p1-r1-4', (23, 8), ((26, 9), (28, 12), (30, 16)))
        self.add_bezier('p1-r1-5', (30, 16), ((28, 20), (26, 23), (23, 24)))
        self.add_bezier('p1-r1-6', (23, 24), ((20, 26), (19, 27), (16, 27)))
        self.add_bezier('p1-r1-7', (16, 27), ((13, 27), (12, 26), (9, 24)))
        self.add_bezier('p1-r1-8', (9, 24), ((6, 23), (4, 20), (2, 16)))
