...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p2-r1-1', (2, 5), (6, 5))
        self.add_line('p2-r1-2', (6, 5), (8, 10))
        self.add_contour('path-2-1', 'p2-r1-1', 'p2-r1-2', closed=False)
        self.add_line('p3-r1-1', (10, 27), (10, 27))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (20, 27), (20, 27))
