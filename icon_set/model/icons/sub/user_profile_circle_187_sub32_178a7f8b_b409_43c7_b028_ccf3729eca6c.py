"""User Account Profile Circle: user-requested grid-fitted 32px version of user-profile-circle-187-solo.
...
SOLO_SOURCE_ICON_ID='user-profile-circle-187-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='user-profile-circle-187-sub32'
    keyshape=Keyshape.CIRCLE
    semantic_role='SUB'
    semantic_kind='modifier'
    category = 'primitives-generate'
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'user account profile circle')
    def build(self):
