...
class Drawing(TextSub32):
    icon_id = 'text-android-package-application-label-23d4a745-sub32'
    ...
    text_ink_bounds = (2.0, 0.0, 66.0001, 20.0)

    def build(self):
        """Source-native uppercase composition for 'APK'; 4-unit letter spacing."""
        ...
        self.add_line('p3-r1-1', (52.017089999999996, 2), (52.017089999999996, 18))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (64.0001, 17.889), (54.1001, 9.42859))
        self.add_contour('path-4-1', 'p4-r1-1', closed=False)
        self.add_line('p5-r1-1', (62.8968, 2.09521), (52, 11.1429))
