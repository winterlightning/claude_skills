...
class Drawing(Sub32):
    icon_id = 'state32-ce80faa0-dd47-4d1a-9ecb-fb349333dde8'
    ...
    def build(self):
        ...
        self.add_bezier('p1-r1-7', (3, 11), ((2.3333333333333335, 11.666666666666666), (2, 12.333333333333334), (2, 13)))
        self.add_bezier('p1-r1-8', (2, 13), ((2, 13.666666666666666), (2.666666666666667, 14.333333333333334), (4, 15)))
        self.add_line('p1-r1-9', (4, 15), (12, 12))
        self.add_line('p1-r1-10', (12, 12), (6, 25))
