...
class Drawing(Sub32):
    ...
    def build(self):
        self.add_line('p1-r1-1', (5, 18), (5, 27))
        self.add_arc('p1-r1-2', (5, 27), (8, 30), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_line('p1-r1-3', (8, 30), (24, 30))
        self.add_arc('p1-r1-4', (24, 30), (27, 27), radius_x=3, radius_y=3, large_arc=False, sweep=False)
        self.add_line('p1-r1-5', (27, 27), (27, 18))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', 'p1-r1-4', 'p1-r1-5', closed=False)
        self.add_line('p2-r1-1', (5, 18), (27, 18))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_line('p3-r1-1', (5, 18), (5, 8))
        self.add_arc('p3-r1-2', (5, 8), (6, 6), radius_x=3, radius_y=3, large_arc=False, sweep=True)
        ...
        self.add_arc('p3-r1-7', (20, 6), (27, 7), radius_x=8, radius_y=8, large_arc=False, sweep=True)
        self.add_line('p3-r1-8', (27, 7), (27, 18))
