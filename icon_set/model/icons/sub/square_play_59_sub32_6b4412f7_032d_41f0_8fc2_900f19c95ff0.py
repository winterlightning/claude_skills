"""Square Media Play Button: user-requested grid-fitted 32px version of square-play-59-solo.
...
SOLO_SOURCE_ICON_ID='square-play-59-solo'
AUTHOR='gpt-6'
class Drawing(Sub32):
    icon_id='square-play-59-sub32'
    keyshape=Keyshape.SQUARE
    semantic_role='SUB'
    semantic_kind='modifier'
    category='objects/interface-essential'
    tags=('sub icon',)
    keywords=('sub icon', 'grid fitted', 'square media play button')
    def build(self):
