...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p1-r1-2', (10, 15), (16, 5))
        self.add_line('p1-r1-3', (16, 5), (22, 15))
        self.add_line('p1-r1-4', (22, 15), (30, 8))
        self.add_line('p1-r1-5', (30, 8), (28, 27))
        self.add_line('p1-r1-6', (28, 27), (4, 27))
        self.add_line('p1-r1-7', (4, 27), (2, 8))
