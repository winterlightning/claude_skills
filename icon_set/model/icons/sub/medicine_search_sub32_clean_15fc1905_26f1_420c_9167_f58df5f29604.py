...
class Drawing(Sub32):
    exception = {'reason': 'User-approved complete reference composition; accept remaining visual/grid/spacing findings while preserving 32x32 and uniform 4px strokes.', 'approved_by': 'user', 'approved_on': '2026-09-24', 'svg_sha256': 'e1b0ff769bbb70b13c5f50192e474e53018e29f3b1b8385fd64a39af9d1d9784'}
    icon_id = 'medicine-search-sub32-clean'
    variant_of = 'medicine-search-sub32'
    variant_label = 'Complete 4px cleanup'
    REPAIR_PLAN = {'concept': 'Medicine Search Magnifying Glass', 'core_parts': ('circular magnifier lens', 'lower-right handle', 'diagonal capsule outline', 'one transverse divider'), 'flexible_parts': 'Coordinates and proportions only; no original elements removed.', 'repair': 'Enlarge the magnifier lens, center the complete inner symbol and use an integer handle joint within the painted circle stroke.'}
