# Variant of puzzle-piece-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    ...
    def build(self):
        # Matched side sockets and a centered top tab, using shared arc radii and a clean continuous outline.
        self.add_arc('tab',(11,8),(21,8),radius_x=5,radius_y=6,sweep=True)
        self.add_line('top-right',(21,8),(30,8));self.add_line('right-upper',(30,8),(30,15))
        self.add_arc('right-socket',(30,15),(30,23),radius_x=5,radius_y=4,sweep=False)
        self.add_line('right-lower',(30,23),(30,30));self.add_line('base',(30,30),(2,30));self.add_line('left-lower',(2,30),(2,23))
        self.add_arc('left-socket',(2,23),(2,15),radius_x=5,radius_y=4,sweep=False)
        self.add_line('left-upper',(2,15),(2,8));self.add_line('top-left',(2,8),(11,8))
