# Variant of hidden-sub32-v2; parent file remains unchanged.
...
class DrawingVariant3(Sub32):
    icon_id = 'hidden-sub32-v3'
    variant_of = 'hidden-sub32-v2'
    ...
    def build(self):
        # Both eye halves derive from mirrored control points; the slash is directional.
        ...
        self.add_line('slash',(8,8),(24,24));self.relate('connect','eye','slash')
