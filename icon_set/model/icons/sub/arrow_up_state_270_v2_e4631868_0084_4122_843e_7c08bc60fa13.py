...
class CompleteReferenceRedraw(Sub32):
    icon_id = 'arrow-up-state-270-v2'
    variant_of = 'arrow-up-state-270'
    ...
    def build(self):
        ...
        self.add_line('arrow-0-0', (16, 22), (16, 10))
        self.add_line('arrow-1-0', (11, 15), (16, 10))
        self.add_line('arrow-1-1', (16, 10), (21, 15))
