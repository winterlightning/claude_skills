...
class CompleteReferenceRedraw(Sub32):
    icon_id = 'arrow-up-right-state-50-v2'
    variant_of = 'arrow-up-right-state-50'
    ...
    def build(self):
        ...
        self.add_line('arrow-0-0', (11, 21), (21, 11))
        self.add_line('arrow-1-0', (14, 11), (21, 11))
        self.add_line('arrow-1-1', (21, 11), (21, 18))
