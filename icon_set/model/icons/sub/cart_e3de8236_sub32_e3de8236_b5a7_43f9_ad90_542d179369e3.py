...
class Drawing(Sub32):
    ...
    def build(self):
        ...
        self.add_line('p1-r1-4', (30, 13), (26, 24))
        self.add_bezier('p1-r1-5', (26, 24), ((26, 27), (24, 27), (23, 27)))
        self.add_line('p1-r1-6', (23, 27), (9, 27))
        self.add_bezier('p1-r1-7', (9, 27), ((8, 27), (6, 27), (6, 24)))
        self.add_line('p1-r1-8', (6, 24), (2, 13))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', 'p1-r1-4', 'p1-r1-5', 'p1-r1-6', 'p1-r1-7', 'p1-r1-8', closed=False)
        self.add_arc('p2-r1-1', (8, 13), (24, 13), radius_x=8, radius_y=8, large_arc=False, sweep=True)
