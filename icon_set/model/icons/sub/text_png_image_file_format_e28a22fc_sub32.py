...
class Drawing(TextSub32):
    icon_id = 'text-png-image-file-format-e28a22fc-sub32'
    ...
    text_ink_bounds = (2.28564, 0.0, 68.00000000000009, 20.0)

    def build(self):
        """Source-native uppercase composition for 'PNG'; 4-unit letter spacing."""
        ...
        self.add_line('p2-r1-1', (27, 18), (27, 2.21987))
        self.add_bezier('p2-r1-2', (27, 2.21987), ((27, 1.97187), (27.77876, 1.91394), (27.95982, 2.14847)))
        self.add_line('p2-r1-3', (27.95982, 2.14847), (40.0402, 17.7968))
        self.add_bezier('p2-r1-4', (40.0402, 17.7968), ((40.221199999999996, 18.0313), (41, 17.9734), (41, 17.7254)))
        self.add_line('p2-r1-5', (41, 17.7254), (41, 2.02527))
