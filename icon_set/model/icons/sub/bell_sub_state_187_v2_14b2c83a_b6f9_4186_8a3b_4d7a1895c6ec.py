...
class CompleteReferenceRedraw(Sub32):
    ...
    def build(self):
        ...
        self.add_bezier('bell-0-1', (6, 12), ((6.0, 7.0), (9.0, 5.0), (12, 5)))
        self.add_line('bell-0-2', (12, 5), (12, 2))
        self.add_line('bell-0-3', (12, 2), (20, 2))
        self.add_line('bell-0-4', (20, 2), (20, 5))
        self.add_bezier('bell-0-5', (20, 5), ((23.0, 5.0), (26.0, 7.0), (26, 12)))
        self.add_bezier('bell-0-6', (26, 12), ((26.0, 17.0), (26.0, 18.0), (30, 22)))
        self.add_line('bell-0-7', (30, 22), (2, 22))
        self.add_contour('bell-0', 'bell-0-0', 'bell-0-1', 'bell-0-2', 'bell-0-3', 'bell-0-4', 'bell-0-5', 'bell-0-6', 'bell-0-7', closed=True)
