# Variant of gift-box-container-v6; parent file remains unchanged.
...
class GiftBoxContainerVariant7(Container64):
    icon_id = 'gift-box-container-v7'
    variant_of = 'gift-box-container-v6'
    variant_label = 'Thin plain lid with more interior space'
