...
class SquareArtboardWithCornerIndicatorsVariant2(Container64):
    icon_id = 'square-artboard-with-corner-indicators-v2'
    variant_of = 'square-artboard-with-corner-indicators'
