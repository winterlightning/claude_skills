# Variant of smartphone-with-store-awning-v2; parent file remains unchanged.
...
class SmartphoneWithStoreAwningVariant3(Container64):
    icon_id = 'smartphone-with-store-awning-v3'
    variant_of = 'smartphone-with-store-awning-v2'
    variant_label = 'Wider screen and open awning panels'
