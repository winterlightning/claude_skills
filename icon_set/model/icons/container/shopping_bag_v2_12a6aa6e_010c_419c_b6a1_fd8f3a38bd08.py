# Variant of shopping-bag; parent file remains unchanged.
...
class ShoppingBagVariant2(Container64):
    icon_id = 'shopping-bag-v2'
    variant_of = 'shopping-bag'
    variant_label = 'Handle above bag'
