# Variant of teardrop-location-pin; parent file remains unchanged.
...
class TeardropLocationPinVariant2(Container64):
    icon_id = 'teardrop-location-pin-v2'
    variant_of = 'teardrop-location-pin'
