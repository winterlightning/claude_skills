...
Fresh AVATAR48 construction on VRECT_L: visible bounds (6,0)-(42,48).
Head center (24,10), radius 8; shoulder top is derived from the shared gap.
...
class UserAvatar(Avatar48):
    ...
    def build(self) -> None:
        ...
        shoulder_radius = 12
        self.add_line("left-side", (8,46), (8,top+shoulder_radius))
        ...
        self.add_line("right-side", (40,top+shoulder_radius), (40,46))
