...
class FireFighterWomanAvatar(Avatar48):
    ...
    def build(self):
        cx = 24
        self.add_arc('helmet-left',(8,14),(cx,2),radius_x=16,radius_y=12)
        self.add_arc('helmet-right',(cx,2),(40,14),radius_x=16,radius_y=12)
        ...
        # The broad helmet brim carries identity without a crowded crown ridge.
        self.add_arc('face',(34,14),(14,14),radius_x=10,radius_y=10)
        self.relate('connect','face','brim')
        for side, sign in [('left',-1),('right',1)]:
            self.add_bezier('hair-'+side,(cx+sign*10,14),((cx+sign*10,18),(cx+sign*13,22),(cx+sign*15,24)))
