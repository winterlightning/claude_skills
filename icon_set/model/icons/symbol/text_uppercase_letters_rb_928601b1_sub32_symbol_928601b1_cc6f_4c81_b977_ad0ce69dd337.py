...
class DrawingContainerSymbol(TextSub32):
    icon_id = 'text-uppercase-letters-rb-928601b1-sub32-symbol'
    related_origin_icon_id = 'text-uppercase-letters-rb-928601b1-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-uppercase-letters-rb-928601b1-sub32'
    counterpart_icon_id = 'text-uppercase-letters-rb-928601b1-sub32'
