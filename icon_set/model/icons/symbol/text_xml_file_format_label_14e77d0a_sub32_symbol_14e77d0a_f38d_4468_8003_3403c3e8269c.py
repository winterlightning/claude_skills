...
class DrawingContainerSymbol(TextSub32):
    icon_id = 'text-xml-file-format-label-14e77d0a-sub32-symbol'
    related_origin_icon_id = 'text-xml-file-format-label-14e77d0a-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-xml-file-format-label-14e77d0a-sub32'
    counterpart_icon_id = 'text-xml-file-format-label-14e77d0a-sub32'
