...
class DrawingVariant2ContainerSymbol(Sub32):
    icon_id = 'menu-state-sub32-v2-symbol'
    related_origin_icon_id = 'menu-state-sub32-v2'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/menu-state-sub32-v2'
    counterpart_icon_id = 'menu-state-sub32-v2'
