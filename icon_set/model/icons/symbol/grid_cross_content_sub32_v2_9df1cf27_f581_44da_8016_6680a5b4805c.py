...
class DrawingVariant2(Sub32):
    icon_id = 'grid-cross-content-sub32-v2'
    related_origin_icon_id = 'grid-cross-content-sub32'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-1', (2, short_low), (2, short_low))
        self.add_contour('path-1-1', 'p1-r1-1', closed=False)
        self.add_line('p2-r1-1', (2, 16), (2, 16))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_line('p3-r1-1', (2, short_high), (2, short_high))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (13, short_low), (13, short_low))
        self.add_contour('path-4-1', 'p4-r1-1', closed=False)
        self.add_line('p5-r1-1', (13, 16), (13, 16))
        self.add_contour('path-5-1', 'p5-r1-1', closed=False)
        self.add_line('p6-r1-1', (13, short_high), (13, short_high))
