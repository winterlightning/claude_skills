...
class DrawingContainerSymbol(Sub32):
    icon_id = 'beamed-eighth-notes-level-sub32-symbol'
    related_origin_icon_id = 'beamed-eighth-notes-level-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/beamed-eighth-notes-level-sub32'
    counterpart_icon_id = 'beamed-eighth-notes-level-sub32'
