...
class DrawingContainerSymbol(Sub32):
    icon_id = 'archery-target-on-feet-sub32-symbol'
    related_origin_icon_id = 'archery-target-on-feet-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/archery-target-on-feet-sub32'
    counterpart_icon_id = 'archery-target-on-feet-sub32'
