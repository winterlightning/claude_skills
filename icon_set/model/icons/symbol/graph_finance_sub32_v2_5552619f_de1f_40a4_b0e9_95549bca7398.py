...
class DrawingVariant2(Sub32):
    icon_id = 'graph-finance-sub32-v2'
    related_origin_icon_id = 'graph-finance-sub32'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-1', (2, short_high), (6, short_high))
        self.add_line('p1-r1-2', (6, short_high), (16, short_high))
        self.add_line('p1-r1-3', (16, short_high), (26, short_high))
        self.add_line('p1-r1-4', (26, short_high), (30, short_high))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', 'p1-r1-4', closed=False)
        self.add_line('p2-r1-1', (6, short_low), (6, short_high))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_line('p3-r1-1', (16, 11), (16, short_high))
        self.add_contour('path-3-1', 'p3-r1-1', closed=False)
        self.add_line('p4-r1-1', (26, 15), (26, short_high))
