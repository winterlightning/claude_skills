...
class DrawingContainerSymbol(Sub32):
    icon_id = 'synchronize-refresh-arrow-a0553293-sub32-symbol'
    related_origin_icon_id = 'synchronize-refresh-arrow-a0553293-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/synchronize-refresh-arrow-a0553293-sub32'
    counterpart_icon_id = 'synchronize-refresh-arrow-a0553293-sub32'
