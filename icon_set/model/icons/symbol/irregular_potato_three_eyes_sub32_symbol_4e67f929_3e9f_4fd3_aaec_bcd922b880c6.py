...
class DrawingContainerSymbol(Sub32):
    icon_id = 'irregular-potato-three-eyes-sub32-symbol'
    related_origin_icon_id = 'irregular-potato-three-eyes-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/irregular-potato-three-eyes-sub32'
    counterpart_icon_id = 'irregular-potato-three-eyes-sub32'
