...
class DrawingContainerSymbol(Sub32):
    icon_id = 'tulip-with-curved-leaves-sub32-symbol'
    related_origin_icon_id = 'tulip-with-curved-leaves-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/tulip-with-curved-leaves-sub32'
    counterpart_icon_id = 'tulip-with-curved-leaves-sub32'
