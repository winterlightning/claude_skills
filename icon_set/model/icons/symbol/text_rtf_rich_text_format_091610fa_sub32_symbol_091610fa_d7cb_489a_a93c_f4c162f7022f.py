...
class DrawingContainerSymbol(TextSub32):
    icon_id = 'text-rtf-rich-text-format-091610fa-sub32-symbol'
    related_origin_icon_id = 'text-rtf-rich-text-format-091610fa-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-rtf-rich-text-format-091610fa-sub32'
    counterpart_icon_id = 'text-rtf-rich-text-format-091610fa-sub32'
