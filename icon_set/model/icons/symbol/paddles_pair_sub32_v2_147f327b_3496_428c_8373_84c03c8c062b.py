...
class DrawingVariant2(Sub32):
    icon_id = 'paddles-pair-sub32-v2'
    related_origin_icon_id = 'paddles-pair-sub32'
    ...
    def build(self):
        ...
        self.add_arc('p1-r1-1', (7, short_low), (7, 20), radius_x=5, radius_y=8, large_arc=False, sweep=True)
        self.add_arc('p1-r1-2', (7, 20), (7, short_low), radius_x=5, radius_y=8, large_arc=False, sweep=True)
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', closed=False)
        self.add_line('p2-r1-1', (7, 20), (7, short_high))
        self.add_contour('path-2-1', 'p2-r1-1', closed=False)
        self.add_arc('p3-r1-1', (25, short_low), (25, 20), radius_x=5, radius_y=8, large_arc=False, sweep=True)
        self.add_arc('p3-r1-2', (25, 20), (25, short_low), radius_x=5, radius_y=8, large_arc=False, sweep=True)
        self.add_contour('path-3-1', 'p3-r1-1', 'p3-r1-2', closed=False)
        self.add_line('p4-r1-1', (25, 20), (25, short_high))
