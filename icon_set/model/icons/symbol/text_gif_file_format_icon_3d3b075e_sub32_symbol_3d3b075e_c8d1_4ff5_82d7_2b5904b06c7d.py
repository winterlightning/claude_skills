...
class DrawingContainerSymbol(TextSub32):
    icon_id = 'text-gif-file-format-icon-3d3b075e-sub32-symbol'
    related_origin_icon_id = 'text-gif-file-format-icon-3d3b075e-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-gif-file-format-icon-3d3b075e-sub32'
    counterpart_icon_id = 'text-gif-file-format-icon-3d3b075e-sub32'
