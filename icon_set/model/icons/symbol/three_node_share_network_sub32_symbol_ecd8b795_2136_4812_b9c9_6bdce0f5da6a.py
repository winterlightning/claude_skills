...
class DrawingContainerSymbol(Sub32):
    icon_id = 'three-node-share-network-sub32-symbol'
    related_origin_icon_id = 'three-node-share-network-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/three-node-share-network-sub32'
    counterpart_icon_id = 'three-node-share-network-sub32'
