...
class DrawingVariant2(Sub32):
    icon_id = 'bikini-sub32-v2'
    related_origin_icon_id = 'bikini-sub32'
    ...
    def build(self):
        ...
        self.add_bezier('p1-r1-2', (13, 22), ((13, 26), (11, short_high), (8, short_high)))
        self.add_bezier('p1-r1-3', (8, short_high), ((4, short_high), (2, 26), (2, 22)))
        self.add_bezier('p1-r1-4', (2, 22), ((2, 18), (4, 15), (6, 13)))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', 'p1-r1-4', closed=False)
        self.add_line('p2-r1-1', (6, 13), (16, short_low))
        self.add_line('p2-r1-2', (16, short_low), (20, short_low))
        self.add_contour('path-2-1', 'p2-r1-1', 'p2-r1-2', closed=False)
        self.add_bezier('p3-r1-1', (26, 13), ((22, 16), (19, 18), (19, 22)))
        self.add_bezier('p3-r1-2', (19, 22), ((19, 26), (21, short_high), (24, short_high)))
        self.add_bezier('p3-r1-3', (24, short_high), ((28, short_high), (30, 26), (30, 22)))
        self.add_bezier('p3-r1-4', (30, 22), ((30, 18), (28, 15), (26, 13)))
        self.add_contour('path-3-1', 'p3-r1-1', 'p3-r1-2', 'p3-r1-3', 'p3-r1-4', closed=False)
        self.add_line('p4-r1-1', (26, 13), (16, short_low))
        self.add_line('p4-r1-2', (16, short_low), (12, short_low))
