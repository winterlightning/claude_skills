...
class DrawingContainerSymbol(Sub32):
    icon_id = 'exclamation-point-warning-triangle-solo-v2-sub32-symbol'
    related_origin_icon_id = 'exclamation-point-warning-triangle-solo-v2-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/exclamation-point-warning-triangle-solo-v2-sub32'
    counterpart_icon_id = 'exclamation-point-warning-triangle-solo-v2-sub32'
