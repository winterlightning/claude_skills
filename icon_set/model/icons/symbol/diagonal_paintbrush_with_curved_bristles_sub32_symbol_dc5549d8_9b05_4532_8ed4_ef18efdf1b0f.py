...
class DrawingContainerSymbol(Sub32):
    icon_id = 'diagonal-paintbrush-with-curved-bristles-sub32-symbol'
    related_origin_icon_id = 'diagonal-paintbrush-with-curved-bristles-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/diagonal-paintbrush-with-curved-bristles-sub32'
    counterpart_icon_id = 'diagonal-paintbrush-with-curved-bristles-sub32'
