...
class DrawingContainerSymbol(Sub32):
    icon_id = 'vr-headset-video-games-sub32-symbol'
    related_origin_icon_id = 'vr-headset-video-games-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/vr-headset-video-games-sub32'
    counterpart_icon_id = 'vr-headset-video-games-sub32'
