...
class DrawingContainerSymbol(Sub32):
    icon_id = 'single-tail-award-badge-sub32-symbol'
    related_origin_icon_id = 'single-tail-award-badge-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/single-tail-award-badge-sub32'
    counterpart_icon_id = 'single-tail-award-badge-sub32'
