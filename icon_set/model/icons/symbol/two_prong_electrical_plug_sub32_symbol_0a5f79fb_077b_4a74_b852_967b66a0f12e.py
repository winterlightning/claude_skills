...
class DrawingContainerSymbol(Sub32):
    icon_id = 'two-prong-electrical-plug-sub32-symbol'
    related_origin_icon_id = 'two-prong-electrical-plug-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/two-prong-electrical-plug-sub32'
    counterpart_icon_id = 'two-prong-electrical-plug-sub32'
