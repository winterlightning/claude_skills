...
class DrawingContainerSymbol(Sub32):
    icon_id = 'medical-health-protection-shield-sub32-symbol'
    related_origin_icon_id = 'medical-health-protection-shield-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/medical-health-protection-shield-sub32'
    counterpart_icon_id = 'medical-health-protection-shield-sub32'
