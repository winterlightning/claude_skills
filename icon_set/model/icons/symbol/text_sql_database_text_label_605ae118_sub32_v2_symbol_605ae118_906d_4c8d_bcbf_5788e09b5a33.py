...
class DrawingVariant2ContainerSymbol(TextSub32):
    icon_id = 'text-sql-database-text-label-605ae118-sub32-v2-symbol'
    related_origin_icon_id = 'text-sql-database-text-label-605ae118-sub32-v2'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-sql-database-text-label-605ae118-sub32-v2'
    counterpart_icon_id = 'text-sql-database-text-label-605ae118-sub32-v2'
