...
class DrawingVariant2(Sub32):
    icon_id = 'opposite-arrows-1-sub32-v2'
    related_origin_icon_id = 'opposite-arrows-1-sub32'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-1', (24, short_low), (30, 10))
        self.add_line('p1-r1-2', (30, 10), (3, 10))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', closed=False)
        self.add_line('p2-r1-1', (8, short_high), (2, 22))
