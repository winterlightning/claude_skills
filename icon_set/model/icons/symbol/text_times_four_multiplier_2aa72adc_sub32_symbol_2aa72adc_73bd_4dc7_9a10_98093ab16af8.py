...
class DrawingContainerSymbol(TextSub32):
    icon_id = 'text-times-four-multiplier-2aa72adc-sub32-symbol'
    related_origin_icon_id = 'text-times-four-multiplier-2aa72adc-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-times-four-multiplier-2aa72adc-sub32'
    counterpart_icon_id = 'text-times-four-multiplier-2aa72adc-sub32'
