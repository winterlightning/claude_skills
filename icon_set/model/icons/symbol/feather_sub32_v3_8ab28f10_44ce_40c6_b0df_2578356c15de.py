...
class DrawingVariant3(Sub32):
    ...
    related_origin_icon_id = 'feather-sub32-v2'
    ...
    def build(self):
        ...
        self.add_line('quill', (2, 30), (22, 10))
        self.relate('connect', 'quill', 'vane')
        self.add_line('barb', (16, 16), (28, 16))
        self.relate('connect', 'barb', 'quill')
        self.relate('connect', 'barb', 'vane')
