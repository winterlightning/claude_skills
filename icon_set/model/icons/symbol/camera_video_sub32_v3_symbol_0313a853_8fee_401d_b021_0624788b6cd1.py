...
class DrawingVariant3ContainerSymbol(Sub32):
    icon_id = 'camera-video-sub32-v3-symbol'
    related_origin_icon_id = 'camera-video-sub32-v3'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/camera-video-sub32-v3'
    counterpart_icon_id = 'camera-video-sub32-v3'
