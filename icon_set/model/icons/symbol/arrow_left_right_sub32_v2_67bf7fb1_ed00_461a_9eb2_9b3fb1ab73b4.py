...
class DrawingVariant2(Sub32):
    icon_id = 'arrow-left-right-sub32-v2'
    related_origin_icon_id = 'arrow-left-right-sub32'
    ...
    def build(self):
        ...
        self.add_line('p2-r1-1', (19, short_low), (30, 16))
        self.add_line('p2-r1-2', (30, 16), (19, short_high))
