...
class CircularArrowSubContainerSymbol(Sub32):
    icon_id = 'circular-arrow-sub-symbol'
    related_origin_icon_id = 'circular-arrow-sub'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/circular-arrow-sub'
    counterpart_icon_id = 'circular-arrow-sub'
