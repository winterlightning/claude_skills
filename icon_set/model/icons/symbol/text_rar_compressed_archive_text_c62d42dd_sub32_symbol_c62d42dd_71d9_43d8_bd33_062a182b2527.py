...
class DrawingContainerSymbol(TextSub32):
    icon_id = 'text-rar-compressed-archive-text-c62d42dd-sub32-symbol'
    related_origin_icon_id = 'text-rar-compressed-archive-text-c62d42dd-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-rar-compressed-archive-text-c62d42dd-sub32'
    counterpart_icon_id = 'text-rar-compressed-archive-text-c62d42dd-sub32'
