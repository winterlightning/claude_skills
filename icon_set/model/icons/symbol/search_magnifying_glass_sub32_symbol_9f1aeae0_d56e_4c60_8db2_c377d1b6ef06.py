...
class DrawingContainerSymbol(Sub32):
    icon_id = 'search-magnifying-glass-sub32-symbol'
    related_origin_icon_id = 'search-magnifying-glass-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/search-magnifying-glass-sub32'
    counterpart_icon_id = 'search-magnifying-glass-sub32'
