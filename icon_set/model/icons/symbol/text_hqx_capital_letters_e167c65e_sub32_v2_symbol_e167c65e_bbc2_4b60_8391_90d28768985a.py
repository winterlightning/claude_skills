...
class DrawingVariant2ContainerSymbol(TextSub32):
    icon_id = 'text-hqx-capital-letters-e167c65e-sub32-v2-symbol'
    related_origin_icon_id = 'text-hqx-capital-letters-e167c65e-sub32-v2'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-hqx-capital-letters-e167c65e-sub32-v2'
    counterpart_icon_id = 'text-hqx-capital-letters-e167c65e-sub32-v2'
