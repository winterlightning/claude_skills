...
class DrawingVariant2(Sub32):
    icon_id = 'arrow-left-1-sub32-v2'
    related_origin_icon_id = 'arrow-left-1-sub32'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-1', (short_high, 2), (short_low, 16))
        self.add_line('p1-r1-2', (short_low, 16), (short_high, 30))
