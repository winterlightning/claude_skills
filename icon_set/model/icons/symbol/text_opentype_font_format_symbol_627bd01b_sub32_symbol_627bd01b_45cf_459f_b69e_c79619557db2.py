...
class DrawingContainerSymbol(TextSub32):
    icon_id = 'text-opentype-font-format-symbol-627bd01b-sub32-symbol'
    related_origin_icon_id = 'text-opentype-font-format-symbol-627bd01b-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-opentype-font-format-symbol-627bd01b-sub32'
    counterpart_icon_id = 'text-opentype-font-format-symbol-627bd01b-sub32'
