...
class DrawingContainerSymbol(Sub32):
    icon_id = 'star-b255daf0-sub32-symbol'
    related_origin_icon_id = 'star-b255daf0-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/star-b255daf0-sub32'
    counterpart_icon_id = 'star-b255daf0-sub32'
    keyshape = Keyshape.SQUARE
    semantic_role = 'SUB'
    semantic_kind = 'modifier'
    category = 'holidays'
    categories = ('holidays', 'state', 'other', 'primitives-generate')
