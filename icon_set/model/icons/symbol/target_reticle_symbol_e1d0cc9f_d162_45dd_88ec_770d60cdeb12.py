...
class TargetReticleContainerSymbol(Sub32):
    icon_id = 'target-reticle-symbol'
    related_origin_icon_id = 'target-reticle'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/target-reticle'
    counterpart_icon_id = 'target-reticle'
