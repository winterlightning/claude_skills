...
class DrawingVariant2(Sub32):
    icon_id = 'cursor-sub32-v2'
    related_origin_icon_id = 'cursor-sub32'
    ...
    def build(self):
        ...
        self.add_line('p1-r1-1', (short_high, 14), (short_low, 2))
        self.add_line('p1-r1-2', (short_low, 2), (7, 30))
        self.add_line('p1-r1-3', (7, 30), (14, 17))
        self.add_contour('path-1-1', 'p1-r1-1', 'p1-r1-2', 'p1-r1-3', closed=False)
        self.add_line('p2-r1-1', (14, 17), (short_high, 14))
