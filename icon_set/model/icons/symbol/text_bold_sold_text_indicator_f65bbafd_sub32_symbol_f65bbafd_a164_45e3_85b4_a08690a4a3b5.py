...
class DrawingContainerSymbol(TextSub32):
    icon_id = 'text-bold-sold-text-indicator-f65bbafd-sub32-symbol'
    related_origin_icon_id = 'text-bold-sold-text-indicator-f65bbafd-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/text-bold-sold-text-indicator-f65bbafd-sub32'
    counterpart_icon_id = 'text-bold-sold-text-indicator-f65bbafd-sub32'
