...
class DrawingContainerSymbol(Sub32):
    icon_id = 'thai-baht-currency-symbol-sub32-symbol'
    related_origin_icon_id = 'thai-baht-currency-symbol-sub32'
    variant_label = 'Independent container symbol'
    usage_category = 'symbol'
    related_group = 'sub-origin/thai-baht-currency-symbol-sub32'
    counterpart_icon_id = 'thai-baht-currency-symbol-sub32'
