...
class GasSymbol(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e4', (32, 13), (39, 15), radius_x=7)
        self.add_line('sym-e5', (39, 15), (40, 18))
        self.add_line('sym-e6', (40, 18), (40, 39))
        self.add_arc('sym-e8', (40, 39), (34, 44), radius_x=7)
        self.add_line('sym-e11', (34, 44), (24, 44))
        self.add_line('sym-e12', (24, 44), (14, 44))
        self.add_arc('sym-e15', (14, 44), (8, 39), radius_x=7)
        self.add_line('sym-e17', (8, 39), (8, 18))
        self.add_arc('sym-e18', (8, 18), (9, 15), radius_x=5)
        self.add_arc('sym-e19', (9, 15), (16, 13), radius_x=7)
        self.add_line('sym-e20', (16, 13), (16, 4))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2')
        self.add_contour('sym-c1', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e8', 'sym-e11', 'sym-e12', 'sym-e15', 'sym-e17', 'sym-e18', 'sym-e19', 'sym-e20')
