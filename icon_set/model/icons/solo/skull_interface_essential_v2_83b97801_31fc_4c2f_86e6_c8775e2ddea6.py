...
class SkullInterfaceEssentialVariant2(Solo48):
    icon_id = 'skull-interface-essential-v2'
    variant_of = 'skull-interface-essential'
    ...
    def build(self):
        ...
        ellipse(self,'eye-left',16,23,3);ellipse(self,'eye-right',32,23,3)
