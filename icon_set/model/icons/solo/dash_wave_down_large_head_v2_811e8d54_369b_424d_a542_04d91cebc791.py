...
class DashWaveDownLargeHeadVariant2(Solo48):
    icon_id = 'dash-wave-down-large-head-v2'
    variant_of = 'dash-wave-down-large-head'
    ...
    def build(self):
        runs = [{'start': (6, 6), 'steps': [('A', 12, 12, 6, 6, True), ('L', 12, 35), ('A', 26, 35, 7, 7, False), ('L', 26, 12), ('A', 38, 12, 6, 6, True), ('L', 38, 26)], 'closed': False}, {'start': (34, 22), 'steps': [('L', 38, 26), ('L', 42, 22)], 'closed': False}]
        rotation = 0
