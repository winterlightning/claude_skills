...
SOURCE_ICON_ID = '318acbec-ff5c-4622-87d9-7ff058616421'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_14/den_318acbec-ff5c-4622-87d9-7ff058616421.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'gabled-house-with-plain-doorway'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'primitives-generate'
    aliases = ()
    keywords = ('house', 'home', 'roof', 'door', 'building', 'architecture', 'facade')
