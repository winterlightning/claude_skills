...
class CursorTarget(Solo48):
    ...
    def build(self):
        self.add_line('sym-e0', (24, 31), (24, 42))
        self.add_line('sym-e2', (24, 17), (24, 6))
        self.add_line('sym-e4', (17, 24), (6, 24))
        self.add_arc('sym-e5', (24, 12), (17, 14), radius_x=12, radius_y=12, large_arc=False, sweep=False)
        self.add_arc('sym-e6', (17, 14), (12, 24), radius_x=13, radius_y=13, large_arc=False, sweep=False)
        self.add_line('sym-e7', (12, 24), (12, 26))
        self.add_arc('sym-e8', (12, 26), (24, 36), radius_x=12, radius_y=12, large_arc=False, sweep=False)
        self.add_arc('sym-e9', (24, 36), (36, 26), radius_x=12, radius_y=12, large_arc=False, sweep=False)
        self.add_line('sym-e10', (36, 26), (36, 24))
        self.add_arc('sym-e11', (36, 24), (31, 14), radius_x=13, radius_y=13, large_arc=False, sweep=False)
        self.add_arc('sym-e12', (31, 14), (24, 12), radius_x=12, radius_y=12, large_arc=False, sweep=False)
