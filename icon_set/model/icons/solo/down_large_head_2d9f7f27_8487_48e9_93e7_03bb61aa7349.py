...
SOURCE_PATH = 'pictographic-primitives/arrows/down large head_2d9f7f27-8487-48e9-93e7-03bb61aa7349.svg'
AUTHOR = 'gpt-6'
...
class DownLargeHead(Solo48):
    ...
    def build(self):
        runs = [{'start': (6, 6), 'steps': [('A', 34, 34, 28, 28, False), ('L', 42, 34)], 'closed': False}, {'start': (34, 26), 'steps': [('L', 42, 34), ('L', 34, 42)], 'closed': False}]
        rotation = 0
