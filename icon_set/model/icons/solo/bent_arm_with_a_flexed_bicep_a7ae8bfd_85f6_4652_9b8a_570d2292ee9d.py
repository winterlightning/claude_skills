...
SOURCE_ICON_ID = 'a7ae8bfd-85f6-4652-9b8a-570d2292ee9d'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_04/arm_a7ae8bfd-85f6-4652-9b8a-570d2292ee9d.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'bent-arm-with-a-flexed-bicep'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'objects'
    aliases = ()
    keywords = ('bicep', 'arm', 'flexed', 'muscle', 'fist', 'strength', 'body')
