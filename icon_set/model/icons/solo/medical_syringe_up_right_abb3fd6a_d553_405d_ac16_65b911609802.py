...
SOURCE_ICON_ID = 'abb3fd6a-d553-405d-ac16-65b911609802'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/other/syringe_abb3fd6a-d553-405d-ac16-65b911609802.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'medical-syringe-up-right'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'objects'
    aliases = ()
    keywords = ('medical', 'syringe', 'up', 'right')
