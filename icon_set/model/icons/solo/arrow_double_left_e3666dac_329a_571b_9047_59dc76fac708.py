...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow double left_e3666dac-329a-571b-9047-59dc76fac708.svg'
AUTHOR = 'gpt-6'

class ArrowDoubleLeft(Solo48):
    icon_id = 'arrow-double-left'
    ...
    def build(self):
        runs = [{'start': (20, 8), 'steps': [('L', 4, 24), ('L', 20, 40)], 'closed': False}, {'start': (44, 8), 'steps': [('L', 28, 24), ('L', 44, 40)], 'closed': False}]
        rotation = 0
