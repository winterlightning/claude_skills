"""Graph (arrows), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class GraphVariant2(Solo48):
    ...
    def build(self):
        runs = [{'start': (36, 8), 'steps': [('L', 44, 8), ('L', 25, 31), ('L', 18, 23), ('L', 4, 40)], 'closed': False}, {'start': (44, 8), 'steps': [('L', 44, 16)], 'closed': False}]
        rotation = 0
