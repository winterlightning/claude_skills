"""Comfortable Upholstered Lounge Armchair.

Lounge armchair with outward swept arms, gently curved seat and slanted legs. Centerline extremes (6,6)-(42,42). Lucide armchair informs the arm caps and shared frame; mirror all contours. Omit doubled cushion piping.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'db2734e5-4a3a-5d28-8bc1-860b04a1d6e0'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/furnitures/armchair_db2734e5-4a3a-5d28-8bc1-860b04a1d6e0.svg'
AUTHOR = 'gpt-6'

class LoungeArmchairCurvedSeat(Solo48):
    icon_id = 'lounge-armchair-curved-seat'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'furnitures'
    aliases = ()
    keywords = ('comfortable', 'upholstered', 'lounge', 'armchair')

    def build(self):
        # Symbol plan: Lounge armchair with outward swept arms, gently curved seat and slanted legs. Centerline extremes (6,6)-(42,42). Lucide armchair informs the arm caps and shared frame; mirror all contours. Omit doubled cushion piping.
        ...
        back_radius=4;arm_y=22;seat_y=28;bottom=36;inner=16 if True else 14;other=48-inner
        ...
        if True:path('seat',(inner,seat_y),[('C',(other,seat_y),(18,seat_y-2),(30,seat_y-2))])
