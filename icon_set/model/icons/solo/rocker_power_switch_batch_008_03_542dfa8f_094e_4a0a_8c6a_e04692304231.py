"""Rocker Power Switch.
Plan: Angled rocker upper face and hinge retained.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/rocker switch_542dfa8f-094e-4a0a-8c6a-e04692304231.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '542dfa8f-094e-4a0a-8c6a-e04692304231'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/rocker switch_542dfa8f-094e-4a0a-8c6a-e04692304231.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'rocker-power-switch-batch-008-03'
    ...
    def build(self):
        ...
        rect('plate',6,6,36,36,3)
        path('rocker',(17,15),(33,15),(29,25),(29,33),(15,33),(15,25),closed=True)
        line('hinge',(15,25),(29,25))
