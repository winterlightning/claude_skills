...
class SpoutingWhale(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('fluke-3', (40, 15), (42, 7))
        self.add_line('fluke-4', (42, 7), (42, 26))
        self.add_arc("rump",(42,26),(34,42),radius_x=12,radius_y=16)
        ...
        self.add_arc("spray-left",(6,6),(14,10),radius_x=8)
        self.add_arc("spray-right",(14,10),(22,6),radius_x=8)
