# Variant of open-laptop; parent file remains unchanged.
'open-laptop: Repositioned the outer contours to the exact keyshape width while retaining the defining details. Keyshape HRECT_L; SOLO48 stroke 4. Reviewed at 48 px in both themes.'
...
class OpenLaptopVariant2(Solo48):
    icon_id = 'open-laptop-v2'
    variant_of = 'open-laptop'
    ...
    def build(self) -> None:
        ...
        self.add_line('base-right', (42, 30), (44, 40))
        self.add_line('base-bottom', (44, 40), (4, 40))
        self.add_line('base-left', (4, 40), (6, 30))
        self.add_line('screen-left', (6, 30), (6, 12))
        self.add_arc('upper-left', (6, 12), (10, 8), radius_x=4)
        self.add_contour('outline', 'top', 'upper-right', 'screen-right', 'base-right', 'base-bottom', 'base-left', 'screen-left', 'upper-left', closed=True)
