...
class Crab(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('left-claw', (6, 6), (12, 16), radius_x=6, radius_y=14, sweep=True, large_arc=False)
        ...
        self.add_arc('right-claw', (42, 6), (36, 16), radius_x=6, radius_y=14, sweep=False, large_arc=False)
