"""The lowercase letter x, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 6, top 6, right 42, bottom 42.
Plan: Two diagonals meet at a shared center; both axes are symmetric.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/X.svg'
AUTHOR = 'gpt-6'


class LetterX(Solo48):
    icon_id = 'letter-x'
    ...
    typeface = {'character': 'x', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('x', "typeface", "typography", 'lowercase')

    def build(self):
        rotation = 0
        mirror = False
        center=(24,24)
        runs=[((6,6), [('L',*center),('L',42,42)],False), ((42,6), [('L',*center),('L',6,42)],False)]
