...
class FastUpLargeHeadVariant2(Solo48):
    icon_id = 'fast-up-large-head-v2'
    variant_of = 'fast-up-large-head'
    ...
    def build(self):
        runs = [{'start': (6, 42), 'steps': [('A', 34, 14, 28, 28, False), ('L', 34, 6)], 'closed': False}, {'start': (26, 14), 'steps': [('L', 34, 6), ('L', 42, 14)], 'closed': False}]
        rotation = 0
