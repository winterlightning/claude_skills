...
SOURCE_ICON_ID = 'e03556f1-1273-4786-bfb6-ecf9e361dbb5'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/resize expand corner 1_e03556f1-1273-4786-bfb6-ecf9e361dbb5.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-005/references/resize expand corner 1_e03556f1-1273-4786-bfb6-ecf9e361dbb5.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'expand-corner-arrow-solo-b005-15'
    ...
    aliases = ()
    keywords = ('expand', 'corner', 'arrow')

    def build(self):
        s = self
        box(s,'frame',6,6,42,42,3)
        arrow(s,'expand',(16,32),(32,16),9)
