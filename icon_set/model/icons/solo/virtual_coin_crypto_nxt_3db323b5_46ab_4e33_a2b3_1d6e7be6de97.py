...
SOURCE_PATH = 'pictographic-primitives/money/virtual coin crypto nxt_3db323b5-46ab-4e33-a2b3-1d6e7be6de97.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class VirtualCoinCryptoNxt(Solo48):
    icon_id = 'virtual-coin-crypto-nxt'
