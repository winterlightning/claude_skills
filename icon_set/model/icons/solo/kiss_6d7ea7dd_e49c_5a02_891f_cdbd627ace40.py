...
class Kiss(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e1-1', (25, 28), (28, 29), radius_x=4)
        self.add_arc('e1-2', (28, 29), (28, 32), radius_x=3)
        self.add_arc('e2', (28, 32), (25, 36), radius_x=3)
        self.add_arc('e3', (28, 32), (27, 32), radius_x=28, sweep=False)
        self.add_arc('e4', (12, 20), (19, 20), radius_x=5)
        self.add_arc('e5', (29, 20), (36, 20), radius_x=5)
