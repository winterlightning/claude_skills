"""Uppercase Z for SOLO48; centerline envelope (10, 4)–(38, 44).
...
class LetterZUppercase(Solo48):
    icon_id = 'letter-z-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'Z', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('Z', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((10,4),[('L',38,4),('L',10,44),('L',38,44)],False)]
