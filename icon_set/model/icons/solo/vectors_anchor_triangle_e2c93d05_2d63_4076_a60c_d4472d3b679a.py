...
class VectorsAnchorTriangle(Solo48):
    icon_id = 'vectors-anchor-triangle'
    ...
    def build(self):
        ...
        self.add_line('sym-e2', (23, 8), (25, 8))
        self.add_line('sym-e8', (25, 8), (26, 9))
        self.add_line('sym-e9', (26, 9), (44, 37))
        self.add_line('sym-e10', (44, 37), (44, 38))
        self.add_arc('sym-e11', (44, 38), (41, 40), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        self.add_line('sym-e12', (41, 40), (7, 40))
        self.add_arc('sym-e14', (7, 40), (4, 38), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        self.add_line('sym-e15', (4, 38), (4, 37))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e14', 'sym-e15', closed=True)
