...
class ClamShell(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('top-left', (6, 24), (14, 6), radius_x=12, radius_y=19, sweep=True, large_arc=False)
        self.add_arc('top-right', (14, 6), (42, 24), radius_x=32, radius_y=19, sweep=True, large_arc=False)
        self.add_arc('bottom-right', (42, 24), (14, 42), radius_x=32, radius_y=19, sweep=True, large_arc=False)
        self.add_arc('bottom-left', (14, 42), (6, 24), radius_x=12, radius_y=19, sweep=True, large_arc=False)
        ...
        self.add_line('hinge', (6, 24), (26, 24))
