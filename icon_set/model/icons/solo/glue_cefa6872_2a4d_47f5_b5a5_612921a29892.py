...
class Glue(Solo48):
    ...
    def build(self):
        self.add_arc('sym-e2', (24, 4), (27, 6), radius_x=4)
        ...
        self.add_arc('sym-e9', (21, 6), (24, 4), radius_x=4)
        ...
        self.add_arc('sym-e16', (40, 40), (36, 44), radius_x=5)
        self.add_line('sym-e18', (36, 44), (24, 44))
        self.add_line('sym-e19', (24, 44), (12, 44))
        self.add_arc('sym-e21', (12, 44), (8, 40), radius_x=6)
        ...
        self.add_contour('sym-c0', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', closed=True)
        self.add_contour('sym-c1', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e15', 'sym-e16', 'sym-e18', 'sym-e19', 'sym-e21', 'sym-e22', 'sym-e23', 'sym-e24', 'sym-e25')
