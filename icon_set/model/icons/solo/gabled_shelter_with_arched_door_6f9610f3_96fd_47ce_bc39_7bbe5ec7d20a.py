...
Plan: Gabled shelter, eaves, rounded lower corners and arched doorway retained. Removed a close roof baseline. Keyshape SQUARE uses its exact SOLO48 bounds; mirrored geometry only where the source supports it.
...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_34/shelter_6f9610f3-96fd-47ce-bc39-7bbe5ec7d20a.svg'
AUTHOR = 'gpt-6'
