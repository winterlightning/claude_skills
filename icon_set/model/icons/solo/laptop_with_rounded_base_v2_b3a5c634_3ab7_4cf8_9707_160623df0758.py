...
class LaptopWithRoundedBaseVariant2(Solo48):
    icon_id = 'laptop-with-rounded-base-v2'
    variant_of = 'laptop-with-rounded-base'
    ...
    def build(self) -> None:
        ...
        self.add_line('lip-left', (4, 31), (6, 31))
        self.add_line('lip-mid', (6, 31), (42, 31))
        self.add_line('lip-right', (42, 31), (44, 31))
        self.add_line('base-right', (44, 31), (44, 32))
        self.add_line('base-bottom', (38, 40), (10, 40))
        self.add_line('base-left', (4, 32), (4, 31))
        self.add_arc('base-se', (44, 32), (38, 40), radius_x=6, radius_y=8, sweep=True)
        self.add_arc('base-sw', (10, 40), (4, 32), radius_x=6, radius_y=8, sweep=True)
