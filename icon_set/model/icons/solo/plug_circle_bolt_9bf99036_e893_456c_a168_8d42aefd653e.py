"""A two-prong plug inside a circular enclosure, cable descending to the rim.

Symbol plan: plug: mirrored prongs, flat cap and rounded bowl.
Envelope: CIRCLE. The enclosing circular rim is the dominant silhouette, centered at (24,24) with radius 20 on the centerline.
Reduction: No bolt is visible in the supplied reference; none was invented.
"""
from ...keyshapes import Keyshape
from icon_set.model.profiles import Profile
from ._base import Solo48

SOURCE_ICON_ID = '9bf99036-e893-456c-a168-8d42aefd653e'
SOURCE_PATH = 'icon_set/work/todo-references/plug circle bolt_9bf99036-e893-456c-a168-8d42aefd653e.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'plug-circle-bolt'
    keyshape = Keyshape.CIRCLE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "primitives-generate"
    aliases = ()
    keywords = ('plug', 'circle', 'bolt')
