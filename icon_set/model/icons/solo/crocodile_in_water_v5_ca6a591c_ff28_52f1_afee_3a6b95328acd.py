"""Right-facing crocodile above water, with enlarged brow, deeper snout and lower scalloped waves. HRECT_M centerline bounds (4,8)-(44,40). No useful exact Lucide crocodile match."""
...
class CrocodileInWaterVariant5(Solo48):
    icon_id = 'crocodile-in-water-v5'
