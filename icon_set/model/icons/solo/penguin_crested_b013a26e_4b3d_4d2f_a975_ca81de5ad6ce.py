...
class CrestedPenguin(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('body-1', (15, 8), (24, 6), radius_x=15, radius_y=15, sweep=True)
        self.add_arc('body-2', (24, 6), (33, 8), radius_x=15, radius_y=15, sweep=True)
        self.add_line('body-3', (33, 8), (36, 22))
        self.add_arc('body-4', (36, 22), (42, 32), radius_x=18, radius_y=18, sweep=True)
        self.add_line('body-5', (42, 32), (36, 29))
        self.add_line('body-6', (36, 29), (36, 36))
        self.add_arc('body-7', (36, 36), (24, 42), radius_x=12, radius_y=10, sweep=True)
        self.add_arc('body-8', (24, 42), (12, 36), radius_x=12, radius_y=10, sweep=True)
        self.add_line('body-9', (12, 36), (12, 29))
        self.add_line('body-10', (12, 29), (6, 32))
        self.add_arc('body-11', (6, 32), (12, 22), radius_x=18, radius_y=18, sweep=True)
        ...
        self.add_arc('crest-left-1', (15, 8), (6, 6), radius_x=14, radius_y=14, sweep=False)
        self.add_contour('crest-left', 'crest-left-1', closed=False)
        self.add_arc('crest-right-1', (33, 8), (42, 6), radius_x=14, radius_y=14, sweep=True)
