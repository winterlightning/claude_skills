# Variant of suspended-succulent-planter; parent file remains unchanged.
...
class SuspendedSucculentPlanterVariant2(Solo48):
    icon_id = 'suspended-succulent-planter-v2'
    variant_of = 'suspended-succulent-planter'
