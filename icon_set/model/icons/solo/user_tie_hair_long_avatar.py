"""user-tie-hair-long: shirt collar and tie with reference head silhouette.
...
Body cue: shirt collar and tie. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-tie-hair-long.svg'
...
class UserTieHairLongAvatar(Solo48):
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'tie', 'hair', 'long', 'portrait', 'bust')
    def build(self):
        cx = 24
