...
class RaisedClenchedFist(Solo48):
    ...
    def build(self):
        ...
        P('outline',(12,42),(12,36),(8,29),(8,18))
        ...
        P('palm',(40,28),(36,38),(32,42));J('palm','thumb')
        J('outline','knuckle-left');J('knuckle-left','finger-left');J('finger-left','knuckle-top');J('knuckle-top','finger-right');J('finger-right','thumb')
        L('thumb-fold',(34,22),(24,32));J('thumb-fold','finger-right');J('thumb-fold','thumb')
        L('ray',(36,6),(40,8))
