...
class CnLettersUnderlined(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('c-top', (18, 8), (6, 15), radius_x=14, radius_y=7, sweep=False)
        self.add_line('c-side', (6, 15), (6, 23))
        self.add_arc('c-bottom', (6, 23), (18, 30), radius_x=14, radius_y=7, sweep=False)
        self.add_contour('c', 'c-top', 'c-side', 'c-bottom')
        self.add_polyline('n-stem', (30, 16), (30, 22), (30, 30))
        self.add_arc('n-arch', (30, 22), (42, 22), radius_x=7, radius_y=7, sweep=True)
        self.add_line('n-right', (42, 22), (42, 30))
