...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('cone',(15,28),(28,15),(34,29),(30,30),(22,32),(18,33),closed=True)
        self.add_bezier('grip',(22,32),((23,41),(33,39),(30,30)))
        self.relate('connect','cone','grip')

KEYSHAPE_REASON='The complete composition uses centerline extremes (6,6)–(42,42).'
FINAL_REDUCTIONS='No major components omitted. Compact grip trials lost the handle opening or resembled a sailboat; retain recognizable diagonal cone and rounded handle with its reported frame-clearance failure.'
