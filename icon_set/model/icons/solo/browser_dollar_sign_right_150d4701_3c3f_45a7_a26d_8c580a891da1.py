"""A browser window with a right-aligned dollar sign.
Symbol plan: panels-top-left: rounded frame and connected header; dollar-sign: joined currency curves.
Reduction: Tiny title-bar marks omitted because the eight-unit header cannot contain detached details.
...
class Drawing(Solo48):
    ...
    def build(self):
        self.browser();self.dollar(26,28)
    ...
    def dollar(self,x,y):
        self.add_bezier('dollar',(x+4,y-5),((x+2,y-6),(x+1,y-6),(x,y-6)),((x-7,y-6),(x-7,y),(x,y)),((x+7,y),(x+7,y+6),(x,y+6)),((x-1,y+6),(x-2,y+6),(x-4,y+5)))
        self.add_line('stem-top',(x,y-7),(x,y-6));self.relate('connect','dollar','stem-top')
        self.add_line('stem-bottom',(x,y+6),(x,y+7));self.relate('connect','dollar','stem-bottom')
