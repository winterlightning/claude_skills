...
SOURCE_PATH = 'icons-json/artificial-intelligence/robot_3b4771f4-de72-4538-b549-43276caa2ff1.json'
AUTHOR = 'json_to_solo'
...
class Robot3b4771f4(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e8', (16, 16), (8, 22), radius_x=7, sweep=False)
        self.add_arc('e9', (8, 34), (16, 44), radius_x=11, sweep=False)
        self.add_line('e10-1', (32, 44), (33, 44))
        self.add_arc('e10-2', (33, 44), (40, 35), radius_x=10, sweep=False)
        self.add_arc('e11', (40, 21), (32, 16), radius_x=6, sweep=False)
        self.add_contour('c0', 'e0')
        self.add_contour('c1', 'e1')
        self.add_contour('c2', 'e8', 'e2', 'e9', 'e3', 'e10-1', 'e10-2', 'e4', 'e11')
