...
class SittingRabbit(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('outline-5', (8, 41), (13, 42), radius_x=5, radius_y=5, sweep=False)
        self.add_line('outline-6', (13, 42), (35, 42))
        self.add_arc('outline-7', (35, 42), (40, 41), radius_x=5, radius_y=5, sweep=False)
        ...
        self.add_line('ear-left-1', (14, 19), (14, 6))
        self.add_arc('ear-left-2', (14, 6), (20, 6), radius_x=3, radius_y=3, sweep=True)
        self.add_line('ear-left-3', (20, 6), (20, 13))
        self.add_contour('ear-left', 'ear-left-1', 'ear-left-2', 'ear-left-3', closed=False)
        self.add_line('ear-right-1', (28, 13), (28, 6))
        self.add_arc('ear-right-2', (28, 6), (34, 6), radius_x=3, radius_y=3, sweep=True)
        self.add_line('ear-right-3', (34, 6), (34, 19))
