...
SOURCE_ICON_ID = '63e0f9d0-9c7a-56ed-b1ae-386ff2aa6eb5'
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thick dot top_63e0f9d0-9c7a-56ed-b1ae-386ff2aa6eb5.svg'
SOURCE_ICON_IDS = ('63e0f9d0-9c7a-56ed-b1ae-386ff2aa6eb5',)
SOURCE_PATHS = ('pictographic-primitives/arrows/arrow thick dot top_63e0f9d0-9c7a-56ed-b1ae-386ff2aa6eb5.svg',)
AUTHOR = 'gpt-6'


class ArrowUpMadeOfCircles(Solo48):
    icon_id = 'arrow-up-made-of-circles'
    ...
    aliases = ()
    keywords = ('arrow', 'up', 'made', 'of', 'circles')
