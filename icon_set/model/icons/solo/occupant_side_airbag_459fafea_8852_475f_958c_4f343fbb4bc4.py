...
class OccupantSideAirbag(Solo48):
    ...
    def build(self) -> None:
        ...
        # Seated figure owns a round head and shoulder/leg junctions; airbag is detached.
        self.add_arc('head-top',(13,7),(19,7),radius_x=3)
        self.add_arc('head-bottom',(19,7),(13,7),radius_x=3)
        self.add_contour('head','head-top','head-bottom',closed=True)
        self.add_polyline('body',(8,42),(8,34),(8,25),(15,19),(22,25),(22,34),(22,42))
        self.add_line('belt',(8,34),(22,25))
        self.add_line('seat',(8,34),(22,34))
        for part in ['body-1','body-2','body-4','body-5']: self.relate('connect','belt',part)
        for part in ['body-1','body-2','body-5','body-6']: self.relate('connect','seat',part)
