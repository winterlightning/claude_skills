"""The digit 9, re-authored from the supplied reference for SOLO48.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/9.svg'
AUTHOR = 'gpt-6'
...
class Digit9(Solo48):
    ...
    aliases = ()
    keywords = ('9', "typeface", "typography", 'number')
