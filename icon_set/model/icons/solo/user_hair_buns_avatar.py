"""user-hair-buns: rounded blouse neckline with reference head silhouette.
...
Body cue: rounded blouse neckline. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-10/references/user-hair-buns.svg'
SOURCE_HEAD_ICON_ID = 'user-hair-buns'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserHairBunsAvatar(Solo48):
    icon_id = 'user-hair-buns-avatar'
