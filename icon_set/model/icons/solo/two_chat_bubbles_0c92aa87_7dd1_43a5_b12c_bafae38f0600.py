...
SOURCE_ICON_ID = '0c92aa87-7dd1-43a5-b12c-bafae38f0600'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_12/conversation chat_0c92aa87-7dd1-43a5-b12c-bafae38f0600.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'square-speech-bubble'
DESIGN_NOTES = 'No defining feature omitted.'
CONSTRUCTION_REFERENCE = 'Lucide messages-square original and atomic-debug; coherent contours and shared attachment nodes.'

class Drawing(Solo48):
    icon_id = 'two-chat-bubbles'
    variant_of = 'square-speech-bubble'
    variant_label = 'Two chat bubbles'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('chat', 'bubbles', 'stacked', 'opposing', 'downward', 'tails')
    def build(self):
        # Plan: Two stacked horizontal rectangular chat bubbles with opposing downward tails.
        ...
        p('upper',(8,4),(40,4),(40,16),(24,16),(16,22),(16,16),(8,16),closed=True)
        p('lower',(8,30),(40,30),(40,38),(32,38),(32,44),(24,38),(8,38),closed=True)
