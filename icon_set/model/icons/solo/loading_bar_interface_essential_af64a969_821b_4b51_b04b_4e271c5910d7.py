"""loading-bar-interface-essential: Regular curved loading bar; earlier revisions preserved."""
...
class LoadingBarInterfaceEssential(Solo48):
    ...
    aliases = ()
    keywords = ('solo-ai-full-set', 'loading-bar-interface-essential')
