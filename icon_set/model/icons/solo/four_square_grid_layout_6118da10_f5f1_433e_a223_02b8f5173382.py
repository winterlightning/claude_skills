...
SOURCE_ICON_ID = '6118da10-f5f1-433e-a223-02b8f5173382'
SOURCE_PATH = 'pictographic-primitives/_uncategorized_25/layout 20_6118da10-f5f1-433e-a223-02b8f5173382.svg'
AUTHOR = "gpt-6"

class FourSquareGridLayout(Solo48):
    icon_id = 'four-square-grid-layout-solo'
    ...
    def build(self) -> None:
        ...
        self.add_line("divider-1", (6,24), (42,24))
