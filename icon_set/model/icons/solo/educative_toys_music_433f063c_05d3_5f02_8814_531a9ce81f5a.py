...
SOURCE_PATH = 'pictographic-primitives/music/educative toys music_433f063c-05d3-5f02-8814-531a9ce81f5a.svg'
AUTHOR = 'gpt-6'
...
class EducativeToysMusic(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e7', (20, 37), ((20, 37.873), (19.781, 38.6), (19.503, 39.436)), ((18.585, 42.209), (15.562000000000001, 44.0), (12.884, 44)), ((10.712, 44), (8.017, 42.182), (8.017, 39.573)), ((8.008, 39.427), (8.008, 39.270999999999994), (8, 39.134)), ((8, 38.902), (8.017, 38.678), (8.017, 38.455)), ((8.017, 37.8), (8.345, 37), (8.632, 36.436)), ((9.844, 34.064), (12.404, 32.527), (14.939, 32.964)), ((16.867, 33.291), (18.484, 34.782), (20, 36)))
        ...
        self.add_contour('c0', 'e0', 'e5', 'e1', 'e6', 'e2', 'e7', closed=False)
