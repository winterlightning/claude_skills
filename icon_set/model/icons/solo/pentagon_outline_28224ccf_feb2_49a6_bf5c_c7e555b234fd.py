"""A regular upright pentagon outline.

SOLO48 SQUARE; Lucide reference: pentagon: five equal visual sides and mirrored axis.
...
class PentagonOutline(Solo48):
    ...
    def build(self) -> None:
        self.add_polyline('pentagon',(24,6),(42,19),(35,42),(13,42),(6,19),closed=True)
