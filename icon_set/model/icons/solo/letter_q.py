"""The lowercase letter q, re-authored from the supplied reference for SOLO48.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/Q.svg'
AUTHOR = 'gpt-6'


class LetterQ(Solo48):
    icon_id = 'letter-q'
    ...
    typeface = {'character': 'q', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('q', "typeface", "typography", 'lowercase')
    ...
    def build(self):
        ...
        mirror = True
        cx, cy, r = 24, 18, 14
        runs = [((cx-r,cy), [('A',cx,cy-r,r,r,True),('A',cx+r,cy,r,r,True),('A',cx,cy+r,r,r,True),('A',cx-r,cy,r,r,True)],True), ((cx-r,cy), [('L',cx-r,44)],False)]
