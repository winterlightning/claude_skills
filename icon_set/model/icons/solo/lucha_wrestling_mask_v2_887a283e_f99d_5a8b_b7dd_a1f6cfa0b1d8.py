...
class LuchaWrestlingMaskVariant2(Solo48):
    icon_id = 'lucha-wrestling-mask-v2'
    variant_of = 'lucha-wrestling-mask'
    ...
    def build(self):
        self.add_arc('top-l', (8, 20), (24, 4), radius_x=16, radius_y=16, sweep=True)
        self.add_arc('top-r', (24, 4), (40, 20), radius_x=16, radius_y=16, sweep=True)
        ...
        self.add_line('mask-seam', (24, 4), (24, 12))
