"""user-helmet-safety-1: work apron with reference head silhouette.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-11/references/user-helmet-safety-1.svg'
SOURCE_HEAD_ICON_ID = 'user-helmet-safety-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class UserHelmetSafety1Avatar(Solo48):
    icon_id = 'user-helmet-safety-1-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'helmet', 'safety', '1', 'portrait', 'bust')
    def build(self):
