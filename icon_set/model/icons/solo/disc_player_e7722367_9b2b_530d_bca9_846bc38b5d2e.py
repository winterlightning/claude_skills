"""Circular disc behind a shallow player with feet; Lucide disc-3 informs the disc and hub; separate slot omitted."""
...
class DiscPlayer(Solo48):
    ...
    def build(self):
        # Circular disc behind a shallow player; shared foot junctions on base.
        self.add_arc('disc',(12,30),(36,30),radius_x=15,large_arc=True)
        self.circle('hub',24,18,3)
        ...
        for part in ['top-left','top-middle','top-right']:self.relate('connect','disc',part)
        for label,x,parts in [('left',12,['bottom-left','bottom-middle']),('right',36,['bottom-right','bottom-middle'])]:
            ...
            for part in parts:self.relate('connect',label+'-foot',part)
