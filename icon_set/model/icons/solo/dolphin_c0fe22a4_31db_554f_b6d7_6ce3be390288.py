"""leaping-dolphin: reconstructed at native SOLO48 size."""
...
class LeapingDolphin(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('silhouette-12', (9, 34), (18, 39), radius_x=12, radius_y=12, sweep=True)
        self.add_line('silhouette-13', (18, 39), (10, 40))
        self.add_line('silhouette-14', (10, 40), (2, 46))
