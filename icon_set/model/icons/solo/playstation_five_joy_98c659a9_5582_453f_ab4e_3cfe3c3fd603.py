...
class PlaystationFiveJoy(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e5', (36, 8), (40, 14), radius_x=8)
        self.add_line('sym-e6', (40, 14), (44, 34))
        self.add_line('sym-e7', (44, 34), (44, 35))
        self.add_arc('sym-e8', (44, 35), (40, 40), radius_x=6)
        ...
        self.add_arc('sym-e18', (10, 39), (8, 40), radius_x=3)
        self.add_arc('sym-e21', (8, 40), (4, 35), radius_x=6)
        self.add_line('sym-e22', (4, 35), (4, 34))
        self.add_line('sym-e23', (4, 34), (8, 14))
        self.add_arc('sym-e24', (8, 14), (12, 8), radius_x=8)
