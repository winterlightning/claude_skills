"""ship-transportation: Smooth sailboat and waves; earlier revisions preserved."""
...
class ShipTransportation(Solo48):
    icon_id = 'ship-transportation'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'transportation'
    aliases = ()
    keywords = ('solo-ai-full-set', 'ship-transportation')
