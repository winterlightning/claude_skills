...
Plan: Three rounded braided bundles reoriented horizontally. Rounded capsule ends and two sweeping strand seams. Bounds (4,10)-(44,38); reduce fine thread lines.
"""
...
class BraidedYarnSkein(Solo48):
    ...
    def build(self):
        self.add_line('top-left',(12,10),(24,10))
        self.add_line('top-right',(24,10),(36,10))
        self.add_arc('end-right',(36,10),(36,38),radius_x=8,radius_y=14)
        self.add_line('bottom-right',(36,38),(24,38))
        self.add_line('bottom-left',(24,38),(12,38))
        ...
        for i in range(2):
            x=24+12*i
            self.add_arc(f'strand-{i}',(x,10),(x-12,38),radius_x=40,radius_y=60)
