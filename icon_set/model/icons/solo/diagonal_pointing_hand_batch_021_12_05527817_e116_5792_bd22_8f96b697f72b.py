...
Symbol plan: Diagonal finger with a broad thumb and curved palm; angular wrist is intentional.
Keyshape: SQUARE; authored at SOLO48, never scaled from the source.
Reference construction: Lucide pointer.
Reduction: Combined small curled fingertips into one smooth palm.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '05527817-e116-5792-bd22-8f96b697f72b'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/other/hand pointer diagonal_05527817-e116-5792-bd22-8f96b697f72b.svg'
AUTHOR = 'gpt-6'
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-021/references/hand pointer diagonal_05527817-e116-5792-bd22-8f96b697f72b.svg'

class GeneratedIcon(Solo48):
    icon_id = 'diagonal-pointing-hand-batch-021-12'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'objects'
    keywords = ('diagonal', 'pointing', 'hand')
    ...
    def build(self):
        ...
        def cross(name,x,y,r):
            for j,p in enumerate(((x-r,y),(x+r,y),(x,y-r),(x,y+r))):
                line(f'{name}-{j}',(x,y),p)
        path('hand',(6,42),('L',(10,31)),('L',(10,23)),('C',(10,14),(18,14),(18,24)),('L',(33,9)),('C',(35,7),(36,6),(38,6)),('A',(42,10),4,4,True),('C',(42,12),(41,13),(39,15)),('L',(29,25)),('C',(39,25),(40,34),(32,38)),('C',(25,42),(20,36),(16,42)))
