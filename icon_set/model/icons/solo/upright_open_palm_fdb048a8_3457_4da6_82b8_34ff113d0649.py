'Upright Open Palm.\nSymbol plan: An open hand faces forward with four long fingers held upright and a thumb angled outward to the left. A curved palm crease sweeps inward from the thumb base above the open wrist.\nConstruction: Lucide hand and human_ref: shared round fingertips and coherent palm contour.\nReduction: Use four round fingertips with 8-unit pitch; shorten finger creases for clarity.\nKeyshape HRECT_L.'
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'fdb048a8-3457-4da6-82b8-34ff113d0649'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_29/palm_fdb048a8-3457-4da6-82b8-34ff113d0649.svg'
AUTHOR = 'gpt-6'
...
class BatchIcon(Solo48):
    ...
    aliases = ()
    keywords = ('hand', 'palm', 'fingers', 'thumb', 'anatomy', 'gesture')
    def build(self):
