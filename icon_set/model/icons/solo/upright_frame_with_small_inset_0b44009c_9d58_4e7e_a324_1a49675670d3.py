...
SOURCE_ICON_ID = '0b44009c-9d58-4e7e-a324-1a49675670d3'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_22/hardboard_0b44009c-9d58-4e7e-a324-1a49675670d3.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'rectangular-picture-frame'
...
class Drawing(Solo48):
    icon_id = 'upright-frame-with-small-inset'
    variant_of = None
    variant_label = 'Upright Frame with Small Inset'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('frame', 'inset', 'smaller', 'opening', 'Uncategorized', 'outline')
    def build(self):
        # Plan: An upright rounded rectangular frame with a smaller rectangular opening.
        ...
        rr('frame',8,4,40,44,4)
        p('opening',(17,16),(31,16),(31,32),(17,32),closed=True)
