"""A KuCoin token contains a vertical stem and open angular K mark.
Plan: The K uses a shared central junction and paired open angular branches.
...
SOURCE_ICON_ID = 'c9bb37e2-7a8c-4d98-bf50-10507c68d838'
SOURCE_PATH = 'icon_set/work/todo-references/virtual coin crypto kucoin token_c9bb37e2-7a8c-4d98-bf50-10507c68d838.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    icon_id = 'virtual-coin-crypto-kucoin-token'
    keyshape = Keyshape.CIRCLE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('virtual', 'coin', 'crypto', 'kucoin', 'token')
