"""A separate oval head sits above a broad-shouldered shirt. A central necktie hangs from a small trapezoidal knot, widening downward before ending in a pointed tip.
Symbol plan: Office portrait with a long broad necktie on the chest. Circular head and curved shoulders share the set parameters. Omit the separate small knot; the flat tie top and pointed lower end remain clear.
...
SOURCE_PATH = 'pictographic-primitives/avatars/man office_958445fb-294c-5b85-9463-6a253bbd6c31.svg'
...
class BatchSolo(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('office', 'worker', 'with', 'long', 'tie')
    ...
    def build(self):
        ...
        self.add_polyline('body-tie',(20,32),(28,32),(28,38),(24,44),(20,38),closed=True)
