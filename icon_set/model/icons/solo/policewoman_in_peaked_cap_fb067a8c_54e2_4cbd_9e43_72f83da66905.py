"""Policewoman in Peaked Cap.

Symbol plan: Broad peaked cap with a smoothly curved visor over a circular jaw, flared bob and uniform seam. Drop the second narrow cap band and small chest badge.
...
SOURCE_PATH = 'pictographic-primitives/avatars/police woman_fb067a8c-54e2-4cbd-9e43-72f83da66905.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self) -> None:
        ...
        path('crown',(12,16),(8,12),(24,4),(40,12),(36,16))
