"""Two offset speech bubbles, with tails at opposite lower corners.
...
SOURCE_ICON_ID = "72e7c0cd-44db-4c24-a53d-c462c4742d48"
SOURCE_PATH = "pictographic-primitives/_uncategorized_12/conversation chat 1_72e7c0cd-44db-4c24-a53d-c462c4742d48.svg"
AUTHOR = "gpt-6"


class DoubleChatBubbles(Solo48):
    icon_id = "double-chat-bubbles"
    ...
    def build(self) -> None:
        ...
        self.add_line("back-tail-down",(12,26),(12,34))
        self.add_line("back-tail-up",(12,34),(15,30))
