...
SOURCE_ICON_ID = '5a587cee-e18f-44d2-9f39-519830d5e8d4'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_34/sherry_5a587cee-e18f-44d2-9f39-519830d5e8d4.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'wide-wine-glass-with-short-stem'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'objects'
    aliases = ()
    keywords = ('glass', 'wine', 'sherry', 'stem', 'bowl', 'drinkware')
