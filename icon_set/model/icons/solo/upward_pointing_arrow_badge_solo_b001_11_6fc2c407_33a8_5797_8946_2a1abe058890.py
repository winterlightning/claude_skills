"""Upward Pointing Arrow Badge.
Plan: Pointed badge with centered up chevron; preserve vertical direction.
Centerline envelope: (8,4)-(40,44).
Final reduction/review: Pointed badge with centered up chevron; preserve vertical direction.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-001/references/arrow badge top_6fc2c407-33a8-5797-8946-2a1abe058890.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'upward-pointing-arrow-badge-solo-b001-11'
    ...
    def build(self):
        s = self
        s.add_polyline('badge',(8,44),(8,20),(24,4),(40,20),(40,44),closed=True)
        s.add_polyline('chevron',(16,32),(24,24),(32,32))
