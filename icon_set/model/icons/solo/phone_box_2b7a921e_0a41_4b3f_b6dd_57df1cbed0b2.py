...
class PhoneBox(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e5', (38, 14), (37, 11), radius_x=6, sweep=False)
        self.add_arc('sym-e6', (37, 11), (25, 4), radius_x=15, sweep=False)
        self.add_arc('sym-e7', (25, 4), (24, 4), radius_x=76)
        self.add_arc('sym-e12', (24, 4), (23, 4), radius_x=69)
        self.add_arc('sym-e13', (23, 4), (11, 11), radius_x=15, sweep=False)
        self.add_arc('sym-e14', (11, 11), (10, 14), radius_x=7, sweep=False)
        self.add_line('sym-e15', (10, 14), (10, 44))
        self.add_contour('sym-c0', 'sym-e0')
        self.add_contour('sym-c1', 'sym-e1', 'sym-e2', 'sym-e3')
        self.add_contour('sym-c2', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e15')
