...
Plan: Thumbnail series reduced from four to two to keep legal open interiors.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/gallery view_93460326-fd48-5ccc-80d9-26e7fb498e7f.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '93460326-fd48-5ccc-80d9-26e7fb498e7f'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/gallery view_93460326-fd48-5ccc-80d9-26e7fb498e7f.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'image-gallery-with-thumbnails-batch-006-03'
    ...
    aliases = ()
    keywords = ('image', 'gallery', 'with', 'thumbnails')
    ...
    def build(self):
        ...
        rect('image',6,6,36,20,3)
        for i in range(2): rect(f'thumbnail-{i}',6+26*i,34,10,8,2)
