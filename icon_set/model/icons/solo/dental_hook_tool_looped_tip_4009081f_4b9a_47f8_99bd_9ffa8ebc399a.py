"""Dental Hook Instrument."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '4009081f-4b9a-47f8-99bd-9ffa8ebc399a'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/health/dentistry tooth hook_4009081f-4b9a-47f8-99bd-9ffa8ebc399a.svg'
AUTHOR = 'gpt-6'


class DentalHookToolLoopedTip(Solo48):
    ...
    def build(self):
        # Plan: An upper-right diagonal grip joins a thin shaft and a broad open working hook below-left. Extremes (6,6)-(42,42).
        # Reduction: Enlarge the working hook opening and simplify the grip end; preserve the full instrument.
        # Reference: Lucide search: separate head and handle sharing a physical attachment; circular arcs form the open hook.
        ...
        path('grip-left',(22,18),(34,6),(38,6))
        arc('grip-cap',(38,6),(42,10),4)
        path('grip-right',(42,10),(42,14),(30,26),(26,22),(22,18))
        contour('grip','grip-left','grip-cap','grip-right',closed=True)
        path('shaft',(26,22),(22,26),(22,34))
        arc('hook-bottom',(22,34),(6,34),8)
        line('hook-tip',(6,34),(6,30))
        contour('shaft-hook','shaft','hook-bottom','hook-tip')
        contacts()
