...
"""Scorpio with equal circular humps and clear space beside the arrowhead. SQUARE bounds (6,6)-(42,42). The directional tail remains asymmetric. Lucide zodiac-scorpio informs equal circular humps, a quarter-circle tail bend and a longer horizontal run before the arrow."""
...
class ScorpioZodiacSymbolVariant2(Solo48):
    ...
    def build(self) -> None:
        # SQUARE (6,6)-(42,42); equal humps, wider arrow-to-stem gap.
        self.add_arc('entry', (6,6), (7,8), radius_x=5, radius_y=6)
