...
Final reduction/review: Open door uses shifted panel line; handle omitted to preserve panel spacing.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-002/references/door sliding left hand open_f0c28f5a-8618-48b9-aa2f-5160d2226c1b.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    ...
    aliases = ()
    keywords = ('sliding', 'door', 'open', 'left')

    def build(self):
        s = self
        box(s,'frame',6,6,42,42,2,nodes=((24,6),(24,42)))
        s.add_line('divider',(24,6),(24,42));join(s,'frame','divider')
        s.add_line('shifted-panel',(34,6),(34,42));join(s,'frame','shifted-panel')
