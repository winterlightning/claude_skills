...
class EagleHeadProfile(Solo48):
    ...
    def build(self) -> None:
        # Eagle head; centerline extremes (6,6)-(42,42). Hooked beak and three feather tips retained; beak slit omitted. Lucide bird informs continuous crown; right-facing asymmetry.
        self.add_arc('crown-left', (6, 24), (24, 6), radius_x=22, radius_y=22, sweep=True)
        self.add_arc('crown-right', (24, 6), (37, 9), radius_x=16, radius_y=16, sweep=True)
        self.add_arc('beak-top', (37, 9), (42, 22), radius_x=9, radius_y=13, sweep=True)
