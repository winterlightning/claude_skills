...
Plan: Paired socket contacts retained; secondary exterior plate border omitted to provide clear spacing.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/socket box_cb4871be-f857-50cb-b4a5-b49bd3db6452.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'cb4871be-f857-50cb-b4a5-b49bd3db6452'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/socket box_cb4871be-f857-50cb-b4a5-b49bd3db6452.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'electrical-power-outlet-batch-007-05'
    ...
    def build(self):
        ...
        rect('socket',6,6,36,36,7)
        for x in (18,30): line(f'slot-{x}',(x,20),(x,28))
