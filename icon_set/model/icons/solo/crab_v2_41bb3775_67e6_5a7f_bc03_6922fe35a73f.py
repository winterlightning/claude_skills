...
class CrabVariant2(Solo48):
    icon_id = 'crab-v2'
    variant_of = 'crab'
    variant_label = 'Opposing curved pincers'
    ...
    def build(self) -> None:
        ...
        self.add_arc('left-claw', (6, 2), (12, 16), radius_x=6, radius_y=14, sweep=False, large_arc=False)
        self.add_arc('left-pincer', (12, 16), (18, 2), radius_x=6, radius_y=14, sweep=False)
        ...
        self.add_arc('right-claw', (42, 2), (36, 16), radius_x=6, radius_y=14, sweep=True, large_arc=False)
        self.add_arc('right-pincer', (36, 16), (30, 2), radius_x=6, radius_y=14, sweep=True)
