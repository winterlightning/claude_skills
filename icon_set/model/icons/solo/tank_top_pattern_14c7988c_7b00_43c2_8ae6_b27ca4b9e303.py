"""tank-top-pattern: Balanced sleeveless top; earlier revisions preserved."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '14c7988c-7b00-43c2-8ae6-b27ca4b9e303'
SOURCE_PATH = 'pictographic-primitives/clothes/tank top pattern_14c7988c-7b00-43c2-8ae6-b27ca4b9e303.svg'
AUTHOR = 'gpt-6'

class TankTopPattern(Solo48):
    icon_id = 'tank-top-pattern'
    ...
    aliases = ()
    keywords = ('solo-ai-full-set', 'tank-top-pattern')
    ...
    def build(self):
        ...
        if 'flat'=='curve':commands += [('C',(40,42),(37,30),(38,34)),('C',(24,44),(36,44),(30,44)),('C',(8,42),(18,44),(12,44)),('C',(8,20),(10,34),(11,30))]
