...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/o.svg'
AUTHOR = 'gpt-6'


class LetterOLarge(Solo48):
    icon_id = 'letter-o-large'
    ...
    typeface = {'character': 'o', 'kind': 'lowercase', 'preferred': False}
    aliases = ()
