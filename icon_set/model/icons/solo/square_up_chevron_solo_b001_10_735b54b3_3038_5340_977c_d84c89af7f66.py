...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-001/references/arrow rectangle left svg90_735b54b3-3038-5340-977c-d84c89af7f66.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'square-up-chevron-solo-b001-10'
    ...
    def build(self):
        ...
        s.add_polyline('chevron',*[(16, 28), (24, 20), (32, 28)])
