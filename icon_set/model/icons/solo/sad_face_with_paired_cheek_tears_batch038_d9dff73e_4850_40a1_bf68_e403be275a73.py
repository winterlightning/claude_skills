"""Fresh batch-038 result for sad-face-with-paired-cheek-tears.
...
SOURCE_ICON_ID = 'd9dff73e-4850-40a1-bf68-e403be275a73'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_17/face holding back tears_d9dff73e-4850-40a1-bf68-e403be275a73.svg'
AUTHOR = 'gpt-6'

class Batch038Icon(Solo48):
    icon_id = 'sad-face-with-paired-cheek-tears-batch038'
    keyshape = Keyshape.CIRCLE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/expressions" 
    aliases = ()
    keywords = ('sad', 'face', 'with', 'paired', 'cheek', 'tears')
    ...
    def build(self):
        ...
        # Paired short tear trails fit inside a complete circular face.
        circle('face',24,24,20)
        for i,x in enumerate((18,30)):
            eye('closed-eye-'+str(i),x,16)
        for i,x in enumerate((15,33)):
            self.add_line('tear-'+str(i),(x,25),(x,28))
        mouth(34,True,3,2)
