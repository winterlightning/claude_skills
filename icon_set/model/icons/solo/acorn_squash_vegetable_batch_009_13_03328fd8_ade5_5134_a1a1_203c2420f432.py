...
Plan: Three broad lobes with shared top/bottom nodes and short curved stem.
Construction reference: Lucide bottle-wine; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/acornsquash_03328fd8-ade5-5134-a1a1-203c2420f432.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '03328fd8-ade5-5134-a1a1-203c2420f432'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/food/acornsquash_03328fd8-ade5-5134-a1a1-203c2420f432.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'acorn-squash-vegetable-batch-009-13'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/batch-009"
    aliases = ()
    keywords = ('acorn', 'squash', 'vegetable')
    ...
    def build(self):
        ...
        curve('squash',(24,44),((13,44),(8,35),(8,24)),((8,16),(14,13),(24,14)),((34,13),(40,16),(40,24)),((40,35),(35,44),(24,44)))
        curve('lobe-left',(24,14),((13,17),(13,36),(24,44)))
        curve('lobe-right',(24,14),((35,17),(35,36),(24,44)))
        path('stem',(24,14),(24,7),(28,4))
