...
class Ticket(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e4', (4, 17), (9, 24), radius_x=7)
        self.add_arc('sym-e5', (9, 24), (4, 31), radius_x=7)
        ...
        self.add_arc('sym-e10', (44, 31), (39, 24), radius_x=7)
        self.add_arc('sym-e11', (39, 24), (44, 17), radius_x=7)
