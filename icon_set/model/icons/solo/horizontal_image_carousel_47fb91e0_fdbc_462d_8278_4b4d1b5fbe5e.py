...
SOURCE_ICON_ID = '47fb91e0-fdbc-462d-8278-4b4d1b5fbe5e'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_10/carousel horizontal_47fb91e0-fdbc-462d-8278-4b4d1b5fbe5e.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'vertical-card-carousel-batch-006-08'
...
class Drawing(Solo48):
    icon_id = 'horizontal-image-carousel'
    variant_of = 'vertical-card-carousel-batch-006-08'
    variant_label = 'Horizontal Image Carousel'
    ...
    aliases = ()
    keywords = ('image', 'carousel', 'card', 'partial', 'Uncategorized', 'outline')
    def build(self):
        # Plan: A central upright rounded rectangular card with a partial card visible on each side.
        ...
        rr('center',16,8,32,40,3)
        p('left',(4,16),(8,16),(8,32),(4,32));p('right',(44,16),(40,16),(40,32),(44,32))
