"""House with isolated vertical door indicator as in reference. Simple axis symmetry and unobstructed facade. Centerline6,6–42,42.
...
class BatchIcon(Solo48):
    icon_id='house-with-interior-door-stroke-solo-b015'
    ...
    def build(self):
        ...
        self.relate('connect','roof','walls');self.add_line('door',(24,25),(24,33))
