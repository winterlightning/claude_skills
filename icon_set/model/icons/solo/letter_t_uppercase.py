"""Uppercase T for SOLO48; centerline envelope (10, 4)–(38, 44).
...
class LetterTUppercase(Solo48):
    icon_id = 'letter-t-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    typeface = {'character': 'T', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('T', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        axis=24
        runs=[((10,4),[('L',axis,4),('L',38,4)],False),((axis,4),[('L',axis,44)],False)]
