...
Final reduction/review: Dashed sidebar reduced to two equally spaced dots.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-001/references/sidebar dots left_8b3c753d-e676-4e1a-811c-69448f6e158f.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    ...
    def build(self):
        ...
        for y in (18,30): s.add_dot(f'divider-{y}',(20,y))
