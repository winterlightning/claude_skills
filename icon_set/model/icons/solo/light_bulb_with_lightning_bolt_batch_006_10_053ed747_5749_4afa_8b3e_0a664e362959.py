"""Light Bulb with Lightning Bolt.
Plan: Open lightning stroke inside bulb; single broad base band.
Construction reference: Lucide lightbulb; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/charging light idea_053ed747-5749-4afa-8b3e-0a664e362959.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '053ed747-5749-4afa-8b3e-0a664e362959'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/devices/charging light idea_053ed747-5749-4afa-8b3e-0a664e362959.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'light-bulb-with-lightning-bolt-batch-006-10'
    ...
    def build(self):
        ...
        curve('bulb',(16,36),((16,30),(8,29),(8,20)),((8,11),(15,4),(24,4)),((33,4),(40,11),(40,20)),((40,29),(32,30),(32,36)))
        path('base',(16,36),(16,44),(32,44),(32,36))
        line('base-top',(16,36),(32,36))
        path('electricity',(26,13),(17,20),(31,20),(22,27))
