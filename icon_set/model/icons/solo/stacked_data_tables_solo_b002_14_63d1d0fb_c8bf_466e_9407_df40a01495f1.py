"""Stacked Data Tables.
Plan: Stacked table sheets, front grid with two columns and two rows.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Stacked table sheets, front grid with two columns and two rows.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-002/references/workflow data table stack_63d1d0fb-c8bf-466e-9407-df40a01495f1.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'stacked-data-tables-solo-b002-14'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'business'
    aliases = ()
    keywords = ('stacked', 'data', 'tables')

    def build(self):
        s = self
        s.add_polyline('back',(16,6),(42,6),(42,32))
        box(s,'front',6,16,32,42,2,nodes=((6,25),(32,25),(19,25),(19,42)))
        s.add_polyline('row',(6,25),(19,25),(32,25));join(s,'front','row')
        s.add_line('col',(19,25),(19,42));join(s,'front','col');join(s,'row','col')
