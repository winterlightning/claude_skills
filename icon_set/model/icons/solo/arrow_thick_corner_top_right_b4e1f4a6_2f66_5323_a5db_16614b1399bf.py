"""Arrow thick corner top right (arrows), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'b4e1f4a6-2f66-5323-a5db-16614b1399bf'
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thick corner top right_b4e1f4a6-2f66-5323-a5db-16614b1399bf.svg'
AUTHOR = 'gpt-6'

class ArrowThickCornerTopRight(Solo48):
    icon_id = 'arrow-thick-corner-top-right'
    ...
    def build(self):
        runs = [{'start': (16, 6), 'steps': [('L', 24, 14), ('L', 6, 32), ('L', 16, 42), ('L', 34, 24), ('L', 42, 32), ('L', 42, 6), ('L', 16, 6)], 'closed': True}]
        rotation = 0
