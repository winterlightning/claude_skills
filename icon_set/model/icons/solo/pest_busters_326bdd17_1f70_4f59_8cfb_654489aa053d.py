"""Bug crossed out by a diagonal pest-control slash.
Plan: SQUARE accommodates head, body, legs and slash.
Reduction: Six legs reduced to four; fine antennae omitted; head and body integrated with a head separator.
Construction: bug: integrated shell and attached legs. Slash intersections are exact body nodes. One rear leg is redirected to prevent a small pocket, so appendages are intentionally asymmetric.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('outline',(30,12),(30,16),(30,18),(34,24),(34,30),(32,36),(24,42),(16,36),(14,34),(12,24),(18,16),(18,12))
        ...
        for n,a,z in [('left-front',(12,24),(6,20)),('right-front',(34,24),(42,24)),('left-back',(14,34),(14,42)),('right-back',(32,36),(42,40))]:
            self.add_line(n,a,z);self.relate('connect',n,'outline')
            if n=='left-back':self.relate('connect',n,'slash')
