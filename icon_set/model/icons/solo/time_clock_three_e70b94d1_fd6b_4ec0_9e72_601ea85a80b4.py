...
SOURCE_PATH = 'pictographic-primitives/interface-essential/time clock three_e70b94d1-fd6b-4ec0-9e72-601ea85a80b4.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class TimeClockThree(Solo48):
    icon_id = 'time-clock-three'
