...
SOURCE_ICON_ID = '52a72434-ed3c-4fee-a58d-fa530deecaca'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/files/common file dash_52a72434-ed3c-4fee-a58d-fa530deecaca.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'common-file-empty'
...
class Drawing(Solo48):
    icon_id = 'dashed-document-icon'
    variant_of = 'common-file-empty'
    variant_label = 'Dashed Document Icon'
    ...
    aliases = ()
    keywords = ('dashed', 'document', 'clipped', 'corner', 'broken', 'outline')
    def build(self):
        # Plan: An upright blank document with a clipped upper-right corner and a broken dashed outline.
