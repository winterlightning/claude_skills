# Variant of standing-elephant; parent file remains unchanged.
...
class StandingElephantVariant2(Solo48):
    icon_id = 'standing-elephant-v2'
    variant_of = 'standing-elephant'
