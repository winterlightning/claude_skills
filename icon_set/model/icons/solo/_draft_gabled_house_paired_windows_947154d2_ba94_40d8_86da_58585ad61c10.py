...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        poly('shell',(4,16),(24,8),(44,16),(44,40),(4,40),(4,16))
        box('left-window',12,24,20,32,0);box('right-window',28,24,36,32,0)
        poly('door',(20,40),(20,32),(28,32),(28,40));join('door','shell');join('door','left-window');join('door','right-window')
