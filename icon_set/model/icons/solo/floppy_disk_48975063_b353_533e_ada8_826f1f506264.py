"""Use four matching 4-unit corner radii and center the solid hub dot on the disk; keep the shutter and label cleanly separated. Applied to the original icon identity."""
