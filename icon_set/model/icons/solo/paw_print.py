'paw-print: Four rounded toes in a compact arch above a smooth mirrored three-lobed pad; matching oval toes. Original redrawn in place after the nine-icon meaning review.'
...
class PawPrint(Solo48):
    ...
    def build(self):
        # Symbol plan: Four rounded toes in a compact arch above a smooth mirrored three-lobed pad; matching oval toes.
        ...
        for n,x,y,rx,ry in [('upper-left',15,8,3,4),('upper-right',33,8,3,4),('outer-left',8,22,3,4),('outer-right',40,22,3,4)]:ellipse(n,x,y,rx,ry)
