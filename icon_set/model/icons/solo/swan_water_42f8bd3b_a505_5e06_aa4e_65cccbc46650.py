"""Swan on a separate wavy waterline with raised wing. Bounds (6,6)-(42,42). Lucide bird: open wing and simple head; omit eye and extra ripples."""
...
class SwanOnWater(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('hull-back',(20,34),(6,21),radius_x=18,radius_y=13,sweep=True)
        self.add_line('tail',(6,21),(7,21))
        self.add_contour('hull','hull-base','hull-back','tail')
        self.relate('connect','hull','front-neck')
        self.relate('connect','hull','neck-wing')
        self.add_arc('wave-left',(6,42),(14,42),radius_x=6,radius_y=1,sweep=False)
        ...
        self.add_arc('wave-end',(36,42),(42,42),radius_x=5,radius_y=1,sweep=True)
