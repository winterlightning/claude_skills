...
class RipGravestone(Solo48):
    ...
    def build(self):
        ...
        P('walls',(40,20),(40,42),(8,42),(8,20));J('walls','arch')
        L('r-stem',(22,14),(22,21));C('r-loop',24,16,2);J('r-stem','r-loop')
        L('r-leg',(24,18),(26,21));J('r-leg','r-loop')
        L('i',(18,29),(18,36))
        L('p-stem',(27,29),(27,35));C('p-loop',29,31,2);J('p-stem','p-loop')
