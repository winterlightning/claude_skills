...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_06/battery charge_4f3486c1-78f2-42f8-9b6a-d48e5e4db3f1.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    variant_label = 'Battery with Charging Cable'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('battery', 'charging', 'cable', 'wide', 'terminal', 'Uncategorized')
    def build(self):
        # Plan: A wide rounded rectangular battery with a right terminal and short cable below.
        ...
        rr('battery',4,8,36,32,3,right=(16,24),bottom=(20,))
