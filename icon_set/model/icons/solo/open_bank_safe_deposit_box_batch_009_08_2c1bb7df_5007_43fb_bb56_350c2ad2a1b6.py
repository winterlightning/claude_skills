"""Open Bank Safe Deposit Box.
Plan: Three compartments replace six; lower open compartment holds the broad trapezoid.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/saving bank drawer_2c1bb7df-5007-43fb-bb56-350c2ad2a1b6.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '2c1bb7df-5007-43fb-bb56-350c2ad2a1b6'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/finance/saving bank drawer_2c1bb7df-5007-43fb-bb56-350c2ad2a1b6.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'open-bank-safe-deposit-box-batch-009-08'
    ...
    def build(self):
        ...
        rect('cabinet',4,8,28,32)
        line('upper-shelf',(4,18),(32,18))
        line('upper-divider',(18,8),(18,18))
        path('door',(32,18),(44,14),(44,40),(32,40))
        path('object',(12,40),(14,28),(22,28),(24,40))
