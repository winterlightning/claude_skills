"""A horizontal battery has a right terminal and a wide empty rectangular level window."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '90c3e57b-fa24-4ba6-9881-92c8e8a0dc51'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_06/battery empty_90c3e57b-fa24-4ba6-9881-92c8e8a0dc51.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'empty-battery-level-indicator'
...
class Drawing(Solo48):
    ...
    variant_of = None
    variant_label = 'Empty Battery Level Indicator'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('battery', 'level', 'indicator', 'terminal', 'wide', 'window')
    def build(self):
        # Plan: A horizontal battery has a right terminal and a wide empty rectangular level window.
        ...
        rr('battery',4,8,36,40,3,right=(16,32))
        p('terminal',(36,16),(44,16),(44,32),(36,32))
        rr('level',13,17,27,31,2)
