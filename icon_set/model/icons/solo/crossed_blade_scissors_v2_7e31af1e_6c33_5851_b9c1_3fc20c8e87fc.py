...
class CrossedBladeScissorsVariant2(Solo48):
    icon_id = 'crossed-blade-scissors-v2'
    variant_of = 'crossed-blade-scissors'
    ...
    def build(self) -> None:
        ...
        self.add_polyline('blade-a', (13, 34), (24, 22), (36, 4))
        self.add_polyline('blade-b', (35, 34), (24, 22), (12, 4))
