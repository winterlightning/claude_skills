...
class JetSkiRiderJumpingAWaveVariant2(Solo48):
    icon_id = 'jet-ski-rider-jumping-a-wave-v2'
    variant_of = 'jet-ski-rider-jumping-a-wave'
    ...
    def build(self):
        ...
        self.add_line('rider-2', (19, 27), (19, 18))
