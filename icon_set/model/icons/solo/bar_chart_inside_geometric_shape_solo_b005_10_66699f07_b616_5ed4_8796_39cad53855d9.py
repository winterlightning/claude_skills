"""Bar Chart Inside Geometric Shape.
Plan: Irregular angular enclosure with three bars sharing baseline; omit smallest fourth bar.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Four bars reduced to three; angular enclosing outline preserved.
...
SOURCE_ICON_ID = '66699f07-b616-5ed4-8796-39cad53855d9'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/amazon manage service for grafana_66699f07-b616-5ed4-8796-39cad53855d9.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-005/references/amazon manage service for grafana_66699f07-b616-5ed4-8796-39cad53855d9.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'bar-chart-inside-geometric-shape-solo-b005-10'
    ...
    aliases = ()
    keywords = ('bar', 'chart', 'inside', 'geometric', 'shape')

    def build(self):
        s = self
        s.add_polyline('outline',(6,20),(22,6),(34,8),(34,18),(42,14),(42,38),(14,42),closed=True)
        for x,y in ((18,27),(26,21),(34,27)):s.add_line(f'bar-{x}',(x,y),(x,29))
