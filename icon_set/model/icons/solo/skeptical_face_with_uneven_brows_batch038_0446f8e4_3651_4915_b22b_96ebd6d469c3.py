"""Fresh batch-038 result for skeptical-face-with-uneven-brows.
...
SOURCE_ICON_ID = '0446f8e4-3651-4915-b22b-96ebd6d469c3'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_17/face raised eyebrow_0446f8e4-3651-4915-b22b-96ebd6d469c3.svg'
AUTHOR = 'gpt-6'

class Batch038Icon(Solo48):
    icon_id = 'skeptical-face-with-uneven-brows-batch038'
    ...
    def build(self):
        ...
        self.add_arc('brow-left',(17,15),(20,15),radius_x=2,radius_y=1)
        self.add_line('brow-right',(29,15),(31,15))
        self.add_line('mouth',(20,33),(28,34))
