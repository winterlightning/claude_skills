"""The digit 7, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 10, top 4, right 38, bottom 44.
Plan: One horizontal arm and a descending diagonal.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/7.svg'
AUTHOR = 'gpt-6'
...
class Digit7(Solo48):
    ...
    typeface = {'character': '7', 'kind': 'digit'}
    aliases = ()
    keywords = ('7', "typeface", "typography", 'number')

    def build(self):
        rotation = 0
        mirror = False
        runs = [((10,4), [('L',38,4),('L',18,44)],False)]
