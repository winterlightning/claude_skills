"""Arrow angle right (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class ArrowAngleRight(Solo48):
    ...
    def build(self):
        self.add_line('sym-e1', (40, 24), (38, 25))
        self.add_line('sym-e2', (38, 25), (8, 44))
        self.add_line('sym-e3', (40, 24), (38, 23))
