"""symbol-aviation: smooth geometric reconstruction on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '02c5863b-6ad4-49a6-b742-3c17b40f5da2'
SOURCE_PATH = 'pictographic-primitives/war/symbol aviation_02c5863b-6ad4-49a6-b742-3c17b40f5da2.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class SymbolAviation(Solo48):
    icon_id = 'symbol-aviation'
