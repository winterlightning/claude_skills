...
SOURCE_ICON_ID = '41aad5d3-e851-5336-9a83-7dc40ce28b04'
SOURCE_PATH = 'pictographic-primitives/animals/insect_41aad5d3-e851-5336-9a83-7dc40ce28b04.svg'
AUTHOR = 'gpt-6'


class HornedBeetle(Solo48):
    icon_id = 'horned-beetle'
    ...
    aliases = ()
    keywords = ('beetle', 'insect', 'horn', 'bug', 'shell', 'profile', 'legs', 'nature')
    ...
    def build(self) -> None:
        ...
        self.add_arc('leg-1',(24, 32),(28, 40),radius_x=10,radius_y=10,large_arc=False,sweep=False)
        self.add_bezier('leg-2',(34, 32),*(((34.0, 35.14757303), (35.85242697, 38.11145618), (39, 40)),))
        ...
        self.relate('connect',*('shell', 'leg-1'))
