...
class Drawing(Solo48):
    icon_id='square-envelope'
    keyshape=Keyshape.SQUARE
    semantic_role='MAIN'
    semantic_kind='noun'
    category='objects/general'
    aliases=()
    keywords=('square', 'envelope')
    ...
    def build(self):
        ...
        self.add_polyline('envelope',(15,15),(33,15),(33,33),(15,33),closed=True)
        self.add_polyline('flap',(15,15),(24,24),(33,15));self.relate('connect','envelope','flap')

KEYSHAPE_REASON='The complete composition uses centerline extremes (6,6)–(42,42).'
FINAL_REDUCTIONS='Lower envelope fold seams omitted because the small triangular pockets collapsed at native size; outer envelope and complete flap retained.'
