...
class SharkFinInWater(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('wave-low-2', (9, 42), (16, 40), radius_x=7, radius_y=3, sweep=False)
        self.add_arc('wave-low-3', (16, 40), (24, 42), radius_x=8, radius_y=3, sweep=False)
        self.add_arc('wave-low-4', (24, 42), (32, 40), radius_x=8, radius_y=3, sweep=False)
        self.add_arc('wave-low-5', (32, 40), (39, 42), radius_x=7, radius_y=3, sweep=False)
