"""Rubber Stamp Tool.
Plan: Mirrored rounded knob, straight narrow neck and two-tier stamp base. Centerline extremes (6,6)-(42,42).
...
SOURCE_ICON_ID = 'bb3acb4b-788b-5715-be4b-2e44ae64a08b'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/design/design tool stamp_bb3acb4b-788b-5715-be4b-2e44ae64a08b.svg'
AUTHOR = 'gpt-6'
CATALOG_REFERENCE = 'pictographic-primitives/design/design tool stamp_bb3acb4b-788b-5715-be4b-2e44ae64a08b.svg'
...
class Drawing(Solo48):
    icon_id = 'rubber-stamp-with-narrow-neck-grip'
    ...
    def build(self):
        ...
        self.add_line('neck-r2',(28,22),(28,26))
        self.add_line('neck-l2',(20,26),(20,22))
        self.add_contour('grip','neck-l2','neck-l','knob','neck-r','neck-r2')
