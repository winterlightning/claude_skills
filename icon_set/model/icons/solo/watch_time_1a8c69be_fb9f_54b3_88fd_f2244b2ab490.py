"""watch-time: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '1a8c69be-fb9f-54b3-88fd-f2244b2ab490'
SOURCE_PATH = 'pictographic-primitives/interface-essential/watch time_1a8c69be-fb9f-54b3-88fd-f2244b2ab490.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class WatchTime(Solo48):
    icon_id = 'watch-time'
    ...
    def build(self):
        # Plan: CIRCLE; one clean shared clock-hand node replaces a small curved detour.
