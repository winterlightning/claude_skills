"""Comfortable Padded Armchair.

Padded chair with outward flared arms, a distinct flat cushion and angled legs. Centerline extremes (6,6)-(42,42). Lucide armchair informs coherent frame and balanced mirrored halves. Retain flared sides; omit duplicate cushion edge.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '69002efb-1746-5370-a2c2-7f5501e62977'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/furnitures/sofa_69002efb-1746-5370-a2c2-7f5501e62977.svg'
AUTHOR = 'gpt-6'

class PaddedArmchairFlaredArms(Solo48):
    icon_id = 'padded-armchair-flared-arms'
    ...
    def build(self):
        # Symbol plan: Padded chair with outward flared arms, a distinct flat cushion and angled legs. Centerline extremes (6,6)-(42,42). Lucide armchair informs coherent frame and balanced mirrored halves. Retain flared sides; omit duplicate cushion edge.
        ...
        back_radius=6;arm_y=20;seat_y=26;bottom=34;inner=16 if True else 14;other=48-inner
