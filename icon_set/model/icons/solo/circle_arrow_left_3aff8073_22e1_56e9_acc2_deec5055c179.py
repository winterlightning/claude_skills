"""Circle arrow left (arrows), converted from the icons-json construction graph by json_to_solo --mode fit. CIRCLE keyshape; curves fitted to integer lines and arcs."""
...
class CircleArrowLeft(Solo48):
    icon_id = 'circle-arrow-left'
