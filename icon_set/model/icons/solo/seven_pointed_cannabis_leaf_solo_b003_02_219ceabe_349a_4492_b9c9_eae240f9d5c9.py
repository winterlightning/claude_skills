"""Seven Pointed Cannabis Leaf.
Plan: Five radiating pointed lobes in symmetric leaf outline; omit serrations. Stem follows source direction.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Five radiating pointed lobes in symmetric leaf outline; omit serrations. Stem follows source direction.
Keyshape: SQUARE; all geometry authored at SOLO48, never scaled.
Construction reference: Lucide cannabis; rounded contours and shared attachment nodes.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-003/references/cannabis_219ceabe-349a-4492-b9c9-eae240f9d5c9.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'seven-pointed-cannabis-leaf-solo-b003-02'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'objects'
    aliases = ()
    keywords = ('seven', 'pointed', 'cannabis', 'leaf')

    def build(self):
        s = self
        s.add_polyline('leaf',(24,6),(30,22),(40,14),(34,28),(42,32),(32,36),(24,34),(16,36),(6,32),(14,28),(8,14),(18,22),closed=True)
        s.add_line('stem',(24,34),(20,42));join(s,'stem','leaf')
