...
Plan: Two broad awning scallops and wide laptop base; small base recess omitted.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/e commerce shop_9f4bfb12-0d40-5a5f-a7aa-e2b3371ced5e.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '9f4bfb12-0d40-5a5f-a7aa-e2b3371ced5e'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/ecommerce/e commerce shop_9f4bfb12-0d40-5a5f-a7aa-e2b3371ced5e.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'online-marketplace-storefront-batch-007-02'
    keyshape = Keyshape.HRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "ecommerce"
    aliases = ()
    keywords = ('online', 'marketplace', 'storefront')
    ...
    def build(self):
        ...
        path('roof',(4,18),(8,8),(40,8),(44,18))
        line('awning-top',(4,18),(44,18))
        for i in range(2): arc(f'awning-{i}',(24+20*i,18),(4+20*i,18),10,8)
        path('screen',(4,18),(4,40),(44,40),(44,18))
        line('base',(4,40),(44,40))
