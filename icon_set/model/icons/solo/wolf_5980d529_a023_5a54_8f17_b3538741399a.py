...
class WolfHead(Solo48):
    ...
    def build(self) -> None:
        self.add_line('nape', (6, 40), (6, 25))
        self.add_arc('skull', (6, 25), (17, 7), radius_x=20, radius_y=20, sweep=True)
        self.add_line('ear-1', (17, 7), (24, 6))
        self.add_line('ear-2', (24, 6), (24, 12))
        self.add_arc('brow', (24, 12), (34, 20), radius_x=11, radius_y=11, sweep=True)
        self.add_line('muzzle', (34, 20), (42, 20))
        self.add_line('nose-front', (42, 20), (42, 24))
        self.add_arc('nose', (42, 24), (35, 32), radius_x=8, radius_y=8, sweep=True)
        self.add_line('jaw', (35, 32), (29, 32))
        self.add_arc('throat', (29, 32), (21, 40), radius_x=8, radius_y=8, sweep=False)
        self.add_arc('chest', (21, 40), (24, 42), radius_x=10, radius_y=10, sweep=False)
