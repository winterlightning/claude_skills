...
Plan: Attached notched ribbon and folder tab retained.
Construction reference: Lucide folder; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/folder bookmark_930dd44e-6822-5bd4-aa80-2235589f118e.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '930dd44e-6822-5bd4-aa80-2235589f118e'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/folders/folder bookmark_930dd44e-6822-5bd4-aa80-2235589f118e.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'folder-with-bookmark-batch-009-11'
    keyshape = Keyshape.HRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "folders"
    aliases = ()
    keywords = ('folder', 'with', 'bookmark')
    ...
    def build(self):
        ...
        path('folder',(4,40),(4,8),(16,8),(24,16),(44,16),(44,40),closed=True)
        path('bookmark',(24,16),(24,30),(30,26),(36,30),(36,16))
