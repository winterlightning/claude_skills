...
class PoliceCarFrontVariant2(Solo48):
    icon_id = 'police-car-front-v2'
    variant_of = 'police-car-front'
    ...
    def build(self) -> None:
        ...
        self.add_line('left-ray', (8, 4), (10, 4))
        self.add_dot('top-ray', (24, 4))
        self.add_line('right-ray', (38, 4), (40, 4))
