...
SOURCE_ICON_ID = '39569ded-3e41-5507-b7ca-fc669c005518'
SOURCE_PATH = 'pictographic-primitives/smileys/ouch_39569ded-3e41-5507-b7ca-fc669c005518.svg'
AUTHOR = 'gpt-6'


class PainedGrimacingFace(Solo48):
    icon_id = 'pained-grimacing-face'
    ...
    def build(self) -> None:
        ...
        self.add_arc("eye-left",(15,17),(19,17),radius_x=4,sweep=True)
