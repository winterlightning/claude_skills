...
class BathDuckVariant3(Solo48):
    icon_id = 'bath-duck-v3'
    ...
    def build(self) -> None:
        ...
        self.add_arc('back', (26, 26), (42, 23), radius_x=22, radius_y=12, sweep=False)
        self.add_contour('upper', 'head-top', 'head-back', 'neck', 'back', closed=False)
        self.add_line('tail', (42, 23), (42, 26))
        self.add_arc('body-right', (42, 26), (32, 40), radius_x=12, radius_y=14, sweep=True)
        ...
        self.add_line('bill-1', (13, 26), (6, 26))
        self.add_line('bill-2', (6, 26), (6, 18))
