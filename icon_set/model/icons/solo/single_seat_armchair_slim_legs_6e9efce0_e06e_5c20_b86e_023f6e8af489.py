"""Comfortable Single Seat Armchair.

Single-seat chair with broad back, rounded arms and long straight slim legs. Centerline extremes (6,6)-(42,42). Lucide armchair informs the integrated seat/arm topology; both legs share one length. Straight feet distinguish this source.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '6e9efce0-e06e-5c20-b86e-023f6e8af489'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/furnitures/sofa couch_6e9efce0-e06e-5c20-b86e-023f6e8af489.svg'
AUTHOR = 'gpt-6'
...
class SingleSeatArmchairSlimLegs(Solo48):
    ...
    category = 'furnitures'
    aliases = ()
    keywords = ('comfortable', 'single', 'seat', 'armchair')

    def build(self):
        # Symbol plan: Single-seat chair with broad back, rounded arms and long straight slim legs. Centerline extremes (6,6)-(42,42). Lucide armchair informs the integrated seat/arm topology; both legs share one length. Straight feet distinguish this source.
        ...
        back_radius=7;arm_y=18;seat_y=24;bottom=32;inner=16 if False else 14;other=48-inner
        ...
        if 'straight'=='block':
            ...
            for n,x,z in [('left',18,16 if 'straight'=='slant' else 18),('right',30,32 if 'straight'=='slant' else 30)]:
