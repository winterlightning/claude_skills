...
class WhaleTail(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("fluke-left-bottom",(18,25),(6,6),radius_x=26,sweep=True)
        ...
        self.add_arc("fluke-right-bottom",(42,6),(30,25),radius_x=26,sweep=True)
        ...
        self.add_arc("wave-left",(6,42),(16,42),radius_x=7,radius_y=4,sweep=False)
        self.add_arc("wave-middle",(16,42),(32,42),radius_x=8,radius_y=4,sweep=False)
        self.add_arc("wave-right",(32,42),(42,42),radius_x=7,radius_y=4,sweep=False)
