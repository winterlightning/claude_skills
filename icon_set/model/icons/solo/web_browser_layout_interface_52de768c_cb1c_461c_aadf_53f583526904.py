...
SOURCE_ICON_ID = '52de768c-cb1c-461c-aadf-53f583526904'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/websites/website build_52de768c-cb1c-461c-aadf-53f583526904.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'web-page-interface-layout-batch-006-09'
...
class Drawing(Solo48):
    icon_id = 'web-browser-layout-interface'
    variant_of = 'web-page-interface-layout-batch-006-09'
    variant_label = 'Web Browser Layout Interface'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'websites'
    aliases = ()
    keywords = ('web', 'browser', 'layout', 'interface', 'window', 'panel', 'grid', 'panels')
    def build(self):
        # Plan: A rounded rectangular window with a broad upper-left panel and a two-by-two grid of small panels at the upper right. The remaining lower area is empty.
        ...
        rr('window',4,8,44,40,2,top=(24,34),right=(16,24))
