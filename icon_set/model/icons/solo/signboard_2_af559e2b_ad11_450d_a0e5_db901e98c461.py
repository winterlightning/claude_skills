"""A broad blank sign on one central upright.
Symbol plan: rectangle-horizontal: matched corner radii and central support, independently authored for this UUID.
...
SOURCE_ICON_ID='af559e2b-ad11-450d-a0e5-db901e98c461'
SOURCE_PATH='icon_set/work/todo-references/signboard 2_af559e2b-ad11-450d-a0e5-db901e98c461.svg'
AUTHOR='gpt-6'

class Drawing(Solo48):
    icon_id='signboard-2-solo'
    keyshape=Keyshape.SQUARE
    semantic_role='MAIN'
    semantic_kind='noun'
    category = 'primitives-generate'
    aliases=()
    keywords=('signboard', '2')
