...
Plan: Offset documents with equal opposed chevrons; a vertical envelope gives both arrows clear space.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/compare_6518c2a3-c818-4cbb-b912-36d793d7d18b.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '6518c2a3-c818-4cbb-b912-36d793d7d18b'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/compare_6518c2a3-c818-4cbb-b912-36d793d7d18b.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'overlapping-documents-with-facing-arrows-batch-006-05'
    ...
    def build(self):
        ...
        rect('front-page',8,4,20,20)
        path('back-page',(36,16),(40,16),(40,44),(20,44),(20,32))
        path('arrow-right',(16,12),(20,14),(16,16))
        path('arrow-left',(32,32),(28,34),(32,36))
