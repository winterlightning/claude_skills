...
class MilestoneMarkerDividedVariant2(Solo48):
    icon_id = 'milestone-marker-divided-v2'
    variant_of = 'milestone-marker-divided'
    ...
    def build(self) -> None:
        ...
        self.add_polyline('plinth', (8, 36), (12, 36), (24, 36), (36, 36), (40, 36), (40, 44), (8, 44), closed=True)
        self.add_line('divider', (24, 16), (24, 36))
        for part in ('stone-left', 'stone-right', 'arch-base'):
            self.relate('connect', 'arch', part)
        self.relate('connect', 'stone-left', 'arch-base')
        self.relate('connect', 'stone-right', 'arch-base')
        for part in ('stone-left', 'stone-right', 'divider'):
            self.relate('connect', 'plinth', part)
