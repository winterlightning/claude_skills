...
Symbol plan: Wide cylindrical shell; elliptical cap shares its endpoints with the two straight walls.
Keyshape: HRECT_L; authored at SOLO48, never scaled from the source.
Reference construction: Lucide database.
Reduction: Dropped inset vertical seams in favor of a clear cylindrical cap.
"""
...
SAVED_SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/other/virtual environment 1_960eb0e0-a911-4c9c-883a-ff622c45b802.svg'
BRIEF_PATH = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-021/10-database-storage-cylinder--960eb0e0-a911-4c9c-883a-ff622c45b802.md'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-021/references/virtual environment 1_960eb0e0-a911-4c9c-883a-ff622c45b802.svg'

class GeneratedIcon(Solo48):
    icon_id = 'database-cylinder-batch-021-10'
    ...
    def build(self):
        ...
        def cross(name,x,y,r):
            for j,p in enumerate(((x-r,y),(x+r,y),(x,y-r),(x,y+r))):
                line(f'{name}-{j}',(x,y),p)
        path('shell',(4,16),('A',(44,16),20,8,True),('L',(44,32)),('A',(4,32),20,8,True),('L',(4,16)),closed=True)
        path('cap',(4,16),('A',(44,16),20,8,False))
