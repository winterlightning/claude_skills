...
SOURCE_ICON_ID = '14a6c16f-ee8a-432f-8cbe-d7df3e7f4874'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/crime/piracy liquor_14a6c16f-ee8a-432f-8cbe-d7df3e7f4874.svg'
AUTHOR = 'gpt-6'


class CorkedBottleWithLiquid(Solo48):
    icon_id = 'corked-bottle-with-liquid'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "crime"
    aliases = ()
    keywords = ('corked', 'bottle', 'with', 'liquid')
    ...
    def build(self):
        ...
        path('liquid',(17,33), [((24,33),4,3,True),((31,33),4,3,False)])
