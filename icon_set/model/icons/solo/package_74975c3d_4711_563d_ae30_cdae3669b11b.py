"""Package (shipping), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '74975c3d-4711-563d-ae30-cdae3669b11b'
SOURCE_PATH = 'pictographic-primitives/shipping/package_74975c3d-4711-563d-ae30-cdae3669b11b.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class Package(Solo48):
    icon_id = 'package'
