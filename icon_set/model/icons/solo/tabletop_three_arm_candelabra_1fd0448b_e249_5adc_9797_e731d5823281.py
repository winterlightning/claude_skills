...
class TabletopThreeArmCandelabra(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('left-candle', (10, 18), (10, 24))
        self.add_line('centre-flame', (24, 4), (24, 4))
        self.add_line('centre-candle', (24, 12), (24, 38))
        self.add_line('right-flame', (38, 7), (38, 10))
        self.add_line('right-candle', (38, 18), (38, 24))
        ...
        self.add_line('table', (8, 38), (40, 38))
        self.relate('connect', 'foot', 'table')
        self.relate('connect', 'centre-candle', 'table')
        self.add_line('leg-left', (8, 38), (8, 44))
        self.add_line('leg-right', (40, 38), (40, 44))
