"""Three overlapping blank folders stepping upward-right, each with a raised upper-left tab."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'a87869a0-d431-40d8-b441-35e78886b5de'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_12/coding apps website big data volume folder_a87869a0-d431-40d8-b441-35e78886b5de.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'folder'
DESIGN_NOTES = 'No defining feature omitted.'
CONSTRUCTION_REFERENCE = 'Lucide folder original and atomic-debug; coherent contours and shared attachment nodes.'

class Drawing(Solo48):
    icon_id = 'stacked-file-folders'
    variant_of = 'folder'
    variant_label = 'Stacked File Folders'
    ...
    aliases = ()
    keywords = ('stacked', 'file', 'folders', 'overlapping', 'stepping', 'upward', 'raised', 'tab')
    def build(self):
        # Plan: Three overlapping blank folders stepping upward-right, each with a raised upper-left tab.
        ...
        p('rear',(22,6),(30,6),(34,14),(42,14),(42,30))
        p('middle',(14,14),(22,14),(26,22),(34,22),(34,38))
        p('front',(6,22),(14,22),(18,30),(26,30),(26,42),(6,42),closed=True)
