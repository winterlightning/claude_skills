...
SOURCE_ICON_ID = 'c4f9e2f1-641c-4dbb-ae42-c4ce12aafedf'
SOURCE_PATH = 'icons-json/phones/mobile phone_c4f9e2f1-641c-4dbb-ae42-c4ce12aafedf.json'
AUTHOR = 'json_to_solo'

class MobilePhoneC4f9e2f1(Solo48):
    icon_id = 'mobile-phone-c4f9e2f1'
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (40, 40), (35, 44), radius_x=6)
        self.add_line('sym-e3', (35, 44), (24, 44))
        self.add_line('sym-e4', (24, 44), (13, 44))
        self.add_arc('sym-e5', (13, 44), (8, 40), radius_x=6)
        self.add_line('sym-e6', (8, 40), (8, 36))
        self.add_line('sym-e7', (8, 36), (8, 8))
        self.add_arc('sym-e8', (8, 8), (13, 4), radius_x=6)
        self.add_line('sym-e11', (13, 4), (24, 4))
        self.add_line('sym-e12', (24, 4), (35, 4))
        self.add_arc('sym-e15', (35, 4), (40, 8), radius_x=6)
        self.add_line('sym-e16', (40, 8), (40, 36))
        self.add_line('sym-e17', (24, 12), (24, 12))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e11', 'sym-e12', 'sym-e15', 'sym-e16')
