...
class Error500Label(Solo48):
    ...
    def build(self) -> None:
        self.add_line('five-cap-1', (10, 8), (6, 8))
        self.add_line('five-cap-2', (6, 8), (6, 24))
        self.add_line('five-cap-3', (6, 24), (7, 24))
        self.add_arc('five-bowl', (7, 24), (7, 40), radius_x=3, radius_y=8, sweep=True)
        self.add_line('five-foot', (7, 40), (6, 40))
        ...
        self.add_arc('zero-second-top', (36, 12), (42, 12), radius_x=4, radius_y=4, sweep=True)
        self.add_line('zero-second-right', (42, 12), (42, 36))
        self.add_arc('zero-second-bottom', (42, 36), (36, 36), radius_x=4, radius_y=4, sweep=True)
