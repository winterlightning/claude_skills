"""Open the pot rim and simplify the cactus to a tall center stem with larger mirrored branches. Applied to the original icon identity."""
...
class CactusInRimmedPot(Solo48):
    ...
    def build(self):
        ...
        poly('rim', (8, 28), (24, 28), (40, 28), (40, 36), (8, 36), closed=True)
        poly('pot', (13, 36), (16, 44), (32, 44), (35, 36))
        join('pot', 'rim')
