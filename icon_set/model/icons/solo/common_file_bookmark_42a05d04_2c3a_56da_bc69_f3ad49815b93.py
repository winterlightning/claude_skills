...
class CommonFileBookmark(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e8-1', (12, 44), (8, 40), radius_x=4)
        self.add_line('e8-2', (8, 40), (8, 39))
        self.add_line('e9-1', (8, 8), (9, 5))
        self.add_line('e9-2', (9, 5), (11, 4))
        self.add_line('e10-1', (37, 4), (39, 5))
        self.add_line('e10-2', (39, 5), (40, 8))
        self.add_arc('e10-3', (40, 8), (40, 9), radius_x=20, sweep=False)
        self.add_contour('c0', 'e0', 'e1', 'e2')
        self.add_contour('c1', 'e3', 'e7-1', 'e7-2', 'e4', 'e8-1', 'e8-2', 'e5', 'e9-1', 'e9-2', 'e6', 'e10-1', 'e10-2', 'e10-3', closed=True)
