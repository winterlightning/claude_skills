"""A kissing face with one wink and a small heart.
...
class KissingFaceWinkHeart(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('wink',(11,21),(19,21),radius_x=5,radius_y=4,sweep=False)
        self.add_arc('eye',(26,21),(34,21),radius_x=5,radius_y=4,sweep=True)
        self.add_polyline('kiss',(22,30),(26,32),(22,34))
