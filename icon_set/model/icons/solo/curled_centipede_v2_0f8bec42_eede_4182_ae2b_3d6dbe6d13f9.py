...
class CurledCentipedeVariant2(Solo48):
    icon_id = 'curled-centipede-v2'
    variant_of = 'curled-centipede'
    ...
    def build(self) -> None:
        ...
        self.add_arc('head', (12, 24), (12, 10), radius_x=6, radius_y=7, sweep=True)
        self.add_contour('body', 'crown-a', 'crown-b', 'side', 'base-r', 'base-l', 'inside', 'head', closed=True)
        self.add_line('top-left', (12, 10), (7, 6))
        self.relate('connect', 'body', 'top-left')
        self.add_line('top-mid', (24, 12), (26, 6))
        self.relate('connect', 'body', 'top-mid')
        self.add_line('top-right', (38, 26), (42, 20))
        self.relate('connect', 'body', 'top-right')
        self.add_line('low-right', (38, 32), (42, 39))
        self.relate('connect', 'body', 'low-right')
        self.add_line('base-leg', (28, 42), (28, 42))
        self.relate('connect', 'body', 'base-leg')
        self.add_line('left-leg', (12, 24), (6, 26))
