...
SOURCE_ICON_ID='48638845-8ed3-40d9-b091-9b8e634fd759'
SOURCE_PATH='icon_set/work/todo-references/square p text_48638845-8ed3-40d9-b091-9b8e634fd759.svg'
AUTHOR='gpt-6'
PLAN='Square containing a single-stroke uppercase P.'
CONSTRUCTION_REFERENCES='Lucide square-parking: upright stem and rounded upper bowl.'
OMISSIONS='None.'
KEYSHAPE_INK_BOUNDS=(4, 4, 44, 44)

class Drawing(Solo48):
    icon_id='square-p-text'
    ...
    def build(self):
        ...
        self.add_polyline('stem',(18,33),(18,25),(18,15),(24,15))
