...
class DogBark(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('e10-4', (24, 26), (18, 30), radius_x=14, radius_y=14, large_arc=False, sweep=True)
        self.add_arc('e10-5', (18, 30), (23, 32), radius_x=3, radius_y=3, large_arc=False, sweep=False)
