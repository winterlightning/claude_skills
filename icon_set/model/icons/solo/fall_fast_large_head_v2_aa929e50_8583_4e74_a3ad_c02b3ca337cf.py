...
class FallFastLargeHeadVariant2(Solo48):
    icon_id = 'fall-fast-large-head-v2'
    variant_of = 'fall-fast-large-head'
    ...
    def build(self):
        runs = [{'start': (6, 6), 'steps': [('L', 6, 14), ('A', 12, 20, 6, 6, False), ('L', 26, 20), ('A', 34, 28, 8, 8, True), ('L', 34, 42)], 'closed': False}, {'start': (26, 34), 'steps': [('L', 34, 42), ('L', 42, 34)], 'closed': False}]
        rotation = 0
