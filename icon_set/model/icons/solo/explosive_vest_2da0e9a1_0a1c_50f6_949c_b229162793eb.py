...
class ExplosiveVest(Solo48):
    icon_id = 'explosive-vest'
    ...
    def build(self):
        ...
        C('bomb',24,32,6)
        L('fuse',(24,26),(24,22));J('fuse','bomb')
        L('belt-left',(8,32),(18,32));L('belt-right',(30,32),(40,32))
        J('belt-left','vest');J('belt-left','bomb');J('belt-right','vest');J('belt-right','bomb')
