"""An oval blank head connects through a short neck to rounded shoulders. A large cross sits centrally on the plain shirt, below a curved collar line at the base of the neck.
Symbol plan: One shared Christian portrait for the two equivalent references. Round head and curved shoulders above a centered chest cross with a longer lower stem. Omit the narrow collar and anatomical neck outline.
...
SOURCE_ICON_ID = '68182df6-1dff-5401-a4da-f6323ae374b4'
SOURCE_PATH = 'pictographic-primitives/avatars/man christian_68182df6-1dff-5401-a4da-f6323ae374b4.svg'
SOURCE_CATEGORY = 'avatars'
AUTHOR = 'gpt-6'
SOURCE_REFERENCES = (('68182df6-1dff-5401-a4da-f6323ae374b4', 'pictographic-primitives/avatars/man christian_68182df6-1dff-5401-a4da-f6323ae374b4.svg'), ('75e45ed8-5dee-5b32-9ee5-2b293785e9c8', 'pictographic-primitives/avatars/man christian_75e45ed8-5dee-5b32-9ee5-2b293785e9c8.svg'))

class BatchSolo(Solo48):
    icon_id = 'christian-man-with-chest-cross'
    ...
    aliases = ()
    keywords = ('christian', 'man', 'with', 'chest', 'cross')
    ...
    def build(self):
        ...
        bottom=avatar_head();shoulders(bottom)
        self.add_polyline('body-cross-vertical',(24,32),(24,36),(24,44));self.add_polyline('body-cross-horizontal',(18,36),(24,36),(30,36));self.relate('connect','body-cross-vertical','body-cross-horizontal')
