...
SOURCE_ICON_ID = '88b4807d-4cf9-4887-b43d-8a077885bd04'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_10/cell border top_88b4807d-4cf9-4887-b43d-8a077885bd04.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'table-cell-top-border'
    variant_of = 'cell-border-full'
    variant_label = 'Table Cell Top Border'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('table', 'cell', 'border', 'wide', 'corners', 'dashed', 'center', 'dividers')
    def build(self):
        # Plan: A wide rectangular table with rounded lower corners, dashed center dividers and a separate horizontal top border above.
