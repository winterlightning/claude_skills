...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow double bottom_2eda92fd-b6ba-5559-a3bf-266f874236db.svg'
AUTHOR = 'gpt-6'

class ArrowDoubleBottom(Solo48):
    icon_id = 'arrow-double-bottom'
    ...
    def build(self):
        runs = [{'start': (8, 28), 'steps': [('L', 24, 44), ('L', 40, 28)], 'closed': False}, {'start': (8, 4), 'steps': [('L', 24, 20), ('L', 40, 4)], 'closed': False}]
        rotation = 0
