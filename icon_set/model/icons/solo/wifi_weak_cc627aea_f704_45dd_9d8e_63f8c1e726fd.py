...
class WifiWeak(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (4, 16), (23, 8), radius_x=28)
        self.add_line('sym-e3', (23, 8), (24, 8))
        self.add_line('sym-e4', (24, 8), (25, 8))
        self.add_arc('sym-e5', (25, 8), (44, 16), radius_x=29)
        self.add_arc('sym-e6', (12, 25), (24, 20), radius_x=18)
        self.add_arc('sym-e7', (24, 20), (36, 25), radius_x=18)
