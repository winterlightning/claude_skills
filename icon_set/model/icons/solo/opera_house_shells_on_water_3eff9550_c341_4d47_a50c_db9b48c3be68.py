...
class OperaHouseShellsOnWater(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('base', (6, 30), (42, 30))
        self.add_line('left-front-1', (7, 30), (6, 19))
        self.add_arc('left-roof', (6, 19), (19, 24), radius_x=23, sweep=True)
        self.add_line('main-front', (19, 24), (15, 8))
        self.add_arc('main-roof', (15, 8), (32, 24), radius_x=24, sweep=True)
        self.add_arc('right-roof', (32, 24), (42, 20), radius_x=23, sweep=True)
        self.add_line('right-front', (42, 20), (41, 30))
        ...
        self.add_arc('wave-left', (6, 37), (24, 37), radius_x=11, radius_y=3, sweep=False)
        self.add_arc('wave-right', (24, 37), (42, 37), radius_x=11, radius_y=3, sweep=False)
