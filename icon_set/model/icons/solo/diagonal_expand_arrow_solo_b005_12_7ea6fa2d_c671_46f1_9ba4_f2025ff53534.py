...
Plan: Northeast expand arrow with source corner or square and outer button; preserve direction.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Northeast expand arrow with source corner or square and outer button; preserve direction.
...
SOURCE_ICON_ID = '7ea6fa2d-c671-46f1-9ba4-f2025ff53534'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/resize expand corner_7ea6fa2d-c671-46f1-9ba4-f2025ff53534.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-005/references/resize expand corner_7ea6fa2d-c671-46f1-9ba4-f2025ff53534.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'diagonal-expand-arrow-solo-b005-12'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'objects'
    aliases = ()
    keywords = ('diagonal', 'expand', 'arrow')

    def build(self):
        s = self
        s.add_polyline('frame',(10,18),(10,6),(42,6),(42,38),(30,38))
        box(s,'source',6,28,20,42,2)
        arrow(s,'expand',(26,22),(32,16),7)
