"""Standalone voicemail with two matching loops joined along their baseline; loops elongated to fit current keyshape."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '06fe9ad6-66bf-5efc-9afe-5d64c2e9319b'
SOURCE_PATH = 'pictographic-primitives/phones/phone actions voice mail_06fe9ad6-66bf-5efc-9afe-5d64c2e9319b.svg'
AUTHOR = 'gpt-6'

class VoicemailSymbol(Solo48):
    ...
    def build(self):
        ...
        # Matching upright loops are elongated for the current horizontal envelope.
        for x in (11,37):
