...
class ResponsiveDesignExpand(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e7', (4, 11), (8, 8), radius_x=5)
        self.add_arc('e8', (41, 8), (44, 11), radius_x=3)
        self.add_line('e9-1', (4, 32), (4, 34))
        self.add_arc('e9-2', (4, 34), (5, 37), radius_x=7, sweep=False)
        self.add_arc('e9-3', (5, 37), (9, 40), radius_x=5, sweep=False)
        self.add_arc('e10', (40, 40), (44, 37), radius_x=5, sweep=False)
        self.add_contour('c0', 'e0', 'e7', 'e1', 'e8', 'e2')
        self.add_contour('c1', 'e3')
        self.add_contour('c2', 'e4', 'e9-1', 'e9-2', 'e9-3', 'e5', 'e10', 'e6')
