...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thick left bottom corner_7edc5400-5396-52a8-a848-07f2f6484c49.svg'
AUTHOR = 'gpt-6'

class ArrowThickLeftBottomCorner7edc5400(Solo48):
    icon_id = 'arrow-thick-left-bottom-corner-7edc5400'
    ...
    def build(self):
        runs = [{'start': (32, 42), 'steps': [('L', 24, 34), ('L', 42, 16), ('L', 32, 6), ('L', 14, 24), ('L', 6, 16), ('L', 6, 42), ('L', 32, 42)], 'closed': True}]
        rotation = 0
