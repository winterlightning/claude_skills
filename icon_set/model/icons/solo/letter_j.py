"""The lowercase letter j, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 10, top 4, right 38, bottom 44.
Plan: A dotted descender with a quarter-circle hook and baseline terminal.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/J.svg'
AUTHOR = 'gpt-6'


class LetterJ(Solo48):
    icon_id = 'letter-j'
    ...
    typeface = {'character': 'j', 'kind': 'lowercase', 'body_band': (18, 36)}
    aliases = ()
    keywords = ('j', "typeface", "typography", 'lowercase')

    def build(self):
        rotation = 0
        mirror = False
        runs = [((38,18), [('L',38,30),('A',24,44,14,14,True),('L',10,44)],False)]
        self.add_dot('tittle',(38,4))
