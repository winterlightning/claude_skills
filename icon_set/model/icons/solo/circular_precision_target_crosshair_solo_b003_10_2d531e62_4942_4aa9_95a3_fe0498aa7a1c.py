"""Circular Precision Target Crosshair.
...
SOURCE_ICON_ID = '2d531e62-4942-4aa9-95a3-fe0498aa7a1c'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/container/target 2_2d531e62-4942-4aa9-95a3-fe0498aa7a1c.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-003/references/target 2_2d531e62-4942-4aa9-95a3-fe0498aa7a1c.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'circular-precision-target-crosshair-solo-b003-10'
    keyshape = Keyshape.CIRCLE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'objects'
    aliases = ()
    keywords = ('circular', 'precision', 'target', 'crosshair')
    ...
    def build(self):
        ...
        for j,(a,z) in enumerate([((24,24-r),(24,24-20)),((24+r,24),(24+20,24)),((24,24+r),(24,24+20)),((24-r,24),(24-20,24))]):
