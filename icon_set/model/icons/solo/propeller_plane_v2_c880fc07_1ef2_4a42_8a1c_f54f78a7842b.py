...
class PropellerPlaneVariant2(Solo48):
    icon_id = 'propeller-plane-v2'
    variant_of = 'propeller-plane'
    ...
    def build(self) -> None:
        ...
        self.add_polyline('airframe', (36, 23), (42, 12), (38, 6), (34, 6), (24, 18), (14, 18), (8, 10), (6, 12), (6, 16), (12, 26), (16, 28), (10, 40), (16, 42), (24, 31))
