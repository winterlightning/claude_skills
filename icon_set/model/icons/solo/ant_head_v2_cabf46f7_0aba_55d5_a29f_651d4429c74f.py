...
class AntHeadVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('mouth-bottom-1', (29, 39), (29, 44))
        self.add_line('mouth-bottom-2', (29, 44), (19, 44))
        self.add_line('mouth-bottom-3', (19, 44), (19, 39))
        ...
        self.add_polyline('antenna-left', (20, 18), (20, 8), (14, 4), closed=False)
        ...
        self.add_polyline('antenna-right', (28, 18), (28, 8), (34, 4), closed=False)
