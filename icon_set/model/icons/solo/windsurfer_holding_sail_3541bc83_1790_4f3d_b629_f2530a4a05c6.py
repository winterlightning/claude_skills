...
class WindsurferHoldingSail(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('head-top', (8, 14), (12, 14), radius_x=2, radius_y=2, sweep=True)
        self.add_arc('head-bottom', (12, 14), (8, 14), radius_x=2, radius_y=2, sweep=True)
        ...
        self.relate("connect", 'rider', 'sail-mast')
