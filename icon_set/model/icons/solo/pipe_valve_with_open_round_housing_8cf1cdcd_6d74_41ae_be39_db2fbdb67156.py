...
SOURCE_ICON_ID = '8cf1cdcd-6d74-41ae-be39-db2fbdb67156'
SOURCE_PATH = 'pictographic-primitives/construction/valve_8cf1cdcd-6d74-41ae-be39-db2fbdb67156.svg'
AUTHOR = 'gpt-6'
...
class PipeValveWithOpenRoundHousing(Solo48):
    ...
    def build(self):
        axis=14
        path(self,'housing',(axis,14),('A',(4,24),10,10,False),('A',(axis,34),10,10,False))
