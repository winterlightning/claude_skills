...
class HardHatWithWideCurvedBrim(Solo48):
    ...
    def build(self):
        ...
        self.add_line('side-left',(8,32),(8,24))
        self.add_line('side-right',(40,24),(40,32))
        self.add_contour('shell','side-left','crown-left','crown-right','side-right')
        self.add_polyline('brim-top',(4,32),(8,32),(40,32),(44,32))
        self.add_arc('brim-bottom',(44,32),(4,32),radius_x=20,radius_y=8)
