...
class WhaleWithSpout(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("back",(6,31),(16,19),radius_x=14,radius_y=12)
        ...
        self.add_arc("tail-right",(42,6),(42,19),radius_x=30)
        self.add_arc("rump",(42,19),(25,42),radius_x=27)
        self.add_arc("belly",(25,42),(6,31),radius_x=23,radius_y=15)
        ...
        self.add_arc("spray-left",(8,6),(16,10),radius_x=8)
        self.add_arc("spray-right",(16,10),(24,6),radius_x=8)
