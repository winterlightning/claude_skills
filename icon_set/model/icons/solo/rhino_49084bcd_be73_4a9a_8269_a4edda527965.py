"""Downward-facing rhino head, open neck and sweeping jaw. Source sets tilt and single horn. Centerline (6,6)-(42,42)."""
...
class RhinoHead(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('upper-1', (6, 6), (14, 9), radius_x=20, radius_y=12, sweep=True)
        self.add_line('upper-2', (14, 9), (18, 6))
        self.add_arc('upper-3', (18, 6), (20, 20), radius_x=8, radius_y=12, sweep=True)
