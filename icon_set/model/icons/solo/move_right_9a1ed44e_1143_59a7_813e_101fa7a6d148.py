...
class MoveRight(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e4', (12, 8), (13, 8))
        self.add_arc('sym-e5', (13, 8), (16, 11), radius_x=3)
        self.add_line('sym-e6', (16, 11), (16, 24))
        self.add_line('sym-e7', (16, 24), (16, 37))
        self.add_arc('sym-e8', (16, 37), (13, 40), radius_x=3)
        self.add_line('sym-e9', (13, 40), (12, 40))
        ...
        self.add_arc('sym-e14', (4, 11), (7, 8), radius_x=3)
