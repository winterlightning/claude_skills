"""A horizontal battery has a right terminal and a stepped internal boundary that rises near its right side."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'e5f79193-cb40-43a4-9c47-47a790565e33'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_06/battery three quarters_e5f79193-cb40-43a4-9c47-47a790565e33.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'battery-1'
DESIGN_NOTES = 'No defining feature omitted.'
CONSTRUCTION_REFERENCE = 'Lucide battery original and atomic-debug; coherent contours and shared attachment nodes.'

class Drawing(Solo48):
    icon_id = 'battery-with-stepped-level'
    variant_of = 'battery-1'
    variant_label = 'Battery with Stepped Level'
    ...
    aliases = ()
    keywords = ('battery', 'stepped', 'level', 'terminal', 'internal', 'boundary', 'rises')
    def build(self):
        # Plan: A horizontal battery has a right terminal and a stepped internal boundary that rises near its right side.
        ...
        rr('battery',4,8,36,40,3,left=(32,),right=(24,32),bottom=(28,))
        p('terminal',(36,24),(44,24),(44,32),(36,32))
        p('level',(4,32),(28,32),(28,24),(36,24))
