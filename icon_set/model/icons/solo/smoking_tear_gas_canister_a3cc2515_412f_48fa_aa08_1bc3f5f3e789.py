...
class SmokingTearGasCanister(Solo48):
    icon_id = 'smoking-tear-gas-canister'
    ...
    def build(self):
        ...
        L('outlet',(28,38),(33,38));J('outlet','canister')
        A('smoke-lower',(33,38),(40,27),7,11,s=False)
        A('smoke-upper',(40,27),(30,16),10,11,s=False)
        A('smoke-tip',(30,16),(20,6),10,12)
        self.add_contour('smoke','smoke-lower','smoke-upper','smoke-tip');J('smoke','outlet')
