...
'A crocodile in water with a single horizontal snout line. HRECT_M extremes (6,11)-(42,37) preserve the low aquatic profile. The rectangular mouth return is removed; brow, eye and waves remain. No useful local Lucide crocodile match. Right-facing asymmetry is intentional.'
...
class CrocodileInWaterVariant4(Solo48):
    ...
    def build(self) -> None:
        self.add_line('water-left', (6, 19), (10, 19))
        ...
        self.add_line('snout-top', (35, 19), (42, 19))
        self.add_contour('crocodile', 'water-left', 'ridge-up', 'ridge-down', 'back', 'brow', 'snout-top')
        self.add_dot('eye', (27, 19))
        self.add_arc('wave-left', (6, 32), (16, 32), radius_x=7, radius_y=5, sweep=False)
        self.add_arc('wave-middle', (16, 32), (32, 32), radius_x=8, radius_y=5, sweep=False)
        self.add_arc('wave-right', (32, 32), (42, 32), radius_x=7, radius_y=5, sweep=False)
