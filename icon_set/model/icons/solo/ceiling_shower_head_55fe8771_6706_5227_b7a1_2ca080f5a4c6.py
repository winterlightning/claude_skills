...
SOURCE_ICON_ID = '55fe8771-6706-5227-b7a1-2ca080f5a4c6'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/hotels/bathroom shower head_55fe8771-6706-5227-b7a1-2ca080f5a4c6.svg'
AUTHOR = 'gpt-6'


class IconCeilingShowerHead(Solo48):
    icon_id = 'ceiling-shower-head'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'hotels'
    aliases = ()
    keywords = ('ceiling', 'shower', 'head')
