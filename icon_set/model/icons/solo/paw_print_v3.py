...
class PawPrintVariant3(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('outer-left-top', (6, 23), (12, 23), radius_x=3, radius_y=3)
        self.add_arc('outer-left-bottom', (12, 23), (6, 23), radius_x=3, radius_y=3)
        ...
        self.add_arc('outer-right-top', (36, 23), (42, 23), radius_x=3, radius_y=3)
        self.add_arc('outer-right-bottom', (42, 23), (36, 23), radius_x=3, radius_y=3)
        self.add_contour('outer-right', 'outer-right-top', 'outer-right-bottom', closed=True)
        self.add_arc('pad-crown', (16, 37), (32, 37), radius_x=8, radius_y=10)
        self.add_arc('pad-right-lobe', (32, 37), (28, 42), radius_y=9, radius_x=4)
        ...
        self.add_arc('pad-left-lobe', (20, 42), (16, 37), radius_y=9, radius_x=4)
