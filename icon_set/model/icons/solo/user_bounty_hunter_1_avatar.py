"""user-bounty-hunter-1: shoulder strap with reference head silhouette.
...
Body cue: shoulder strap. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-09/references/user-bounty-hunter-1.svg'
SOURCE_HEAD_ICON_ID = 'user-bounty-hunter-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class UserBountyHunter1Avatar(Solo48):
    icon_id = 'user-bounty-hunter-1-avatar'
    ...
    def build(self):
        ...
        self.add_line('tie',(34,16),(40,24))
        self.relate('connect','tie','brim')
