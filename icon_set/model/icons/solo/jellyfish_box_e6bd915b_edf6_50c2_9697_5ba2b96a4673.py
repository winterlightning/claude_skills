...
class Jellyfish(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('bell-left', (6, 22), (24, 6), radius_x=19, radius_y=20, sweep=True)
        self.add_arc('bell-right', (24, 6), (42, 22), radius_x=19, radius_y=20, sweep=True)
        self.add_line('rim-0', (42, 22), (34, 22))
        self.add_line('rim-1', (34, 22), (24, 22))
        self.add_line('rim-2', (24, 22), (14, 22))
        self.add_line('rim-3', (14, 22), (6, 22))
        ...
        self.add_arc('tentacle-0-lower', (12, 34), (14, 42), radius_x=10, radius_y=10, sweep=False)
        ...
        self.add_arc('tentacle-1-lower', (22, 34), (24, 42), radius_x=10, radius_y=10, sweep=False)
        ...
        self.add_arc('tentacle-2-lower', (32, 34), (34, 42), radius_x=10, radius_y=10, sweep=False)
