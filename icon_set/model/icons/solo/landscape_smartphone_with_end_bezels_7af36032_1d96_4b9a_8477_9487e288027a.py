"""Landscape phone with equal end bezels and a centered blank screen.
...
SOURCE_ICON_ID = '7af36032-1d96-4b9a-8477-9487e288027a'
SOURCE_PATH = 'pictographic-primitives/phones/mobile phone horizontal_7af36032-1d96-4b9a-8477-9487e288027a.svg'
AUTHOR = 'gpt-6'

class LandscapeSmartphoneWithEndBezels(Solo48):
    icon_id = 'landscape-smartphone-with-end-bezels'
    ...
    def build(self):
        ...
        box(4,8,44,40,xs=(14,34))
        for x in (14,34): seam(f'bezel-{x}',(x,8),(x,40))
