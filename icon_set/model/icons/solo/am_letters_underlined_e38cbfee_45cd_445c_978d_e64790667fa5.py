...
class AmLettersUnderlined(Solo48):
    icon_id = 'am-letters-underlined'
    ...
    def build(self) -> None:
        ...
        self.add_line('m-leg-0', (28, 31), (28, 20))
        ...
        self.add_line('m-leg-1', (36, 31), (36, 20))
        self.add_arc('m-arch-1', (36, 24), (42, 24), radius_x=4, radius_y=4, sweep=True)
        self.add_line('m-down-1', (42, 24), (42, 31))
