...
class PathfinderUnite(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e8', (28, 8), (26, 6), radius_x=2, sweep=False)
        self.add_line('e9-1', (9, 6), (6, 7))
        self.add_line('e9-2', (6, 7), (6, 8))
        self.add_line('e10', (6, 27), (7, 29))
        self.add_line('e11', (17, 29), (18, 31))
        self.add_line('e12', (18, 40), (20, 42))
        self.add_arc('e13', (40, 42), (42, 40), radius_x=2, sweep=False)
        self.add_line('e14', (42, 21), (40, 18))
        self.add_arc('e15', (29, 18), (28, 15), radius_x=6)
        self.add_contour('c0', 'e0', 'e8', 'e1', 'e9-1', 'e9-2', 'e2', 'e10', 'e3', 'e11', 'e4', 'e12', 'e5', 'e13', 'e6', 'e14', 'e7', 'e15', closed=True)
