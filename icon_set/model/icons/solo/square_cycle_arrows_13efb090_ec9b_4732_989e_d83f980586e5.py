"""Square Cycle Arrows — independently authored for batch 49."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '13efb090-ec9b-4732-989e-d83f980586e5'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/synchronize arrows square_13efb090-ec9b-4732-989e-d83f980586e5.svg'
AUTHOR = 'gpt-6'

class BatchIcon(Solo48):
    icon_id = 'square-cycle-arrows'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "interface-essential"
    aliases = ()
    keywords = ('square', 'cycle', 'arrows')
