...
class PottyWithLid(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('base-1', (6, 34), (6, 42))
        self.add_line('base-2', (6, 42), (16, 42))
        self.add_arc('base-3', (16, 42), (32, 42), radius_x=8, radius_y=8, sweep=True)
        self.add_line('base-4', (32, 42), (42, 42))
        self.add_line('base-5', (42, 42), (42, 34))
