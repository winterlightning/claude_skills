...
SOURCE_PATH = 'pictographic-primitives/arrows/diagram arrow corner point right_6b198725-2cd8-572f-9de2-14b59f73ede4.svg'
AUTHOR = 'gpt-6'

class DiagramArrowCornerPointRight(Solo48):
    icon_id = 'diagram-arrow-corner-point-right'
    ...
    def build(self):
        runs = [{'start': (42, 6), 'steps': [('L', 17, 6), ('A', 15, 8, 2, 2, False), ('L', 15, 42)], 'closed': False}, {'start': (6, 33), 'steps': [('L', 15, 42), ('L', 24, 33)], 'closed': False}]
        rotation = 3
