# Variant of arrow-badge-bottom-arrows; parent file remains unchanged.
...
class ArrowBadgeBottomArrowsVariant2(Solo48):
    icon_id = 'arrow-badge-bottom-arrows-v2'
    variant_of = 'arrow-badge-bottom-arrows'
