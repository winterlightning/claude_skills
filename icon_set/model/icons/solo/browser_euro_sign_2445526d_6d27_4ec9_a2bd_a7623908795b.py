"""A browser window with a centered single-bar euro sign.
Symbol plan: panels-top-left: rounded frame and joined header; euro: open currency contour and crossbar.
...
class Drawing(Solo48):
    ...
    def euro(self,x):
        ...
        self.add_polyline('crossbar',(x-9,28),(x-8,28),(x,28));self.relate('connect','euro','crossbar')
