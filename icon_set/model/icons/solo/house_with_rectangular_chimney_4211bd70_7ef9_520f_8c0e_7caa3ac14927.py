"""House with Rectangular Chimney; standalone reconstruction of the supplied reference.
...
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/house chimney_4211bd70-7ef9-520f-8c0e-7caa3ac14927.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'house-with-rectangular-chimney'
    ...
    def build(self):
        ...
        left,right=10,38
        base=42
        self.add_polyline("roof", (6,24),(10,20),(24,6),(30,12),(30,6),(38,6),(38,20),(42,24))
