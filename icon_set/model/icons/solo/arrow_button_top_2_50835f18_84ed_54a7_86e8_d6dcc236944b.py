...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow button top 2_50835f18-84ed-54a7-86e8-d6dcc236944b.svg'
AUTHOR = 'gpt-6'
...
class ArrowButtonTop2(Solo48):
    ...
    def build(self):
        runs = [{'start': (4, 40), 'steps': [('L', 24, 8), ('L', 44, 40)], 'closed': True}]
        rotation = 0
