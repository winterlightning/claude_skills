# Variant of overhead-barbell-lifter; parent file remains unchanged.
...
class OverheadBarbellLifterVariant2(Solo48):
    icon_id = 'overhead-barbell-lifter-v2'
    variant_of = 'overhead-barbell-lifter'
