"""user-robot: robot torso seam with reference head silhouette.
...
Body cue: robot torso seam. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-robot.svg'
SOURCE_HEAD_ICON_ID = 'user-robot'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 32
class UserRobotAvatar(Solo48):
    icon_id = 'user-robot-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'robot', 'portrait', 'bust')
    def build(self):
        ...
        self.add_line('visor',(21,20),(27,20))
