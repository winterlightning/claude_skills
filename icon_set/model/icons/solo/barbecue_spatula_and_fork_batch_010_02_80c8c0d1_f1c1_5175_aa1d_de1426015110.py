...
Plan: Spatula with central slot and two-prong fork; grips reduced to thick strokes.
Construction reference: Lucide cable; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-010/references/barbecue set_80c8c0d1-f1c1-5175-aa1d-de1426015110.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '80c8c0d1-f1c1-5175-aa1d-de1426015110'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/food/barbecue set_80c8c0d1-f1c1-5175-aa1d-de1426015110.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'barbecue-spatula-and-fork-batch-010-02'
    ...
    aliases = ()
    keywords = ('barbecue', 'spatula', 'and', 'fork')
    ...
    def build(self):
        ...
        rect('spatula',6,6,16,18)
        line('spatula-slot',(14,14),(14,16))
        line('shaft-left',(14,24),(14,42))
        path('fork',(32,6),(32,20),(42,20),(42,6))
        line('shaft-right',(37,20),(37,42))
