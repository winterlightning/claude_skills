...
class ArrowRightVariant2(Solo48):
    icon_id = 'arrow-right-2dabd652-v2'
    variant_of = 'arrow-right-2dabd652'
    ...
    def build(self):
        runs = [{'start': (4, 40), 'steps': [('A', 28, 16, 24, 24, True), ('L', 44, 16)], 'closed': False}, {'start': (34, 8), 'steps': [('L', 44, 16), ('L', 34, 24)], 'closed': False}]
        rotation = 0
