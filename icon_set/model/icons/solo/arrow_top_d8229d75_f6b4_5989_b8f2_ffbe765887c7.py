...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow top_d8229d75-f6b4-5989-b8f2-ffbe765887c7.svg'
AUTHOR = 'gpt-6'

class ArrowTop(Solo48):
    icon_id = 'arrow-top'
    ...
    def build(self):
        runs = [{'start': (40, 22), 'steps': [('L', 24, 4)], 'closed': False}, {'start': (8, 22), 'steps': [('L', 24, 4), ('L', 24, 44)], 'closed': False}]
        rotation = 0
