...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_27/modern music drums_bfff7043-ece0-4457-96f0-b41a431cceaa.svg'
AUTHOR = 'gpt-6'
...
class BatchIcon(Solo48):
    ...
    def build(self):
        ...
        circle('bass',24,36,6)
        circle('tom-a',14,19,4);circle('tom-b',34,19,4)
        line('cymbal-a',(6,6),(18,6));line('stem-a',(6,6),(6,8))
        line('cymbal-b',(30,6),(42,6));line('stem-b',(42,6),(42,8))
