"""Uppercase Y for SOLO48; centerline envelope (10, 4)–(38, 44).
...
class LetterYUppercase(Solo48):
    icon_id = 'letter-y-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'Y', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('Y', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        junction=(24,24)
        runs=[((10,4),[('L',*junction),('L',38,4)],False),(junction,[('L',24,44)],False)]
