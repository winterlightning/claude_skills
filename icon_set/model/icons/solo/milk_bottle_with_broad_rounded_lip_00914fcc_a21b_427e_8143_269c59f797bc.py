...
SOURCE_ICON_ID = '00914fcc-a21b-427e-8143-269c59f797bc'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/drinks/milk_00914fcc-a21b-427e-8143-269c59f797bc.svg'
AUTHOR = 'gpt-6'


class Drawing(Solo48):
    icon_id = 'milk-bottle-with-broad-rounded-lip'
    ...
    aliases = ()
    keywords = ('classic', 'glass', 'milk', 'bottle')
