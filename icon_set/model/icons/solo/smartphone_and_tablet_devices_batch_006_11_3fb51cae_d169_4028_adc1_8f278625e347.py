...
Plan: Unequal overlapping devices; tiny phone control removed.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/ios ipados devices_3fb51cae-d169-4028-adc1-8f278625e347.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '3fb51cae-d169-4028-adc1-8f278625e347'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/devices/ios ipados devices_3fb51cae-d169-4028-adc1-8f278625e347.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    ...
    aliases = ()
    keywords = ('smartphone', 'and', 'tablet', 'devices')
    ...
    def build(self):
        ...
        rect('phone',6,20,16,22,3)
        path('tablet',(14,11),(14,6),(42,6),(42,42),(30,42))
        line('tablet-control',(31,33),(33,33))
