...
centerline extremes (8,4)-(40,44). Head bottom 28, body top 36;
...
class FamousPeopleWitchAvatar(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('hat',(10,20),(22,4),(38,4),(30,12),(36,20),(10,20))
        ...
        # Body cue: curved cape with a central opening; smooth shoulders remain primary.
