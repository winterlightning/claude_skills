...
Plan: Unequal plugs and a tall serpentine cable; small identifiers omitted.
Construction reference: Lucide cable; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/thunderbolt cable_0df11177-f26b-418b-88d9-7a1b4a229799.svg
"""
...
class GeneratedSolo(Solo48):
    icon_id = 'thunderbolt-charging-power-cable-batch-008-06'
    ...
    def build(self):
        ...
        rect('plug-left',6,6,10,16)
        rect('plug-right',32,26,10,16)
        line('left-stub',(11,22),(11,33))
        arc('loop-bottom',(11,33),(24,33),7,9,False)
        line('loop-rise',(24,33),(24,15))
        arc('loop-top',(24,15),(37,15),7,9)
        line('right-stub',(37,15),(37,26))
