...
SOURCE_ICON_ID = '8dd9f306-2770-406b-9d7b-a5378ab62a38'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/interface-essential/cell select_8dd9f306-2770-406b-9d7b-a5378ab62a38.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'camera-focus-corners'
...
class Drawing(Solo48):
    icon_id = 'rectangular-selection-frame'
    variant_of = 'camera-focus-corners'
    variant_label = 'Rectangular Selection Frame'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'interface-essential'
    aliases = ()
    keywords = ('selection', 'frame', 'separated', 'corner', 'brackets', 'surround', 'rectangle')
    def build(self):
        # Plan: Four separated rounded corner brackets surround a horizontal rounded rectangle.
        ...
        for j,pts in enumerate([[(4,16),(4,8),(12,8)],[(36,8),(44,8),(44,16)],[(44,32),(44,40),(36,40)],[(12,40),(4,40),(4,32)]]): p(f'corner-{j}',*pts)
        rr('selection',12,18,36,30,3)
