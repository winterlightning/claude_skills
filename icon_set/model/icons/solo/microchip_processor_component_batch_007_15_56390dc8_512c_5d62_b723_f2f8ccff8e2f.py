...
Plan: Repeated three-pin series on each side, blank chip body; shared pitch and attachment points.
Construction reference: Lucide cpu; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/electronics integrated circuit_56390dc8-512c-5d62-b723-f2f8ccff8e2f.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '56390dc8-512c-5d62-b723-f2f8ccff8e2f'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/electronics integrated circuit_56390dc8-512c-5d62-b723-f2f8ccff8e2f.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'microchip-processor-component-batch-007-15'
    ...
    def build(self):
        ...
        rect('chip',12,12,24,24,4)
        for j in range(3):
            v=16+8*j
            line(f'pin-top-{j}',(v,6),(v,12))
            line(f'pin-bottom-{j}',(v,36),(v,42))
            line(f'pin-left-{j}',(6,v),(12,v))
            line(f'pin-right-{j}',(36,v),(42,v))
