...
SOURCE_ICON_ID = 'b8f0aaaa-1584-5336-93df-4a4fb432a43a'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/furnitures/dresser_b8f0aaaa-1584-5336-93df-4a4fb432a43a.svg'
AUTHOR = 'gpt-6'


class ThreeDrawerDresserShortPulls(Solo48):
    icon_id = 'three-drawer-dresser-short-pulls'
    ...
    def build(self):
        # Plan: Three equal drawer fronts within one softly rounded cabinet; two equal legs. Extremes (8,4)-(40,44).
        ...
        l,t,r,b,foot = (8,4,40,40,44) if True else (6,6,42,36,42)
        step=(b-t)//3
