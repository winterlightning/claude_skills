"""Speech Bubble with Text. Authored directly on SOLO48 for later user-requested sub reuse.
...
class Drawing(Solo48):
    icon_id = 'speech-bubble-with-text-solo'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    tags = ('sub icon',)
    keywords = ('sub icon', 'speech bubble with text')
    def build(self):
        ...
        self.add_line('text-top',(15,15),(33,15))
        self.add_line('text-bottom',(15,25),(27,25))
