...
class LiddedCeremonialUrnVariant2(Solo48):
    ...
    def build(self) -> None:
        # VRECT_M extremes (11,6)-(37,42); matching circular shoulders.
        self.add_line('lid',(15,6),(33,6))
        self.add_line('neck-left',(18,6),(18,10))
        ...
        self.add_line('neck-right',(30,10),(30,6))
        ...
        self.add_line('stem',(24,38),(24,42))
