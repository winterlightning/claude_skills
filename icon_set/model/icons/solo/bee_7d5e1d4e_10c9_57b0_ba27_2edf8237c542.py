...
SOURCE_PATH = 'pictographic-primitives/animals/bee_7d5e1d4e-10c9-57b0-ba27-2edf8237c542.svg'
AUTHOR = 'gpt-6'


class BeeWithRoundedWings(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('stripe-24', (16, 24), (32, 24))
        self.relate("connect", 'body', 'stripe-24')
        self.add_line('stripe-32', (16, 32), (32, 32))
        self.relate("connect", 'body', 'stripe-32')
        self.add_line('stinger', (24, 42), (24, 46))
        self.relate("connect", 'body', 'stinger')
        self.add_arc('left-wing-upper', (16, 18), (2, 26), radius_x=14, radius_y=8, sweep=False)
        self.add_arc('left-wing-lower', (2, 26), (16, 34), radius_x=14, radius_y=8, sweep=False)
        ...
        self.add_arc('right-wing-upper', (32, 18), (46, 26), radius_x=14, radius_y=8, sweep=True)
        self.add_arc('right-wing-lower', (46, 26), (32, 34), radius_x=14, radius_y=8, sweep=True)
