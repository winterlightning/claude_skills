"""Building tall (office), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
...
class BuildingTall(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e5', (24, 32), (20, 35), radius_x=3, sweep=False)
        self.add_line('sym-e6', (20, 35), (20, 42))
        self.add_line('sym-e7', (24, 6), (12, 6))
        self.add_line('sym-e8', (12, 6), (11, 6))
        self.add_arc('sym-e9', (11, 6), (10, 8), radius_x=4, sweep=False)
        self.add_line('sym-e10', (10, 8), (10, 42))
        self.add_line('sym-e11', (20, 13), (20, 16))
        self.add_line('sym-e12', (20, 22), (20, 26))
        self.add_arc('sym-e13', (24, 32), (28, 35), radius_x=3)
        self.add_line('sym-e14', (28, 35), (28, 42))
        self.add_line('sym-e15', (24, 6), (36, 6))
        self.add_line('sym-e16', (36, 6), (37, 6))
        self.add_line('sym-e17', (37, 6), (38, 8))
