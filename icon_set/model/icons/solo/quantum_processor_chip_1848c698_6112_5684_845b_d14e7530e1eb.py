"""A microchip has two pins on each side and a diagonal trace running from its lower-left boundary through a small circular node."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '1848c698-6112-5684-845b-d14e7530e1eb'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/programing/amazon braket quantum computing_1848c698-6112-5684-845b-d14e7530e1eb.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'quantum-processor-chip'
    variant_of = 'chip-symbol'
    variant_label = 'Quantum Processor Chip'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'programing'
    aliases = ()
    keywords = ('quantum', 'processor', 'chip', 'microchip', 'pins', 'diagonal', 'trace', 'running')
    def build(self):
        # Plan: A microchip has two pins on each side and a diagonal trace running from its lower-left boundary through a small circular node.
        ...
        rr('chip',12,12,36,36,2,top=(18,30),bottom=(18,30),left=(18,30),right=(18,30))
        for j,t in enumerate([18,30]):
         l(f'top-{j}',(t,6),(t,12));l(f'bottom-{j}',(t,36),(t,42));l(f'left-{j}',(6,t),(12,t));l(f'right-{j}',(36,t),(42,t))
        c('node',24,24,3)
        l('trace-low',(18,36),(24,27));l('trace-high',(27,24),(32,20))
