"""woman-swimmer-1: swimsuit neckline with reference head silhouette.
...
Body cue: swimsuit neckline. Shared parameters own mirrored elements.
"""
...
class WomanSwimmer1Avatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('woman', 'swimmer', '1', 'portrait', 'bust')
    def build(self):
