"""House with Open Arched Entrance; standalone reconstruction of the supplied reference.
...
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/house_227ad5a9-e803-58fe-a499-6f8e9c5274e9.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'house-with-open-arched-entrance'
