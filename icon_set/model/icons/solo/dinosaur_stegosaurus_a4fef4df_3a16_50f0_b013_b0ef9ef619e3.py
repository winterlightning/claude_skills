"""Stegosaurus facing right, with three broad dorsal plates. Centerlines (6,8)-(42,40). Plate silhouette replaces fine separated plates; two visible legs replace four."""
...
class Stegosaurus(Solo48):
    ...
    def build(self) -> None:
        self.add_polyline('upper', (6,33), (10,27), (12,16), (18,21), (20,8), (26,18), (32,11), (34,24), (39,23))
        self.add_arc('brow', (39,23), (42,30), radius_x=7)
        self.add_arc('nose', (42,30), (42,34), radius_x=4)
        self.add_line('chin', (42,34), (36,34))
        self.add_polyline('legs-belly', (36,34), (36,40), (29,40), (27,33), (19,33), (17,40), (10,40), (11,33), (6,33))
