...
SOURCE_PATH = 'pictographic-primitives/arrows/download arrow_58683514-619a-4591-ab3b-7d4cfa512a2d.svg'
AUTHOR = 'gpt-6'

class DownloadArrowArrows(Solo48):
    icon_id = 'download-arrow-arrows'
    ...
    def build(self):
        runs = [{'start': (9, 8), 'steps': [('L', 39, 8), ('L', 24, 29)], 'closed': True}, {'start': (4, 40), 'steps': [('L', 44, 40)], 'closed': False}]
        rotation = 0
