"""Unlocked Security Padlock.
Plan: Unlocked padlock with open curved shackle and rounded body.
Centerline envelope: (8,4)-(40,44).
Final reduction/review: Unlocked padlock with open curved shackle and rounded body.
Keyshape: VRECT_L; all geometry authored at SOLO48, never scaled.
Construction reference: Lucide lock-open; rounded contours and shared attachment nodes.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-004/references/unlock_a11bc25d-bb24-4eb3-ab89-b3565a788892.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'unlocked-security-padlock-solo-b004-13'
    ...
    def build(self):
        s = self
        box(s,'body',8,26,40,44,4,nodes=((14,26),))
        s.add_line('shackle-leg',(14,26),(14,14))
        s.add_arc('shackle-top',(14,14),(34,14),radius_x=10)
        s.add_contour('shackle','shackle-leg','shackle-top');join(s,'shackle','body')
