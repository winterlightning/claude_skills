...
class FilmReelWithHangingTailVariant2(Solo48):
    icon_id = 'film-reel-with-hanging-tail-v2'
    variant_of = 'film-reel-with-hanging-tail'
    ...
    def build(self):
        ...
        arc('reel-upper-left', (20, 40), (4, 24), 16)
        ...
        for name, p in [('top', (20, 17)), ('right', (27, 24)), ('bottom', (20, 31)), ('left', (13, 24))]:
            self.add_dot(f'radial-{name}', p)
        line('hanging-film', (36, 24), (36, 36))
        arc('tail-curl', (36, 36), (44, 36), 4, False)
        line('tail-end', (44, 36), (44, 32))
        self.add_contour('tail', 'hanging-film', 'tail-curl', 'tail-end')
        self.relate('connect', 'tail', 'reel')
