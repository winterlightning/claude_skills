# Variant of fuel-pump-with-display; parent file remains unchanged.
...
class FuelPumpWithDisplayVariant2(Solo48):
    icon_id = 'fuel-pump-with-display-v2'
    variant_of = 'fuel-pump-with-display'
