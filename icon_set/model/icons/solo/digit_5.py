"""The digit 5, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 10, top 4, right 38, bottom 44.
Plan: A flat upper arm and vertical neck flow into one lower bowl.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/5.svg'
AUTHOR = 'gpt-6'
...
class Digit5(Solo48):
    ...
    typeface = {'character': '5', 'kind': 'digit'}
    aliases = ()
    keywords = ('5', "typeface", "typography", 'number')

    def build(self):
        rotation = 0
        mirror = False
        runs = [((38,4), [('L',10,4),('L',10,20),('L',26,20),('A',26,44,12,12,True),('L',10,44)],False)]
