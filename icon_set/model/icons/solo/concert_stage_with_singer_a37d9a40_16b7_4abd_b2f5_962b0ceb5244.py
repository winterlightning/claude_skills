"""A microphone on a stand beneath stage bunting.
Plan: HRECT_L retains the wide stage.
Reduction: Three pennants reduced to two; banner thickness omitted; stand arm made horizontal.
Construction: mic-vocal: round microphone head with a true attached arm. Microphone remains deliberately off-center.
"""
