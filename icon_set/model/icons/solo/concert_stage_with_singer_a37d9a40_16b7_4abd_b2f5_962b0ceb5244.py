...
class ConcertStageWithSinger(Solo48):
    ...
    def build(self) -> None:
        self.add_polyline("stage",(4,40),(4,8),(44,8),(44,40))
        self.add_polyline("pennants",(10,8),(12,16),(14,8),(22,8),(24,16),(26,8),(34,8),(36,16),(38,8))
        self.relate("connect","stage","pennants")
        points=[(17,28),(20,25),(23,28),(20,31),(17,28)]
        parts=[]
        ...
        self.add_line("angled-arm",(20,31),(26,34))
        self.add_line("stand",(26,34),(26,38))
        self.add_polyline("feet",(20,40),(26,38),(32,40))
