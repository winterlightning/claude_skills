"""The lowercase letter b, re-authored from the supplied reference for SOLO48.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/B.svg'
AUTHOR = 'gpt-6'


class LetterB(Solo48):
    icon_id = 'letter-b'
    ...
    typeface = {'character': 'b', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('b', "typeface", "typography", 'lowercase')
