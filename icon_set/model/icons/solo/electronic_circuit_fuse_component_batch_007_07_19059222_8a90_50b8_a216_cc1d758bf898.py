...
Plan: Broad end caps and two axial leads; glass fuse body left open.
Construction reference: Lucide cable; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/electronics fuse_19059222-8a90-50b8-a216-cc1d758bf898.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '19059222-8a90-50b8-a216-cc1d758bf898'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/electronics fuse_19059222-8a90-50b8-a216-cc1d758bf898.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'electronic-circuit-fuse-component-batch-007-07'
    ...
    def build(self):
        ...
        rect('left-cap',10,10,8,28,2)
        rect('right-cap',30,10,8,28,2)
        line('body-top',(18,16),(30,16))
        line('body-bottom',(18,32),(30,32))
        line('left-lead',(4,24),(10,24))
        line('right-lead',(38,24),(44,24))
