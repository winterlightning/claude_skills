# Variant of mouse-with-long-tail; parent file remains unchanged.
...
class MouseWithLongTailVariant2(Solo48):
    icon_id = 'mouse-with-long-tail-v2'
    variant_of = 'mouse-with-long-tail'
