...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for side in (-1,1):
            ...
            poly(f'car{side}',(x(20),30),(x(17),26),(x(10),26),(x(6),30),(x(10),33),(x(6),36),(x(14),36),(x(20),36),(x(20),30))
            circle(f'wheel{side}',x(14),38,2);join(f'car{side}',f'wheel{side}')
