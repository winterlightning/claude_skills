...
Symbol plan: A smooth wrapping thumb and broad curved palms form the clasp between long cuffs. Fine finger divisions and inside cuff edges are omitted to keep the opening clear.
...
SOURCE_PATH = 'pictographic-primitives/business/deal handshake_291c6be8-564b-4357-96fd-484a347b7dbd.svg'
AUTHOR = 'gpt-6'


class HandshakeWithShirtCuffs(Solo48):
    ...
    def build(self):
        self.path('left-cuff',(12,8),(4,8),(4,32),(8,32))
        self.path('right-cuff',(36,8),(44,8),(44,32),(40,32))
        self.path('left-upper-hand',(12,8),(20,8),(24,12))
        self.path('thumb',(36,8),(28,8),(24,12),(16,20),(24,28,12,24,20,32),(32,20))
