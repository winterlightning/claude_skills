...
class LighthouseWithBeams(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line("beam-left", (6,12), (8,15))
        self.add_line("beam-right", (40,15), (42,12))
