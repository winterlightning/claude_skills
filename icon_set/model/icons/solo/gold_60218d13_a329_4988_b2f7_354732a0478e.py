...
class Gold(Solo48):
    ...
    def build(self):
        self.add_line('sym-e0', (24, 38), (24, 40))
        ...
        self.add_line('sym-e10', (19, 8), (29, 8))
        self.add_line('sym-e12', (29, 8), (30, 9))
        self.add_line('sym-e13', (30, 9), (34, 20))
        self.add_arc('sym-e14', (34, 20), (34, 22), radius_x=23, radius_y=23, large_arc=False, sweep=False)
        self.add_line('sym-e15', (34, 22), (33, 24))
        self.add_line('sym-e16', (33, 24), (28, 24))
        self.add_line('sym-e17', (24, 39), (22, 40))
        self.add_arc('sym-e18', (22, 40), (21, 40), radius_x=26, radius_y=26, large_arc=False, sweep=False)
        self.add_line('sym-e19', (21, 40), (6, 40))
        self.add_arc('sym-e20', (6, 40), (4, 38), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        ...
        self.add_arc('sym-e26', (26, 40), (27, 40), radius_x=29, radius_y=29, large_arc=False, sweep=True)
        self.add_line('sym-e27', (27, 40), (42, 40))
        self.add_arc('sym-e28', (42, 40), (44, 38), radius_x=2, radius_y=2, large_arc=False, sweep=False)
        ...
        self.add_contour('sym-c1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e15', 'sym-e16', closed=False)
        self.add_contour('sym-c2', 'sym-e17', 'sym-e18', 'sym-e19', 'sym-e20', 'sym-e22', 'sym-e23', 'sym-e24', closed=False)
        self.add_contour('sym-c3', 'sym-e25', 'sym-e26', 'sym-e27', 'sym-e28', 'sym-e30', 'sym-e31', 'sym-e32', closed=False)
