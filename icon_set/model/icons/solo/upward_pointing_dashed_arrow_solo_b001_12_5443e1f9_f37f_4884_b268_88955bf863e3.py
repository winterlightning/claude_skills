...
Plan: Outlined up arrow with two detached shaft dashes; mirror shaft sides.
Centerline envelope: (8,4)-(40,44).
Final reduction/review: Outlined up arrow with two detached shaft dashes; mirror shaft sides.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-001/references/arrow dash up_5443e1f9-f37f-4884-b268-88955bf863e3.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'upward-pointing-dashed-arrow-solo-b001-12'
    ...
    def build(self):
        s = self
        s.add_polyline('arrow',(18,32),(18,20),(8,20),(24,4),(40,20),(30,20),(30,32))
        for x in (18,30):s.add_line(f'dash-{x}',(x,40),(x,44))
