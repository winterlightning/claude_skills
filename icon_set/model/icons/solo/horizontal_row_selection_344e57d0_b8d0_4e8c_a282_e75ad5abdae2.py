...
SOURCE_ICON_ID = '344e57d0-b8d0-4e8c-a282-e75ad5abdae2'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/interface-essential/row selected_344e57d0-b8d0-4e8c-a282-e75ad5abdae2.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'layout-three-columns'
...
class Drawing(Solo48):
    icon_id = 'horizontal-row-selection'
    variant_of = 'layout-three-columns'
    variant_label = 'Horizontal Row Selection'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'interface-essential'
    aliases = ()
    keywords = ('row', 'selection', 'control', 'panel', 'adjoining', 'cells')
    def build(self):
        # Plan: A rounded rectangular control panel contains a horizontal row of three adjoining cells.
        ...
        rr('frame',4,8,44,40,0)
        rr('row',12,20,36,28,0,top=(20,28),bottom=(20,28))
