"""Flying bird with raised wing, round head, short beak and broad tail. HRECT_L (6,8)-(42,40). Lucide bird informs a coherent body arc and clear beak; removed extra feather notches. Intentional flight-profile asymmetry."""
...
class BirdInFlightVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        # Centerline extremes (6,8)-(42,40); intentional flight asymmetry.
        ...
        self.add_line('beak-1', (41, 23), (42, 26))
        self.add_line('beak-2', (42, 26), (40, 29))
        self.add_arc('breast',(40,29),(25,40),radius_x=15,radius_y=11)
        self.add_line('belly',(25,40),(16,36))
        self.add_line('tail-1', (16, 36), (6, 39))
        self.add_line('tail-2', (6, 39), (8, 29))
