"""The lowercase letter p, re-authored from the supplied reference for SOLO48.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/P.svg'
AUTHOR = 'gpt-6'


class LetterP(Solo48):
    icon_id = 'letter-p'
    ...
    typeface = {'character': 'p', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('p', "typeface", "typography", 'lowercase')
