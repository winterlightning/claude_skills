"""Two rounded notification cards slide across the open right edge of a smartphone, beside three dismissal marks."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '441362d8-bae6-41ec-8d2b-a0322773a48a'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_01/alert clear notification_441362d8-bae6-41ec-8d2b-a0322773a48a.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'mobile-phone'
...
class Drawing(Solo48):
    icon_id = 'clear-mobile-phone-notifications'
    variant_of = 'mobile-phone'
    variant_label = 'Clear Mobile Phone Notifications'
    ...
    aliases = ()
    keywords = ('clear', 'mobile', 'phone', 'notifications', 'notification', 'cards', 'slide', 'open')
    def build(self):
        # Plan: Two rounded notification cards slide across the open right edge of a smartphone, beside three dismissal marks.
        ...
        p('phone',(24,4),(8,4),(8,44),(24,44),(24,36))
        rr('upper',17,12,31,20,0)
        rr('lower',17,28,31,36,0)
        for j,y in enumerate([12,24,36]): dot(f'dismiss-{j}',40,y)
