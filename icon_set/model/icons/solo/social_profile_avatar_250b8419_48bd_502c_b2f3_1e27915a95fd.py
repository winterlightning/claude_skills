"""social-profile-avatar: reviewed and repaired in place on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '250b8419-48bd-502c-b2f3-1e27915a95fd'
SOURCE_PATH = 'pictographic-primitives/social/social profile avatar_250b8419-48bd-502c-b2f3-1e27915a95fd.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-repaired'

class SocialProfileAvatar(Solo48):
    icon_id = 'social-profile-avatar'
