...
Plan: Stored-data concave right side and rounded left side, fresh wide construction.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/stored data_1f5bbbac-60cf-5ba1-92ad-e8170af6c399.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '1f5bbbac-60cf-5ba1-92ad-e8170af6c399'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/diagrams/stored data_1f5bbbac-60cf-5ba1-92ad-e8170af6c399.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'stored-data-flowchart-symbol-batch-006-12'
    keyshape = Keyshape.HRECT_M
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/batch-006"
    aliases = ()
    keywords = ('stored', 'data', 'flowchart', 'symbol')
    ...
    def build(self):
        ...
        line('top',(12,10),(44,10))
        curve('right',(44,10),((38,18),(38,30),(44,38)))
        line('bottom',(44,38),(12,38))
        curve('left',(12,38),((4,38),(4,30),(4,24)),((4,18),(4,10),(12,10)))
        self.add_contour('stored-data','top','right','bottom','left',closed=True)
