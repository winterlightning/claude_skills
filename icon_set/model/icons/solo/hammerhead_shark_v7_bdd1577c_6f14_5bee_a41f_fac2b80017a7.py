# Variant of hammerhead-shark-v5; parent file remains unchanged.
...
class HammerheadSharkVariant7(Solo48):
    icon_id = 'hammerhead-shark-v7'
    variant_of = 'hammerhead-shark-v5'
    variant_label = 'Smaller body with open tail clearance'
