"""man-graduate: gown bands with reference hair/headwear.
...
cardinal arcs. Fine trim omitted at 48. Body cue: gown bands.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-05/references/man-graduate.svg'
SOURCE_HEAD_ICON_ID = 'man-graduate'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 32
class ManGraduateAvatar(Solo48):
