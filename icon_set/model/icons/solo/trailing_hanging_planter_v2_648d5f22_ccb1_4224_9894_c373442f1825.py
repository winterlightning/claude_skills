...
class TrailingHangingPlanterVariant2(Solo48):
    ...
    def build(self) -> None:
        self.add_polyline('cords', (6, 32), (24, 6), (42, 32), closed=False)
        ...
        self.add_line('left-support', (6, 32), (10, 32))
        self.add_line('right-support', (42, 32), (38, 32))
        ...
        self.add_polyline('left-trail', (6, 32), (6, 36), (6, 42), closed=False)
        self.add_polyline('right-trail', (42, 32), (42, 36), (42, 42), closed=False)
