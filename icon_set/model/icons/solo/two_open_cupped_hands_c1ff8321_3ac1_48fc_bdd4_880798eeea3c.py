...
OMISSIONS=['Diagonal thumb folds simplified to upright folds to keep the paired palms open at stroke 4.']
class Drawing(Solo48):
    ...
    def build(self):
        for side in (-1,1):
            ...
            self.path(n+'-outer',p(12,40),[('L',p(12,36)),('A',p(4,28),8,8,side==-1),('L',p(4,12)),('A',p(12,12),4,4,side==-1),('L',p(12,20))])
            self.path(n+'-thumb-palm',p(12,28),[('L',p(12,20)),('A',p(20,28),8,8,side==-1),('L',p(20,40))])
