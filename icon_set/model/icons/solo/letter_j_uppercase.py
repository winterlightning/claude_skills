"""Uppercase J for SOLO48; centerline envelope (10, 4)–(38, 44).
Plan: Top bar above one descending stem and a tangent two-radius hook.
...
class LetterJUppercase(Solo48):
    icon_id = 'letter-j-uppercase'
    ...
    def build(self):
        rotation = 0
        mirror = False
        runs=[((10,4),[('L',30,4),('L',38,4)],False),((30,4),[('L',30,30),('A',16,44,14,14,True),('A',10,38,6,6,True)],False)]
