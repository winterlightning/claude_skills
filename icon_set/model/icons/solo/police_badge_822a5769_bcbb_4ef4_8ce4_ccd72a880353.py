...
class PoliceBadge(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (40, 9), (37, 19), radius_x=14, radius_y=14, large_arc=False, sweep=False)
        self.add_line('sym-e3', (37, 19), (40, 28))
        self.add_arc('sym-e5', (40, 28), (40, 29), radius_x=30, radius_y=30, large_arc=False, sweep=False)
        ...
        self.add_arc('sym-e18', (10, 34), (9, 31), radius_x=14, radius_y=14, large_arc=False, sweep=False)
        self.add_line('sym-e19', (9, 31), (8, 29))
        self.add_line('sym-e20', (8, 29), (8, 28))
        self.add_line('sym-e21', (8, 28), (11, 19))
        self.add_arc('sym-e23', (11, 19), (8, 9), radius_x=13, radius_y=13, large_arc=False, sweep=False)
        self.add_line('sym-e24', (8, 9), (11, 5))
        self.add_arc('sym-e25', (11, 5), (21, 6), radius_x=11, radius_y=11, large_arc=False, sweep=False)
        ...
        self.add_arc('sym-e35', (27, 6), (37, 5), radius_x=12, radius_y=12, large_arc=False, sweep=False)
        self.add_contour('sym-c0', 'sym-e0', closed=False)
        self.add_contour('sym-c1', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e15', 'sym-e16', 'sym-e17', 'sym-e18', 'sym-e19', 'sym-e20', 'sym-e21', 'sym-e23', 'sym-e24', 'sym-e25', 'sym-e26', 'sym-e27', 'sym-e33', 'sym-e34', 'sym-e35', closed=True)
