...
class KeyholeSquare(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e6', (6, 10), (10, 6), radius_x=5)
        self.add_line('sym-e7', (10, 6), (24, 6))
        self.add_line('sym-e8', (24, 6), (38, 6))
        self.add_arc('sym-e9', (38, 6), (42, 10), radius_x=5)
        self.add_line('sym-e11', (42, 10), (42, 38))
        self.add_arc('sym-e12', (42, 38), (38, 42), radius_x=5)
        self.add_line('sym-e14', (38, 42), (24, 42))
        self.add_line('sym-e15', (24, 42), (10, 42))
        self.add_arc('sym-e17', (10, 42), (6, 38), radius_x=5)
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', closed=True)
        self.add_contour('sym-c1', 'sym-e3')
        self.add_contour('sym-c2', 'sym-e4', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e11', 'sym-e12', 'sym-e14', 'sym-e15', 'sym-e17', closed=True)
