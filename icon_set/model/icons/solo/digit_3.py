"""The digit 3, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 10, top 4, right 38, bottom 44.
Plan: Two identical right-facing elliptical bowls share the middle terminal.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/3.svg'
AUTHOR = 'gpt-6'
...
class Digit3(Solo48):
    ...
    typeface = {'character': '3', 'kind': 'digit'}
    aliases = ()
    keywords = ('3', "typeface", "typography", 'number')

    def build(self):
        rotation = 0
        mirror = False
        left, shoulder, right = 10, 24, 38
        runs = [((left,4), [('L',shoulder,4),('A',shoulder,24,14,10,True),('L',20,24)],False), ((shoulder,24), [('A',shoulder,44,14,10,True),('L',left,44)],False)]
