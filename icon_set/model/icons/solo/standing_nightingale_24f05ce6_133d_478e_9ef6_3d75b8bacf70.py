...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_28/nightingale_24f05ce6-133d-478e-9ef6-3d75b8bacf70.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    aliases = ()
    keywords = ('nightingale', 'bird', 'songbird', 'wings', 'tail', 'wildlife')
