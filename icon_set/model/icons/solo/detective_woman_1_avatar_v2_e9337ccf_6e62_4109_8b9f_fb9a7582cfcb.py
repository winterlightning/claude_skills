...
class DetectiveWoman1AvatarVariant2(Solo48):
    icon_id = 'detective-woman-1-avatar-v2'
    variant_of = 'detective-woman-1-avatar'
    ...
    def build(self):
        """Remove the hat baseline duplicated by the brim; preserve the circular avatar face and its shoulder contact."""
        self.add_polyline('hat', (12, 16), (15, 4), (24, 6), (33, 4), (36, 16))
