# Variant of computer-keyboard; parent file remains unchanged.
...
class ComputerKeyboardVariant2(Solo48):
    icon_id = 'computer-keyboard-v2'
    variant_of = 'computer-keyboard'
