...
SOURCE_PATH = 'pictographic-primitives/arrows/left_2e7d5eb7-d8b8-5f42-8456-a7d8ce8a9c6d.svg'
AUTHOR = 'gpt-6'

class LeftArrows(Solo48):
    icon_id = 'left-arrows'
    ...
    def build(self):
        runs = [{'start': (8, 24), 'steps': [('L', 40, 4), ('L', 40, 44)], 'closed': True}]
        rotation = 0
