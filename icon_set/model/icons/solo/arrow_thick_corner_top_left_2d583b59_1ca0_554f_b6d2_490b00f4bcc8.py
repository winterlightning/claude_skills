"""Arrow thick corner top left (arrows), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '2d583b59-1ca0-554f-b6d2-490b00f4bcc8'
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thick corner top left_2d583b59-1ca0-554f-b6d2-490b00f4bcc8.svg'
AUTHOR = 'gpt-6'

class ArrowThickCornerTopLeft(Solo48):
    icon_id = 'arrow-thick-corner-top-left'
    ...
    def build(self):
        runs = [{'start': (6, 32), 'steps': [('L', 14, 24), ('L', 32, 42), ('L', 42, 32), ('L', 24, 14), ('L', 32, 6), ('L', 6, 6), ('L', 6, 32)], 'closed': True}]
        rotation = 0
