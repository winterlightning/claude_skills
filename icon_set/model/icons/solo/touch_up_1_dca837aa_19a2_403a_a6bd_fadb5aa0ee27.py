"""An upward arrow rises out of an open circular touch target.
Plan: A circular major arc leaves an upper opening; the arrow shares its apex node and stays on the vertical axis.
Keyshape: CIRCLE. Exact envelope: {'center': [24, 24], 'ink_radius': 22, 'centerline_radius': 20}.
