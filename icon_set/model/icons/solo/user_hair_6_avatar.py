"""user-hair-6: wrap neckline with reference head silhouette.
...
Body cue: wrap neckline. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-10/references/user-hair-6.svg'
SOURCE_HEAD_ICON_ID = 'user-hair-6'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserHair6Avatar(Solo48):
    icon_id = 'user-hair-6-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'hair', '6', 'portrait', 'bust')
    def build(self):
