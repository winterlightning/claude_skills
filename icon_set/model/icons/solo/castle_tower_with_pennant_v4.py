...
class LandmarkVariant4(Solo48):
    ...
    def build(self):
        """Opening repair: Deepened the pennant and rebuilt its notch without the folded-back top segment."""
        ...
        self.add_polyline('flag', (22, 20), (22, 14), (22, 6), (38, 6), (34, 10), (38, 14), (22, 14))
