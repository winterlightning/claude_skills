...
SOURCE_ICON_ID = '756e8097-9021-43b6-b31f-f019d5c585aa'
SOURCE_PATH = 'icon_set/work/todo-references/person improvement_756e8097-9021-43b6-b31f-f019d5c585aa.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    """A person with two upward improvement arrows.
    Plan: Circular head, exact detached shoulder gap, and matched arrows on both sides.
    Reference: Shared human_ref/user.svg: circular head and broad curved shoulders; source arrows retain bilateral placement.
    """
    icon_id = 'person-improvement'
    keyshape = Keyshape.HRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects"
    aliases = ()
    keywords = ('person', 'improvement')
    ...
    def build(self):
        ...
        self.bust('person',24,23,4,12,40,5)
        ...
        self.add_line('crown-mark',(24,15),(24,19));self.relate('connect','crown-mark','person-head')

# Final human spacing: Shared human_ref/user.svg inspected. Head (24,23), radius 4, lower centerline y=27. Shoulder apex (24,35): exact gap 8 centerline / 4 ink. Head and shoulders rebalanced to clear both arrows.
