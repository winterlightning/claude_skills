...
"""A smiling baby with a circular jaw and curved ears. SQUARE retains the bow and ear extremes (6,6)-(42,42). Lucide baby informs the circular head with paired ear lobes; the original bow and facial features are preserved."""
...
class BabyGirlFaceVariant3(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('chin-right', (40, 30), (24, 42), radius_x=16, radius_y=16, sweep=True, large_arc=False)
        self.add_arc('chin-left', (24, 42), (8, 30), radius_x=16, radius_y=16, sweep=True, large_arc=False)
        ...
        self.add_line('bow-left-top', (24, 8), (12, 6))
        ...
        self.add_line('bow-right-top', (24, 8), (36, 6))
