...
"""Cactus with an enlarged nine-unit pot rim band. VRECT_XL bounds (6,6)-(42,42). Preserve naturally unequal arms. No useful local Lucide cactus match; semicircular caps and quarter-circle arm bends are retained."""
...
class CactusInRimmedPotVariant3(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('left-arm-outer', (18, 23), (6, 10), radius_x=13)
        self.add_arc('left-arm-cap', (6, 10), (11, 10), radius_x=3)
        ...
        self.add_arc('right-arm-cap', (37, 8), (42, 8), radius_x=3)
        self.add_arc('right-arm-outer', (42, 8), (30, 21), radius_x=13)
