...
class Layout4(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e19', (42, 8), (41, 6), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('sym-e20', (41, 6), (7, 6))
        ...
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e7', 'sym-e9', 'sym-e12', 'sym-e13', 'sym-e15', closed=False)
        self.add_contour('sym-c1', 'sym-e16', 'sym-e17', closed=False)
        self.add_contour('sym-c2', 'sym-e18', 'sym-e19', 'sym-e20', 'sym-e24', 'sym-e25', 'sym-e26', closed=False)
        self.add_contour('sym-c3', 'sym-e27', closed=False)
