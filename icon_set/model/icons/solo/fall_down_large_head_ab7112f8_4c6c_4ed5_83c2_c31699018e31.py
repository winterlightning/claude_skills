...
class FallDownLargeHead(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e3', (44, 17), (41, 20), radius_x=3, radius_y=3, large_arc=False, sweep=True)
        self.add_line('sym-e4', (41, 20), (7, 20))
        self.add_arc('sym-e6', (7, 20), (4, 17), radius_x=3, radius_y=3, large_arc=False, sweep=True)
        self.add_line('sym-e7', (4, 17), (4, 8))
        self.add_line('sym-e8', (16, 33), (24, 40))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', closed=False)
        self.add_contour('sym-c1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e6', 'sym-e7', closed=False)
