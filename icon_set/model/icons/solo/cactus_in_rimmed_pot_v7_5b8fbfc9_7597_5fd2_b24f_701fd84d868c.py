# Variant of cactus-in-rimmed-pot-v4; parent file remains unchanged.
...
class CactusInRimmedPotVariant7(Solo48):
    icon_id = 'cactus-in-rimmed-pot-v7'
    variant_of = 'cactus-in-rimmed-pot-v4'
