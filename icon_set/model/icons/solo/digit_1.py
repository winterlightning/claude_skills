"""The digit 1, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 10, top 4, right 38, bottom 44.
Plan: One stem, a short top flag and a symmetric baseline; baseline junction is explicit.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/1.svg'
AUTHOR = 'gpt-6'
...
class Digit1(Solo48):
    ...
    typeface = {'character': '1', 'kind': 'digit'}
    aliases = ()
    keywords = ('1', "typeface", "typography", 'number')

    def build(self):
        rotation = 0
        mirror = False
        runs = [((10,4), [('L',24,4),('L',24,44)],False), ((10,44), [('L',24,44),('L',38,44)],False)]
