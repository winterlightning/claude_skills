"""user-chef-2-1: chef jacket collar.
Distinct-avatar plan: preserve reference identity; use chef jacket collar.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-10/references/user-chef-2-1.svg'
SOURCE_HEAD_ICON_ID = 'user-chef-2-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class UserChef21Avatar(Solo48):
    icon_id = 'user-chef-2-1-avatar'
