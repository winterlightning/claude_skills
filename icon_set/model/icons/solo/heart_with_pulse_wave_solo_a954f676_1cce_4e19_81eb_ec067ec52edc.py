"""A heart with an open-ended pulse waveform.
Symbol plan and construction: heart-pulse: rounded lobes and an open cardiograph stroke.
Keyshape: HRECT_L preserves the broad source heart.
Omissions: None.
Review: The left waveform joins a real outline node at (6,24). Its shortened open right end and shallower trough leave space to the heart edge. Heart outline is mirrored; pulse follows source asymmetry."""
