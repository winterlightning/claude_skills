...
class PlatypusVariant2(Solo48):
    ...
    def build(self):
        """Opening repair: Deepened the bill and moved its shared body attachments together."""
        ...
        self.add_arc('body-2', (12, 29), (18, 34), radius_x=6, radius_y=9, sweep=False)
        self.add_line('body-3', (18, 34), (28, 34))
        self.add_arc('body-4', (28, 34), (34, 29), radius_x=6, radius_y=9, sweep=False)
        ...
        self.add_arc('bill-2', (28, 34), (28, 42), sweep=True, radius_x=5, radius_y=4)
        self.add_line('bill-3', (28, 42), (18, 42))
        self.add_arc('bill-4', (18, 42), (18, 34), sweep=True, radius_x=5, radius_y=4)
