...
class EiffelTower(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('left-foot', (8,44), (13,32), radius_x=65, sweep=False)
        ...
        self.add_arc('right-foot', (35,32), (40,44), radius_x=65, sweep=False)
        ...
        self.add_arc('base-arch',(17,44),(31,44),radius_x=7,sweep=True)
