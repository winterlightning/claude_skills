...
SOURCE_ICON_ID = 'd0ceaf6b-60c5-432a-9109-8d752478118c'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_23/installation_d0ceaf6b-60c5-432a-9109-8d752478118c.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'hanging-shop-sign-solo'
...
class Drawing(Solo48):
    icon_id = 'hanging-rectangular-sign'
    variant_of = 'hanging-shop-sign-solo'
    variant_label = 'Hanging Rectangular Sign'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('hanging', 'sign', 'suspended', 'support', 'rail', 'Uncategorized')
    def build(self):
        # Plan: An upright rounded rectangular sign suspended by a short vertical support from a horizontal rail.
        ...
        p('rail',(8,4),(24,4),(40,4))
        l('hanger',(24,4),(24,16))
        rr('sign',12,16,36,44,3,top=(24,))
