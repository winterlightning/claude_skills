...
class DiagramArrowDashCornerPointLeftVariant2(Solo48):
    icon_id = 'diagram-arrow-dash-corner-point-left-v2'
    variant_of = 'diagram-arrow-dash-corner-point-left'
    ...
    def build(self):
        runs = [{'start': (21, 6), 'steps': [('L', 6, 21)], 'closed': False}, {'start': (21, 36), 'steps': [('L', 6, 21), ('L', 42, 21), ('L', 42, 42)], 'closed': False}]
        rotation = 0
