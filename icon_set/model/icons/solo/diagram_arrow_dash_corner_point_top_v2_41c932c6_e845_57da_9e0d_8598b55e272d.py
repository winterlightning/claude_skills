...
class DiagramArrowDashCornerPointTopVariant2(Solo48):
    icon_id = 'diagram-arrow-dash-corner-point-top-v2'
    variant_of = 'diagram-arrow-dash-corner-point-top'
    ...
    def build(self):
        runs = [{'start': (42, 21), 'steps': [('L', 27, 6)], 'closed': False}, {'start': (12, 21), 'steps': [('L', 27, 6), ('L', 27, 42), ('L', 6, 42)], 'closed': False}]
        rotation = 0
