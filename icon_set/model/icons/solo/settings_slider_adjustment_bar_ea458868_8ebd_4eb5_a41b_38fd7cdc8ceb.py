"""A rounded rectangular control panel contains a horizontal slider near its upper edge, with its circular knob left of center."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'ea458868-8ebd-4eb5-a41b-38fd7cdc8ceb'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/interface-essential/settings slider_ea458868-8ebd-4eb5-a41b-38fd7cdc8ceb.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'settings-slider-adjustment-bar'
    variant_of = 'two-vertical-sliders'
    variant_label = 'Settings Slider Adjustment Bar'
    ...
    aliases = ()
    keywords = ('settings', 'slider', 'adjustment', 'bar', 'control', 'panel', 'knob', 'center')
    def build(self):
        # Plan: A rounded rectangular control panel contains a horizontal slider near its upper edge, with its circular knob left of center.
        ...
        rr('frame',6,6,42,42)
        c('knob',20,18,3)
        l('track-left',(15,18),(17,18));l('track-right',(23,18),(33,18))
