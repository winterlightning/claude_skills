"""Broad outlined check with short left arm and long ascending right arm; deliberate diagonal asymmetry. Centerline6,6–42,42.
Lucide construction reference: check.
"""
...
class BatchIcon(Solo48):
    icon_id='outlined-check-mark-solo-b015'
    ...
    def build(self):
        ...
        self.add_polyline('check',(6,28),(12,22),(20,28),(36,6),(42,14),(21,42),closed=True)
