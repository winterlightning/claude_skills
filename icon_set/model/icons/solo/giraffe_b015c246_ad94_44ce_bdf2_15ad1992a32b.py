...
class GiraffeHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('outline-1', (6, 42), (15, 18))
        self.add_arc('outline-2', (15, 18), (6, 6), radius_x=13, radius_y=13, sweep=True)
        self.add_arc('outline-3', (6, 6), (17, 17), radius_x=15, radius_y=15, sweep=True)
        self.add_line('outline-4', (17, 17), (20, 10))
        self.add_line('outline-5', (20, 10), (19, 6))
        self.add_line('outline-6', (19, 6), (25, 6))
        self.add_line('outline-7', (25, 6), (26, 10))
        self.add_line('outline-8', (26, 10), (29, 10))
        self.add_line('outline-9', (29, 10), (42, 27))
        self.add_line('outline-10', (42, 27), (42, 29))
        self.add_arc('outline-11', (42, 29), (41, 34), radius_x=5, radius_y=5, sweep=True)
        self.add_line('outline-12', (41, 34), (23, 29))
        self.add_line('outline-13', (23, 29), (17, 42))
