...
class PersonDescendingStairsVariant2(Solo48):
    icon_id = 'person-descending-stairs-v2'
    variant_of = 'person-descending-stairs'
    ...
    def build(self):
        """Raise the hip to open the triangular space above the step."""
        self.add_arc('person-head-top', (15,9),(21,9), radius_x=3, radius_y=3, large_arc=False, sweep=True)
        self.add_arc('person-head-bottom', (21,9),(15,9), radius_x=3, radius_y=3, large_arc=False, sweep=True)
        self.add_line('person-body-1', (18, 20), (22, 25))
        self.add_line('person-arms-1', (6, 25), (18, 20))
        self.add_line('person-arms-2', (18, 20), (28, 26))
