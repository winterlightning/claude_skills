"""Two equal horizontal underline strokes.
Symbol plan: No more useful Lucide subject match; source defines two straight repeated rules.
Keyshape: HRECT_M; fixed profile envelope is recorded in ink_extremes.
Reduction: None; no U letter is present in the supplied reference.
"""
