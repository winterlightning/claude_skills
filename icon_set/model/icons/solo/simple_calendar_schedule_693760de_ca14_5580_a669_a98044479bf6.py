...
SOURCE_ICON_ID = '693760de-ca14-5580-a669-a98044479bf6'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/interface-essential/calendar 1_693760de-ca14-5580-a669-a98044479bf6.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'simple-calendar-schedule'
    variant_of = 'simple-monthly-calendar-solo'
    variant_label = 'Simple Calendar Schedule'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'interface-essential'
    aliases = ()
    keywords = ('calendar', 'schedule', 'binding', 'header', 'divider', 'row', 'date', 'marks')
    def build(self):
        # Plan: A two-binding calendar has a header divider above a row of three short date marks.
        ...
        l('header',(8,20),(40,20))
        for j,x in enumerate([16,24,32]): dot(f'date-{j}',x,32)
