"""Subroutine Flowchart Symbol.
Plan: Whole predefined-process symbol; side rules share the outline.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/sub routine default process_90435806-e6da-5296-9960-f2edbe37e542.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '90435806-e6da-5296-9960-f2edbe37e542'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/diagrams/sub routine default process_90435806-e6da-5296-9960-f2edbe37e542.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'subroutine-flowchart-symbol-batch-006-13'
    keyshape = Keyshape.HRECT_M
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "diagrams"
    aliases = ()
    keywords = ('subroutine', 'flowchart', 'symbol')
    ...
    def build(self):
        ...
        rect('process',4,10,40,28)
        for x in (12,36): line(f'side-rule-{x}',(x,10),(x,38))
