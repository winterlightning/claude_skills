"""Smartphone rear with two vertically stacked lenses; lenses inset and separated, intentionally left-sided."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '3fd36e29-728b-52a8-9cdc-ab4ac349f4b4'
SOURCE_PATH = 'pictographic-primitives/phones/phone double camera_3fd36e29-728b-52a8-9cdc-ab4ac349f4b4.svg'
AUTHOR = 'gpt-6'
...
class DualCameraSmartphoneBack(Solo48):
    ...
    aliases = ()
    keywords = ('smartphone', 'camera', 'dual', 'lenses', 'back', 'phone')
    ...
    def build(self):
        ...
        box(8,4,40,44)
        for y in (16,31):circle(f'lens-{y}',20,y,3)
