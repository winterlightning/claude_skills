...
class Drawing(Solo48):
    ...
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    exception = {'approved_by': 'user', 'svg_sha256': '85de685b9639cc15d62da61d0f319f87dca780cd1e8a2bd10bbd75659568fcfc', 'reason': 'put exception on fail gate — All existing blocking validation findings for this exact standalone batch drawing, including review warnings.', 'source_svg_sha256': '85de685b9639cc15d62da61d0f319f87dca780cd1e8a2bd10bbd75659568fcfc'}
