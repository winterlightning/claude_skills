...
Omissions: Coin ring and fulcrum baseline removed; dollar retains upper and lower ticks; person uses shared stick vocabulary.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_line('torso',(12,20),(12,22))
        self.add_polyline('arms',(6,20),(12,20),(18,20));self.relate('connect','arms','torso')
        self.add_polyline('legs',(6,34),(12,22),(22,34));self.relate('connect','legs','torso')
        self.mark_human_figure('person',head='head',torso='torso',torso_junction='start')
        self.add_polyline('cash',(42,10),(37,10),(32,10),(32,18),(42,18),(42,26),(37,26),(32,26))
        self.add_line('dollar-tick',(37,6),(37,10));self.relate('connect','dollar-tick','cash')
        self.add_polyline('beam',(6,34),(22,34),(24,34),(37,34),(42,34));self.relate('connect','legs','beam')
        self.add_polyline('fulcrum',(18,42),(24,34),(30,42));self.relate('connect','fulcrum','beam')

        self.add_line('dollar-lower',(37,26),(37,34))
        self.relate('connect','dollar-lower','cash');self.relate('connect','dollar-lower','beam')
