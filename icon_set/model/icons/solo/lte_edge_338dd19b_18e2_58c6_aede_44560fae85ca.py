"""An uppercase E denotes the EDGE mobile network.
Plan: semantic components use coherent contours, shared nodes, and mirrored or repeated definitions.
Keyshape VRECT_M; full composition retained on SOLO48. Omissions: None.
"""
...
# Final review record: Clear E with evenly spaced bars and upright proportions.
# Visible keyshape bounds: (8, 2, 40, 46)
