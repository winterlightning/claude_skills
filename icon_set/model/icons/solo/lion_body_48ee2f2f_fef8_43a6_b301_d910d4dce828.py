"""Standing lion with an offset muzzle inside a tall teardrop mane, grounded rounded paws and an upcurved tail. The mane is no longer a circular head or eye. Far legs omitted; deliberate left-facing asymmetry."""
...
class StandingLion(Solo48):
    icon_id = 'standing-lion'
    ...
    def build(self) -> None:
        ...
        self.add_arc('mane-crown', (9, 13), (16, 6), radius_x=7, radius_y=8, sweep=True)
        self.add_arc('mane-right', (16, 6), (26, 17), radius_x=10, radius_y=12, sweep=True)
        ...
        self.add_line('snout-top', (6, 20), (6, 20))
        self.add_line('forehead', (6, 20), (9, 13))
        ...
        self.add_arc('nose-low', (7, 29), (6, 24), radius_x=5, radius_y=5, sweep=True)
        self.add_line('nose', (6, 24), (6, 20))
        ...
        self.add_line('hind-shin', (42, 26), (42, 40))
        self.add_arc('hind-foot', (42, 40), (36, 40), radius_x=3, radius_y=3, sweep=True)
        self.add_line('hind-inner', (36, 40), (36, 31))
        self.add_line('belly', (36, 31), (24, 31))
        self.add_line('fore-inner', (24, 31), (24, 40))
        self.add_arc('fore-foot', (24, 40), (18, 40), radius_x=3, radius_y=3, sweep=True)
        self.add_line('fore-shin', (18, 40), (18, 33))
        ...
        self.add_arc('tail', (42, 26), (42, 12), radius_x=4, radius_y=14, sweep=False)
