"""Zero Percent Sign — new batch-033 result."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '4fd52187-1c97-4d8d-8d4a-93db88e7190c'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/symbol/0%_4fd52187-1c97-4d8d-8d4a-93db88e7190c.svg'
AUTHOR = 'gpt-6'

class Batch033Icon(Solo48):
    icon_id = 'zero-percent-sign-batch-033'
    keyshape = Keyshape.HRECT_M
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "symbol"
    aliases = ('zero-percent-sign',)
    keywords = ('batch-033',)

    def build(self):
        # Symbol plan: Existing zero and percent glyphs, uniformly laid out without replacement geometry. SOLO48 grid compatibility must be checked.
        ...
        glyphs=[next(g for g in catalog if g['character']==c and g.get('preferred',True)) for c in '0%']
