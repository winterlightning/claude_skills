...
SOURCE_ICON_ID = '658192ad-5d22-4f1c-a6a6-35b2cd28f0b9'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_04/archives_658192ad-5d22-4f1c-a6a6-35b2cd28f0b9.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'framed-stack-of-three-filing-drawers'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('framed', 'stack', 'of', 'three', 'filing', 'drawers')

    # Repair: Three continuous drawer fronts retained; outer trim and handles removed to open each face.
