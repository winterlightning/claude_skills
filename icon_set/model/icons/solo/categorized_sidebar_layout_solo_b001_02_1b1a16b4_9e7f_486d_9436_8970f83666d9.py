"""Categorized Sidebar Layout.
Plan: Rounded application panel with structural sidebar; repeated menu marks share spacing. Content tiles reduced to short strokes.
Centerline envelope: (4,8)-(44,40).
Final reduction/review: Content tile rectangles reduced to two strokes; one menu mark retained.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-001/references/categorization list_1b1a16b4-9e7f-486d-9436-8970f83666d9.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'categorized-sidebar-layout-solo-b001-02'
    ...
    def build(self):
        s = self
        box(s,'frame',4,8,44,40,3,nodes=((24,8),(24,40)))
        s.add_line('divider',(24,8),(24,40));join(s,'frame','divider')
        for y in (17,31): s.add_line(f'tile-{y}',(32,y),(35,y))
        s.add_line('menu',(13,20),(16,20))
