...
Plan: Text and landscape document with clipped corner; inner folded-corner line and tiny sun omitted.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/design file text image_b0709a54-a849-5e7a-a49f-b5092fcf8a85.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'b0709a54-a849-5e7a-a49f-b5092fcf8a85'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/files/design file text image_b0709a54-a849-5e7a-a49f-b5092fcf8a85.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'document-with-text-and-image-batch-009-07'
    ...
    aliases = ()
    keywords = ('document', 'with', 'text', 'and', 'image')
    ...
    def build(self):
        ...
        line('text',(17,22),(30,22))
        path('landscape',(17,35),(22,30),(31,35))
