"""An empty eight-pointed badge with stepped shoulders.

Symbol plan: One closed contour made from four quarter-turn copies of shared shoulder coordinates around (24,24). Ink extremes (4,4)-(44,44).
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '83414ae1-83ad-4f09-a7d9-9c6c5864840a'
SOURCE_PATH = 'pictographic-primitives/container/badge 1_83414ae1-83ad-4f09-a7d9-9c6c5864840a.svg'
AUTHOR = "gpt-6"
...
class AuthoredIcon(Solo48):
    icon_id = 'eight-pointed-star-badge-solo'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'container'
    aliases = ()
    keywords = ('eight', 'pointed', 'star', 'badge')
    ...
    def build(self):
        ...
        for turn in range(4):
         for px,py in quarter:
          for _ in range(turn):px,py=-py,px
          points.append((axis+px,axis+py))
