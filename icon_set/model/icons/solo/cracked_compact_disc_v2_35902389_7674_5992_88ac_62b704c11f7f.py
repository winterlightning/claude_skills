...
class CrackedCompactDiscVariant2(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('rim-upper-left', (12, 10), (6, 24), radius_x=10, radius_y=14, sweep=False, large_arc=False)
        self.add_arc('rim-lower-left', (6, 24), (24, 42), radius_x=22, radius_y=22, sweep=False, large_arc=False)
        self.add_arc('rim-lower-right', (24, 42), (42, 24), radius_x=22, radius_y=22, sweep=False, large_arc=False)
        self.add_arc('rim-upper-right', (42, 24), (24, 6), radius_x=22, radius_y=22, sweep=False, large_arc=False)
        self.add_contour('rim', 'rim-upper-left', 'rim-lower-left', 'rim-lower-right', 'rim-upper-right', closed=False)
        self.add_polyline('crack', (24, 6), (16, 18), (29, 18), (18, 34), closed=False)
