"""vest-clothes: Balanced vest panels; earlier revisions preserved."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'c9403137-cb21-5da2-b4de-4d67a662fe18'
SOURCE_PATH = 'pictographic-primitives/clothes/vest_c9403137-cb21-5da2-b4de-4d67a662fe18.svg'
AUTHOR = 'gpt-6'

class VestClothes(Solo48):
    icon_id = 'vest-clothes'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'clothes'
    aliases = ()
    keywords = ('solo-ai-full-set', 'vest-clothes')
    ...
    def build(self):
        ...
        commands=[('L',(20,4))]
        if False:commands += [('L',(24,18)),('L',(28,4))]
        ...
        line('seam',(24,14),(24,40));join('seam','vest')
