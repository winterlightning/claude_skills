"""A rounded square map containing two opposing right triangles separated by a broad diagonal lane."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'c99bd688-6fb6-43f5-b2f7-cc91d6ec6976'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/video-games/batch-10/sport esport multiplayer online battle arena moba_c99bd688-6fb6-43f5-b2f7-cc91d6ec6976.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'square-arena-emblem'
...
class Drawing(Solo48):
    icon_id = 'multiplayer-online-battle-arena-map'
    variant_of = 'square-arena-emblem'
    variant_label = 'Multiplayer Online Battle Arena Map'
    ...
    aliases = ()
    keywords = ('multiplayer', 'online', 'battle', 'arena', 'map', 'square', 'opposing', 'triangles')
    def build(self):
        # Plan: A rounded square map containing two opposing right triangles separated by a broad diagonal lane.
        ...
        rr('map',6,6,42,42,2)
        p('upper',(15,15),(27,15),(15,27),closed=True)
        p('lower',(33,21),(33,33),(21,33),closed=True)
