"""A circular head floats above an office worker's V-neck torso behind a wide rectangular desk edge. Two short vertical lines mark the arms resting behind the front panel.
Symbol plan: Circular head and broad curved shoulders behind a wide rectangular desk rail. The desk is the distinctive body cue; omit the crowded V neckline and fine arm divisions. Head radius8 and shoulder top24 give zero head/body ink gap.
...
SOURCE_ICON_ID = '0f9ad87b-4b68-5838-b74a-c232ebe3e0e1'
SOURCE_PATH = 'pictographic-primitives/avatars/man office_0f9ad87b-4b68-5838-b74a-c232ebe3e0e1.svg'
SOURCE_CATEGORY = 'avatars'
AUTHOR = 'gpt-6'

class BatchSolo(Solo48):
    icon_id = 'office-worker-behind-desk'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'avatars'
    aliases = ()
    keywords = ('office', 'worker', 'behind', 'desk')
    ...
    def build(self):
        ...
        self.add_arc('crown',(16,12),(32,12),radius_x=8);self.add_arc('jaw',(32,12),(16,12),radius_x=8);self.add_contour('head','crown','jaw',closed=True)
        shoulders(20,pl=20,left=12,right=36,bottom=36,join_y=32)
        self.add_polyline('body-desk',(8,36),(12,36),(36,36),(40,36),(40,44),(8,44),closed=True)
        self.relate('connect','body-desk','body-left');self.relate('connect','body-desk','body-right')
