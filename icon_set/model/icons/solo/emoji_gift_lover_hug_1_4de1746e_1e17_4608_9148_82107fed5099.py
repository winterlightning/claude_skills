...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('gift',(6,28),(18,28),(30,28),(30,36),(30,42),(18,42),(6,42),closed=True)
        self.add_line('ribbon',(18,28),(18,42));self.relate('connect','gift','ribbon')
        self.relate('connect','face','gift')
        for i,x in enumerate((18,30)):self.add_arc(f'eye-{i}',(x-1,19),(x+1,19),radius_x=3,sweep=True)
