...
class BugHeadWithAntennae(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('antenna-l', (18, 18), (8, 4), radius_x=18, radius_y=20, sweep=True)
        self.relate("connect", 'head', 'antenna-l')
        self.add_arc('leg-l', (18, 38), (13, 44), radius_x=10, radius_y=10, sweep=False)
        self.relate("connect", 'head', 'leg-l')
        self.add_arc('antenna-r', (30, 18), (40, 4), radius_x=18, radius_y=20, sweep=False)
        self.relate("connect", 'head', 'antenna-r')
        self.add_arc('leg-r', (30, 38), (35, 44), radius_x=10, radius_y=10, sweep=True)
