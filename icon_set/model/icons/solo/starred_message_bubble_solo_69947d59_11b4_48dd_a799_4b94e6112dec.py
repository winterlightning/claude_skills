"""Starred Message Bubble. Authored directly on SOLO48 for later user-requested sub reuse.
...
class Drawing(Solo48):
    icon_id = 'starred-message-bubble-solo'
    ...
    def build(self):
        ...
        self.add_polyline('star',(24,15),(27,19),(32,19),(28,22),(29,25),(24,23),(19,25),(20,22),(16,19),(21,19),closed=True)
