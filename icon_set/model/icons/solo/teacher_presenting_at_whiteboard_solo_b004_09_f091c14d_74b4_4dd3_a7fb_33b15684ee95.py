"""Teacher presenting at whiteboard.
Plan: Teacher gestures beside open whiteboard; full_body_ref head radius four and exact gap.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Teacher reduced to stick figure gesture; head r4 center(12,14), torso start(12,26): gap8 / ink4.
...
class GeneratedSolo(Solo48):
    icon_id = 'teacher-presenting-at-whiteboard-solo-b004-09'
    ...
    def build(self):
        s = self
        circle(s,'head',12,14,4)
        s.add_line('torso',(12,26),(12,34))
        s.add_polyline('legs',(6,42),(12,34),(18,42));join(s,'torso','legs')
        s.add_polyline('arm',(12,26),(22,30));join(s,'torso','arm')
        s.mark_human_figure('person',head='head',torso='torso',torso_junction='start')
        s.add_polyline('board',(24,6),(42,6),(42,34),(30,34))
