...
class LighthouseInWaves(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("wave-left", (8,41), (17,41), radius_x=5, radius_y=3, sweep=False)
        self.add_arc("wave-middle", (17,41), (31,41), radius_x=7, radius_y=3, sweep=False)
        self.add_arc("wave-right", (31,41), (40,41), radius_x=5, radius_y=3, sweep=False)
