...
class LighthouseInWaves(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("wave-left", (6,42), (17,42), radius_x=6, radius_y=3, sweep=False)
        self.add_arc("wave-middle", (17,42), (31,42), radius_x=7, radius_y=3, sweep=False)
        self.add_arc("wave-right", (31,42), (42,42), radius_x=6, radius_y=3, sweep=False)
