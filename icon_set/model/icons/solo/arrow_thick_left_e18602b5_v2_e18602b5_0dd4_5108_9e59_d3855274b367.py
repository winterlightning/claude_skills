...
class ArrowThickLeftE18602b5Variant2(Solo48):
    icon_id = 'arrow-thick-left-e18602b5-v2'
    variant_of = 'arrow-thick-left-e18602b5'
    ...
    def build(self):
        runs = [{'start': (23, 6), 'steps': [('L', 6, 24), ('L', 42, 24)], 'closed': False}, {'start': (23, 42), 'steps': [('L', 6, 24)], 'closed': False}]
        rotation = 0
