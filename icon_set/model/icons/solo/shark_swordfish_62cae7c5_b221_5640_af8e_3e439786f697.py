"""leaping-marlin: SQUARE ink (6,6)-(42,42). Curved leaping body, tall dorsal and crescent tail; asymmetry carries motion."""
...
class LeapingMarlin(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('body-8', (22, 40), (6, 27), radius_x=22, radius_y=17, sweep=True)
        self.add_arc('body-9', (6, 27), (8, 22), radius_x=16, radius_y=16, sweep=True)
        ...
        self.add_arc('dorsal-1', (8, 22), (7, 6), radius_x=50, radius_y=50, sweep=False)
