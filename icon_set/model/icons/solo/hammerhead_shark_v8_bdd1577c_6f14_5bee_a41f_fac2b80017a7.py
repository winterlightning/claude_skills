# Variant of hammerhead-shark-v6; parent file remains unchanged.
...
class HammerheadSharkVariant8(Solo48):
    icon_id = 'hammerhead-shark-v8'
    variant_of = 'hammerhead-shark-v6'
