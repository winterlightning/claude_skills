...
class FolderDdd2bcfe(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e5', (4, 12), (8, 8), radius_x=4)
        self.add_line('e6-1', (16, 8), (17, 8))
        self.add_line('e6-2', (17, 8), (22, 13))
        self.add_arc('e6-3', (22, 13), (25, 14), radius_x=4, sweep=False)
        self.add_arc('e7', (41, 14), (44, 16), radius_x=3)
        self.add_arc('e8-1', (44, 36), (43, 39), radius_x=5)
        self.add_arc('e8-2', (43, 39), (41, 40), radius_x=3)
        self.add_arc('e9-1', (8, 40), (5, 39), radius_x=5)
        self.add_arc('e9-2', (5, 39), (4, 37), radius_x=3)
        self.add_contour('c0', 'e0', 'e5', 'e1', 'e6-1', 'e6-2', 'e6-3', 'e2', 'e7', 'e3', 'e8-1', 'e8-2', 'e4', 'e9-1', 'e9-2', closed=True)
