...
class Octopus(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('dome-left', (12, 16), (24, 6), radius_x=12, radius_y=14, sweep=True, large_arc=False)
        self.add_arc('dome-right', (24, 6), (36, 16), radius_x=12, radius_y=14, sweep=True, large_arc=False)
        ...
        self.add_arc('inner-left', (20, 33), (8, 42), radius_x=12, radius_y=13, sweep=True, large_arc=False)
        self.add_arc('inner-right', (28, 33), (40, 42), radius_x=12, radius_y=13, sweep=False, large_arc=False)
