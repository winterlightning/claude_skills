"""A rounded document outline with a folded upper-right corner whose seam extends into an inset rectangular loop."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'd3e82afb-7407-48b2-add7-fcecf69b5b5e'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_21/google docs logo 1_d3e82afb-7407-48b2-add7-fcecf69b5b5e.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'document-with-folded-corner'
...
class Drawing(Solo48):
    icon_id = 'document-with-extended-fold-seam'
    variant_of = None
    variant_label = 'Document with Extended Fold Seam'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'files'
    categories = ('files', 'primitive', 'primitives')
    aliases = ()
    keywords = ('document', 'extended', 'fold', 'seam', 'outline', 'folded', 'corner', 'inset')
    def build(self):
        # Plan: A rounded document outline with a folded upper-right corner whose seam extends into an inset rectangular loop.
        ...
        p('inset',(28,16),(16,16),(16,36),(28,36),(28,16))
