"""Frontal roe deer with mirrored leaf ears and tapered muzzle; source supplies face and neck. Centerline (6,6)-(42,42)."""
...
class RoeDeerHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('ear-left-1', (14, 16), (6, 6), radius_x=12, radius_y=14, sweep=True)
        self.add_line('ear-left-2', (6, 6), (6, 6))
        self.add_bezier('ear-left-3', (6, 6), *(((9.75486888, 6), (13.40173125, 7.28362231), (16, 10)),))
        self.add_contour('ear-left', 'ear-left-1', 'ear-left-2', 'ear-left-3', closed=False)
        self.add_arc('ear-right-1', (34, 16), (42, 6), radius_x=12, radius_y=14, sweep=False)
        self.add_line('ear-right-2', (42, 6), (42, 6))
        self.add_bezier('ear-right-3', (42, 6), *(((38.24513112, 6), (34.59826875, 7.28362231), (32, 10)),))
        ...
        self.add_arc('neck-left-2', (13, 37), (6, 42), radius_x=11, radius_y=9, sweep=True)
        self.add_contour('neck-left', 'neck-left-1', 'neck-left-2', closed=False)
        self.add_line('neck-right-1', (32, 26), (35, 37))
        self.add_arc('neck-right-2', (35, 37), (42, 42), radius_x=11, radius_y=9, sweep=False)
