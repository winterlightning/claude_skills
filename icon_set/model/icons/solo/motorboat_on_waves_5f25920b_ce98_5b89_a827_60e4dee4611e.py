...
class MotorboatOnWaves(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline('hull',(6,19),(12,19),(32,19),(42,19),(36,28),(8,28),(6,19))
        ...
        self.add_arc('wave-a',(6,39),(14,39),radius_x=5,radius_y=1,sweep=False)
        ...
        self.add_arc('wave-d',(34,39),(42,39),radius_x=5,radius_y=1,sweep=True)
