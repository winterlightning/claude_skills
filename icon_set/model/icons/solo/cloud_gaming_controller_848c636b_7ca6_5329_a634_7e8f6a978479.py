...
class CloudGamingController(Solo48):
    icon_id = 'cloud-gaming-controller'
    ...
    def build(self):
        ...
        self.add_polyline('controller', (24, 31), (35, 31), (40, 44), (31, 44), (27, 39), (21, 39), (17, 44), (8, 44), (13, 31), (24, 31), closed=True)
