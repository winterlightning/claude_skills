"""A rounded front page with a clipped upper-right corner overlaps a dashed rear page at upper-left."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'c568142f-7cf8-4e1c-abca-02f1d76da1fb'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_13/copy files_c568142f-7cf8-4e1c-abca-02f1d76da1fb.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'stacked-duplicate-document-symbol'
    variant_of = None
    variant_label = 'Stacked Duplicate Document Symbol'
    ...
    aliases = ()
    keywords = ('stacked', 'duplicate', 'document', 'page', 'clipped', 'corner', 'overlaps', 'dashed')
    def build(self):
        # Plan: A rounded front page with a clipped upper-right corner overlaps a dashed rear page at upper-left.
        ...
        p('front',(18,18),(32,18),(42,28),(42,42),(18,42),closed=True)
        p('top-left',(6,14),(6,6),(14,6));l('top-dash',(22,6),(30,6));l('left-dash',(6,22),(6,30));l('left-bottom',(6,38),(6,42))
