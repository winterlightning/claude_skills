"""A large rounded speech bubble encloses a smaller speech bubble, both with tails at lower right."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'c29842f5-9a8d-4828-803e-dab54763ae0c'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/state/comment box with message_c29842f5-9a8d-4828-803e-dab54763ae0c.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'comment-box'
...
class Drawing(Solo48):
    icon_id = 'nested-speech-bubbles'
    variant_of = 'comment-box'
    variant_label = 'Nested Speech Bubbles'
    ...
    categories = ('state',)
    aliases = ()
    keywords = ('nested', 'speech', 'bubbles', 'bubble', 'encloses', 'smaller', 'tails')
    def build(self):
        # Plan: A large rounded speech bubble encloses a smaller speech bubble, both with tails at lower right.
        ...
        p('outer',(6,6),(42,6),(42,36),(34,36),(34,42),(24,36),(6,36),closed=True)
        p('inner',(15,15),(33,15),(33,23),(26,23),(26,27),(22,23),(15,23),closed=True)
