...
class Globe(Solo48):
    ...
    def build(self) -> None:
        rim=[(24,6),(42,24),(24,42),(6,24)]
        for i in range(4):
            self.add_arc(f'rim-{i}',rim[i],rim[(i+1)%4],radius_x=20)
        self.add_contour('rim',*(f'rim-{i}' for i in range(4)),closed=True)
        self.add_arc('meridian-left-top',(24,6),(14,24),radius_x=25,sweep=False)
        self.add_arc('meridian-left-bottom',(14,24),(24,42),radius_x=25,sweep=False)
        self.add_arc('meridian-right-bottom',(24,42),(34,24),radius_x=25,sweep=False)
        self.add_arc('meridian-right-top',(34,24),(24,6),radius_x=25,sweep=False)
        self.add_contour('meridians','meridian-left-top','meridian-left-bottom','meridian-right-bottom','meridian-right-top',closed=True)
        self.add_polyline('equator',(6,24),(14,24),(34,24),(42,24))
