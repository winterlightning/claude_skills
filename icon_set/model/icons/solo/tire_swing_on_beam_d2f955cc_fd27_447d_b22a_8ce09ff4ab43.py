"""Tire Swing on Beam — batch 55."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'd2f955cc-fd27-447d-b22a-8ce09ff4ab43'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/kids/playground tire swing_d2f955cc-fd27-447d-b22a-8ce09ff4ab43.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'tire-swing-on-beam'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'kids'
    aliases = ()
    keywords = ('tire', 'swing', 'on', 'beam')

    def build(self):
        # Plan: rounded overhead beam with a central rope attached to a concentric tire.
        # SQUARE extremes6,6,42,42. Source structure; no useful exact Lucide match.
        # Beam becomes one thick rounded stroke, preserving clear space above the tire.
        self.add_polyline('beam',(6,6),(24,6),(42,6))
        self.add_line('rope',(24,6),(24,18));self.circle('tire',24,30,12);self.circle('opening',24,30,3);self.join_shared()
