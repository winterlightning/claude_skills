...
Plan: Upright envelope and two parallel speed strokes.
Construction reference: Lucide mail; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/send email_b16d6d74-2c11-46d0-b165-8f50e0a4a4c2.svg
"""
...
class GeneratedSolo(Solo48):
    icon_id = 'sending-mail-envelope-batch-008-15'
    ...
    def build(self):
        ...
        rect('envelope',18,10,26,28)
        path('flap',(18,10),(31,23),(44,10))
        for y in (18,30): line(f'speed-{y}',(4,y),(10,y))
