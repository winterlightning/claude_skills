...
SOURCE_PATH = 'pictographic-primitives/phones/phone retro_5ca50b01-8656-4eb1-afbd-538f1b2ca7cb.svg'
AUTHOR = 'gpt-6'
...
class RoundRotaryTelephone(Solo48):
    ...
    def build(self):
        ...
        compact_receiver()
        ellipse('base-left',(14,17),(10,26),4,9,False)
        ellipse('base-bottom',(10,26),(38,26),14,16,False)
        ellipse('base-right',(38,26),(34,17),4,9,False)
