...
SOURCE_ICON_ID = '90e4d268-936f-43da-bda4-3024899f9539'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_12/computer project screen_90e4d268-936f-43da-bda4-3024899f9539.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'computer-display-screen-with-stand-solo'
DESIGN_NOTES = 'Lower bezel merges into the monitor outline; preserve rear projection screen and front stand.'
CONSTRUCTION_REFERENCE = 'Lucide presentation original and atomic-debug; coherent contours and shared attachment nodes.'

class Drawing(Solo48):
    icon_id = 'computer-screen-projection'
    variant_of = 'computer-display-screen-with-stand-solo'
    variant_label = 'Computer Screen Projection'
    ...
    def build(self):
        # Plan: A desktop monitor with lower bezel and stand overlaps a second rounded rectangular display at upper-right.
        # SQUARE: exact SOLO48 envelope; repeated parts share coordinates.
        # Reduction: Lower bezel merges into the monitor outline; preserve rear projection screen and front stand.
        ...
        p('rear',(18,12),(18,6),(42,6),(42,30),(39,30))
        rr('monitor',6,22,30,34,2,bottom=(18,))
        l('stand',(18,34),(18,42));p('foot',(10,42),(18,42),(26,42))
