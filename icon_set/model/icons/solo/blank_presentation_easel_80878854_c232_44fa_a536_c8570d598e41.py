...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_10/chalkboard_80878854-c232-44fa-a536-c8570d598e41.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'blank-presentation-easel'
    variant_of = 'blank-board-on-easel'
    variant_label = 'Blank Presentation Easel'
    ...
    aliases = ()
    keywords = ('presentation', 'easel', 'wide', 'board', 'legged', 'stand', 'brace')
    def build(self):
        # Plan: A wide rounded rectangular board on a two-legged stand with a horizontal brace.
        ...
        rr('board',6,6,42,30,3,bottom=(16,32))
        p('left-leg',(16,30),(14,38),(12,42));p('right-leg',(32,30),(34,38),(36,42));l('brace',(14,38),(34,38))
