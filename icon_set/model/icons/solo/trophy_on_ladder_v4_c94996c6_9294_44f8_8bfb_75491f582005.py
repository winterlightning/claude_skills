...
class TrophyOnLadderVariant4(Solo48):
    icon_id = 'trophy-on-ladder-v4'
    variant_of = 'trophy-on-ladder-v2'
    ...
    def build(self) -> None:
        ...
        self.add_line('cup-wall-left', (16, 14), (16, 4))
        self.add_line('cup-rim', (16, 4), (32, 4))
        self.add_line('cup-wall-right', (32, 4), (32, 14))
        ...
        self.add_line('handle-left-top', (16, 4), (8, 4))
        self.add_arc('handle-left', (8, 4), (16, 14), large_arc=False, radius_x=8, radius_y=10, sweep=False)
        self.add_contour('left-handle', 'handle-left-top', 'handle-left', closed=False)
        self.relate('connect', 'left-handle', 'cup')
        self.add_line('handle-right-top', (32, 4), (40, 4))
        self.add_arc('handle-right', (40, 4), (32, 14), large_arc=False, radius_x=8, radius_y=10, sweep=True)
        self.add_contour('right-handle', 'handle-right-top', 'handle-right', closed=False)
        self.relate('connect', 'right-handle', 'cup')
        self.add_polyline('ladder', (16, 44), (18, 34), (20, 24), (24, 24), (28, 24), (30, 34), (32, 44), closed=False)
