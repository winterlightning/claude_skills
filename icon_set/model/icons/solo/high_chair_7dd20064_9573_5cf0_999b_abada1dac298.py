...
class HighChair(Solo48):
    ...
    def build(self) -> None:
        self.add_line('tray-1', (6, 19), (42, 19))
        self.add_line('tray-2', (42, 19), (42, 27))
        self.add_line('tray-3', (42, 27), (6, 27))
        self.add_line('tray-4', (6, 27), (6, 19))
        self.add_contour('tray', 'tray-1', 'tray-2', 'tray-3', 'tray-4', closed=True)
        self.add_line('back-1', (13, 19), (11, 9))
        self.add_bezier('back-2', (11, 9), *(((12.53761026, 6.70714356), (15.27923481, 6), (18, 6)),))
        self.add_line('back-3', (18, 6), (30, 6))
        self.add_bezier('back-4', (30, 6), *(((32.72076519, 6), (35.46238974, 6.70714356), (37, 9)),))
        self.add_line('back-5', (37, 9), (35, 19))
        self.add_contour('back', 'back-1', 'back-2', 'back-3', 'back-4', 'back-5', closed=False)
        self.add_line('left-leg-1', (8, 27), (6, 42))
        self.add_contour('left-leg', 'left-leg-1', closed=False)
        self.add_line('right-leg-1', (40, 27), (42, 42))
