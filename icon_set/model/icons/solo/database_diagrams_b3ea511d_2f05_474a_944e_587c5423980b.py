"""database-diagrams: next hundred AI review; original preserved."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'b3ea511d-2f05-474a-944e-587c5423980b'
SOURCE_PATH = 'pictographic-primitives/diagrams/database_b3ea511d-2f05-474a-944e-587c5423980b.svg'
AUTHOR = 'gpt-6'

class DatabaseDiagrams(Solo48):
    icon_id = 'database-diagrams'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'diagrams'
    categories = ('diagrams', 'state')
    aliases = ()
    ...
    def build(self):
        ...
        for y in [24]:
         path(f'ring-{y}',(8,y),[('A',(40,y),16,5,False)]);join(f'ring-{y}','body')
