...
class IglooWithFlag(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("dome-left", (6,42), (24,20), radius_x=22, radius_y=26)
        self.add_arc("dome-right", (24,20), (42,42), radius_x=22, radius_y=26)
        self.add_line("ground-right", (42,42), (31,42))
        self.add_line("door-right", (31,42), (31,39))
        self.add_arc("door", (31,39), (17,39), radius_x=7, sweep=False)
        self.add_line("door-left", (17,39), (17,42))
        self.add_line("ground-left", (17,42), (6,42))
        self.add_contour("shelter", "dome-left", "dome-right", "ground-right", "door-right", "door", "door-left", "ground-left", closed=True)
        self.add_polyline("pennant", (24,20), (24,16), (24,6), (42,9), (24,16))
