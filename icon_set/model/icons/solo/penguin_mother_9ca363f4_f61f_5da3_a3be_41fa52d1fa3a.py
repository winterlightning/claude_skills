...
class PenguinLookingDown(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('outline-1', (8, 18), (20, 6), radius_x=12, radius_y=16, sweep=True)
        self.add_arc('outline-2', (20, 6), (35, 17), radius_x=15, radius_y=15, sweep=True)
        self.add_arc('outline-3', (35, 17), (37, 39), radius_x=70, radius_y=70, sweep=True)
        self.add_line('outline-4', (37, 39), (40, 42))
        self.add_line('outline-5', (40, 42), (27, 42))
        self.add_arc('outline-6', (27, 42), (20, 18), radius_x=15, radius_y=35, sweep=True)
