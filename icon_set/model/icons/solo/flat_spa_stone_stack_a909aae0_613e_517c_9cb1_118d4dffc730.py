...
SOURCE_ICON_ID = 'a909aae0-613e-517c-9cb1-118d4dffc730'
SOURCE_PATH = 'pictographic-primitives/spas/spa stone_a909aae0-613e-517c-9cb1-118d4dffc730.svg'
AUTHOR = 'gpt-6'

class FlatSpaStoneStack(Solo48):
    icon_id = 'flat-spa-stone-stack'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "spas"
    aliases = ()
    keywords = ('spa', 'wellness', 'flat-spa-stone-stack')

    def build(self):
        self.add_arc('top-top', (14,11), (34,11), radius_x=10, radius_y=5)
        self.add_arc('top-bottom', (34,11), (14,11), radius_x=10, radius_y=5)
        self.add_contour('top', 'top-top', 'top-bottom', closed=True)
        self.add_arc('middle-upper-left', (14,11), (8,25), radius_x=6, radius_y=14, sweep=False)
        self.add_arc('middle-lower', (8,25), (40,25), radius_x=16, radius_y=7, sweep=False)
        self.add_arc('middle-upper-right', (40,25), (34,11), radius_x=6, radius_y=14, sweep=False)
