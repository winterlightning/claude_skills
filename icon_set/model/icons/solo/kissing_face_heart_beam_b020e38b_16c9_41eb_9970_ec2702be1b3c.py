"""A kissing face with closed eyes and a heart at its side.
...
class KissingFaceHeartBeam(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('eye-left',(12,21),(20,21),radius_x=5,radius_y=4,sweep=False)
        self.add_arc('eye-right',(28,21),(36,21),radius_x=5,radius_y=4,sweep=False)
        self.add_polyline('kiss',(23,30),(27,31),(23,34))
