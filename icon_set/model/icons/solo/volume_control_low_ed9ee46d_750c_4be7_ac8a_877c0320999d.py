...
class VolumeControlLow(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e3', (8, 17), (8, 19))
        self.add_line('sym-e4', (8, 19), (8, 24))
        self.add_line('sym-e5', (8, 24), (8, 29))
        self.add_line('sym-e6', (8, 29), (8, 31))
        self.add_line('sym-e7', (8, 31), (12, 32))
        self.add_line('sym-e8', (12, 32), (19, 32))
        self.add_arc('sym-e9', (19, 32), (25, 37), radius_x=69, sweep=False)
        self.add_line('sym-e10', (25, 37), (31, 41))
        self.add_arc('sym-e11', (31, 41), (36, 44), radius_x=10, sweep=False)
        self.add_line('sym-e12', (36, 44), (37, 44))
        self.add_arc('sym-e14', (37, 44), (40, 41), radius_x=3, sweep=False)
        self.add_line('sym-e16', (40, 41), (40, 24))
        self.add_line('sym-e17', (40, 24), (40, 7))
        self.add_arc('sym-e19', (40, 7), (37, 4), radius_x=4, sweep=False)
        self.add_line('sym-e21', (37, 4), (36, 4))
        self.add_arc('sym-e22', (36, 4), (31, 7), radius_x=10, sweep=False)
        self.add_line('sym-e23', (31, 7), (25, 11))
        self.add_arc('sym-e24', (25, 11), (19, 16), radius_x=69, sweep=False)
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e14', 'sym-e16', 'sym-e17', 'sym-e19', 'sym-e21', 'sym-e22', 'sym-e23', 'sym-e24')
