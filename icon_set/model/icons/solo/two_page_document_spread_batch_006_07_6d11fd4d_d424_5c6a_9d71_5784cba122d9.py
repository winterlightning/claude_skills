"""Two Page Document Spread.
Plan: Shared gutter and clipped corner retained; two short text lines.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/align to spread_6d11fd4d-d424-5c6a-9d71-5784cba122d9.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '6d11fd4d-d424-5c6a-9d71-5784cba122d9'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/align to spread_6d11fd4d-d424-5c6a-9d71-5784cba122d9.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'two-page-document-spread-batch-006-07'
    ...
    def build(self):
        ...
        path('spread',(6,6),(32,6),(42,16),(42,42),(6,42),closed=True)
        line('gutter',(24,6),(24,42))
        for y in (18,30): line(f'text-{y}',(14,y),(16,y))
