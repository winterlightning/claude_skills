...
class LogisticWeight(Solo48):
    ...
    def build(self):
        self.add_arc('sym-e0', (28, 14), (29, 11), radius_x=10, sweep=False)
        self.add_arc('sym-e1', (29, 11), (26, 6), radius_x=5, sweep=False)
        self.add_line('sym-e2', (26, 6), (25, 6))
        self.add_arc('sym-e3', (25, 6), (24, 6), radius_x=52)
        self.add_line('sym-e8', (24, 6), (23, 6))
        self.add_line('sym-e9', (23, 6), (22, 6))
        self.add_arc('sym-e10', (22, 6), (19, 11), radius_x=5, sweep=False)
        self.add_arc('sym-e11', (19, 11), (20, 14), radius_x=10, sweep=False)
        self.add_line('sym-e12', (20, 14), (24, 14))
        self.add_line('sym-e13', (24, 14), (28, 14))
        self.add_line('sym-e14', (28, 14), (34, 14))
        self.add_arc('sym-e15', (34, 14), (37, 17), radius_x=3)
        ...
        self.add_arc('sym-e24', (11, 17), (14, 14), radius_x=3)
        self.add_line('sym-e25', (14, 14), (20, 14))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e15', 'sym-e16', 'sym-e17', 'sym-e18', 'sym-e19', 'sym-e20', 'sym-e21', 'sym-e22', 'sym-e23', 'sym-e24', 'sym-e25')
