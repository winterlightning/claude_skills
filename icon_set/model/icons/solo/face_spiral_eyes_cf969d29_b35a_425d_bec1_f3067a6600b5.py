...
Design changes: One full turn per eye replaces the denser winding. The outer curls meet the forehead and jaw at shared nodes. Straight mouth retained.
References: Original reference supplies opposing spiral directions and flat mouth. No local Lucide spiral match found. Human user.svg reviewed; no body is depicted.
"""
...
class Drawing(Solo48):
    icon_id='dizzy-hypnotized-face-solo'
    ...
    def build(self):
        ...
        self.add_line('mouth',(22,31),(26,31))