...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/resize expand corner_5258ac69-241c-4b0b-aabc-f19af491ff9e.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-005/references/resize expand corner_5258ac69-241c-4b0b-aabc-f19af491ff9e.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    ...
    category = 'objects'
    aliases = ()
    keywords = ('diagonal', 'expand', 'square', 'icon')

    def build(self):
        s = self
        box(s,'frame',6,6,42,42,3)
        s.add_polyline('corner',(15,30),(20,30),(20,33))
