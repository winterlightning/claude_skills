...
Plan: Wide archive folder, hanging zipper pull and single zipper tooth.
Construction reference: Lucide folder; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/folder zip_9382e030-a1e3-548f-9171-a89bf59e09b7.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '9382e030-a1e3-548f-9171-a89bf59e09b7'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/folders/folder zip_9382e030-a1e3-548f-9171-a89bf59e09b7.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'archive-folder-with-zipper-batch-009-09'
    ...
    aliases = ()
    keywords = ('archive', 'folder', 'with', 'zipper')
    ...
    def build(self):
        ...
        path('folder',(4,40),(4,8),(17,8),(23,16),(44,16),(44,40),closed=True)
        path('pull',(28,16),(28,24),(36,24),(36,16))
        self.add_dot('zipper',(32,32))
