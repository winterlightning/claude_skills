...
class GasPollutionMask(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('e4', (10, 35), ((10.514, 35.864), (10.703, 36.718), (11.326, 37.5)), ((14.198, 41.1), (18.787, 43.991), (23.284, 43.991)), ((23.425, 43.991), (23.558, 44), (23.699, 44)), ((23.916, 44), (24.135, 43.991), (24.345, 43.991)), ((28.749, 43.991), (33.356, 41.491), (36.295, 38.027)), ((37.103, 37.073), (37.394, 36.109), (38, 35)))
        ...
        self.add_bezier('e8', (40, 20), ((40, 19.627), (39.992, 19.609), (39.992, 19.236)), ((39.992, 18.636), (39.352, 16.373), (39.158, 15.755)), ((37.095, 9.173), (31.057, 4.009), (24.48, 4.009)), ((24.414, 4.009), (24.339, 4), (24.273, 4)), ((23.949, 4), (23.638, 4.009), (23.318, 4.009)), ((17.272, 4.009), (11.916, 8.518), (9.482, 14.282)), ((9.027, 15.364), (8.758, 16.473), (8.446, 17.6)), ((8.337, 17.991), (8.008, 18.455), (8.008, 18.864)), ((8, 19.409), (8, 19.518), (8, 20)))
        self.add_contour('c0', 'e3', closed=False)
        self.add_contour('c1', 'e4', closed=False)
        self.add_contour('c2', 'e5', 'e0', closed=False)
        self.add_contour('c3', 'e6', 'e1', closed=False)
        self.add_contour('c4', 'e2', 'e7', closed=False)
