...
class Shrimp(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('back', (27, 14), (42, 33), radius_x=19, radius_y=19, sweep=True, large_arc=False)
        self.add_arc('rump', (42, 33), (30, 42), radius_x=16, radius_y=13, sweep=True, large_arc=False)
        self.add_line('tail-base', (30, 42), (6, 42))
        self.add_line('tail-fan-1', (6, 42), (6, 41))
        self.add_line('tail-fan-2', (6, 41), (10, 37))
        ...
        self.add_arc('antenna-curl', (14, 14), (14, 6), radius_x=6, radius_y=6, sweep=True, large_arc=False)
        self.add_line('antenna', (14, 6), (32, 6))
        self.add_contour('antenna-shape', 'antenna-curl', 'antenna', closed=False)
        self.relate("connect", 'antenna-shape', 'outline')
        self.add_line('segment', (34, 28), (42, 25))
