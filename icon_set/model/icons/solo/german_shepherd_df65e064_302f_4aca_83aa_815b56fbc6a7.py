...
SOURCE_PATH = 'pictographic-primitives/pets/german shepherd_df65e064-302f-4aca-83aa-815b56fbc6a7.svg'
AUTHOR = 'gpt-6'
...
class GermanShepherd(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e6', (12, 23), (11, 20), radius_x=9, radius_y=9, large_arc=False, sweep=True)
        self.add_arc('sym-e7', (11, 20), (10, 13), radius_x=7, radius_y=7, large_arc=False, sweep=True)
        ...
        self.add_arc('sym-e13', (17, 9), (20, 16), radius_x=26, radius_y=26, large_arc=False, sweep=False)
        self.add_line('sym-e14', (20, 16), (28, 16))
        self.add_arc('sym-e16', (28, 16), (31, 9), radius_x=26, radius_y=26, large_arc=False, sweep=True)
        ...
        self.add_arc('sym-e22', (38, 13), (37, 20), radius_x=7, radius_y=7, large_arc=False, sweep=True)
        ...
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e4', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e9', 'sym-e11', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e16', 'sym-e17', 'sym-e18', 'sym-e20', 'sym-e21', 'sym-e22', 'sym-e23', 'sym-e25', 'sym-e28', 'sym-e29', closed=False)
