...
class Network5GSymbol(Solo48):
    ...
    def build(self):
        ...
        chain('five-top',(18,8),(6,8),(6,24),(12,24))
        arc('five-round',(12,24),(12,40),8)
        line('five-base',(12,40),(6,40));contour('five','five-top-1','five-top-2','five-top-3','five-round','five-base')
        arc('g-top',(42,15),(30,15),7,sweep=False)
        line('g-left',(30,15),(30,33));arc('g-bottom',(30,33),(42,33),7,sweep=False)
        chain('g-bar',(42,33),(42,25),(38,25));contour('g','g-top','g-left','g-bottom','g-bar-1','g-bar-2')
