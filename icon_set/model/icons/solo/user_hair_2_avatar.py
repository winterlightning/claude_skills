"""user-hair-2: shirt fastening with reference head silhouette.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-10/references/user-hair-2.svg'
SOURCE_HEAD_ICON_ID = 'user-hair-2'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserHair2Avatar(Solo48):
    icon_id = 'user-hair-2-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'hair', '2', 'portrait', 'bust')
    def build(self):
