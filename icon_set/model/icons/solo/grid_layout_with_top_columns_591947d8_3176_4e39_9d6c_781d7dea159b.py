...
SOURCE_ICON_ID = '591947d8-3176-4e39-9d6c-781d7dea159b'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_25/layout 12_591947d8-3176-4e39-9d6c-781d7dea159b.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'layout-two-upper-panes'
...
class Drawing(Solo48):
    icon_id = 'grid-layout-with-top-columns'
    variant_of = 'layout-two-upper-panes'
    variant_label = 'Grid Layout with Top Columns'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('grid', 'layout', 'columns', 'square', 'frame', 'cells', 'full', 'width')
    def build(self):
        # Plan: A rounded square frame with two upper cells and two full-width rows below.
        ...
        rr('frame',6,6,42,42,2,top=(24,),left=(22,32),right=(22,32))
