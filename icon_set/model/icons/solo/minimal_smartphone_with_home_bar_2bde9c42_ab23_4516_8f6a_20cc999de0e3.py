"""Rounded upright body and centered home bar; softened clipped corners for tangent flow.
...
class MinimalSmartphoneWithHomeBar(Solo48):
    icon_id = 'minimal-smartphone-with-home-bar'
