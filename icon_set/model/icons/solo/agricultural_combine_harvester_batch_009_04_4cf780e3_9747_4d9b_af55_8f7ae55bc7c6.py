...
Plan: Combine with raised harvesting arm, large wheel and one crop sprout; cabin raised for clearance.
Construction reference: Lucide cable; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/harvester_4cf780e3-9747-4d9b-af55-8f7ae55bc7c6.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '4cf780e3-9747-4d9b-af55-8f7ae55bc7c6'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/farming/harvester_4cf780e3-9747-4d9b-af55-8f7ae55bc7c6.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'agricultural-combine-harvester-batch-009-04'
    ...
    def build(self):
        ...
        circle('wheel',36,33,7)
        path('body',(29,33),(20,33),(24,16),(36,16),(36,26))
        path('arm',(4,18),(20,8),(28,16))
        line('nose',(36,16),(44,16))
        path('crop',(4,34),(8,40),(12,34))
