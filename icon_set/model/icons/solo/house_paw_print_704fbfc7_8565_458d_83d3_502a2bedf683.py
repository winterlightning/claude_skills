"""house-paw-print: Restore closed triangular pad; top toe shifted down one for roof clearance. Three solid toes preserve reference arrangement.
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for name,x,y in [('toe-left',16,21),('toe-top',24,16),('toe-right',32,21)]:self.add_dot(name,(x,y))
