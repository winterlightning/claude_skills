"""user-vneck-hair-long-1: long hair and rounded button collar.
Distinct-avatar plan: preserve reference identity; use long hair and rounded button collar.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-13/references/user-vneck-hair-long-1.svg'
SOURCE_HEAD_ICON_ID = 'user-vneck-hair-long-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 22
class UserVneckHairLong1Avatar(Solo48):
    icon_id = 'user-vneck-hair-long-1-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'vneck', 'hair', 'long', '1', 'portrait', 'bust')
    def build(self):
        cx = 24
        for side, sign in [('left', -1), ('right', 1)]:
            pt = lambda x, y: (cx + sign * x, y)
            self.add_arc('hair-' + side, (cx, 4), pt(16, 14), radius_x=16, radius_y=10, sweep=sign > 0)
            self.add_bezier('tip-' + side, pt(16,14),(pt(16,18),pt(16,20),pt(16,22)))
        ...
        self.add_line('body-button-placket',(24,32),(24,44))
