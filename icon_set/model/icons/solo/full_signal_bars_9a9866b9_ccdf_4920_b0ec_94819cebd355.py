"""Three upright hollow signal bars stand on a common baseline and increase in height from left to right. Their straight sides and level tops form a stepped silhouette with open gaps between the bars."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '9a9866b9-ccdf-4920-b0ec-94819cebd355'
SOURCE_PATH = 'pictographic-primitives/mobile/signal full_9a9866b9-ccdf-4920-b0ec-94819cebd355.svg'
AUTHOR = 'gpt-6'

class MobileIcon(Solo48):
    icon_id = 'full-signal-bars'
    ...
    aliases = ()
    keywords = ('signal', 'full', 'bars', 'reception', 'cellular', 'network', 'strength')
    ...
    def build(self):
        ...
        # HRECT_L extremes (4,8)-(44,40): equal widths and equal horizontal spacing.
