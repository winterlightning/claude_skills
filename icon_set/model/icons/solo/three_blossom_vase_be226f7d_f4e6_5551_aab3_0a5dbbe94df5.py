...
class ThreeBlossomVase(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('front1',(27,23),(30,26),radius_x=3)
        self.add_arc('front2',(30,26),(24,32),radius_x=6)
        self.add_arc('front2b',(24,32),(18,26),radius_x=6)
        self.add_arc('front3',(18,26),(21,23),radius_x=3)
        ...
        self.add_contour('front',*('front0', 'front1', 'front2', 'front2b', 'front3'),closed=True)
