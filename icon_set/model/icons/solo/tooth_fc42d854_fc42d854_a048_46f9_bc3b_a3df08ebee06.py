"""tooth-fc42d854: Smooth tooth crown and roots; earlier revisions preserved."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'fc42d854-a048-46f9-bc3b-a3df08ebee06'
SOURCE_PATH = 'pictographic-primitives/health/tooth_fc42d854-a048-46f9-bc3b-a3df08ebee06.svg'
AUTHOR = 'gpt-6'

class ToothFc42d854(Solo48):
    icon_id = 'tooth-fc42d854'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'health'
    aliases = ()
    keywords = ('solo-ai-full-set', 'tooth-fc42d854')
