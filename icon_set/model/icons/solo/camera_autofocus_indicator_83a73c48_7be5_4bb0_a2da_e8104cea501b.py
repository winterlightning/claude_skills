"""A rounded square frame contains a central circle between two tall inward-facing arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '83a73c48-7be5-4bb0-a2da-e8104cea501b'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/photography/focus_83a73c48-7be5-4bb0-a2da-e8104cea501b.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'focus-circle'
...
class Drawing(Solo48):
    icon_id = 'camera-autofocus-indicator'
    variant_of = 'focus-circle'
    variant_label = 'Camera Autofocus Indicator'
    ...
    def build(self):
        # Plan: A rounded square frame contains a central circle between two tall inward-facing arcs.
        ...
        rr('frame',4,8,44,40,2)
        c('focus',24,24,2)
        a('left',(16,31),(16,17),3,ry=7)
        a('right',(32,17),(32,31),3,ry=7)
