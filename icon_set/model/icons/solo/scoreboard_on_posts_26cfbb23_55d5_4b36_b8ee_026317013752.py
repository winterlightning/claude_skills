"""Scoreboard on Posts, independently authored on SOLO48."""
...
class ScoreboardOnPosts(Solo48):
    icon_id='scoreboard-on-posts'
    ...
    def build(self) -> None:
        ...
        for x in (14,2*axis-14):
            self.add_line(f'mount-{x}',(x,34),(x,40))
            self.relate('connect',f'mount-{x}','frame')
        arc('two-top',(13,19),(21,19),4,2)
        poly('two-lower',(21,19),(13,25),(21,25))
