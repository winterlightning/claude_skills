"""Open Storage Drawer.
Plan: Raised rear rim and scooped drawer front; one outline owns both sides.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/drawer open_244afd80-5d73-57d2-8e56-c06e1e49d855.svg
"""
...
class GeneratedSolo(Solo48):
    icon_id = 'open-storage-drawer-batch-008-10'
    ...
    def build(self):
        ...
        path('outer',(4,24),(10,8),(38,8),(44,24),(44,40),(4,40),closed=True)
        path('front-rim',(4,24),(14,24))
        arc('scoop',(14,24),(34,24),10,8,False)
        line('rim-right',(34,24),(44,24))
