...
class NecklaceWithThreeBeadsVariant3(Solo48):
    icon_id = 'necklace-with-three-beads-v3'
    variant_of = 'necklace-with-three-beads-v2'
    ...
    def build(self) -> None:
        """Opening repair: Made the central pendant a broader oval, keeping the cord attachments fixed."""
        ...
        self.add_arc('main-bead-a', (24, 30), (24, 42), sweep=True, radius_x=5, radius_y=6)
        self.add_arc('main-bead-b', (24, 42), (24, 30), sweep=True, radius_x=5, radius_y=6)
