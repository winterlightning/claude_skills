"""car-5e6ba5b0: Rounded sedan; earlier revisions preserved."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '5e6ba5b0-525c-42f8-9b38-33b843bfe31b'
SOURCE_PATH = 'icons-json/transportation/car_5e6ba5b0-525c-42f8-9b38-33b843bfe31b.json'
AUTHOR = 'gpt-6'
...
class Car5e6ba5b0(Solo48):
    ...
    def build(self):
        ...
        path('body',(6,34),[('C', (4, 24), (4, 32), (4, 28)), ('C', (10, 18), (4, 20), (6, 18)), ('L', (14, 12)), ('C', (20, 8), (15, 9), (17, 8)), ('L', (28, 8)), ('C', (34, 12), (31, 8), (33, 9)), ('L', (38, 18)), ('C', (44, 24), (40, 18), (44, 20)), ('C', (42, 34), (44, 28), (44, 32)), ('A', (36, 40), 6, 6, True), ('A', (30, 34), 6, 6, True), ('L', (18, 34)), ('A', (12, 40), 6, 6, True), ('A', (6, 34), 6, 6, True)],True)
