"""Code Chat Bubble. Authored directly on SOLO48 for later user-requested sub reuse.
...
class Drawing(Solo48):
    icon_id = 'code-message-67-solo'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    tags = ('sub icon',)
    keywords = ('sub icon', 'code chat bubble')
    def build(self):
        ...
        self.add_line('code-underscore',(28,25),(33,25))
