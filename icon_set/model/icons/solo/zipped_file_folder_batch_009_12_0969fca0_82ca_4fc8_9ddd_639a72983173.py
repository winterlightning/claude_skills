"""Zipped File Folder.
Plan: Upright zip folder with long pull and interrupted seam.
Construction reference: Lucide folder; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/file zip_0969fca0-82ca-4fc8-9ddd-639a72983173.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '0969fca0-82ca-4fc8-9ddd-639a72983173'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/folders/file zip_0969fca0-82ca-4fc8-9ddd-639a72983173.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'zipped-file-folder-batch-009-12'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "folders"
    aliases = ()
    keywords = ('zipped', 'file', 'folder')
    ...
    def build(self):
        ...
        path('folder',(8,44),(8,4),(20,4),(24,12),(40,12),(40,44),closed=True)
        path('pull',(24,12),(24,24),(32,24),(32,12))
        line('zipper',(28,33),(28,35))
