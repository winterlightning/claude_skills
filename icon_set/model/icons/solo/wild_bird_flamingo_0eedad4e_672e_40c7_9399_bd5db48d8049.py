"""Flamingo with long neck and one supporting leg; extremes (8,6)-(40,42). Open neck and crescent body preserve clear space; tucked leg reduced to a bent stroke."""
...
class Flamingo(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('head', (26, 10), (34, 6), radius_x=8, radius_y=8, sweep=True)
        self.add_arc('head-front', (34, 6), (40, 10), radius_x=6, radius_y=8, sweep=True)
