"""woman-beanie-1: winter sweater neckline with reference head silhouette.
...
Body cue: winter sweater neckline. Shared parameters own mirrored elements.
"""
...
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class WomanBeanie1Avatar(Solo48):
    icon_id = 'woman-beanie-1-avatar'
    ...
    aliases = ()
    keywords = ('woman', 'beanie', '1', 'portrait', 'bust')
    def build(self):
        ...
        self.add_polyline('brim',(12,16),(14,16),(34,16),(36,16))
