...
SOURCE_ICON_ID = '03b6bf01-e0ce-40d9-ab96-7d9cdf917ff5'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_01/alert notification bars 2_03b6bf01-e0ce-40d9-ab96-7d9cdf917ff5.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'two-stacked-rounded-cards'
...
class Drawing(Solo48):
    icon_id = 'stacked-notification-cards'
    variant_of = 'two-stacked-rounded-cards'
    variant_label = 'Stacked Notification Cards'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('stacked', 'notification', 'cards', 'wide', 'vertically', 'header', 'band')
    def build(self):
        # Plan: Two wide rounded rectangular cards stacked vertically, each with a narrow header band.
