...
class LabBottleExperiment(Solo48):
    ...
    def build(self):
        ...
        self.add_line('e7', (30, 19), (39, 37))
        self.add_line('e8-1', (39, 37), (40, 40))
        self.add_arc('e8-2', (40, 40), (36, 44), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        self.add_line('e8-3', (36, 44), (13, 44))
        self.add_arc('e9-1', (13, 44), (10, 43), radius_x=5, radius_y=5, large_arc=False, sweep=True)
        self.add_line('e9-2', (10, 43), (8, 40))
        self.add_line('e9-3', (8, 40), (9, 37))
        self.add_arc('e10', (17, 21), (18, 19), radius_x=15, radius_y=15, large_arc=False, sweep=True)
        self.add_line('e11-1', (18, 8), (16, 7))
        self.add_arc('e11-2', (16, 7), (17, 4), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('e12-1', (29, 4), (32, 5))
        self.add_arc('e12-2', (32, 5), (32, 7), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('e12-3', (32, 7), (30, 8))
        self.add_contour('c0', 'e0', closed=False)
        self.add_contour('c1', 'e1', 'e7', 'e8-1', 'e8-2', 'e8-3', 'e9-1', 'e9-2', 'e9-3', 'e4', 'e10', 'e5', 'e11-1', 'e11-2', 'e6', 'e12-1', 'e12-2', 'e12-3', closed=True)
