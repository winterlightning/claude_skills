...
class Receipt(Solo48):
    ...
    def build(self):
        ...
        self.add_line('e19', (40, 7), (40, 42))
        self.add_arc('e20', (10, 43), (8, 40), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        self.add_arc('e21', (38, 4), (40, 7), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        self.add_arc('e22-2', (40, 42), (38, 44), radius_x=3, radius_y=3, large_arc=False, sweep=True)
        self.add_line('e22-3', (38, 44), (37, 44))
        self.add_line('e23', (37, 44), (38, 44))
        self.add_contour('c0', 'e0', 'e1', 'e2', 'e3', 'e4', 'e5', 'e6', 'e7', 'e8', 'e20', 'e9', 'e11', 'e12', 'e13', 'e14', 'e15', 'e16', 'e17', 'e18', 'e21', 'e19', 'e22-2', 'e22-3', closed=True)
        self.add_contour('c1', 'e23', closed=False)
