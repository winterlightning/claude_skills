...
class Shark(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('body-1', (6, 25), (19, 17), radius_x=30, radius_y=24, sweep=True)
        ...
        self.add_arc('body-5', (38, 22), (42, 14), radius_x=20, radius_y=20, sweep=True)
        self.add_arc('body-6', (42, 14), (42, 36), radius_x=32, radius_y=32, sweep=False)
        self.add_arc('body-7', (42, 36), (38, 29), radius_x=20, radius_y=20, sweep=True)
        ...
        self.add_arc('body-11', (19, 32), (6, 25), radius_x=30, radius_y=24, sweep=True)
