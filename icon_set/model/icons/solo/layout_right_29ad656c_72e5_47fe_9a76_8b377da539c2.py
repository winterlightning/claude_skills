...
class LayoutRight(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (39, 42), (42, 39), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_line('sym-e4', (42, 39), (42, 9))
        self.add_arc('sym-e7', (42, 9), (39, 6), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_line('sym-e8', (39, 6), (9, 6))
        self.add_arc('sym-e10', (9, 6), (6, 9), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_line('sym-e11', (6, 9), (6, 39))
        self.add_arc('sym-e13', (6, 39), (9, 42), radius_x=5, radius_y=5, large_arc=False, sweep=False)
