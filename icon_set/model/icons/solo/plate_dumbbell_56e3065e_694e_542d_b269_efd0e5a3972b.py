"""A horizontal dumbbell has a short thick grip joining two upright weight plates. Smaller end caps project beyond the plates, with the left plate shown slightly turned in perspective.

Perspective left plate and straight right plate retained; bar and caps reduced to strokes.
...
SOURCE_PATH = 'pictographic-primitives/sports/fitness grip weights_56e3065e-694e-542d-b269-efd0e5a3972b.svg'
AUTHOR = "gpt-6"
...
class PlateDumbbell(Solo48):
    ...
    category = "sports"
    aliases = ()
    keywords = ('dumbbell', 'plate', 'weight', 'fitness', 'strength', 'equipment')
    ...
    def build(self):
        self.add_polyline('left',(8,12),(18,8),(18,24),(18,40),(8,36),(8,24),closed=True)
        self.weight('right',30,8,10,32,3)
        ...
        for p in ['left-5','left-6']:self.relate('connect','left-tip',p)
