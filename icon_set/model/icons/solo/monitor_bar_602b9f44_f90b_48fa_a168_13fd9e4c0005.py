"""monitor bar, complete SOLO48 composition.
Symbol plan in build(); visible keyshape extremes (4, 4, 44, 44).
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '602b9f44-f90b-48fa-a168-13fd9e4c0005'
SOURCE_PATH = 'icon_set/work/todo-references/monitor bar_602b9f44-f90b-48fa-a168-13fd9e4c0005.svg'
AUTHOR = "gpt-6"
...
class Drawing(Solo48):
    ...
    def build(self):
        # Three descending bars share a baseline and constant eight-unit step.
        self.monitor()
        self.add_polyline('baseline',(15,25),(17,25),(25,25),(33,25))
        for i,(x,y) in enumerate(((17,15),(25,18),(33,21))):
            self.add_line('bar-'+str(i),(x,y),(x,25))
