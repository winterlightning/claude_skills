"""Slide right (arrows), converted from the icons-json construction graph by json_to_solo --mode fit. VRECT_L keyshape; curves fitted to integer lines and arcs."""
...
class SlideRightVariant2(Solo48):
    icon_id = 'slide-right-v2'
    variant_of = 'slide-right'
    ...
    def build(self):
        runs = [{'start': (8, 44), 'steps': [('L', 8, 30), ('L', 28, 18), ('L', 28, 4), ('L', 16, 9)], 'closed': False}, {'start': (28, 4), 'steps': [('L', 40, 9)], 'closed': False}]
        rotation = 0
