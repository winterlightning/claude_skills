...
SOURCE_ICON_ID = '58c34c53-84bb-47c3-bba3-cb044691aa5b'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_13/corduroy_58c34c53-84bb-47c3-bba3-cb044691aa5b.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'layout-four-columns'
DESIGN_NOTES = 'Six source strips reduce to five equal panels to retain the striped-pattern subject with clear openings.'
...
class Drawing(Solo48):
    icon_id = 'vertical-striped-pattern-square'
    variant_of = 'layout-four-columns'
    variant_label = 'Vertical Striped Pattern Square'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('striped', 'pattern', 'square', 'panels', 'Uncategorized', 'outline')
    def build(self):
        # Plan: A rounded square is divided into six narrow vertical panels.
        # HRECT_L: exact SOLO48 envelope; repeated parts share coordinates.
        # Reduction: Six source strips reduce to five equal panels to retain the striped-pattern subject with clear openings.
        ...
        rr('frame',4,8,44,40,2,top=(12,20,28,36),bottom=(12,20,28,36))
        for j,x in enumerate([12,20,28,36]):l(f'divider-{j}',(x,8),(x,40))
