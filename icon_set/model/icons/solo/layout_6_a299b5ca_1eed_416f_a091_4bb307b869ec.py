...
class Layout6(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e11', (40, 6), (8, 6))
        ...
        self.add_arc('sym-e18', (8, 42), (6, 40), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        ...
        self.add_contour('sym-c1', 'sym-e8', 'sym-e10', 'sym-e11', 'sym-e13', 'sym-e15', 'sym-e16', closed=False)
