...
"""A beaded necklace with a large hexagonal pendant. SQUARE extremes (6,6)-(42,42). Lucide gem informs a clean faceted outline; internal facets omitted. Symmetric round beads and exposed links replace densely packed elongated beads."""
...
class BeadedNecklaceWithHexagonStoneVariant2(Solo48):
    ...
    def build(self) -> None:
        # SQUARE extremes (6,6)-(42,42); four solid beads, no tiny holes or wires.
        self.add_dot('bead-left-top', (6,6))
        self.add_dot('bead-right-top', (42,6))
        ...
        self.add_polyline('stone', (24,30), (34,34), (34,42), (24,42), (14,42), (14,34), closed=True)
