...
Box-cushion armchair with round high back, bulbous arms and two broad block feet. Centerline extremes (6,6)-(42,42). Lucide armchair informs nested seat and shared arm topology. Keep a flat deep cushion front and smaller back corner radii than the classic chair.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '7cd8a760-c87a-5d60-ac0e-cd6e2d8efb6a'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/furnitures/armchair_7cd8a760-c87a-5d60-ac0e-cd6e2d8efb6a.svg'
AUTHOR = 'gpt-6'

class ArmchairBoxCushion(Solo48):
    icon_id = 'armchair-box-cushion'
    ...
    def build(self):
        # Symbol plan: Box-cushion armchair with round high back, bulbous arms and two broad block feet. Centerline extremes (6,6)-(42,42). Lucide armchair informs nested seat and shared arm topology. Keep a flat deep cushion front and smaller back corner radii than the classic chair.
        ...
        back_radius=5;arm_y=20;seat_y=26;bottom=34;inner=16 if False else 14;other=48-inner
