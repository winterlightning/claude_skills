...
class BabyFaceWithBow(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('bow-cross-down', (12, 6), (36, 14))
        self.add_arc('bow-right-end', (36, 14), (36, 6), radius_x=6, radius_y=6, sweep=False, large_arc=False)
        self.add_line('bow-cross-up', (36, 6), (12, 14))
        self.add_arc('bow-left-end', (12, 14), (12, 6), radius_x=6, radius_y=6, sweep=True, large_arc=False)
