"""Spreadsheet Exchange Diagram — independently authored for batch 49."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'eb061824-199f-42a1-9b97-6b98204a9853'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/compare spreadsheet_eb061824-199f-42a1-9b97-6b98204a9853.svg'
AUTHOR = 'gpt-6'

class BatchIcon(Solo48):
    icon_id = 'spreadsheet-exchange-diagram'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "interface-essential"
    aliases = ()
    keywords = ('spreadsheet', 'exchange', 'diagram')
