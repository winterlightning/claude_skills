...
class FolderEmptyFolders(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e5', (7, 8), (4, 11), radius_x=3, sweep=False)
        self.add_line('e6-1', (4, 37), (4, 38))
        self.add_arc('e6-2', (4, 38), (6, 40), radius_x=2, sweep=False)
        self.add_line('e6-3', (6, 40), (7, 40))
        self.add_line('e7-1', (41, 40), (44, 38))
        self.add_arc('e7-2', (44, 38), (44, 37), radius_x=38)
        self.add_arc('e8-1', (44, 16), (44, 15), radius_x=24)
        self.add_arc('e8-2', (44, 15), (41, 13), radius_x=3, sweep=False)
        self.add_line('e9', (23, 13), (19, 8))
        self.add_contour('c0', 'e0', 'e5', 'e1', 'e6-1', 'e6-2', 'e6-3', 'e2', 'e7-1', 'e7-2', 'e3', 'e8-1', 'e8-2', 'e4', 'e9', closed=True)
