...
class BirdInFlight(Solo48):
    ...
    def build(self) -> None:
        self.add_line('upper-left', (6, 8), (16, 11))
        self.add_arc('left-shoulder', (16, 11), (27, 26), radius_x=15, radius_y=15, sweep=True)
        self.add_arc('right-wing-front', (27, 26), (42, 8), radius_x=19, radius_y=18, sweep=True)
        self.add_line('right-wing-back', (42, 8), (36, 26))
        self.add_line('back', (36, 26), (38, 26))
        self.add_arc('head', (38, 26), (42, 34), radius_x=8, radius_y=8, sweep=True)
        self.add_line('beak', (42, 34), (37, 31))
        ...
        self.add_arc('tail', (9, 40), (6, 33), radius_x=7, radius_y=7, sweep=True)
        self.add_line('tail-tip', (6, 33), (11, 30))
        self.add_line('underwing', (11, 30), (18, 24))
        self.add_arc('left-wing', (18, 24), (6, 8), radius_x=30, radius_y=30, sweep=True)
