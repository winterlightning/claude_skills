"""Unlocked Padlock with Keyhole — batch 52."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '6de7f43f-2d2b-5bdb-b9ce-cc4675e5a076'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/lock unlock_6de7f43f-2d2b-5bdb-b9ce-cc4675e5a076.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'unlocked-padlock-with-keyhole'
    ...
    def build(self):
        ...
        self.circle('hole',24,31,2)
        self.add_line('slot',(24,33),(24,35));self.relate('connect','slot','hole')
