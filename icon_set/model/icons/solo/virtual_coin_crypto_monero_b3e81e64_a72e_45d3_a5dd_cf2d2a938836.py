"""A Monero coin contains a simple angular M.
Plan: The circular coin encloses a symmetric five-node M stroke.
...
SOURCE_ICON_ID = 'b3e81e64-a72e-45d3-a5dd-cf2d2a938836'
SOURCE_PATH = 'icon_set/work/todo-references/virtual coin crypto monero_b3e81e64-a72e-45d3-a5dd-cf2d2a938836.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    icon_id = 'virtual-coin-crypto-monero'
    keyshape = Keyshape.CIRCLE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'objects/general'
    aliases = ()
    keywords = ('virtual', 'coin', 'crypto', 'monero')
