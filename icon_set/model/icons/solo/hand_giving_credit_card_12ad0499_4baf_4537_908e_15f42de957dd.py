...
class HandGivingCreditCard(Solo48):
    ...
    def build(self):
        ...
        self.add_line('card-bottom', (40, 32), (18, 32))
        self.add_arc('card-bl', (18, 32), (14, 28), radius_x=4)
        self.add_line('card-left-lower', (14, 28), (14, 24))
        self.add_contour('card', 'card-left','card-tl','card-top','card-tr','card-right-1','card-right-2','card-br','card-bottom','card-bl','card-left-lower')
