"""Stairs ascend (wayfinding), converted from the icons-json construction graph by json_to_solo --mode fit. HRECT_L keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '32c62d00-2703-50e4-aa2e-dd84ae2352ab'
SOURCE_PATH = 'pictographic-primitives/wayfinding/stairs ascend_32c62d00-2703-50e4-aa2e-dd84ae2352ab.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class StairsAscend(Solo48):
    icon_id = 'stairs-ascend'
