...
Plan: Directional button: centered chevron in rounded square, no omissions.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Directional button: centered chevron in rounded square, no omissions.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-001/references/arrow rectangle left svg360_9e23fdb9-8ea4-519c-a9ed-906aae17294d.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'left-arrow-square-button-solo-b001-08'
    ...
    def build(self):
        s = self
        box(s,'button',6,6,42,42,3)
        s.add_polyline('chevron',*[(28, 16), (20, 24), (28, 32)])
