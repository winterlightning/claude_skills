...
class ArtboardShapes(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e9', (18, 42), (19, 42), radius_x=26, radius_y=26, large_arc=False, sweep=True)
        self.add_arc('e10-1', (37, 42), (41, 42), radius_x=64, radius_y=64, large_arc=False, sweep=True)
        self.add_line('e10-2', (41, 42), (42, 36))
        self.add_arc('e10-3', (42, 36), (42, 35), radius_x=37, radius_y=37, large_arc=False, sweep=True)
        self.add_arc('e11', (42, 18), (41, 15), radius_x=5, radius_y=5, large_arc=False, sweep=False)
        self.add_contour('c0', 'e0', 'e1', 'e2', 'e3', closed=False)
        self.add_contour('c1', 'e4', 'e9', 'e6', 'e10-1', 'e10-2', 'e10-3', 'e7', 'e11', 'e8', closed=True)
