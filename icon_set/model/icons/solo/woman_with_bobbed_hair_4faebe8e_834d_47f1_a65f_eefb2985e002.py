'Female User Profile Icon.\nPlan and review: Retained bob with deliberately asymmetric side-part fringe, blank circular face and broad curved shoulders. Jaw center(24,20), radius8, bottom28; shoulder top32 gives zero ink gap.\nKeyshape: VRECT_L, exact SOLO48 envelope selected for this silhouette.\nConstruction reference: human_ref/user.svg: circular jaw, rounded touching shoulders; source hair.'
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '4faebe8e-834d-47f1-a65f-eefb2985e002'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_24/lady_4faebe8e-834d-47f1-a65f-eefb2985e002.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        curve('fringe',(16,20),((22,20),(28,16),(29,13)),((29,18),(30,20),(32,20)))
