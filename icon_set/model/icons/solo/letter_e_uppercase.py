"""Uppercase E for SOLO48; centerline envelope (10, 4)–(38, 44).
...
class LetterEUppercase(Solo48):
    icon_id = 'letter-e-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'E', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('E', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((38,4),[('L',10,4),('L',10,24),('L',10,44),('L',38,44)],False),((10,24),[('L',32,24)],False)]
