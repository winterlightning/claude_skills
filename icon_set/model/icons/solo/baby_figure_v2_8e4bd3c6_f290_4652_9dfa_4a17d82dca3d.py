...
class BabyFigureVariant2(Solo48):
    icon_id = 'baby-figure-v2'
    variant_of = 'baby-figure'
    variant_label = 'arms must be the stick-lines'
    ...
    def build(self) -> None:
        ...
        self.add_line('arm-left', (17, 22), (5, 33))
        self.add_line('arm-right', (31, 22), (43, 33))
        self.add_line('waist-left', (17, 22), (16, 37))
        self.add_line('waist-right', (31, 22), (32, 37))
