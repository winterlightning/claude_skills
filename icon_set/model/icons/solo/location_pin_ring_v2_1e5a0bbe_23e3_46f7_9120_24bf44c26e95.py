...
class LocationPinRingVariant2(Solo48):
    icon_id = 'location-pin-ring-v2'
    variant_of = 'location-pin-ring'
    ...
    def build(self) -> None:
        ...
        self.add_line('right-tip', (36, 30), (24, 44))
        self.add_line('left-tip', (24, 44), (12, 30))
