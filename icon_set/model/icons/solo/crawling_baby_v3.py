...
class CrawlingBabyVariant3(Solo48):
    ...
    def build(self) -> None:
        """Opening repair: Made the baby’s head circular, preserving the crawling body silhouette."""
        self.add_arc('head-top', (6, 10), (18, 10), sweep=True, large_arc=False, radius_x=6, radius_y=6)
        self.add_arc('head-bottom', (18, 10), (6, 10), sweep=True, large_arc=False, radius_x=6, radius_y=6)
