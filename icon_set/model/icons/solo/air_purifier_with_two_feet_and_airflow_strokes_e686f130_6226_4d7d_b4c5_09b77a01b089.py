...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        for i,x in enumerate((16,32)):
            self.add_bezier(f'air-{i}',(x,4),((x-4,7),(x+4,10),(x,13)))
