...
class SimpleBirdShape(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('beak-top', (40, 19), (42, 24))
        self.add_line('beak-bottom', (42, 24), (40, 26))
        self.add_arc('breast', (40, 26), (20, 42), radius_x=20, radius_y=20, sweep=True)
        self.add_arc('belly', (20, 42), (6, 31), radius_x=15, radius_y=15, sweep=True)
        self.add_line('tail', (6, 31), (8, 31))
