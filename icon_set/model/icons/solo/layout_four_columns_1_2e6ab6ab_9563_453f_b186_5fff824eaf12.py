...
class LayoutFourColumns1(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e15', (8, 42), (6, 40), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        ...
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e8', 'sym-e11', 'sym-e12', 'sym-e13', closed=False)
        self.add_contour('sym-c1', 'sym-e14', 'sym-e15', 'sym-e16', closed=False)
        self.add_contour('sym-c2', 'sym-e17', 'sym-e18', 'sym-e19', closed=False)
