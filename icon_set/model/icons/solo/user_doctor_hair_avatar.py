"""user-doctor-hair: rounded coat collar and button placket.
Distinct-avatar plan: preserve reference identity; use rounded coat collar and button placket.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-10/references/user-doctor-hair.svg'
SOURCE_HEAD_ICON_ID = 'user-doctor-hair'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 22
class UserDoctorHairAvatar(Solo48):
    icon_id = 'user-doctor-hair-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'doctor', 'hair', 'portrait', 'bust')
    def build(self):
        cx = 24
