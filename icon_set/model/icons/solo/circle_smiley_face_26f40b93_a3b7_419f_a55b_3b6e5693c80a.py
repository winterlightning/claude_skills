"""Circle smiley face (state), converted from the icons-json construction graph by json_to_solo --mode fit. CIRCLE keyshape; curves fitted to integer lines and arcs."""
...
class CircleSmileyFace(Solo48):
    icon_id = 'circle-smiley-face'
    ...
    def build(self):
        ...
        self.add_arc('e3', (15, 30), (33, 30), radius_x=12, sweep=False)
