"""car-e1ae9ac1: Round roof compact; earlier revisions preserved."""
...
class CarE1ae9ac1(Solo48):
    ...
    def build(self):
        ...
        path('body',(6,34),[('C', (4, 24), (4, 32), (4, 28)), ('C', (10, 18), (4, 20), (6, 18)), ('L', (12, 18)), ('C', (24, 8), (12, 12), (18, 8)), ('C', (36, 18), (30, 8), (36, 12)), ('L', (38, 18)), ('C', (44, 24), (40, 18), (44, 20)), ('C', (42, 34), (44, 28), (44, 32)), ('A', (36, 40), 6, 6, True), ('A', (30, 34), 6, 6, True), ('L', (18, 34)), ('A', (12, 40), 6, 6, True), ('A', (6, 34), 6, 6, True)],True)

        for x in (12,36):
         path(f'wheel-{x}',(x-6,34),[('A',(x,28),6,6,True),('A',(x+6,34),6,6,True)]);join(f'wheel-{x}','body')
        poly('windshield-base',*[(10, 18), (24, 18), (38, 18)]);join('windshield-base','body')
        line('pillar',(24,8),(24,18));join('pillar','body');join('pillar','windshield-base')
