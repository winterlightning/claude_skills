"""Precision Farming Steering Control.
Plan: Steering control hub and broad handles above two crops; overlapping decorative rim omitted.
Construction reference: Lucide cpu; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/harvest farmer technology_8a6f297d-adef-4f36-8a4c-2b757ed85a8d.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '8a6f297d-adef-4f36-8a4c-2b757ed85a8d'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/farming/harvest farmer technology_8a6f297d-adef-4f36-8a4c-2b757ed85a8d.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'precision-farming-steering-control-batch-009-05'
    ...
    def build(self):
        ...
        circle('hub',24,15,7)
        line('handle-left',(4,15),(17,15))
        line('handle-right',(31,15),(44,15))
        for x in (10,38): path(f'crop-{x}',(x-5,33),(x,40),(x+5,33))
