"""Two women overlap, the front woman with a pointed fringe and long hair. Lucide users-round informs the staggered hierarchy; ear and facial detail is omitted."""
