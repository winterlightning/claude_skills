...
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/cursor hand_4b627c16-f813-40f0-a579-c26e314fc6fd.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'raised-index-finger-hand'
    keyshape = Keyshape.HRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "interface-essential"
    aliases = ()
    keywords = ('hand', 'index', 'finger', 'point', 'cursor', 'gesture')
    def build(self):
