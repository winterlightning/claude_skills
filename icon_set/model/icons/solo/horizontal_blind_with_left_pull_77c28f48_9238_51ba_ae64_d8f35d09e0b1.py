"""Horizontal Blind with Left Pull.
...
SOURCE_PATH = 'pictographic-primitives/building/blinds horizontal open_77c28f48-9238-51ba-ae64-d8f35d09e0b1.svg'
SOURCE_ICON_IDS = ('77c28f48-9238-51ba-ae64-d8f35d09e0b1',)
SOURCE_PATHS = ('pictographic-primitives/building/blinds horizontal open_77c28f48-9238-51ba-ae64-d8f35d09e0b1.svg',)
AUTHOR = 'gpt-6'
...
class HorizontalBlindWithLeftPull(Solo48):
    ...
    def build(self) -> None:
        ...
        mirror='horizontal-blind-with-left-pull'.endswith("left-pull")
