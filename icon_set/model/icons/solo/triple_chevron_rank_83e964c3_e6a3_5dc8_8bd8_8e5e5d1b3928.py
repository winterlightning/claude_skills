"""Triple Chevron Rank Insignia. Three repeated chevrons on shared center axis; equal apex construction.
Keyshape HRECT_XL: chosen for the subject's overall proportions; authored directly on SOLO48.
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '83e964c3-e6a3-5dc8-8bd8-8e5e5d1b3928'
SOURCE_PATH = 'pictographic-primitives/war/badge 4_83e964c3-e6a3-5dc8-8bd8-8e5e5d1b3928.svg'
AUTHOR = 'gpt-6'

class TripleChevronRank(Solo48):
    icon_id = 'triple-chevron-rank'
    ...
    aliases = ()
    keywords = ('chevron', 'rank', 'insignia', 'military', 'stripe', 'sergeant')
    ...
    def build(self):
        ...
        for i,y in enumerate((8,20,32)): P('chevron-'+str(i),(4,y+8),(24,y),(44,y+8))
