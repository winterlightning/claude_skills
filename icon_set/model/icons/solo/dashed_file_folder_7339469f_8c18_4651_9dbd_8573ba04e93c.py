...
SOURCE_ICON_ID = '7339469f-8c18-4651-9dbd-8573ba04e93c'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/folders/folder dash_7339469f-8c18-4651-9dbd-8573ba04e93c.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'folder'
...
class Drawing(Solo48):
    icon_id = 'dashed-file-folder'
    variant_of = 'folder'
    variant_label = 'Dashed File Folder'
    ...
    def build(self):
        # Plan: A blank horizontal file folder with a raised upper-left tab and interrupted outline.
