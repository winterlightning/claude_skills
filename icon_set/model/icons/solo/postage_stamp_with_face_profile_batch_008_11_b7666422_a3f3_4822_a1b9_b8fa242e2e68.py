...
Plan: Portrait face profile shares stamp edge; three broad perforations replace small scallops. Human reference inspected; no detached head/body pair.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/stamps famous_b7666422-a3f3-4822-a1b9-b8fa242e2e68.svg
"""
...
class GeneratedSolo(Solo48):
    icon_id = 'postage-stamp-with-face-profile-batch-008-11'
    ...
    def build(self):
        ...
        path('stamp',(6,6),(42,6),(42,42),(6,42))
        for j in range(3):
            y=42-12*j
            arc(f'perforation-{j}',(6,y),(6,y-12),6,6,False)
        path('face',(28,6),(24,21),(21,26),(27,26),(27,34),(34,34),(34,42))
