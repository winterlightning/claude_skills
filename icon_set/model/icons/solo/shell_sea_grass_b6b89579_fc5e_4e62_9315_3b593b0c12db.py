...
class ShellWithSeagrass(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('shell', (6, 42), (36, 42), radius_x=17, radius_y=15, sweep=True, large_arc=False)
        self.add_line('base', (36, 42), (6, 42))
        self.add_contour('clam', 'shell', 'base', closed=True)
        self.add_arc('small-shell', (36, 35), (42, 42), radius_x=10, radius_y=11, sweep=True, large_arc=False)
        self.add_line('small-base', (42, 42), (36, 42))
