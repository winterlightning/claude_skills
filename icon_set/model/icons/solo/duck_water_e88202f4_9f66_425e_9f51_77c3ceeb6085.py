...
class DuckOnWater(Solo48):
    ...
    def build(self):
        self.add_arc('duck-1', (8, 29), (6, 22), radius_x=14, radius_y=14, sweep=True)
        self.add_arc('duck-2', (6, 22), (23, 26), radius_x=26, radius_y=26, sweep=False)
        ...
        self.add_line('duck-6', (39, 17), (42, 20))
        self.add_line('duck-7', (42, 20), (37, 24))
        ...
        self.add_arc('water-1', (6, 38), (13, 38), radius_x=6, radius_y=2, sweep=False)
        ...
        self.add_arc('water-4', (35, 38), (42, 40), radius_x=11, radius_y=2, sweep=False)
