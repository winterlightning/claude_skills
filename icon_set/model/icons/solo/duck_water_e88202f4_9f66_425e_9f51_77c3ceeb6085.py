...
class DuckOnWater(Solo48):
    ...
    def build(self):
        ...
        self.add_line('duck-6', (39, 17), (44, 20))
        self.add_line('duck-7', (44, 20), (37, 24))
        ...
        self.add_arc('water-1', (4, 38), (13, 38), radius_x=6, radius_y=2, sweep=False)
        ...
        self.add_arc('water-4', (35, 38), (44, 40), radius_x=11, radius_y=2, sweep=False)
