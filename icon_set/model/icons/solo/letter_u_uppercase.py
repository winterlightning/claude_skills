"""Uppercase U for SOLO48; centerline envelope (10, 4)–(38, 44).
Plan: Two equal upright stems joined by a tangent semicircular base.
...
class LetterUUppercase(Solo48):
    icon_id = 'letter-u-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    typeface = {'character': 'U', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('U', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((10,4),[('L',10,30),('A',38,30,14,14,False),('L',38,4)],False)]
