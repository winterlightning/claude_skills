...
class PointedWrestlingMaskVariant2(Solo48):
    icon_id = 'pointed-wrestling-mask-v2'
    variant_of = 'pointed-wrestling-mask'
    ...
    def build(self):
        self.add_line('crown-1', (8, 28), (8, 4))
        self.add_line('crown-2', (8, 4), (24, 14))
        self.add_line('crown-3', (24, 14), (40, 4))
        self.add_line('crown-4', (40, 4), (40, 28))
