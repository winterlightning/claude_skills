...
class ControlsStop(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e9', (42, 40), (40, 42), radius_x=2)
        self.add_line('sym-e11', (40, 42), (24, 42))
        self.add_line('sym-e12', (24, 42), (8, 42))
        self.add_arc('sym-e14', (8, 42), (6, 40), radius_x=2)
        self.add_line('sym-e17', (6, 40), (6, 24))
        self.add_line('sym-e18', (6, 24), (6, 8))
        self.add_arc('sym-e21', (6, 8), (8, 6), radius_x=2)
        self.add_line('sym-e23', (8, 6), (24, 6))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e2', 'sym-e5', 'sym-e6', 'sym-e9', 'sym-e11', 'sym-e12', 'sym-e14', 'sym-e17', 'sym-e18', 'sym-e21', 'sym-e23', closed=True)
