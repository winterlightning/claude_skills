"""Flying bird facing right with raised feathered wing; extremes (6,6)-(42,42). Lucide bird informs rounded breast; two broad feather corners replace fine teeth."""
...
class FlyingBird(Solo48):
    ...
    def build(self) -> None:
        self.add_line('wing-1', (8, 35), (6, 26))
        self.add_line('wing-2', (6, 26), (8, 28))
        self.add_line('wing-3', (8, 28), (6, 15))
        self.add_line('wing-4', (6, 15), (11, 20))
        self.add_line('wing-5', (11, 20), (9, 6))
        self.add_line('wing-6', (9, 6), (23, 18))
