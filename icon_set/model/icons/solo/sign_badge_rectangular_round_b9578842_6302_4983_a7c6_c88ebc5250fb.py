...
class SignBadgeRectangularRound(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (40, 6), (42, 9), radius_x=4)
        self.add_line('sym-e4', (42, 9), (42, 24))
        self.add_line('sym-e5', (42, 24), (42, 39))
        self.add_arc('sym-e7', (42, 39), (40, 42), radius_x=4)
        self.add_line('sym-e9', (40, 42), (24, 42))
        self.add_line('sym-e10', (24, 42), (8, 42))
        self.add_arc('sym-e12', (8, 42), (6, 39), radius_x=4)
        self.add_line('sym-e14', (6, 39), (6, 24))
        self.add_line('sym-e15', (6, 24), (6, 9))
        self.add_arc('sym-e17', (6, 9), (8, 6), radius_x=4)
        self.add_line('sym-e19', (8, 6), (24, 6))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e2', 'sym-e4', 'sym-e5', 'sym-e7', 'sym-e9', 'sym-e10', 'sym-e12', 'sym-e14', 'sym-e15', 'sym-e17', 'sym-e19', closed=True)
