...
class WoodpeckerOnTrunk(Solo48):
    ...
    def build(self) -> None:
        self.add_line('trunk-top', (42, 6), (42, 42))
        self.add_arc('head', (6, 14), (21, 14), radius_x=8, radius_y=8, sweep=True)
        ...
        self.add_line('tail', (23, 36), (11, 42))
        self.add_line('back', (11, 42), (11, 20))
        self.add_arc('nape', (11, 20), (6, 14), radius_x=6, radius_y=6, sweep=False)
        self.add_contour('bird', 'head', 'beak-top', 'beak-bottom', 'breast', 'tail', 'back', 'nape', closed=True)
        self.add_line('grip', (23, 36), (42, 36))
