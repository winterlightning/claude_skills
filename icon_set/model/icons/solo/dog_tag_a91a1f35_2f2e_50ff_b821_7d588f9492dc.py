...
class PetIdTag(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('loop-br',(29,9),(24,14),radius_x=5)
        self.add_arc('loop-bl',(24,14),(19,9),radius_x=5)
        self.add_contour('loop', 'loop-top', 'loop-br', 'loop-bl', closed=True)

        # A shared corner radius keeps all four turns tangent to their walls.
        left, top, right, bottom, radius = 8, 14, 40, 44, 7
        self.add_line('plate-top-a',(left+radius,top),(24,top))
        self.add_line('plate-top-b',(24,top),(right-radius,top))
        ...
        self.add_contour('plate', *('plate-'+part for part in ('top-a','top-b','tr','right','br','bottom','bl','left','tl')), closed=True)
