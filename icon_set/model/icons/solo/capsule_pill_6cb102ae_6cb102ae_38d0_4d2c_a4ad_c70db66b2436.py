...
SOURCE_PATH = 'icon_set/work/primitive-fix-thuan/solo__capsule-pill-6cb102ae/20260924T115444Z-thuan-mac/reference/pill_6cb102ae-38d0-4d2c-a4ad-c70db66b2436.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    icon_id = 'capsule-pill-6cb102ae-solo'
    ...
    aliases = ()
    keywords = ('capsule', 'pill', '6cb102ae')
    def build(self):
