...
class LandmarkVariant2(Solo48):
    ...
    def build(self):
        self.add_polyline('outline', (6, 24), (14, 24), (34, 24), (42, 24), (42, 42), (36, 42), (36, 32), (12, 32), (12, 42), (6, 42), closed=True)
        self.add_polyline('attic', (14, 24), (14, 16), (24, 16), (34, 16), (34, 24))
        self.relate('connect', 'attic', 'outline')
        self.add_polyline('mast', (24, 6), (24, 6), (24, 16))
        self.add_polyline('cross', (19, 6), (24, 6), (29, 6))
        self.relate('connect', 'mast', 'cross')
        self.relate('connect', 'mast', 'attic')
        self.add_line('lintel-left', (6, 32), (12, 32))
        self.add_line('lintel-right', (36, 32), (42, 32))
