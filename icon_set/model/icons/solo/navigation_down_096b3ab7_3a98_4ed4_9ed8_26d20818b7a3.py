...
SOURCE_PATH = 'pictographic-primitives/interface-essential/navigation down_096b3ab7-3a98-4ed4-9ed8-26d20818b7a3.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class NavigationDown(Solo48):
    icon_id = 'navigation-down'
