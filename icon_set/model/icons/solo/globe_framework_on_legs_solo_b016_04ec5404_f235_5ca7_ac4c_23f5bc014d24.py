"""Globe framework on two splayed legs. One equator and central meridian retain the globe while reducing tight polar mesh. Centerline8,4–40,44.
Lucide construction reference: globe.
"""
...
SAVED_REFERENCE_PATH='/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/kids/playground globe_04ec5404-f235-5ca7-ac4c-23f5bc014d24.svg'
...
class BatchIcon(Solo48):
    icon_id='globe-framework-on-legs-solo-b016'
    ...
    def build(self):
        ...
        self.add_polyline('legs',(12,44),(24,36),(36,44));self.relate('connect','legs','globe');self.relate('connect','legs','meridian')
