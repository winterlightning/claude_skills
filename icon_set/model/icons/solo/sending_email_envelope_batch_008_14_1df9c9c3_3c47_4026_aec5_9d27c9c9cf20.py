...
Plan: Slanted envelope and two speed strokes; third small motion mark omitted.
Construction reference: Lucide mail; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/send email envelope_1df9c9c3-3c47-4026-aec5-9d27c9c9cf20.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '1df9c9c3-3c47-4026-aec5-9d27c9c9cf20'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/emails/send email envelope_1df9c9c3-3c47-4026-aec5-9d27c9c9cf20.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'sending-email-envelope-batch-008-14'
    ...
    def build(self):
        ...
        path('envelope',(20,10),(44,10),(40,38),(16,38),closed=True)
        path('flap',(20,10),(30,23),(44,10))
        line('speed-top',(4,18),(8,18))
        line('speed-bottom',(4,29),(6,29))
