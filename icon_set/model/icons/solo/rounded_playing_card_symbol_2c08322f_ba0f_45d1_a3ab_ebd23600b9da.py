...
SOURCE_ICON_ID = '2c08322f-ba0f-45d1-a3ab-ebd23600b9da'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_14/deck_2c08322f-ba0f-45d1-a3ab-ebd23600b9da.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'double-square-frame'
...
class Drawing(Solo48):
    icon_id = 'rounded-playing-card-symbol'
    variant_of = 'double-square-frame'
    variant_label = 'Rounded Playing Card Symbol'
    ...
    aliases = ()
    keywords = ('playing', 'card', 'smaller', 'inset', 'Uncategorized', 'outline')
    def build(self):
        # Plan: An upright rounded rectangular card with a smaller rounded rectangular inset.
