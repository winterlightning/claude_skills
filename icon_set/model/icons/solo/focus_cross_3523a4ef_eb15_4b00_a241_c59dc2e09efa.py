...
class FocusCross(Solo48):
    ...
    def build(self):
        self.add_line('sym-e0', (33, 24), (15, 24))
        self.add_line('sym-e2', (24, 34), (24, 14))
        self.add_line('sym-e4', (35, 42), (40, 42))
        self.add_arc('sym-e5', (40, 42), (42, 40), radius_x=2, radius_y=2, large_arc=False, sweep=False)
        ...
        self.add_arc('sym-e11', (40, 6), (42, 8), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('sym-e12', (42, 8), (42, 13))
        self.add_line('sym-e13', (13, 6), (8, 6))
        self.add_arc('sym-e14', (8, 6), (6, 8), radius_x=2, radius_y=2, large_arc=False, sweep=False)
        ...
        self.add_contour('sym-c3', 'sym-e7', 'sym-e8', 'sym-e9', closed=False)
        self.add_contour('sym-c4', 'sym-e10', 'sym-e11', 'sym-e12', closed=False)
        self.add_contour('sym-c5', 'sym-e13', 'sym-e14', 'sym-e15', closed=False)
