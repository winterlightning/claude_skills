"""Workflow with Winding Connector.
Plan: Three task bars and a winding connector with repeated radius4 tangent corners. Bounds (4,8)-(44,40).
References: Lucide workflow for rounded boxes and real joins; route for coherent alternating turns.
Reduction: Task outlines reduced to consistent bars to retain all three tasks and the winding connector with clear spacing.
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '27f83d9a-087f-47d3-81f1-dfcb21caefa7'
SOURCE_PATH = 'pictographic-primitives/business/workflow gantt chart_27f83d9a-087f-47d3-81f1-dfcb21caefa7.svg'
AUTHOR = 'gpt-6'
...
class WorkflowWithWindingConnector(Solo48):
    ...
    def build(self):
        self.add_line('first',(4,8),(24,8))
        self.add_line('middle',(24,28),(44,28))
        self.add_line('last',(20,40),(44,40))
        path(self,'connector',(24,8),('L',(32,8)),('A',(36,12),4,4,True),('L',(36,14)),('A',(32,18),4,4,True),('L',(12,18)),('A',(8,22),4,4,False),('L',(8,36)),('A',(12,40),4,4,False),('L',(20,40)))
        self.relate('connect','first','connector')
        self.relate('connect','last','connector')
