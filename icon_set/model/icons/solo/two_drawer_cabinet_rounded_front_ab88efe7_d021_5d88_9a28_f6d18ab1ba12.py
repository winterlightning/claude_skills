...
SOURCE_ICON_ID = 'ab88efe7-d021-5d88-9a28-f6d18ab1ba12'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/furnitures/dresser wardrobe drawers_ab88efe7-d021-5d88-9a28-f6d18ab1ba12.svg'
AUTHOR = 'gpt-6'


class TwoDrawerCabinetRoundedFront(Solo48):
    icon_id = 'two-drawer-cabinet-rounded-front'
    ...
    def build(self):
        ...
        # Reduction: Retain both pulls and drawer count; short legs.
        ...
        rounded('body',8,4,40,40,2,left=(22,),right=(22,),bottom=(12,36))
        line('divider',(8,22),(40,22))
        for i,y in enumerate((13,31)):line(f'pull-{i}',(22,y),(26,y))
        for x in (12,36):line(f'leg-{x}',(x,40),(x,44))
        contacts()
