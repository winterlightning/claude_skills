...
class HyenaHeadFront(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('head-4', (8, 6), (16, 10), radius_x=8, radius_y=8, sweep=True)
        ...
        self.add_arc('head-7', (32, 10), (40, 6), radius_x=8, radius_y=8, sweep=True)
        ...
        self.add_arc('head-14', (30, 42), (24, 42), radius_x=7, radius_y=6, sweep=True)
        self.add_arc('head-15', (24, 42), (18, 42), radius_x=7, radius_y=6, sweep=True)
