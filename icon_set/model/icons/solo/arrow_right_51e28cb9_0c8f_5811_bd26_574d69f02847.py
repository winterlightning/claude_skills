...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow right_51e28cb9-0c8f-5811-bd26-574d69f02847.svg'
AUTHOR = 'gpt-6'

class ArrowRightArrows(Solo48):
    icon_id = 'arrow-right-arrows'
    ...
    def build(self):
        runs = [{'start': (26, 40), 'steps': [('L', 44, 24)], 'closed': False}, {'start': (26, 8), 'steps': [('L', 44, 24), ('L', 4, 24)], 'closed': False}]
        rotation = 0
