"""Postcard with Stamp.
Plan: Postcard stamp integrated with top-right border; two address lines retained.
Construction reference: Lucide mail; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/envelope postcard_34ef082f-51bf-4e8d-a4e0-40d600b51d90.svg
"""
...
class GeneratedSolo(Solo48):
    icon_id = 'postcard-with-stamp-batch-008-13'
    ...
    def build(self):
        ...
        rect('postcard',4,10,40,28)
        rect('stamp',28,10,16,12)
        line('address-one',(12,21),(19,21))
        line('address-two',(12,30),(28,30))
