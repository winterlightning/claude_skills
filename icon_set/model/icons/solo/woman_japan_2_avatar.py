"""woman-japan-2: kimono wrap with reference head silhouette.
...
Body cue: kimono wrap. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = '26a1c09d-ea15-43a7-9d47-728e74a2e340'
SOURCE_PATH = 'pictographic-primitives/avatars/woman japan_26a1c09d-ea15-43a7-9d47-728e74a2e340.svg'
SOURCE_HEAD_ICON_ID = 'woman-japan-2'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class WomanJapan2Avatar(Solo48):
    icon_id = 'woman-japan-2-avatar'
