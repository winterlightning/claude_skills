"""expand-horizontal-left-right: reconstructed stroke graph on SOLO48."""
...
class ExpandHorizontalLeftRight(Solo48):
    ...
    def build(self):
        # Plan: HRECT_L; equal centered walls and arrowheads; duplicated one-unit arcs replaced by a straight shared stem node.
