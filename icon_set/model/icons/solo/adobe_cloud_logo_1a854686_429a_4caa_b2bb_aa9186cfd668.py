"""adobe-cloud-logo: Interlocking cloud — local spacing refinement; earlier revisions preserved."""
...
class AdobeCloudLogo(Solo48):
    ...
    def build(self):
        # Plan: Original cloud outline and upper flourish restored. Adjusted only the inner loop and flourish endpoint.
        ...
        path('inner',(22,40),[('L',(15,30)),('C',(20,23),(11,24),(16,19)),('L',(31,36)),('L',(32,40))]);join('inner','outer')
        line('upper',(24,16),(29,20));join('upper','outer')
