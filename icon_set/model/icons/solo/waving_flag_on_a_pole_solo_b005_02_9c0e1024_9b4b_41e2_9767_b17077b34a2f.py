...
SOURCE_ICON_ID = '9c0e1024-9b4b-41e2-9767-b17077b34a2f'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/container/flag 3_9c0e1024-9b4b-41e2-9767-b17077b34a2f.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-005/references/flag 3_9c0e1024-9b4b-41e2-9767-b17077b34a2f.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'waving-flag-on-a-pole-solo-b005-02'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'container'
    aliases = ()
    keywords = ('waving', 'flag', 'on', 'a', 'pole')
