...
Plan: Person faces handheld scan device, neutral interpretation of ambiguous source; omit rays if crowded.
Centerline envelope: (4,8)-(44,40).
Final reduction/review: Neutral handheld scanner interpretation; two rays reduced to one dot. Head r6 center(12,20), shoulder top34: gap8 / ink4.
...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/crime/headshot_f5a0d7ed-c682-43c5-adba-50825e93ac3f.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-005/references/headshot_f5a0d7ed-c682-43c5-adba-50825e93ac3f.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'forehead-temperature-scan-solo-b005-05'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'objects'
    aliases = ()
    keywords = ('forehead', 'temperature', 'scan')

    def build(self):
        s = self
        circle(s,'head',12,20,6)
        s.add_arc('shoulders',(4,40),(20,40),radius_x=8,radius_y=6)
        s.add_polyline('device',(30,16),(44,16),(44,24),(40,24),(40,32),(32,32),(32,24),(30,24),closed=True)
        s.add_dot('ray',(24,8))
