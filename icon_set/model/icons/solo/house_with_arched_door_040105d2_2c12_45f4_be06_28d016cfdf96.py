"""House with Arched Door; standalone reconstruction of the supplied reference.
...
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/house_040105d2-2c12-45f4-be06-28d016cfdf96.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'house-with-arched-door'
