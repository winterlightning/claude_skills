"""European Type C Power Socket.
Plan: Blank round socket housing preserved exactly as visible; absent contacts not invented.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/power outlet type c_5d314c6f-1589-4e51-8880-9d7115f88fab.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '5d314c6f-1589-4e51-8880-9d7115f88fab'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/power outlet type c_5d314c6f-1589-4e51-8880-9d7115f88fab.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'european-type-c-power-socket-batch-007-13'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "electronics"
    aliases = ()
    keywords = ('european', 'type', 'c', 'power', 'socket')
