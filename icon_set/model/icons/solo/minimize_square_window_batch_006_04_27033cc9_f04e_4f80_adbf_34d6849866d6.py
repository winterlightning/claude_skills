"""Minimize Square Window.
Plan: Open window, smaller destination and inward arrow retained.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/resize shrink_27033cc9-f04e-4f80-adbf-34d6849866d6.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '27033cc9-f04e-4f80-adbf-34d6849866d6'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/resize shrink_27033cc9-f04e-4f80-adbf-34d6849866d6.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'minimize-square-window-batch-006-04'
    ...
    aliases = ()
    keywords = ('minimize', 'square', 'window')
    ...
    def build(self):
        ...
        path('window',(6,22),(6,6),(42,6),(42,42),(26,42))
        rect('destination',6,30,12,12,2)
        path('arrowhead',(24,14),(24,24),(34,24))
        line('shaft',(24,24),(34,14))
