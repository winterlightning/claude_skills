...
class Printer(Solo48):
    ...
    def build(self):
        ...
        self.add_line('e12', (29, 4), (28, 4))
        self.add_arc('e13', (16, 4), (14, 5), radius_x=17, sweep=False)
        self.add_arc('e14', (40, 28), (38, 30), radius_x=2)
        self.add_arc('e15', (10, 30), (8, 28), radius_x=2)
