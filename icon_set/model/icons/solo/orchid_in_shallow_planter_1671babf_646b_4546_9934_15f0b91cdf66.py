"""Three scalloped orchid blossoms above a shallow planter. SQUARE (6,6)-(42,42). Lucide flower informs repeated petal arcs. Four broad lobes replace five small petals; leaves reduced to outward curves."""
...
class OrchidInShallowPlanter(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('left0', (6, 13), (11, 13), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('left1', (11, 13), (11, 19), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('left3', (6, 19), (6, 13), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('left2a', (11, 19), (8, 22), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('left2b', (8, 22), (6, 19), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        ...
        self.add_arc('middle0', (21, 6), (27, 6), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('middle1', (27, 6), (27, 11), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('middle3', (21, 11), (21, 6), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        ...
        self.add_arc('right0', (37, 13), (42, 13), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('right1', (42, 13), (42, 19), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('right3', (37, 19), (37, 13), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_arc('right2a', (42, 19), (40, 22), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        ...
        self.add_polyline('planter', (6, 36), (42, 36), (40, 42), (8, 42), closed=True)
        self.relate('connect', 'left-stem', 'planter')
        self.relate('connect', 'middle-stem', 'planter')
        self.relate('connect', 'right-stem', 'planter')
        self.add_arc('leaf-left', (6, 28), (8, 32), radius_x=6, radius_y=4, sweep=False, large_arc=False)
        self.add_arc('leaf-right', (40, 32), (42, 28), radius_x=6, radius_y=4, sweep=False, large_arc=False)
