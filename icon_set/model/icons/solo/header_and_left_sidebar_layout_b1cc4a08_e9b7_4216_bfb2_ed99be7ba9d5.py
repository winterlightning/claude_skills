...
SOURCE_ICON_ID = 'b1cc4a08-e9b7-4216-bfb2-ed99be7ba9d5'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_25/layout 1_b1cc4a08-e9b7-4216-bfb2-ed99be7ba9d5.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'layout-16'
...
class Drawing(Solo48):
    icon_id = 'header-and-left-sidebar-layout'
    variant_of = 'layout-16'
    variant_label = 'Header and Left Sidebar Layout'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('header', 'sidebar', 'layout', 'square', 'frame', 'full', 'width', 'panel')
    def build(self):
        # Plan: A rounded square frame with a full-width top header, narrow left sidebar and broad right panel.
        ...
        rr('frame',6,6,42,42,2,left=(18,),right=(18,),bottom=(18,))
