"""Incomplete Circular Progress Indicator.
Plan: Progress ring with open upper-left quarter and two fading dashes.
Centerline envelope: center (24,24), radius 20; cardinal extrema (4,24),(24,4),(44,24),(24,44).
Final reduction/review: Fading arc reduced to two dots; main three-quarter circle retained.
...
SOURCE_ICON_ID = '0dc957f1-cf93-42b6-9a80-195c4c7289a8'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/container/circle dash quarter_0dc957f1-cf93-42b6-9a80-195c4c7289a8.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-003/references/circle dash quarter_0dc957f1-cf93-42b6-9a80-195c4c7289a8.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'incomplete-circular-progress-indicator-solo-b003-15'
    ...
    def build(self):
        s = self
        s.add_arc('ring-a',(24,4),(24,44),radius_x=20)
        s.add_arc('ring-b',(24,44),(4,24),radius_x=20);s.add_contour('ring','ring-a','ring-b')
        s.add_dot('dash',(6,16));s.add_dot('fade',(14,7))
