"""A smartphone wifi signal reconstructed on the SOLO48 grid. Source silhouette and internal mark are retained; matching paired elements share coordinates. Lucide geometric construction informs the outer device or enclosure."""
...
class Drawing(Solo48):
    icon_id = 'smartphone-wifi-signal'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'objects/device'
    aliases = ()
    keywords = ('smartphone', 'wifi', 'signal')
    ...
    def build(self) -> None:
        ...
        self.add_bezier('wifi-outer',(19,18),((21,15),(27,15),(29,18)))
        self.add_bezier('wifi-inner',(22,27),((23,25),(25,25),(26,27)))
