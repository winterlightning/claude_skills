...
SOURCE_PATH = 'pictographic-primitives/devices/end point reversed triangle_0d07c79d-33b8-4d96-a76c-208a00c1fb9a.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class EndPointReversedTriangle(Solo48):
    icon_id = 'end-point-reversed-triangle'
