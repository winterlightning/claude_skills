"""Uppercase P for SOLO48; centerline envelope (10, 4)–(38, 44).
Plan: Upper semicircular bowl attaches to a full-height spine.
...
class LetterPUppercase(Solo48):
    icon_id = 'letter-p-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'P', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('P', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((10,44),[('L',10,24),('L',10,4),('L',28,4),('A',28,24,10,10,True),('L',10,24)],False)]
