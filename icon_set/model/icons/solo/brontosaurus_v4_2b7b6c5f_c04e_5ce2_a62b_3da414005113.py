...
"""A long-necked sauropod with two visible legs and a sweeping tail."""
...
class BrontosaurusVariant4(Solo48):
    icon_id = 'brontosaurus-v4'
    ...
    def build(self) -> None:
        ...
        self.add_line('tail-1', (36, 28), (42, 34))
        self.add_line('tail-2', (42, 34), (38, 38))
