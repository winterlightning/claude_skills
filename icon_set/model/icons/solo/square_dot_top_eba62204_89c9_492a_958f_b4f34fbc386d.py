...
class Drawing(Solo48):
    icon_id='square-dot-top'
    keyshape=Keyshape.SQUARE
    semantic_role='MAIN'
    semantic_kind='noun'
    category='objects/general'
    aliases=()
    keywords=('square', 'dot', 'top')
    ...
    def build(self):
        self.add_polyline('top-left',(10,12),(18,12))
        self.add_arc('corner-tl',(6,16),(10,12),radius_x=4)
        self.add_line('left',(6,16),(6,38))
        ...
        self.add_line('right',(42,38),(42,16))
        self.add_arc('corner-tr',(42,16),(38,12),radius_x=4,sweep=False)
        self.add_line('top-right',(38,12),(30,12))
...
FINAL_REDUCTIONS='Frame is shortened vertically to accommodate the circular top tab.'
