...
class OneFingerVerticalSwipeGesture(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline("hand", (10, 28), (16, 24), (18, 26), (18, 16), (26, 16), (26, 24), (36, 24), (38, 26), (38, 30), (34, 32), (18, 32), (10, 28), closed=True)
        self.add_polyline("up-head", (20, 8), (24, 4), (28, 8))
        self.add_line("up-shaft", (24, 4), (24, 8))
        self.relate("connect", "up-head", "up-shaft")
        self.add_polyline("down-head", (20, 40), (24, 44), (28, 40))
        self.add_line("down-shaft", (24, 40), (24, 44))
