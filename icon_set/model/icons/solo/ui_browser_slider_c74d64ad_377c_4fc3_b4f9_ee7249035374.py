...
class UiBrowserSlider(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('e1', (15, 25), (32, 25))
        self.add_line('e2', (38, 6), (10, 6))
        self.add_line('e3', (6, 10), (6, 38))
        self.add_line('e4', (10, 42), (38, 42))
        self.add_line('e5', (42, 36), (42, 10))
        self.add_arc('e6', (10, 6), (6, 10), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_arc('e7-1', (6, 38), (7, 41), radius_x=5, radius_y=5, large_arc=False, sweep=False)
        self.add_line('e7-2', (7, 41), (9, 42))
        self.add_arc('e7-3', (9, 42), (10, 42), radius_x=22, radius_y=22, large_arc=False, sweep=True)
        self.add_line('e8-1', (38, 42), (41, 41))
        self.add_line('e8-2', (41, 41), (42, 36))
        self.add_arc('e9', (42, 10), (38, 6), radius_x=4, radius_y=4, large_arc=False, sweep=False)
