"""An open door with a right-pointing logout arrow.
Plan: semantic components use coherent contours, shared nodes, and mirrored or repeated definitions.
Keyshape HRECT_L; full composition retained on SOLO48. Omissions: Tiny handle arrow simplified to one horizontal handle.
"""
...
# Final review record: Door and right arrow read clearly; perspective is intentionally asymmetric.
