...
SOURCE_PATH = 'icons-json/state/rectangle remove_5c4ca37f-144e-4809-8a31-ca31fdd14824.json'
AUTHOR = 'gpt-6'
...
class RectangleRemoveState(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e1', (20, 18), (28, 30))
        self.add_line('sym-e3', (24, 40), (7, 40))
        self.add_arc('sym-e4', (7, 40), (6, 40), radius_x=20, radius_y=20, large_arc=False, sweep=False)
        self.add_line('sym-e5-1', (6, 40), (4, 39))
        self.add_line('sym-e5-2', (4, 39), (4, 9))
        self.add_line('sym-e10-2', (4, 9), (6, 8))
        self.add_line('sym-e11', (6, 8), (42, 8))
        self.add_line('sym-e15-1', (42, 8), (44, 9))
        self.add_arc('sym-e15-2', (44, 9), (44, 11), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_line('sym-e17', (44, 11), (44, 39))
        self.add_line('sym-e20-2', (44, 39), (42, 40))
        self.add_arc('sym-e21', (42, 40), (41, 40), radius_x=41, radius_y=41, large_arc=False, sweep=False)
        ...
        self.add_contour('sym-c2', 'sym-e3', 'sym-e4', 'sym-e5-1', 'sym-e5-2', 'sym-e10-2', 'sym-e11', 'sym-e15-1', 'sym-e15-2', 'sym-e17', 'sym-e20-2', 'sym-e21', 'sym-e22', closed=True)
