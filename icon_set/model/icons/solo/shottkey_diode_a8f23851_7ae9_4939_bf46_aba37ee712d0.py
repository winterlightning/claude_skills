...
class ShottkeyDiode(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e3', (32, 20), (32, 23), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('sym-e4', (32, 23), (22, 33))
        self.add_arc('sym-e6', (22, 33), (18, 30), radius_x=6, radius_y=6, large_arc=False, sweep=False)
        self.add_line('sym-e7', (18, 30), (6, 42))
        self.add_arc('sym-e8', (18, 30), (15, 26), radius_x=6, radius_y=6, large_arc=False, sweep=False)
        self.add_arc('sym-e9', (15, 26), (16, 25), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('sym-e10', (16, 25), (25, 16))
        self.add_arc('sym-e11', (25, 16), (28, 16), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('sym-e12', (28, 16), (29, 18))
        self.add_line('sym-e13', (29, 18), (30, 18))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e6', 'sym-e7', closed=False)
        self.add_contour('sym-c1', 'sym-e8', 'sym-e9', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e13', closed=False)
