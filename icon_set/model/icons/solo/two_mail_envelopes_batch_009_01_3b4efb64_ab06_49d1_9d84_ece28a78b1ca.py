"""Two Mail Envelopes.
Plan: Two offset closed envelopes; concealed lower rear edge omitted.
Construction reference: Lucide mail; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-009/references/envelope back front_3b4efb64-ab06-49d1-9d84-ece28a78b1ca.svg
"""
...
class GeneratedSolo(Solo48):
    icon_id = 'two-mail-envelopes-batch-009-01'
    ...
    def build(self):
        ...
        path('back-envelope',(6,30),(6,6),(32,6),(32,18))
        path('back-flap',(6,6),(19,18),(32,6))
        rect('front-envelope',16,26,26,16)
        path('front-flap',(16,26),(29,34),(42,26))
