"""Chicken Drumstick.
Plan: Broad drumstick with widened exposed bone and two rounded end knobs.
Construction reference: Lucide drumstick; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-010/references/drumsticks_53405d1d-04f2-4aff-975d-11f2ee7649b8.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '53405d1d-04f2-4aff-975d-11f2ee7649b8'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/food/drumsticks_53405d1d-04f2-4aff-975d-11f2ee7649b8.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'chicken-drumstick-batch-010-15'
    ...
    def build(self):
        ...
        curve('meat',(18,26),((15,18),(25,6),(33,6)),((39,6),(42,10),(42,16)),((42,25),(30,36),(24,32)))
        path('bone-upper',(18,26),(10,30))
        curve('knobs',(10,30),((6,26),(6,31),(6,34)),((6,37),(9,38),(12,36)),((10,40),(13,42),(16,42)),((20,42),(22,39),(18,36)))
        line('bone-lower',(18,36),(24,32))
