"""News Article Page.
Plan: News page with image placeholder and two text lines; clipped corner retained.
Centerline envelope: (8,4)-(40,44).
Final reduction/review: Second text line omitted; image placeholder and one text line retained.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-005/references/newspaper_d2ec8c43-9e6d-4059-8823-4ce004c7a076.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'news-article-page-solo-b005-04'
    ...
    aliases = ()
    keywords = ('news', 'article', 'page')

    def build(self):
        s = self
        s.add_polyline('page',(8,4),(30,4),(40,14),(40,44),(8,44),closed=True)
        s.add_polyline('image',(17,14),(28,14),(28,23),(17,23),closed=True)
        s.add_line('text-1',(17,32),(31,32))
