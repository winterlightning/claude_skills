...
class Photo(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e8-2', (41, 40), (38, 42), radius_x=4, radius_y=4, large_arc=False, sweep=True)
        self.add_arc('e9', (11, 42), (6, 38), radius_x=6, radius_y=6, large_arc=False, sweep=True)
        self.add_arc('e10-1', (6, 11), (11, 6), radius_x=6, radius_y=6, large_arc=False, sweep=True)
        self.add_line('e10-2', (11, 6), (38, 6))
        self.add_arc('e11', (38, 6), (42, 10), radius_x=5, radius_y=5, large_arc=False, sweep=True)
        self.add_contour('c0', 'e0', 'e1', 'e2', 'e3', closed=False)
        self.add_contour('c1', 'e8-1', 'e8-2', 'e4', 'e9', 'e5', 'e10-1', 'e10-2', 'e11', 'e7', closed=True)
