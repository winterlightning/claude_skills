...
"""Saturn with a lowered curved shoulder to open the gap below the crossbar. VRECT_L bounds (8,6)-(40,42). Preserve the directional scythe; no useful local Lucide subject match."""
...
class SaturnAstrologicalSymbolVariant2(Solo48):
    ...
    def build(self) -> None:
        self.add_line('stem-top', (16, 6), (16, 10))
        ...
        self.add_arc('sickle', (40, 26), (16, 42), radius_x=24, radius_y=20)
