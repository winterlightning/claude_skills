"""Woman User Profile Avatar. Avatar with circular jaw and smooth shoulder arcs. Body top32 = jaw bottom28 + HEAD_BODY_CENTERLINE_GAP; zero visible head/body gap.
...
PARENT_MODULE = 'icon_set/model/icons/solo/person_with_long_center_parted_hair_d1b68996_9303_5ddf_a1d9_7855e2a05442.py'

class Drawing(Solo48):
    icon_id = 'person-with-long-center-parted-hair'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('person', 'with', 'long', 'center-parted', 'hair')
    ...
    def build(self):
        self.path('hair',(8,40),[('L',(8,20)),('A',(24,4),16,16,True),('A',(40,20),16,16,True),('L',(40,40))])
