...
SOURCE_ICON_ID = 'a5aca3d7-8b27-4c0e-a466-8dec6d3087b5'
SOURCE_PATH = 'pictographic-primitives/sports/tennis_a5aca3d7-8b27-4c0e-a466-8dec6d3087b5.svg'
AUTHOR = 'gpt-6'

class TennisRacketWithBall(Solo48):
    icon_id = 'tennis-racket-with-ball'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/sports"
    aliases = ()
    keywords = ('tennis', 'racket', 'with', 'ball', 'sport')
