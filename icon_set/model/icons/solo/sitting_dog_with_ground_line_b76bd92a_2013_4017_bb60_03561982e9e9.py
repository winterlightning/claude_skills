...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.path("tail",(6,18),[((6,27),(9,31),(14,31))]);self.relate("connect","tail","body")
        self.path("haunch",(22,33),[((27,33),(28,38),(25,42))]);self.relate("connect","haunch","body")
        self.add_line("ground",(36,42),(40,42));self.relate("connect","ground","body")
    ...
    category = 'pets'
    aliases = ()
    keywords = ('dog', 'sitting', 'profile', 'silhouette', 'pet', 'obedient', 'ground')
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
