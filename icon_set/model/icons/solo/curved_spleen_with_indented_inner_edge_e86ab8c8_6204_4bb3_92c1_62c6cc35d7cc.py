...
SOURCE_PATH = 'pictographic-primitives/_uncategorized_35/spleen_e86ab8c8-6204-4bb3-92c1-62c6cc35d7cc.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    aliases = ['Human Spleen Organ']
    keywords = ['spleen','organ','anatomy','body','medical','abdomen']
    def build(self):
        ...
        bez('spleen',(8,44),((8,30),(22,30),(20,20)),((17,9),(22,4),(28,4)),((37,4),(40,13),(40,24)),((40,38),(32,44),(25,44)),((23,44),(22,42),(22,40)))
        bez('inner',(22,40),((22,32),(30,32),(30,24)))
        self.add_contour('organ-outline','spleen','inner')
