"""Construction Worker with Bob and V-Neck.
...
SOURCE_ICON_ID = 'cf44aeae-72fb-497d-bced-a85ff3fd1594'
SOURCE_PATH = 'pictographic-primitives/avatars/woman construction_cf44aeae-72fb-497d-bced-a85ff3fd1594.svg'
AUTHOR = 'gpt-6'
...
class ConstructionWorkerWithBobAndVNeck(Solo48):
    ...
    semantic_kind = 'noun'
    aliases = ()
    keywords = ('construction', 'worker', 'with', 'bob', 'and', 'v-neck')
    ...
    def build(self):
        ...
        self.add_polyline('body-neckline',(16,body_top),(24,44),(32,body_top))
