"""Open the web into a taller six-spoke construction with one scalloped outer ring and no inner polygon; derive every spoke from the same center. Applied to the original icon identity."""
