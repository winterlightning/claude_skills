...
SOURCE_ICON_ID = 'c6182923-9af3-4d1a-92fb-5c159e1879db'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_10/casement_c6182923-9af3-4d1a-92fb-5c159e1879db.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'window-closed'
...
class Drawing(Solo48):
    icon_id = 'casement-window-with-handle'
    variant_of = 'window-closed'
    variant_label = 'Casement Window with Handle'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('casement', 'window', 'handle', 'frame', 'panes', 'Uncategorized')
    def build(self):
        # Plan: A rectangular window frame containing four panes and a short right-side handle.
