"""Pentagon Refresh Symbol.
Plan: Pentagonal refresh contour with integrated direction tip; asymmetric opening at upper right.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Pentagonal refresh contour with integrated direction tip; asymmetric opening at upper right.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-004/references/pentagon arrow_073ed87e-3bfe-406c-a209-2a6bd9256bb0.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    ...
    def build(self):
        s = self
        s.add_polyline('pentagon',(38,18),(42,22),(34,42),(14,42),(6,20),(24,6),(32,12))
        s.add_polyline('tip',(24,20),(32,12),(32,6));join(s,'pentagon','tip')
