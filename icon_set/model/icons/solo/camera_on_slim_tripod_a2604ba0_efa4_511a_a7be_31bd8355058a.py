"""Camera directly mounted on three long tripod legs. Vertical envelope; Lucide camera corners. Top hump omitted to preserve the lens. Mirrored outer legs and central leg share the underside node."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'a2604ba0-efa4-511a-a7be-31bd8355058a'
SOURCE_PATH = 'pictographic-primitives/photography/camera tripod_a2604ba0-efa4-511a-a7be-31bd8355058a.svg'
AUTHOR = 'gpt-6'
...
class CameraOnSlimTripod(Solo48):
    ...
    aliases = ()
    keywords = ('camera', 'tripod', 'stand', 'photo', 'photography', 'legs', 'mount', 'lens')
    ...
    def build(self):
        ...
        for i,x in enumerate((8,24,40)):
            line('leg-'+str(i),(24,28),(x,44));connect('camera','leg-'+str(i))
