"""Open Padlock with Round Keyhole.
...
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/lock unlock_9bf06b1a-b862-578c-beb7-04728368914f.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'open-padlock-with-round-keyhole'
