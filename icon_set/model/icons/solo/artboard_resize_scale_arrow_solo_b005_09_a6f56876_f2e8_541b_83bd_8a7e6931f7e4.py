"""Artboard Resize Scale Arrow.
Plan: Resize tool: corner guides and diagonal double arrow, omit outer application frame for clearance.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Outer frame omitted so four corner guides and double-ended resize arrow remain legible.
...
SOURCE_ICON_ID = 'a6f56876-f2e8-541b-83bd-8a7e6931f7e4'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/artboard shrink_a6f56876-f2e8-541b-83bd-8a7e6931f7e4.svg'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-005/references/artboard shrink_a6f56876-f2e8-541b-83bd-8a7e6931f7e4.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'artboard-resize-scale-arrow-solo-b005-09'
    ...
    aliases = ()
    keywords = ('artboard', 'resize', 'scale', 'arrow')

    def build(self):
        s = self
        for j,pts in enumerate([((6,16),(6,6),(16,6)),((32,6),(42,6),(42,16)),((6,32),(6,42),(16,42)),((32,42),(42,42),(42,32))]):s.add_polyline(f'corner-{j}',*pts)
        arrow(s,'resize',(16,16),(32,32),7)
        s.add_polyline('start',(16,23),(16,16),(23,16));join(s,'start','resize-shaft')
