...
class HangingBoxingBag(Solo48):
    ...
    def build(self):
        # A heavy boxing bag hangs from a short suspension beneath a beam.
        # Beam supplies the wide extrema; centered bag and chain share one axis.
        self.skeleton([('beam',[(8,6),(24,6),(40,6)]),('chain',[(24,6),(24,16)])])
        ...
        for part in ['bag-top-left','bag-top-right']:self.relate('connect','chain-0',part)
