...
class Smile(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e8-2', (43, 14), (44, 14), radius_x=16, sweep=False)
        self.add_line('e8-3', (44, 14), (44, 19))
        self.add_line('e9-1', (9, 40), (5, 38))
        self.add_line('e9-2', (5, 38), (4, 33))
        self.add_arc('e10', (4, 13), (9, 8), radius_x=5)
        self.add_arc('e11', (29, 8), (33, 14), radius_x=5)
        self.add_arc('e12-1', (33, 34), (31, 39), radius_x=6)
        self.add_line('e12-2', (31, 39), (28, 40))
        self.add_contour('c0', 'e0', 'e8-1', 'e8-2', 'e8-3', 'e1', 'e2', 'e3')
