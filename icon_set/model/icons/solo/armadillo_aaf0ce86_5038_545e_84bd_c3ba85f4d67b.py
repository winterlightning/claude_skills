"""Armadillo with domed shell; centerline extremes (6,11)-(42,37). One shell band and two near legs retained; extra bands and overlapping legs omitted. No useful Lucide match; directional head and tail remain asymmetric."""
...
class Armadillo(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline('head', (14, 29), (7, 29), (6, 25), (8, 20), (8, 14), (13, 19), closed=False)
        self.relate("connect", 'head', 'shell')
        self.add_line('band', (28, 11), (28, 32))
        self.relate("connect", 'band', 'shell')
        self.add_polyline('tail', (42, 29), (42, 34), (42, 35), closed=False)
