"""Power Adapter With Lightning Symbol.
Plan: Wide adapter, two plug pins and a clear lightning stroke; collar omitted.
Construction reference: Lucide cable; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/charger_168c59f3-928c-5cd5-90ee-221448b0fdc2.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '168c59f3-928c-5cd5-90ee-221448b0fdc2'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/charger_168c59f3-928c-5cd5-90ee-221448b0fdc2.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'power-adapter-with-lightning-symbol-batch-008-02'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "electronics"
    aliases = ()
    keywords = ('power', 'adapter', 'with', 'lightning', 'symbol')
    ...
    def build(self):
        ...
        rect('adapter',8,4,32,32,3)
        for x in (18,30): line(f'pin-{x}',(x,36),(x,44))
        path('bolt',(26,13),(17,20),(31,20),(22,27))
