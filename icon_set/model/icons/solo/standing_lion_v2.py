...
class StandingLionVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('hind-shin', (42, 26), (42, 42))
        self.add_line('hind-foot', (42, 42), (34, 42))
        self.add_line('hind-inner', (34, 42), (34, 31))
        self.add_line('belly', (34, 31), (26, 31))
        self.add_line('fore-inner', (26, 31), (26, 42))
        self.add_line('fore-foot', (26, 42), (18, 42))
        self.add_line('fore-shin', (18, 42), (18, 33))
