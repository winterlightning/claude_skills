"""Captive Bead Ring Jewelry.
Plan: Open circular ring above separate captive bead; broaden opening to maintain clearance.
Centerline envelope: (8,4)-(40,44).
Final reduction/review: Open circular ring above separate captive bead; broaden opening to maintain clearance.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-003/references/circle top circle 1_47a67469-8ea2-48c7-aa8a-95fc823049c7.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'captive-bead-ring-jewelry-solo-b003-09'
    ...
    aliases = ()
    keywords = ('captive', 'bead', 'ring', 'jewelry')

    def build(self):
        s = self
        s.add_arc('top',(8,20),(40,20),radius_x=16)
        s.add_arc('left',(12,30),(8,20),radius_x=16,sweep=True)
        s.add_arc('right',(40,20),(36,30),radius_x=16)
        s.add_contour('ring','left','top','right')
        circle(s,'bead',24,39,5)
