...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/icon_set/.local/work/solo-saved-briefs-20260920/batch-folders/batch-019/references/03-09afbc31-5487-4884-b5bb-9534c9f636f2.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        path('basket',(12,14),[('L',(44,14)),('L',(43,18)),('A',(38,23),5,5,True),('L',(14,23)),('L',(12,14))],True)
        join('handle','basket')
