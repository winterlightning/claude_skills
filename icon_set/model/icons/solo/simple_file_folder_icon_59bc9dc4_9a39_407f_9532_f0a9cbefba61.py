...
SOURCE_ICON_ID = '59bc9dc4-9a39-407f-9532-f0a9cbefba61'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_24/label_59bc9dc4-9a39-407f-9532-f0a9cbefba61.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'folder'
...
class Drawing(Solo48):
    icon_id = 'simple-file-folder-icon'
    variant_of = 'folder'
    variant_label = 'Simple File Folder Icon'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('file', 'folder', 'raised', 'tab', 'Uncategorized', 'outline')
    def build(self):
        # Plan: A rounded rectangular folder with a raised upper-left tab.
        ...
        p('folder',(4,16),(4,8),(16,8),(16,16),(40,16))
        a('tr',(40,16),(44,20),4)
        l('right',(44,20),(44,36));a('br',(44,36),(40,40),4)
        l('bottom',(40,40),(8,40));a('bl',(8,40),(4,36),4);l('left',(4,36),(4,16))
