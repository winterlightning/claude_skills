...
class ArrowThickCorner1BottomLeftVariant2(Solo48):
    icon_id = 'arrow-thick-corner-1-bottom-left-v2'
    variant_of = 'arrow-thick-corner-1-bottom-left'
    ...
    def build(self):
        runs = [{'start': (6, 8), 'steps': [('L', 6, 42), ('L', 40, 42)], 'closed': False}, {'start': (18, 30), 'steps': [('L', 42, 6)], 'closed': False}]
        rotation = 0
