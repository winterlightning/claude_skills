...
class BreadLoafVariant2(Solo48):
    icon_id = 'bread-loaf-v2'
    variant_of = 'bread-loaf'
    ...
    def build(self):
        ...
        path('loaf', (8, 40), [('L', (10, 22)), ('C', (4, 16), (6, 22), (4, 19)), ('C', (14, 8), (4, 10), (8, 8)), ('L', (26, 8)), ('L', (34, 8)), ('C', (44, 16), (40, 8), (44, 10)), ('C', (38, 22), (44, 19), (42, 22)), ('L', (40, 40)), ('L', (30, 40)), ('L', (8, 40))], True)
        path('slice', (26, 8), [('C', (26, 22), (34, 10), (34, 18)), ('L', (30, 40))])
        join('slice', 'loaf')
