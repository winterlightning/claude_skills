"""A speaker horn is muted by an X to its right.
Plan: Rounded speaker housing transitions to a tall horn; a detached symmetric X occupies the right band.
Keyshape SQUARE: {'ink': [4, 4, 44, 44], 'centerline': [6, 6, 42, 42]}.
References: Supplied SVG rendered and inspected. Lucide original/volume-x.svg and atomic-debug/volume-x.svg: coherent contours, repeated radii and explicit shared junctions, freshly authored for SOLO48.
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'b8ca0005-eaa0-4a39-bf26-842cad2b3802'
SOURCE_PATH = 'icon_set/work/todo-references/volume slash_b8ca0005-eaa0-4a39-bf26-842cad2b3802.svg'
AUTHOR = 'gpt-6'
class Drawing(Solo48):
    icon_id = 'volume-slash'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('volume', 'slash')
