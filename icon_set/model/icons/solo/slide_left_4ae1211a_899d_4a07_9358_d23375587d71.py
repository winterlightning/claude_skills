"""slide-left: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '4ae1211a-899d-4a07-9358-d23375587d71'
SOURCE_PATH = 'pictographic-primitives/transportation/slide left_4ae1211a-899d-4a07-9358-d23375587d71.svg'
AUTHOR = 'gpt-6'
...
class SlideLeft(Solo48):
    ...
    def build(self):
        # Plan: VRECT_L; a tangent continuous diagonal turn and equal arrow arms.
