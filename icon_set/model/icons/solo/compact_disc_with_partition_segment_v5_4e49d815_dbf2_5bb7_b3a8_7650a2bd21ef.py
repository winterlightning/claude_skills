...
'Concentric disc with a lower-right sector; smaller circular hub leaves nine units to the sector. CIRCLE visible radius 22; SOLO48 stroke 4.'
...
class CompactDiscWithPartitionSegmentVariant5(Solo48):
    icon_id = 'compact-disc-with-partition-segment-v5'
