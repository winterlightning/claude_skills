"""An upright rounded document contains a wide rounded header block above two horizontal text lines."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '3beeb3fe-2b42-4c04-a9bf-d74b1ccfd77b'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_04/atm_3beeb3fe-2b42-4c04-a9bf-d74b1ccfd77b.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'text-document-square'
...
class Drawing(Solo48):
    icon_id = 'document-with-header-and-text'
    variant_of = 'text-document-square'
    variant_label = 'Document with Header and Text'
    ...
    aliases = ()
    keywords = ('document', 'header', 'text', 'wide', 'block', 'lines')
    def build(self):
        # Plan: An upright rounded document contains a wide rounded header block above two horizontal text lines.
        ...
        rr('page',8,4,40,44,0)
        rr('header',16,12,32,20,0)
        l('text-top',(16,28),(32,28));l('text-low',(16,36),(28,36))
