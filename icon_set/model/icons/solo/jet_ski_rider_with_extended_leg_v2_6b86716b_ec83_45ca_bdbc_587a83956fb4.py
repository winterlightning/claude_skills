...
class JetSkiRiderWithExtendedLegVariant2(Solo48):
    icon_id = 'jet-ski-rider-with-extended-leg-v2'
    variant_of = 'jet-ski-rider-with-extended-leg'
    ...
    def build(self) -> None:
        """Open the filled head with radius 3; place the nearest shoulder at (22,20), exactly 4 ink units below the head. Shared full_body_ref.png proportions."""
        self.add_arc('head-top', (19, 9), (25, 9), radius_x=3, radius_y=3, sweep=True)
        self.add_arc('head-bottom', (25, 9), (19, 9), radius_x=3, radius_y=3, sweep=True)
        self.add_contour('head', 'head-top', 'head-bottom', closed=True)
        self.add_line('rider-1', (13, 25), (19, 27))
        self.add_line('rider-2', (19, 27), (22, 20))
        self.add_line('rider-3', (22, 20), (31, 22))
