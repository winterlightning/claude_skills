# Variant of pentagon-with-star; parent file remains unchanged.
...
class PentagonWithStarVariant2(Solo48):
    icon_id = 'pentagon-with-star-v2'
    variant_of = 'pentagon-with-star'
