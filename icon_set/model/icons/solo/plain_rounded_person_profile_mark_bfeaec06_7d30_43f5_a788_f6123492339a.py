...
SOURCE_ICON_ID = 'bfeaec06-7d30-43f5-a788-f6123492339a'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_33/seller_bfeaec06-7d30-43f5-a788-f6123492339a.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'plain-rounded-person-profile-mark'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('plain', 'rounded', 'person', 'profile', 'mark')
