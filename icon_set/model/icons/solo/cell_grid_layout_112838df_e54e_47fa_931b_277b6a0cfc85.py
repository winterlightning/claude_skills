...
SOURCE_ICON_ID = '112838df-e54e-47fa-931b-277b6a0cfc85'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_10/cell border frame_112838df-e54e-47fa-931b-277b6a0cfc85.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'cell-border-full'
...
class Drawing(Solo48):
    icon_id = 'cell-grid-layout'
    variant_of = 'cell-border-full'
    variant_label = 'Cell Grid Layout'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('cell', 'grid', 'layout', 'wide', 'frame', 'cells', 'dashed', 'center')
    def build(self):
        # Plan: A wide rounded rectangular frame divided into four cells by dashed horizontal and vertical center lines.
        ...
        rr('frame',4,8,44,40,2,top=(24,),bottom=(24,),left=(24,),right=(24,))
