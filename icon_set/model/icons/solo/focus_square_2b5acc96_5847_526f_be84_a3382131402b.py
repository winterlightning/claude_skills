...
class FocusSquare(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e11', (6, 8), (8, 6), radius_x=2)
        ...
        self.add_arc('sym-e17', (42, 8), (40, 6), radius_x=3, sweep=False)
        self.add_line('sym-e18', (40, 6), (24, 6))
        self.add_line('sym-e19', (24, 34), (24, 42))
        self.add_line('sym-e20', (24, 42), (8, 42))
        self.add_arc('sym-e21', (8, 42), (6, 40), radius_x=2)
        self.add_line('sym-e23', (6, 40), (6, 24))
        self.add_arc('sym-e25', (42, 40), (40, 42), radius_x=2)
        ...
        self.add_contour('sym-c1', 'sym-e8', 'sym-e9', 'sym-e11', 'sym-e12', 'sym-e13')
        self.add_contour('sym-c2', 'sym-e14', 'sym-e15', 'sym-e17', 'sym-e18')
        self.add_contour('sym-c3', 'sym-e19', 'sym-e20', 'sym-e21', 'sym-e23')
        self.add_contour('sym-c4', 'sym-e25', 'sym-e26')
