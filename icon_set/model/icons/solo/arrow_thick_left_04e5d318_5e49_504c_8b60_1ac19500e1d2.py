...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thick left_04e5d318-5e49-504c-8b60-1ac19500e1d2.svg'
AUTHOR = 'gpt-6'
...
class ArrowThickLeft(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline('head',(24,16),(16,24),(24,32))
        self.add_line('shaft',(16,24),(33,24))
