"""warp-arc-lower: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '0a4f4267-7d21-5808-b7a6-444116b80104'
SOURCE_PATH = 'pictographic-primitives/design/warp arc lower_0a4f4267-7d21-5808-b7a6-444116b80104.svg'
AUTHOR = 'gpt-6'
...
class WarpArcLower(Solo48):
    ...
    def build(self):
        # Plan: SQUARE; equal walls and a true semicircular lower edge.
