...
class SwitchOff(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (18, 33), (20, 35), radius_x=2, sweep=False)
        self.add_line('sym-e3', (20, 35), (24, 35))
        self.add_line('sym-e4', (24, 35), (28, 35))
        self.add_arc('sym-e5', (28, 35), (30, 33), radius_x=2, sweep=False)
        self.add_line('sym-e6', (30, 33), (30, 24))
        self.add_line('sym-e7', (30, 24), (30, 15))
        self.add_arc('sym-e8', (30, 15), (28, 13), radius_x=2, sweep=False)
        self.add_line('sym-e9', (28, 13), (24, 13))
        self.add_line('sym-e10', (24, 13), (20, 13))
        self.add_arc('sym-e11', (20, 13), (18, 15), radius_x=2, sweep=False)
        ...
        self.add_arc('sym-e18', (40, 7), (37, 4), radius_x=3, sweep=False)
        self.add_line('sym-e20', (37, 4), (24, 4))
        self.add_line('sym-e21', (24, 4), (11, 4))
        self.add_arc('sym-e23', (11, 4), (8, 7), radius_x=3, sweep=False)
        self.add_line('sym-e24', (8, 7), (8, 24))
        self.add_line('sym-e25', (8, 24), (8, 41))
        self.add_arc('sym-e26', (8, 41), (11, 44), radius_x=3, sweep=False)
        ...
        self.add_contour('sym-c1', 'sym-e13', 'sym-e15', 'sym-e16', 'sym-e17', 'sym-e18', 'sym-e20', 'sym-e21', 'sym-e23', 'sym-e24', 'sym-e25', 'sym-e26', 'sym-e28', closed=True)
