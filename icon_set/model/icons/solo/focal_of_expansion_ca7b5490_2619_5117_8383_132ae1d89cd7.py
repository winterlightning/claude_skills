...
class FocalOfExpansion(Solo48):
    ...
    def build(self):
        ...
        self.add_contour('sym-c2', 'sym-e4', 'sym-e6', closed=False)
        ...
        self.add_contour('sym-c7', 'sym-e11', closed=False)
