"""A hand supports a smartphone that displays a heart.

SOLO48 VRECT_L; Lucide reference: smartphone: rounded device; hand-heart: supporting hand.
...
class HandSmartphoneHeart(Solo48):
    ...
    def build(self) -> None:
        self.round_box('phone',18,4,38,42,4)
        self.heart('heart',28,16)
        self.add_polyline('hand',(8,25),(8,34),(13,40),(18,40))
        self.add_line('finger',(8,28),(18,28))
