# Variant of hand-touching-multiple-devices; parent file remains unchanged.
...
class HandTouchingMultipleDevicesVariant2(Solo48):
    icon_id = 'hand-touching-multiple-devices-v2'
    variant_of = 'hand-touching-multiple-devices'
    variant_label = 'Readable devices and touch hand'
