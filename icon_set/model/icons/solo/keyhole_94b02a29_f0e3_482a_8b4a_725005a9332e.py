...
class Keyhole(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e4-1', (33, 24), (40, 15), radius_x=10, sweep=False)
        self.add_arc('e4-2', (40, 15), (35, 7), radius_x=9, sweep=False)
        self.add_arc('e4-3', (35, 7), (26, 4), radius_x=21, sweep=False)
        self.add_arc('e5-1', (20, 4), (8, 15), radius_x=13, sweep=False)
        self.add_arc('e5-2', (8, 15), (15, 24), radius_x=10, sweep=False)
        self.add_contour('c0', 'e4-1', 'e4-2', 'e4-3', 'e0', 'e5-1', 'e5-2', 'e1', 'e2', 'e3')
