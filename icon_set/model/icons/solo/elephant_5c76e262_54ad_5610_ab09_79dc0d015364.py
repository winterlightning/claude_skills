...
class StandingElephant(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('brow', (6, 20), (14, 8), radius_x=12, radius_y=12, sweep=True)
        ...
        self.add_line('trunk-outer', (6, 20), (6, 34))
        self.add_arc('trunk-tip', (6, 34), (10, 34), radius_x=4, radius_y=4, sweep=False)
        ...
        self.add_arc('back', (34, 14), (42, 26), radius_x=12, radius_y=12, sweep=True)
        self.add_line('hind', (42, 26), (42, 40))
        self.add_line('rear-foot', (42, 40), (36, 40))
