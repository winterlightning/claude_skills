"""monitor astronomy, complete SOLO48 composition.
Symbol plan in build(); visible keyshape extremes (4, 4, 44, 44).
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '05e504e4-9d44-430b-a3b8-b381d38174f9'
SOURCE_PATH = 'icon_set/work/todo-references/monitor astronomy_05e504e4-9d44-430b-a3b8-b381d38174f9.svg'
AUTHOR = "gpt-6"
...
class Drawing(Solo48):
    ...
    def build(self):
        # Crescent moon and four-point star remain distinct content symbols.
        self.monitor()
        self.add_arc('moon-outer',(22,14),(28,24),radius_x=8,large_arc=True,sweep=False)
        self.add_arc('moon-inner',(28,24),(22,14),radius_x=7)
        self.add_contour('moon','moon-outer','moon-inner',closed=True)
        self.add_polyline('star',(32,12),(33,15),(36,16),(33,17),(32,20),(31,17),(28,16),(31,15),closed=True)
