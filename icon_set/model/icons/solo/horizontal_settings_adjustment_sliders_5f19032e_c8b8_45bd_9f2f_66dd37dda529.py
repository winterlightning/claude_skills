"""A rounded rectangular panel contains two horizontal slider tracks with circular knobs at different positions."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '5f19032e-c8b8-45bd-9f2f-66dd37dda529'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/interface-essential/settings horizontal_5f19032e-c8b8-45bd-9f2f-66dd37dda529.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'two-vertical-sliders'
DESIGN_NOTES = 'No defining feature omitted.'
CONSTRUCTION_REFERENCE = 'Lucide sliders-horizontal original and atomic-debug; coherent contours and shared attachment nodes.'

class Drawing(Solo48):
    icon_id = 'horizontal-settings-adjustment-sliders'
    variant_of = 'two-vertical-sliders'
    variant_label = 'Horizontal Settings Adjustment Sliders'
    ...
    aliases = ()
    keywords = ('settings', 'adjustment', 'sliders', 'panel', 'slider', 'tracks', 'knobs', 'different')
    def build(self):
        # Plan: A rounded rectangular panel contains two horizontal slider tracks with circular knobs at different positions.
        ...
        rr('frame',6,6,42,42)
        for j,(x,y) in enumerate([(20,17),(28,31)]):
         c(f'knob-{j}',x,y,2)
         l(f'track-left-{j}',(15,y),(x-2,y));l(f'track-right-{j}',(x+2,y),(33,y))
