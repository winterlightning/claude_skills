...
SOURCE_PATH = 'pictographic-primitives/arrows/down_ad2d3aa0-79ab-4b3f-9eac-1acb1f09fe8c.svg'
AUTHOR = 'gpt-6'

class DownAd2d3aa0(Solo48):
    icon_id = 'down-ad2d3aa0'
    ...
    def build(self):
        runs = [{'start': (44, 17), 'steps': [('L', 24, 40), ('L', 4, 17), ('L', 8, 8), ('L', 24, 27), ('L', 40, 8)], 'closed': True}]
        rotation = 0
