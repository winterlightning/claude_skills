...
class HandHoldingRemoteWithSignalVariant3(Solo48):
    icon_id = 'hand-holding-remote-with-signal-v3'
    ...
    def build(self):
        ...
        self.add_line('thumb-palm-2', (24, 39), (26, 44))
        self.add_contour('grip', 'thumb-tip-a', 'thumb-tip', 'thumb-round', 'thumb-palm-1', 'thumb-palm-2')
        self.add_polyline('outer-hand', (28, 23), (40, 29), (40, 44))
