...
EXPORTED_REFERENCE_PATH = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-015/references/house_040105d2-2c12-45f4-be06-28d016cfdf96.svg'
AUTHOR = "gpt-6"
BATCH_AUTHORING_RUN = "20260917-011-015"


class GeneratedSolo(Solo48):
    icon_id = 'house-with-arched-door-batch-015-04'
    ...
    def build(self):
        ...
        self.add_line('threshold', (18, 42), (30, 42))
        self.relate("connect", 'walls', 'threshold')
