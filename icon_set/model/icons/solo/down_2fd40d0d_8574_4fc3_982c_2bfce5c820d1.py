...
SOURCE_PATH = 'pictographic-primitives/arrows/down_2fd40d0d-8574-4fc3-982c-2bfce5c820d1.svg'
AUTHOR = 'gpt-6'
...
class Down(Solo48):
    ...
    def build(self):
        runs = [{'start': (6, 6), 'steps': [('L', 24, 24), ('L', 42, 6)], 'closed': False}, {'start': (6, 24), 'steps': [('L', 24, 42), ('L', 42, 24)], 'closed': False}]
        rotation = 0
