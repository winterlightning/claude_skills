"""Uppercase X for SOLO48; centerline envelope (10, 4)–(38, 44).
...
class LetterXUppercase(Solo48):
    icon_id = 'letter-x-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'X', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('X', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        center=(24,24)
        runs=[((10,4),[('L',*center),('L',38,44)],False),((38,4),[('L',*center),('L',10,44)],False)]
