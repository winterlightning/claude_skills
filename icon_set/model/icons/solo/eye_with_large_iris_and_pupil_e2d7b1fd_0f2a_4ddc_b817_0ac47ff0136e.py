...
SOURCE_ICON_ID = 'e2d7b1fd-0f2a-4ddc-b817-0ac47ff0136e'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_22/hazel_e2d7b1fd-0f2a-4ddc-b817-0ac47ff0136e.svg'
AUTHOR = 'gpt-6'

class EyeWithLargeIrisAndPupil(Solo48):
    icon_id = 'eye-with-large-iris-and-pupil'
    ...
    aliases = ()
    keywords = ('eye', 'with', 'large', 'iris', 'and', 'pupil')
