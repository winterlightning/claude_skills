"""royal-soldier-1: uniform belt and fastening with reference head silhouette.
...
Body cue: uniform belt and fastening. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = '6af581d6-8faf-4a5c-8467-4df8daf28e28'
SOURCE_PATH = 'pictographic-primitives/avatars/royal soldier_6af581d6-8faf-4a5c-8467-4df8daf28e28.svg'
SOURCE_HEAD_ICON_ID = 'royal-soldier-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class RoyalSoldier1Avatar(Solo48):
    icon_id = 'royal-soldier-1-avatar'
    ...
    aliases = ()
    keywords = ('royal', 'soldier', '1', 'portrait', 'bust')
    def build(self):
        ...
        for side,sign in [('left',-1),('right',1)]:
            self.add_polyline('guard-'+side,(24+sign*12,16),(24+sign*16,26))
            self.relate('connect','guard-'+side,'brim')
            self.relate('connect','guard-'+side,'cap')
