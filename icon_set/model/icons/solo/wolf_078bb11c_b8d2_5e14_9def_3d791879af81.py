...
class WolfHeadProfile(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('nape', (6, 34), (17, 16), radius_x=42, radius_y=42, sweep=True)
        self.add_arc('ear-back', (17, 16), (26, 6), radius_x=15, radius_y=15, sweep=True)
        self.add_line('ear-1', (26, 6), (25, 12))
        self.add_arc('brow', (25, 12), (35, 20), radius_x=11, radius_y=11, sweep=True)
        self.add_line('muzzle', (35, 20), (42, 25))
        self.add_arc('nose', (42, 25), (39, 33), radius_x=7, radius_y=8, sweep=True)
        self.add_line('jaw', (39, 33), (30, 32))
        self.add_arc('throat', (30, 32), (24, 38), radius_x=6, radius_y=6, sweep=False)
        self.add_line('chest', (24, 38), (24, 42))
