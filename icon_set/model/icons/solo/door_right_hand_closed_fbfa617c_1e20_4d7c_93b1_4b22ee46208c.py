...
class DoorRightHandClosed(Solo48):
    icon_id = 'door-right-hand-closed'
    ...
    def build(self):
        self.add_line('sym-e0', (11, 42), (42, 42))
        self.add_line('sym-e2', (24, 6), (35, 6))
        self.add_arc('sym-e3', (35, 6), (37, 8), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('sym-e4', (37, 8), (37, 42))
        self.add_line('sym-e5', (6, 42), (11, 42))
        self.add_line('sym-e6', (11, 42), (11, 8))
        self.add_arc('sym-e7', (11, 8), (13, 6), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('sym-e8', (13, 6), (24, 6))
        self.add_contour('sym-c0', 'sym-e0', closed=False)
        self.add_contour('sym-c1', 'sym-e2', 'sym-e3', 'sym-e4', closed=False)
