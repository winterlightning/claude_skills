"""A gift box with an overhanging lid and paired bow loops; wide construction.
...
SOURCE_ICON_ID='edd094e0-1018-4fb8-991b-0b2c85b4ef62'
SOURCE_PATH='pictographic-primitives/rewards/gift box 1_edd094e0-1018-4fb8-991b-0b2c85b4ef62.svg'
AUTHOR='gpt-6'

class GiftBoxWideBow(Solo48):
    icon_id='gift-box-wide-bow'
    keyshape=Keyshape.SQUARE
    semantic_role='MAIN'
    semantic_kind='noun'
    category = 'rewards'
    aliases=()
    keywords=('award', 'reward', 'gift-box-wide-bow')
    def build(self) -> None:
        axis=24
