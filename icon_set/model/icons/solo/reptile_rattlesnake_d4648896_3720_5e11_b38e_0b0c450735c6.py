"""Rattlesnake with broad U bends, tapering head and rattle dashes. Extrema (6,6)-(42,42). Smooth paired bends replace source switchbacks; small tongue fork omitted."""
...
class Rattlesnake(Solo48):
    ...
    def build(self) -> None:
        # Rattlesnake with broad U bends, tapering head and rattle dashes. Extrema (6,6)-(42,42). Smooth paired bends replace source switchbacks; small tongue fork omitted.
        self.add_line('tail-outer', (6, 25), (6, 32))
        self.add_arc('bend-outer', (6, 32), (26, 32), radius_x=12, radius_y=12, sweep=False)
        ...
        self.add_arc('head-taper-right', (40, 42), (42, 32), radius_x=6, radius_y=10, sweep=False)
        self.add_arc('head-right', (42, 32), (42, 22), radius_x=4, radius_y=10, sweep=False)
        ...
        self.add_arc('tail-cap', (10, 25), (6, 25), radius_x=4, radius_y=4, sweep=False)
        ...
        self.add_line('rattle-top', (6, 6), (7, 6))
        self.add_line('rattle-bottom', (6, 12), (8, 12))
        self.add_line('tongue', (40, 42), (40, 42))
