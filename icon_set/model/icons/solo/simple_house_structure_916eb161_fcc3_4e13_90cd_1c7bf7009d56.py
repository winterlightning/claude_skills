...
SOURCE_ICON_ID = '916eb161-fcc3-4e13-90cd-1c7bf7009d56'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_09/cabana_916eb161-fcc3-4e13-90cd-1c7bf7009d56.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'empty-house'
...
class Drawing(Solo48):
    icon_id = 'simple-house-structure'
    variant_of = 'empty-house'
    variant_label = 'Simple house structure'
    ...
    aliases = ()
    keywords = ('house', 'structure', 'outline', 'triangular', 'roof', 'walls', 'flat', 'base')
    def build(self):
        # Plan: An empty house outline with a broad triangular roof, upright side walls and flat base.
        ...
        p('roof',(4,20),(24,8),(44,20),(36,20),(12,20),closed=True)
        for j,x in enumerate([12,36]):l(f'wall-{j}',(x,20),(x,40))
        p('ground',(4,40),(12,40),(36,40),(44,40))
