"""House with overhanging roof and central arched door; mirrored x24, exact shared sill nodes. Centerline6,6–42,42.
...
class BatchIcon(Solo48):
    icon_id='house-with-arched-doorway-solo-b015'
    ...
    def build(self):
        ...
        path('door',(18,42),[('L',(18,31)),('A',6,6,True,(30,31)),('L',(30,42))])
