...
class WatersideFortressV2(Solo48):
    icon_id = 'waterside-fortress-v2'
    ...
    def build(self):
        ...
        P('flag',(24,6),(38,6),(34,8),(38,12),(24,12),closed=True)
        L('pole',(24,12),(24,22));J('pole','flag');J('pole','fort')
