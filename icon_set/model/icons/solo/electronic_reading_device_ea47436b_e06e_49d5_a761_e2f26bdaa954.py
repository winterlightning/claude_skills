...
SOURCE_ICON_ID = 'ea47436b-e06e-49d5-a761-e2f26bdaa954'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_17/ereader_ea47436b-e06e-49d5-a761-e2f26bdaa954.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'mobile-phone-mobile'
...
class Drawing(Solo48):
    icon_id = 'electronic-reading-device'
    variant_of = 'mobile-phone-mobile'
    variant_label = 'Electronic Reading Device'
    ...
    def build(self):
        # Plan: An upright rounded electronic reader with a rectangular empty screen and short lower home indicator.
