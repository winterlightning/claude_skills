"""Hanging Wrecking Ball.
Plan: A spherical demolition weight, radius16 centered(24,28), and a vertical suspension cable at x24. Bounds (8,4)-(40,44).
References: Lucide weight for the attached hanging-mass construction; supplied reference for the circular ball.
Reduction: Small hook loop removed to keep the sphere and cable clear.
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'a1628475-77ad-5a65-a9f2-ea2088b28b4d'
SOURCE_PATH = 'pictographic-primitives/construction/wrecking ball_a1628475-77ad-5a65-a9f2-ea2088b28b4d.svg'
AUTHOR = 'gpt-6'
...
class HangingWreckingBall(Solo48):
    ...
    semantic_kind = 'noun'
    aliases = ()
    keywords = ('hanging', 'wrecking', 'ball')
    def build(self):
        circle(self,'ball',24,28,16)
        self.add_line('cable',(24,4),(24,12))
        self.relate('connect','ball','cable')
