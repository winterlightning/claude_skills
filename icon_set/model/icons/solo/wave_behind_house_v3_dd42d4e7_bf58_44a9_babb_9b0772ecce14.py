# Variant of wave-behind-house-v2; parent file remains unchanged.
...
class WaveBehindHouseVariant3(Solo48):
    icon_id = 'wave-behind-house-v3'
    variant_of = 'wave-behind-house-v2'
