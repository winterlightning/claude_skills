"""Top-view scorpion with open pincers and a curled stinging tail. Centerline extremes (2,2)-(46,46). Lucide bug informs paired appendages. Tail remains left-curled; segmentation and one leg pair omitted for clear gaps."""
...
class Scorpion(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('jaw-l-inner', (14, 2), (8, 7))
        self.add_line('jaw-l-outer', (8, 7), (2, 2))
        ...
        self.add_polyline('leg-l-0', (18, 22), (8, 24), (2, 24))
        self.relate("connect", 'body', 'leg-l-0')
        self.add_polyline('leg-l-1', (18, 28), (8, 30), (2, 30))
        ...
        self.add_line('jaw-r-inner', (34, 2), (40, 7))
        self.add_line('jaw-r-outer', (40, 7), (46, 2))
        ...
        self.add_polyline('leg-r-0', (30, 22), (40, 24), (46, 24))
        self.relate("connect", 'body', 'leg-r-0')
        self.add_polyline('leg-r-1', (30, 28), (40, 30), (46, 30))
