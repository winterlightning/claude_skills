"""Medical Support Chat Bubble. Authored directly on SOLO48 for later user-requested sub reuse.
...
class Drawing(Solo48):
    icon_id = 'medical-message-55-solo'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    tags = ('sub icon',)
    keywords = ('sub icon', 'medical support chat bubble')
    def build(self):
