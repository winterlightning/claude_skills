...
Plan: Wide breaker housing accommodates a readable lightning stroke below the actuator.
Construction reference: Lucide lightbulb; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/circuit breaker_e352b853-9859-4390-8925-68ce858fb1db.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'e352b853-9859-4390-8925-68ce858fb1db'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/circuit breaker_e352b853-9859-4390-8925-68ce858fb1db.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'electrical-power-circuit-breaker-batch-007-04'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/batch-007"
    aliases = ()
    keywords = ('electrical', 'power', 'circuit', 'breaker')
    ...
    def build(self):
        ...
        rect('housing',8,12,32,32,3)
        path('actuator',(18,12),(18,4),(30,4),(30,12))
        path('bolt',(26,21),(17,28),(31,28),(22,35))
