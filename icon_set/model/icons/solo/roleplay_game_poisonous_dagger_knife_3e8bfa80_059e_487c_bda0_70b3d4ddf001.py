"""A poisoned dagger beside a droplet and skull.

Plan: Diagonal blade and rounded handle form one tool, with crossguard; poison symbols occupy right side.
Construction: No useful Lucide match for the complete dagger/skull composition.
"""
...
class Drawing(Solo48):
    ...
    def build(self):
        blade_points=[(15,32),(34,6),(31,22),(21,38)]
        for i in range(3):self.add_line(f'blade-{i+1}',blade_points[i],blade_points[i+1])
