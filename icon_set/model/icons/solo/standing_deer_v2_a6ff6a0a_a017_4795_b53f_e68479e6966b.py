...
class StandingDeerVariant2(Solo48):
    icon_id = 'standing-deer-v2'
    variant_of = 'standing-deer'
    ...
    def build(self) -> None:
        ...
        self.add_arc('shoulder', (28, 24), (32, 18), radius_x=4, radius_y=6, sweep=False)
        self.add_line('neck-back', (32, 18), (32, 12))
        self.add_line('head-1', (32, 12), (40, 12))
        self.add_line('head-2', (40, 12), (42, 18))
        self.add_line('head-3', (42, 18), (42, 24))
        self.add_line('head-4', (42, 24), (38, 24))
        ...
        self.add_arc('rump', (12, 38), (12, 24), radius_x=6, radius_y=7, sweep=True)
        self.add_contour('body', 'back', 'shoulder', 'neck-back', 'head-1', 'head-2', 'head-3', 'head-4', 'neck-front', 'chest', 'belly', 'rump', closed=True)
        self.add_line('leg-back', (12, 38), (12, 42))
        self.add_line('leg-front', (26, 38), (26, 42))
        self.relate('connect', 'leg-back', 'body')
        self.relate('connect', 'leg-front', 'body')
        self.add_arc('antler-left', (32, 12), (24, 6), radius_x=10, radius_y=10, sweep=True)
        self.add_arc('antler-right', (32, 12), (42, 6), radius_x=10, radius_y=10, sweep=False)
