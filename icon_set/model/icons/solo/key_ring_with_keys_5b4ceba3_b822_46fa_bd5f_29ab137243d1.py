"""A round ring holds three distinct key shafts; crowded outlines and repeated teeth are reduced to two bent tips and a plain third key."""
...
class KeyRingWithKeys(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline('left-key',(6,18),(6,30),(6,42))
