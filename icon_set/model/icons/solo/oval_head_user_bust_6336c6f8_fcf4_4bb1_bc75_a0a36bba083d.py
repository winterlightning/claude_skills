'A plain oval head floats above a rounded shoulder-length bust. A shallow curved neckline dips beneath the head, with upright sides and a flat lower edge enclosing the torso.\nPlan: Circular head and broad circular shoulder arc; head bottom24 shoulder top28 gives zero ink gap. Normalize oval head to shared human proportions; open lower bust.\nConstruction reference: human_ref/user.svg and avatar specialization: circular face, rounded shoulders and zero painted gap.'
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '6336c6f8-fcf4-4bb1-bc75-a0a36bba083d'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_12/congressperson_6336c6f8-fcf4-4bb1-bc75-a0a36bba083d.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'oval-head-user-bust'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('oval', 'head', 'user', 'bust')
