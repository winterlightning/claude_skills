...
class SheepHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('chin-right', (38, 19), (24, 42), radius_x=14, radius_y=24, sweep=True, large_arc=False)
        self.add_arc('chin-left', (24, 42), (10, 19), radius_x=14, radius_y=24, sweep=True, large_arc=False)
