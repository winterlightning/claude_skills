...
Final reduction/review: Menu reduced from three strokes to two for wall clearance.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-001/references/sidebar line left_779a7169-b4d5-52a9-a799-2ce7e82c5026.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'left-sidebar-navigation-layout-solo-b001-05'
    ...
    def build(self):
        ...
        for y in (18,30): s.add_line(f'menu-{y}',(13,y),(16,y))
