"""Uppercase A for SOLO48; centerline envelope (10, 4)–(38, 44).
Plan: Mirrored stems around x=24; crossbar attaches halfway along each diagonal.
...
class LetterAUppercase(Solo48):
    icon_id = 'letter-a-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'A', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('A', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        apex=(24,4)
        left_bar,right_bar=(17,24),(31,24)
        runs=[((10,44), [('L',*left_bar),('L',*apex),('L',*right_bar),('L',38,44)],False), (left_bar,[('L',*right_bar)],False)]
