...
class PieChartAndSquare(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e7', (20, 42), (20, 41), radius_x=53, radius_y=53, large_arc=False, sweep=True)
        self.add_arc('e8-1', (31, 20), (19, 6), radius_x=13, radius_y=13, large_arc=False, sweep=False)
        self.add_line('e8-2', (19, 6), (13, 7))
        self.add_arc('e8-3', (13, 7), (8, 12), radius_x=14, radius_y=14, large_arc=False, sweep=False)
        self.add_arc('e8-4', (8, 12), (6, 18), radius_x=11, radius_y=11, large_arc=False, sweep=False)
        self.add_line('e8-5', (6, 18), (7, 24))
        self.add_line('e8-6', (7, 24), (10, 28))
        self.add_arc('e8-7', (10, 28), (20, 31), radius_x=13, radius_y=13, large_arc=False, sweep=False)
        self.add_contour('c0', 'e0', 'e1', 'e2', 'e7', 'e3', closed=False)
        self.add_contour('c1', 'e4', 'e5', closed=False)
        self.add_contour('c2', 'e8-1', 'e8-2', 'e8-3', 'e8-4', 'e8-5', 'e8-6', 'e8-7', closed=False)
