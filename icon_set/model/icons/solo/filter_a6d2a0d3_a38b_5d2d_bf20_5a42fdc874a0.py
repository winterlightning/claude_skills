"""filter: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'a6d2a0d3-a38b-5d2d-bf20-5a42fdc874a0'
SOURCE_PATH = 'pictographic-primitives/interface-essential/filter_a6d2a0d3-a38b-5d2d-bf20-5a42fdc874a0.svg'
AUTHOR = 'gpt-6'
...
class Filter(Solo48):
    ...
    def build(self):
        # Plan: SQUARE; clean straight funnel rim and walls, with equal shoulder slopes.
