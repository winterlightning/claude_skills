...
SOURCE_ICON_ID = 'f46dad41-64e7-4112-b47a-9dcc2fd2f790'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_12/composition layout 2_f46dad41-64e7-4112-b47a-9dcc2fd2f790.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'layout-three-rows'
...
class Drawing(Solo48):
    icon_id = 'three-row-grid-layout'
    variant_of = 'layout-three-rows'
    variant_label = 'Three Row Grid Layout'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('row', 'grid', 'layout', 'rows', 'middle', 'cells')
    def build(self):
        # Plan: A rounded rectangular layout with broad top and bottom rows and two empty middle cells.
        ...
        rr('frame',6,6,42,42,2,left=(18,30),right=(18,30))
