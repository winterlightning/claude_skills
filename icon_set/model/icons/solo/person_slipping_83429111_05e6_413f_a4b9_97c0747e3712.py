...
class PersonSlipping(Solo48):
    ...
    def build(self):
        ...
        self.add_line('person-torso-1', (26, 21), (20, 28))
        self.add_line('person-arms-1', (12, 14), (18, 23))
        self.add_line('person-arms-2', (18, 23), (26, 21))
        self.add_line('person-arms-3', (26, 21), (42, 16))
        self.add_line('person-legs-1', (6, 29), (20, 28))
