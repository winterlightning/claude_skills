...
SOURCE_PATH = 'pictographic-primitives/arrows/arrow thick circle left 1_00c9a365-5888-5d76-bb53-1e0c545792c7.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class ArrowThickCircleLeft1(Solo48):
    icon_id = 'arrow-thick-circle-left-1'
