...
class SpiderOnThread(Solo48):
    ...
    def build(self) -> None:
        # Round abdomen and smaller head with six legs; extremes (6,6)-(42,42).
        ...
        self.add_arc('head2', (29, 41), (24, 42), radius_x=5, radius_y=5, sweep=True)
        self.add_arc('head3', (24, 42), (19, 41), radius_x=5, radius_y=5, sweep=True)
