"""user-pilot-hair-long-2: pilot jacket fastening with reference head silhouette.
...
Body cue: pilot jacket fastening. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-11/references/user-pilot-hair-long-2.svg'
SOURCE_HEAD_ICON_ID = 'user-pilot-hair-long-2'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 30
class UserPilotHairLong2Avatar(Solo48):
    icon_id = 'user-pilot-hair-long-2-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'pilot', 'hair', 'long', '2', 'portrait', 'bust')
    def build(self):
        cx = 24
