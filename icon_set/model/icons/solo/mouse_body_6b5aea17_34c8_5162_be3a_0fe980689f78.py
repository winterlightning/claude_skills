...
class SittingMouse(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('belly', (32, 34), (20, 42), radius_x=12, radius_y=12, sweep=True, large_arc=False)
        self.add_arc('rump', (20, 42), (8, 34), radius_x=12, radius_y=12, sweep=True, large_arc=False)
