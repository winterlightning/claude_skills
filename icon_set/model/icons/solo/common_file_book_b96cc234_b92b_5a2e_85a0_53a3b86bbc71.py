...
class CommonFileBook(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e2', (10, 8), (5, 13))
        self.add_arc('sym-e4', (5, 13), (4, 14), radius_x=6, radius_y=6, large_arc=False, sweep=False)
        self.add_line('sym-e6', (4, 14), (4, 37))
        self.add_arc('sym-e8', (4, 37), (7, 40), radius_x=3, radius_y=3, large_arc=False, sweep=False)
        self.add_line('sym-e10', (7, 40), (41, 40))
        self.add_arc('sym-e13', (41, 40), (44, 37), radius_x=3, radius_y=3, large_arc=False, sweep=False)
        self.add_line('sym-e15', (44, 37), (44, 14))
        self.add_line('sym-e17', (44, 14), (38, 8))
        self.add_line('sym-e20', (38, 8), (24, 8))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e4', 'sym-e6', 'sym-e8', 'sym-e10', 'sym-e13', 'sym-e15', 'sym-e17', 'sym-e20', closed=False)
