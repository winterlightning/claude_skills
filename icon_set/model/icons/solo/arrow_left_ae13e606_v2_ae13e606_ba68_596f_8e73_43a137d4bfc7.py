...
class ArrowLeftAe13e606Variant2(Solo48):
    icon_id = 'arrow-left-ae13e606-v2'
    variant_of = 'arrow-left-ae13e606'
    ...
    def build(self):
        runs = [{'start': (22, 8), 'steps': [('L', 4, 24)], 'closed': False}, {'start': (22, 40), 'steps': [('L', 4, 24), ('L', 44, 24)], 'closed': False}]
        rotation = 0
