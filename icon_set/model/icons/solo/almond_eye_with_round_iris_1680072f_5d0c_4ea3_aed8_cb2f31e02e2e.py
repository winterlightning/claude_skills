'Human Eye View Icon.\n\nSymbol plan: Symmetric almond eyelids and one circular iris.\nKeyshape: HRECT_L; authored on SOLO48, not scaled from source.\nLucide: eye.'
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '1680072f-5d0c-4ea3-aed8-cb2f31e02e2e'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_23/iris_1680072f-5d0c-4ea3-aed8-cb2f31e02e2e.svg'
AUTHOR = 'gpt-6'

class AlmondEyeWithRoundIris(Solo48):
    icon_id = 'almond-eye-with-round-iris'
    ...
    aliases = ()
    keywords = ('almond', 'eye', 'with', 'round', 'iris')

    def build(self):
        # Symmetric almond eyelids and one circular iris.
        axis_x = 24
        p_4_24 = (4, 24)
        p_10_15 = (10, 15)
        p_10_33 = (10, 33)
