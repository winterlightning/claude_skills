"""user-hair: wrap blouse with reference head silhouette.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-11/references/user-hair.svg'
SOURCE_HEAD_ICON_ID = 'user-hair'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 22
class UserHairAvatar(Solo48):
    icon_id = 'user-hair-avatar'
