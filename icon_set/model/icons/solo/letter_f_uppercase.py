"""Uppercase F for SOLO48; centerline envelope (10, 4)–(38, 44).
...
class LetterFUppercase(Solo48):
    icon_id = 'letter-f-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'F', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('F', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((38,4),[('L',10,4),('L',10,24),('L',10,44)],False),((10,24),[('L',32,24)],False)]
