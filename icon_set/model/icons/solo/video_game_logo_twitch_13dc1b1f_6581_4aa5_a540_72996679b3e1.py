"""The Twitch speech-bubble logo contains two upright bars.
Plan: Rounded upper frame, clipped lower-right corner and lower-left tail contain evenly spaced bars.
...
class Drawing(Solo48):
    ...
    aliases = ()
    keywords = ('video', 'game', 'logo', 'twitch')
