"""Classic Padded Armchair.

Classic padded armchair, high round back, round projecting arms and broad block feet. Centerline extremes (6,6)-(42,42). Lucide armchair informs shared arm/back contacts; mirrored geometry owns both sides. Simplify doubled upholstery to one seat line.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '9a570d4f-eabb-5f25-92a6-b77da284dfc9'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/furnitures/chair retro_9a570d4f-eabb-5f25-92a6-b77da284dfc9.svg'
AUTHOR = 'gpt-6'

class ClassicArmchairCurvedArms(Solo48):
    icon_id = 'classic-armchair-curved-arms'
    ...
    aliases = ()
    keywords = ('classic', 'padded', 'armchair')

    def build(self):
        # Symbol plan: Classic padded armchair, high round back, round projecting arms and broad block feet. Centerline extremes (6,6)-(42,42). Lucide armchair informs shared arm/back contacts; mirrored geometry owns both sides. Simplify doubled upholstery to one seat line.
        ...
        back_radius=8;arm_y=20;seat_y=26;bottom=34;inner=16 if False else 14;other=48-inner
        ...
        if 'block'=='block':
            ...
            for n,x,z in [('left',18,16 if 'block'=='slant' else 18),('right',30,32 if 'block'=='slant' else 30)]:
