"""red-indian-woman: diagonal garment fold and reference head silhouette.
...
Body cue: diagonal garment fold. Hair and feather asymmetry follow the source.
"""
...
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class RedIndianWomanAvatar(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('hair',(16,20),((14,22),(10,24),(8,24)))
        self.relate('connect','hair','head')
        self.relate('connect','hair','headband')
        ...
        self.add_polyline('body-wrap', (12,top), (30,44))
