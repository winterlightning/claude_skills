"""Woman Spy with Sunglasses and Hat.

Symbol plan: Notched hat and round sunglasses with two flared hair locks and a coat lapel; retain smooth circular jaw and shoulder anatomy.
VRECT_L centerline extremes (8,4)-(40,44); exact envelope selected for the subject's proportions.
Construction reference: Shared human_ref/user.svg: circular jaw, broad smooth shoulders and zero-ink-gap head/body contact. Supplied reference defines headwear; tiny trim is omitted. Lucide glasses: equal paired lenses; symmetric hair follows the source.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = 'c37ef694-b1ba-45ed-ba25-393a9b498040'
SOURCE_PATH = 'pictographic-primitives/avatars/police woman spy 1_c37ef694-b1ba-45ed-ba25-393a9b498040.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'woman-spy-with-sunglasses-and-hat'
    ...
    def build(self) -> None:
        ...
        for side,sign in [('left',-1),('right',1)]:
            ...
            connect('hair-'+side,'face');connect('hair-'+side,'brim');connect('hair-'+side,'crown');connect('hair-'+side,'lens-'+side)
