...
class SegmentedHandGrenadeVariant2(Solo48):
    icon_id = 'segmented-hand-grenade-v2'
    variant_of = 'segmented-hand-grenade'
    ...
    def build(self):
        ...
        P('neck', (18, 12), (18, 4), (30, 4), (30, 12))
        A('shoulder-r', (30, 12), (40, 24), 10, 12)
        A('lower-r', (40, 24), (24, 44), 16, 20)
        A('lower-l', (24, 44), (8, 24), 16, 20)
        A('shoulder-l', (8, 24), (18, 12), 10, 12)
        self.add_contour('body', 'shoulder-r', 'lower-r', 'lower-l', 'shoulder-l')
        J('neck', 'body')
        L('seam', (8, 24), (40, 24))
        J('seam', 'body')
        L('lower-seam', (24, 24), (24, 44))
        J('lower-seam', 'body')
        J('lower-seam', 'seam')
