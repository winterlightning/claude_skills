"""synchronize-refresh-arrow-b3069a62: Smooth refresh curve; earlier revisions preserved."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'b3069a62-a707-4dfe-ad1b-5c5d76ab3dc0'
SOURCE_PATH = 'icons-json/interface-essential/synchronize refresh arrow_b3069a62-a707-4dfe-ad1b-5c5d76ab3dc0.json'
AUTHOR = 'gpt-6'

class SynchronizeRefreshArrowB3069a62(Solo48):
    icon_id = 'synchronize-refresh-arrow-b3069a62'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'interface-essential'
    aliases = ()
    keywords = ('solo-ai-full-set', 'synchronize-refresh-arrow-b3069a62')
