"""House and open rectangular door with a detached squared chimney. Chimney separated from roof to preserve clearance at48. Centerline6,6–42,42.
...
class BatchIcon(Solo48):
    icon_id='house-with-rectangular-chimney-solo-b015'
    ...
    def build(self):
        ...
        path('walls',(10,24),[('L',(10,40)),('A',2,2,False,(12,42)),('L',(18,42)),('L',(18,31)),('A',2,2,True,(20,29)),('L',(28,29)),('A',2,2,True,(30,31)),('L',(30,42)),('L',(36,42)),('A',2,2,False,(38,40)),('L',(38,24))])
