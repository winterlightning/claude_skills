...
SOURCE_PATH = 'pictographic-primitives/arrows/curve rise large head_dd13c23c-99cd-4dd8-932b-e39c965b1587.svg'
AUTHOR = 'gpt-6'
...
class CurveRiseLargeHead(Solo48):
    ...
    def build(self):
        runs = [{'start': (4, 8), 'steps': [('L', 10, 8), ('A', 18, 16, 8, 8, True), ('L', 18, 31), ('A', 36, 31, 9, 9, False), ('L', 36, 8)], 'closed': False}, {'start': (28, 18), 'steps': [('L', 36, 8), ('L', 44, 18)], 'closed': False}]
        rotation = 0
