...
SOURCE_ICON_ID = 'a4d6f451-4c6e-5004-97b6-dee65eba0dd0'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/health/dentistry tooth equipment_a4d6f451-4c6e-5004-97b6-dee65eba0dd0.svg'
AUTHOR = 'gpt-6'


class DentalMirrorAndProbePair(Solo48):
    icon_id = 'dental-mirror-and-probe-pair'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/health"
    aliases = ()
    keywords = ('dental', 'mirror', 'and', 'probe')

    def build(self):
        # Plan: A bent probe and circular mouth mirror stand side by side, each with a narrow rounded grip. Extremes (8,4)-(40,44).
        # Reduction: Retain both instruments and handles; omit grip texture.
        # Reference: Lucide search: circular head on a narrow shaft; shared capsule definitions for both grips.
        ...
        path('probe',(16,4),(8,12),(16,20),(16,28))
        rounded('probe-grip',12,28,20,44,4)
        circle('mirror',34,10,6)
        line('mirror-shaft',(34,16),(34,28))
        rounded('mirror-grip',30,28,38,44,4)
        contacts()
