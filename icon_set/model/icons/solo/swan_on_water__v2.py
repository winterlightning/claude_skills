...
"""Swan with an open raised wing above smooth circular ripples. HRECT_XL centerline extremes (6,6)-(42,42). Lucide bird informs the simple wing; waves-horizontal informs repeated tangent-continuous lobes. The facing-right silhouette is deliberately asymmetric."""
...
class SwanOnWaterVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('head-right', (42, 15), (32, 6), radius_x=10, sweep=False)
        self.add_arc('head-left', (32, 6), (22, 15), radius_x=10, sweep=False)
        ...
        self.add_arc('hull-back', (20, 32), (6, 16), radius_x=18, radius_y=16, sweep=True)
        self.add_line('tail', (6, 16), (7, 16))
        ...
        self.add_arc('wave-left', (6, 41), (12, 42), radius_x=26, sweep=False)
        self.add_arc('wave-middle', (12, 42), (22, 41), radius_x=26, sweep=False)
