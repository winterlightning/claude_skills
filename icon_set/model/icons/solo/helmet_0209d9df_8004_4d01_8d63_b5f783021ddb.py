...
class Helmet(Solo48):
    ...
    def build(self):
        self.add_arc('sym-e0', (40, 31), (40, 30), radius_x=31, sweep=False)
        self.add_line('sym-e1', (40, 30), (40, 27))
        self.add_arc('sym-e2', (40, 27), (29, 13), radius_x=18, sweep=False)
        self.add_line('sym-e3', (29, 13), (29, 11))
        self.add_arc('sym-e4', (29, 11), (29, 10), radius_x=3)
        ...
        self.add_arc('sym-e11', (19, 10), (19, 11), radius_x=3)
        self.add_line('sym-e12', (19, 11), (19, 13))
        self.add_arc('sym-e13', (19, 13), (8, 27), radius_x=17, sweep=False)
        self.add_arc('sym-e14', (8, 27), (8, 30), radius_x=18, sweep=False)
        self.add_arc('sym-e15', (8, 30), (8, 31), radius_x=63, sweep=False)
        self.add_line('sym-e16', (8, 31), (6, 31))
        self.add_line('sym-e17', (6, 31), (4, 33))
        self.add_line('sym-e18', (4, 33), (4, 34))
        self.add_line('sym-e19', (4, 34), (4, 36))
        self.add_line('sym-e20', (4, 36), (5, 39))
        self.add_arc('sym-e21', (5, 39), (5, 40), radius_x=1)
        self.add_arc('sym-e22', (5, 40), (6, 40), radius_x=7)
        self.add_line('sym-e23', (6, 40), (24, 40))
        self.add_line('sym-e24', (24, 40), (42, 40))
        self.add_line('sym-e25', (42, 40), (43, 40))
        self.add_arc('sym-e26', (43, 40), (43, 39), radius_x=1)
        self.add_line('sym-e27', (43, 39), (44, 36))
        self.add_line('sym-e28', (44, 36), (44, 34))
        self.add_arc('sym-e29', (44, 34), (44, 33), radius_x=34)
        ...
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e7', 'sym-e8', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e15', 'sym-e16', 'sym-e17', 'sym-e18', 'sym-e19', 'sym-e20', 'sym-e21', 'sym-e22', 'sym-e23', 'sym-e24', 'sym-e25', 'sym-e26', 'sym-e27', 'sym-e28', 'sym-e29', 'sym-e30', 'sym-e31', 'sym-e32', 'sym-e33')
