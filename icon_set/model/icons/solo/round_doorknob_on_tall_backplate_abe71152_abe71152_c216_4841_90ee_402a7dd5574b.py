...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_15/doorknob_abe71152-c216-4841-90ee-402a7dd5574b.svg'
AUTHOR = 'gpt-6'
...
class BatchIcon(Solo48):
    ...
    def build(self):
        ...
        poly('plate',(24,30),(24,44),(8,44),(8,4),(20,4))
        circle('knob',28,18,12)
        self.relate('connect','knob','plate')
