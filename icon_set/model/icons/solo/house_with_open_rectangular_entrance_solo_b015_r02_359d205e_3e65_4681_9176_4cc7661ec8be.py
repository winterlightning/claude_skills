"""House with open rectangular entrance interrupting the baseline. Shared roof and wall corners, mirror x24. Centerline4,8–44,40.
...
class BatchIcon(Solo48):
    icon_id='house-with-open-rectangular-entrance-solo-b015-r02'
    ...
    def build(self):
        ...
        self.add_polyline('walls',(8,21),(8,40),(17,40),(17,27),(31,27),(31,40),(40,40),(40,21));self.relate('connect','roof','walls')
