'Cyclist Above Two Open Wheels.\nSymbol plan: A round-headed cyclist bends forward with rounded arms extending to a short handlebar. One leg hangs between two detached wheel circles, with a thin fork line entering the front wheel at right.\nConstruction: Human full_body_ref.png: circular heads, coherent torso/limbs, exact 8u centerline / 4u ink head-to-neck clearance. Lucide bike: circular wheels and bent cycling pose.\nReduction: Smaller wheels leave room for the bent pedaling leg and forward fork; retain the complete rider/bicycle subject.\nKeyshape SQUARE.'
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '5d94706e-5e90-41ee-bd73-a7f28a558ba3'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_06/biking helmet person_5d94706e-5e90-41ee-bd73-a7f28a558ba3.svg'
AUTHOR = 'gpt-6'
...
class BatchIcon(Solo48):
    ...
    aliases = ()
    keywords = ('cyclist', 'bicycle', 'rider', 'wheels', 'handlebar', 'transport', 'cycling')
    def build(self):
