"""dog-c099ef25: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'c099ef25-3154-4ff5-ba1a-7e0f9f82bb67'
SOURCE_PATH = 'pictographic-primitives/pets/dog_c099ef25-3154-4ff5-ba1a-7e0f9f82bb67.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class DogC099ef25(Solo48):
    icon_id = 'dog-c099ef25'
    ...
    def build(self):
        # Plan: SQUARE; continuous muzzle and neck curves preserve the pointed ear while removing polygonal nose bumps.
