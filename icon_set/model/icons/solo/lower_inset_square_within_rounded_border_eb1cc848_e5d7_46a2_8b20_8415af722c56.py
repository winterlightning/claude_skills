"""Lower Inset Square within Rounded Border.
...
SOURCE_ICON_ID = 'eb1cc848-e5d7-46a2-8b20-8415af722c56'
SOURCE_PATH = 'pictographic-primitives/_uncategorized_35/square r_eb1cc848-e5d7-46a2-8b20-8415af722c56.svg'
AUTHOR = 'gpt-6-astra'
class AuthoredFrame(Solo48):
    icon_id = 'lower-inset-square-within-rounded-border'
