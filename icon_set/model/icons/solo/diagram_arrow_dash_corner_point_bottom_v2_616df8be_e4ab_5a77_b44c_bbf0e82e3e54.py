...
class DiagramArrowDashCornerPointBottomVariant2(Solo48):
    icon_id = 'diagram-arrow-dash-corner-point-bottom-v2'
    variant_of = 'diagram-arrow-dash-corner-point-bottom'
