...
class DinosaurSkullVariant2(Solo48):
    ...
    def build(self) -> None:
        self.add_line('snout-1', (6, 28), (6, 22))
        self.add_line('snout-2', (6, 22), (6, 12))
        self.add_line('snout-3', (6, 12), (30, 6))
