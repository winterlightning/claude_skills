"""Arrow Right with Broad Triangular Head.
...
SOURCE_ICON_ID = '98fb6655-caa9-50e9-abba-653013a3546c'
SOURCE_PATH = 'pictographic-primitives/arrows/end point triangle arrow right_98fb6655-caa9-50e9-abba-653013a3546c.svg'
AUTHOR = 'gpt-6'

class ArrowRightWithBroadTriangularHead(Solo48):
    icon_id = 'arrow-right-with-broad-triangular-head'
