'Cart with angular basket, curled support and equal open wheels.'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_polyline('basket',(12,12),(44,12),(40,24),(16,24),closed=True)
...
# Visual review: Deeper angular basket and a curled support reaching the rear wheel distinguish this from the rounded version.
