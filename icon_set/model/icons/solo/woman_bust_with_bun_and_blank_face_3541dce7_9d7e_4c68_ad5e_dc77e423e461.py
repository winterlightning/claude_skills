'Elderly Woman Profile Icon.\nPlan and review: Retained top bun, blank circular face and curved shoulders. Integrated bun into the hair silhouette; omitted ears, hair part and neckline. Enlarged the head after native review so the bun reads distinctly. Jaw center(24,22), radius12, bottom34; shoulder top38 gives zero ink gap.\nKeyshape: VRECT_L, exact SOLO48 envelope selected for this silhouette.\nConstruction reference: human_ref/user.svg: circular jaw and touching curved shoulders.'
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '3541dce7-9d7e-4c68-ad5e-dc77e423e461'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_21/grandmom_3541dce7-9d7e-4c68-ad5e-dc77e423e461.svg'
AUTHOR = 'gpt-6'
