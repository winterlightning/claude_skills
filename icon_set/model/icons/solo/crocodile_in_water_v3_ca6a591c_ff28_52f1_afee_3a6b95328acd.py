...
'Crocodile with a raised eye and extended rectangular snout above one smooth wave. HRECT_L (6,8)-(42,40) gives room for the eye and water. Back ridge removed to emphasize the head. Deliberate right-facing asymmetry.'
...
class CrocodileInWaterVariant3(Solo48):
    ...
    def build(self) -> None:
        # HRECT_L centerline bounds (6,8)-(42,40). Long jaw, raised eye, water.
        self.add_line('back', (6,20), (8,20))
        self.add_arc('brow-left', (8,20), (16,8), radius_x=8, radius_y=12)
        self.add_arc('brow-right', (16,8), (24,16), radius_x=8)
        self.add_line('snout-top', (24,16), (42,16))
        self.add_line('nose', (42,16), (42,27))
        self.add_line('jaw', (42,27), (19,27))
        self.add_contour('crocodile','back','brow-left','brow-right','snout-top','nose','jaw')
        self.add_dot('eye',(16,17))
        self.add_arc('water-left', (6,38), (24,38), radius_x=11, radius_y=2,sweep=False)
        self.add_arc('water-right', (24,38), (42,38), radius_x=11,radius_y=2,sweep=True)
