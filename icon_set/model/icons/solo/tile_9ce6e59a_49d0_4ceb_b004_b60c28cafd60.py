"""A rounded square tile is divided into four equal quadrants.
Plan: The square owns four midpoint nodes; a four-ray divider meets exactly at the center.
Keyshape: SQUARE. Exact envelope: {'ink': [4, 4, 44, 44], 'centerline': [6, 6, 42, 42]}.
Construction references: icon_set/references/lucide/original/tv.svg and atomic-debug/tv.svg: coherent contours, shared junctions, and consistent rounding; re-authored on SOLO48.
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '9ce6e59a-49d0-4ceb-b004-b60c28cafd60'
SOURCE_PATH = 'icon_set/work/todo-references/tile_9ce6e59a-49d0-4ceb-b004-b60c28cafd60.svg'
AUTHOR = 'gpt-6'
