...
SOURCE_ICON_ID = '50f4c4d3-006b-4879-8f1d-325ee5ebce0e'
SOURCE_PATH = 'icon_set/work/todo-references/penny_50f4c4d3-006b-4879-8f1d-325ee5ebce0e.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    """A penny marked with a dollar sign.
    Plan: Circular coin enclosing a smooth two-lobed dollar and aligned terminal stems.
    Reference: circle-percent: circular enclosure and central currency-style mark; dollar reconstructed independently.
    """
    icon_id = 'penny'
    ...
    def dollar(self):
        ...
        self.add_line('stem-top',(24,13),(24,16));self.relate('connect','stem-top','dollar')
        self.add_line('stem-bottom',(24,32),(24,35));self.relate('connect','stem-bottom','dollar')
