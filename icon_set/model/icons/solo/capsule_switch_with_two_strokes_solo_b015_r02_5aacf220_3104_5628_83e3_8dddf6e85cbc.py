"""Capsule with two matching short left-side marks; preserve the unusual two-stroke control. Centerline4,10–44,38.
...
class BatchIcon(Solo48):
    icon_id='capsule-switch-with-two-strokes-solo-b015-r02'
    ...
    def build(self):
        ...
        for x in (15,24):self.add_line('mark'+str(x),(x,21),(x,27))
