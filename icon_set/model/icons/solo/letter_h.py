"""The lowercase letter h, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 10, top 4, right 38, bottom 44.
Plan: An ascender and a tangent semicircular shoulder share the left spring point.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/H.svg'
AUTHOR = 'gpt-6'


class LetterH(Solo48):
    icon_id = 'letter-h'
    ...
    typeface = {'character': 'h', 'kind': 'lowercase', 'body_band': (16, 44)}
    aliases = ()
    keywords = ('h', "typeface", "typography", 'lowercase')

    def build(self):
        rotation = 0
        mirror = False
        runs = [((10,4), [('L',10,30),('L',10,44)],False), ((10,30), [('A',38,30,14,14,True),('L',38,44)],False)]
