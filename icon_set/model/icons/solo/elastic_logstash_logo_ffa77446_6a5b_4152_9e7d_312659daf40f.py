...
SOURCE_PATH = 'pictographic-primitives/logos/elastic logstash logo_ffa77446-6a5b-4152-9e7d-312659daf40f.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class ElasticLogstashLogo(Solo48):
    icon_id = 'elastic-logstash-logo'
