...
Plan: Inner radius reduced to 9 to maintain certified ink clearance. Both complete rings retained. Source stroke weight replaced by the required 4-unit stroke.
...
class Drawing(Solo48):
    icon_id = 'concentrics-circle-solo'
    ...
    def build(self):
        ...
        for name,radius in [('outer',20),('inner',9)]:
