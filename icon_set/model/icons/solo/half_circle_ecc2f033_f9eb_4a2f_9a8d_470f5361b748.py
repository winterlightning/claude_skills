"""half-circle: Concentric arch; earlier revisions preserved."""
...
class HalfCircle(Solo48):
    ...
    categories = ('symbol',)
    aliases = ()
    keywords = ('solo-ai-full-set', 'half-circle')

    def build(self):
        # Plan: Matched half-circles and straight end legs preserve a constant-width arch.
