...
class BabyBottleWithHandlesVariant3(Solo48):
    icon_id = 'baby-bottle-with-handles-v3'
    variant_of = 'baby-bottle-with-handles'
    variant_label = 'The cap should touch both sides of the bottle. Avoid any small gaps'
