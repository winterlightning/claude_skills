"""Resize Expand Scale Square.
Plan: Resize square and diagonal expansion retained; tiny control handles omitted.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/resize expand arrow_865abe34-b441-4a25-8201-1f58646b4c58.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '865abe34-b441-4a25-8201-1f58646b4c58'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/resize expand arrow_865abe34-b441-4a25-8201-1f58646b4c58.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'resize-expand-scale-square-batch-006-06'
    ...
    aliases = ()
    keywords = ('resize', 'expand', 'scale', 'square')
    ...
    def build(self):
        ...
        path('frame',(6,24),(6,6),(42,6),(42,42),(24,42))
        rect('small-square',6,24,18,18)
        path('arrowhead',(28,16),(34,16),(34,22))
        line('shaft',(24,26),(34,16))
