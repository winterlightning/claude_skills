# Variant of brick-firewall; parent file remains unchanged.
...
class BrickFirewallVariant2(Solo48):
    icon_id = 'brick-firewall-v2'
    variant_of = 'brick-firewall'
    variant_label = 'Open small counter'
    ...
    def build(self) -> None:
        ...
        tongue_points = ((14, 18), (18, 12), (20, 16), (28, 8), (28, 20), (38, 12))
