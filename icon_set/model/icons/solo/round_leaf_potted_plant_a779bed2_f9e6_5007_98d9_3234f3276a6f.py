...
class RoundLeafPottedPlant(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("central-left", (17,10), (24,6), radius_x=7, radius_y=8)
        self.add_arc("central-right", (24,6), (31,10), radius_x=7, radius_y=8)
        ...
        self.add_arc("left-lower", (24,26), (6,10), radius_x=19, radius_y=16)
        self.add_contour("left-leaf", "left-upper", "left-inner", "left-lower", closed=True)
        self.add_arc("right-lower", (42,10), (24,26), radius_x=19, radius_y=16)
        ...
        self.add_arc("bowl-right", (37,33), (24,42), radius_x=13)
        self.add_arc("bowl-left", (24,42), (11,33), radius_x=13)
