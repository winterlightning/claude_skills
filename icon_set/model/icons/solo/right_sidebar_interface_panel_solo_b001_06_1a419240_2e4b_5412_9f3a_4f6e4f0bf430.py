...
Final reduction/review: Right menu reduced from three strokes to two for wall clearance.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-001/references/sidebar line right_1a419240-2e4b-5412-9f3a-4f6e4f0bf430.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'right-sidebar-interface-panel-solo-b001-06'
    ...
    def build(self):
        ...
        for y in (18,30): s.add_line(f'menu-{y}',(32,y),(35,y))
