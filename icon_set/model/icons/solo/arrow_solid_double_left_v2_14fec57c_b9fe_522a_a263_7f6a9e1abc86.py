...
class ArrowSolidDoubleLeftVariant2(Solo48):
    icon_id = 'arrow-solid-double-left-v2'
    variant_of = 'arrow-solid-double-left'
    ...
    def build(self):
        runs = [{'start': [4, 24], 'steps': [('L', 14, 8), ('L', 23, 8), ('L', 15, 24), ('L', 23, 40), ('L', 14, 40), ('L', 4, 24)], 'closed': True}, {'start': [44, 8], 'steps': [('L', 35, 8), ('L', 25, 24), ('L', 35, 40), ('L', 44, 40), ('L', 36, 24), ('L', 44, 8)], 'closed': True}]
        rotation = 0
