"""man-cap-1: cap and wide jacket collar.
Distinct-avatar plan: preserve reference identity; use cap and wide jacket collar.
...
SOURCE_ICON_ID = 'eb3ba447-1203-44ae-af10-3e2e4eaf00ae'
SOURCE_PATH = 'pictographic-primitives/_uncategorized_26/man cap 1_eb3ba447-1203-44ae-af10-3e2e4eaf00ae.svg'
SOURCE_HEAD_ICON_ID = 'man-cap-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class ManCap1Avatar(Solo48):
    icon_id = 'man-cap-1-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('man', 'cap', '1', 'portrait', 'bust')
    def build(self):
        self.add_arc('cap',(12,16),(36,16),radius_x=12)
        self.add_polyline('brim',(8,16),(12,16),(34,16),(36,16))
