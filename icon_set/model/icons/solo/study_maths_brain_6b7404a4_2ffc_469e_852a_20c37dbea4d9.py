...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('back-neck',(42,22),((42,31),(40,32),(40,38)))
        self.add_line('neck-right',(40,38),(40,42))
        self.add_polyline('face',(10,22),(6,29),(8,30),(8,35))
        self.add_arc('chin',(8,35),(12,39),radius_x=4,sweep=False)
        self.add_polyline('neck-left',(12,39),(20,39),(20,42))
        ...
        self.cross('plus',22,18,2)
        self.add_line('minus',(16,29),(20,29))
        self.cross('times',30,28,2,True)
