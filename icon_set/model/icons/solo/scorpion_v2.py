...
'A scorpion with four shorter legs and curved pincer jaws. SQUARE extremes (6,6)-(42,42) preserve the claws and curled tail. Lucide bug informs mirrored appendages and consistent paired curves. Leg extensions are shortened; the tail remains deliberately left-curled.'
...
class ScorpionVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('jaw-l-inner', (14, 6), (8, 7), radius_x=6, radius_y=5, sweep=False)
        self.add_arc('jaw-l-outer', (8, 7), (6, 6), radius_x=6, radius_y=5, sweep=False)
        ...
        self.add_arc('jaw-r-inner', (34, 6), (40, 7), radius_x=6, radius_y=5, sweep=True)
        self.add_arc('jaw-r-outer', (40, 7), (42, 6), radius_x=6, radius_y=5, sweep=True)
