"""Upright phone with attached vertical earpiece and home bar; enlarged lower bezel to preserve both seam and control.
...
SOURCE_ICON_ID = '11dc98cc-8ce7-4d7d-859a-a6914439a9c9'
SOURCE_PATH = 'pictographic-primitives/phones/mobile phone_11dc98cc-8ce7-4d7d-859a-a6914439a9c9.svg'
AUTHOR = 'gpt-6'
...
class SmartphoneWithHomeBar(Solo48):
    ...
    def build(self):
        ...
        box(8,4,40,44,ys=(26,),xs=(24,))
        seam('lower-bezel',(8,26),(40,26))
        line('home-bar',(21,35),(27,35))
        line('earpiece',(24,4),(24,10))
        self.relate('connect','earpiece','body')
