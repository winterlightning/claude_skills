...
class LabProtectionGlasses(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e6', (44, 31), (44, 32), radius_x=34, sweep=False)
        self.add_line('sym-e7', (44, 32), (42, 37))
        self.add_line('sym-e8', (42, 37), (40, 38))
        self.add_line('sym-e9', (40, 38), (33, 40))
        self.add_arc('sym-e10', (33, 40), (32, 40), radius_x=34, sweep=False)
        self.add_arc('sym-e11', (32, 40), (29, 36), radius_x=6)
        self.add_line('sym-e12', (29, 36), (27, 31))
        self.add_arc('sym-e13', (27, 31), (24, 30), radius_x=2, sweep=False)
        self.add_arc('sym-e14', (24, 30), (21, 31), radius_x=2, sweep=False)
        self.add_line('sym-e15', (21, 31), (19, 36))
        self.add_arc('sym-e16', (19, 36), (16, 40), radius_x=5)
        self.add_arc('sym-e17', (16, 40), (15, 40), radius_x=23, sweep=False)
        self.add_line('sym-e18', (15, 40), (8, 38))
        self.add_arc('sym-e19', (8, 38), (6, 37), radius_x=3)
        self.add_arc('sym-e20', (6, 37), (4, 32), radius_x=8)
        self.add_line('sym-e21', (4, 32), (4, 31))
        self.add_line('sym-e22', (4, 31), (4, 25))
        self.add_arc('sym-e23', (4, 25), (5, 22), radius_x=9)
        ...
        self.add_arc('sym-e28', (31, 10), (34, 8), radius_x=5)
        self.add_arc('sym-e30', (34, 8), (39, 13), radius_x=8)
        self.add_line('sym-e31', (39, 13), (43, 22))
        self.add_line('sym-e32', (17, 10), (14, 8))
        self.add_arc('sym-e34', (14, 8), (9, 13), radius_x=8, sweep=False)
        ...
        self.add_contour('sym-c1', 'sym-e28', 'sym-e30', 'sym-e31')
        self.add_contour('sym-c2', 'sym-e32', 'sym-e34', 'sym-e35')
