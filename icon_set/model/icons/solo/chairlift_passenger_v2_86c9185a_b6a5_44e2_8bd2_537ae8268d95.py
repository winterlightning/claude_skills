# Variant of chairlift-passenger; parent file remains unchanged.
...
class ChairliftPassengerVariant2(Solo48):
    icon_id = 'chairlift-passenger-v2'
    variant_of = 'chairlift-passenger'
