...
Open-seat armchair with rounded high back, curved seat line and angled slim legs. Centerline extremes (6,6)-(42,42). Lucide armchair informs round arm caps and continuous frame. Mirror both sides; remove extra cushion border.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '71c8356b-e0c6-5ca9-9ff5-19f12704410c'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/furnitures/armchair 1_71c8356b-e0c6-5ca9-9ff5-19f12704410c.svg'
AUTHOR = 'gpt-6'

class ArmchairOpenSeatFront(Solo48):
    icon_id = 'armchair-open-seat-front'
    ...
    def build(self):
        # Symbol plan: Open-seat armchair with rounded high back, curved seat line and angled slim legs. Centerline extremes (6,6)-(42,42). Lucide armchair informs round arm caps and continuous frame. Mirror both sides; remove extra cushion border.
        ...
        back_radius=4;arm_y=22;seat_y=28;bottom=36;inner=16 if False else 14;other=48-inner
