...
class CrouchingWindsurfer(Solo48):
    ...
    def build(self):
        self.add_arc('sail-edge', (25, 6), (8, 27), radius_x=36, radius_y=36, large_arc=False, sweep=False)
        self.add_line('sail-base-1', (8, 27), (20, 27))
        self.add_line('sail-base-2', (20, 27), (21, 25))
        self.add_line('sail-base-3', (21, 25), (25, 6))
        self.add_line('mast', (20, 27), (18, 38))
