"""A magnifier contains a centered plus sign.
...
SOURCE_ICON_ID='d4c62eb9-8ceb-4689-a05a-b7833b5be21f'
SOURCE_PATH='icon_set/work/todo-references/magnifying glass cross_d4c62eb9-8ceb-4689-a05a-b7833b5be21f.svg'
AUTHOR='gpt-6'
class Drawing(Solo48):
    icon_id='magnifying-glass-cross'
    keyshape=Keyshape.SQUARE
    semantic_role='MAIN'
    semantic_kind='noun'
    category = 'primitives-generate'
    aliases=()
    keywords=('magnifying', 'glass', 'cross')
...
# Final review record: Plus sign centered with even bar lengths and an open margin to lens.
