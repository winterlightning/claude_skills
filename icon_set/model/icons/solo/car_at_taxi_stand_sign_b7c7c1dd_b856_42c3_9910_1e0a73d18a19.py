...
class CarAtTaxiStandSign(Solo48):
    ...
    def build(self) -> None:
        ...
        # A physical station scene: signpost and car share one ground line.
        self.add_polyline('sign',(6,6),(14,6),(14,18),(10,18),(6,18),closed=True)
        self.add_line('post',(10,18),(10,42))
        self.add_polyline('car',(22,28),(26,18),(38,18),(42,28),(42,36),(38,36),(26,36),(22,36),closed=True)
        self.add_line('windscreen',(22,28),(42,28))
        self.add_line('tyre-left',(26,36),(26,42))
        self.add_line('tyre-right',(38,36),(38,42))
