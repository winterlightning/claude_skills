...
class FishOutline(Solo48):
    ...
    def build(self) -> None:
        self.add_line('tail-top', (4,8), (14,17))
        self.add_arc('back-left', (14,17), (24,8), radius_x=10, radius_y=9)
        self.add_arc('back-right', (24,8), (44,24), radius_x=25, radius_y=40)
        self.add_arc('belly-right', (44,24), (24,40), radius_x=25, radius_y=40)
        self.add_arc('belly-left', (24,40), (14,31), radius_x=10, radius_y=9)
        self.add_line('tail-bottom-1', (14,31), (4,40))
        self.add_line('tail-bottom-2', (4,40), (7,24))
        self.add_line('tail-bottom-3', (7,24), (4,8))
