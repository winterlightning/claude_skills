...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('shoulders',(15,33),(33,33),radius_x=9,radius_y=2)

KEYSHAPE_REASON='The complete composition uses centerline extremes (6,6)–(42,42).'
FINAL_REDUCTIONS='Compact head and shallow shoulders fit the frame. Head bottom23 to shoulder apex31 gives exactly 4 ink units.'
