"""A front-facing monk has a smooth bald head, prominent ears and a blank face. A broad robe crosses the chest diagonally, with a second curved fold descending along the right shoulder.
Symbol plan: Bald circular head, broad curved shoulders and one sweeping diagonal robe fold. Shared head radius 8 at (24,12); shoulder top24 gives zero ink gap. Omit ears and the secondary narrow fold.
...
SOURCE_ICON_ID = 'c1580be8-826f-5ac1-a563-b9d01531fe17'
SOURCE_PATH = 'pictographic-primitives/avatars/mahayana monk_c1580be8-826f-5ac1-a563-b9d01531fe17.svg'
SOURCE_CATEGORY = 'avatars'
AUTHOR = 'gpt-6'

class BatchSolo(Solo48):
    icon_id = 'monk-with-diagonal-robe-fold'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'avatars'
    aliases = ()
    keywords = ('monk', 'with', 'diagonal', 'robe', 'fold')
