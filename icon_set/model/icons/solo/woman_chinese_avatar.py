"""woman-chinese: blouse fastening with reference head silhouette.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-14/references/woman-chinese.svg'
...
class WomanChineseAvatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('woman', 'chinese', 'portrait', 'bust')
    def build(self):
