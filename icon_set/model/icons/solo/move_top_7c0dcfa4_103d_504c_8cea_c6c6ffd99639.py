...
class MoveTop(Solo48):
    ...
    def build(self):
        ...
        self.add_line('sym-e4', (8, 36), (8, 35))
        self.add_arc('sym-e5', (8, 35), (11, 32), radius_x=3)
        self.add_line('sym-e6', (11, 32), (24, 32))
        self.add_line('sym-e7', (24, 32), (37, 32))
        self.add_arc('sym-e8', (37, 32), (40, 35), radius_x=3)
        self.add_line('sym-e9', (40, 35), (40, 36))
        self.add_line('sym-e10', (40, 36), (40, 41))
        self.add_arc('sym-e11', (40, 41), (37, 44), radius_x=3)
        self.add_line('sym-e12', (37, 44), (24, 44))
        self.add_line('sym-e13', (24, 44), (11, 44))
        self.add_arc('sym-e14', (11, 44), (8, 41), radius_x=3)
