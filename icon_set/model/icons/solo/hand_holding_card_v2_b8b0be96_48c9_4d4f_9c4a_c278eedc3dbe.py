...
class HandHoldingCardVariant2(Solo48):
    icon_id = 'hand-holding-card-v2'
    ...
    def build(self):
        ...
        self.add_arc('finger-curl', (34, 14), (42, 22), radius_x=8)
        self.add_arc('finger-curl-lower', (42, 22), (34, 30), radius_x=8)
        ...
        self.add_contour('grip', 'finger-tip', 'finger-inner', 'finger-curl', 'finger-curl-lower', 'finger-return', 'thumb-tip-upper', 'thumb-tip-lower', 'thumb-lower')
        self.add_line('hand-outside-1', (42,18), (42,22))
        self.add_line('hand-outside-2', (42,22), (42,42))
        self.add_arc('knuckle', (38, 6), (42, 18), radius_x=4, radius_y=12)
        self.add_contour('back', 'finger-tip-top', 'knuckle', 'hand-outside-1', 'hand-outside-2')
