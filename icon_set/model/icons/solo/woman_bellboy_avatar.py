"""woman-bellboy: uniform fastening with reference head silhouette.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-13/references/woman-bellboy.svg'
SOURCE_HEAD_ICON_ID = 'woman-bellboy'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 24
class WomanBellboyAvatar(Solo48):
    icon_id = 'woman-bellboy-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('woman', 'bellboy', 'portrait', 'bust')
    def build(self):
