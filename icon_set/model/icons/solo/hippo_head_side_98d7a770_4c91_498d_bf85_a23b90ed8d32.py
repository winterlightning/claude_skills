...
class HippoHeadOpenMouth(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('head-13', (37, 38), (42, 38))
        self.add_line('head-14', (42, 38), (42, 32))
        ...
        self.add_arc('lower-jaw-1', (42, 38), (41, 42), radius_x=5, radius_y=5, sweep=True)
        self.add_line('lower-jaw-2', (41, 42), (25, 41))
        self.add_line('lower-jaw-3', (25, 41), (22, 42))
