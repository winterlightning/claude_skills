...
class GenieOilLampVariant2(Solo48):
    icon_id = 'genie-oil-lamp-v2'
    variant_of = 'genie-oil-lamp'
    ...
    def build(self) -> None:
        ...
        self.add_line('spout-top', (32, 20), (44, 14))
        self.add_arc('spout-underside', (44, 14), (24, 32), radius_x=30)
        ...
        self.add_arc('handle', (12, 20), (12, 32), radius_x=8, radius_y=6, sweep=False)
