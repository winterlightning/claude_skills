...
class CactusInRoundedPot(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("left-arm-outer", (18,21), (6,8), radius_x=13)
        self.add_arc("left-arm-cap", (6,8), (11,8), radius_x=3)
        ...
        self.add_arc("right-arm-cap", (37,11), (42,11), radius_x=3)
        self.add_arc("right-arm-outer", (42,11), (30,24), radius_x=13)
