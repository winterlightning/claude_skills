"""Short Haired Woman Avatar. Avatar with circular jaw and smooth shoulder arcs. Body top32 = jaw bottom28 + HEAD_BODY_CENTERLINE_GAP; zero visible head/body gap.
...
PARENT_MODULE = 'icon_set/model/icons/solo/person_with_short_bob_3daffd35_7113_5e05_9b42_ebb7b4db0338.py'

class Drawing(Solo48):
    icon_id = 'person-with-short-bob'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('person', 'with', 'short', 'bob')
