...
Plan: Diagonal physical diode with cathode band and coaxial leads.
Construction reference: Lucide cable; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/crystal diode_df3cec3b-cd40-4110-be54-9f249b9ee747.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'df3cec3b-cd40-4110-be54-9f249b9ee747'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/crystal diode_df3cec3b-cd40-4110-be54-9f249b9ee747.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'electronic-diode-component-batch-007-08'
    ...
    def build(self):
        ...
        path('body',(13,23),(25,11),(37,23),(25,35),closed=True)
        line('band',(19,17),(31,29))
        line('lead-left',(6,42),(19,29))
        line('lead-right',(31,17),(42,6))
