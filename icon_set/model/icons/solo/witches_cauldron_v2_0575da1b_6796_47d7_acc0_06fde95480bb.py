# Variant of witches-cauldron; parent file remains unchanged.
"""Witches cauldron with both steam strokes joined to the rim. SQUARE retains the broad bowl and feet; Lucide cooking-pot informs rim contacts."""
...
class WitchesCauldronVariant2(Solo48):
    icon_id = 'witches-cauldron-v2'
    variant_of = 'witches-cauldron'
    variant_label = 'Steam meets rim'
    ...
    def build(self) -> None:
        ...
        for side, x in (('left', 17), ('right', 31)):
            ...
            self.add_line(side + '-steam-stem', (x - 6, 8), (x - 6, 20))
