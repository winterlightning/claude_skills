...
class LayoutTop(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e5', (8, 42), (6, 40), radius_x=4)
        self.add_line('sym-e6', (6, 40), (6, 16))
        self.add_line('sym-e7', (6, 16), (6, 8))
        self.add_arc('sym-e9', (6, 8), (8, 6), radius_x=4)
        self.add_line('sym-e11', (8, 6), (24, 6))
        self.add_line('sym-e12', (24, 6), (40, 6))
        self.add_arc('sym-e14', (40, 6), (42, 8), radius_x=4)
        self.add_line('sym-e16', (42, 8), (42, 16))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e9', 'sym-e11', 'sym-e12', 'sym-e14', 'sym-e16')
