...
class TrashCan(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (13, 41), (16, 44), radius_x=5, sweep=False)
        self.add_line('sym-e3', (16, 44), (24, 44))
        self.add_line('sym-e4', (24, 44), (32, 44))
        self.add_arc('sym-e5', (32, 44), (35, 41), radius_x=4, sweep=False)
        self.add_line('sym-e6', (35, 41), (37, 18))
        self.add_line('sym-e7', (37, 18), (24, 18))
        self.add_line('sym-e8', (9, 18), (11, 18))
        self.add_arc('sym-e9', (9, 18), (8, 18), radius_x=10, sweep=False)
        ...
        self.add_arc('sym-e14', (18, 7), (20, 4), radius_x=4)
        self.add_line('sym-e15', (20, 4), (24, 4))
        self.add_line('sym-e16', (24, 4), (28, 4))
        self.add_arc('sym-e17', (28, 4), (30, 7), radius_x=3)
        ...
        self.add_arc('sym-e22', (40, 18), (39, 18), radius_x=53, sweep=False)
