...
class Delay(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e3', (27, 40), (30, 40), radius_x=15)
        self.add_arc('sym-e4', (30, 40), (44, 25), radius_x=17, sweep=False)
        self.add_line('sym-e5', (44, 25), (44, 24))
        self.add_arc('sym-e6', (44, 24), (44, 23), radius_x=28)
        self.add_arc('sym-e7', (44, 23), (30, 8), radius_x=17, sweep=False)
        self.add_arc('sym-e8', (30, 8), (27, 8), radius_x=15)
