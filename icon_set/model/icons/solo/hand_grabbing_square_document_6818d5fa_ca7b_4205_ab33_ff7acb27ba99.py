...
DESIGN_NOTES = 'Reduce individual finger creases to two broad knuckles and a curved palm; keep the grip at lower right.'
...
class Drawing(Solo48):
    ...
    variant_label = 'Hand Grabbing Square Document'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'interface-essential'
    aliases = ()
    keywords = ('hand', 'grabbing', 'square', 'document', 'closed', 'gripping')
    def build(self):
        # Plan: A closed hand gripping the lower-right of a blank rounded rectangular document.
        # SQUARE: exact SOLO48 envelope; repeated parts share coordinates.
        # Reduction: Reduce individual finger creases to two broad knuckles and a curved palm; keep the grip at lower right.
        ...
        p('paper',(6,34),(6,6),(34,6))
        p('fingers',(22,30),(14,22),(20,16),(26,22),(32,14),(42,28))
        a('palm',(42,28),(28,42),14)
        p('lower',(28,42),(18,38),(14,34),(18,30))
