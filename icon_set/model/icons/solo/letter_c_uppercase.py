"""Uppercase C for SOLO48; centerline envelope (10, 4)–(38, 44).
Plan: Open elliptical bowl with mirrored terminals and tangent quarter arcs.
...
class LetterCUppercase(Solo48):
    icon_id = 'letter-c-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    typeface = {'character': 'C', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('C', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((38,12),[('A',24,4,14,8,False),('A',10,24,14,20,False),('A',24,44,14,20,False),('A',38,36,14,8,False)],False)]
