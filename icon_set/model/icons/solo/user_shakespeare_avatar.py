"""user-shakespeare: rounded doublet collar with reference head silhouette.
...
Body cue: rounded doublet collar. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-shakespeare.svg'
SOURCE_HEAD_ICON_ID = 'user-shakespeare'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserShakespeareAvatar(Solo48):
    icon_id = 'user-shakespeare-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'shakespeare', 'portrait', 'bust')
    def build(self):
        ...
        for side,sign in [('left',-1),('right',1)]:
            self.add_bezier('hair-'+side,(24+sign*12,16),((24+sign*12,20),(24+sign*16,22),(24+sign*16,24)))
