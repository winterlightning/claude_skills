"""A round smartwatch bearing a euro currency mark.
Symbol plan: watch: round case and paired straps; euro: open bowl and horizontal currency stroke.
...
Reduction: Second euro bar omitted because the supplied reference has one visible bar.
"""
