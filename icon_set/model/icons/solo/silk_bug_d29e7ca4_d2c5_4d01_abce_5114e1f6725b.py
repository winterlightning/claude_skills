...
class DomedBeetle(Solo48):
    ...
    def build(self) -> None:
        # Square extremes (6,6)-(42,42); paired legs around x=24.
        ...
        self.add_arc('base-r', (36, 34), (24, 42), radius_x=12, radius_y=12, sweep=True)
        self.add_arc('base-l', (24, 42), (12, 34), radius_x=12, radius_y=12, sweep=True)
