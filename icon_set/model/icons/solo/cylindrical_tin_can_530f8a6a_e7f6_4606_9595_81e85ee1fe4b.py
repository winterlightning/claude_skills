...
SOURCE_ICON_ID = '530f8a6a-e7f6-4606-9595-81e85ee1fe4b'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/container/can 1_530f8a6a-e7f6-4606-9595-81e85ee1fe4b.svg'
AUTHOR = "gpt-6"

class Batch02Icon6(Solo48):
    icon_id = 'cylindrical-tin-can-530f8a6a'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/can"
