...
class UnequalBalanceScale(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline('left-suspension', (4, 24), (10, 10), (16, 24), closed=False)
        self.add_arc('left-pan', (16, 24), (4, 24), radius_x=6, radius_y=6, sweep=True, large_arc=False)
        self.relate('connect', 'left-suspension', 'left-pan')
        self.relate('connect', 'left-suspension', 'beam')
        self.add_polyline('right-suspension', (32, 30), (38, 16), (44, 30), closed=False)
        self.add_arc('right-pan', (44, 30), (32, 30), radius_x=6, radius_y=6, sweep=True, large_arc=False)
