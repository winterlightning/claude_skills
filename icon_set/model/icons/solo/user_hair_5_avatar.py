"""user-hair-5: broad swept fringe and plain shirt.
Distinct-avatar plan: preserve reference identity; use broad swept fringe and plain shirt.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-10/references/user-hair-5.svg'
SOURCE_HEAD_ICON_ID = 'user-hair-5'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserHair5Avatar(Solo48):
    icon_id = 'user-hair-5-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'hair', '5', 'portrait', 'bust')
    def build(self):
