...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_28/objects align top_19c4c5fb-b9bd-4623-9622-444b3ad9da42.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        rect('bar-a',8,4,32,8,4);rect('bar-b',18,24,22,8,4);line('bottom',(8,44),(40,44))
