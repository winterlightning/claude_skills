...
Plan: Storage box and lid, lid thickness eight centerline units; shared boundary.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Storage box and lid, lid thickness eight centerline units; shared boundary.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-004/references/archive box_1a461e83-5b52-4307-94e7-188e590f4dff.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'storage-box-with-lid-solo-b004-08'
    ...
    def build(self):
        s = self
        box(s,'lid',6,6,42,14,2,nodes=((10,14),(38,14)))
        s.add_line('body-side',(10,14),(10,36))
        s.add_arc('corner-left',(10,36),(16,42),radius_x=6,sweep=False)
        s.add_line('bottom',(16,42),(32,42))
        s.add_arc('corner-right',(32,42),(38,36),radius_x=6,sweep=False)
        s.add_line('right',(38,36),(38,14))
        s.add_contour('box','body-side','corner-left','bottom','corner-right','right');join(s,'lid','box')
