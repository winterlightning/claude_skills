...
Plan: Full central card with cropped neighboring cards; vertical symmetry.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/carousel verticle_fd123a87-322b-50ad-9447-472f0b3cc03a.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'fd123a87-322b-50ad-9447-472f0b3cc03a'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/carousel verticle_fd123a87-322b-50ad-9447-472f0b3cc03a.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'vertical-card-carousel-batch-006-08'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/batch-006"
    aliases = ()
    keywords = ('vertical', 'card', 'carousel')
    ...
    def build(self):
        ...
        rect('active-card',8,16,32,16,3)
        path('previous',(12,4),(12,8),(36,8),(36,4))
        path('next',(12,44),(12,40),(36,40),(36,44))
