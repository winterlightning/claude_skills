"""Chip (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
...
class ChipSymbol(Solo48):
    ...
    def build(self):
        ...
        self.add_line('e12-1', (35, 28), (34, 34))
        self.add_line('e12-2', (34, 34), (32, 35))
        self.add_arc('e13', (17, 35), (13, 32), radius_x=4)
        self.add_arc('e14', (13, 20), (17, 13), radius_x=6)
        self.add_line('e15', (32, 13), (35, 16))
        ...
        self.add_contour('c8', 'e12-1', 'e12-2', 'e8', 'e13', 'e9', 'e14', 'e10', 'e15', 'e11', closed=True)
