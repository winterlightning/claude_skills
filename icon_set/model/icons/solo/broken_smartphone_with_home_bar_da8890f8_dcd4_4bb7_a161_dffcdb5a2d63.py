"""Phone snapped into two jagged pieces with a home bar; impact strokes and redundant bezel omitted."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'da8890f8-dcd4-4bb7-a161-dffcdb5a2d63'
SOURCE_PATH = 'pictographic-primitives/phones/phone broken 1_da8890f8-dcd4-4bb7-a161-dffcdb5a2d63.svg'
AUTHOR = 'gpt-6'

class BrokenSmartphoneWithHomeBar(Solo48):
    icon_id = 'broken-smartphone-with-home-bar'
    ...
    def build(self):
        ...
        segments('lower-break',(8,40),(8,27),(20,27),(28,23),(40,27),(40,40))
        arc('br',(40,40),(36,44),4);line('bottom',(36,44),(12,44));arc('bl',(12,44),(8,40),4)
        self.add_contour('lower',*[f'lower-break-{i}' for i in range(1,6)],'br','bottom','bl',closed=True)
        line('home-bar',(22,35),(28,35))
