"""Reconstruct skipping athlete crossed leg using its inspected source pose and full_body_ref.png. Head radius 4, center (24, 10), actual torso junction (24, 22): squared distance 144, centerline clearance8 and painted clearance4. Upper torso tangent follows that axis; preserve the subject's limb action and equipment. Shared Lucide person-standing joints; updated approaching-ball example informs head/body balance.
...
class SkippingAthleteCrossedLeg(Solo48):
    ...
    def build(self):
        ...
        self.add_line('left-leg-0', (24, 27), (30, 33))
        self.add_line('right-leg-0', (24, 27), (17, 33))
        self.add_line('right-leg-1', (17, 33), (20, 34))
