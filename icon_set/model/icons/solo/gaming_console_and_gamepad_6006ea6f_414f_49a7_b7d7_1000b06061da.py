...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/icon_set/.local/work/solo-saved-briefs-20260920/batch-folders/batch-022/references/09-6006ea6f-414f-49a7-b7d7-1000b06061da.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        path('console',(x(14),42),[('L',(x(6),42)),('L',(x(6),10)),('A',(x(10),6),4,4,False),('L',(x(29),6)),('A',(x(33),10),4,4,False),('L',(x(33),20))])
        path('pad',(x(14),42),[('L',(x(14),29)),('A',(x(23),20),9,9,False),('L',(x(33),20)),('A',(x(42),29),9,9,False),('L',(x(42),42)),('L',(x(33),38)),('L',(x(23),38)),('L',(x(14),42))],True);join('console','pad')
