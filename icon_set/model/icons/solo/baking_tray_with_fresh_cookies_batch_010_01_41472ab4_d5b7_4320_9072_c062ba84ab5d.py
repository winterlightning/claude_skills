...
Plan: Open oven, one heat wisp and two cookies; tray and oven join at shared corners.
Construction reference: Lucide soup; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-010/references/cooking baking tray oven_41472ab4-d5b7-4320-9072-c062ba84ab5d.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '41472ab4-d5b7-4320-9072-c062ba84ab5d'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/food/cooking baking tray oven_41472ab4-d5b7-4320-9072-c062ba84ab5d.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    ...
    def build(self):
        ...
        path('oven',(6,20),(6,6),(12,6))
        path('oven-right',(36,6),(42,6),(42,20))
        curve('heat',(24,6),((20,8),(28,10),(24,12)))
        rect('tray',6,20,36,22)
        for x in (17,31): circle(f'cookie-{x}',x,31,2)
