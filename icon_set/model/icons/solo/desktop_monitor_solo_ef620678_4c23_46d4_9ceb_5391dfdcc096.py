...
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/other/self payment computer yuan_ef620678-4c23-46d4-9ceb-5391dfdcc096.svg'
AUTHOR = 'gpt-6'


class SourceMain(Solo48):
    icon_id = 'desktop-monitor-solo-ef620678'
