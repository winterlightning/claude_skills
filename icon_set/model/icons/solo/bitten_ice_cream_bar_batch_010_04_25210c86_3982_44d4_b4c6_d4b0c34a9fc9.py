...
Plan: Large round bite and wooden stick; single smooth rounded crown.
Construction reference: Lucide ice-cream-bowl; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-010/references/ice cream bite_25210c86-3982-44d4-b4c6-d4b0c34a9fc9.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '25210c86-3982-44d4-b4c6-d4b0c34a9fc9'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/food/ice cream bite_25210c86-3982-44d4-b4c6-d4b0c34a9fc9.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'bitten-ice-cream-bar-batch-010-04'
    ...
    def build(self):
        ...
        arc('top-left',(10,18),(24,4),14)
        line('top',(24,4),(28,4))
        arc('bite',(28,4),(38,14),10,10,False)
        path('bar',(38,14),(38,32),(10,32),(10,18))
        path('stick',(20,32),(20,40))
        arc('stick-end',(20,40),(28,40),4,4,False)
        line('stick-right',(28,40),(28,32))
