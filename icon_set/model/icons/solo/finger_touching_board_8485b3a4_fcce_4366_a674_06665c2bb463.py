# Refinement: Shorten the unused left board edge to clear the thumb.
# Repair: Broaden the bent thumb while retaining the fingertip and board.
...
class FingerTouchingBoard(Solo48):
    ...
    def build(self):
        ...
        poly('board', (6, 12), (6, 6), (42, 6), (42, 18))
        arc('finger-tip', (24, 19), (32, 19), 4)
        chain('hand-right', (32, 19), (32, 28), (40, 30), (40, 42))
        chain('hand-left', (24, 42), (10, 29), (12, 20), (24, 27), (24, 19))
