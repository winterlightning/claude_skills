"""Diagonal DNA Helix with Three Rungs.

Symbol plan: Two tangent cubic strands share two crossing nodes and three perpendicular rungs. One repeated central strand definition preserves the paired shape.
...
SOURCE_ICON_ID = '96b3f4b9-d902-4960-bd63-d93a8261706c'
SOURCE_PATH = 'pictographic-primitives/artificial-intelligence/dna_96b3f4b9-d902-4960-bd63-d93a8261706c.svg'
AUTHOR = 'gpt-6'


class DiagonalDnaHelixWithThreeRungs(Solo48):
    icon_id = 'diagonal-dna-helix-with-three-rungs'
    ...
    def build(self):
        ...
        for n,a,z in [('bottom',(6,30),(18,42)),('middle',(18,18),(30,30)),('top',(30,6),(42,18))]:
