"""The lowercase letter s, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 6, top 6, right 42, bottom 42.
Plan: Two opposed half-elliptical lobes meet smoothly at the waist; rotational symmetry.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/S.svg'
AUTHOR = 'gpt-6'
...
class LetterS(Solo48):
    ...
    typeface = {'character': 's', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('s', "typeface", "typography", 'lowercase')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((42,15), [('A',24,6,18,9,False),('A',6,15,18,9,False),('A',24,24,18,9,False),('A',42,33,18,9,True),('A',24,42,18,9,True),('A',6,33,18,9,True)],False)]
