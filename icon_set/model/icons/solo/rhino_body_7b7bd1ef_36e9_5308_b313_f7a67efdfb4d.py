...
class StandingRhino(Solo48):
    ...
    def build(self) -> None:
        self.add_line('silhouette-1', (6, 40), (6, 22))
        self.add_arc('silhouette-2', (6, 22), (14, 10), radius_x=12, radius_y=12, sweep=True)
        ...
        self.add_line('silhouette-7', (39, 20), (42, 12))
        self.add_line('silhouette-8', (42, 12), (42, 26))
        self.add_arc('silhouette-9', (42, 26), (40, 32), radius_x=6, radius_y=6, sweep=True)
        ...
        self.add_line('silhouette-16', (8, 40), (6, 40))
