"""pregnancy-ultrasound: reconstructed stroke graph on SOLO48."""
...
class PregnancyUltrasound(Solo48):
    icon_id = 'pregnancy-ultrasound'
    ...
    def build(self):
        # Plan: HRECT_L; mirrored scan sector with smooth centered upper and lower arcs.
