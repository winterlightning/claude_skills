# Variant of beetle-in-coiled-shell-v2; parent file remains unchanged.
...
class BeetleInCoiledShellVariant3(Solo48):
    icon_id = 'beetle-in-coiled-shell-v3'
    variant_of = 'beetle-in-coiled-shell-v2'
