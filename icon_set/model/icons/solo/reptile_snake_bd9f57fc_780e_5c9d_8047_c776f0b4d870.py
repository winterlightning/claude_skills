"""Open spiral snake with a broad right-hand head; eye dots omitted to preserve space. Centerline extremes (6,6)-(42,42), natural asymmetric coil."""
...
class CoiledSnake(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('snake-6', (40, 40), (34, 42), radius_x=6, radius_y=6, sweep=True)
        self.add_arc('snake-7', (34, 42), (28, 40), radius_x=6, radius_y=6, sweep=True)
