...
SOURCE_PATH = 'pictographic-primitives/interface-essential/house_51e8bb01-0f35-5ff5-85f3-672839327e85.svg'
AUTHOR = 'gpt-6'

class House51e8bb01(Solo48):
    icon_id = 'house-51e8bb01'
    ...
    def build(self):
        ...
        self.add_line('sym-e8', (42, 42), (19, 42))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', closed=False)
