"""An upright sheet with a folded upper-right corner. Its outline reaches VRECT_L bounds (8,4)-(40,44); fold-crease legs share the document boundary.
Construction references: Lucide file original and atomic-debug: folded sheet silhouette with shared crease endpoints."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '2ebe2458-fdb8-4aeb-ae7a-69f9e0936ed4'
SOURCE_PATH = 'icon_set/work/todo-references/file 1_2ebe2458-fdb8-4aeb-ae7a-69f9e0936ed4.svg'
AUTHOR = "gpt-6"
