"""Geometric Shapes In Rounded Square.
Plan: Circle, square and triangle retained; square and triangle meet the frame, opening the internal spacing.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/shapes_610733a3-dfd5-42df-9651-d396d039493b.svg
"""
...
class GeneratedSolo(Solo48):
    ...
    def build(self):
        ...
        rect('frame',6,6,36,36,3)
        rect('square',6,24,10,10)
        circle('circle',30,18,3)
        path('triangle',(29,30),(38,42),(20,42),closed=True)
