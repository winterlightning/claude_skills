...
class PersonWithLongStraightHair(Solo48):
    ...
    def build(self):
        path(self,'hair',(8,27),('L',(8,20)),('A',(24,4),16,16,True),('A',(40,20),16,16,True),('L',(40,27)))
        path(self,'fringe',(17,22),('B',(22, 15),(19,21),(21,18)),('B',(31,22),(24,18),(28,21)))
