...
SOURCE_ICON_ID = '714605ab-9a21-4e2c-89fe-40c1921cee48'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/design drawing board_714605ab-9a21-4e2c-89fe-40c1921cee48.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'blank-board-on-easel'
DESIGN_NOTES = 'Lower support rail merges with the board lower edge; retain clamp and three legs.'
CONSTRUCTION_REFERENCE = 'Lucide presentation original and atomic-debug; coherent contours and shared attachment nodes.'

class Drawing(Solo48):
    icon_id = 'drawing-board-on-tripod-easel'
    variant_of = 'blank-board-on-easel'
    variant_label = 'Drawing Board on Tripod Easel'
    ...
    aliases = ()
    keywords = ('drawing', 'board', 'tripod', 'easel', 'clip', 'support', 'mounted', 'splayed')
    def build(self):
        # Plan: A rounded rectangular drawing board with a small top clip and long lower support, mounted on three splayed legs.
        # VRECT_L: exact SOLO48 envelope; repeated parts share coordinates.
        # Reduction: Lower support rail merges with the board lower edge; retain clamp and three legs.
