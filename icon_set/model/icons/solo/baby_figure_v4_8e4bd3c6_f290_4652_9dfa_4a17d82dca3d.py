# Variant of baby-figure-v3; parent file remains unchanged.
...
class BabyFigureVariant4(Solo48):
    icon_id = 'baby-figure-v4'
    variant_of = 'baby-figure-v3'
    variant_label = 'Open legs with clear diaper spacing'
    ...
    def build(self) -> None:
        ...
        self.add_line('shoulders', (17, 25), (31, 25))
        self.add_polyline('arm-left', (17, 25), (8, 25), (8, 33))
        self.add_polyline('arm-right', (31, 25), (40, 25), (40, 33))
        self.add_line('waist-left', (17, 25), (16, 37))
        self.add_line('waist-right', (31, 25), (32, 37))
        self.add_line('diaper-band', (16, 37), (32, 37))
        self.add_arc('diaper', (16, 37), (32, 37), radius_x=8, radius_y=7, sweep=False, large_arc=False)
        self.add_line('leg-left', (16, 37), (8, 42))
        self.add_line('leg-right', (32, 37), (40, 42))
