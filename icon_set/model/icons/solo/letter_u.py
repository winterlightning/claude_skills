"""The lowercase letter u, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 6, top 6, right 42, bottom 42.
Plan: A semicircular lower bowl and equal vertical stems mirror the n construction.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/U.svg'
AUTHOR = 'gpt-6'


class LetterU(Solo48):
    icon_id = 'letter-u'
    ...
    typeface = {'character': 'u', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('u', "typeface", "typography", 'lowercase')

    def build(self):
        rotation = 0
        mirror = False
        rotation=2
        runs=[((6,42), [('L',6,24),('A',42,24,18,18,True),('L',42,42)],False)]
