"""scientist-man-1: lab coat fronts.
Distinct-avatar plan: preserve reference identity; use lab coat fronts.
...
SOURCE_PATH = 'pictographic-primitives/avatars/scientist man_4ca8c27b-e86e-4de1-a0ff-2af65d9b94cc.svg'
SOURCE_HEAD_ICON_ID = 'scientist-man-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 32
class ScientistMan1Avatar(Solo48):
    icon_id = 'scientist-man-1-avatar'
