...
class HornCurled(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('crown-left',(22,12),(30,6),radius_x=8)
        self.add_arc('crown-right',(30,6),(38,12),radius_x=8)
        self.add_line('mouth-top',(38,12),(40,20))
        self.add_line('mouth-bottom',(40,20),(33,16))
        self.add_arc('neck-inner',(33,16),(31,20),radius_x=3,sweep=False)
        self.add_line('tube-inner',(31,20),(34,30))
        self.add_arc('tube-bottom',(34,30),(22,42),radius_x=12,radius_y=14)
        self.add_arc('bell-bottom',(22,42),(8,30),radius_x=14)
        ...
        self.add_arc('bell-divider',(22,21),(22,42),radius_x=7,radius_y=13)
