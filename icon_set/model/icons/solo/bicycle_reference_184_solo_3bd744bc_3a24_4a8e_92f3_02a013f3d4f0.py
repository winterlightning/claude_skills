"""Two Wheeled Pedal Bicycle. Authored directly on SOLO48 for later user-requested sub reuse.
...
SOURCE_ICON_ID = '3bd744bc-3a24-4a8e-92f3-02a013f3d4f0'
SOURCE_PATH = 'pictographic-primitives/other/bike_3bd744bc-3a24-4a8e-92f3-02a013f3d4f0.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'bicycle-reference-184-solo'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'objects/interface-essential'
    tags = ('sub icon',)
    keywords = ('sub icon', 'two wheeled pedal bicycle')
    def build(self):
