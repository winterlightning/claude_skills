...
"""Left-facing bath duck with a curved lower bill. HRECT_L bounds (6,8)-(42,40). Lucide bird informs the coherent circular head and body contour. The head and tail are deliberately asymmetric; the original eye-free reduction is retained."""
...
class RubberDuckVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('tail-rise', (38, 27), (42, 23), radius_x=10, radius_y=10, sweep=False)
        self.add_contour('upper', 'head-top', 'head-back', 'neck', 'back', 'tail-rise', closed=False)
        self.add_line('tail', (42, 23), (42, 26))
        self.add_arc('body-right', (42, 26), (32, 40), radius_x=14, radius_y=14, sweep=True)
        ...
        self.add_arc('bill-1', (13, 24), (6, 18), radius_x=11, radius_y=6)
        self.add_line('bill-3', (6, 18), (10, 18))
