# Repair: Widen both palms symmetrically while keeping the open cradling gesture.
...
class HandsCradlingHeart(Solo48):
    ...
    def build(self) -> None:
        ...
        for side in (-1, 1):
            ...
            def p(x, y):
                return (24 + side * x, y)
            self.add_line(n + '-wrist', p(15, 42), p(15, 38))
            self.add_line(n + '-heel', p(15, 38), p(18, 30))
            ...
            self.add_line(n + '-palm', p(10, 30), p(5, 35))
            self.add_line(n + '-inner', p(5, 35), p(5, 42))
