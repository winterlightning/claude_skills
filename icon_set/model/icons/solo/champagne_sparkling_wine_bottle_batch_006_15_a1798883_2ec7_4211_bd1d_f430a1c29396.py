...
Plan: Champagne bottle with sloping shoulders, neck band and lower body seam.
Construction reference: Lucide bottle-wine; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/champagne bottle_a1798883-2ec7-4211-bd1d-f430a1c29396.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'a1798883-2ec7-4211-bd1d-f430a1c29396'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/drinks/champagne bottle_a1798883-2ec7-4211-bd1d-f430a1c29396.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    ...
    def build(self):
        ...
        path('neck',(18,14),(18,4),(30,4),(30,14))
        curve('shoulder-right',(30,14),((30,21),(38,23),(38,30)))
        path('body',(38,30),(38,44),(10,44),(10,30))
        curve('shoulder-left',(10,30),((10,23),(18,21),(18,14)))
        line('neck-band',(18,14),(30,14))
        line('label-seam',(10,36),(38,36))
