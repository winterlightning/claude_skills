"""user-hair-long-2: blouse fastening with reference head silhouette.
...
Body cue: blouse fastening. Shared parameters own mirrored elements.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-11/references/user-hair-long-2.svg'
...
class UserHairLong2Avatar(Solo48):
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'hair', 'long', '2', 'portrait', 'bust')
    def build(self):
        cx = 24
