...
Plan: Two splayed chopsticks entering bowl; foreshortened ellipse reduced to straight rim.
Construction reference: Lucide soup; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-010/references/soup_77a9a077-f1dd-4bee-b3cd-ef26744fdd63.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '77a9a077-f1dd-4bee-b3cd-ef26744fdd63'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/food/soup_77a9a077-f1dd-4bee-b3cd-ef26744fdd63.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'bowl-with-chopsticks-batch-010-08'
    ...
    def build(self):
        ...
        line('rim',(4,24),(44,24))
        arc('bowl',(44,24),(4,24),20,16)
        line('chopstick-left',(22,24),(28,8))
        line('chopstick-right',(32,24),(44,8))
