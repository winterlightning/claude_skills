"""flame-products: smooth geometric reconstruction on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '40563a28-79a3-40b5-8561-0142a3687b2c'
SOURCE_PATH = 'pictographic-primitives/products/flame_40563a28-79a3-40b5-8561-0142a3687b2c.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-reconstructed'

class FlameProducts(Solo48):
    icon_id = 'flame-products'
