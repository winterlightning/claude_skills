...
class Textbox(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('sym-e0', (24, 31), (24, 17))
        self.add_line('sym-e1', (24, 17), (17, 17))
        self.add_line('sym-e2', (24, 40), (9, 40))
        self.add_arc('sym-e3', (9, 40), (8, 40), radius_x=20, radius_y=20, large_arc=False, sweep=False)
        self.add_arc('sym-e4', (8, 40), (4, 36), radius_x=5, radius_y=5, large_arc=False, sweep=True)
        self.add_line('sym-e6', (4, 36), (4, 12))
        self.add_arc('sym-e7', (4, 12), (9, 8), radius_x=6, radius_y=6, large_arc=False, sweep=True)
        self.add_line('sym-e8', (9, 8), (24, 8))
        self.add_line('sym-e9', (24, 8), (39, 8))
        self.add_arc('sym-e10', (39, 8), (44, 12), radius_x=6, radius_y=6, large_arc=False, sweep=True)
        self.add_line('sym-e11', (44, 12), (44, 36))
        self.add_arc('sym-e13', (44, 36), (40, 40), radius_x=5, radius_y=5, large_arc=False, sweep=True)
        self.add_line('sym-e14', (40, 40), (39, 40))
        self.add_line('sym-e15', (39, 40), (24, 40))
        self.add_line('sym-e16', (31, 17), (24, 17))
