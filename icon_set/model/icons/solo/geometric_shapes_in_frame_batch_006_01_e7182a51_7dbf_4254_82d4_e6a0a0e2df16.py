...
Plan: Circle, two squares and baseline; squares share the frame border to keep their interiors open.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/shape_e7182a51-7dbf-4254-82d4-e6a0a0e2df16.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'e7182a51-7dbf-4254-82d4-e6a0a0e2df16'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/shape_e7182a51-7dbf-4254-82d4-e6a0a0e2df16.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'geometric-shapes-in-frame-batch-006-01'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/batch-006"
    aliases = ()
    keywords = ('geometric', 'shapes', 'in', 'frame')
    ...
    def build(self):
        ...
        rect('frame',6,6,36,36)
        circle('circle',20,20,5)
        rect('square-top',34,6,8,8)
        rect('square-bottom',34,34,8,8)
        line('baseline',(14,34),(22,34))
