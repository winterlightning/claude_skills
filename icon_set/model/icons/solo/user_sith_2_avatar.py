"""user-sith-2: robe panels with reference head silhouette.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-sith-2.svg'
...
class UserSith2Avatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('user', 'sith', '2', 'portrait', 'bust')
    def build(self):
