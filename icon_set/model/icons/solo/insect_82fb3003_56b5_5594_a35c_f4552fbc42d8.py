"""Symmetric top-view beetle with six legs, antennae and a divided wing case. Centerline extremes (6,6)-(42,42). Lucide bug informs the capsule and radial leg connections. Thorax band reduced to a single head/body boundary."""
...
class Beetle(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('base-l', (13, 39), (24, 42), radius_x=11, radius_y=7, sweep=True)
        self.add_contour('wing-l', 'shoulder-l', 'wall-l-0', 'wall-l-1', 'base-l', closed=False)
        self.relate("connect", 'head', 'wing-l')
        self.add_polyline('leg-l-0', (13, 25), (6, 22))
        self.relate("connect", 'wing-l', 'leg-l-0')
        self.add_polyline('leg-l-1', (13, 32), (6, 32))
        self.relate("connect", 'wing-l', 'leg-l-1')
        self.add_polyline('leg-l-2', (13, 39), (6, 42))
        self.relate("connect", 'wing-l', 'leg-l-2')
        self.add_line('antenna-l', (16, 14), (12, 6))
        ...
        self.add_arc('base-r', (35, 39), (24, 42), radius_x=11, radius_y=7, sweep=False)
        self.add_contour('wing-r', 'shoulder-r', 'wall-r-0', 'wall-r-1', 'base-r', closed=False)
        self.relate("connect", 'head', 'wing-r')
        self.add_polyline('leg-r-0', (35, 25), (42, 22))
        self.relate("connect", 'wing-r', 'leg-r-0')
        self.add_polyline('leg-r-1', (35, 32), (42, 32))
        self.relate("connect", 'wing-r', 'leg-r-1')
        self.add_polyline('leg-r-2', (35, 39), (42, 42))
        self.relate("connect", 'wing-r', 'leg-r-2')
        self.add_line('antenna-r', (32, 14), (36, 6))
        self.relate("connect", 'head', 'antenna-r')
        self.add_line('seam', (24, 20), (24, 42))
