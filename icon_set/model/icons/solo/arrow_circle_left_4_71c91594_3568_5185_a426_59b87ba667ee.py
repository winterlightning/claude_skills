"""arrow-circle-left-4: Smooth open ring arrow; earlier revisions preserved."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '71c91594-3568-5185-a426-59b87ba667ee'
SOURCE_PATH = 'pictographic-primitives/arrows/arrow circle left 4_71c91594-3568-5185-a426-59b87ba667ee.svg'
AUTHOR = 'gpt-6'
...
class ArrowCircleLeft4(Solo48):
    ...
    category = 'arrows'
    aliases = ()
    keywords = ('solo-ai-full-set', 'arrow-circle-left-4')
    ...
    def build(self):
        ...
        def pt(x,y):return (48-y,x) if 'left'=='left' else (x,y)
