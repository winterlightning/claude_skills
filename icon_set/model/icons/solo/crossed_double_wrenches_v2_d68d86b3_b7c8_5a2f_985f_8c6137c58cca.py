# Variant of crossed-double-wrenches; parent file remains unchanged.
...
class CrossedDoubleWrenchesVariant2(Solo48):
    icon_id = 'crossed-double-wrenches-v2'
    variant_of = 'crossed-double-wrenches'
    variant_label = 'Full wrench silhouettes'
