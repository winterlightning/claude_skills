"""Replace the plain oval sheep body with broad wool scallops, a dropped oval head and two short legs attached to a level belly. Applied to the original icon identity."""
