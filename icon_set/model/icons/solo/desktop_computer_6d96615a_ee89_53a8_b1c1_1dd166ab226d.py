"""A desktop display with a lower bezel and straight stand. All paired corners share radius 3; shared axis x24. Centerline extremes (6,6)-(42,42).
...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        l,t,r,b,q=6,6,42,32,3
        self.add_line('top',(l+q,t),(r-q,t))
        self.add_arc('top-right',(r-q,t),(r,t+q),radius_x=q)

        self.add_line('right-upper',(r,t+q),(r,24))
        self.add_line('right-lower',(r,24),(r,b-q))
        ...
        self.add_line('left-lower',(l,b-q),(l,24))
        self.add_line('left-upper',(l,24),(l,t+q))
        ...
        self.add_line('bezel',(l,24),(r,24))
        self.relate('connect','screen','bezel')

        self.add_line('stand-left',(20,b),(20,42))
        self.add_line('stand-right',(28,b),(28,42))
        self.add_polyline('foot',(14,42),(20,42),(28,42),(34,42))
