"""Worker ant; centerline extremes (6,6)-(42,42). Mirrored on x=24; six legs and two antennae retained. Lucide bug informs repeated leg attachments; waist reduced to one stroke."""
...
class Ant(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('leg-mid-left', (24, 26), (6, 30))
        ...
        self.add_line('leg-mid-right', (24, 26), (42, 30))
