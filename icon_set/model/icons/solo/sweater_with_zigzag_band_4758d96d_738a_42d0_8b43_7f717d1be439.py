...
Reduction: Thin cuff bands simplify to clean stepped sleeve ends; short underarm seams separate the long sleeves; the repeated zigzag remains the defining decoration.
Construction reference: Lucide shirt.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '4758d96d-738a-42d0-8b43-7f717d1be439'
SOURCE_PATH = 'pictographic-primitives/clothes/sweater_4758d96d-738a-42d0-8b43-7f717d1be439.svg'
AUTHOR = 'gpt-6'
SOURCE_REFERENCES = (('4758d96d-738a-42d0-8b43-7f717d1be439', 'pictographic-primitives/clothes/sweater_4758d96d-738a-42d0-8b43-7f717d1be439.svg'),)
...
class SweaterWithZigzagBand(Solo48):
    icon_id = 'sweater-with-zigzag-band'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'clothes'
    aliases = ()
    keywords = ('sweater', 'with', 'zigzag', 'band')
    ...
    def build(self):
        ...
        self.add_polyline('zigzag',(14,32),(19,24),(24,32),(29,24),(34,32))
        for side in (-1,1):self.relate('connect','zigzag',f'side-{side}')
