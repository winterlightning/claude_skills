"""Left-facing dinosaur skull with a larger eye cavity, nostril and open lower jaw. Same repaired geometry as the original skull revision, preserving independent parent ancestry. SQUARE centerline bounds (6,6)-(42,42). No useful exact Lucide skull match."""
...
class DinosaurSkullVariant4(Solo48):
    icon_id = 'dinosaur-skull-v4'
