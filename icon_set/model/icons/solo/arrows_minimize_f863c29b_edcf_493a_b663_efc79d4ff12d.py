...
SOURCE_PATH = 'pictographic-primitives/_uncategorized_04/arrows minimize_f863c29b-edcf-493a-b663-efc79d4ff12d.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class ArrowsMinimize(Solo48):
    icon_id = 'arrows-minimize'
