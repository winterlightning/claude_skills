...
class StandingGiraffe(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('body-5', (27, 7), (26, 6))
        self.add_line('body-6', (26, 6), (32, 6))
        self.add_line('body-7', (32, 6), (35, 9))
        self.add_line('body-8', (35, 9), (42, 15))
        self.add_line('body-9', (42, 15), (42, 18))
        self.add_line('body-10', (42, 18), (35, 18))
        self.add_line('body-11', (35, 18), (33, 31))
        self.add_line('body-12', (33, 31), (33, 42))
        self.add_line('body-13', (33, 42), (27, 42))
        self.add_line('body-14', (27, 42), (25, 36))
        self.add_line('body-15', (25, 36), (17, 36))
        self.add_line('body-16', (17, 36), (11, 42))
        self.add_line('body-17', (11, 42), (6, 42))
        self.add_line('body-18', (6, 42), (11, 27))
        ...
        self.add_line('horn', (35, 9), (35, 6))
        self.relate("connect", 'horn', 'body')
        self.add_line('tail', (11, 27), (6, 33))
