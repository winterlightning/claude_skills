...
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/cursor hand_baa22743-9c62-58d2-8745-cbad8fa0b530.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'raised-index-finger-cursor'
    ...
    aliases = ()
    keywords = ('hand', 'cursor', 'index', 'finger', 'point', 'gesture')
    def build(self):
