...
class Drawing(Solo48):
    ...
    def build(self):
        ...
        self.add_bezier('right-nose',(32,38),((29,38),(28,30),(28,27)))
        self.add_arc('bridge',(28,27),(20,27),radius_x=4,sweep=False)
        self.add_bezier('left-nose',(20,27),((20,30),(19,38),(16,38)))
