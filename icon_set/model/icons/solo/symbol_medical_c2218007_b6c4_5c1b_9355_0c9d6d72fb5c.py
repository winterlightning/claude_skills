...
class SymbolMedical(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('e12-1', (30, 8), (28, 6), radius_x=2, sweep=False)
        self.add_arc('e12-2', (28, 6), (27, 6), radius_x=65)
        self.add_line('e13-1', (21, 6), (19, 6))
        self.add_arc('e13-2', (19, 6), (18, 8), radius_x=2, sweep=False)
        self.add_line('e14', (8, 18), (6, 19))
        self.add_arc('e15-1', (6, 28), (6, 29), radius_x=2)
        self.add_arc('e15-2', (6, 29), (9, 30), radius_x=3, sweep=False)
        self.add_arc('e16', (18, 39), (19, 42), radius_x=2, sweep=False)
        self.add_line('e17', (26, 42), (30, 41))
        self.add_arc('e18', (40, 30), (42, 28), radius_x=2, sweep=False)
        self.add_arc('e19', (42, 20), (40, 18), radius_x=2, sweep=False)
        self.add_contour('c0', 'e0', 'e12-1', 'e12-2', 'e1', 'e13-1', 'e13-2', 'e2', 'e3', 'e14', 'e4', 'e15-1', 'e15-2', 'e5', 'e6', 'e16', 'e7', 'e17', 'e8', 'e9', 'e18', 'e10', 'e19', 'e11', closed=True)
