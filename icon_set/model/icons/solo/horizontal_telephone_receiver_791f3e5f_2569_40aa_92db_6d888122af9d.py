"""Horizontal receiver with matched downward cuffs and a deep central recess; one tangent contour."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '791f3e5f-2569-40aa-92db-6d888122af9d'
SOURCE_PATH = 'pictographic-primitives/phones/phone horizontal_791f3e5f-2569-40aa-92db-6d888122af9d.svg'
AUTHOR = 'gpt-6'

class HorizontalTelephoneReceiver(Solo48):
    icon_id = 'horizontal-telephone-receiver'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'phones'
    categories = ('phones', 'state')
    aliases = ()
    keywords = ('telephone', 'receiver', 'handset', 'horizontal', 'call', 'communication')
    ...
    def build(self):
        ...
        line('top',(14,8),(34,8));arc('outer-right',(34,8),(44,18),10)
        line('right',(44,18),(44,36));arc('cuff-br',(44,36),(40,40),4)
        line('cuff-bottom-r',(40,40),(36,40));arc('cuff-inner-r',(36,40),(32,36),4)
        line('neck-r',(32,36),(32,28));arc('recess-r',(32,28),(28,24),4,False)
        line('recess',(28,24),(20,24));arc('recess-l',(20,24),(16,28),4,False)
        line('neck-l',(16,28),(16,36));arc('cuff-inner-l',(16,36),(12,40),4)
        line('cuff-bottom-l',(12,40),(8,40));arc('cuff-bl',(8,40),(4,36),4)
        line('left',(4,36),(4,18));arc('outer-left',(4,18),(14,8),10)
