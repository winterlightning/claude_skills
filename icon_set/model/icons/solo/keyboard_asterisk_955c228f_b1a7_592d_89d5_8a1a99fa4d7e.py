...
SOURCE_PATH = 'pictographic-primitives/interface-essential/keyboard asterisk_955c228f-b1a7-592d-89d5-8a1a99fa4d7e.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class KeyboardAsterisk955c228f(Solo48):
    icon_id = 'keyboard-asterisk-955c228f'
