"""Hands Cradling Woman with Parted Hair.

Symbol plan: Circular head with paired hanging hair strands above domed shoulders. Omit the internal part line and finger creases for clear small-scale reading. Matched palms use a shared mirrored definition; head-to-shoulder ink gap is exactly 4.
...
SOURCE_PATH = 'pictographic-primitives/business/donation charity care person female_980cf59c-d36f-4ecd-b2a3-868c7b401314.svg'
AUTHOR = 'gpt-6'

class HandsCradlingWomanWithPartedHair(Solo48):
    ...
    def build(self):
        ...
        for n,mirror in [('left',False),('right',True)]:
            ...
            self.path(n+'-hair',p(18,10),(*p(16,18),*p(18,14),*p(17,16)));self.relate('connect',n+'-hair','head')
