...
Reduction: Join the nib to the barrel and omit the narrow side clip. Keep the writing stroke attached to the nib tip.
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = 'ffe08ac3-8444-4717-b236-e05602679f52'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/interface-essential/pen write 1_ffe08ac3-8444-4717-b236-e05602679f52.svg'
AUTHOR = 'gpt-6'
