...
class Ostrich(Solo48):
    ...
    def build(self) -> None:
        self.add_arc('head', (32, 9), (39, 6), radius_x=7, radius_y=7, sweep=True)
        self.add_arc('beak-top', (39, 6), (42, 7), radius_x=7, radius_y=5, sweep=True)
        self.add_line('beak-bottom', (42, 7), (38, 12))
        ...
        self.add_line('leg-left', (18, 34), (18, 42))
        self.add_line('foot-left', (18, 42), (23, 42))
        ...
        self.add_line('tail-top', (16, 20), (6, 28))
        self.add_arc('tail-bottom', (6, 28), (17, 29), radius_x=16, radius_y=10, sweep=False)
        self.add_contour('back-wing', 'neck-back', 'back', 'tail-top', 'tail-bottom', closed=False)
        self.relate("connect", 'front', 'back-wing')
        self.add_line('leg-right', (26, 34), (28, 42))
        self.add_line('foot-right', (28, 42), (34, 42))
