...
SOURCE_PATH = 'pictographic-primitives/_uncategorized_34/shuttlecock_97335598-fa75-4c18-a90d-4c7cc781b905.svg'
AUTHOR = 'gpt-6-astra'
...
class Drawing(Solo48):
    ...
    aliases = ()
    keywords = ('badminton', 'sports', 'shuttlecock')
