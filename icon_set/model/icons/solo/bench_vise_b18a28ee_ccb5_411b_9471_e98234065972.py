...
class BenchVise(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_polyline('support',(10,22),(10,40),(32,40),(32,22))
        self.relate('connect','support','left-jaw')
        self.relate('connect','support','right-jaw')
        self.add_line('base',(6,40),(38,40))
        self.relate('connect','support','base')
        self.add_line('crank-link',(32,31),(42,31))
        self.add_line('crank',(42,22),(42,40))
