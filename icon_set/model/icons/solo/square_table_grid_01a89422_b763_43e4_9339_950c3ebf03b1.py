...
SOURCE_ICON_ID = '01a89422-b763-43e4-9339-950c3ebf03b1'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_10/cell border bottom_01a89422-b763-43e4-9339-950c3ebf03b1.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    icon_id = 'square-table-grid'
    variant_of = 'cell-border-full'
    variant_label = 'Square Table Grid'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('square', 'table', 'grid', 'cells', 'dashed', 'lines')
    def build(self):
        # Plan: An empty square table divided into four cells by dashed central lines.
        ...
        rr('frame',6,6,42,42,2,top=(24,),bottom=(24,),left=(24,),right=(24,))
        for j,(v,w) in enumerate([((24,6),(24,14)),((24,34),(24,42)),((6,24),(14,24)),((34,24),(42,24))]):l(f'dash-{j}',v,w)
        p('cross-h',(22,24),(24,24),(26,24));p('cross-v',(24,22),(24,24),(24,26))
