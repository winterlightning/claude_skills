"""The lowercase letter n, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 6, top 6, right 42, bottom 42.
Plan: A single arch with matching vertical stems and a semicircular crown.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/N.svg'
AUTHOR = 'gpt-6'


class LetterN(Solo48):
    icon_id = 'letter-n'
    ...
    typeface = {'character': 'n', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('n', "typeface", "typography", 'lowercase')

    def build(self):
        rotation = 0
        mirror = False
        left,right,spring,baseline=6,42,24,42
        runs=[((left,baseline), [('L',left,spring),('A',right,spring,18,18,True),('L',right,baseline)],False)]
