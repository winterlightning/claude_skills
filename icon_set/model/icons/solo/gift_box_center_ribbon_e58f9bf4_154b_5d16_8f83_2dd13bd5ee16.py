"""A gift box with an overhanging lid and paired bow loops; line construction.
...
SOURCE_ICON_ID='e58f9bf4-154b-5d16-8f83-2dd13bd5ee16'
SOURCE_PATH='pictographic-primitives/rewards/gift box_e58f9bf4-154b-5d16-8f83-2dd13bd5ee16.svg'
AUTHOR='gpt-6'

class GiftBoxCenterRibbon(Solo48):
    icon_id='gift-box-center-ribbon'
    ...
    aliases=()
    keywords=('award', 'reward', 'gift-box-center-ribbon')
    def build(self) -> None:
        axis=24
        ...
        self.add_line('ribbon-24',(24,18),(24,44))
        self.relate('connect','ribbon-24','lid')
        self.relate('connect','ribbon-24','body')
