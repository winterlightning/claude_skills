"""check-towing-device: next hundred AI review; original preserved."""
...
class CheckTowingDevice(Solo48):
    icon_id = 'check-towing-device'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'transportation'
    aliases = ()
    keywords = ('check', 'towing', 'device', 'transportation', 'solo-ai-next100')

    def build(self):
        # Plan: Keep the tow hook as a long bent shank with a round towing eye; a tangent quarter-circle replaces the kinked elbow.
