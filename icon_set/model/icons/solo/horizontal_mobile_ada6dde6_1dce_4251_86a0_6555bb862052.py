...
SOURCE_ICON_ID = 'ada6dde6-1dce-4251-86a0-6555bb862052'
SOURCE_PATH = 'icon_set/work/todo-references/horizontal mobile_ada6dde6-1dce-4251-86a0-6555bb862052.svg'
AUTHOR = "gpt-6"

class Drawing(Solo48):
    icon_id = 'horizontal-mobile-solo'
    ...
    def build(self):
        ...
        self.rounded('phone',4,10,40,28,6)
