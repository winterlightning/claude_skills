"""A car front with slot headlights and rounded U tyres. SQUARE ink (6,6)-(42,42). Lucide car-front informed mirrored geometry; the reference light and wheel treatment remains distinct."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '2ff44051-c27a-489e-8314-464892a54b20'
SOURCE_PATH = 'pictographic-primitives/transportation/car 1_2ff44051-c27a-489e-8314-464892a54b20.svg'
SOURCE_REFERENCES = (('2ff44051-c27a-489e-8314-464892a54b20', 'pictographic-primitives/transportation/car 1_2ff44051-c27a-489e-8314-464892a54b20.svg'),)
AUTHOR = 'gpt-6'

class CarFrontHeadlights(Solo48):
    icon_id = 'car-front-headlights'
    ...
    def build(self) -> None:
        ...
        self.add_line('left-light',(15,25),(17,25))
        self.add_line('right-light',(31,25),(33,25))
