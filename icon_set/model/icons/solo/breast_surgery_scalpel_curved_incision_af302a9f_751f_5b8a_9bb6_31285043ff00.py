...
SOURCE_ICON_ID = 'af302a9f-751f-5b8a-9bb6-31285043ff00'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/health/surgery breast surgery_af302a9f-751f-5b8a-9bb6-31285043ff00.svg'
AUTHOR = 'gpt-6'


class BreastSurgeryScalpelCurvedIncision(Solo48):
    icon_id = 'breast-surgery-scalpel-curved-incision'
    ...
    def build(self):
        # Plan: A diagonal scalpel meets the breast contour; curved anatomy and angular blade remain separate symbols sharing the incision contact. Extremes (6,6)-(42,42).
        # Reduction: Omit the tiny nipple mark, lower torso stub and extra incision line; the curved blade edge represents the contact at the incision.
        # Reference: Shared human reference inspected; supplied anatomical reference governs the breast. Lucide syringe informs the diagonal tool.
        ...
        bez('blade-edge',(14,32),((23,32),(28,27),(32,22)))
        line('blade-neck',(32,22),(26,16))
        contour('blade','blade-back','blade-tip','blade-edge','blade-neck',closed=True)
        bez('upper-chest',(16,6),((16,10),(19,14),(26,16)))
        bez('breast',(6,22),((6,34),(10,42),(18,42)),((34,42),(40,28),(32,22)))
        contacts()
