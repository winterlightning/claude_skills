"""Programming Code Chat Bubble. Authored directly on SOLO48 for later user-requested sub reuse.
...
class Drawing(Solo48):
    icon_id = 'code-message-40-solo'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    tags = ('sub icon',)
    keywords = ('sub icon', 'programming code chat bubble')
    def build(self):
        ...
        self.add_polyline('code-left',(20,15),(15,20),(20,25))
        self.add_polyline('code-right',(28,15),(33,20),(28,25))
