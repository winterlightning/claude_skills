"""soldier: uniform chest band.
Distinct-avatar plan: preserve reference identity; use uniform chest band.
...
SOURCE_ICON_ID = '05acd9fd-f693-5a7a-a99a-c2968c60c675'
SOURCE_PATH = 'pictographic-primitives/avatars/soldier_05acd9fd-f693-5a7a-a99a-c2968c60c675.svg'
SOURCE_HEAD_ICON_ID = 'soldier'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 26
class SoldierAvatar(Solo48):
    icon_id = 'soldier-avatar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'avatars'
    aliases = ()
    keywords = ('soldier', 'portrait', 'bust')
    def build(self):
