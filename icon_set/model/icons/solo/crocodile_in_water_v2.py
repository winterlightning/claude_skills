...
"""Crocodile with a distinct eye under a broader brow, long snout, back ridge and scalloped water. HRECT_M extrema (6,11)-(42,37). Deliberately right-facing; no useful local Lucide crocodile match."""
...
class CrocodileInWaterVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('snout-end', (42, 19), (42, 25))
        self.add_line('snout-bottom', (42, 25), (35, 25))
