...
class TableTools(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (7, 40), (4, 37), radius_x=4)
        ...
        self.add_arc('sym-e8', (44, 37), (41, 40), radius_x=4)
        ...
        self.add_arc('sym-e18', (44, 11), (44, 10), radius_x=1)
        self.add_arc('sym-e19', (44, 10), (41, 8), radius_x=4, sweep=False)
        self.add_line('sym-e20', (41, 8), (24, 8))
        self.add_line('sym-e21', (24, 8), (7, 8))
        self.add_arc('sym-e22', (7, 8), (4, 10), radius_x=4, sweep=False)
        self.add_line('sym-e23', (4, 10), (4, 11))
