...
class ThreeLeafPlantInRimmedPot(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc("leaf-left-outer", (16,30), (6,12), radius_x=11, radius_y=18)
        self.add_arc("leaf-left-inner", (6,12), (18,20), radius_x=13, radius_y=8)
        self.add_arc("leaf-centre-left", (18,20), (24,6), radius_x=6, radius_y=18)
        self.add_arc("leaf-centre-right", (24,6), (30,20), radius_x=6, radius_y=18)
        self.add_arc("leaf-right-inner", (30,20), (42,12), radius_x=13, radius_y=8)
        self.add_arc("leaf-right-outer", (42,12), (32,30), radius_x=11, radius_y=18)
