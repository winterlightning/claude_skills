...
class OrcaHead(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('forehead', (6, 23), (18, 12), radius_x=16, radius_y=11, sweep=True, large_arc=False)
        self.add_arc('back', (18, 12), (30, 15), radius_x=24, radius_y=24, sweep=False, large_arc=False)
        self.add_arc('dorsal-front', (30, 15), (42, 6), radius_x=20, radius_y=20, sweep=True, large_arc=False)
        self.add_arc('dorsal-back', (42, 6), (41, 24), radius_x=22, radius_y=22, sweep=False, large_arc=False)
        self.add_line('rear', (41, 24), (42, 42))
        self.add_line('fin-bottom', (42, 42), (30, 37))
        self.add_arc('jaw', (30, 37), (6, 23), radius_x=36, radius_y=36, sweep=True, large_arc=False)
