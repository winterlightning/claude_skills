"""Uppercase D for SOLO48; centerline envelope (10, 4)–(38, 44).
Plan: A flat spine closes a half-elliptical bowl; top and bottom shoulders match.
...
class LetterDUppercase(Solo48):
    icon_id = 'letter-d-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'D', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('D', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((10,4),[('L',24,4),('A',38,24,14,20,True),('A',24,44,14,20,True),('L',10,44),('L',10,4)],True)]
