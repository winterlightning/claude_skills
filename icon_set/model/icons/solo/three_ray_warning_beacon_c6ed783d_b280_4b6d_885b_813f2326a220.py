...
SOURCE_ICON_ID = 'c6ed783d-b280-4b6d-885b-813f2326a220'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_34/siren on_c6ed783d-b280-4b6d-885b-813f2326a220.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'three-ray-warning-beacon'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects"
    aliases = ()
    keywords = ('three', 'ray', 'warning', 'beacon')
