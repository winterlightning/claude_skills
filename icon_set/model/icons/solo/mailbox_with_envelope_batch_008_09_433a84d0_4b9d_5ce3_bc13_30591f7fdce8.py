...
Plan: Letter occupies the upper-right mailbox opening; rounded left shoulder and post preserve the delivery scene.
Construction reference: Lucide mail; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-008/references/mailbox in_433a84d0-4b9d-5ce3-bc13-30591f7fdce8.svg
"""
...
class GeneratedSolo(Solo48):
    icon_id = 'mailbox-with-envelope-batch-008-09'
    ...
    def build(self):
        ...
        path('mailbox-left',(6,34),(6,24))
        arc('dome',(6,24),(16,14),10)
        path('body',(6,34),(42,34),(42,22))
        line('front',(16,22),(16,34))
        rect('letter',16,6,26,16)
        path('flap',(16,6),(29,14),(42,6))
        line('post',(24,34),(24,42))
