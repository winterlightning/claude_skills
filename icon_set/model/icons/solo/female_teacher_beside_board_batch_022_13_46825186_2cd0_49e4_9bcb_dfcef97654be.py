"""Female Teacher with Whiteboard.

Symbol plan: Teacher at left of an empty board; circular detached head and flared dress.
Keyshape: SQUARE; authored at SOLO48, never scaled from the source.
Reference construction: Lucide user.
Reduction: Hair reduced; board left edge omitted behind teacher.
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '46825186-2cd0-49e4-9bcb-dfcef97654be'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/other/female teacher_46825186-2cd0-49e4-9bcb-dfcef97654be.svg'
AUTHOR = 'gpt-6'
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-022/references/female teacher_46825186-2cd0-49e4-9bcb-dfcef97654be.svg'

class GeneratedIcon(Solo48):
    icon_id = 'female-teacher-beside-board-batch-022-13'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    keywords = ('female', 'teacher', 'beside', 'board')
    ...
    def build(self):
        ...
        def cross(name,x,y,r):
            for j,p in enumerate(((x-r,y),(x+r,y),(x,y-r),(x,y+r))):
                line(f'{name}-{j}',(x,y),p)
        circle('head',12,12,6)
        poly('dress',(8,26),(16,26),(20,34),(6,34),closed=True)
        line('leg-left',(8,34),(8,42))
        line('leg-right',(16,34),(16,42))
        poly('board',(26,6),(42,6),(42,34),(28,34))
