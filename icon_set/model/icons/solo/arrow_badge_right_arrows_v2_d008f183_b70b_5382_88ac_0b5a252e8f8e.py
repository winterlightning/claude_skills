# Variant of arrow-badge-right-arrows; parent file remains unchanged.
...
class ArrowBadgeRightArrowsVariant2(Solo48):
    icon_id = 'arrow-badge-right-arrows-v2'
    variant_of = 'arrow-badge-right-arrows'
