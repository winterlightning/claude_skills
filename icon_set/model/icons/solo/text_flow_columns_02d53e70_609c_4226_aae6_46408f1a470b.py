...
class TextFlowColumns(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('e20', (18, 40), (17, 42), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_arc('e21', (8, 42), (6, 40), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_arc('e22', (6, 32), (8, 31), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('e23', (30, 7), (31, 6))
        self.add_arc('e24', (40, 6), (42, 8), radius_x=2, radius_y=2, large_arc=False, sweep=True)
        self.add_line('e25', (42, 17), (40, 17))
        self.add_arc('e26', (18, 8), (17, 6), radius_x=2, radius_y=2, large_arc=False, sweep=False)
        self.add_arc('e27', (8, 6), (6, 8), radius_x=2, radius_y=2, large_arc=False, sweep=False)
        self.add_arc('e28', (6, 16), (8, 17), radius_x=2, radius_y=2, large_arc=False, sweep=False)
        self.add_arc('e29', (17, 17), (18, 17), radius_x=20, radius_y=20, large_arc=False, sweep=True)
        self.add_contour('c0', *('e0',), closed=False)
        self.add_contour('c1', *('e1',), closed=False)
        self.add_contour('c2', *('e2',), closed=False)
        self.add_contour('c3', *('e3', 'e4', 'e20', 'e5', 'e21', 'e6', 'e22', 'e7'), closed=False)
        self.add_contour('c4', *('e8',), closed=False)
        self.add_contour('c5', *('e9', 'e23', 'e10', 'e24', 'e11', 'e25', 'e12'), closed=False)
        self.add_contour('c6', *('e13',), closed=False)
        self.add_contour('c7', *('e14',), closed=False)
        self.add_contour('c8', *('e15',), closed=False)
