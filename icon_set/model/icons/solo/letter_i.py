"""The lowercase letter i, re-authored from the supplied reference for SOLO48.

Centerline envelope: radius 20 around (24, 24); radial fit preserves aspect.
Plan: One narrow vertical stroke and its centered detached dot; radial envelope preserves the narrow letter.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/I.svg'
AUTHOR = 'gpt-6'


class LetterI(Solo48):
    icon_id = 'letter-i'
    ...
    typeface = {'character': 'i', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('i', "typeface", "typography", 'lowercase')

    def build(self):
        rotation = 0
        mirror = False
        runs = [((24,18), [('L',24,44)],False)]
        self.add_dot('tittle',(24,4))
