...
class GraduationMortarboardVariant2(Solo48):
    icon_id = 'graduation-mortarboard-v2'
    variant_of = 'graduation-mortarboard'
    ...
    def build(self) -> None:
        ...
        self.add_polyline('board', (4, 18), (24, 8), (44, 18), (38, 22), (24, 28), (10, 22), closed=True)
