"""Three flying birds with broad raised wings; extremes (6,6)-(42,42). Directional silhouettes; small feather teeth omitted to preserve distinct birds."""
...
class ThreeFlyingBirds(Solo48):
    ...
    def build(self) -> None:
        self.add_line('upper-0-1', (6, 12), (8, 12))
        self.add_line('upper-0-2', (8, 12), (6, 6))
        self.add_arc('wing-front-0', (6, 6), (14, 9), radius_x=18, radius_y=14, sweep=True)
        self.add_line('wing-tip-0', (14, 9), (15, 6))
        self.add_arc('wing-small-0', (15, 6), (19, 11), radius_x=6, radius_y=8, sweep=True)
        self.add_line('beak-0', (19, 11), (22, 12))
        self.add_arc('belly-0', (22, 12), (6, 12), radius_x=10, radius_y=6, sweep=True)
        ...
        self.add_arc('wing-small-1', (39, 20), (42, 28), radius_x=6, radius_y=8, sweep=True)
        self.add_line('beak-1', (42, 28), (42, 29))
        self.add_arc('belly-1', (42, 29), (26, 29), radius_x=10, radius_y=6, sweep=True)
        self.add_contour('bird-1', 'upper-1-1', 'upper-1-2', 'wing-front-1', 'wing-tip-1', 'wing-small-1', 'beak-1', 'belly-1', closed=True)
        self.add_line('upper-2-1', (6, 40), (10, 40))
        self.add_line('upper-2-2', (10, 40), (6, 30))
        self.add_arc('wing-front-2', (6, 30), (16, 37), radius_x=18, radius_y=14, sweep=True)
        ...
        self.add_arc('belly-2', (24, 40), (6, 40), radius_x=10, radius_y=6, sweep=True)
