"""A large circular mirror has an empty face and a single thin handle descending from its lowest point. The upright stem is straight, with no separate surrounding frame visible.
Symbol plan: Large circular mirror with radius16 at (24,20) and a single attached stem. Two semicircles share their top and bottom points; preserve the empty face with no added decoration.
...
SOURCE_ICON_ID = '91de3a41-1cef-51cc-b264-0ec644addc79'
SOURCE_PATH = 'pictographic-primitives/beauty/make up hand mirror_91de3a41-1cef-51cc-b264-0ec644addc79.svg'
SOURCE_CATEGORY = 'beauty'
AUTHOR = 'gpt-6'

class BatchSolo(Solo48):
    icon_id = 'circular-makeup-mirror-on-stem'
    keyshape = Keyshape.VRECT_L
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'beauty'
    aliases = ()
    keywords = ('circular', 'makeup', 'mirror', 'on', 'stem')
    ...
    def build(self):
        ...
        self.add_arc('mirror-right',(24,4),(24,36),radius_x=16)
        self.add_arc('mirror-left',(24,36),(24,4),radius_x=16)
        self.add_contour('mirror','mirror-right','mirror-left',closed=True)
        self.add_line('stem',(24,36),(24,44));self.relate('connect','stem','mirror')
