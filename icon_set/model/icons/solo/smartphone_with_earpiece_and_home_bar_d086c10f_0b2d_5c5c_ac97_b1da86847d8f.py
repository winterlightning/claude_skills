"""Rounded smartphone with matching centered earpiece and home bar; all identity features retained."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'd086c10f-0b2d-5c5c-ac97-b1da86847d8f'
SOURCE_PATH = 'pictographic-primitives/phones/mobile phone_d086c10f-0b2d-5c5c-ac97-b1da86847d8f.svg'
AUTHOR = 'gpt-6'

class SmartphoneWithEarpieceAndHomeBar(Solo48):
    icon_id = 'smartphone-with-earpiece-and-home-bar'
    keyshape = Keyshape.VRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'phones'
    aliases = ()
    keywords = ('smartphone', 'phone', 'screen', 'earpiece', 'home', 'mobile')
