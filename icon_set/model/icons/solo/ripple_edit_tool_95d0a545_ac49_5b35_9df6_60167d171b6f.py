...
SOURCE_PATH = 'pictographic-primitives/arrows/ripple edit tool_95d0a545-ac49-5b35-9df6-60167d171b6f.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class RippleEditTool(Solo48):
    icon_id = 'ripple-edit-tool'
