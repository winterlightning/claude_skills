...
class SlenderPearShapedVase(Solo48):
    ...
    def build(self) -> None:
        self.add_line('lip', (16,6), (32,6))
        self.add_arc('neck-right', (32,6), (32,18), radius_x=4, radius_y=8, sweep=False)
        self.add_arc('shoulder-right', (32,18), (37,32), radius_x=5, radius_y=14)
        self.add_arc('base-right', (37,32), (24,42), radius_x=13, radius_y=14)
        self.add_arc('base-left', (24,42), (11,32), radius_x=13, radius_y=14)
        self.add_arc('shoulder-left', (11,32), (16,18), radius_x=5, radius_y=14)
        self.add_arc('neck-left', (16,18), (16,6), radius_x=4, radius_y=8, sweep=False)
