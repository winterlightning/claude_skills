...
class Vertical(Solo48):
    ...
    def build(self):
        self.add_arc('sym-e0', (8, 4), (10, 11), radius_x=75)
        self.add_arc('sym-e1', (10, 11), (12, 24), radius_x=53)
        self.add_arc('sym-e2', (12, 24), (10, 37), radius_x=53)
        self.add_arc('sym-e3', (10, 37), (8, 44), radius_x=75)
        self.add_line('sym-e4', (8, 44), (24, 44))
        self.add_line('sym-e5', (24, 44), (40, 44))
        self.add_arc('sym-e6', (40, 44), (38, 37), radius_x=75)
        self.add_arc('sym-e7', (38, 37), (36, 24), radius_x=53)
        self.add_arc('sym-e8', (36, 24), (38, 11), radius_x=53)
        self.add_arc('sym-e9', (38, 11), (40, 4), radius_x=75)
