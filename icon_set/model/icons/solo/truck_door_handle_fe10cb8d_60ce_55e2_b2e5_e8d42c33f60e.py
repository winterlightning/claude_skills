...
class TruckDoorHandle(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('cargo-tr',(22, 8),(24, 12),radius_x=4,radius_y=4,large_arc=False,sweep=True)
        self.add_line('cargo-front-1',(24, 12),(24, 16))
        self.add_line('cargo-front-2',(24, 16),(24, 36))
        self.add_line('cargo-front-3',(24, 36),(16, 36))
