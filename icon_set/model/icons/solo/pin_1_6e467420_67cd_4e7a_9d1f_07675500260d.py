"""pin-1-interface-essential: smooth geometric reconstruction on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '6e467420-67cd-4e7a-9d1f-07675500260d'
SOURCE_PATH = 'pictographic-primitives/interface-essential/pin 1_6e467420-67cd-4e7a-9d1f-07675500260d.svg'
AUTHOR = 'gpt-6'
