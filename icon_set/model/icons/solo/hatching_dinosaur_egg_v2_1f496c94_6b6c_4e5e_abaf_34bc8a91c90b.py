# Variant of hatching-dinosaur-egg; parent file remains unchanged.
...
class HatchingDinosaurEggVariant2(Solo48):
    icon_id = 'hatching-dinosaur-egg-v2'
    variant_of = 'hatching-dinosaur-egg'
