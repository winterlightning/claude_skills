"""The lowercase letter z, re-authored from the supplied reference for SOLO48.

Centerline extremes: left 6, top 6, right 42, bottom 42.
Plan: A diagonal between matching horizontal arms.
...
SOURCE_ICON_ID = None
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/Letters/Z.svg'
AUTHOR = 'gpt-6'


class LetterZ(Solo48):
    icon_id = 'letter-z'
    ...
    typeface = {'character': 'z', 'kind': 'lowercase'}
    aliases = ()
    keywords = ('z', "typeface", "typography", 'lowercase')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((6,6), [('L',42,6),('L',6,42),('L',42,42)],False)]
