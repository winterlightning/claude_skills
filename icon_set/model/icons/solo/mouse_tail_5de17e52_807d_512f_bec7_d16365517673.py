...
class MouseWithLongTail(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('snout', (34, 24), (42, 16), radius_x=12, radius_y=8, sweep=False, large_arc=False)
        self.add_line('face', (42, 16), (36, 12))
        ...
        self.add_arc('tail-tip', (26, 40), (26, 42), radius_x=3, radius_y=3, sweep=True, large_arc=False)
        self.add_line('tail-end', (26, 42), (16, 42))
