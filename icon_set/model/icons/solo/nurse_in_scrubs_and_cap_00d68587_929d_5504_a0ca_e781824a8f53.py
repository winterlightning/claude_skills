"""A round blank head wears a close-fitting cap with a straight lower band. The torso has a deep V-shaped scrub neckline, short central seam and small cross on the right chest.
Symbol plan: Round cap and circular jaw above a clear V-shaped scrub neckline. The neckline and shoulder plateau form one coherent garment contour. Omit the small off-centre chest cross and short centre seam.
...
SOURCE_ICON_ID = '00d68587-929d-5504-a0ca-e781824a8f53'
SOURCE_PATH = 'pictographic-primitives/avatars/man nurse_00d68587-929d-5504-a0ca-e781824a8f53.svg'
SOURCE_CATEGORY = 'avatars'
AUTHOR = 'gpt-6'

class BatchSolo(Solo48):
    icon_id = 'nurse-in-scrubs-and-cap'
    ...
    aliases = ()
    keywords = ('nurse', 'in', 'scrubs', 'and', 'cap')
    ...
    def build(self):
        ...
        bottom=avatar_head(14,10,cap=True);shoulders(bottom,kind='v-neck',join_y=40)
