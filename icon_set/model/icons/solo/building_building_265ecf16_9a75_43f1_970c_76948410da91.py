"""building-building: next hundred AI review; original preserved."""
...
class BuildingBuilding(Solo48):
    icon_id = 'building-building'
    ...
    def build(self):
        # Plan: Keep a broad high-rise and lower right annex; exact baseline and a centered upper window.
