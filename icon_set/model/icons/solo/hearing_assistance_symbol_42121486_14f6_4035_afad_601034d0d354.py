"""An ear with inner fold, two broken diagonal marks and an outer sound arc.

SQUARE extrema (6,6)-(42,42). The source's diagonal series reduces from
three to two so distinct strokes retain clearance at 48 pixels. Lucide ear
informs the continuous outer ear and smaller inner fold.
"""
...
class HearingAssistanceSymbol(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_bezier("inner-fold",(19,23),((21,20),(23,20),(25,23)),((25,24),(23,25),(22,25)))
