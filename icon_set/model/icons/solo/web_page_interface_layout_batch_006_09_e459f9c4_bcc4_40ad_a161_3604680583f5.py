...
Plan: Header and slanted lower columns kept; doubled inset borders removed.
Construction reference: Lucide panels-top-left; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/wireframe_e459f9c4-bcc4-40ad-a161-3604680583f5.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'e459f9c4-bcc4-40ad-a161-3604680583f5'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/design/wireframe_e459f9c4-bcc4-40ad-a161-3604680583f5.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'web-page-interface-layout-batch-006-09'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = "objects/batch-006"
    aliases = ()
    keywords = ('web', 'page', 'interface', 'layout')
    ...
    def build(self):
        ...
        rect('page',6,6,36,36,2)
        line('header',(6,18),(42,18))
        line('columns',(24,18),(20,42))
