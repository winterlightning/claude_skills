"""Left-Facing Fish with Forked Tail
...
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_34/smolt_d06ef240-e10e-4010-a5c8-eae1292b73b9.svg'
AUTHOR = 'gpt-6'
...
class Drawing(Solo48):
    ...
    category = 'objects'
    aliases = ()
    keywords = ('fish', 'fin', 'tail', 'gill', 'animal', 'aquatic')
