...
Plan: Complete diode symbol with two emitted-light arrows.
Construction reference: Lucide cpu; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/light emitting diode_4aea2c3b-9c74-49a6-b3a6-5e8cf78dec5e.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '4aea2c3b-9c74-49a6-b3a6-5e8cf78dec5e'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/light emitting diode_4aea2c3b-9c74-49a6-b3a6-5e8cf78dec5e.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'light-emitting-diode-circuit-symbol-batch-007-14'
    ...
    def build(self):
        ...
        path('diode',(14,22),(32,32),(14,42),closed=True)
        line('anode',(6,32),(14,32))
        line('cathode',(32,22),(32,42))
        line('lead',(32,32),(42,32))
        for j in range(2):
            x=18+16*j; y=6+2*j
            path(f'arrow-{j}',(x-6,y+6),(x,y),(x,y+5))
            line(f'arrow-tip-{j}',(x-5,y),(x,y))
