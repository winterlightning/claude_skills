"""Arrow Left with Broad Triangular Head.
...
SOURCE_ICON_ID = 'a67a2113-d229-5c0a-8983-bdc64ca86a36'
SOURCE_PATH = 'pictographic-primitives/arrows/end point triangle arrow left_a67a2113-d229-5c0a-8983-bdc64ca86a36.svg'
AUTHOR = 'gpt-6'

class ArrowLeftWithBroadTriangularHead(Solo48):
    icon_id = 'arrow-left-with-broad-triangular-head'
