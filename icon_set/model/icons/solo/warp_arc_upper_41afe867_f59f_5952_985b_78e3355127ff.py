...
class WarpArcUpper(Solo48):
    ...
    def build(self):
        self.add_arc('sym-e1', (24, 4), (23, 4), radius_x=1)
        self.add_arc('sym-e2', (23, 4), (8, 21), radius_x=18, sweep=False)
        self.add_line('sym-e3', (8, 21), (8, 22))
        ...
        self.add_line('sym-e10', (40, 22), (40, 21))
        self.add_arc('sym-e11', (40, 21), (25, 4), radius_x=18, sweep=False)
        self.add_arc('sym-e12', (25, 4), (24, 4), radius_x=1)
        self.add_contour('sym-c0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e5', 'sym-e6', 'sym-e7', 'sym-e8', 'sym-e10', 'sym-e11', 'sym-e12', closed=True)
