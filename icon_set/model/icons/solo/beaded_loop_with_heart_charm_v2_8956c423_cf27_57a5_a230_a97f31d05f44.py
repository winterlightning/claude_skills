...
"""Beaded loop with lower-right heart. SQUARE (6,6)-(42,42) supports the offset charm. Eight solid beads replace twelve touching hollow beads. Heart informed by Lucide lobes; asymmetry preserves source charm position."""
...
class BeadedLoopWithHeartCharmVariant2(Solo48):
    ...
    def build(self) -> None:
        self.add_dot('bead-0', (18, 6))
        self.add_dot('bead-1', (8, 8))
        self.add_dot('bead-2', (6, 18))
        ...
        self.add_arc('lobe-left', (34,34), (34,42), radius_x=6, sweep=False)
        self.add_line('side-left', (34,42), (42,42))
        self.add_line('side-right', (42,42), (42,34))
        self.add_arc('lobe-right', (42,34), (34,34), radius_x=6, sweep=False)
