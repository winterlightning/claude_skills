...
class EMail(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e1', (41, 40), (40, 40), radius_x=41, sweep=False)
        self.add_line('sym-e2', (40, 40), (8, 40))
        self.add_arc('sym-e3', (8, 40), (7, 40), radius_x=20, sweep=False)
        self.add_line('sym-e4', (7, 40), (5, 39))
        self.add_line('sym-e5', (5, 39), (19, 24))
        self.add_arc('sym-e6', (19, 24), (24, 27), radius_x=12, sweep=False)
        self.add_arc('sym-e7', (24, 27), (29, 24), radius_x=12, sweep=False)
        ...
        self.add_arc('sym-e13', (43, 10), (40, 8), radius_x=5, sweep=False)
        self.add_line('sym-e14', (40, 8), (24, 8))
        self.add_line('sym-e15', (24, 8), (8, 8))
        self.add_arc('sym-e16', (8, 8), (5, 10), radius_x=5, sweep=False)
