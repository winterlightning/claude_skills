...
class Hedgehog(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('body-1', (6, 30), (12, 22))
        ...
        self.add_line('body-8', (38, 22), (42, 27))
        self.add_line('body-9', (42, 27), (42, 30))
        self.add_arc('body-10', (42, 30), (34, 35), radius_x=17, radius_y=8, sweep=True)
        self.add_line('body-11', (34, 35), (12, 35))
        self.add_line('body-12', (12, 35), (6, 30))
