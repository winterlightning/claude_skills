"""Cancer Awareness Ribbon Symbol."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '51534d9b-1929-402f-81c3-b76ec9f75b44'
SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/health/ribbon cancer_51534d9b-1929-402f-81c3-b76ec9f75b44.svg'
AUTHOR = 'gpt-6'


class CancerAwarenessLoopedRibbon(Solo48):
    icon_id = 'cancer-awareness-looped-ribbon'
    ...
    def build(self):
        # Plan: One coherent ribbon stroke loops around a circular crown and crosses below before flaring into two tails. Extremes (10,4)-(38,44).
        # Reduction: Reduce outlined ribbon width to the canonical stroke; omit layered edges while preserving loop, crossing and two tails.
        # Reference: Lucide ribbon: a single continuous loop and diagonal crossing.
        ...
        line('left-tail',(10,44),(30,24))
        bez('loop-right',(30,24),((33,21),(34,18),(34,14)))
        arc('crown',(34,14),(14,14),10,sweep=False)
        bez('loop-left',(14,14),((14,18),(15,21),(18,24)))
        line('right-tail',(18,24),(38,44))
        contour('ribbon','left-tail','loop-right','crown','loop-left','right-tail')
        contacts()
