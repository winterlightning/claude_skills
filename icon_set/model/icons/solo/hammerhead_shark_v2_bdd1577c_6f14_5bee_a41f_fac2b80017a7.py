...
'Hammerhead shark with an enlarged angular tail and straight fork edges. SQUARE (6,6)-(42,42) preserves hammer width and tail extent. Curved tail edge replaced; swept body remains deliberately asymmetric.'
...
class HammerheadSharkVariant2(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('body-14', (29, 42), (13, 27), radius_x=16, radius_y=16, sweep=True)
