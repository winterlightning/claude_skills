"""Round hand fan with diagonal handle and one rib. Extrema (6,6)-(42,42). Paddle retained from supplied image; no useful Lucide subject match. Diagonal pose is intentional."""
...
class RoundHandFan(Solo48):
    ...
    def build(self) -> None:
        # Round hand fan with diagonal handle and one rib. Extrema (6,6)-(42,42). Paddle retained from supplied image; no useful Lucide subject match. Diagonal pose is intentional.
        self.add_arc('blade-upper-left', (14, 12), (32, 6), radius_x=18, radius_y=10, sweep=True)
        self.add_arc('blade-upper-right', (32, 6), (42, 18), radius_x=14, radius_y=16, sweep=True)
        self.add_arc('blade-lower-right', (42, 18), (32, 36), radius_x=14, radius_y=18, sweep=True)
        ...
        self.add_line('handle', (6, 42), (20, 29))
