"""user-tie: parted hair and tie.
Distinct-avatar plan: preserve reference identity; use parted hair and tie.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-tie.svg'
SOURCE_HEAD_ICON_ID = 'user-tie'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class UserTieAvatar(Solo48):
    icon_id = 'user-tie-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'tie', 'portrait', 'bust')
    def build(self):
