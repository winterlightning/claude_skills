...
class HippoFace(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('head-1', (6, 22), (6, 8))
        self.add_arc('head-2', (6, 8), (8, 6), radius_x=6, radius_y=6, sweep=True)
        self.add_arc('head-3', (8, 6), (15, 9), radius_x=7, radius_y=7, sweep=True)
        ...
        self.add_arc('head-6', (33, 9), (40, 6), radius_x=7, radius_y=7, sweep=True)
        self.add_arc('head-7', (40, 6), (42, 8), radius_x=6, radius_y=6, sweep=True)
        self.add_line('head-8', (42, 8), (42, 22))
        self.add_arc('head-9', (42, 22), (42, 34), radius_x=4, radius_y=12, sweep=True)
        self.add_arc('head-10', (42, 34), (34, 42), radius_x=12, radius_y=12, sweep=True)
        self.add_line('head-11', (34, 42), (14, 42))
        self.add_arc('head-12', (14, 42), (6, 34), radius_x=12, radius_y=12, sweep=True)
        self.add_arc('head-13', (6, 34), (6, 22), radius_x=4, radius_y=12, sweep=True)
