"""Roaring right-facing bear with round ear and separated jaws; teeth and fur removed."""
...
class GrizzlyHeadProfile(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('head-3', (8, 9), (12, 6), radius_x=4, radius_y=4, sweep=True)
        self.add_arc('head-4', (12, 6), (18, 11), radius_x=6, radius_y=6, sweep=True)
        ...
        self.add_arc('head-9', (42, 28), (37, 30), radius_x=7, radius_y=7, sweep=True)
        ...
        self.add_arc('head-15', (32, 42), (23, 40), radius_x=10, radius_y=10, sweep=False)
        ...
        self.add_arc('neck-1', (6, 29), (9, 41), radius_x=18, radius_y=18, sweep=False)
        self.add_contour('neck', 'neck-1', closed=False)
