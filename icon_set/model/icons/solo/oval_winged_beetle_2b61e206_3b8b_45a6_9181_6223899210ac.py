...
SOURCE_ICON_ID = '2b61e206-3b8b-45a6-9181-6223899210ac'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_30/pest_2b61e206-3b8b-45a6-9181-6223899210ac.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'oval-winged-beetle'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'objects'
    aliases = ()
    keywords = ('beetle', 'insect', 'legs', 'antennae', 'shell', 'bug')
