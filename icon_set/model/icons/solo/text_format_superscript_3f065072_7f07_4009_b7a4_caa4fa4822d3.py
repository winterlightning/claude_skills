"""A large A is followed by a raised numeral one.
Plan: The A owns its shared crossbar nodes; the superscript is a separate upper-right stroke group.
...
SOURCE_ICON_ID = '3f065072-7f07-4009-b7a4-caa4fa4822d3'
SOURCE_PATH = 'icon_set/work/todo-references/text format superscript_3f065072-7f07-4009-b7a4-caa4fa4822d3.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'text-format-superscript'
    keyshape = Keyshape.SQUARE
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'primitives-generate'
    aliases = ()
    keywords = ('text', 'format', 'superscript')
