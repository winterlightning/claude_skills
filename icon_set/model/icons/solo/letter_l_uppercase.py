"""Uppercase L for SOLO48; centerline envelope (10, 4)–(38, 44).
...
class LetterLUppercase(Solo48):
    icon_id = 'letter-l-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'L', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('L', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        runs=[((10,4),[('L',10,44),('L',38,44)],False)]
