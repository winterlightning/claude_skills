"""Cosmetic Face Cream Jar.

Symbol plan: Jar and rim share horizontal nodes; a single asymmetric cream curl rises above.
...
SAVED_SOURCE_PATH = '/Applications/Workspaces/pictographic/icon_simplification/pictographic-primitives/other/face cream_35786485-a3d0-4f1c-8bb6-3eaad7429935.svg'
BRIEF_PATH = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-021/02-cosmetic-face-cream-jar--35786485-a3d0-4f1c-8bb6-3eaad7429935.md'
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-021/references/face cream_35786485-a3d0-4f1c-8bb6-3eaad7429935.svg'
    ...
    def build(self):
        ...
        def cross(name,x,y,r):
            for j,p in enumerate(((x-r,y),(x+r,y),(x,y-r),(x,y+r))):
                line(f'{name}-{j}',(x,y),p)
        poly('jar',(6,26),(14,26),(34,26),(42,26),(42,42),(6,42),closed=True)
        poly('rim',(14,26),(14,18),(34,18),(34,26))
        path('cream',(14,18),('C',(15,12),(25,14),(23,6)),('C',(28,8),(34,12),(34,18)))
