...
Plan: Glass valve crown, shared base band, support and three leads.
Construction reference: Lucide bottle-wine; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-007/references/vacuum tube_e8389125-9282-435d-9bdb-a07cd825ce5f.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'e8389125-9282-435d-9bdb-a07cd825ce5f'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/electronics/vacuum tube_e8389125-9282-435d-9bdb-a07cd825ce5f.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'electronic-vacuum-tube-batch-007-11'
    ...
    def build(self):
        ...
        curve('glass',(10,24),((10,18),(10,12),(16,12)),((20,12),(20,4),(24,4)),((28,4),(28,12),(32,12)),((38,12),(38,18),(38,24)))
        rect('base',10,24,28,12)
        for x in (16,24,32): line(f'lead-{x}',(x,36),(x,44))
        line('support',(24,16),(24,24))
