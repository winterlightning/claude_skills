"""An upright battery has a top terminal and a rectangular charge area occupying its lower half."""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '0b77e40b-1f66-4f17-a31e-e0898fdd78c1'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_06/battery full_0b77e40b-1f66-4f17-a31e-e0898fdd78c1.svg'
AUTHOR = 'gpt-6'
ADAPTED_FROM = 'full-battery-gauge'
...
class Drawing(Solo48):
    icon_id = 'half-full-vertical-battery'
    variant_of = 'full-battery-gauge'
    variant_label = 'Half Full Vertical Battery'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'Uncategorized'
    aliases = ()
    keywords = ('half', 'full', 'battery', 'terminal', 'charge', 'area', 'occupying')
    def build(self):
        # Plan: An upright battery has a top terminal and a rectangular charge area occupying its lower half.
        ...
        rr('battery',10,12,38,44,3,top=(18,30))
        p('terminal',(18,12),(18,4),(30,4),(30,12))
        p('level',(19,27),(29,27),(29,35),(19,35),closed=True)
