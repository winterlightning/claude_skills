"""flash: Clean lightning outline; earlier revisions preserved."""
...
class Flash(Solo48):
    ...
    aliases = ()
    keywords = ('solo-ai-full-set', 'flash')

    def build(self):
        # Plan: Preserve the broad top and pointed lower arm; consolidate the lower diagonal into one deliberate straight run.
