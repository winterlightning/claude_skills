...
Reduction: Outer hair layers simplified; round lenses and a centered part retained.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = '905fd817-2df0-5be5-b796-3a85f47027d6'
SOURCE_PATH = 'pictographic-primitives/avatars/woman glasses_905fd817-2df0-5be5-b796-3a85f47027d6.svg'
AUTHOR = 'gpt-6'
...
class PersonWithBobAndGlasses(Solo48):
    icon_id = 'person-with-bob-and-glasses'
    ...
    semantic_kind = 'noun'
    aliases = ()
    keywords = ('person', 'with', 'bob', 'and', 'glasses')
    def build(self):
