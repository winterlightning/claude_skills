"""man-moustache-2: crew neck shirt with reference hair/headwear.
...
Fine trim omitted at 48; clothing cue: crew neck shirt. Source asymmetry is retained
in headwear while the face stays centered.
"""
from ...keyshapes import Keyshape
from ._base import Solo48, HEAD_BODY_CENTERLINE_GAP
SOURCE_ICON_ID = 'f1e90e6f-9678-5658-8681-1e4153774b02'
SOURCE_PATH = 'pictographic-primitives/avatars/man moustache_f1e90e6f-9678-5658-8681-1e4153774b02.svg'
SOURCE_HEAD_ICON_ID = 'man-moustache-2'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 28
class ManMoustache2Avatar(Solo48):
    icon_id = 'man-moustache-2-avatar'
    ...
    def build(self):
        ...
        self.add_line('moustache',(21,16),(27,16))
