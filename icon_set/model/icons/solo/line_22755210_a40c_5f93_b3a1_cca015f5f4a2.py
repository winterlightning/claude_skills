"""line: reconstructed stroke graph on SOLO48."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '22755210-a40c-5f93-b3a1-cca015f5f4a2'
SOURCE_PATH = 'pictographic-primitives/diagrams/line_22755210-a40c-5f93-b3a1-cca015f5f4a2.svg'
AUTHOR = 'gpt-6'
...
class Line(Solo48):
    ...
    def build(self):
        # Plan: SQUARE; two exact equal circles and one straight link, with the extra attachment hooks removed.
