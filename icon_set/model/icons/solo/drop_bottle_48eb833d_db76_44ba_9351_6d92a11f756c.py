...
class DropBottle(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e2', (38, 17), (36, 15), radius_x=5, sweep=False)
        self.add_arc('sym-e3', (36, 15), (32, 12), radius_x=16, sweep=False)
        self.add_line('sym-e4-1', (32, 12), (30, 6))
        self.add_arc('sym-e4-2', (30, 6), (28, 5), radius_x=5, sweep=False)
        self.add_line('sym-e5', (28, 5), (24, 4))
        self.add_line('sym-e8', (24, 4), (20, 5))
        self.add_arc('sym-e9-1', (20, 5), (18, 6), radius_x=5, sweep=False)
        self.add_line('sym-e9-2', (18, 6), (16, 12))
        self.add_arc('sym-e10', (16, 12), (12, 15), radius_x=17, sweep=False)
        self.add_arc('sym-e11', (12, 15), (10, 17), radius_x=5, sweep=False)
        ...
        self.add_arc('sym-e17', (8, 40), (14, 44), radius_x=7, sweep=False)
        self.add_line('sym-e18', (14, 44), (24, 44))
        self.add_line('sym-e19', (24, 44), (34, 44))
        self.add_arc('sym-e20', (34, 44), (40, 40), radius_x=7, sweep=False)
        self.add_line('sym-e21', (40, 40), (40, 23))
        self.add_line('sym-e23', (40, 23), (38, 21))
        self.add_line('sym-e24', (38, 21), (38, 20))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e1', 'sym-e2', 'sym-e3', 'sym-e4-1', 'sym-e4-2', 'sym-e5', 'sym-e8', 'sym-e9-1', 'sym-e9-2', 'sym-e10', 'sym-e11', 'sym-e12', 'sym-e13', 'sym-e14', 'sym-e16', 'sym-e17', 'sym-e18', 'sym-e19', 'sym-e20', 'sym-e21', 'sym-e23', 'sym-e24')
