"""synchronize-refresh-arrow-interface-essential: Smooth refresh curve; earlier revisions preserved."""
...
class SynchronizeRefreshArrowInterfaceEssential(Solo48):
    icon_id = 'synchronize-refresh-arrow-interface-essential'
    keyshape = Keyshape.HRECT_L
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'interface-essential'
    aliases = ()
    keywords = ('solo-ai-full-set', 'synchronize-refresh-arrow-interface-essential')
