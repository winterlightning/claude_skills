"""Rain Cloud Watering Growing Sprouts.
...
SOURCE_ICON_ID = 'ae33cc8a-8230-4494-8237-2c148bf297de'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_29/organic rain growth_ae33cc8a-8230-4494-8237-2c148bf297de.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'rainfall-young-sprouts'
    keyshape = Keyshape.SQUARE
    semantic_role = "MAIN"
    semantic_kind = "noun"
    category = 'objects'
    aliases = ()
    keywords = ('rainfall', 'young', 'sprouts')
