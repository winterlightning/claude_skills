"""Three vertical lines with circles (symbol), converted from the icons-json construction graph by json_to_solo --mode fit. SQUARE keyshape; curves fitted to integer lines and arcs."""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '716f5d1f-012b-4858-82db-a76ccdfa13ba'
SOURCE_PATH = 'pictographic-primitives/symbol/three vertical lines with circles_716f5d1f-012b-4858-82db-a76ccdfa13ba.svg'
AUTHOR = 'gpt-6'
ORIGINAL_AUTHOR = 'json_to_solo'
REVIEWED_BY = 'gpt-6'
REVIEW_ACTION = 'geometry-retained-after-visual-review'

class ThreeVerticalLinesWithCircles(Solo48):
    icon_id = 'three-vertical-lines-with-circles'
