...
class PulleyAndHangingWeight(Solo48):
    ...
    def build(self):
        ...
        self.circle('pulley',24,22,8)
        self.relate('connect','hanger','support');self.relate('connect','hanger','pulley')
        self.add_line('rope-left',(16,22),(16,32))
        self.add_polyline('weight',(8,32),(16,32),(24,32),(24,42),(8,42),closed=True)
        self.relate('connect','rope-left','pulley');self.relate('connect','rope-left','weight')
        self.add_line('rope-right',(32,22),(42,36))
        self.add_polyline('pull-arrow',(34,34),(42,36),(42,28))
        self.relate('connect','rope-right','pulley');self.relate('connect','rope-right','pull-arrow')
