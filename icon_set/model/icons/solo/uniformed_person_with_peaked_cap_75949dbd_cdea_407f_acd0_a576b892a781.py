'A uniformed person faces forward beneath a broad peaked cap and curved visor. The plain head sits above a short neck and rounded shoulders divided by a central shirt seam.\nPlan: Uniform cap over circular jaw and touching circular shoulders; seam in open torso. Jaw bottom24 shoulder top28 gives zero ink gap.\nConstruction reference: human_ref/user.svg and avatar specialization: circular jaw, broad round shoulders and zero head/body ink gap.'
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = '75949dbd-cdea-407f-acd0-a576b892a781'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/_uncategorized_08/bus driver_75949dbd-cdea-407f-acd0-a576b892a781.svg'
AUTHOR = 'gpt-6'

class Drawing(Solo48):
    icon_id = 'uniformed-person-with-peaked-cap'
    ...
    aliases = ()
    keywords = ('uniformed', 'person', 'with', 'peaked', 'cap')
    ...
    def build(self):
        ...
        poly('cap',(12,16),(12,8),(24,4),(36,8),(36,16),(32,16),(16,16),(12,16))
