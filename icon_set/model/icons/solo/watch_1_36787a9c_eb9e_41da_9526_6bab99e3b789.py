"""A blank rounded watch face sits in front of a curved perspective strap.
Plan: Rounded face and an interrupted outer strap share exact attachment nodes; two inner strap seams preserve depth.
Keyshape SQUARE: {'ink': [4, 4, 44, 44], 'centerline': [6, 6, 42, 42]}.
References: Supplied SVG rendered and inspected. Lucide original/watch.svg and atomic-debug/watch.svg: coherent contours, repeated radii and explicit shared junctions, freshly authored for SOLO48.
"""
from ...keyshapes import Keyshape
from ._base import Solo48
SOURCE_ICON_ID = '36787a9c-eb9e-41da-9526-6bab99e3b789'
SOURCE_PATH = 'icon_set/work/todo-references/watch 1_36787a9c-eb9e-41da-9526-6bab99e3b789.svg'
AUTHOR = 'gpt-6'
