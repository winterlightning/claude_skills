...
class Equalizer7b5f7ef4(Solo48):
    ...
    def build(self):
        ...
        self.add_line('e1', (40, 20), (40, 40))
        self.add_line('e2', (8, 27), (8, 8))
        self.add_line('e3', (8, 40), (8, 34))
        self.add_line('e4', (24, 20), (24, 8))
        self.add_line('e5', (24, 27), (24, 40))
        self.add_arc('e6-top', (20, 23), (28, 23), radius_x=4, radius_y=3)
        self.add_arc('e6-bottom', (28, 23), (20, 23), radius_x=4, radius_y=3)
        self.add_arc('e7-top', (36, 16), (44, 16), radius_x=4, radius_y=3)
        self.add_arc('e7-bottom', (44, 16), (36, 16), radius_x=4, radius_y=3)
        self.add_arc('e8-top', (4, 31), (12, 31), radius_x=4, radius_y=3)
        self.add_arc('e8-bottom', (12, 31), (4, 31), radius_x=4, radius_y=3)
