"""Standing hyena; centerline extremes (6,8)-(42,40). High shoulders, low rump and pointed ear retained; far legs and face details omitted for clearance."""
...
class StandingHyena(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_line('ear-muzzle-3', (37, 16), (42, 21))
        self.add_line('ear-muzzle-4', (42, 21), (42, 27))
        self.add_line('ear-muzzle-5', (42, 27), (36, 26))
        ...
        self.add_arc('tail', (6, 28), (6, 34), radius_x=8, radius_y=8, sweep=False)
