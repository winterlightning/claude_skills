...
class AzadiTower(Solo48):
    ...
    def build(self) -> None:
        # HRECT_XL centerline extremes: (6,6)-(42,42); mirror around x=24.
        self.add_line('crown',(14,6),(34,6))
        self.add_line('right-neck',(34,6),(35,16))
        self.add_arc('right-shoulder',(35,16),(40,33),radius_x=34,sweep=False)
        self.add_line('right-flare',(40,33),(42,42))
        self.add_line('right-foot',(42,42),(34,42))
        self.add_line('right-opening-leg',(34,42),(32,33))
        ...
        self.add_line('left-opening-leg',(16,33),(14,42))
        self.add_line('left-foot',(14,42),(6,42))
        self.add_line('left-flare',(6,42),(8,33))
        self.add_arc('left-shoulder',(8,33),(13,16),radius_x=34,sweep=False)
        self.add_line('left-neck',(13,16),(14,6))
