"""Uppercase V for SOLO48; centerline envelope (10, 4)–(38, 44).
Plan: Mirrored diagonals meet at one lower vertex.
...
class LetterVUppercase(Solo48):
    icon_id = 'letter-v-uppercase'
    keyshape = Keyshape.VRECT_M
    semantic_role = 'MAIN'
    semantic_kind = 'noun'
    category = 'typeface'
    categories = ('typeface',)
    typeface = {'character': 'V', 'kind': 'uppercase'}
    aliases = ()
    keywords = ('V', 'uppercase', 'capital', 'typeface')

    def build(self):
        rotation = 0
        mirror = False
        axis=24
        runs=[((10,4),[('L',axis,44),('L',38,4)],False)]
