...
class Drawing(Solo48):
    ...
    tags=('sub icon',)
    keywords=('sub icon', 'dollar banknote')
    def build(self):
        banknote(self)
        diagonal_dollar(self,24,24)
