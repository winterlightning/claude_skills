...
Plan: Three tiers represented by ellipse and two curved seams; shared side endpoints.
Construction reference: Lucide database; independently solved SOLO48 geometry.
Source copy inspected: work/brief-exports/20260917-all-todo-batches-15/batches/batch-006/references/database_d40ae4d7-e128-56bc-a8c2-ffe062e0f172.svg
"""
from ...keyshapes import Keyshape
from ._base import Solo48

SOURCE_ICON_ID = 'd40ae4d7-e128-56bc-a8c2-ffe062e0f172'
SOURCE_PATH = '/Applications/Workspaces/pictographic/claude_skills/pictographic-primitives/diagrams/database_d40ae4d7-e128-56bc-a8c2-ffe062e0f172.svg'
AUTHOR = 'gpt-6'


class GeneratedSolo(Solo48):
    icon_id = 'three-tiered-database-storage-batch-006-14'
    ...
    def build(self):
        ...
        circle('top',24,10,16,6)
        line('left',(8,10),(8,38))
        line('right',(40,10),(40,38))
        for y in (24,38): arc(f'tier-{y}',(40,y),(8,y),16,6)
