"""Trash Can with Lid.
Plan: Trash can lid and raised handle with plain body; second source has tapered walls.
Centerline envelope: (8,4)-(40,44).
Final reduction/review: Trash can lid and raised handle with plain body; second source has tapered walls.
Keyshape: VRECT_L; all geometry authored at SOLO48, never scaled.
Construction reference: Lucide trash; rounded contours and shared attachment nodes.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-004/references/trash 1_28b56564-05b2-4cca-8e2b-854f459cd66b.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'trash-can-with-lid-solo-b004-11'
    ...
    def build(self):
        s = self
        s.add_polyline('lid',(8,14),(16,14),(32,14),(40,14))
        s.add_polyline('handle',(16,14),(16,4),(32,4),(32,14));join(s,'handle','lid')
        s.add_polyline('body',(10,14),(10,38),(16,44),(32,44),(38,38),(38,14))
        join(s,'body','lid')
