...
Plan: Presentation scene: person at left, rising chart at right. Shared full_body_ref head r4, 8 centerline gap.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Chart reduced to rising arrow; chart points and stand omitted. Person head r4, center(12,14), torso junction(12,26): gap8 / ink4.
