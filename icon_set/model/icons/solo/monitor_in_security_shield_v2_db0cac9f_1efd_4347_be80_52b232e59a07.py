# Variant of monitor-in-security-shield; parent file remains unchanged.
...
class MonitorInSecurityShieldVariant2(Solo48):
    icon_id = 'monitor-in-security-shield-v2'
    variant_of = 'monitor-in-security-shield'
