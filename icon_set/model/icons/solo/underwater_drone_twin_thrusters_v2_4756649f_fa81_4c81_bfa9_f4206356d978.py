# Variant of underwater-drone-twin-thrusters; parent file remains unchanged.
...
class UnderwaterDroneTwinThrustersVariant2(Solo48):
    icon_id = 'underwater-drone-twin-thrusters-v2'
    variant_of = 'underwater-drone-twin-thrusters'
