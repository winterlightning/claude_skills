...
class SlotMachine(Solo48):
    ...
    def build(self):
        ...
        self.add_arc('sym-e8', (6, 40), (8, 42), radius_x=4, radius_y=4, large_arc=False, sweep=False)
        self.add_line('sym-e9', (8, 42), (40, 42))
        self.add_line('sym-e11', (40, 42), (42, 40))
        self.add_line('sym-e13', (42, 40), (42, 26))
        self.add_line('sym-e14', (40, 6), (8, 6))
        self.add_line('sym-e16', (8, 6), (6, 8))
        self.add_line('sym-e17', (6, 8), (6, 26))
        self.add_line('sym-e19', (42, 16), (42, 8))
        self.add_line('sym-e20', (42, 8), (40, 6))
        self.add_contour('sym-c0', 'sym-e0', 'sym-e2', 'sym-e3', 'sym-e4', closed=False)
        self.add_contour('sym-c1', 'sym-e5', 'sym-e6', 'sym-e8', 'sym-e9', 'sym-e11', 'sym-e13', closed=False)
        self.add_contour('sym-c2', 'sym-e14', 'sym-e16', 'sym-e17', closed=False)
        self.add_contour('sym-c3', 'sym-e19', 'sym-e20', closed=False)
