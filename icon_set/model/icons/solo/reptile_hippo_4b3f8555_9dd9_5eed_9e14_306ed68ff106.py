...
class OpenMouthCrocodile(Solo48):
    ...
    def build(self) -> None:
        # Left-facing crocodile with open wedge jaws and scalloped body. Extrema (6,8)-(42,40). Tiny teeth omitted to keep the open jaw readable; profile asymmetry retained.
        self.add_arc('skull', (6, 16), (12, 8), radius_x=8, radius_y=8, sweep=True)
        ...
        self.add_arc('back', (32, 18), (42, 32), radius_x=14, radius_y=14, sweep=True)
        self.add_line('tail', (42, 32), (42, 40))
        self.add_arc('belly-right', (42, 40), (32, 35), radius_x=14, radius_y=5, sweep=True)
        self.add_arc('belly-left', (32, 35), (18, 35), radius_x=9, radius_y=8, sweep=True)
        self.add_arc('jaw-lower', (18, 35), (6, 36), radius_x=12, radius_y=10, sweep=True)
        self.add_line('mouth-lower', (6, 36), (15, 29))
        self.add_arc('mouth-hinge', (15, 29), (15, 23), radius_x=4, radius_y=4, sweep=False)
        self.add_line('mouth-upper', (15, 23), (6, 16))
