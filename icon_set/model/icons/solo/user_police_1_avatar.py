"""user-police-1: protective uniform vest.
Distinct-avatar plan: preserve reference identity; use protective uniform vest.
...
SOURCE_ICON_ID = None
SOURCE_PATH = 'work/head-solo/batch-12/references/user-police-1.svg'
SOURCE_HEAD_ICON_ID = 'user-police-1'
AUTHOR = 'gpt-6'
HEAD_BOTTOM = 30
class UserPolice1Avatar(Solo48):
    icon_id = 'user-police-1-avatar'
    ...
    categories = ('avatars',)
    aliases = ()
    keywords = ('user', 'police', '1', 'portrait', 'bust')
    def build(self):
        cx = 24
