"""woman-aviator: flight jacket fastening with reference head silhouette.
...
Body cue: flight jacket fastening. Shared parameters own mirrored elements.
"""
...
class WomanAviatorAvatar(Solo48):
    ...
    category = 'avatars'
    aliases = ()
    keywords = ('woman', 'aviator', 'portrait', 'bust')
    def build(self):
