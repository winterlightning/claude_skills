...
'A leaping rabbit with a detached dot tail. SQUARE extremes (6,6)-(42,42) preserve the leaping pose; the open tail loop is removed. Lucide rabbit informs rounded ears and haunch. Right-facing asymmetry is intentional.'
...
class LeapingRabbitVariant2(Solo48):
    icon_id = 'leaping-rabbit-v2'
    variant_of = 'leaping-rabbit'
    variant_label = 'Dot tail'
    ...
    def build(self) -> None:
        self.add_arc('outline-1', (6, 27), (15, 17), radius_x=13, radius_y=10, sweep=True)
        ...
        self.add_arc('outline-5', (22, 10), (22, 6), radius_x=4, radius_y=4, sweep=True)
        self.add_arc('outline-6', (22, 6), (26, 6), radius_x=5, radius_y=5, sweep=True)
        self.add_line('outline-7', (26, 6), (42, 18))
        self.add_arc('outline-8', (42, 18), (42, 25), radius_x=10, radius_y=10, sweep=True)
        self.add_arc('outline-9', (42, 25), (39, 32), radius_x=7, radius_y=7, sweep=True)
        ...
        self.add_arc('belly-1', (6, 27), (13, 35), radius_x=11, radius_y=11, sweep=False)
        self.add_line('belly-2', (13, 35), (22, 42))
        self.add_line('belly-3', (22, 42), (35, 42))
        self.add_arc('belly-4', (35, 42), (35, 40), radius_x=3, radius_y=3, sweep=False)
