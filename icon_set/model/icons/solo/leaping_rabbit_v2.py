...
'A leaping rabbit with a detached dot tail. SQUARE extremes (2,2)-(46,46) preserve the leaping pose; the open tail loop is removed. Lucide rabbit informs rounded ears and haunch. Right-facing asymmetry is intentional.'
