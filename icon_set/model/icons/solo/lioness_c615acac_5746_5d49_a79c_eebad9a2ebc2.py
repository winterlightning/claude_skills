...
class LionessFace(Solo48):
    ...
    def build(self) -> None:
        ...
        self.add_arc('jaw-right', (40, 25), (24, 42), radius_x=16, radius_y=18, sweep=True)
        self.add_arc('jaw-left', (24, 42), (8, 25), radius_x=16, radius_y=18, sweep=True)
        ...
        self.add_arc('ear-left-top', (18, 13), (6, 13), radius_x=8, radius_y=8, sweep=False)
        self.add_arc('ear-left-low', (6, 13), (8, 25), radius_x=6, radius_y=12, sweep=False)
        self.add_contour('ear-left', 'ear-left-top', 'ear-left-low', closed=False)
        self.relate("connect", 'ear-left', 'head')
        self.add_arc('ear-right-top', (30, 13), (42, 13), radius_x=8, radius_y=8, sweep=True)
        self.add_arc('ear-right-low', (42, 13), (40, 25), radius_x=6, radius_y=12, sweep=True)
