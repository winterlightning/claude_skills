...
class DownloadVariant2(Solo48):
    ...
    def build(self):
        runs = [{'start': (4, 33), 'steps': [('L', 4, 37), ('A', 7, 40, 3, 3, False), ('L', 41, 40), ('A', 44, 37, 3, 3, False), ('L', 44, 33)], 'closed': False}, {'start': (24, 8), 'steps': [('L', 24, 31)], 'closed': False}, {'start': (14, 22), 'steps': [('L', 24, 31), ('L', 34, 22)], 'closed': False}]
        rotation = 0
