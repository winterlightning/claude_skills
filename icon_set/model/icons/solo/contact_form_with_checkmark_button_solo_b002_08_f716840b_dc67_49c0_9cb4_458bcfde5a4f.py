"""Contact Form with Checkmark Button.
Plan: Two form entry bands plus checked submit area; omit submit border to retain check at 48.
Centerline envelope: (6,6)-(42,42).
Final reduction/review: Submit border omitted; two fields and check retained.
...
EXPORTED_REFERENCE = 'work/brief-exports/20260917-all-todo-batches-15/batches/batch-002/references/lead capture_f716840b-dc67-49c0-9cb4-458bcfde5a4f.svg'
AUTHOR = 'gpt-6'
...
class GeneratedSolo(Solo48):
    icon_id = 'contact-form-with-checkmark-button-solo-b002-08'
    ...
    aliases = ()
    keywords = ('contact', 'form', 'with', 'checkmark', 'button')

    def build(self):
        s = self
        box(s,'field-1',6,6,42,14,2)
        box(s,'field-2',6,22,42,30,2)
        s.add_polyline('check',(8,38),(12,42),(16,38))
