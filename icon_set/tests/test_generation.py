...
class GenerationTests(unittest.TestCase):
    ...
    def build(self,workspace,family,log,dist=None,icon=None):
        gallery=workspace/'published/gallery';gallery.mkdir(parents=True,exist_ok=True)
        ...
        svg=workspace/'published/sub32/new-mark.svg';svg.parent.mkdir(exist_ok=True);svg.write_text('<svg/>')
