...
- Production uses an explicit external release and state directory. Never point
  an agent build, generation job, or maintenance script at a production release.
- Do not commit build output, runtime databases, candidate workspaces, or previews.
